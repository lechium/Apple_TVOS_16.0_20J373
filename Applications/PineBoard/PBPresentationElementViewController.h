...
- (void).cxx_destruct;	// IMP=0x002000000009974f
...
- (void)_updateState;	// IMP=0x00100000000994ea
- (void)_removeAcceptsEventObserverForViewController:(id)arg1;	// IMP=0x0010000000099460
- (void)_addAcceptsEventObserverForViewController:(id)arg1;	// IMP=0x00100000000993c1
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0010000000099303
- (void)setContentViewController:(id)arg1 animated:(_Bool)arg2 transitionBlock:(CDUnknownBlockType)arg3;	// IMP=0x0010000000098fcb
- (id)preferredFocusEnvironments;	// IMP=0x0010000000098f42
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x0010000000098dcd
- (void)loadView;	// IMP=0x0010000000098d2f
- (id)initWithLayoutLevel:(long long)arg1;	// IMP=0x0010000000098cd8
