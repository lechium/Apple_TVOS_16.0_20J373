...
- (void).cxx_destruct;	// IMP=0x002000000015b746
...
- (void)_performReducedMotionAnimation;	// IMP=0x001000000015b1f4
- (void)_performDefaultAnimation;	// IMP=0x001000000015b05a
- (void)startAnimation;	// IMP=0x001000000015b025
- (id)initWithContext:(unsigned long long)arg1 layout:(id)arg2 targetSize:(struct CGSize)arg3 quadrant:(long long)arg4 pipInsets:(struct UIEdgeInsets)arg5;	// IMP=0x001000000015af0a
