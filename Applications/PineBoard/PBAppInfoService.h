...
- (void).cxx_destruct;	// IMP=0x002000000005f764
...
- (void)appInfoUpdatesWithReply:(CDUnknownBlockType)arg1;	// IMP=0x001000000005f041
- (void)setServiceDelegate:(id)arg1;	// IMP=0x001000000005efe8
- (void)appInfoController:(id)arg1 didUpdate:(id)arg2;	// IMP=0x001000000005eaf4
- (void)invalidate;	// IMP=0x001000000005eaee
- (id)initWithInfoStore:(id)arg1 remoteConnection:(id)arg2;	// IMP=0x001000000005e78d
- (id)init;	// IMP=0x001000000005e77f
