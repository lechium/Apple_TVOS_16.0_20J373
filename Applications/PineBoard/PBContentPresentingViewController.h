...
- (void).cxx_destruct;	// IMP=0x0020000000125508
...
- (void)_didDismiss:(id)arg1;	// IMP=0x001000000012541f
- (void)_willDismiss:(id)arg1;	// IMP=0x00100000001253c0
- (void)dismissContentAnimated:(_Bool)arg1 clientOptions:(id)arg2 withCompletion:(CDUnknownBlockType)arg3;	// IMP=0x001000000012525f
- (void)presentContentAnimated:(_Bool)arg1 clientOptions:(id)arg2 withCompletion:(CDUnknownBlockType)arg3;	// IMP=0x001000000012511e
@property(readonly, nonatomic) _Bool expectsEventForwarding;
- (_Bool)definesPresentationContext;	// IMP=0x0010000000125104
- (void)dealloc;	// IMP=0x0010000000125028
- (id)initWithContentViewController:(id)arg1 supportsInterruption:(_Bool)arg2;	// IMP=0x0010000000124eec
