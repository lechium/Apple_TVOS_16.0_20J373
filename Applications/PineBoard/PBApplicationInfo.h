...
+ (id)_infoPlistKeys;	// IMP=0x004000000008f7de
+ (id)_entitlementKeys;	// IMP=0x001000000008f718
- (void).cxx_destruct;	// IMP=0x001000000008fb3b
...
- (void)_refreshRunsAsCurrentUser;	// IMP=0x001000000008f5b8
- (void)_refreshLocalizedName;	// IMP=0x001000000008f4cb
- (id)getEntitlementValueUncached:(id)arg1 ofClass:(Class)arg2;	// IMP=0x001000000008f417
- (id)getInfoPlistValueUncached:(id)arg1;	// IMP=0x001000000008f333
...
- (void)_loadFromProxy:(id)arg1;	// IMP=0x001000000008e379
- (void)pb_reportUntrustedLaunchAttempt;	// IMP=0x00100000001cfa49
