...
+ (id)sharedApplication;	// IMP=0x002000000002eb72
...
- (void)setFrontMostAppOrientation:(long long)arg1;	// IMP=0x001000000002ec17
- (long long)_frontMostAppOrientation;	// IMP=0x001000000002ec06
- (long long)launchOrientation;	// IMP=0x001000000002ebf5
