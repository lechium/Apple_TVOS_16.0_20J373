...
- (void).cxx_destruct;	// IMP=0x00200000000254fb
...
- (_Bool)canBecomeFirstResponder;	// IMP=0x00100000000253de
- (void)layoutSubviews;	// IMP=0x0010000000024a5d
@property(readonly, nonatomic, getter=_snippetYOrigin) double snippetYOrigin;
- (void)gatekeeperHeaderViewRequestsFocusUpdate:(id)arg1;	// IMP=0x001000000002494c
- (void)gatekeeperHeaderDismissalButtonPressed:(id)arg1;	// IMP=0x00100000000248fb
- (void)_updateUserFocusedItem:(id)arg1 fromView:(id)arg2 toView:(id)arg3;	// IMP=0x0010000000024663
- (_Bool)canBecomeFocused;	// IMP=0x001000000002462e
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x00100000000242d9
- (_Bool)shouldUpdateFocusInContext:(id)arg1;	// IMP=0x00100000000241d1
- (id)preferredFocusEnvironments;	// IMP=0x0010000000023fee
- (void)_setGatekeeperHeader:(id)arg1 animated:(_Bool)arg2;	// IMP=0x0010000000023c62
- (void)setGatekeeperHeader:(id)arg1 animated:(_Bool)arg2;	// IMP=0x0010000000023c50
- (void)_setSnippetView:(id)arg1 animated:(_Bool)arg2;	// IMP=0x001000000002387b
- (void)setSnippetView:(id)arg1 animated:(_Bool)arg2;	// IMP=0x0010000000023869
- (void)_setMessagesContactContainerView:(id)arg1 animated:(_Bool)arg2;	// IMP=0x001000000002356a
- (void)setMessagesContactContainerView:(id)arg1 animated:(_Bool)arg2;	// IMP=0x0010000000023558
- (void)_dismissalTapped:(id)arg1;	// IMP=0x0010000000023272
- (void)_selectButtonTapped:(id)arg1;	// IMP=0x0010000000023226
- (void)_handleBackButtonTapGestureRecognizer:(id)arg1;	// IMP=0x00100000000231b1
- (_Bool)isOrbFocused;	// IMP=0x0010000000023194
- (id)initWithDelegate:(id)arg1;	// IMP=0x0010000000022ef5
