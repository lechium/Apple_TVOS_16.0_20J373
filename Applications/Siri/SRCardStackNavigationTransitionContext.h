...
- (void).cxx_destruct;	// IMP=0x0020000000059064
...
- (void)completeTransition:(_Bool)arg1;	// IMP=0x0010000000058e1a
@property(readonly, nonatomic) long long semanticContentAttribute;
- (id)init;	// IMP=0x0010000000058d7f
- (id)initWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000058d0c
