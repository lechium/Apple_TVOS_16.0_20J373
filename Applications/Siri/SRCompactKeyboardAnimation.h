...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000002e99e
- (id)initWithKeyboardNotification:(id)arg1;	// IMP=0x001000000002e72b
- (id)initWithDuration:(double)arg1 curve:(long long)arg2 beginningFrame:(struct CGRect)arg3 endingFrame:(struct CGRect)arg4;	// IMP=0x001000000002e69e
