...
- (void).cxx_destruct;	// IMP=0x00200000000651e9
@property(copy, nonatomic) NSString *responseText; // @synthesize responseText=_responseText;
- (void)updateConstraints;	// IMP=0x0010000000064f78
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0010000000064ef1
- (_Bool)pointInside:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x0010000000064ea2
- (struct UIEdgeInsets)edgeInsets;	// IMP=0x0010000000064e39
- (id)initWithTitle:(id)arg1;	// IMP=0x0010000000064ca3
