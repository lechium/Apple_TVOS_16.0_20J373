...
@class MISSING_TYPE, NSDictionary, NSError, NSString, SAUIAudioData, VSPresynthesizedAudioRequest, VSSpeechRequest;
...
@interface SRTTSTask : NSObject
{
    ...
    MISSING_TYPE *_presynthesizedAudioRequest;	// 80 = 0x50
...
- (void).cxx_destruct;	// IMP=0x002000000000babb
...
- (void)_updateSynthesisEligibility;	// IMP=0x001000000000b6ee
- (void)executeCompletion;	// IMP=0x001000000000b61f
- (id)description;	// IMP=0x001000000000b319
