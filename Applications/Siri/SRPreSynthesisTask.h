...
- (void).cxx_destruct;	// IMP=0x0020000000064c2e
...
- (void)speechSynthesizer:(id)arg1 didFinishSynthesisRequest:(id)arg2 withInstrumentMetrics:(id)arg3 error:(id)arg4;	// IMP=0x001000000006490e
- (_Bool)handlePreSynthesisCommandWithError:(id *)arg1;	// IMP=0x0010000000063c83
- (id)init;	// IMP=0x00100000000631ea
