...
- (void).cxx_destruct;	// IMP=0x002000000001d98b
@property(nonatomic) __weak id <SRStarkItemControllerDelegate> delegate; // @synthesize delegate=_delegate;
- (unsigned long long)autoDismissalReason;	// IMP=0x001000000001d944
- (long long)autoDismissalStrategy;	// IMP=0x001000000001d91b
- (void)viewDidLoad;	// IMP=0x001000000001d790
- (void)loadView;	// IMP=0x001000000001d71b
- (id)initWithTitle:(id)arg1 subtitle:(id)arg2 shouldSynthesizeTitles:(_Bool)arg3;	// IMP=0x001000000001d638
