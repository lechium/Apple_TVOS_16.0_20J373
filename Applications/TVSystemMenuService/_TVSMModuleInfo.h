...
+ (id)_defaultModuleDirectories;	// IMP=0x0020000000028030
+ (id)allModuleInfos;	// IMP=0x0010000000027b60
- (void).cxx_destruct;	// IMP=0x00200000000283a0
...
- (id)_initWithURL:(id)arg1;	// IMP=0x0010000000027ec0
