...
+ (_Bool)automaticallyNotifiesObserversForKey:(id)arg1;	// IMP=0x002000000000d3c0
...
- (id)homeManager;	// IMP=0x0010000000017ed0
...
- (void)accessoryDidUpdateControllable:(id)arg1;	// IMP=0x0010000000017a70
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0010000000017650
- (void)_updateWithAvailableMediaDestinations:(id)arg1;	// IMP=0x00100000000160a0
- (void)_updateWithAvailableEndpoints:(id)arg1 outputDevices:(id)arg2;	// IMP=0x0010000000012010
- (id)_endpointRoutesWithForcedLocalRoute:(id)arg1;	// IMP=0x0010000000011b80
...
- (void)presentEARCUpsell;	// IMP=0x0010000000010700
- (void)selectOdeonDestination:(id)arg1;	// IMP=0x00100000000100c0
- (void)unpickRoutes:(id)arg1 forDestination:(id)arg2;	// IMP=0x001000000000fbf0
- (void)pickRoutes:(id)arg1 forDestination:(id)arg2;	// IMP=0x001000000000e720
- (void)_updateAllowsDestinationSelection;	// IMP=0x001000000000e640
- (void)dealloc;	// IMP=0x001000000000e090
- (id)initWithOutputContextUID:(id)arg1 allowsRetargeting:(_Bool)arg2 initalFetchCompletion:(CDUnknownBlockType)arg3;	// IMP=0x001000000000d570
- (id)initWithOutputContextUID:(id)arg1 allowsRetargeting:(_Bool)arg2;	// IMP=0x001000000000d4d0
- (id)init;	// IMP=0x001000000000d470
