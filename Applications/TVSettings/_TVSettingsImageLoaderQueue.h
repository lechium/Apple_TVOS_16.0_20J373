...
- (void)_checkForPreloadCompletion;	// IMP=0x001000000000b5de
- (void)_imageProxyDidFail:(id)arg1 withError:(id)arg2;	// IMP=0x001000000000b4f1
- (void)_imageProxyDidLoad:(id)arg1 withImage:(id)arg2;	// IMP=0x001000000000b451
- (void)_loadPendingImages;	// IMP=0x001000000000b081
- (id)_imageProxyToLoadNext;	// IMP=0x001000000000afd2
- (void)_fillQueue;	// IMP=0x001000000000aede
- (unsigned long long)_currentQueueSize;	// IMP=0x001000000000ae84
- (id)popNextImage;	// IMP=0x001000000000adeb
- (void)preloadImageCount:(long long)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000000ad9b
- (void)dealloc;	// IMP=0x001000000000acb3
- (id)init;	// IMP=0x001000000000abdb
