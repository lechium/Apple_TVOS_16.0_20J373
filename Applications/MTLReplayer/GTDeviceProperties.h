...
+ (id)bootSessionUUID;	// IMP=0x00200000000617fe
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000617f6
- (void).cxx_destruct;	// IMP=0x0020000000061638
- (void);	// IMP=0x001000000006162f
...
- (void)refreshPropertiesFromXPCObject:(id)arg1;	// IMP=0x0010000000061127
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000060f52
- (id)initForEmbeddedSystem;	// IMP=0x0010000000060b46
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000607fd
- (id)initWithXPCObject:(id)arg1;	// IMP=0x0010000000060795
- (id)init;	// IMP=0x001000000006072b
