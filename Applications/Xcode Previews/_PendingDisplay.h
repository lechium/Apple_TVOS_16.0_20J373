...
- (void).cxx_destruct;	// IMP=0x002000000000516b
...
- (_Bool)matches:(id)arg1;	// IMP=0x0010000000005097
- (void)cancelTimeoutTimer;	// IMP=0x0010000000005065
- (void)startTimeoutTimerWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x0010000000004f32
- (id)initWithToken:(id)arg1 pixelSize:(struct CGSize)arg2 scale:(double)arg3 capabilitiesPath:(id)arg4 maskPath:(id)arg5 successHandler:(CDUnknownBlockType)arg6 failureHandler:(CDUnknownBlockType)arg7;	// IMP=0x0010000000004db6
