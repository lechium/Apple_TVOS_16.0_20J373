...
- (void).cxx_destruct;	// IMP=0x0040000000013db0
- (id)init;	// IMP=0x0010000000013d50
- (id)initWithName:(id)arg1 displayID:(unsigned int)arg2 displayConfiguration:(id)arg3 capabilitiesPath:(id)arg4;	// IMP=0x0010000000013cb0
