...
- (void).cxx_destruct;	// IMP=0x002000000001bd70
...
- (void)_callElapsedTimeObserversDueToTimeJump:(_Bool)arg1;	// IMP=0x001000000001b120
- (void)_fireElapsedTimeUpdate:(id)arg1;	// IMP=0x001000000001b0c0
- (void)_updateElapsedTimeTimer;	// IMP=0x001000000001afc0
@property(readonly, nonatomic) double elapsedTime;
- (float)_rateForState:(id)arg1;	// IMP=0x001000000001a900
...
- (_Bool)currentMediaItemSupportsScrubbingUsingPlayer;	// IMP=0x001000000001a570
- (void)setSelectedSubtitleOption:(id)arg1 setGlobalPreference:(_Bool)arg2;	// IMP=0x001000000001a520
- (void)updateSubtitleOptions;	// IMP=0x001000000001a510
- (void)removeBoundaryTimeObserverWithToken:(id)arg1;	// IMP=0x001000000001a4d0
- (id)addBoundaryTimeObserverForDates:(id)arg1 withHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000001a460
- (id)addBoundaryTimeObserverForTimes:(id)arg1 withHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000001a3f0
- (void)removeElapsedTimeObserverWithToken:(id)arg1;	// IMP=0x001000000001a360
- (id)addElapsedTimeObserver:(CDUnknownBlockType)arg1;	// IMP=0x001000000001a250
- (void)skipToNextChapterInDirection:(long long)arg1;	// IMP=0x001000000001a1c0
- (void)setElapsedTime:(double)arg1 seekPrecision:(CDStruct_198678f7)arg2 ignoreDelegate:(_Bool)arg3;	// IMP=0x001000000001a180
- (void)setElapsedTime:(double)arg1 seekPrecision:(CDStruct_198678f7)arg2;	// IMP=0x001000000001a140
- (void)setElapsedTime:(double)arg1 precise:(_Bool)arg2;	// IMP=0x001000000001a100
- (void)setElapsedTime:(double)arg1;	// IMP=0x0010000000019ff0
- (void)stopWithVolumeRampDuration:(double)arg1;	// IMP=0x0010000000019fc0
- (void)stop;	// IMP=0x0010000000019f20
- (void)scanWithRate:(double)arg1;	// IMP=0x0010000000019d40
- (void)togglePlayPause;	// IMP=0x0010000000019ce0
- (void)pauseIgnoringDelegate:(_Bool)arg1;	// IMP=0x0010000000019cb0
- (void)pauseWithVolumeRampDuration:(double)arg1;	// IMP=0x0010000000019c80
- (void)pause;	// IMP=0x0010000000019c20
- (void)playIgnoringDelegate:(_Bool)arg1;	// IMP=0x0010000000019bf0
- (void)play;	// IMP=0x0010000000019ae0
- (void)continueLoadingCurrentItem;	// IMP=0x0010000000019ad0
- (void)changeMediaInDirection:(long long)arg1 reason:(id)arg2;	// IMP=0x0010000000019a00
- (void)changeMediaInDirection:(long long)arg1;	// IMP=0x00100000000199c0
- (void)setLastElapsedTime:(double)arg1 atTimestamp:(id)arg2;	// IMP=0x00100000000198c0
- (void)invalidate;	// IMP=0x0010000000019880
- (id)initWithName:(id)arg1;	// IMP=0x0010000000019720
- (id)init;	// IMP=0x00100000000196c0
