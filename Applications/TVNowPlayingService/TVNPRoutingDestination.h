...
- (void)refreshPropertiesWithRoute:(id)arg1;	// IMP=0x00100000000190f0
- (void)connectAndPair;	// IMP=0x00100000000190e0
- (void)togglePlayPause;	// IMP=0x00100000000190d0
- (id)initWithEndpointRoute:(id)arg1;	// IMP=0x0010000000019030
- (id)init;	// IMP=0x0010000000019000
