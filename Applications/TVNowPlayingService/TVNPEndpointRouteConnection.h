...
+ (id)keyPathsForValuesAffectingPaired;	// IMP=0x00200000000428f0
- (void).cxx_destruct;	// IMP=0x0020000000046ec0
...
- (id)_preloadArtwork;	// IMP=0x0010000000046a00
- (id)_placeholderArtwork;	// IMP=0x0010000000046900
- (void)_updateState;	// IMP=0x00100000000466a0
- (void)_updateAutomaticResponseLoading;	// IMP=0x00100000000465b0
- (void)_connectPairingIfNeeded:(_Bool)arg1;	// IMP=0x0010000000045f60
- (void)_connectionDidInvalidate:(id)arg1;	// IMP=0x0010000000045da0
- (void)_updateMetadata;	// IMP=0x0010000000043c10
- (void)_createRequestController;	// IMP=0x0010000000043580
- (void)_reloadPlayerPathWithRoute:(id)arg1;	// IMP=0x00100000000432b0
- (void)controller:(id)arg1 defersResponseReplacement:(CDUnknownBlockType)arg2;	// IMP=0x0010000000043060
- (void)sendCommand:(unsigned int)arg1 options:(id)arg2;	// IMP=0x0010000000042b70
- (void)playPause;	// IMP=0x0010000000042b40
- (void)deregisterMetadataUpdateHandler:(id)arg1;	// IMP=0x0010000000042ab0
- (id)registerMetadataUpdateHandler:(CDUnknownBlockType)arg1;	// IMP=0x00100000000429d0
@property(retain, nonatomic) MPAVEndpointRoute *route;
- (id)response;	// IMP=0x0010000000042850
- (id)playerPath;	// IMP=0x0010000000042760
@property(readonly, copy, nonatomic) NSString *bundleID;
@property(readonly, nonatomic, getter=isPaired) _Bool paired;
- (void)connectAndPair;	// IMP=0x0010000000042570
@property(readonly, copy) NSString *description;
- (id)initWithRoute:(id)arg1;	// IMP=0x00100000000421c0
