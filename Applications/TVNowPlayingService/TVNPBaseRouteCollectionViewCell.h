...
+ (id)_volumeImage:(_Bool)arg1;	// IMP=0x0020000000023300
+ (void)_configureFloatingContentViewAppearance;	// IMP=0x0010000000020e60
+ (_Bool)shouldUpdateMusicBars;	// IMP=0x001000000001cde0
+ (_Bool)allowsSelection;	// IMP=0x001000000001cdc0
- (void).cxx_destruct;	// IMP=0x00200000000237e0
...
- (id)_checkmarkImage:(_Bool)arg1;	// IMP=0x00100000000230f0
- (void)_configureAppearanceForControlState:(unsigned long long)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0010000000022250
- (unsigned long long)_controlStateForCell;	// IMP=0x0010000000022180
- (void)_addInitialConstraints;	// IMP=0x0010000000021010
- (void)accessoryViewSelected;	// IMP=0x0010000000020e50
- (void)routeViewSelected;	// IMP=0x0010000000020e40
- (void)volumeSliderValueChanged:(id)arg1;	// IMP=0x0010000000020e00
- (void)applyLayoutAttributes:(id)arg1;	// IMP=0x00100000000203e0
- (id)preferredLayoutAttributesFittingAttributes:(id)arg1;	// IMP=0x00100000000202b0
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00100000000201a0
- (void)updateConstraints;	// IMP=0x001000000001e360
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x001000000001e230
- (void)setSelected:(_Bool)arg1;	// IMP=0x001000000001e210
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x001000000001e0d0
- (void)prepareForReuse;	// IMP=0x001000000001e030
- (id)preferredFocusEnvironments;	// IMP=0x001000000001deb0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x001000000001ce00
