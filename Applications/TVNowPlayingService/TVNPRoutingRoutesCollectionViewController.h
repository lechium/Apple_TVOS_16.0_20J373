...
- (void).cxx_destruct;	// IMP=0x0020000000037c70
...
- (void)_pickRoute:(id)arg1;	// IMP=0x00100000000374c0
- (void)_relinquishVolumeHUDAssertionForRouteWithUID:(id)arg1;	// IMP=0x0010000000037410
- (void)_acquireVolumeHUDAssertionForRouteWithUID:(id)arg1;	// IMP=0x00100000000372a0
- (void)_calculateVisibleVolumeCells;	// IMP=0x0010000000036d50
- (void)_cleanupRouteForVolumeIfNeeded;	// IMP=0x0010000000036c00
- (id)_gradientMask;	// IMP=0x0010000000036580
- (void)routeCellDidSelectAccessoryView:(id)arg1;	// IMP=0x0010000000036470
- (void)routeCellDidSelectRouteView:(id)arg1;	// IMP=0x0010000000035b80
- (void)viewControllerDidRequestDismissal:(id)arg1 cancelled:(_Bool)arg2;	// IMP=0x0010000000035b10
- (void)shareAudioSelected;	// IMP=0x0010000000035a70
- (void)handleEndVolumeControl:(id)arg1;	// IMP=0x0010000000035760
- (void)longPressSelect:(id)arg1;	// IMP=0x0010000000035660
- (id)indexPathForVolumeSliderInCollectionView:(id)arg1 layout:(id)arg2;	// IMP=0x0010000000035500
- (void)collectionView:(id)arg1 didEndDisplayingCell:(id)arg2 forItemAtIndexPath:(id)arg3;	// IMP=0x0010000000035330
- (void)collectionView:(id)arg1 willDisplayCell:(id)arg2 forItemAtIndexPath:(id)arg3;	// IMP=0x0010000000035160
- (_Bool)collectionView:(id)arg1 shouldUpdateFocusInContext:(id)arg2;	// IMP=0x00100000000350c0
- (void)collectionView:(id)arg1 didUpdateFocusInContext:(id)arg2 withAnimationCoordinator:(id)arg3;	// IMP=0x0010000000034d30
- (struct CGSize)collectionView:(id)arg1 layout:(id)arg2 sizeForItemAtIndexPath:(id)arg3;	// IMP=0x0010000000034af0
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x00100000000349c0
- (void)handleVolumeDown;	// IMP=0x0010000000034390
- (void)handleVolumeUp;	// IMP=0x0010000000033d00
- (void)updateCollectionViewWithRoutes:(id)arg1;	// IMP=0x0010000000032a20
- (void)viewDidLayoutSubviews;	// IMP=0x0010000000032690
- (void)viewDidLoad;	// IMP=0x0010000000031750
- (void)dealloc;	// IMP=0x0010000000031700
- (id)initWithCollectionViewLayout:(id)arg1 routingController:(id)arg2;	// IMP=0x00100000000315a0
