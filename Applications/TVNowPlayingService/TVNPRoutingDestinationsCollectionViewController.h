...
- (id)_indexPathForCurrentDestination;	// IMP=0x001000000000aaf0
- (void)_presentVolumeBulletinForDestination:(id)arg1;	// IMP=0x001000000000a950
- (void)bulletinService:(id)arg1 didDismissBulletin:(id)arg2 withReason:(unsigned long long)arg3;	// IMP=0x001000000000a7e0
- (id)indexPathForPreferredFocusedViewInCollectionView:(id)arg1;	// IMP=0x001000000000a770
- (void)collectionView:(id)arg1 didSelectItemAtIndexPath:(id)arg2;	// IMP=0x0010000000009f00
- (void)collectionView:(id)arg1 didUpdateFocusInContext:(id)arg2 withAnimationCoordinator:(id)arg3;	// IMP=0x0010000000009860
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0010000000009120
- (_Bool)_ignoreVolumeChangesWhilePendingSelection;	// IMP=0x0010000000008ea0
- (void)_showConnectionFailedAlertControllerForRoutingDestination:(id)arg1;	// IMP=0x0010000000008bf0
- (void)updateCollectionViewWithDestinations:(id)arg1;	// IMP=0x00100000000084c0
- (void)viewDidLayoutSubviews;	// IMP=0x0010000000007d80
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x0010000000007cd0
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x0010000000007ba0
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x00100000000074e0
- (void)viewDidLoad;	// IMP=0x0010000000006f40
- (void)dealloc;	// IMP=0x0010000000006e70
- (id)initWithCollectionViewLayout:(id)arg1 routingController:(id)arg2 options:(id)arg3 initialUIDProvider:(CDUnknownBlockType)arg4;	// IMP=0x0010000000006bf0
