...
+ (void)_configureFloatingContentViewAppearance;	// IMP=0x004000000003bf60
...
- (void)_configureAppearanceForControlState:(unsigned long long)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x001000000003d5d0
- (unsigned long long)_controlStateForCell;	// IMP=0x001000000003d500
- (void)_addInitialConstraints;	// IMP=0x001000000003c110
- (void)applyLayoutAttributes:(id)arg1;	// IMP=0x001000000003b750
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x001000000003b620
- (void)setSelected:(_Bool)arg1;	// IMP=0x001000000003b600
- (void)updateConstraints;	// IMP=0x001000000003abc0
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x001000000003aab0
- (void)useFocusedAppearance;	// IMP=0x001000000003aa80
- (void)layoutSubviews;	// IMP=0x001000000003a690
- (void)prepareForReuse;	// IMP=0x001000000003a630
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0010000000039880
