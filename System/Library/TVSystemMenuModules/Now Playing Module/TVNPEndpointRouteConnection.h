...
+ (id)keyPathsForValuesAffectingPaired;	// IMP=0x0010000000002080
- (void).cxx_destruct;	// IMP=0x0000000000006850
...
- (id)_preloadArtwork;	// IMP=0x0000000000006390
- (id)_placeholderArtwork;	// IMP=0x0000000000006290
- (void)_updateState;	// IMP=0x0000000000006030
- (void)_updateAutomaticResponseLoading;	// IMP=0x0000000000005f40
- (void)_connectPairingIfNeeded:(_Bool)arg1;	// IMP=0x0000000000005800
- (void)_connectionDidInvalidate:(id)arg1;	// IMP=0x0000000000005640
- (void)_updateMetadata;	// IMP=0x0000000000003440
- (void)_createRequestController;	// IMP=0x0000000000002db0
- (void)_reloadPlayerPathWithRoute:(id)arg1;	// IMP=0x0000000000002ae0
- (void)controller:(id)arg1 defersResponseReplacement:(CDUnknownBlockType)arg2;	// IMP=0x00000000000027f0
- (void)sendCommand:(unsigned int)arg1 options:(id)arg2;	// IMP=0x0000000000002300
- (void)playPause;	// IMP=0x00000000000022d0
- (void)deregisterMetadataUpdateHandler:(id)arg1;	// IMP=0x0000000000002240
- (id)registerMetadataUpdateHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000002160
@property(retain, nonatomic) MPAVEndpointRoute *route;
- (id)response;	// IMP=0x0000000000001fe0
- (id)playerPath;	// IMP=0x0000000000001ef0
@property(readonly, copy, nonatomic) NSString *bundleID;
@property(readonly, nonatomic, getter=isPaired) _Bool paired;
- (void)connectAndPair;	// IMP=0x0000000000001d00
@property(readonly, copy) NSString *description;
- (id)initWithRoute:(id)arg1;	// IMP=0x00000000000018e0
