...
- (void).cxx_destruct;	// IMP=0x000000000000baa0
...
- (void)_updateVolume;	// IMP=0x000000000000b500
- (id)_imageForAVRoute:(id)arg1 destination:(id)arg2;	// IMP=0x000000000000b390
- (id)overrideTitle;	// IMP=0x000000000000b360
- (void)setOverrideTitle:(id)arg1;	// IMP=0x000000000000b2d0
- (void)volumeController:(id)arg1 mutedStateDidChange:(_Bool)arg2;	// IMP=0x000000000000b1d0
- (void)volumeController:(id)arg1 volumeValueDidChange:(float)arg2;	// IMP=0x000000000000b0c0
- (void)volumeController:(id)arg1 volumeControlAvailableDidChange:(_Bool)arg2;	// IMP=0x000000000000afc0
- (id)deviceTypeDescription;	// IMP=0x000000000000ae30
- (void)setMuted:(_Bool)arg1;	// IMP=0x000000000000adb0
- (void)setVolumeLevel:(id)arg1;	// IMP=0x000000000000ace0
- (id)deviceImage;	// IMP=0x000000000000ac40
- (void)updateWithOutputDevice:(id)arg1 selectionState:(unsigned long long)arg2 destination:(id)arg3 wantsVolumeUpdates:(_Bool)arg4;	// IMP=0x000000000000a230
@property(readonly, copy) NSString *description;
- (id)init;	// IMP=0x000000000000a100
