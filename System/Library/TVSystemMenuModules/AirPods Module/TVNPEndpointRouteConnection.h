...
+ (id)keyPathsForValuesAffectingPaired;	// IMP=0x0010000000034270
- (void).cxx_destruct;	// IMP=0x00000000000388a0
...
- (id)_preloadArtwork;	// IMP=0x00000000000383e0
- (id)_placeholderArtwork;	// IMP=0x00000000000382e0
- (void)_updateState;	// IMP=0x0000000000038080
- (void)_updateAutomaticResponseLoading;	// IMP=0x0000000000037f90
- (void)_connectPairingIfNeeded:(_Bool)arg1;	// IMP=0x0000000000037940
- (void)_connectionDidInvalidate:(id)arg1;	// IMP=0x0000000000037780
- (void)_updateMetadata;	// IMP=0x00000000000355f0
- (void)_createRequestController;	// IMP=0x0000000000034f60
- (void)_reloadPlayerPathWithRoute:(id)arg1;	// IMP=0x0000000000034c90
- (void)controller:(id)arg1 defersResponseReplacement:(CDUnknownBlockType)arg2;	// IMP=0x00000000000349e0
- (void)sendCommand:(unsigned int)arg1 options:(id)arg2;	// IMP=0x00000000000344f0
- (void)playPause;	// IMP=0x00000000000344c0
- (void)deregisterMetadataUpdateHandler:(id)arg1;	// IMP=0x0000000000034430
- (id)registerMetadataUpdateHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000034350
@property(retain, nonatomic) MPAVEndpointRoute *route;
- (id)response;	// IMP=0x00000000000341d0
- (id)playerPath;	// IMP=0x00000000000340e0
@property(readonly, copy, nonatomic) NSString *bundleID;
@property(readonly, nonatomic, getter=isPaired) _Bool paired;
- (void)connectAndPair;	// IMP=0x0000000000033ef0
@property(readonly, copy) NSString *description;
- (id)initWithRoute:(id)arg1;	// IMP=0x0000000000033b40
