...
- (void).cxx_destruct;	// IMP=0x0000000000031250
...
- (void)refreshPropertiesWithRoute:(id)arg1;	// IMP=0x0000000000030d50
- (void)connectAndPair;	// IMP=0x0000000000030d40
- (void)togglePlayPause;	// IMP=0x0000000000030d30
- (id)initWithEndpointRoute:(id)arg1;	// IMP=0x0000000000030c90
- (id)init;	// IMP=0x0000000000030c60
