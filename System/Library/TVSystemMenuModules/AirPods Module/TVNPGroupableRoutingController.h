...
+ (_Bool)automaticallyNotifiesObserversForKey:(id)arg1;	// IMP=0x0010000000013240
...
- (void)accessoryDidUpdateControllable:(id)arg1;	// IMP=0x000000000001d980
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000000001d560
- (void)_updateWithAvailableMediaDestinations:(id)arg1;	// IMP=0x000000000001bfb0
- (void)_updateWithAvailableEndpoints:(id)arg1 outputDevices:(id)arg2;	// IMP=0x0000000000017f20
- (id)_endpointRoutesWithForcedLocalRoute:(id)arg1;	// IMP=0x0000000000017a90
- (void)_updateAvailableRoutes;	// IMP=0x0000000000016f20
- (void)_setNeedsDisplayedRoutesUpdate;	// IMP=0x0000000000016d60
- (void)routingController:(id)arg1 pickedRouteDidChange:(id)arg2;	// IMP=0x0000000000016ce0
- (void)routingControllerAvailableRoutesDidChange:(id)arg1;	// IMP=0x0000000000016c90
@property(readonly, nonatomic) _Bool isLocalRouteAVR;
- (void)targetDestination:(id)arg1;	// IMP=0x0000000000016a90
- (void)presentEARCUpsell;	// IMP=0x0000000000016630
- (void)selectOdeonDestination:(id)arg1;	// IMP=0x0000000000015fb0
- (void)unpickRoutes:(id)arg1 forDestination:(id)arg2;	// IMP=0x0000000000015ae0
- (void)pickRoutes:(id)arg1 forDestination:(id)arg2;	// IMP=0x00000000000145d0
- (void)_updateAllowsDestinationSelection;	// IMP=0x00000000000144f0
- (void)dealloc;	// IMP=0x0000000000013f40
- (id)initWithOutputContextUID:(id)arg1 allowsRetargeting:(_Bool)arg2 initalFetchCompletion:(CDUnknownBlockType)arg3;	// IMP=0x00000000000133f0
- (id)initWithOutputContextUID:(id)arg1 allowsRetargeting:(_Bool)arg2;	// IMP=0x0000000000013350
- (id)init;	// IMP=0x00000000000132f0
