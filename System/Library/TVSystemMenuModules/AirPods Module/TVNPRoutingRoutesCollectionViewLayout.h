...
+ (Class)layoutAttributesClass;	// IMP=0x0060000000031bb0
- (void).cxx_destruct;	// IMP=0x00000000000322b0
...
- (id)layoutAttributesForItemAtIndexPath:(id)arg1;	// IMP=0x0000000000032060
- (id)layoutAttributesForElementsInRect:(struct CGRect)arg1;	// IMP=0x0000000000031d40
- (void)prepareLayout;	// IMP=0x0000000000031be0
