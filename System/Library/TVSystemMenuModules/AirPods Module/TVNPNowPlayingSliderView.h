...
- (id)_unfocusedProgressColor;	// IMP=0x0000000000012eb0
- (id)_focusedProgressColor;	// IMP=0x0000000000012dd0
- (void)_rightPressed:(id)arg1;	// IMP=0x0000000000012ce0
- (void)_leftPressed:(id)arg1;	// IMP=0x0000000000012c00
- (void)_panUpdated:(id)arg1;	// IMP=0x0000000000012660
- (void)_menuPressed;	// IMP=0x0000000000012650
- (void)endTrackingWithTouch:(id)arg1 withEvent:(id)arg2;	// IMP=0x00000000000125e0
- (_Bool)continueTrackingWithTouch:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000012570
- (_Bool)beginTrackingWithTouch:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000012500
- (_Bool)shouldTrack;	// IMP=0x00000000000124e0
- (double)maxBarWidth;	// IMP=0x00000000000124c0
- (void)setMaxBarWidth:(double)arg1;	// IMP=0x0000000000012450
- (void)setValue:(float)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000012160
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000012080
- (struct CGSize)intrinsicContentSize;	// IMP=0x0000000000012040
- (void)layoutSubviews;	// IMP=0x0000000000011a00
- (_Bool)canBecomeFocused;	// IMP=0x00000000000119e0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000011010
