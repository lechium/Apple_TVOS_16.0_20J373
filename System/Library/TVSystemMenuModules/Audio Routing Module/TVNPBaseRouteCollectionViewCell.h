...
+ (id)_volumeImage:(_Bool)arg1;	// IMP=0x004000000001ff20
+ (void)_configureFloatingContentViewAppearance;	// IMP=0x004000000001da80
+ (_Bool)shouldUpdateMusicBars;	// IMP=0x0040000000019a00
+ (_Bool)allowsSelection;	// IMP=0x00400000000199e0
...
- (id)_checkmarkImage:(_Bool)arg1;	// IMP=0x000000000001fd10
- (void)_configureAppearanceForControlState:(unsigned long long)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x000000000001ee70
- (unsigned long long)_controlStateForCell;	// IMP=0x000000000001eda0
- (void)_addInitialConstraints;	// IMP=0x000000000001dc30
- (void)accessoryViewSelected;	// IMP=0x000000000001da70
- (void)routeViewSelected;	// IMP=0x000000000001da60
- (void)volumeSliderValueChanged:(id)arg1;	// IMP=0x000000000001da20
- (void)applyLayoutAttributes:(id)arg1;	// IMP=0x000000000001d000
- (id)preferredLayoutAttributesFittingAttributes:(id)arg1;	// IMP=0x000000000001ced0
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000000001cdc0
- (void)updateConstraints;	// IMP=0x000000000001af80
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x000000000001ae50
- (void)setSelected:(_Bool)arg1;	// IMP=0x000000000001ae30
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x000000000001acf0
- (void)prepareForReuse;	// IMP=0x000000000001ac50
- (id)preferredFocusEnvironments;	// IMP=0x000000000001aad0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000019a20
