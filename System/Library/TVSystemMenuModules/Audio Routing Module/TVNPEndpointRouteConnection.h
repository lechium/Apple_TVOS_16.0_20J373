...
+ (id)keyPathsForValuesAffectingPaired;	// IMP=0x0010000000029070
- (void).cxx_destruct;	// IMP=0x000000000002d700
...
- (id)_preloadArtwork;	// IMP=0x000000000002d240
- (id)_placeholderArtwork;	// IMP=0x000000000002d140
- (void)_updateState;	// IMP=0x000000000002cee0
- (void)_updateAutomaticResponseLoading;	// IMP=0x000000000002cdf0
- (void)_connectPairingIfNeeded:(_Bool)arg1;	// IMP=0x000000000002c740
- (void)_connectionDidInvalidate:(id)arg1;	// IMP=0x000000000002c580
- (void)_updateMetadata;	// IMP=0x000000000002a3f0
- (void)_createRequestController;	// IMP=0x0000000000029d60
- (void)_reloadPlayerPathWithRoute:(id)arg1;	// IMP=0x0000000000029a90
- (void)controller:(id)arg1 defersResponseReplacement:(CDUnknownBlockType)arg2;	// IMP=0x00000000000297e0
- (void)sendCommand:(unsigned int)arg1 options:(id)arg2;	// IMP=0x00000000000292f0
- (void)playPause;	// IMP=0x00000000000292c0
- (void)deregisterMetadataUpdateHandler:(id)arg1;	// IMP=0x0000000000029230
- (id)registerMetadataUpdateHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000029150
@property(retain, nonatomic) MPAVEndpointRoute *route;
- (id)response;	// IMP=0x0000000000028fd0
- (id)playerPath;	// IMP=0x0000000000028ee0
@property(readonly, copy, nonatomic) NSString *bundleID;
@property(readonly, nonatomic, getter=isPaired) _Bool paired;
- (void)connectAndPair;	// IMP=0x0000000000028cf0
@property(readonly, copy) NSString *description;
- (id)initWithRoute:(id)arg1;	// IMP=0x0000000000028940
