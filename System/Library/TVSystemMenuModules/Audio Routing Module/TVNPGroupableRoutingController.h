...
+ (_Bool)automaticallyNotifiesObserversForKey:(id)arg1;	// IMP=0x00100000000012c0
...
- (void)accessoryDidUpdateControllable:(id)arg1;	// IMP=0x000000000000bb20
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000000000b700
- (void)_updateWithAvailableMediaDestinations:(id)arg1;	// IMP=0x000000000000a150
- (void)_updateWithAvailableEndpoints:(id)arg1 outputDevices:(id)arg2;	// IMP=0x00000000000060c0
- (id)_endpointRoutesWithForcedLocalRoute:(id)arg1;	// IMP=0x0000000000005c30
- (void)_updateAvailableRoutes;	// IMP=0x00000000000050c0
- (void)_setNeedsDisplayedRoutesUpdate;	// IMP=0x0000000000004eb0
- (void)routingController:(id)arg1 pickedRouteDidChange:(id)arg2;	// IMP=0x0000000000004e30
- (void)routingControllerAvailableRoutesDidChange:(id)arg1;	// IMP=0x0000000000004de0
@property(readonly, nonatomic) _Bool isLocalRouteAVR;
- (void)targetDestination:(id)arg1;	// IMP=0x0000000000004be0
- (void)presentEARCUpsell;	// IMP=0x0000000000004760
- (void)selectOdeonDestination:(id)arg1;	// IMP=0x00000000000040e0
- (void)unpickRoutes:(id)arg1 forDestination:(id)arg2;	// IMP=0x0000000000003c10
- (void)pickRoutes:(id)arg1 forDestination:(id)arg2;	// IMP=0x0000000000002690
- (void)_updateAllowsDestinationSelection;	// IMP=0x00000000000025b0
- (void)dealloc;	// IMP=0x0000000000002000
- (id)initWithOutputContextUID:(id)arg1 allowsRetargeting:(_Bool)arg2 initalFetchCompletion:(CDUnknownBlockType)arg3;	// IMP=0x0000000000001470
- (id)initWithOutputContextUID:(id)arg1 allowsRetargeting:(_Bool)arg2;	// IMP=0x00000000000013d0
- (id)init;	// IMP=0x0000000000001370
