...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000001f46
...
- (id)description;	// IMP=0x0000000000001e0c
- (id)initWithSyntheticCommand:(id)arg1;	// IMP=0x0000000000001c1d
- (void)evaluateDeviceNoteParams:(id)arg1;	// IMP=0x0000000000001b8a
- (pair_218a80e9)valueForNoteParam:(unsigned int)arg1 inParameters:(id)arg2;	// IMP=0x00000000000019a0
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000002080
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000001f4e
