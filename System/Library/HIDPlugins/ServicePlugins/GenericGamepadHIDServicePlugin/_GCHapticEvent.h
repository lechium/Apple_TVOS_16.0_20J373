...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000000c5c6
...
- (id)description;	// IMP=0x000000000000c48c
- (id)initWithSyntheticCommand:(id)arg1;	// IMP=0x000000000000c29d
- (void)evaluateDeviceNoteParams:(id)arg1;	// IMP=0x000000000000c20a
- (pair_218a80e9)valueForNoteParam:(unsigned int)arg1 inParameters:(id)arg2;	// IMP=0x000000000000c020
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000c700
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000c5ce
