...
+ (_Bool)matchService:(unsigned int)arg1 options:(id)arg2 score:(long long *)arg3;	// IMP=0x0010000000003854
...
- (void)readBatteryWithReply:(CDUnknownBlockType)arg1;	// IMP=0x0000000000007786
- (void)connectToGenericDeviceDriverConfigurationServiceWithClient:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x0000000000007774
- (void)connectToGameIntentServiceWithClient:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x0000000000007762
- (void)connectToBatteryServiceWithClient:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x000000000000767e
- (void)connectToMotionServiceWithClient:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x000000000000766c
- (void)connectToAdaptiveTriggersServiceWithClient:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x000000000000765a
- (void)connectToLightServiceWithClient:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x0000000000007648
- (void)connectToNintendoJoyConFusionGestureServiceWithClient:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x0000000000007636
- (void)enqueueTransient:(id)arg1 hapticMotor:(unsigned long long)arg2;	// IMP=0x0000000000007569
- (void)setHapticMotor:(unsigned long long)arg1 frequency:(float)arg2 amplitude:(float)arg3;	// IMP=0x00000000000074f5
- (void)fetchDeviceRegistryIDWithReply:(CDUnknownBlockType)arg1;	// IMP=0x0000000000007470
- (void)requestServiceWithReply:(CDUnknownBlockType)arg1;	// IMP=0x00000000000073b1
- (void)ping;	// IMP=0x0000000000007355
- (float)defaultHapticDispatchFrequency;	// IMP=0x0000000000007347
- (id)defaultHapticMotors;	// IMP=0x000000000000732e
- (float)defaultRightAxisSnapRadius;	// IMP=0x0000000000007325
- (float)defaultLeftAxisSnapRadius;	// IMP=0x000000000000731c
- (float)defaultRightThumbstickDeadzoneRadius;	// IMP=0x000000000000730e
- (float)defaultLeftThumbstickDeadzoneRadius;	// IMP=0x0000000000007300
- (float)defaultIdleTimeoutDuration;	// IMP=0x00000000000072f2
- (float)defaultRightThumbstickNoiseBuffer;	// IMP=0x00000000000072e9
- (float)defaultLeftThumbstickNoiseBuffer;	// IMP=0x00000000000072e0
- (void)enableHaptics;	// IMP=0x0000000000007020
- (_Bool)updateHapticMotor:(id)arg1;	// IMP=0x0000000000006f18
- (void)stopHaptics;	// IMP=0x0000000000006d2e
- (unsigned int)numberOfTimesToSendZeroHapticReport;	// IMP=0x0000000000006d23
- (_Bool)isHapticsActive;	// IMP=0x0000000000006d17
- (void)updateHaptics:(_Bool)arg1;	// IMP=0x0000000000006d11
- (void)dispatchHapticEvent;	// IMP=0x0000000000006d0b
- (_Bool)isAnyHapticMotorEnabled;	// IMP=0x0000000000006af7
- (void)dispatchShareButtonEventWithValue:(_Bool)arg1 timestamp:(unsigned long long)arg2;	// IMP=0x0000000000006a23
- (void)dispatchOptionsButtonEventWithValue:(_Bool)arg1 timestamp:(unsigned long long)arg2;	// IMP=0x000000000000694f
- (void)dispatchMenuButtonEventWithValue:(_Bool)arg1 timestamp:(unsigned long long)arg2;	// IMP=0x000000000000687b
- (void)dispatchHomeButtonEventWithValue:(_Bool)arg1 timestamp:(unsigned long long)arg2;	// IMP=0x00000000000067a7
- (void)dispatchGameControllerExtendedEventWithState:(CDStruct_cd435f0f)arg1 timestamp:(unsigned long long)arg2;	// IMP=0x0000000000006293
- (void)dispatchMotionEventWithState:(CDStruct_06597ee6)arg1 timestamp:(unsigned long long)arg2;	// IMP=0x0000000000005ff8
- (_Bool)isTwoAxisInputIdle:(MISSING_TYPE **)arg1 prevInput:(MISSING_TYPE **)arg2 noiseBuffer:(float)arg3;	// IMP=0x0000000000005f9f
- (void)applyDeadzone:(float)arg1 axisSnapRadius:(float)arg2 input:(MISSING_TYPE **)arg3;	// IMP=0x0000000000005e9e
- (void)dispatchEvent:(id)arg1;	// IMP=0x0000000000005e87
- (void)dispatchEvent:(id)arg1 updateLastEventTime:(_Bool)arg2;	// IMP=0x0000000000005d9e
- (id)createEvent:(unsigned int)arg1 timestamp:(unsigned long long)arg2;	// IMP=0x0000000000005d50
- (_Bool)shouldDisconnectWhenIdle;	// IMP=0x0000000000005d48
- (_Bool)isIdle;	// IMP=0x0000000000005bd6
- (void)updateIdleState;	// IMP=0x0000000000005b1c
- (void)scheduleIdleTimer;	// IMP=0x00000000000059e6
- (_Bool)shouldCreateBatteryDevice;	// IMP=0x00000000000059de
- (void)sendBatteryReport;	// IMP=0x00000000000058d1
- (void)updateClientBattery;	// IMP=0x0000000000005804
- (void)createVirtualHIDDeviceForBattery;	// IMP=0x00000000000054c3
...
- (void)initGameControllerDaemonXPC;	// IMP=0x000000000000385c
