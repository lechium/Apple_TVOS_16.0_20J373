...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000000234e
...
- (id)description;	// IMP=0x0000000000002214
- (id)initWithSyntheticCommand:(id)arg1;	// IMP=0x0000000000002025
- (void)evaluateDeviceNoteParams:(id)arg1;	// IMP=0x0000000000001f92
- (pair_218a80e9)valueForNoteParam:(unsigned int)arg1 inParameters:(id)arg2;	// IMP=0x0000000000001da8
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000002488
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000002356
