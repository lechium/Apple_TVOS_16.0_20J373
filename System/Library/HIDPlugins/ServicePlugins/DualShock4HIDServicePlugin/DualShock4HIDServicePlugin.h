...
+ (_Bool)matchService:(unsigned int)arg1 options:(id)arg2 score:(long long *)arg3;	// IMP=0x0010000000003198
- (void).cxx_destruct;	// IMP=0x0000000000006f88
@property(nonatomic) _Bool extendedSupportEnabled; // @synthesize extendedSupportEnabled=_extendedSupportEnabled;
- (void)connectToMotionServiceWithClient:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x0000000000006e93
- (void)updateSensorsActive:(_Bool)arg1;	// IMP=0x0000000000006d43
- (void)readSensorsActiveWithReply:(CDUnknownBlockType)arg1;	// IMP=0x0000000000006d2a
- (void)connectToLightServiceWithClient:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x0000000000006c45
- (void)updateLightWithRed:(float)arg1 green:(float)arg2 blue:(float)arg3;	// IMP=0x0000000000006a4a
- (void)readLightWithReply:(CDUnknownBlockType)arg1;	// IMP=0x0000000000006966
- (id)defaultHapticMotors;	// IMP=0x0000000000006885
- (float)defaultHapticDispatchFrequency;	// IMP=0x0000000000006877
- (void)dispatchHapticEvent;	// IMP=0x0000000000006836
- (_Bool)shouldDisconnectWhenIdle;	// IMP=0x0000000000006824
- (_Bool)setProperty:(id)arg1 forKey:(id)arg2 client:(id)arg3;	// IMP=0x000000000000670d
- (id)propertyForKey:(id)arg1 client:(id)arg2;	// IMP=0x00000000000063ab
@property(readonly, copy) NSString *description;
- (void)updateBatteryLevel:(unsigned char)arg1 isPowerSupplyConnected:(_Bool)arg2;	// IMP=0x00000000000061e2
- (void)dispatchOutputReport;	// IMP=0x0000000000005ddc
- (void)setupRawReportHandling;	// IMP=0x0000000000005148
- (void)requestPairingInfo;	// IMP=0x0000000000004e31
- (void)requestSensorCalibrationInfo;	// IMP=0x0000000000003e22
- (void)requestFirmwareInfo;	// IMP=0x00000000000037cc
- (void)determineSupportMode;	// IMP=0x00000000000034c6
- (id)initWithService:(unsigned int)arg1;	// IMP=0x0000000000003252
