...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000063fa
...
- (id)description;	// IMP=0x00000000000062c0
- (id)initWithSyntheticCommand:(id)arg1;	// IMP=0x00000000000060d1
- (void)evaluateDeviceNoteParams:(id)arg1;	// IMP=0x000000000000603e
- (pair_218a80e9)valueForNoteParam:(unsigned int)arg1 inParameters:(id)arg2;	// IMP=0x0000000000005e54
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000006534
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000006402
