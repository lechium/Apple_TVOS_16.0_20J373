...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000000178a
...
- (id)description;	// IMP=0x0000000000001650
- (id)initWithSyntheticCommand:(id)arg1;	// IMP=0x0000000000001461
- (void)evaluateDeviceNoteParams:(id)arg1;	// IMP=0x00000000000013ce
- (pair_218a80e9)valueForNoteParam:(unsigned int)arg1 inParameters:(id)arg2;	// IMP=0x00000000000011e4
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000018c4
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000001792
