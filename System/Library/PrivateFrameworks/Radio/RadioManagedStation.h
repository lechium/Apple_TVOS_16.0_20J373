...
+ (id)defaultPropertiesToFetch;	// IMP=0x0060000000002089
@property(readonly, nonatomic) NSDictionary *dictionaryRepresentation;
@property(nonatomic) _Bool virtualPlayEnabled;
@property(nonatomic) int subscriberCount;
- (id)streamKeyURL;	// IMP=0x00000000000053e3
- (id)streamCertificateURL;	// IMP=0x0000000000005342
...
- (void)setStreamKeyURL:(id)arg1;	// IMP=0x0000000000004a38
- (void)setStreamCertificateURL:(id)arg1;	// IMP=0x000000000000494a
...
- (id)feedbackDictionaryRepresentation;	// IMP=0x0000000000002567
- (id)additionalReferencedTrackDescriptors;	// IMP=0x000000000000217c
