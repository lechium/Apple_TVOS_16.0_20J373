...
+ (id)keysToFetchForFaceTime;	// IMP=0x001000000002119c
+ (id)tu_contactHandlesForHandle:(id)arg1;	// IMP=0x00100000000cd798
- (id)allTUHandles;	// IMP=0x001000000000d287
- (id)tuHandlesForEmailAddresses;	// IMP=0x001000000000d056
- (id)tuHandlesForPhoneNumbers;	// IMP=0x001000000000cdb1
- (id)tu_labeledValueForSocialProfileWithUsername:(id)arg1;	// IMP=0x001000000000cb58
- (id)tu_labeledValueForPhoneNumber:(id)arg1;	// IMP=0x001000000000c91d
- (id)tu_labeledValueForHandle:(id)arg1;	// IMP=0x001000000000c724
- (id)tu_labeledValueForEmailAddress:(id)arg1;	// IMP=0x001000000000c4e9
