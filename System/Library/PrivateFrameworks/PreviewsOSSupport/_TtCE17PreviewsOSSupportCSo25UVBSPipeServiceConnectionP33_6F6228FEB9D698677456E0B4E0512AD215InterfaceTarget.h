...
- (id)init;	// IMP=0x00000000000096f0
- (void)sendEncodedEvent:(id)arg1 replyHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000009640
- (void)sendEncodedEvent:(id)arg1;	// IMP=0x0000000000009220
