...
+ (id)serviceName;	// IMP=0x006000000002e954
+ (id)sharedInstance;	// IMP=0x006000000002e8ef
...
- (void)removeObserver:(id)arg1;	// IMP=0x000000000002f00f
- (void)addObserver:(id)arg1;	// IMP=0x000000000002efbb
- (id)findOrRegisterIcon:(id)arg1;	// IMP=0x000000000002edd0
- (void)dealloc;	// IMP=0x000000000002eda1
- (id)_init;	// IMP=0x000000000002e9ab
