...
+ (id)customRecipeWithInfo:(id)arg1 bundle:(id)arg2;	// IMP=0x0010000000024272
...
- (id)resourceNamed:(id)arg1;	// IMP=0x0000000000024596
- (id)initWithRecipe:(id)arg1 bitmapResources:(id)arg2 symbolResources:(id)arg3 bundle:(id)arg4;	// IMP=0x000000000002448f
