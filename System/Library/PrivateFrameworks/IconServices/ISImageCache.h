...
- (void).cxx_destruct;	// IMP=0x000000000000c593
...
- (id)allImages;	// IMP=0x000000000000c357
- (id)debugDescription;	// IMP=0x000000000000c116
- (void)setImage:(id)arg1 forDescriptor:(id)arg2;	// IMP=0x000000000000bff8
- (id)imageForDescriptor:(id)arg1;	// IMP=0x000000000000befe
- (id)init;	// IMP=0x000000000000bea1
