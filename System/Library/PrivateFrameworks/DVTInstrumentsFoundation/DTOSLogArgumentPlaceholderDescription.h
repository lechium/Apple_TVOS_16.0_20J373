...
- (void).cxx_destruct;	// IMP=0x0000000000019cac
...
- (unsigned long long)hash;	// IMP=0x0000000000019c6e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000019c63
- (id)initWithPlaceholderToken:(id)arg1;	// IMP=0x0000000000019780
