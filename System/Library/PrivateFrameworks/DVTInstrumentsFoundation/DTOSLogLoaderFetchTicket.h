...
- (void).cxx_destruct;	// IMP=0x0000000000021c4b
...
- (void)prepareAgent:(id)arg1 loader:(id)arg2;	// IMP=0x00000000000218e5
- (void)holdAgent:(id)arg1 loader:(id)arg2;	// IMP=0x0000000000020dd5
