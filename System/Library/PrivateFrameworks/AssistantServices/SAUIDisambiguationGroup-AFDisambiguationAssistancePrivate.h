...
- (void)af_saveItemSelection:(id)arg1 forType:(long long)arg2;	// IMP=0x00200000000b8e91
- (id)af_assistedSelectionItem;	// IMP=0x00200000000b8e19
@property(retain, nonatomic, setter=af_setDisambiguationInfo:) AFDisambiguationInfo *af_disambiguationInfo;
- (id)af_itemForIndexIdentifier:(id)arg1;	// IMP=0x00200000000b8bb1
- (id)af_indexIdentifierForItem:(id)arg1;	// IMP=0x00200000000b89a8
