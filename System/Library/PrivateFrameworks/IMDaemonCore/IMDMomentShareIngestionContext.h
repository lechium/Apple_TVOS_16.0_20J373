...
- (void)completeTransferForAssetUUID:(id)arg1;	// IMP=0x0000000000002476
- (void)clearAllTransfers;	// IMP=0x0000000000002460
- (void)addTransfers:(id)arg1;	// IMP=0x000000000000244a
@property(readonly, nonatomic) NSDictionary *assetUUIDsToFileTransfers;
- (id)initWithURL:(id)arg1 message:(id)arg2 inChat:(id)arg3;	// IMP=0x0000000000002368
