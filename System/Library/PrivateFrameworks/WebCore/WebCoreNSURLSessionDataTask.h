...
- (id).cxx_construct;	// IMP=0x00000000021102e0
- (void).cxx_destruct;	// IMP=0x00000000021101c0
...
- (void)resourceFinished:(void *)arg1 metrics:(const void *)arg2;	// IMP=0x00000000021100c0
- (void)resource:(void *)arg1 loadFailedWithError:(const void *)arg2;	// IMP=0x0000000002110010
- (void)resource:(void *)arg1 accessControlCheckFailedWithError:(const void *)arg2;	// IMP=0x000000000210ff60
- (void)_resource:(void *)arg1 loadFinishedWithError:(id)arg2 metrics:(const void *)arg3;	// IMP=0x000000000210fc50
- (void)resource:(void *)arg1 receivedRedirect:(const void *)arg2 request:(void *)arg3 completionHandler:(void *)arg4;	// IMP=0x000000000210f800
- (void)resource:(void *)arg1 receivedData:(void *)arg2;	// IMP=0x000000000210f6f0
- (_Bool)resource:(void *)arg1 shouldCacheResponse:(const void *)arg2;	// IMP=0x000000000210f6a0
- (void)resource:(void *)arg1 receivedResponse:(const void *)arg2 completionHandler:(void *)arg3;	// IMP=0x000000000210f2e0
- (void)resource:(void *)arg1 sentBytes:(unsigned long long)arg2 totalBytesToBeSent:(unsigned long long)arg3;	// IMP=0x000000000210f2d0
- (id)_timingData;	// IMP=0x000000000210f2c0
- (void)dealloc;	// IMP=0x000000000210f140
- (void)resume;	// IMP=0x000000000210f0a0
- (void)suspend;	// IMP=0x000000000210f000
- (void)cancel;	// IMP=0x000000000210ef30
...
- (void)_cancel;	// IMP=0x000000000210ec80
- (void)_restart;	// IMP=0x000000000210e6f0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000210e6e0
- (id)initWithSession:(id)arg1 identifier:(unsigned long long)arg2 request:(id)arg3;	// IMP=0x000000000210e5b0
