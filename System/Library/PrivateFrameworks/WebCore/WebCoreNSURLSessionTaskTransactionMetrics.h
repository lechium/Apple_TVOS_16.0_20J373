...
- (id).cxx_construct;	// IMP=0x000000000210bd10
- (void).cxx_destruct;	// IMP=0x000000000210bd00
- (_Bool)multipath;	// IMP=0x000000000210bcf0
- (_Bool)constrained;	// IMP=0x000000000210bce0
- (_Bool)expensive;	// IMP=0x000000000210bcd0
- (_Bool)cellular;	// IMP=0x000000000210bcc0
...
- (void)dealloc;	// IMP=0x000000000210b870
- (id)_initWithMetrics:(void *)arg1;	// IMP=0x000000000210b7a0
