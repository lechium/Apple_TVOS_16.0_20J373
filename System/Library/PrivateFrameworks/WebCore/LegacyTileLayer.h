...
- (id)actionForKey:(id)arg1;	// IMP=0x0000000000a86980
- (void)drawInContext:(struct CGContext *)arg1;	// IMP=0x0000000000a85d10
- (void)renderInContext:(struct CGContext *)arg1;	// IMP=0x0000000000a85cb0
- (void)layoutSublayers;	// IMP=0x0000000000a85bf0
- (void)setNeedsDisplayInRect:(struct CGRect)arg1;	// IMP=0x0000000000a85ba0
