...
- (void).cxx_destruct;	// IMP=0x000000000092a747
@property(readonly) __weak HMDAccessoryBrowser *accessoryBrowser; // @synthesize accessoryBrowser=_accessoryBrowser;
- (void)invalidate;	// IMP=0x000000000092a6b3
- (id)initWithAccessoryBrowser:(id)arg1 reason:(id)arg2;	// IMP=0x000000000092a580
- (id)initWithName:(id)arg1;	// IMP=0x000000000092a4ca
