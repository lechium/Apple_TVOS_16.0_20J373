...
+ (id)logCategory;	// IMP=0x001000000075739a
+ (double)timeout;	// IMP=0x00100000007572bc
- (void).cxx_destruct;	// IMP=0x00000000007570e8
...
- (id)logIdentifier;	// IMP=0x0000000000756fb9
- (void)main;	// IMP=0x0000000000756eb8
- (id)initWithMessage:(id)arg1 home:(id)arg2 dispatcher:(id)arg3;	// IMP=0x0000000000756d6d
