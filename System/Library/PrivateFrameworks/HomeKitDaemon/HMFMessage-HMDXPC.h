...
+ (id)nonSPIEntitledMessageWithName:(id)arg1 messagePayload:(id)arg2;	// IMP=0x0020000000304f37
+ (id)entitledMessageWithName:(id)arg1 identifier:(id)arg2 messagePayload:(id)arg3;	// IMP=0x0020000000304ebf
+ (id)entitledMessageWithName:(id)arg1 messagePayload:(id)arg2;	// IMP=0x0020000000304d95
+ (id)internalMessageWithName:(id)arg1 destination:(id)arg2 messagePayload:(id)arg3;	// IMP=0x002000000059660c
+ (id)internalMessageWithName:(id)arg1 messagePayload:(id)arg2 responseHandler:(CDUnknownBlockType)arg3;	// IMP=0x00200000005965bd
+ (id)internalMessageWithName:(id)arg1 messagePayload:(id)arg2;	// IMP=0x002000000059656e
+ (id)homeLocationAuthorizedAndEntitledMessageWithName:(id)arg1 target:(id)arg2 messagePayload:(id)arg3;	// IMP=0x00200000007b9eb4
+ (id)locationAuthorizedMessageWithName:(id)arg1 messagePayload:(id)arg2;	// IMP=0x00200000007b9e4a
@property(readonly, nonatomic, getter=isLocalFallback) _Bool localFallback;
- (unsigned long long)homeManagerOptions;	// IMP=0x0010000000304ca1
...
- (_Bool)_supportsFeature:(unsigned long long)arg1 forCapabilitiesKey:(id)arg2;	// IMP=0x001000000043d8d3
- (_Bool)supportsRequestedFeature:(unsigned long long)arg1;	// IMP=0x001000000043d8ba
- (_Bool)supportsRequiredFeature:(unsigned long long)arg1;	// IMP=0x001000000043d8a1
...
- (id)userForHome:(id)arg1;	// IMP=0x0010000000a095e3
- (id)matchingRemoteIdentityUserForHome:(id)arg1;	// IMP=0x0010000000a09264
- (_Bool)isSingleReadWriteRequest;	// IMP=0x0010000000bbd677
