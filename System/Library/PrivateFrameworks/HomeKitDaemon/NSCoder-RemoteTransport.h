...
- (id)hm_decodeSetOfConditionalObjects:(Class)arg1 forKey:(id)arg2;	// IMP=0x0030000000685779
- (void)hm_encodeSetOfConditionalObjects:(id)arg1 forKey:(id)arg2;	// IMP=0x00300000006854ed
- (id)hm_decodeArrayOfConditionalObjects:(Class)arg1 forKey:(id)arg2;	// IMP=0x0030000000685396
- (void)hm_encodeArrayOfConditionalObjects:(id)arg1 forKey:(id)arg2;	// IMP=0x003000000068510a
- (_Bool)hmd_isHH2MigrationInProgress;	// IMP=0x0030000000999c33
