...
- (void).cxx_destruct;	// IMP=0x00000000000221b1
...
- (void)setHeaderValue:(id)arg1 forHeaderKey:(id)arg2;	// IMP=0x0000000000022055
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000021f4a
- (id)initWithStatusCode:(long long)arg1 headerFields:(id)arg2 body:(id)arg3;	// IMP=0x0000000000021e75
- (id)init;	// IMP=0x0000000000021dcd
