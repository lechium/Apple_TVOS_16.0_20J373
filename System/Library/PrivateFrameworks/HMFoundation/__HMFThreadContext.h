...
+ (id)currentContext;	// IMP=0x0040000000021798
- (void).cxx_destruct;	// IMP=0x00000000000219c6
...
- (id)description;	// IMP=0x000000000002190e
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000021880
- (unsigned long long)hash;	// IMP=0x0000000000021863
- (id)__init;	// IMP=0x0000000000021834
- (id)init;	// IMP=0x00000000000216f0
