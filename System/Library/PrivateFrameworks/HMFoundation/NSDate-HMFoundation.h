...
+ (id)shortDescription;	// IMP=0x0010000000041d70
+ (id)timeIntervalDescription:(double)arg1;	// IMP=0x0010000000041f30
- (id)hmf_dateComponentsUsingTimeZone:(id)arg1;	// IMP=0x0010000000041e91
