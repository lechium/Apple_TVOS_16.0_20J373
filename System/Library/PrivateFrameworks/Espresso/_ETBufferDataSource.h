...
- (id).cxx_construct;	// IMP=0x00000000006e53be
- (void).cxx_destruct;	// IMP=0x00000000006e5391
...
- (float *)dataAtIndex:(unsigned long long)arg1 key:(const void *)arg2;	// IMP=0x00000000006e5136
- (id)initWithBlobShapes:(const void *)arg1 numberOfDataPoints:(unsigned long long)arg2 batchSize:(unsigned long long)arg3 error:(id *)arg4;	// IMP=0x00000000006e4ea3
- (id)dataPointAtIndex:(unsigned long long)arg1 error:(id *)arg2;	// IMP=0x00000000006e465d
- (unsigned long long)numberOfDataPoints;	// IMP=0x00000000006e4653
