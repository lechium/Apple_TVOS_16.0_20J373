...
- (void).cxx_destruct;	// IMP=0x0000000000668e7a
...
- (struct _mxnetTools_imageID_t_)imageID;	// IMP=0x0000000000668d29
- (id)labels;	// IMP=0x0000000000668c2e
- (id)imageData;	// IMP=0x0000000000668ac5
- (_Bool)nextRecordAndError:(id *)arg1;	// IMP=0x00000000006685eb
- (_Bool)seekRecordWithID:(struct _mxnetTools_imageID_t_ *)arg1 error:(id *)arg2;	// IMP=0x00000000006684f1
- (id)initWithRecFile:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000668225
