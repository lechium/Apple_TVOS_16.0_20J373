...
- (id).cxx_construct;	// IMP=0x00000000004a84a2
- (void).cxx_destruct;	// IMP=0x00000000004a846d
- (int)numberOfDataPoints;	// IMP=0x00000000004a8457
- (id)dataPointAtIndex:(int)arg1;	// IMP=0x00000000004a829f
- (id)initWithDataSource:(id)arg1 dumpPath:(id)arg2;	// IMP=0x00000000004a81cd
- (id)initWithDataSource:(id)arg1;	// IMP=0x00000000004a80f2
