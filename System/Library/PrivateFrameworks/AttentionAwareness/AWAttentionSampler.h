...
- (void).cxx_destruct;	// IMP=0x0000000000011971
...
- (id)initWithMask:(unsigned long long)arg1;	// IMP=0x0000000000011852
- (void)setSmartCoverClosed:(_Bool)arg1;	// IMP=0x0000000000011849
- (void)shouldSample:(_Bool)arg1 withDeadline:(unsigned long long)arg2 withOptions:(union)arg3;	// IMP=0x0000000000011840
- (unsigned long long)minimumAttentionSamplerErrorRetryTime;	// IMP=0x0000000000011837
- (unsigned long long)nextSampleTimeForSamplingInterval:(unsigned long long)arg1;	// IMP=0x000000000001182e
- (void)finishDeadlineComputationWithOptions:(union)arg1;	// IMP=0x00000000000117d9
- (void)updateSamplingDeadline:(unsigned long long)arg1 forClient:(id)arg2;	// IMP=0x0000000000011775
- (void)startDeadlineComputation;	// IMP=0x0000000000011744
- (void)setUnitTestMode;	// IMP=0x000000000001171e
- (id)description;	// IMP=0x0000000000011687
- (id)init;	// IMP=0x00000000000115ea
