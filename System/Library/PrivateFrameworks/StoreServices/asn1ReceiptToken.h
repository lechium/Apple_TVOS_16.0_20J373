...
+ (id)readFromBuffer:(const char *)arg1;	// IMP=0x006000000016ae2b
...
- (id)description;	// IMP=0x000000000016aff7
- (void)dealloc;	// IMP=0x000000000016adf0
- (id)_initWithType:(unsigned long long)arg1 typeVersion:(unsigned long long)arg2 contentToken:(id)arg3;	// IMP=0x000000000016ad8a
