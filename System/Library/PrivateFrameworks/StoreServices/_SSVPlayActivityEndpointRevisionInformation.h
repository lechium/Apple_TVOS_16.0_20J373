...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000127384
- (void).cxx_destruct;	// IMP=0x00000000001273d2
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000127310
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000012728b
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000012713c
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000012709f
- (unsigned long long)hash;	// IMP=0x000000000012705c
