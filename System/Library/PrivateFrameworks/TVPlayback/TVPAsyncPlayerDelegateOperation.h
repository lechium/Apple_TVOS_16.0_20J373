...
- (void).cxx_destruct;	// IMP=0x00000000000092a5
@property(copy, nonatomic) CDUnknownBlockType block; // @synthesize block=_block;
@property(readonly, nonatomic) NSNumber *identifier; // @synthesize identifier=_identifier;
- (unsigned long long)hash;	// IMP=0x000000000000923e
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000009190
- (id)init;	// IMP=0x0000000000009118
