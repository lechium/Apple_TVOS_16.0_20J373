...
- (void).cxx_destruct;	// IMP=0x0000000000071004
...
- (void)_updateImageViewWithPlaceholderImageIfNeeded;	// IMP=0x0000000000070e88
- (void)_setImage:(id)arg1;	// IMP=0x0000000000070d2f
- (id)_imageView;	// IMP=0x0000000000070bb3
- (void)_loadImage;	// IMP=0x000000000007056e
- (void)setSelected:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x00000000000703fa
@property(nonatomic) double cornerRadius;
- (void)setImageProxy:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000007000c
@property(retain, nonatomic) UIImage *image;
- (void)willMoveToWindow:(id)arg1;	// IMP=0x000000000006ff0f
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000006fe56
- (void)setFrame:(struct CGRect)arg1;	// IMP=0x000000000006fdc4
- (void)setContentMode:(long long)arg1;	// IMP=0x000000000006fd9c
- (void)layoutSubviews;	// IMP=0x000000000006fd20
- (long long)contentMode;	// IMP=0x000000000006fd03
- (struct CGSize)intrinsicContentSize;	// IMP=0x000000000006fce6
- (void)dealloc;	// IMP=0x000000000006fc81
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000006fb7a
