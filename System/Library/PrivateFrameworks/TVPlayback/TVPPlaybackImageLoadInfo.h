...
- (void).cxx_destruct;	// IMP=0x000000000009fe7f
...
- (void)callCompletionHandlerWithImage:(id)arg1 actualCMTime:(CDStruct_1b6d18a9)arg2 actualDate:(id)arg3;	// IMP=0x000000000009fc3f
- (id)description;	// IMP=0x000000000009fb88
