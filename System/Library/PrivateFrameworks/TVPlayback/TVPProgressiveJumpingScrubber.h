...
- (void).cxx_destruct;	// IMP=0x00000000000f3063
...
- (void)_skipTimerFired:(id)arg1;	// IMP=0x00000000000f2e59
- (double)_nextTimeToAdvanceFromTime:(double)arg1;	// IMP=0x00000000000f2d73
- (void)cancelScrub;	// IMP=0x00000000000f2d41
- (void)startScrubWithRate:(double)arg1;	// IMP=0x00000000000f2c61
