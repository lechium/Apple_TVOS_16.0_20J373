...
- (void).cxx_destruct;	// IMP=0x0000000000046b3c
...
- (double)_timeAfterRemovingInterstitials:(double)arg1;	// IMP=0x000000000004691e
- (void)_updateImageIntervalWithRate:(double)arg1;	// IMP=0x000000000004684a
- (void)_cancelStaleImageLoadsForTime:(double)arg1;	// IMP=0x0000000000046619
- (void)_cancelAllImageLoads;	// IMP=0x0000000000046585
- (void)_loadImagesIfNecessary;	// IMP=0x0000000000045a86
- (void)_displayLinkTimerFired:(id)arg1;	// IMP=0x000000000004567a
- (void)invalidate;	// IMP=0x0000000000045665
- (id)initWithMediaItem:(id)arg1 referenceTime:(CDStruct_1b6d18a9)arg2 forDate:(id)arg3;	// IMP=0x0000000000045278
