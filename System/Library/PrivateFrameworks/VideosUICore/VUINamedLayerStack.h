...
+ (id)decodedNamedLayerStackWithImage:(id)arg1 size:(struct CGSize)arg2 cornerRadius:(double)arg3;	// IMP=0x001000000000cc6c
+ (id)namedLayerStackWithImage:(id)arg1;	// IMP=0x001000000000c8b9
- (void).cxx_destruct;	// IMP=0x000000000000d646
...
- (id)_init;	// IMP=0x000000000000c88a
- (id)init;	// IMP=0x000000000000c87c
