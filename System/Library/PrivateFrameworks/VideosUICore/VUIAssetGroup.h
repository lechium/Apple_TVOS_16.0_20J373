...
+ (id)_humanReadableStringForGroupType:(long long)arg1;	// IMP=0x0060000000025d93
- (void).cxx_destruct;	// IMP=0x0000000000025ed7
...
- (id)_manifestFilePath;	// IMP=0x0000000000025db2
- (void)_saveManifest;	// IMP=0x0000000000025c32
- (void)_updateManifestWithChange:(CDUnknownBlockType)arg1;	// IMP=0x0000000000025a52
- (id)description;	// IMP=0x0000000000025976
- (void)updateAssetsFromFiles;	// IMP=0x0000000000024edd
- (void)_removeAssetInfoForKey:(id)arg1 removeFile:(_Bool)arg2;	// IMP=0x0000000000024a5d
- (void)_removeAssetInfoForKey:(id)arg1;	// IMP=0x0000000000024a46
- (id)infoForAllAssetsWithTags:(id)arg1 queue:(id)arg2;	// IMP=0x00000000000244c1
- (id)infoForAllAssetsWithQueue:(id)arg1;	// IMP=0x000000000002430e
- (void)removeAllAssetsWithQueue:(id)arg1;	// IMP=0x0000000000024126
- (void)removeAssetInfoForKey:(id)arg1 queue:(id)arg2;	// IMP=0x0000000000024020
- (id)assetInfoForKey:(id)arg1 queue:(id)arg2;	// IMP=0x0000000000023ac6
- (void)setAssetInfo:(id)arg1 forKey:(id)arg2 queue:(id)arg3;	// IMP=0x00000000000230c7
- (id)initWithGroupType:(long long)arg1 baseCachePath:(id)arg2 folderName:(id)arg3 maxCacheSize:(unsigned long long)arg4 purgeOnLoad:(_Bool)arg5;	// IMP=0x0000000000022d36
