...
- (void).cxx_destruct;	// IMP=0x0000000000013f5f
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000013d19
- (unsigned long long)hash;	// IMP=0x0000000000013cb7
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000013c6f
- (id)initWithRootIdentifier:(id)arg1 collisionCount:(unsigned long long)arg2;	// IMP=0x0000000000013bf1
