...
+ (id)decodedNamedLayerImageFromNamedLayerImage:(id)arg1;	// IMP=0x0010000000006661
+ (id)namedLayerImageFromNamedLayerImage:(id)arg1;	// IMP=0x00100000000065ed
...
- (id)imageObj;	// IMP=0x0000000000006a58
@property(nonatomic) _Bool fixedFrame;
@property(readonly, nonatomic) double opacity;
@property(readonly, nonatomic) struct CGRect frame;
@property(readonly, nonatomic) NSString *name;
- (id)_init;	// IMP=0x00000000000065b2
