...
- (void).cxx_destruct;	// IMP=0x0000000000006ada
...
- (void)main;	// IMP=0x000000000000675e
- (id)initWithAgent:(id)arg1 query:(id)arg2 groups:(id)arg3 substitutionVariables:(id)arg4;	// IMP=0x000000000000663f
