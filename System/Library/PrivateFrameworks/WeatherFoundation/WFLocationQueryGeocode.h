...
+ (id)queryWithSearchString:(id)arg1 resultHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000000bbd0
+ (void)invalidateCaches;	// IMP=0x001000000000bace
+ (id)queryWithSearchCompletion:(id)arg1 resultHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000000ba58
+ (id)queryWithCoordinate:(struct CLLocationCoordinate2D)arg1 resultHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000000b9cc
+ (id)queryWithDictionaryRepresentation:(id)arg1 resultHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000000b656
- (void).cxx_destruct;	// IMP=0x000000000000d3d7
...
- (void)_handleErrorResponse:(id)arg1;	// IMP=0x000000000000d0bb
- (void)handleSearchResponseWithLocation:(id)arg1;	// IMP=0x000000000000cf05
- (id)_reverseGeocoderLocation;	// IMP=0x000000000000ce83
- (id)_mkLocalSearchRequest;	// IMP=0x000000000000cd80
- (_Bool)isLocationValid:(id)arg1;	// IMP=0x000000000000cbdf
- (void)_startCLGeocoderReverseGeo;	// IMP=0x000000000000c51a
- (void)_startMKLocalSearch;	// IMP=0x000000000000bfd5
- (void)cancel;	// IMP=0x000000000000bf5c
- (void)start;	// IMP=0x000000000000be92
- (id)initWithCoordinate:(struct CLLocationCoordinate2D)arg1 resultHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000000bd82
- (id)initWithSearchString:(id)arg1 resultHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000000bc46
- (id)initWithSearchCompletion:(id)arg1 resultHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000000bad4
