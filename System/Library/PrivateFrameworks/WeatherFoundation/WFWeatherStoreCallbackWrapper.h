...
- (void).cxx_destruct;	// IMP=0x000000000002bd74
...
- (void)executeCallbackwithResponse:(id)arg1 error:(id)arg2;	// IMP=0x000000000002bb36
- (id)initWithAQIScaleRetrievalBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000002bab8
- (id)initWithForecastRetrievalBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000002ba41
