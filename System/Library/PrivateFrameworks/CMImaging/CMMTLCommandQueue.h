...
- (void).cxx_destruct;	// IMP=0x0000000000007e06
- (void)forwardInvocation:(id)arg1;	// IMP=0x0000000000007d75
- (_Bool)respondsToSelector:(SEL)arg1;	// IMP=0x0000000000007d25
- (id)forwardingTargetForSelector:(SEL)arg1;	// IMP=0x0000000000007cf0
@property(readonly) id <MTLDevice> device;
- (id)commandBuffer;	// IMP=0x0000000000007caa
- (id)commandBufferWithUnretainedReferences;	// IMP=0x0000000000007c6f
- (id)initWithCMMTLDevice:(id)arg1 descriptor:(id)arg2;	// IMP=0x0000000000007b4b
- (id)initWithCMMTLDevice:(id)arg1 maxCommandBufferCount:(unsigned long long)arg2;	// IMP=0x0000000000007a3e
- (id)initWithCMMTLDevice:(id)arg1;	// IMP=0x0000000000007937
