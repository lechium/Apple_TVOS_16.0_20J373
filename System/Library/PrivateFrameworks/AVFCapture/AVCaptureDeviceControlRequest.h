...
+ (id)deviceControlRequestWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x0060000000078076
...
- (void)dealloc;	// IMP=0x0000000000078116
- (id)_initWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000000780ad
