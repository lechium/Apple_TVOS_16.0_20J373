...
+ (id)requestWithDelegate:(id)arg1 movieRecordingSettings:(id)arg2 momentSettings:(id)arg3;	// IMP=0x006000000004078f
...
- (void)dealloc;	// IMP=0x0000000000040893
- (id)_initWithDelegate:(id)arg1 movieRecordingSettings:(id)arg2 momentSettings:(id)arg3;	// IMP=0x00000000000407da
