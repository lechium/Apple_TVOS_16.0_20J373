...
+ (id)preparedPhotoSettingsArrayRequestWithArray:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x006000000002761a
...
- (void)_setRequestID:(unsigned long long)arg1;	// IMP=0x000000000002774a
@property(readonly) unsigned long long requestID;
- (void)dealloc;	// IMP=0x00000000000276f6
- (id)_initWithArray:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000027656
