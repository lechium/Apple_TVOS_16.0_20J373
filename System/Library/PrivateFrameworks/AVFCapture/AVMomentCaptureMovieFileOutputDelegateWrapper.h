...
+ (id)wrapperWithSettings:(id)arg1 delegate:(id)arg2 connections:(id)arg3;	// IMP=0x00600000000033be
...
- (void)dealloc;	// IMP=0x0000000000003564
- (id)initWithSettings:(id)arg1 delegate:(id)arg2 connections:(id)arg3;	// IMP=0x0000000000003409
