...
- (id)uniqueVideoPreviewLayers:(id)arg1;	// IMP=0x0000000000077263
- (id)uniqueConnections:(id)arg1;	// IMP=0x00000000000771eb
- (id)uniqueOutputs:(id)arg1;	// IMP=0x0000000000077173
- (id)uniqueInputs:(id)arg1;	// IMP=0x00000000000770fb
- (void)dealloc;	// IMP=0x00000000000770a3
- (id)initWithConfigurationID:(long long)arg1 inputs:(id)arg2 outputs:(id)arg3 videoPreviewLayers:(id)arg4 connections:(id)arg5;	// IMP=0x0000000000076fff
