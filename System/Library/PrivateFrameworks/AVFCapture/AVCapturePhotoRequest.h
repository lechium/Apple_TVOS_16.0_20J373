...
+ (id)requestWithDelegate:(id)arg1 settings:(id)arg2 lensStabilizationSupported:(_Bool)arg3;	// IMP=0x0060000000036c1e
+ (void)initialize;	// IMP=0x0060000000036c0d
...
- (void)_resolveExpectedPhotoManifest;	// IMP=0x0000000000036e56
...
- (id)initWithDelegate:(id)arg1 settings:(id)arg2 lensStabilizationSupported:(_Bool)arg3;	// IMP=0x0000000000036c69
