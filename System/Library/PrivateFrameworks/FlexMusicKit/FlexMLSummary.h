...
+ (id)summaryFromSummaries:(id)arg1 targetTimeScale:(int)arg2;	// IMP=0x006000000001454d
- (void).cxx_destruct;	// IMP=0x00000000000168b5
...
- (id)initWithDictionary:(id)arg1 targetTimeScale:(int)arg2;	// IMP=0x0000000000015d5c
