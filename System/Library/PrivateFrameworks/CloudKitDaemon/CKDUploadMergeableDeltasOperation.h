...
- (void).cxx_destruct;	// IMP=0x00000000000c83aa
...
- (void)handleReplaceDeltasRequest:(id)arg1 result:(id)arg2;	// IMP=0x00000000000c7ff6
- (void)handleDeltaUploaded:(id)arg1 result:(id)arg2;	// IMP=0x00000000000c7c66
- (void)_uploadAndReplaceDeltas:(CDUnknownBlockType)arg1;	// IMP=0x00000000000c6c63
- (void)_uploadAndReplaceDeltas;	// IMP=0x00000000000c6acd
- (void)_encryptMergeableDeltas;	// IMP=0x00000000000c6739
- (void)main;	// IMP=0x00000000000c6699
- (id)nameForState:(unsigned long long)arg1;	// IMP=0x00000000000c6637
- (_Bool)makeStateTransition;	// IMP=0x00000000000c6566
- (id)activityCreate;	// IMP=0x00000000000c653d
- (int)operationType;	// IMP=0x00000000000c6532
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x00000000000c63fc
