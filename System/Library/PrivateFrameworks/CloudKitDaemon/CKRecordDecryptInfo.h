...
- (void).cxx_destruct;	// IMP=0x00000000002ce7ec
...
- (void)_setupDecryptCallbackForQueue:(id)arg1;	// IMP=0x00000000002ce48c
- (id)initWithRecord:(id)arg1 callbackQueue:(id)arg2;	// IMP=0x00000000002ce318
- (id)init;	// IMP=0x00000000002ce29c
