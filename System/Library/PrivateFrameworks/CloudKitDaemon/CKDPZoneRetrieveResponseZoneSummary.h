...
- (void).cxx_destruct;	// IMP=0x000000000010d062
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000010ccdf
- (unsigned long long)hash;	// IMP=0x000000000010cb22
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000010c822
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000010c5fb
- (void)copyTo:(id)arg1;	// IMP=0x000000000010c445
- (void)writeTo:(id)arg1;	// IMP=0x000000000010c289
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000010c27c
- (id)dictionaryRepresentation;	// IMP=0x000000000010b80e
- (id)description;	// IMP=0x000000000010b75f
