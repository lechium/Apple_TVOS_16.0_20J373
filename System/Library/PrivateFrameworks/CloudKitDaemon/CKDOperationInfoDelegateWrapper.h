...
- (void).cxx_destruct;	// IMP=0x0000000000244064
...
- (void)performWithDelegate:(CDUnknownBlockType)arg1;	// IMP=0x0000000000243f34
- (id)initWithDelegate:(id)arg1;	// IMP=0x0000000000243eb6
