...
+ (Class)conflictLosersToResolveType;	// IMP=0x0010000000123578
+ (Class)fieldsToDeleteIfExistOnMergeType;	// IMP=0x0010000000123303
+ (id)options;	// IMP=0x0010000000123194
- (void).cxx_destruct;	// IMP=0x000000000012568d
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000001250d0
- (unsigned long long)hash;	// IMP=0x0000000000124f2b
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000124c1c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000012474c
- (void)copyTo:(id)arg1;	// IMP=0x0000000000124482
- (Class)responseClass;	// IMP=0x0000000000124471
- (unsigned int)requestTypeCode;	// IMP=0x0000000000124466
- (void)writeTo:(id)arg1;	// IMP=0x00000000001240fd
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000001240f0
- (id)dictionaryRepresentation;	// IMP=0x000000000012368c
- (id)description;	// IMP=0x00000000001235dd
...
- (id)conflictLosersToResolveAtIndex:(unsigned long long)arg1;	// IMP=0x000000000012355b
- (unsigned long long)conflictLosersToResolvesCount;	// IMP=0x000000000012353e
- (void)addConflictLosersToResolve:(id)arg1;	// IMP=0x00000000001234d4
- (void)clearConflictLosersToResolves;	// IMP=0x00000000001234b7
@property(readonly, nonatomic) _Bool hasRecordProtectionInfoTag;
@property(readonly, nonatomic) _Bool hasZoneProtectionInfoTag;
- (int)StringAsSaveSemantics:(id)arg1;	// IMP=0x00000000001233f0
- (id)saveSemanticsAsString:(int)arg1;	// IMP=0x00000000001233a5
...
- (id)fieldsToDeleteIfExistOnMergeAtIndex:(unsigned long long)arg1;	// IMP=0x00000000001232e6
- (unsigned long long)fieldsToDeleteIfExistOnMergesCount;	// IMP=0x00000000001232c9
- (void)addFieldsToDeleteIfExistOnMerge:(id)arg1;	// IMP=0x000000000012325f
- (void)clearFieldsToDeleteIfExistOnMerges;	// IMP=0x0000000000123242
