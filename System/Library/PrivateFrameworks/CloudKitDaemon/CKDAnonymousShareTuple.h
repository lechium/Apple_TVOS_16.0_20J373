...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000001c5aaf
- (void).cxx_destruct;	// IMP=0x00000000001c5d84
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001c5caa
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001c5b9a
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001c5ab7
- (id)initWithZoneID:(id)arg1 shareID:(id)arg2;	// IMP=0x00000000001c5a16
