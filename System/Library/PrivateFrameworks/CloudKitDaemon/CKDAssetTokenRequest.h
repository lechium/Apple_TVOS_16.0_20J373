...
- (void).cxx_destruct;	// IMP=0x00000000000530eb
...
- (id)description;	// IMP=0x0000000000053088
- (id)CKPropertiesDescription;	// IMP=0x0000000000052edf
- (_Bool)isEmpty;	// IMP=0x0000000000052ec2
- (id)successfulBatches;	// IMP=0x0000000000052e6f
- (_Bool)hasSuccessfulBatches;	// IMP=0x0000000000052d77
- (void)addFailedBatch:(id)arg1;	// IMP=0x0000000000052d58
- (void)addAssetBatch:(id)arg1;	// IMP=0x0000000000052ca6
- (id)init;	// IMP=0x0000000000052c31
