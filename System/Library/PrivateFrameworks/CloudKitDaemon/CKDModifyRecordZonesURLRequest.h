...
- (void).cxx_destruct;	// IMP=0x00000000003340cd
...
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x0000000000333ea6
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x0000000000333be8
- (id)generateRequestOperations;	// IMP=0x00000000003332cd
- (id)requestOperationClasses;	// IMP=0x00000000003331e6
- (id)zoneIDsToLock;	// IMP=0x0000000000332f29
- (_Bool)requiresCKAnonymousUserIDs;	// IMP=0x0000000000332f21
- (id)initWithOperation:(id)arg1 recordZonesToSave:(id)arg2 recordZoneIDsToDelete:(id)arg3;	// IMP=0x0000000000332e56
