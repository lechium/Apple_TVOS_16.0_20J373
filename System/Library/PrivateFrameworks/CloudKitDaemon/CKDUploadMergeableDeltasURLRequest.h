...
- (void).cxx_destruct;	// IMP=0x000000000000ede4
...
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x000000000000e9d7
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x000000000000e6c1
- (id)generateRequestOperations;	// IMP=0x000000000000deda
- (id)anonymousUserIDForHTTPHeader;	// IMP=0x000000000000de60
- (_Bool)handlesAnonymousCKUserIDPropagation;	// IMP=0x000000000000de58
- (id)requestOperationClasses;	// IMP=0x000000000000dd68
- (id)zoneIDsToLock;	// IMP=0x000000000000dc60
- (_Bool)allowsAnonymousAccount;	// IMP=0x000000000000dc46
- (id)initWithOperation:(id)arg1 deltas:(id)arg2 replacementRequests:(id)arg3;	// IMP=0x000000000000db1d
