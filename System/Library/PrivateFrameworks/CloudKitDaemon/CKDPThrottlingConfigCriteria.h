...
- (void).cxx_destruct;	// IMP=0x0000000000320e40
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000320c27
- (unsigned long long)hash;	// IMP=0x0000000000320b06
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000003208e2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000320752
- (void)copyTo:(id)arg1;	// IMP=0x0000000000320617
- (void)writeTo:(id)arg1;	// IMP=0x00000000003204d9
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000003204cc
- (id)dictionaryRepresentation;	// IMP=0x000000000031fa2c
- (id)description;	// IMP=0x000000000031f97d
...
- (int)StringAsDatabaseType:(id)arg1;	// IMP=0x000000000031f860
- (id)databaseTypeAsString:(int)arg1;	// IMP=0x000000000031f815
@property(nonatomic) _Bool hasDatabaseType;
@property(nonatomic) int databaseType; // @synthesize databaseType=_databaseType;
- (int)StringAsOperationType:(id)arg1;	// IMP=0x000000000031f18c
- (id)operationTypeAsString:(int)arg1;	// IMP=0x000000000031ed27
@property(nonatomic) _Bool hasOperationType;
@property(nonatomic) int operationType; // @synthesize operationType=_operationType;
- (int)StringAsContainerEnvironment:(id)arg1;	// IMP=0x000000000031ec56
- (id)containerEnvironmentAsString:(int)arg1;	// IMP=0x000000000031ec00
