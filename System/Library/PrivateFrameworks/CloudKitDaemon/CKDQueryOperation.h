...
- (void).cxx_destruct;	// IMP=0x000000000006eff7
...
- (id)relevantZoneIDs;	// IMP=0x000000000006ed79
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x000000000006ed13
- (void)main;	// IMP=0x000000000006e34e
- (void)_sendQueryRequestWithCursor:(id)arg1 previousRequestSchedulerInfo:(id)arg2;	// IMP=0x000000000006d063
- (void)_handleRecordResponses:(id)arg1 perRequestSchedulerInfo:(id)arg2;	// IMP=0x000000000006c32e
- (id)_wrapError:(id)arg1 format:(id)arg2;	// IMP=0x000000000006c12b
- (void)_handleQueryRequestFinishedWithSchedulerInfo:(id)arg1;	// IMP=0x000000000006ba78
- (id)activityCreate;	// IMP=0x000000000006ba4f
@property(readonly, nonatomic) NSString *pipeliningDescription;
- (int)operationType;	// IMP=0x000000000006ba37
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x000000000006b6d6
