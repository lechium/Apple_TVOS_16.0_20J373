...
- (void).cxx_destruct;	// IMP=0x00000000001f4e93
...
- (id)description;	// IMP=0x00000000001f4da6
- (id)CKPropertiesDescription;	// IMP=0x00000000001f4a68
- (void)performCallback;	// IMP=0x00000000001f46c4
- (id)initWithAggregator:(id)arg1;	// IMP=0x00000000001f45e0
