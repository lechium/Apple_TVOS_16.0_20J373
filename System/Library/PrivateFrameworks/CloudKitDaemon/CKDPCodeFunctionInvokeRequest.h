...
+ (id)options;	// IMP=0x00100000000d080c
- (void).cxx_destruct;	// IMP=0x00000000000d156d
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000d135e
- (unsigned long long)hash;	// IMP=0x00000000000d12a0
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000d110c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000d0fc9
- (void)copyTo:(id)arg1;	// IMP=0x00000000000d0ee6
- (Class)responseClass;	// IMP=0x00000000000d0ed5
- (unsigned int)requestTypeCode;	// IMP=0x00000000000d0eca
- (void)writeTo:(id)arg1;	// IMP=0x00000000000d0df9
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000d0dec
- (id)dictionaryRepresentation;	// IMP=0x00000000000d0989
- (id)description;	// IMP=0x00000000000d08da
