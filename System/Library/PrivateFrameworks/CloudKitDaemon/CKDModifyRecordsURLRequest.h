...
- (void).cxx_destruct;	// IMP=0x000000000031977c
...
- (void)requestDidComplete;	// IMP=0x0000000000318fd7
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x0000000000318a29
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x0000000000317c2f
- (void)addSignatureForRequestOperation:(id)arg1;	// IMP=0x00000000003176d6
- (id)generateMergeableDeltaSaveOperationsForRecord:(id)arg1 error:(id *)arg2;	// IMP=0x00000000003165a4
- (id)generateRequestOperations;	// IMP=0x0000000000313f2c
- (_Bool)handlesAnonymousCKUserIDPropagation;	// IMP=0x0000000000313f24
- (int)isolationLevel;	// IMP=0x0000000000313f07
- (id)requestOperationClasses;	// IMP=0x0000000000313ded
- (id)zoneIDsToLock;	// IMP=0x0000000000313a92
- (_Bool)allowsAnonymousAccount;	// IMP=0x0000000000313a78
- (id)initWithOperation:(id)arg1 recordsToSave:(id)arg2 recordIDsToDelete:(id)arg3 recordIDsToDeleteToSigningPCSIdentity:(id)arg4 oplock:(_Bool)arg5 sendAllFields:(_Bool)arg6 clientChangeTokenData:(id)arg7 requestedFieldsByRecordId:(id)arg8;	// IMP=0x000000000031384f
