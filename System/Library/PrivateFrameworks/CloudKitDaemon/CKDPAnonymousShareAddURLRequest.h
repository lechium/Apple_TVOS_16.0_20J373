...
- (void).cxx_destruct;	// IMP=0x00000000002b994e
...
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x00000000002b979d
- (id)generateRequestOperations;	// IMP=0x00000000002b93a2
- (id)requestOperationClasses;	// IMP=0x00000000002b9336
- (id)initWithOperation:(id)arg1 encryptedAnonymousSharesToAdd:(id)arg2;	// IMP=0x00000000002b929d
- (_Bool)requiresCKAnonymousUserIDs;	// IMP=0x00000000002b9295
