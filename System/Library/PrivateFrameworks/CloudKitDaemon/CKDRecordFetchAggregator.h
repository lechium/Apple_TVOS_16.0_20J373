...
- (void).cxx_destruct;	// IMP=0x00000000001f9f07
...
- (_Bool)supportsClearAssetEncryption;	// IMP=0x00000000001f9c96
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x00000000001f9bd5
- (void)_finishRecordFetchAggregator;	// IMP=0x00000000001f97cd
- (void)finishIfAppropriate;	// IMP=0x00000000001f9643
- (void)fetchRecords:(id)arg1 withPerRecordCompletion:(CDUnknownBlockType)arg2;	// IMP=0x00000000001f933e
- (id)_fetchRecord:(id)arg1 recordReadyHandle:(_Bool *)arg2 withRecordCompletion:(CDUnknownBlockType)arg3;	// IMP=0x00000000001f870a
- (void)main;	// IMP=0x00000000001f8463
- (void)_addRecordFetchInfos:(id)arg1;	// IMP=0x00000000001f8006
- (void)_recordFetchesAvailable;	// IMP=0x00000000001f7f3c
- (void)_lockedSendFetchRequest;	// IMP=0x00000000001f632b
- (void)_flushFetchedRecordsToConsumerLocked;	// IMP=0x00000000001f62bb
- (void)_flushFetchedRecordsToConsumerNoOrderingLocked;	// IMP=0x00000000001f60f9
- (void)_flushFetchedRecordsToConsumerOrderedLocked;	// IMP=0x00000000001f5e98
- (void)_performCallbackForFetchInfoLocked:(id)arg1;	// IMP=0x00000000001f5c2b
- (int)operationType;	// IMP=0x00000000001f5c23
- (id)description;	// IMP=0x00000000001f5c11
- (id)CKPropertiesDescription;	// IMP=0x00000000001f569c
- (void)dealloc;	// IMP=0x00000000001f5641
- (id)activityCreate;	// IMP=0x00000000001f5618
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x00000000001f502c
