...
- (void).cxx_destruct;	// IMP=0x00000000000d40c1
...
- (void)requestDidComplete;	// IMP=0x00000000000d3eb2
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x00000000000d3be5
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x00000000000d331a
- (id)generateRequestOperations;	// IMP=0x00000000000d27d4
- (_Bool)requiresCKAnonymousUserIDs;	// IMP=0x00000000000d2772
- (_Bool)handlesAnonymousCKUserIDPropagation;	// IMP=0x00000000000d276a
- (id)zoneIDsToLock;	// IMP=0x00000000000d26ae
- (_Bool)requestGETPreAuth;	// IMP=0x00000000000d2641
- (_Bool)allowsAnonymousAccount;	// IMP=0x00000000000d2627
- (id)requestOperationClasses;	// IMP=0x00000000000d25bb
- (id)initWithOperation:(id)arg1 query:(id)arg2 cursor:(id)arg3 limit:(unsigned long long)arg4 requestedFields:(id)arg5 zoneID:(id)arg6;	// IMP=0x00000000000d243c
