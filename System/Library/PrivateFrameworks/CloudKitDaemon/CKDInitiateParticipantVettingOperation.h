...
- (void).cxx_destruct;	// IMP=0x000000000014ca5a
...
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x000000000014c93e
- (void)_sendRequest:(_Bool)arg1;	// IMP=0x000000000014be7a
- (int)operationType;	// IMP=0x000000000014be6f
- (void)main;	// IMP=0x000000000014bb2e
- (id)_addSelfIdentityToShareMetadataPublicPCS:(id)arg1 forShareWithURL:(id)arg2 error:(id *)arg3;	// IMP=0x000000000014b07b
- (id)_encryptedKeyDataWithShareMetadata:(id)arg1 error:(id *)arg2;	// IMP=0x000000000014ae0f
- (void)_handleVettingInitiationProgress:(id)arg1;	// IMP=0x000000000014acce
- (id)activityCreate;	// IMP=0x000000000014aca5
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x000000000014abb8
