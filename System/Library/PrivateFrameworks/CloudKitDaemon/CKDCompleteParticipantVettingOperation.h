...
- (void).cxx_destruct;	// IMP=0x00000000000ceb5d
...
- (void)main;	// IMP=0x00000000000cea06
- (void)_verifyOONParticipant;	// IMP=0x00000000000ce1d5
- (void)_reconstructShareURL;	// IMP=0x00000000000cdf89
- (void)_forceFetchShareMetadata;	// IMP=0x00000000000cd84e
- (void)_performAuthKitVerification;	// IMP=0x00000000000cd255
- (void)_reconstructShortToken;	// IMP=0x00000000000ccce9
- (id)shortSharingTokenFromData:(id)arg1;	// IMP=0x00000000000cccd4
- (id)shortSharingTokenFromFullToken:(id)arg1;	// IMP=0x00000000000ccbd8
- (id)nameForState:(unsigned long long)arg1;	// IMP=0x00000000000ccaf0
- (_Bool)makeStateTransition;	// IMP=0x00000000000cc994
- (id)activityCreate;	// IMP=0x00000000000cc96b
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x00000000000cc744
