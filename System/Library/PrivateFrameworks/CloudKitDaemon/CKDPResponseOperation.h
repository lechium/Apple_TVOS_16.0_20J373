...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000131d9d
- (unsigned long long)hash;	// IMP=0x000000000013186a
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000130e82
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001306b1
- (void)copyTo:(id)arg1;	// IMP=0x00000000001300ae
- (void)writeTo:(id)arg1;	// IMP=0x000000000012fb38
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000012eab7
- (id)dictionaryRepresentation;	// IMP=0x000000000012dc76
- (id)description;	// IMP=0x000000000012dbc7
