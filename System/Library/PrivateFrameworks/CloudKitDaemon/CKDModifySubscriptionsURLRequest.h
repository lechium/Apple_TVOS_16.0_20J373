...
- (void).cxx_destruct;	// IMP=0x000000000014e2b9
...
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x000000000014e0bd
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x000000000014df78
- (id)generateRequestOperations;	// IMP=0x000000000014d48b
- (id)requestOperationClasses;	// IMP=0x000000000014d3a4
- (_Bool)requiresCKAnonymousUserIDs;	// IMP=0x000000000014d39c
- (id)initWithOperation:(id)arg1 subscriptionsToSave:(id)arg2 subscriptionIDsToDelete:(id)arg3;	// IMP=0x000000000014d2d1
