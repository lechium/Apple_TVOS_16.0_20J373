...
- (void).cxx_destruct;	// IMP=0x00000000001d7350
...
- (void)main;	// IMP=0x00000000001d721e
- (void)_updateMissingAssetStatus;	// IMP=0x00000000001d6cdf
- (int)operationType;	// IMP=0x00000000001d6cd4
- (id)nameForState:(unsigned long long)arg1;	// IMP=0x00000000001d6c84
- (_Bool)makeStateTransition;	// IMP=0x00000000001d6bdf
- (id)activityCreate;	// IMP=0x00000000001d6bb6
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x00000000001d6a9b
