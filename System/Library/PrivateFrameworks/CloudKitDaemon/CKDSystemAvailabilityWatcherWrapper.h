...
- (void).cxx_destruct;	// IMP=0x00000000000e94fb
...
- (id)description;	// IMP=0x00000000000e93bf
- (unsigned long long)hash;	// IMP=0x00000000000e93b5
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000e9330
- (void)postSystemAvailabilityChanged:(unsigned long long)arg1;	// IMP=0x00000000000e92a6
- (id)initWithDelegate:(id)arg1;	// IMP=0x00000000000e9214
