...
- (void).cxx_destruct;	// IMP=0x000000000023d555
...
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x000000000023d281
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x000000000023c5d0
- (id)generateRequestOperations;	// IMP=0x000000000023c380
- (id)requestOperationClasses;	// IMP=0x000000000023c314
- (long long)databaseScope;	// IMP=0x000000000023c309
- (id)initWithOperation:(id)arg1 lookupInfos:(id)arg2;	// IMP=0x000000000023c270
