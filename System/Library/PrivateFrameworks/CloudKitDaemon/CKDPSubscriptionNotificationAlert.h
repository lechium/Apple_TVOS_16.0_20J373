...
+ (Class)subtitleLocalizedArgumentsType;	// IMP=0x00100000001941cb
+ (Class)titleLocalizedArgumentsType;	// IMP=0x00100000001940cf
+ (Class)localizedArgumentsType;	// IMP=0x0010000000193f7f
- (void).cxx_destruct;	// IMP=0x0000000000196035
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000001959d4
- (unsigned long long)hash;	// IMP=0x000000000019584d
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000019554d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000194f70
- (void)copyTo:(id)arg1;	// IMP=0x0000000000194c34
- (void)writeTo:(id)arg1;	// IMP=0x0000000000194821
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000194814
- (id)dictionaryRepresentation;	// IMP=0x000000000019428b
- (id)description;	// IMP=0x00000000001941dc
- (id)subtitleLocalizedArgumentsAtIndex:(unsigned long long)arg1;	// IMP=0x00000000001941ae
- (unsigned long long)subtitleLocalizedArgumentsCount;	// IMP=0x0000000000194191
- (void)addSubtitleLocalizedArguments:(id)arg1;	// IMP=0x0000000000194127
- (void)clearSubtitleLocalizedArguments;	// IMP=0x000000000019410a
@property(readonly, nonatomic) _Bool hasSubtitleLocalizedKey;
@property(readonly, nonatomic) _Bool hasSubtitle;
- (id)titleLocalizedArgumentsAtIndex:(unsigned long long)arg1;	// IMP=0x00000000001940b2
- (unsigned long long)titleLocalizedArgumentsCount;	// IMP=0x0000000000194095
- (void)addTitleLocalizedArguments:(id)arg1;	// IMP=0x000000000019402b
- (void)clearTitleLocalizedArguments;	// IMP=0x000000000019400e
...
- (id)localizedArgumentsAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000193f62
- (unsigned long long)localizedArgumentsCount;	// IMP=0x0000000000193f45
- (void)addLocalizedArguments:(id)arg1;	// IMP=0x0000000000193edb
- (void)clearLocalizedArguments;	// IMP=0x0000000000193ebe
