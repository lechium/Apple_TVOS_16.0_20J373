...
- (void)forwardInvocation:(id)arg1;	// IMP=0x00000000002199e8
- (id)methodSignatureForSelector:(SEL)arg1;	// IMP=0x00000000002198e2
- (id)initWithClientOperationCallbackProxy:(id)arg1 callbackProtocol:(id)arg2;	// IMP=0x0000000000219828
