...
- (void).cxx_destruct;	// IMP=0x00000000000fef26
...
- (unsigned long long)hash;	// IMP=0x00000000000fedf2
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000feab6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000fe94f
