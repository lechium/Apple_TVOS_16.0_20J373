...
+ (id)options;	// IMP=0x00100000000d15e2
- (void).cxx_destruct;	// IMP=0x00000000000d1f95
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000d1e84
- (unsigned long long)hash;	// IMP=0x00000000000d1e10
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000d1d10
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000d1c4f
- (void)copyTo:(id)arg1;	// IMP=0x00000000000d1bcc
- (Class)responseClass;	// IMP=0x00000000000d1bbb
- (unsigned int)requestTypeCode;	// IMP=0x00000000000d1bb0
- (void)writeTo:(id)arg1;	// IMP=0x00000000000d1b2e
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000d1b21
- (id)dictionaryRepresentation;	// IMP=0x00000000000d1750
- (id)description;	// IMP=0x00000000000d16a1
