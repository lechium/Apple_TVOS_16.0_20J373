...
- (void).cxx_destruct;	// IMP=0x00000000002593d2
...
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x0000000000258eac
- (id)generateRequestOperations;	// IMP=0x0000000000258c54
- (id)requestOperationClasses;	// IMP=0x0000000000258be8
- (id)initWithOperation:(id)arg1 serverChangeTokenData:(id)arg2;	// IMP=0x0000000000258b4f
