...
- (void).cxx_destruct;	// IMP=0x00000000003369cf
...
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x00000000003368ba
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x000000000033669b
- (id)generateRequestOperations;	// IMP=0x0000000000336228
- (id)requestOperationClasses;	// IMP=0x00000000003361bc
- (id)initWithOperation:(id)arg1 assetOrPackageMetadata:(id)arg2 writeRepairRecord:(_Bool)arg3;	// IMP=0x0000000000336132
