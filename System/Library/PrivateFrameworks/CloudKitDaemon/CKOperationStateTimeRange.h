...
- (void).cxx_destruct;	// IMP=0x0000000000311ccc
...
- (id)CKPropertiesDescription;	// IMP=0x0000000000311bd1
@property(readonly) double relativeStart;
@property(readonly) double absoluteStop;
- (long long)compareStopTime:(id)arg1;	// IMP=0x0000000000311ac0
- (long long)compareStartTime:(id)arg1;	// IMP=0x0000000000311a40
@property(readonly) double executing;
@property(readonly) double queueing;
@property(readonly) double absoluteStart;
- (id)initWithOperationState:(unsigned long long)arg1 startDate:(id)arg2 duration:(double)arg3;	// IMP=0x0000000000311941
