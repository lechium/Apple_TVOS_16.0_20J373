...
- (void).cxx_destruct;	// IMP=0x00000000002ca557
...
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x00000000002ca374
- (void)main;	// IMP=0x00000000002ca2fc
- (void)checkPCSIdentity;	// IMP=0x00000000002c9866
- (void)fetchZonesFromServer:(id)arg1;	// IMP=0x00000000002c8c19
- (void)fetchZonesFromServer;	// IMP=0x00000000002c8c05
- (int)operationType;	// IMP=0x00000000002c8bfa
- (void)_cachePCSOnRecordZone:(id)arg1;	// IMP=0x00000000002c8b21
- (void)_continueHandlingFetchedRecordZone:(id)arg1 zoneID:(id)arg2;	// IMP=0x00000000002c7e2d
- (void)_handleRecordZoneFetch:(id)arg1 zoneID:(id)arg2 responseCode:(id)arg3;	// IMP=0x00000000002c77b2
- (void)_handleAnonymousZoneDataObjects:(id)arg1 responsecode:(id)arg2;	// IMP=0x00000000002c71a6
- (void)saveZonesWithUpdatedZonePCS;	// IMP=0x00000000002c6c65
- (void)_handleRecordZoneSaved:(id)arg1 error:(id)arg2;	// IMP=0x00000000002c6956
- (_Bool)_locked_checkAndUpdateZonePCSIfNeededForZone:(id)arg1 error:(id *)arg2;	// IMP=0x00000000002c4166
- (void)_locked_callbackForRecordZone:(id)arg1 zoneID:(id)arg2 error:(id)arg3;	// IMP=0x00000000002c3eb3
- (void)_sendErrorForFailedZones;	// IMP=0x00000000002c38ec
- (id)relevantZoneIDs;	// IMP=0x00000000002c38d7
- (id)activityCreate;	// IMP=0x00000000002c38ae
- (id)nameForState:(unsigned long long)arg1;	// IMP=0x00000000002c3858
- (_Bool)makeStateTransition;	// IMP=0x00000000002c35a9
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x00000000002c3464
