...
+ (id)options;	// IMP=0x00100000001600cc
- (void).cxx_destruct;	// IMP=0x00000000001612a4
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000016102e
- (unsigned long long)hash;	// IMP=0x0000000000160f24
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000160d2d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000160bad
- (void)copyTo:(id)arg1;	// IMP=0x0000000000160a8d
- (Class)responseClass;	// IMP=0x0000000000160a7c
- (unsigned int)requestTypeCode;	// IMP=0x0000000000160a71
- (void)writeTo:(id)arg1;	// IMP=0x0000000000160951
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000160944
- (id)dictionaryRepresentation;	// IMP=0x00000000001602f9
- (id)description;	// IMP=0x000000000016024a
