...
- (void).cxx_destruct;	// IMP=0x000000000012312e
...
- (void)cancel;	// IMP=0x0000000000122fc5
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x0000000000122f5f
- (void)main;	// IMP=0x0000000000122ebc
- (void)_fetchRecords;	// IMP=0x0000000000122181
- (void)_fetchPCSForRecords;	// IMP=0x0000000000121dca
- (void)_dispatchAssetURLsForRecord:(id)arg1 recordID:(id)arg2 pcs:(struct _OpaquePCSShareProtection *)arg3 error:(id)arg4;	// IMP=0x0000000000121495
- (id)nameForState:(unsigned long long)arg1;	// IMP=0x0000000000121433
- (_Bool)makeStateTransition;	// IMP=0x0000000000121362
- (id)activityCreate;	// IMP=0x0000000000121339
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x0000000000121219
