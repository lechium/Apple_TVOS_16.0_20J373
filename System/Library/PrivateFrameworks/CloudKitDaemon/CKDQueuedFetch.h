...
- (void)start;	// IMP=0x000000000007a3a5
- (void)createFetchOperationForItemIDs:(id)arg1 operationQueue:(id)arg2 operationConfigurationBlock:(CDUnknownBlockType)arg3;	// IMP=0x000000000007a32b
- (_Bool)dependentOperationListContainsOperationID:(id)arg1;	// IMP=0x000000000007a273
- (_Bool)dependentOperationListContainsRunningFetch:(id)arg1;	// IMP=0x000000000007a102
- (_Bool)canBeUsedForPendingFetch:(id)arg1;	// IMP=0x000000000007a038
- (_Bool)canBeUsedForOperation:(id)arg1;	// IMP=0x0000000000079f87
- (id)description;	// IMP=0x0000000000079f75
- (id)CKPropertiesDescription;	// IMP=0x0000000000079e46
- (void)cancelFetchOperation;	// IMP=0x0000000000079dad
- (void)finishFetchOperationWithError:(id)arg1;	// IMP=0x00000000000798f3
- (void)performCallbacksForItemWithID:(id)arg1 withItem:(id)arg2 error:(id)arg3;	// IMP=0x00000000000794af
- (id)allItemIDs;	// IMP=0x00000000000793eb
- (id)callbacksForItemWithID:(id)arg1;	// IMP=0x00000000000792f8
- (void)removeCallbacksForItemWithID:(id)arg1;	// IMP=0x0000000000078ff9
- (void)addCallbackForItemWithID:(id)arg1 operation:(id)arg2 callback:(CDUnknownBlockType)arg3;	// IMP=0x0000000000078c32
- (int)numberOfCallbacks;	// IMP=0x0000000000078a45
@property(nonatomic) _Bool isCancelled; // @synthesize isCancelled=_isCancelled;
@property(nonatomic) _Bool isFinished; // @synthesize isFinished=_isFinished;
- (id)initWithOperation:(id)arg1 container:(id)arg2 operationQueue:(id)arg3;	// IMP=0x00000000000783ea
- (id)init;	// IMP=0x000000000007838a
