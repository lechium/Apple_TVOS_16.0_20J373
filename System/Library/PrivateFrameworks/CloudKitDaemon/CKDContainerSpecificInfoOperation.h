...
- (void).cxx_destruct;	// IMP=0x00000000002d71f1
...
- (void)main;	// IMP=0x00000000002d6d32
- (void)setCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000002d6bcc
- (_Bool)shouldCheckAppVersion;	// IMP=0x00000000002d6bc4
- (id)activityCreate;	// IMP=0x00000000002d6b9b
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x00000000002d6b38
