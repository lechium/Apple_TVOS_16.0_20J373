...
- (void).cxx_destruct;	// IMP=0x000000000031381e
...
- (void)main;	// IMP=0x00000000003137c3
- (void)_addAnonymousSharesToSharedDB;	// IMP=0x00000000003132d9
- (int)operationType;	// IMP=0x00000000003132ce
- (id)nameForState:(unsigned long long)arg1;	// IMP=0x000000000031327e
- (_Bool)makeStateTransition;	// IMP=0x00000000003131d9
- (id)activityCreate;	// IMP=0x00000000003131b0
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x00000000003130dc
