...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000308fe1
+ (id)dataWithRecord:(id)arg1;	// IMP=0x0010000000308af8
- (void).cxx_destruct;	// IMP=0x00000000003096a4
...
- (void)dealloc;	// IMP=0x00000000003094d5
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000309245
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000308fe9
- (id)CKPropertiesDescription;	// IMP=0x0000000000308e99
- (void)setPcs:(struct _OpaquePCSShareProtection *)arg1;	// IMP=0x0000000000308b8e
- (_Bool)shouldEncodePCSData;	// IMP=0x0000000000308b5b
- (id)itemID;	// IMP=0x0000000000308b49
- (id)initWithRecord:(id)arg1;	// IMP=0x00000000003087f3
- (id)initWithPCSData:(id)arg1 recordID:(id)arg2;	// IMP=0x000000000030877b
