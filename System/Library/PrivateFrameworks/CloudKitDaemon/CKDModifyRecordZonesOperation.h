...
+ (long long)isPredominatelyDownload;	// IMP=0x00600000000f49be
- (void).cxx_destruct;	// IMP=0x00000000000f50f9
...
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x00000000000f4e98
- (void)main;	// IMP=0x00000000000f4de8
- (void)_checkAndPrepareZones;	// IMP=0x00000000000f49c6
- (void)_fetchPCSDataForZonesFromServer:(_Bool)arg1;	// IMP=0x00000000000f43f4
- (void)_fetchPCSDataForZone:(id)arg1 fromServer:(_Bool)arg2;	// IMP=0x00000000000f3698
- (void)_createNewPCSForZone:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000f24bf
- (_Bool)isOperationType:(int)arg1;	// IMP=0x00000000000f248c
- (int)operationType;	// IMP=0x00000000000f2464
- (_Bool)_saveZonesToServer;	// IMP=0x00000000000f1ac7
- (void)_handleRecordZoneDeleted:(id)arg1 responseCode:(id)arg2;	// IMP=0x00000000000f163d
- (void)_handleRecordZoneSaved:(id)arg1 responseCode:(id)arg2 serverCapabilities:(unsigned long long)arg3 expirationDate:(id)arg4 expired:(_Bool)arg5;	// IMP=0x00000000000f0308
- (void)_sendErrorForFailedZones;	// IMP=0x00000000000efbe0
- (void)_sendCoreAnalyticsEventForKeySync;	// IMP=0x00000000000ef9a9
- (void)_synchronizeUserKeyRegistryIfNeeded;	// IMP=0x00000000000ef26a
- (_Bool)supportsClearAssetEncryption;	// IMP=0x00000000000ef262
- (id)relevantZoneIDs;	// IMP=0x00000000000ef183
- (id)nameForState:(unsigned long long)arg1;	// IMP=0x00000000000ef12d
- (id)activityCreate;	// IMP=0x00000000000ef104
- (_Bool)makeStateTransition;	// IMP=0x00000000000eeecc
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x00000000000eeaf8
