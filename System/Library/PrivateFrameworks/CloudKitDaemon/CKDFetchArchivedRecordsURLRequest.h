...
- (void).cxx_destruct;	// IMP=0x000000000024b041
...
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x000000000024aa2f
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x000000000024a647
- (id)_handleRecords:(id)arg1;	// IMP=0x000000000024a336
- (id)generateRequestOperations;	// IMP=0x0000000000249bee
- (id)requestOperationClasses;	// IMP=0x0000000000249b82
- (id)zoneIDsToLock;	// IMP=0x0000000000249b70
...
- (id)initWithOperation:(id)arg1 recordZoneIDs:(id)arg2 configurationsByRecordZoneID:(id)arg3;	// IMP=0x00000000002499bb
