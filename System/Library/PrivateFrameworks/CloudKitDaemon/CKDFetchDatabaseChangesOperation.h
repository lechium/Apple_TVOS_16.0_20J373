...
- (void).cxx_destruct;	// IMP=0x000000000027013c
...
- (id)analyticsPayload;	// IMP=0x000000000026fe15
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x000000000026fd7a
- (void)main;	// IMP=0x000000000026fbad
- (void)_handleAnonymousZoneDataObjects:(id)arg1 schedulerInfo:(id)arg2;	// IMP=0x000000000026efe1
- (void)_sendFetchDatabaseChangesRequestWithChangeToken:(id)arg1 previousRequestSchedulerInfo:(id)arg2;	// IMP=0x000000000026d37e
- (int)operationType;	// IMP=0x000000000026d373
- (void)_handleFetchDatabaseChangesRequestFinishedWithSchedulerInfo:(id)arg1;	// IMP=0x000000000026ce61
- (id)activityCreate;	// IMP=0x000000000026ce38
@property(readonly, nonatomic) NSString *pipeliningDescription;
- (_Bool)shouldReturnServerChangeTokensToAdopter;	// IMP=0x000000000026cca4
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x000000000026ca25
