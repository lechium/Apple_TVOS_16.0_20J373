...
- (void).cxx_destruct;	// IMP=0x00000000002a22ed
...
- (id)MMCSOptions;	// IMP=0x00000000002a1403
- (_Bool)usesBackgroundSession;	// IMP=0x00000000002a13b2
- (id)description;	// IMP=0x00000000002a13a0
- (id)CKPropertiesDescription;	// IMP=0x00000000002a0ef6
- (id)initWithOperation:(id)arg1;	// IMP=0x00000000002a0b17
