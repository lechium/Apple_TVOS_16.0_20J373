...
- (void).cxx_destruct;	// IMP=0x00000000002e28e1
...
- (id)description;	// IMP=0x00000000002e28a7
- (id)CKPropertiesDescription;	// IMP=0x00000000002e266b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002e2660
- (unsigned long long)hash;	// IMP=0x00000000002e25f8
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002e2457
- (id)initWithRecordID:(id)arg1 fileSignature:(id)arg2 referenceSignature:(id)arg3 size:(id)arg4;	// IMP=0x00000000002e2375
