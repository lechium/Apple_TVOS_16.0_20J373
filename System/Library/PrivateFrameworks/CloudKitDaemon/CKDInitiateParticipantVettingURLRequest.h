...
- (void).cxx_destruct;	// IMP=0x00000000000eab91
...
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x00000000000eaa31
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x00000000000ea814
- (id)generateRequestOperations;	// IMP=0x00000000000ea5a6
- (id)requestOperationClasses;	// IMP=0x00000000000ea53a
- (id)initWithOperation:(id)arg1 shareRecordID:(id)arg2 encryptedKey:(id)arg3 participantID:(id)arg4 baseToken:(id)arg5;	// IMP=0x00000000000ea43f
