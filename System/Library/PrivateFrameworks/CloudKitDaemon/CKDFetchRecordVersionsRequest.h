...
- (void).cxx_destruct;	// IMP=0x00000000002ee0b8
...
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x00000000002ede75
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x00000000002ed9f6
- (id)generateRequestOperations;	// IMP=0x00000000002ed44b
- (id)requestOperationClasses;	// IMP=0x00000000002ed3df
- (id)zoneIDsToLock;	// IMP=0x00000000002ed21d
- (id)initWithOperation:(id)arg1 recordIDs:(id)arg2 desiredKeys:(id)arg3 minimumVersionETag:(id)arg4;	// IMP=0x00000000002ed115
