...
- (void).cxx_destruct;	// IMP=0x000000000034958d
...
- (void)dealloc;	// IMP=0x000000000034950f
- (void)clear;	// IMP=0x0000000000349509
- (id)data;	// IMP=0x00000000003494df
- (id)initWithKey:(id)arg1 permittedRemoteMeasurement:(id)arg2 attestation:(id)arg3;	// IMP=0x0000000000348d1e
