...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000026a257
- (void).cxx_destruct;	// IMP=0x000000000026a74f
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000026a3bb
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000026a25f
