...
- (void).cxx_destruct;	// IMP=0x000000000006322c
...
- (id)CKPropertiesDescription;	// IMP=0x0000000000063184
- (id)description;	// IMP=0x0000000000063172
- (void)invokeWaitCompletedHandler:(_Bool)arg1;	// IMP=0x0000000000063065
- (id)initWithWaiter:(id)arg1 zoneIDs:(id)arg2 waitCompletedHandler:(CDUnknownBlockType)arg3 activity:(id)arg4;	// IMP=0x0000000000062f58
