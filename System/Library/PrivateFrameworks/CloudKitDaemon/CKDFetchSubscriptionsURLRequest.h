...
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x0000000000179222
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x0000000000178b85
- (id)generateRequestOperations;	// IMP=0x0000000000178779
- (id)requestOperationClasses;	// IMP=0x000000000017870d
- (id)initWithOperation:(id)arg1 subscriptionIDs:(id)arg2;	// IMP=0x0000000000178642
