...
- (void).cxx_destruct;	// IMP=0x0000000000330299
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000032ffa8
- (unsigned long long)hash;	// IMP=0x000000000032fe31
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000032fb9f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000032f9ad
- (void)copyTo:(id)arg1;	// IMP=0x000000000032f829
- (void)writeTo:(id)arg1;	// IMP=0x000000000032f6b1
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000032f6a4
- (id)dictionaryRepresentation;	// IMP=0x000000000032eee6
- (id)description;	// IMP=0x000000000032ee37
...
- (int)StringAsDatabaseType:(id)arg1;	// IMP=0x000000000032ec84
- (id)databaseTypeAsString:(int)arg1;	// IMP=0x000000000032ec3b
@property(nonatomic) _Bool hasDatabaseType;
@property(nonatomic) int databaseType; // @synthesize databaseType=_databaseType;
- (int)StringAsDatabaseEnvironment:(id)arg1;	// IMP=0x000000000032eb6f
- (id)databaseEnvironmentAsString:(int)arg1;	// IMP=0x000000000032eb1a
