...
+ (Class)replacedDeltaIdentifiersType;	// IMP=0x0000000000305806
- (void).cxx_destruct;	// IMP=0x0000000000306806
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000003064fd
- (unsigned long long)hash;	// IMP=0x000000000030643f
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000003062ab
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000306033
- (void)copyTo:(id)arg1;	// IMP=0x0000000000305ec9
- (void)writeTo:(id)arg1;	// IMP=0x0000000000305d09
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000305cfc
- (id)dictionaryRepresentation;	// IMP=0x00000000003058c6
- (id)description;	// IMP=0x0000000000305817
- (id)replacedDeltaIdentifiersAtIndex:(unsigned long long)arg1;	// IMP=0x00000000003057e9
- (unsigned long long)replacedDeltaIdentifiersCount;	// IMP=0x00000000003057cc
- (void)addReplacedDeltaIdentifiers:(id)arg1;	// IMP=0x0000000000305762
- (void)clearReplacedDeltaIdentifiers;	// IMP=0x0000000000305745
