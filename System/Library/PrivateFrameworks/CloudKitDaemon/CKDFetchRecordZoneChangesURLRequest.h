...
- (void).cxx_destruct;	// IMP=0x00000000002b91dc
...
- (void)requestDidComplete;	// IMP=0x00000000002b8f8e
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x00000000002b8a99
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x00000000002b8214
- (id)_handleRecordChanges:(id)arg1 deltaChanges:(id)arg2 forZoneID:(id)arg3;	// IMP=0x00000000002b6471
- (id)generateRequestOperations;	// IMP=0x00000000002b51c8
- (_Bool)handlesAnonymousCKUserIDPropagation;	// IMP=0x00000000002b51c0
- (_Bool)requestGETPreAuth;	// IMP=0x00000000002b5153
- (id)requestOperationClasses;	// IMP=0x00000000002b50e7
- (id)zoneIDsToLock;	// IMP=0x00000000002b50d5
- (_Bool)allowsAnonymousAccount;	// IMP=0x00000000002b50bb
...
- (id)initWithOperation:(id)arg1 recordZoneIDs:(id)arg2 configurationsByRecordZoneID:(id)arg3;	// IMP=0x00000000002b4ed5
