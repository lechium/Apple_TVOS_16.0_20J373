...
- (void).cxx_destruct;	// IMP=0x000000000014145c
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000141325
- (unsigned long long)hash;	// IMP=0x00000000001412a1
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000141175
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000014108b
- (void)copyTo:(id)arg1;	// IMP=0x0000000000140fe8
- (void)writeTo:(id)arg1;	// IMP=0x0000000000140f51
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000140f44
- (id)dictionaryRepresentation;	// IMP=0x0000000000140c8f
- (id)description;	// IMP=0x0000000000140be0
