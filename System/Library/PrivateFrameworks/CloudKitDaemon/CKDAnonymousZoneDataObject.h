...
- (void).cxx_destruct;	// IMP=0x00000000001c5a06
...
- (id)initWithEncryptedData:(id)arg1 changeType:(int)arg2 deleteType:(int)arg3;	// IMP=0x00000000001c5969
- (id)initWithEncryptedData:(id)arg1;	// IMP=0x00000000001c58fe
