...
- (void).cxx_destruct;	// IMP=0x0000000000270edb
...
- (void)didCompleteTaskWithError:(id)arg1;	// IMP=0x0000000000270958
- (void)didFillOutURLInfo:(id)arg1 error:(id)arg2;	// IMP=0x0000000000270836
- (void)didDownloadAsset:(id)arg1 error:(id)arg2;	// IMP=0x0000000000270674
- (id)initWithRecord:(id)arg1 trackProgress:(_Bool)arg2 assetsToDownload:(id)arg3 assetsToDownloadInMemory:(id)arg4 packageIndexSets:(id)arg5 assetURLInfosToFillOut:(id)arg6;	// IMP=0x00000000002701e4
