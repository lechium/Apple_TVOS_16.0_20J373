...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000156ea8
- (unsigned long long)hash;	// IMP=0x0000000000156e10
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000156cee
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000156c22
- (void)copyTo:(id)arg1;	// IMP=0x0000000000156b79
- (void)writeTo:(id)arg1;	// IMP=0x0000000000156aa9
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000156a9c
- (id)dictionaryRepresentation;	// IMP=0x000000000015645c
- (id)description;	// IMP=0x00000000001563ad
