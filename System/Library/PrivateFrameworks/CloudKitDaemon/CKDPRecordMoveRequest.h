...
+ (id)options;	// IMP=0x00100000000f5190
- (void).cxx_destruct;	// IMP=0x00000000000f63de
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000f6195
- (unsigned long long)hash;	// IMP=0x00000000000f6080
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000f5e75
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000f5cfe
- (void)copyTo:(id)arg1;	// IMP=0x00000000000f5bd7
- (void)writeTo:(id)arg1;	// IMP=0x00000000000f5ab9
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000f5aac
- (id)dictionaryRepresentation;	// IMP=0x00000000000f547a
- (id)description;	// IMP=0x00000000000f53cb
...
- (int)StringAsSemantics:(id)arg1;	// IMP=0x00000000000f529d
- (id)semanticsAsString:(int)arg1;	// IMP=0x00000000000f5247
