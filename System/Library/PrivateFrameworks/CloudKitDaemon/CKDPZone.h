...
+ (Class)protectionInfoKeysToRemoveType;	// IMP=0x00100000000f65ea
- (void).cxx_destruct;	// IMP=0x00000000000f78e4
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000f752a
- (unsigned long long)hash;	// IMP=0x00000000000f7452
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000f728a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000f6fd2
- (void)copyTo:(id)arg1;	// IMP=0x00000000000f6e45
- (void)writeTo:(id)arg1;	// IMP=0x00000000000f6c55
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000f6c48
- (id)dictionaryRepresentation;	// IMP=0x00000000000f66bf
- (id)description;	// IMP=0x00000000000f6610
@property(readonly, nonatomic) _Bool hasStorageExpiration;
- (id)protectionInfoKeysToRemoveAtIndex:(unsigned long long)arg1;	// IMP=0x00000000000f65cd
- (unsigned long long)protectionInfoKeysToRemovesCount;	// IMP=0x00000000000f65b0
- (void)addProtectionInfoKeysToRemove:(id)arg1;	// IMP=0x00000000000f6546
- (void)clearProtectionInfoKeysToRemoves;	// IMP=0x00000000000f6529
