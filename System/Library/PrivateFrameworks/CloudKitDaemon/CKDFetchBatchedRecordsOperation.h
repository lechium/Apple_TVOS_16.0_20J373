...
- (void).cxx_destruct;	// IMP=0x000000000026a1e2
...
- (_Bool)supportsClearAssetEncryption;	// IMP=0x000000000026a058
- (void)_noteOperationFinishedBlockEnd;	// IMP=0x0000000000269fde
- (void)_noteOperationEnding;	// IMP=0x0000000000269f64
- (void)_noteOperationBeginning;	// IMP=0x0000000000269eea
- (void)_noteCompletedURLRequest:(id)arg1 withSchedulerInfo:(id)arg2;	// IMP=0x0000000000269e70
- (id)_optionsForZonesWithPendingChangesAfterRequest:(id)arg1;	// IMP=0x0000000000269df3
- (id)_createAndConfigureURLRequestForZoneIDs:(id)arg1 optionsByZoneID:(id)arg2;	// IMP=0x0000000000269d76
- (void)_noteDeletedRecordWithID:(id)arg1 recordType:(id)arg2;	// IMP=0x0000000000269cfc
- (void)_noteChangedRecordWithID:(id)arg1 record:(id)arg2 error:(id)arg3;	// IMP=0x0000000000269c82
- (id)activityCreate;	// IMP=0x0000000000269c05
@property(readonly, nonatomic) NSString *pipeliningDescription;
- (int)operationType;	// IMP=0x0000000000269b80
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x0000000000269b1c
- (void)main;	// IMP=0x0000000000268f9a
- (id)_possiblyWrapError:(id)arg1 forRecordWithID:(id)arg2 withCode:(long long)arg3 format:(id)arg4;	// IMP=0x0000000000268d8b
- (void)_sendFetchChangesRequestForZoneIDs:(id)arg1 withOptions:(id)arg2 previousRequestSchedulerInfo:(id)arg3;	// IMP=0x0000000000267e57
- (void)_handleRecordDelete:(id)arg1 recordType:(id)arg2 perRequestSchedulerInfo:(id)arg3;	// IMP=0x0000000000267baa
- (void)_handleChangedRecords:(id)arg1 perRequestSchedulerInfo:(id)arg2;	// IMP=0x0000000000266fd4
- (void)_handleFetchChangesRequestFinishedWithSchedulerInfo:(id)arg1;	// IMP=0x0000000000266f59
- (id)relevantZoneIDs;	// IMP=0x0000000000266f44
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x0000000000266dd4
