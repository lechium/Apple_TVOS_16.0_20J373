...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000003081e7
- (void).cxx_destruct;	// IMP=0x0000000000308485
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000308316
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000003081ef
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000308091
- (id)description;	// IMP=0x000000000030807f
- (id)CKPropertiesDescription;	// IMP=0x0000000000307f2d
...
- (_Bool)shouldEncodePCSData;	// IMP=0x0000000000307e2a
- (void)dealloc;	// IMP=0x0000000000307de3
- (id)initWithPCSData:(id)arg1;	// IMP=0x0000000000307d70
