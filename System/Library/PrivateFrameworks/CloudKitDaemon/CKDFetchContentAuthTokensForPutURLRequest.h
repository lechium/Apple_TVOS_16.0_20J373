...
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x00000000000cbf52
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x00000000000ca597
- (id)generateRequestOperations;	// IMP=0x00000000000c922f
- (_Bool)allowsAnonymousAccount;	// IMP=0x00000000000c9215
- (id)requestOperationClasses;	// IMP=0x00000000000c91a9
- (id)initWithOperation:(id)arg1 assetTokenRequest:(id)arg2 headers:(id)arg3;	// IMP=0x00000000000c90ff
