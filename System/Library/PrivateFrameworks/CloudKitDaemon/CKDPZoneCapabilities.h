...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000266cc6
- (unsigned long long)hash;	// IMP=0x0000000000266c0d
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000266a7e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000026699d
- (void)copyTo:(id)arg1;	// IMP=0x00000000002668df
- (void)writeTo:(id)arg1;	// IMP=0x00000000002667ed
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000002667e0
- (id)dictionaryRepresentation;	// IMP=0x000000000026606f
- (id)description;	// IMP=0x0000000000265fc0
@property(nonatomic) _Bool hasHierarchicalSharing;
@property(nonatomic) _Bool hasZoneSharing;
- (int)StringAsSharingType:(id)arg1;	// IMP=0x0000000000265e8d
- (id)sharingTypeAsString:(int)arg1;	// IMP=0x0000000000265e42
