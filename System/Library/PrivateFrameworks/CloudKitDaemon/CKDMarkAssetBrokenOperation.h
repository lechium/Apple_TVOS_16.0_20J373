...
- (void).cxx_destruct;	// IMP=0x0000000000261830
...
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x0000000000261503
- (void)main;	// IMP=0x00000000002614ef
- (id)checkPreconditions;	// IMP=0x000000000026142a
- (id)assetOrPackageForFetchedRecord;	// IMP=0x0000000000261274
- (id)repairContainer;	// IMP=0x0000000000260e3a
- (void)_markAssetBroken;	// IMP=0x000000000025fa16
- (int)operationType;	// IMP=0x000000000025fa0b
- (void)_breakAsset;	// IMP=0x000000000025ec5f
- (void)_touchCreateRepairZone;	// IMP=0x000000000025e359
- (void)_touchFetchRepairZone;	// IMP=0x000000000025da2d
- (void)_fetchRecord;	// IMP=0x000000000025d22a
- (id)nameForState:(unsigned long long)arg1;	// IMP=0x000000000025d1d4
- (_Bool)makeStateTransition;	// IMP=0x000000000025cd66
- (id)activityCreate;	// IMP=0x000000000025cd3d
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x000000000025cbdc
