...
- (void).cxx_destruct;	// IMP=0x00000000003360bd
...
- (void)requestDidParseNodeFailure:(id)arg1;	// IMP=0x0000000000335dd2
- (id)requestDidParseProtobufObject:(id)arg1;	// IMP=0x000000000033497f
- (id)generateRequestOperations;	// IMP=0x000000000033431a
- (_Bool)requiresCKAnonymousUserIDs;	// IMP=0x000000000033429c
- (_Bool)handlesAnonymousCKUserIDPropagation;	// IMP=0x0000000000334294
- (id)requestOperationClasses;	// IMP=0x0000000000334228
- (id)zoneIDsToLock;	// IMP=0x0000000000334216
- (_Bool)allowsAnonymousAccount;	// IMP=0x00000000003341fc
- (id)initWithOperation:(id)arg1 recordZoneIDs:(id)arg2;	// IMP=0x0000000000334131
