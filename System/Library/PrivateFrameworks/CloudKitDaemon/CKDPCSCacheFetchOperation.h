...
- (void).cxx_destruct;	// IMP=0x0000000000280562
...
- (void)_finishOnCallbackQueueWithError:(id)arg1;	// IMP=0x000000000028026d
- (void)main;	// IMP=0x0000000000280229
- (void)_willRetryFetch;	// IMP=0x0000000000280037
- (_Bool)_savePCSDataToCache;	// IMP=0x000000000028002f
- (_Bool)_saveUpdatedPCSToServer;	// IMP=0x0000000000280027
- (_Bool)_decryptPCS;	// IMP=0x000000000028001f
- (_Bool)_fetchDependentPCS;	// IMP=0x0000000000280017
- (_Bool)_createAdditionalPCS;	// IMP=0x000000000028000f
- (_Bool)_fetchPCSDataFromServer;	// IMP=0x0000000000280007
- (_Bool)_fetchPCSDataFromDatabase;	// IMP=0x000000000027ffff
- (_Bool)needsAdditionalPCSCreation;	// IMP=0x000000000027fff7
@property(readonly, nonatomic) _Bool hasAllPCSData;
@property(readonly, nonatomic) NSString *itemTypeName;
- (id)nameForState:(unsigned long long)arg1;	// IMP=0x000000000027ff4c
- (_Bool)makeStateTransition;	// IMP=0x000000000027f49a
- (_Bool)canBeUsedForOperation:(id)arg1 withOptions:(unsigned long long)arg2;	// IMP=0x000000000027f34b
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x000000000027f24d
