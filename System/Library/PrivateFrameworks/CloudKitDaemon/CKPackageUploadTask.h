...
- (void).cxx_destruct;	// IMP=0x00000000002da151
...
- (void)cancel;	// IMP=0x00000000002da067
...
- (id)activityCreate;	// IMP=0x00000000002d9dfd
- (id)initWithPackage:(id)arg1 trackProgress:(_Bool)arg2;	// IMP=0x00000000002d9c57
