...
- (void).cxx_destruct;	// IMP=0x000000000021a010
...
- (void)forwardInvocation:(id)arg1;	// IMP=0x0000000000219e5c
- (id)methodSignatureForSelector:(SEL)arg1;	// IMP=0x0000000000219cae
- (id)initWithOperationID:(id)arg1 callbackProtocol:(id)arg2 completionSelector:(SEL)arg3 operationInfoCache:(id)arg4;	// IMP=0x0000000000219c13
