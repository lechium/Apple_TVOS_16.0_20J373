...
- (void).cxx_destruct;	// IMP=0x0000000000125f11
...
- (void)main;	// IMP=0x0000000000125eb6
- (void)_removeAnonymousShareFromSharedDB;	// IMP=0x00000000001259cc
- (int)operationType;	// IMP=0x00000000001259c1
- (id)nameForState:(unsigned long long)arg1;	// IMP=0x0000000000125971
- (_Bool)makeStateTransition;	// IMP=0x00000000001258cc
- (id)activityCreate;	// IMP=0x00000000001258a3
- (id)initWithOperationInfo:(id)arg1 container:(id)arg2;	// IMP=0x00000000001257cf
