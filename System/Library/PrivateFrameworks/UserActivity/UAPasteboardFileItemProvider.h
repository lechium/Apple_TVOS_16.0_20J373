...
+ (_Bool)conformsToProtocol:(id)arg1;	// IMP=0x001000000003f55f
- (void).cxx_destruct;	// IMP=0x000000000003fc8b
...
- (void)accessFileAtURLWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000003f7e7
- (void)getDataWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000003f62b
- (void)getDataFileWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000003f619
- (id)getFileName;	// IMP=0x000000000003f5c9
- (id)initWithURL:(id)arg1 sandboxExtension:(id)arg2;	// IMP=0x000000000003f09e
