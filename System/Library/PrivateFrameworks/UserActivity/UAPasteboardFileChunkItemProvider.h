...
- (void).cxx_destruct;	// IMP=0x000000000001e22a
...
- (void)getDataWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000001db0d
- (id)initWithType:(id)arg1 fileHandle:(id)arg2 offsetInFile:(id)arg3 size:(long long)arg4;	// IMP=0x000000000001d9fc
