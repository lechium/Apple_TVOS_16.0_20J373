...
- (id)description;	// IMP=0x000000000079cb50
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000079cb40
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000079cae0
- (void)dealloc;	// IMP=0x000000000079caa0
- (id)init;	// IMP=0x000000000079c7b0
