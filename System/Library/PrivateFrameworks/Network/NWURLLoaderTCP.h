...
- (void).cxx_destruct;	// IMP=0x0000000000017e30
@property(readonly, nonatomic) NSObject<OS_nw_connection> *underlyingConnection;
- (void)writeData:(id)arg1 complete:(_Bool)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000017cf0
@property(readonly, nonatomic) _Bool allowsWrite;
- (void)readDataOfMinimumIncompleteLength:(unsigned long long)arg1 maximumLength:(unsigned long long)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000017be0
- (void)readResponse:(CDUnknownBlockType)arg1;	// IMP=0x0000000000017bc0
- (void)updateClient:(id)arg1;	// IMP=0x0000000000017b70
- (void)stop;	// IMP=0x0000000000017b30
- (void)start;	// IMP=0x00000000000178c0
