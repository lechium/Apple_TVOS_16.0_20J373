...
- (void).cxx_destruct;	// IMP=0x0000000000540b10
@property(readonly) NSObject<OS_nw_path_flow> *internalPathFlow; // @synthesize internalPathFlow=_internalPathFlow;
- (id)privateDescription;	// IMP=0x0000000000540ac0
- (id)description;	// IMP=0x0000000000540aa0
- (id)descriptionWithIndent:(int)arg1 showFullContent:(_Bool)arg2;	// IMP=0x00000000005406b0
...
- (id)initWithPathFlow:(id)arg1;	// IMP=0x000000000053fc20
