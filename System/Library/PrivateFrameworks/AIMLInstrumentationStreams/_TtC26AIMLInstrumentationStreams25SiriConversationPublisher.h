...
+ (id)publisherWithPublisher:(id)arg1 upstreams:(id)arg2 bookmarkState:(id)arg3;	// IMP=0x006000000002dbf0
- (void).cxx_destruct;	// IMP=0x000000000002e560
- (id)init;	// IMP=0x000000000002e4e0
@property(nonatomic, readonly) NSArray *bookmarkableUpstreams;
- (void)subscribe:(id)arg1;	// IMP=0x000000000002daa0
