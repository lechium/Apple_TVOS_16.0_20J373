...
- (void).cxx_destruct;	// IMP=0x00000000000191a0
- (id)init;	// IMP=0x0000000000019150
- (void)cancel;	// IMP=0x0000000000018210
- (void)receiveCompletion:(id)arg1;	// IMP=0x00000000000181a0
- (long long)receiveInput:(id)arg1;	// IMP=0x00000000000180c0
- (void)receiveSubscription:(id)arg1;	// IMP=0x00000000000180a0
