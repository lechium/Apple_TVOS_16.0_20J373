...
- (void).cxx_destruct;	// IMP=0x0000000000005b7c
...
- (void)invalidate;	// IMP=0x0000000000005b04
- (id)initWithIdleHandler:(CDUnknownBlockType)arg1 onResume:(CDUnknownBlockType)arg2;	// IMP=0x0000000000005a66
