...
- (void).cxx_destruct;	// IMP=0x0000000000019c91
...
- (void)reflectNextFireDelay:(double)arg1 fireInterval:(double)arg2;	// IMP=0x0000000000019b89
- (void)dealloc;	// IMP=0x0000000000019b38
- (id)initWithDispatchSilo:(id)arg1;	// IMP=0x00000000000198b8
