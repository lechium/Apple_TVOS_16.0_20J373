...
- (void).cxx_destruct;	// IMP=0x00000000000095bf
...
- (void)reflectNextFireDelay:(double)arg1 fireInterval:(double)arg2;	// IMP=0x000000000000946b
- (void)dealloc;	// IMP=0x0000000000009429
- (id)initWithRunLoopSilo:(id)arg1;	// IMP=0x0000000000009204
