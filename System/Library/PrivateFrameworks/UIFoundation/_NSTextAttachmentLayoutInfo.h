...
- (void)invalidateAttachmentMeasurements;	// IMP=0x0000000000108cd5
- (void)_invalidateLocations;	// IMP=0x0000000000108cb3
...
- (id)textLayoutFragment;	// IMP=0x0000000000108a98
@property(readonly) id <NSTextLocation> location; // @dynamic location;
- (void)_queryLayoutWithHorizontalOffset:(double)arg1;	// IMP=0x0000000000108934
- (void)_queryLayout;	// IMP=0x0000000000108683
- (void)dealloc;	// IMP=0x0000000000108624
- (id)initWithContext:(id)arg1 location:(id)arg2 attributes:(id)arg3;	// IMP=0x0000000000108527
