...
- (void)invalidateElementsInRange:(id)arg1 delta:(long long)arg2;	// IMP=0x00000000000bcc6e
- (void)setObject:(id)arg1 forRange:(id)arg2;	// IMP=0x00000000000bc571
- (id)enumerateObjectsFromLocation:(id)arg1 options:(long long)arg2 usingBlock:(CDUnknownBlockType)arg3;	// IMP=0x00000000000bbcd7
@property(readonly) long long baseIndex;
@property(readonly) id <NSTextLocation> baseLocation;
- (id)description;	// IMP=0x00000000000bb6ec
- (void)dealloc;	// IMP=0x00000000000bb691
- (id)initWithDataSource:(id)arg1;	// IMP=0x00000000000bb590
