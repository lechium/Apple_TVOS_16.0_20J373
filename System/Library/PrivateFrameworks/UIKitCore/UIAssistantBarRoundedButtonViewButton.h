...
- (void).cxx_destruct;	// IMP=0x0000000000ab4a7d
...
- (void)_updateBackgroundAndTitleColor;	// IMP=0x0000000000ab485f
- (id)_titleColorForState:(unsigned long long)arg1;	// IMP=0x0000000000ab484d
- (id)_currentTitleColor;	// IMP=0x0000000000ab4801
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x0000000000ab47c0
