...
+ (id)info;	// IMP=0x00600000009efd34
...
- (void)populateEndInfoWithFrame:(struct CGRect)arg1;	// IMP=0x00000000009f0731
- (void)populateStartInfoWithFrame:(struct CGRect)arg1;	// IMP=0x00000000009f06b1
- (void)populateWithAnimationStyle:(id)arg1;	// IMP=0x00000000009f0630
- (_Bool)containsChange;	// IMP=0x00000000009f05af
- (void)logGeometry;	// IMP=0x00000000009f05a9
@property(readonly, nonatomic) NSDictionary *privateUserInfo;
- (id)rotationUserInfo;	// IMP=0x00000000009f0270
@property(readonly, nonatomic) NSDictionary *userInfo;
- (id)inverseInfo;	// IMP=0x00000000009efe5f
- (id)init;	// IMP=0x00000000009efd4d
