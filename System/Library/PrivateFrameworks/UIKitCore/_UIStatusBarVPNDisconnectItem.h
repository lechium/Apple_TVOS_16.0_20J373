...
- (void).cxx_destruct;	// IMP=0x0000000000da909b
...
- (id)applyUpdate:(id)arg1 toDisplayItem:(id)arg2;	// IMP=0x0000000000da8f2b
- (id)viewForIdentifier:(id)arg1;	// IMP=0x0000000000da8f19
- (void)_create_disconnectView;	// IMP=0x0000000000da8ebf
- (_Bool)canEnableDisplayItem:(id)arg1 fromData:(id)arg2;	// IMP=0x0000000000da8e2e
- (id)dependentEntryKeys;	// IMP=0x0000000000da8e0b
