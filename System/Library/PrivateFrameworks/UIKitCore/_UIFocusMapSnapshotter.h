...
- (void).cxx_destruct;	// IMP=0x00000000006350d8
...
- (id)captureSnapshot;	// IMP=0x0000000000634ec5
- (id)_searchAreaForContainerSearchRect:(struct CGRect)arg1;	// IMP=0x0000000000634616
- (id)initWithFocusSystem:(id)arg1 rootContainer:(id)arg2 coordinateSpace:(id)arg3 searchInfo:(id)arg4 ignoresRootContainerClippingRect:(_Bool)arg5;	// IMP=0x000000000063430b
- (id)init;	// IMP=0x0000000000634284
