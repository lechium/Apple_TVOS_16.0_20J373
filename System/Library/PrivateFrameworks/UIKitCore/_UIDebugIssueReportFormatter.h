...
- (void).cxx_destruct;	// IMP=0x00000000005fe664
...
- (id)stringFromReport:(id)arg1;	// IMP=0x00000000005fe58e
- (id)_componentsFromReport:(id)arg1;	// IMP=0x00000000005fe070
- (id)init;	// IMP=0x00000000005fdfb0
