...
- (void).cxx_destruct;	// IMP=0x0000000000860365
...
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x000000000085f5dc
- (void)layoutSubviews;	// IMP=0x000000000085f44e
- (void)setFrame:(struct CGRect)arg1;	// IMP=0x000000000085f357
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000085f09b
