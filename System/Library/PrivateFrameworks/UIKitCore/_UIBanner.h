...
- (void).cxx_destruct;	// IMP=0x0000000000cfb916
...
- (void)addTapHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000cfb7a2
- (void)addDismissalCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000cfb726
- (void)addDismissalAnimations:(CDUnknownBlockType)arg1;	// IMP=0x0000000000cfb6aa
- (void)dismiss;	// IMP=0x0000000000cfb4bc
- (void)handleLongPressGesture:(id)arg1;	// IMP=0x0000000000cfb235
- (void)present;	// IMP=0x0000000000cfb09a
