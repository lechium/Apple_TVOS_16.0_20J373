...
+ (id)registrationWithImage:(id)arg1 configuration:(id)arg2;	// IMP=0x00600000007a6e4f
- (void).cxx_destruct;	// IMP=0x00000000007a716f
@property(retain, nonatomic) UIImageConfiguration *configuration; // @synthesize configuration=_configuration;
@property(retain, nonatomic) UIImage *image; // @synthesize image=_image;
- (_Bool)matchesConfiguration:(id)arg1;	// IMP=0x00000000007a6fb8
