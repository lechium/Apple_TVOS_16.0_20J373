...
- (void).cxx_destruct;	// IMP=0x00000000005f5b3c
...
- (void)_reportInferredPreferredFocusEnvironment:(id)arg1;	// IMP=0x00000000005f5962
- (void)_stopLogging;	// IMP=0x00000000005f5948
- (id)_startLogging;	// IMP=0x00000000005f5652
- (void)popEnvironment;	// IMP=0x00000000005f5537
- (void)pushEnvironment:(id)arg1;	// IMP=0x00000000005f52dc
- (_Bool)_isAllowedToPreferEnvironment:(id)arg1;	// IMP=0x00000000005f52ae
- (id)_inferPreferencesForEnvironment:(id)arg1;	// IMP=0x00000000005f5111
- (void)_resolvePreferredFocusEnvironments;	// IMP=0x00000000005f4b25
- (void)_invalidatePreferredEnvironments;	// IMP=0x00000000005f4afb
...
- (id)initWithFocusEnvironment:(id)arg1 enumerationMode:(long long)arg2;	// IMP=0x00000000005f449b
- (id)init;	// IMP=0x00000000005f4414
