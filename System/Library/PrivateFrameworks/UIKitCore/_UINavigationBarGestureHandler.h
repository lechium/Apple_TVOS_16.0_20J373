...
- (void).cxx_destruct;	// IMP=0x000000000015255f
...
- (void)_handlePopSwipe:(id)arg1;	// IMP=0x00000000001523ee
- (_Bool)_gestureRecognizerShouldBegin:(id)arg1;	// IMP=0x0000000000152340
- (id)initWithNavigationBar:(id)arg1;	// IMP=0x000000000015227e
