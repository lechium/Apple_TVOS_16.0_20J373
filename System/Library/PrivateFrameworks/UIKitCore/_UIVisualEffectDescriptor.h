...
+ (id)newTransitionDescriptorForStops:(id)arg1;	// IMP=0x00600000000e407e
- (void).cxx_destruct;	// IMP=0x00000000000e474f
...
- (id)description;	// IMP=0x00000000000e43a0
- (void)uniqueFilterNames;	// IMP=0x00000000000e41b3
- (id)copyForTransitionToDescriptor:(id)arg1;	// IMP=0x00000000000e3b8b
- (void)addOverlay:(id)arg1;	// IMP=0x00000000000e3b75
- (void)addUnderlay:(id)arg1;	// IMP=0x00000000000e3b32
@property(retain, nonatomic) UIView<_UIVisualEffectViewParticipating> *containerView;
- (void)addViewEffect:(id)arg1;	// IMP=0x00000000000e3a9b
- (void)addFilterEntry:(id)arg1;	// IMP=0x00000000000e3a58
- (id)init;	// IMP=0x00000000000e3988
