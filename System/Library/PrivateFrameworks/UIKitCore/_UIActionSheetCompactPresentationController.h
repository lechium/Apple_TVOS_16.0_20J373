...
- (void).cxx_destruct;	// IMP=0x000000000038e02a
...
- (double)_resizeAnimationDuration;	// IMP=0x000000000038de68
- (struct CGSize)_minimumSizeForDismissButton;	// IMP=0x000000000038ddd8
- (_Bool)_shouldDisableAvoidsKeyboard;	// IMP=0x000000000038dcde
- (CDStruct_758ece87)_currentLayoutGeometry;	// IMP=0x000000000038daf8
- (void)_handleDismiss:(id)arg1;	// IMP=0x000000000038d9d7
- (void)_dismiss;	// IMP=0x000000000038d8f0
@property(nonatomic) _Bool dismissActionUsesShorterHeightWhenCompactVertically;
- (void)endPseudoAlertPresentationMode;	// IMP=0x000000000038d757
- (void)beginPseudoAlertPresentationMode;	// IMP=0x000000000038d632
@property(copy, nonatomic) NSString *dismissActionTitle;
- (void)_updateForKeyboardStartFrame:(struct CGRect)arg1 endFrame:(struct CGRect)arg2 duration:(double)arg3 curve:(long long)arg4;	// IMP=0x000000000038d313
- (void)_keyboardChanged:(id)arg1;	// IMP=0x000000000038d0fb
- (void)_unsubscribeFromKeyboardNotifications;	// IMP=0x000000000038d02d
- (void)_subscribeToKeyboardNotifications;	// IMP=0x000000000038cf58
- (void)preferredContentSizeDidChangeForChildContentContainer:(id)arg1;	// IMP=0x000000000038cb0c
- (void)dismissalTransitionWillBegin;	// IMP=0x000000000038ca19
- (void)_willRunTransitionForCurrentStateDeferred:(_Bool)arg1;	// IMP=0x000000000038c9c4
- (void)presentationTransitionWillBegin;	// IMP=0x000000000038c6b8
- (struct CGSize)preferredContentSize;	// IMP=0x000000000038c67f
- (void)_applyVisualAffordancesToViews;	// IMP=0x000000000038c5d7
- (void)_layoutViews;	// IMP=0x000000000038c3cd
- (struct CGRect)_frameOfPresentedViewControllerViewInSuperview;	// IMP=0x000000000038c3ae
- (struct CGRect)frameOfPresentedViewInContainerView;	// IMP=0x000000000038c235
- (void)_transitionToPresentationController:(id)arg1 withTransitionCoordinator:(id)arg2;	// IMP=0x000000000038c1f1
- (void)viewWillTransitionToSize:(struct CGSize)arg1 withTransitionCoordinator:(id)arg2;	// IMP=0x000000000038c0d3
- (struct UIEdgeInsets)_baseContentInsetsWithLeftMargin:(double *)arg1 rightMargin:(double *)arg2;	// IMP=0x000000000038beef
- (_Bool)_shouldOccludeDuringPresentation;	// IMP=0x000000000038bee7
- (_Bool)_shouldPresentedViewControllerControlStatusBarAppearance;	// IMP=0x000000000038bedf
- (_Bool)shouldPresentInFullscreen;	// IMP=0x000000000038be8d
- (void)dealloc;	// IMP=0x000000000038be18
- (id)initWithPresentedViewController:(id)arg1 presentingViewController:(id)arg2 visualStyle:(id)arg3;	// IMP=0x000000000038bb94
