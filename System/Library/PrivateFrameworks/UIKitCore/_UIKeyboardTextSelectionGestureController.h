...
+ (id)sharedInstance;	// IMP=0x0060000000b14dc5
- (void).cxx_destruct;	// IMP=0x0000000000b15ad4
...
- (void)configureOneFingerForcePressRecognizer:(id)arg1;	// IMP=0x0000000000b15835
- (void)configureTwoFingerTapGestureRecognizer:(id)arg1;	// IMP=0x0000000000b157da
- (void)configureTwoFingerPanGestureRecognizer:(id)arg1;	// IMP=0x0000000000b1577f
- (id)addLongPressTextSelectionInteractionsToView:(id)arg1;	// IMP=0x0000000000b15777
- (id)addTwoFingerTextSelectionInteractionsToView:(id)arg1;	// IMP=0x0000000000b1570b
- (id)addOneFingerTextSelectionInteractionsToView:(id)arg1;	// IMP=0x0000000000b1566c
- (_Bool)_longPressAllowedForView:(id)arg1;	// IMP=0x0000000000b15650
- (_Bool)allowOneFingerDeepPress;	// IMP=0x0000000000b15648
- (double)oneFingerForcePressAllowableMovement;	// IMP=0x0000000000b1563a
- (_Bool)oneFingerForcePressShouldCancelTouchesInView;	// IMP=0x0000000000b15632
- (_Bool)oneFingerForcePressShouldFailWithoutForce;	// IMP=0x0000000000b1562a
- (double)oneFingerForcePressMinimumDuration;	// IMP=0x0000000000b1561c
- (void)redisableEnclosingScrollViewNestedPinching;	// IMP=0x0000000000b154db
- (void)enableEnclosingScrollViewNestedPinching;	// IMP=0x0000000000b15387
- (void)didRemoveSelectionController;	// IMP=0x0000000000b15381
- (void)willRemoveSelectionController;	// IMP=0x0000000000b152d8
- (void)_cleanupDeadGesturesIfNecessary;	// IMP=0x0000000000b151c2
- (id)selectionController;	// IMP=0x0000000000b15172
- (void)dealloc;	// IMP=0x0000000000b14fc6
- (void)removeDeallocationHandler:(id)arg1;	// IMP=0x0000000000b14fa9
- (id)addDeallocationHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000b14eeb
- (id)init;	// IMP=0x0000000000b14e76
- (_Bool)shouldAddForceGesture;	// IMP=0x0000000000b14e2b
- (Class)textInteractionClass;	// IMP=0x0000000000b14e1a
