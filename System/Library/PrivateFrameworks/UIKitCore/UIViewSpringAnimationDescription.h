...
+ (id)descriptionWithTension:(double)arg1 friction:(double)arg2;	// IMP=0x00600000010ab336
+ (id)descriptionWithSpringAnimationParameters:(CDStruct_6c8af1d9)arg1;	// IMP=0x00600000010ab2ba
