...
+ (id)requestWithRootView:(id)arg1 focusSystem:(id)arg2;	// IMP=0x001000000061dd58
- (void).cxx_destruct;	// IMP=0x000000000061eb25
...
- (id)takeSnapshot;	// IMP=0x000000000061dfb4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000061de91
- (id)initWithRootView:(id)arg1 focusSystem:(id)arg2;	// IMP=0x000000000061ddc4
