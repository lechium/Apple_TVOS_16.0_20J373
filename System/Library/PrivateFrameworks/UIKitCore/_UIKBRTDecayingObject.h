...
- (void).cxx_destruct;	// IMP=0x0000000000af757a
...
- (void)onResetDo:(CDUnknownBlockType)arg1;	// IMP=0x0000000000af7475
- (void)resetActiveDecayTo:(double)arg1;	// IMP=0x0000000000af7455
- (void)startOrUpdateDecay;	// IMP=0x0000000000af7429
- (void)updateDecay;	// IMP=0x0000000000af73e4
- (void)reset;	// IMP=0x0000000000af73ae
- (void)resetDecayTo:(double)arg1;	// IMP=0x0000000000af7357
@property(readonly, nonatomic) _Bool isActive;
- (void)startDecaying;	// IMP=0x0000000000af7314
- (id)initWithTimeoutDuration:(double)arg1;	// IMP=0x0000000000af72d1
