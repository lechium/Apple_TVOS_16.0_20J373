...
- (void).cxx_destruct;	// IMP=0x00000000000afb18
- (id)descriptionBuilderWithMultilinePrefix:(id)arg1;	// IMP=0x00000000000af7c8
- (id)debugDescriptionWithMultilinePrefix:(id)arg1;	// IMP=0x00000000000af778
- (id)descriptionWithMultilinePrefix:(id)arg1;	// IMP=0x00000000000af728
- (id)succinctDescriptionBuilder;	// IMP=0x00000000000af5ed
- (id)succinctDescription;	// IMP=0x00000000000af59d
@property(readonly, copy) NSString *debugDescription;
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x00000000000af48a
- (id)init;	// IMP=0x00000000000af310
