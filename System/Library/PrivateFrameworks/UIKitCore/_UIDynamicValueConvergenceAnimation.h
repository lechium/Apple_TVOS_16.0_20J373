...
- (void).cxx_destruct;	// IMP=0x00000000000a3985
...
- (_Bool)_animateForInterval:(double)arg1;	// IMP=0x00000000000a367b
- (void)runWithValueApplier:(CDUnknownBlockType)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000000a3609
- (id)initWithValue:(double)arg1 targetValue:(double)arg2 convergenceRate:(double)arg3 minimumDifference:(double)arg4;	// IMP=0x00000000000a357d
