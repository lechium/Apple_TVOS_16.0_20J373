...
+ (id)settingsControllerModule;	// IMP=0x0010000000f91d80
...
- (void)setDefaultValues;	// IMP=0x0000000000f91cf3
- (void)settings:(id)arg1 changedValueForKey:(id)arg2;	// IMP=0x0000000000f91a6d
- (id)initWithDefaultValues;	// IMP=0x0000000000f91a1e
