...
- (void).cxx_destruct;	// IMP=0x0000000000e141c6
...
- (_Bool)handledUpdateOfActionable:(id)arg1 highlighted:(_Bool)arg2 initialPress:(_Bool)arg3;	// IMP=0x0000000000e14095
- (void)updateRegion:(id)arg1 highlighted:(_Bool)arg2 initialPress:(_Bool)arg3 cornerRadius:(double)arg4;	// IMP=0x0000000000e13eae
- (id)animationForBackgroundActivityPillWithDuration:(double)arg1 scale:(double)arg2;	// IMP=0x0000000000e13c78
- (id)animationForBackgroundActivityPill;	// IMP=0x0000000000e13c5b
- (id)animationForBackgroundActivityIcon;	// IMP=0x0000000000e13ad9
- (void)_hideActivityDetailAndUpdate:(_Bool)arg1;	// IMP=0x0000000000e139f8
- (void)updatePill;	// IMP=0x0000000000e139dc
- (void)_updateBackgroundActivityWithEntry:(id)arg1 timeEntry:(id)arg2 needsUpdate:(_Bool)arg3;	// IMP=0x0000000000e135c8
- (void)updateDataForBackgroundActivity:(id)arg1;	// IMP=0x0000000000e1320e
