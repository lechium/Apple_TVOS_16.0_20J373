...
- (void).cxx_destruct;	// IMP=0x0000000000bc7ff4
...
- (void)_advanceFromDisplayLink:(id)arg1;	// IMP=0x0000000000bc7e43
- (void)stopAnimation;	// IMP=0x0000000000bc7dda
- (id)initWithDuration:(double)arg1 advanceBlock:(CDUnknownBlockType)arg2;	// IMP=0x0000000000bc7c61
- (id)init;	// IMP=0x0000000000bc7c53
