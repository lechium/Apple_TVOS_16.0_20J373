...
+ (id)beginLoupeSessionAtPoint:(struct CGPoint)arg1 withCaretRect:(struct CGRect)arg2 fromView:(id)arg3;	// IMP=0x0060000000d2ecc4
- (void).cxx_destruct;	// IMP=0x0000000000d2f8f3
...
- (void)dealloc;	// IMP=0x0000000000d2f81e
- (void)didMoveToPoint:(struct CGPoint)arg1 withCaretRect:(struct CGRect)arg2 tracksCaret:(_Bool)arg3;	// IMP=0x0000000000d2f519
- (struct CGPoint)_locationInContainerCoordinateSpace:(struct CGPoint)arg1;	// IMP=0x0000000000d2f459
