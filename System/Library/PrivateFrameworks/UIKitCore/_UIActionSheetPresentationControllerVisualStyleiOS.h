...
- (void).cxx_destruct;	// IMP=0x000000000038ee18
...
- (struct UIEdgeInsets)contentInsetsForContainerView:(id)arg1;	// IMP=0x000000000038ed8a
- (id)init;	// IMP=0x000000000038ed08
