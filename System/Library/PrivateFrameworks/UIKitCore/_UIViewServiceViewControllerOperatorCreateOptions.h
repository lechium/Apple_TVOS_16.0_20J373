...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000104c05b
- (void).cxx_destruct;	// IMP=0x000000000104c139
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000104bc61
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000104b979
