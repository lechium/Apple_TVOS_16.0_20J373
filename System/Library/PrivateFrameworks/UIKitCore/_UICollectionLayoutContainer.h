...
- (void).cxx_destruct;	// IMP=0x000000000026d29a
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000026d15f
...
- (id)initWithContentSize:(struct CGSize)arg1 contentInsets:(struct NSDirectionalEdgeInsets)arg2 insetsEnvironment:(id)arg3;	// IMP=0x000000000026cf47
- (id)initWithContentSize:(struct CGSize)arg1 contentInsets:(struct NSDirectionalEdgeInsets)arg2;	// IMP=0x000000000026ceb0
