...
- (void).cxx_destruct;	// IMP=0x0000000000f71422
...
- (_Bool)endEditing;	// IMP=0x0000000000f71170
- (id)initWithTextStorage:(id)arg1 attributeNames:(id)arg2;	// IMP=0x0000000000f710cc
