...
- (void).cxx_destruct;	// IMP=0x0000000000aa1c33
...
- (void)resetTimer;	// IMP=0x0000000000aa199b
- (void)invalidate;	// IMP=0x0000000000aa18db
- (_Bool)isValid;	// IMP=0x0000000000aa1827
- (void)handleDeferredTimerFiredEvent;	// IMP=0x0000000000aa15ab
- (void)timerFired:(id)arg1;	// IMP=0x0000000000aa14db
@property(readonly, nonatomic) _Bool repeats;
- (id)initWithTaskQueue:(id)arg1 timeInterval:(double)arg2 repeats:(_Bool)arg3 task:(CDUnknownBlockType)arg4;	// IMP=0x0000000000aa1375
- (void)dealloc;	// IMP=0x0000000000aa131a
