...
+ (id)attributesForFocusRegionContentInContainer:(id)arg1 coordinateSpace:(id)arg2;	// IMP=0x0010000000617bf3
- (void).cxx_destruct;	// IMP=0x0000000000617e97
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000617e23
