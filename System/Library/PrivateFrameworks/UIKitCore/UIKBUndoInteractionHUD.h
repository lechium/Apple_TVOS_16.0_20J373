...
- (void).cxx_destruct;	// IMP=0x0000000000b7b712
...
- (void)updateControlWithDirection:(long long)arg1 travelProgress:(double)arg2 isRTL:(_Bool)arg3;	// IMP=0x0000000000b7b45a
- (void)controlActionUpOutside:(id)arg1;	// IMP=0x0000000000b7b3f7
- (void)controlActionUpInside:(id)arg1 forEvent:(id)arg2;	// IMP=0x0000000000b7b1e5
- (void)controlActionDown:(id)arg1;	// IMP=0x0000000000b7b147
- (void)performDelegateRedoAndUpdateHUDIfNeeded;	// IMP=0x0000000000b7b0cc
- (void)performDelegateUndoAndUpdateHUDIfNeeded;	// IMP=0x0000000000b7b051
- (void)updateHUDControlState;	// IMP=0x0000000000b7ad45
- (void)willMoveToWindow:(id)arg1;	// IMP=0x0000000000b7acd1
- (_Bool)availableOfControl:(id)arg1;	// IMP=0x0000000000b7abd4
- (id)controlForType:(long long)arg1;	// IMP=0x0000000000b7aa51
- (_Bool)pointInside:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x0000000000b7a9de
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000000b7a9d8
- (id)createSeparatorView;	// IMP=0x0000000000b7a89d
- (id)initWithKeyboardAppearance:(long long)arg1 isRTL:(_Bool)arg2 mode:(long long)arg3 sceneBounds:(struct CGRect)arg4;	// IMP=0x0000000000b77eab
