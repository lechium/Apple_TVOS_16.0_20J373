...
- (void).cxx_destruct;	// IMP=0x00000000009ef880
...
- (void)layoutSubviews;	// IMP=0x00000000009ef2a6
- (id)hitTest:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x00000000009ef271
- (id)fontUsingSilhouette:(unsigned long long)arg1 size:(double)arg2;	// IMP=0x00000000009ee6f8
- (void)setStringRepresentation:(id)arg1 silhouette:(unsigned long long)arg2;	// IMP=0x00000000009ee5c8
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000009ee0e3
