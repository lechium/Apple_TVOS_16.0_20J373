...
+ (id)configuration;	// IMP=0x0060000000815956
...
- (_Bool)usesReducedFontSize;	// IMP=0x0000000000815e05
- (double)candidateDefaultFontSize;	// IMP=0x0000000000815df7
- (id)candidateFontWithSize:(double)arg1 language:(id)arg2;	// IMP=0x0000000000815c9a
- (id)candidateFontWithSize:(double)arg1;	// IMP=0x0000000000815bdd
...
- (id)extendedScrolledState;	// IMP=0x0000000000815bb2
- (id)extendedState;	// IMP=0x0000000000815baa
- (id)initialState;	// IMP=0x0000000000815968
