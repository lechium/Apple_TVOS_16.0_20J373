...
+ (id)_proxyWithResponder:(id)arg1;	// IMP=0x0060000000efaa39
- (void).cxx_destruct;	// IMP=0x0000000000efab66
...
- (_Bool)canPerformAction:(SEL)arg1 withSender:(id)arg2;	// IMP=0x0000000000efaaa3
- (id)nextResponder;	// IMP=0x0000000000efaa8a
