...
+ (id)settingsControllerModule;	// IMP=0x0060000000734da1
+ (id)keyPathsForValuesAffectingCornerAngleWindowDegreees;	// IMP=0x0060000000734d81
...
- (void)setDefaultValues;	// IMP=0x0000000000734cde
