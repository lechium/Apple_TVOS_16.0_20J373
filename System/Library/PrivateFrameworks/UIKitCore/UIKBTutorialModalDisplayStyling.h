...
- (void).cxx_destruct;	// IMP=0x00000000006d97c0
...
- (id)backgroundBlurEffects:(long long)arg1;	// IMP=0x00000000006d96bd
- (id)initWithKeyboardAppearance:(long long)arg1;	// IMP=0x00000000006d95c3
