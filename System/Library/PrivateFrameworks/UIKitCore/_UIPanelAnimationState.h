...
+ (double)defaultDuration;	// IMP=0x006000000045d9d7
+ (id)timingCurveProviderWithVelocity:(double)arg1;	// IMP=0x006000000045d999
+ (id)timingCurveProvider;	// IMP=0x006000000045d980
- (void).cxx_destruct;	// IMP=0x000000000045dad4
...
- (id)description;	// IMP=0x000000000045d8e6
