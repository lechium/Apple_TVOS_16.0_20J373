...
- (void).cxx_destruct;	// IMP=0x0000000000b2809e
...
- (_Bool)canDisplayTransitionFromKeyplane:(id)arg1 toKeyplane:(id)arg2;	// IMP=0x0000000000b27ff2
- (void)finishWithProgress:(double)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x0000000000b27e87
- (void)transitionToFinalState:(id)arg1;	// IMP=0x0000000000b27df5
- (void)finalizeTransition;	// IMP=0x0000000000b27d0b
- (void)removeAllAnimations;	// IMP=0x0000000000b27a9f
- (void)updateWithProgress:(double)arg1;	// IMP=0x0000000000b2775a
- (void)cancelNonInteractiveAnimation;	// IMP=0x0000000000b27704
- (void)runNonInteractivelyWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000b276f2
@property(readonly, nonatomic) double nonInteractiveDuration;
- (void)commitTransitionRebuild;	// IMP=0x0000000000b276e3
- (void)addTransitionView:(id)arg1 startFrame:(struct CGRect)arg2 endFrame:(struct CGRect)arg3;	// IMP=0x0000000000b273a3
- (void)rebuildWithStartKeyplane:(id)arg1 startView:(id)arg2 endKeyplane:(id)arg3 endView:(id)arg4;	// IMP=0x0000000000b2729a
@property(readonly, nonatomic) double endHeight;
@property(readonly, nonatomic) double startHeight;
- (void)dealloc;	// IMP=0x0000000000b271ad
