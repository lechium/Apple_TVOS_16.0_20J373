...
+ (id)graphCacheForScreen:(id)arg1;	// IMP=0x0010000000940c1c
- (void).cxx_destruct;	// IMP=0x0000000000940c96
@property(readonly, nonatomic) NSMutableDictionary *graphCache; // @synthesize graphCache=_graphCache;
@property(readonly) NSDictionary *_options;
- (_Bool)_matchingOptions:(id)arg1;	// IMP=0x0000000000940c0c
@property(readonly) UIScreen *_intendedScreen;
- (id)_initWithScreen:(id)arg1 options:(id)arg2;	// IMP=0x0000000000940b64
