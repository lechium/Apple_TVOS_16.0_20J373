...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000739cb4
- (void).cxx_destruct;	// IMP=0x000000000073b45b
...
- (void)_updateDigitizerLocationForEvent:(id)arg1;	// IMP=0x000000000073b341
- (struct CGPoint)_digitizerLocation;	// IMP=0x000000000073b331
@property(readonly, nonatomic) NSSet *activeTouches;
- (struct CGPoint)locationInView:(id)arg1 focusSystem:(id)arg2;	// IMP=0x000000000073b226
- (struct CGPoint)locationInView:(id)arg1;	// IMP=0x000000000073b191
- (struct CGPoint)_locationInSceneReferenceSpace;	// IMP=0x000000000073b17e
...
- (void)pressesCancelled:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000000073b0cf
- (void)pressesEnded:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000000073b068
- (void)pressesChanged:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000000073afd8
- (void)pressesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000000073af73
- (void)touchesCancelled:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000000073af06
- (void)_interactionEndedTouch:(_Bool)arg1;	// IMP=0x000000000073adec
- (void)_beginInteraction;	// IMP=0x000000000073ad47
- (void)touchesEnded:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000000073ac61
- (void)touchesMoved:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000000073a9cb
- (void)touchesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000000073a458
- (_Bool)activeTouchesExceedAllowableSeparation;	// IMP=0x000000000073a3c6
- (double)_effectiveAllowableMovement;	// IMP=0x000000000073a367
- (void)multitouchExpired:(id)arg1;	// IMP=0x000000000073a2e3
- (void)startMultitouchTimer:(double)arg1;	// IMP=0x000000000073a293
- (void)clearMultitouchTimer;	// IMP=0x000000000073a24a
- (void)tooSlow:(id)arg1;	// IMP=0x000000000073a1ed
- (void)startTapTimer:(double)arg1;	// IMP=0x000000000073a19d
- (void)clearTapTimer;	// IMP=0x000000000073a154
- (void)_reset;	// IMP=0x000000000073a0c1
- (void)dealloc;	// IMP=0x000000000073a06e
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000739f3e
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000739cbc
- (id)init;	// IMP=0x0000000000739c0b
