...
- (void).cxx_destruct;	// IMP=0x000000000119cec6
...
- (void)startRecodingText:(id)arg1;	// IMP=0x000000000119cdda
- (void)resetHandler;	// IMP=0x000000000119cd98
- (void)recordDictationTipText:(id)arg1;	// IMP=0x000000000119ccf4
- (void)finalizeRecordedText;	// IMP=0x000000000119cb58
- (id)initWithDelegate:(id)arg1;	// IMP=0x000000000119ca9f
