...
+ (id)transformerWithAxisTransitionZonePosition:(struct CGPoint)arg1 axisTransitionZoneSize:(struct CGSize)arg2;	// IMP=0x0060000000bb491d
- (void).cxx_destruct;	// IMP=0x0000000000bb58ae
...
- (void)didEndPanningWithTouchPosition:(struct CGPoint)arg1 currentTransformedPosition:(struct CGPoint)arg2;	// IMP=0x0000000000bb559c
- (void)didPanWithTouchPosition:(struct CGPoint)arg1 currentTransformedPosition:(struct CGPoint)arg2;	// IMP=0x0000000000bb4d55
- (void)didBeginPanningWithTouchPosition:(struct CGPoint)arg1 currentTransformedPosition:(struct CGPoint)arg2;	// IMP=0x0000000000bb4b94
@property(readonly, nonatomic) struct CGVector velocity;
@property(readonly, nonatomic) struct CGVector offset;
- (void)_enterYLockedState;	// IMP=0x0000000000bb4a38
- (void)lockIntoYAxis;	// IMP=0x0000000000bb4a21
- (double)timeIntervalSinceLastDirectionChange;	// IMP=0x0000000000bb496f
- (id)initWithAxisTransitionZonePosition:(struct CGPoint)arg1 axisTransitionZoneSize:(struct CGSize)arg2;	// IMP=0x0000000000bb4824
