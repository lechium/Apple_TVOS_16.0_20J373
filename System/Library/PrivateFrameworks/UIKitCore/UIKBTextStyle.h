...
+ (id)styleWithTextColor:(id)arg1;	// IMP=0x001000000091add3
+ (id)styleWithFontName:(id)arg1 withFontSize:(double)arg2;	// IMP=0x001000000091acfb
- (void).cxx_destruct;	// IMP=0x000000000091bdb9
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000091ba70
- (void)overlayWithStyle:(id)arg1;	// IMP=0x000000000091b5ad
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000091b34f
- (id)description;	// IMP=0x000000000091aee2
- (id)init;	// IMP=0x000000000091ae94
