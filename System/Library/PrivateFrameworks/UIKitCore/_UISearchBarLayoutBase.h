...
- (id)description;	// IMP=0x00000000001c4ada
- (void)invalidateLayout;	// IMP=0x00000000001c4ad0
@property(readonly, nonatomic, getter=isLayoutValid) _Bool layoutValid;
- (void)updateLayoutIfNeeded;	// IMP=0x00000000001c4a9d
- (void)updateLayout;	// IMP=0x00000000001c4a97
- (void)applyLayout;	// IMP=0x00000000001c4a91
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001c495f
