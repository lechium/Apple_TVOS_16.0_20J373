...
- (void).cxx_destruct;	// IMP=0x0000000000e120e3
- (id)reorderSeparatorView:(_Bool)arg1;	// IMP=0x0000000000e11fdf
- (id)reorderControl:(_Bool)arg1;	// IMP=0x0000000000e11f3b
- (id)editControl:(_Bool)arg1;	// IMP=0x0000000000e11e20
@property(readonly, nonatomic) _Bool wantsMaskingWhileAnimatingDisabled;
- (void)dealloc;	// IMP=0x0000000000e11d6d
- (id)initWithTableViewCell:(id)arg1 editingStyle:(long long)arg2;	// IMP=0x0000000000e11cfe
