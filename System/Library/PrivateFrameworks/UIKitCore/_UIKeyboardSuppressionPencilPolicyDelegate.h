...
- (void).cxx_destruct;	// IMP=0x00000000007f05f3
...
- (_Bool)_shouldSuppressForDelegate:(id)arg1;	// IMP=0x00000000007f0514
- (id)_recognitionLocaleIdentifier;	// IMP=0x00000000007f04ff
