...
- (void).cxx_destruct;	// IMP=0x00000000007effda
...
- (void)connectForSimulator;	// IMP=0x00000000007eff85
- (void)connect;	// IMP=0x00000000007eff7f
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000007efefc
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000007efe2e
