...
+ (id)_darkStyleGlyphColor;	// IMP=0x0060000000a22d74
+ (id)_standardGlyphColor;	// IMP=0x0060000000a22d3b
- (void).cxx_destruct;	// IMP=0x0000000000a23506
...
- (id)imageWithRenderConfig:(id)arg1;	// IMP=0x0000000000a2317d
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000a22e63
- (id)initWithImageName:(id)arg1 identifier:(id)arg2;	// IMP=0x0000000000a22d8d
