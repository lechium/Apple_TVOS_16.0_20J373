...
+ (id)descriptionWithVelocity:(id)arg1 targetVelocity:(id)arg2;	// IMP=0x00600000010ad0fb
- (void).cxx_destruct;	// IMP=0x00000000010ad19d
...
- (id)initWithVelocity:(id)arg1 targetVelocity:(id)arg2;	// IMP=0x00000000010ad062
