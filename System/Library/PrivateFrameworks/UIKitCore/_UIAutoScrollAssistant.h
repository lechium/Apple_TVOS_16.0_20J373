...
- (void).cxx_destruct;	// IMP=0x00000000010124e6
...
- (void)setPoint:(struct CGPoint)arg1 forContentOffset:(struct CGPoint)arg2;	// IMP=0x00000000010123bb
- (void)_adjustPointToCurrentContentOffset;	// IMP=0x000000000101232e
- (void)_handleAutoScrollerWithContentOffset:(struct CGPoint)arg1 direction:(unsigned long long)arg2;	// IMP=0x00000000010122b8
- (void)displayLinkFired:(id)arg1;	// IMP=0x00000000010120a3
- (_Bool)_scrollContinuous;	// IMP=0x000000000101203c
@property(readonly, nonatomic, getter=isActive) _Bool active;
- (void)stop;	// IMP=0x0000000001011fa0
- (void)autoScrollFromPoint:(struct CGPoint)arg1;	// IMP=0x0000000001011d72
- (id)initWithScrollView:(id)arg1;	// IMP=0x0000000001011ca3
