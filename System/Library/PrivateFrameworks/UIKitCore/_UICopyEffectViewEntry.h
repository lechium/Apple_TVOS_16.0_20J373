...
- (void).cxx_destruct;	// IMP=0x0000000000248999
@property(retain, nonatomic) _UIVisualEffectViewBackdropCaptureGroup *captureGroup; // @synthesize captureGroup=_captureGroup;
- (id)description;	// IMP=0x00000000002488f5
- (_Bool)canTransitionToEffect:(id)arg1;	// IMP=0x00000000002488ed
- (void)removeEffectFromView:(id)arg1;	// IMP=0x00000000002488a1
- (void)addEffectToView:(id)arg1;	// IMP=0x0000000000248806
