...
- (void).cxx_destruct;	// IMP=0x00000000010e261b
...
- (void)_layoutIfNeeded;	// IMP=0x00000000010e189f
- (id)layoutDescription;	// IMP=0x00000000010e0e7c
- (id)description;	// IMP=0x00000000010e0d68
- (void)enumerateRunsUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000010e0cab
...
- (void)resetLayout;	// IMP=0x00000000010e0b45
- (_Bool)hasLayout;	// IMP=0x00000000010e0b37
@property(readonly, copy, nonatomic) _UIVectorTextLayoutParameters *parameters;
- (id)initWithTextParameters:(id)arg1;	// IMP=0x00000000010e0a65
