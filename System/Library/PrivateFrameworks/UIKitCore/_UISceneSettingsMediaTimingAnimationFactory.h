...
- (void).cxx_destruct;	// IMP=0x0000000000c2cba7
...
- (_Bool)_shouldAnimateAdditivelyForView:(id)arg1 withKeyPath:(id)arg2;	// IMP=0x0000000000c2cb84
- (id)_basicAnimationForView:(id)arg1 withKeyPath:(id)arg2;	// IMP=0x0000000000c2cb7c
