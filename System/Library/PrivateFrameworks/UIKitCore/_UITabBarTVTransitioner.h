...
- (void).cxx_destruct;	// IMP=0x00000000003d847a
...
- (void)animateTransition:(id)arg1;	// IMP=0x00000000003d76d1
- (double)transitionDuration:(id)arg1;	// IMP=0x00000000003d7670
- (void)finishTransition;	// IMP=0x00000000003d73bf
- (void)interruptTabBarControllerTransition;	// IMP=0x00000000003d73ad
- (id)init;	// IMP=0x00000000003d7371
