...
- (void).cxx_destruct;	// IMP=0x0000000000b70bf5
...
- (struct CGRect)boundingRectForGlyphsInRange:(struct _NSRange)arg1;	// IMP=0x0000000000b70a74
- (void)placeGlyphs;	// IMP=0x0000000000b708ae
- (void)removeGlyphs;	// IMP=0x0000000000b70747
- (void)buildGlyphViews;	// IMP=0x0000000000b6f572
- (void)dealloc;	// IMP=0x0000000000b6f509
- (id)initWithLabel:(id)arg1 attributedString:(id)arg2;	// IMP=0x0000000000b6f304
