...
- (void).cxx_destruct;	// IMP=0x0000000000d58afd
@property(retain, nonatomic) UIStackView *stackView; // @synthesize stackView=_stackView;
@property(nonatomic) long long numberOfLines; // @synthesize numberOfLines=_numberOfLines;
- (id)viewForLastBaselineLayout;	// IMP=0x0000000000d58a77
- (id)viewForFirstBaselineLayout;	// IMP=0x0000000000d58a27
- (void)applyStyleAttributes:(id)arg1;	// IMP=0x0000000000d588d6
@property(readonly, nonatomic) NSArray *stringViews;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000d5839f
