...
- (void).cxx_destruct;	// IMP=0x0000000000dc745f
- (id)debugDescription;	// IMP=0x0000000000dc6ff1
- (void)enumerateViewControllersFromModalAncestorUpToButNotIncludingDestination:(CDUnknownBlockType)arg1;	// IMP=0x0000000000dc6f03
...
- (id)initFromSourceViewController:(id)arg1 toDestinationViewController:(id)arg2;	// IMP=0x0000000000dc6ab2
