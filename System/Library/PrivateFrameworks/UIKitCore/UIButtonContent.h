...
- (void).cxx_destruct;	// IMP=0x0000000000517ec5
...
- (_Bool)updateVariableLengthStringForView:(id)arg1;	// IMP=0x0000000000517d63
- (id)description;	// IMP=0x0000000000517cc8
@property(retain, nonatomic) _UIGraphicsLetterpressStyle *letterpressStyle;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000517b07
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000005178aa
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000005176cb
