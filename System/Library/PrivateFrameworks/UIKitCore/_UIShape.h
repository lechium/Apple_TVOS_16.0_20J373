...
+ (id)shapeWithRoundedRect:(struct CGRect)arg1 cornerRadius:(double)arg2 cornerCurve:(id)arg3 cornerMask:(unsigned long long)arg4;	// IMP=0x00100000000493af
+ (id)shapeWithRoundedRect:(struct CGRect)arg1 cornerRadius:(double)arg2 cornerCurve:(id)arg3;	// IMP=0x0010000000049391
+ (id)shapeWithPath:(id)arg1;	// IMP=0x001000000004932d
- (void).cxx_destruct;	// IMP=0x0000000000049fc7
...
- (id)description;	// IMP=0x0000000000049d52
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000049c6c
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000499e6
...
- (id)shapeConvertedFromCoordinateSpace:(id)arg1 toCoordinateSpace:(id)arg2;	// IMP=0x0000000000049420
