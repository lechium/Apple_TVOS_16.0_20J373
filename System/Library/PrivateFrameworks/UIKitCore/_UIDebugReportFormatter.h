...
+ (id)defaultFormatter;	// IMP=0x00600000006002f3
- (void).cxx_destruct;	// IMP=0x000000000060077d
...
- (id)stringFromReportComponents:(id)arg1;	// IMP=0x0000000000600356
- (id)init;	// IMP=0x0000000000600305
