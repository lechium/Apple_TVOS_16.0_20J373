...
- (void).cxx_destruct;	// IMP=0x0000000000e304d0
...
- (id)applyUpdate:(id)arg1 toDisplayItem:(id)arg2;	// IMP=0x0000000000e30327
- (id)viewForIdentifier:(id)arg1;	// IMP=0x0000000000e30315
- (void)_create_sensorActivityIndicator;	// IMP=0x0000000000e302bb
- (id)dependentEntryKeys;	// IMP=0x0000000000e30261
