...
- (void).cxx_destruct;	// IMP=0x00000000005f63d2
...
- (_Bool)_shouldInferDefaultPreferenceForEnvironmentInContext:(id)arg1;	// IMP=0x00000000005f6303
- (void)enumeratePreferencesForEnvironment:(id)arg1 usingBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000000005f5c1a
- (id)initWithEnumerationMode:(long long)arg1;	// IMP=0x00000000005f5bd9
- (id)init;	// IMP=0x00000000005f5bc5
