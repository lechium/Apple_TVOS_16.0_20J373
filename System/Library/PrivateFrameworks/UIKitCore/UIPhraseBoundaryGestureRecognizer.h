...
- (void).cxx_destruct;	// IMP=0x0000000000725a83
...
- (void)clearTimer;	// IMP=0x0000000000725991
- (void)startTimer;	// IMP=0x000000000072565d
- (void)secondDelayElapsed:(id)arg1;	// IMP=0x0000000000725602
- (void)setState:(long long)arg1;	// IMP=0x0000000000725556
- (void)_resetGestureRecognizer;	// IMP=0x0000000000725509
- (id)initWithTarget:(id)arg1 action:(SEL)arg2;	// IMP=0x00000000007254b8
