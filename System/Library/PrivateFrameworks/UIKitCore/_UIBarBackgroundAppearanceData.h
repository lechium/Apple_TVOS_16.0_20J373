...
+ (id)decodeFromCoder:(id)arg1 prefix:(id)arg2;	// IMP=0x00600000000f6953
+ (id)transparentBackgroundData;	// IMP=0x00600000000f6860
+ (id)opaqueBackgroundData;	// IMP=0x00600000000f6741
+ (id)standardBackgroundData;	// IMP=0x00600000000f65d7
- (void).cxx_destruct;	// IMP=0x00000000000f8cfa
...
- (long long)behaviorForTransitioningTo:(id)arg1;	// IMP=0x00000000000f8957
@property(readonly, nonatomic) _Bool hasShadow;
@property(readonly, nonatomic) _Bool hasBackground;
- (void)configureWithoutShadow;	// IMP=0x00000000000f88a3
- (void)configureWithDefaultShadow;	// IMP=0x00000000000f87ff
- (void)_updateShadowFlags;	// IMP=0x00000000000f85d9
@property(copy, nonatomic) UIBlurEffect *backgroundEffect;
- (void)_updateBackgroundFlags;	// IMP=0x00000000000f81cb
- (id)replicate;	// IMP=0x00000000000f805f
- (_Bool)checkEqualTo:(id)arg1;	// IMP=0x00000000000f7c74
- (long long)hashInto:(long long)arg1;	// IMP=0x00000000000f7bcc
- (void)describeInto:(id)arg1;	// IMP=0x00000000000f79fc
- (void)encodeToCoder:(id)arg1 prefix:(id)arg2;	// IMP=0x00000000000f7163
