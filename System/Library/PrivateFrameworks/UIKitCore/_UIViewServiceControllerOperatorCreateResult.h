...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000104c5aa
- (void).cxx_destruct;	// IMP=0x000000000104c627
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000104c339
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000104c18d
