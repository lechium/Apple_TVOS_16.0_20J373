...
- (void).cxx_destruct;	// IMP=0x00000000006464a2
...
- (id)_requestByRedirectingRequestToFocusSystem:(id)arg1;	// IMP=0x0000000000646181
- (id)initWithFocusSystem:(id)arg1 window:(id)arg2;	// IMP=0x0000000000646078
- (id)init;	// IMP=0x0000000000645ff1
