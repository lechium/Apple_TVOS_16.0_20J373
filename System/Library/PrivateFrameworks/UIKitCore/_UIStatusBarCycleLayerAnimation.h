...
+ (id)cycleAnimationWithLayer:(id)arg1 animation:(id)arg2 key:(id)arg3;	// IMP=0x0060000000d8a2b5
- (void).cxx_destruct;	// IMP=0x0000000000d8a5d3
...
- (id)description;	// IMP=0x0000000000d8a472
