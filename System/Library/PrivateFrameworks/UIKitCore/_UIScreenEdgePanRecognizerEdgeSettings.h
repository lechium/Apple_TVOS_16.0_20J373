...
+ (id)settingsControllerModule;	// IMP=0x0060000000734158
+ (id)keyPathsForValuesAffectingEdgeAngleWindowDegreees;	// IMP=0x0060000000734138
...
- (void)setDefaultValues;	// IMP=0x0000000000733f83
