...
- (id)description;	// IMP=0x0000000001081810
- (unsigned long long)hash;	// IMP=0x00000000010817e6
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000001081797
- (_Bool)isEqualToTargetInfo:(id)arg1;	// IMP=0x00000000010816f1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000010816e6
- (id)initWithTargetSize:(struct CGSize)arg1 horizontalPriority:(float)arg2 verticalPriority:(float)arg3;	// IMP=0x0000000001081676
