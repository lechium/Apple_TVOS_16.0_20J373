...
+ (id)instanceForScene:(id)arg1;	// IMP=0x00600000005065e9
+ (id)sharedInstance;	// IMP=0x0060000000506564
- (void).cxx_destruct;	// IMP=0x0000000000508d3b
...
- (void)displayForDownloadingURL:(id)arg1 copyToURL:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000050799e
- (void)displayForCopyingFileAtURL:(id)arg1 toURL:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000050798c
- (void)displayForDownloadingURL:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000507975
- (void)displayWithTitle:(id)arg1 message:(id)arg2 progress:(id)arg3 buttonTitle:(id)arg4 preDisplayTestBlock:(CDUnknownBlockType)arg5 dismissalHandler:(CDUnknownBlockType)arg6;	// IMP=0x000000000050755b
@property(copy, nonatomic) NSString *message;
@property(copy, nonatomic) NSString *title;
- (void)reconfigureWithTitle:(id)arg1 message:(id)arg2 progress:(id)arg3 buttonTitle:(id)arg4 dismissalHandler:(CDUnknownBlockType)arg5;	// IMP=0x0000000000506ebd
- (void)hideAfterDelay:(double)arg1 forceCompletion:(_Bool)arg2 replacementDismissalHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000506d4f
- (void)hideAfterMinimumUptimeWithDismissalHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000506c13
- (void)_dismissButtonAction:(id)arg1;	// IMP=0x0000000000506bf4
- (void)_hideTimerAction:(id)arg1;	// IMP=0x0000000000506bb7
- (void)_showTimerAction:(id)arg1;	// IMP=0x0000000000506ae7
- (void)_hideImmediatelyWasDismissedByUser:(_Bool)arg1;	// IMP=0x0000000000506a97
- (void)_reset;	// IMP=0x0000000000506a13
- (void)_callAndClearDismissalHandlerWasDismissedByUser:(_Bool)arg1;	// IMP=0x00000000005069c3
- (id)init;	// IMP=0x00000000005068b1
