...
- (void).cxx_destruct;	// IMP=0x000000000026d3d6
...
- (id)initWithContainer:(id)arg1 traitCollection:(id)arg2 dataSourceSnapshot:(id)arg3 sectionIndex:(long long)arg4 wantsCollapsedTopSpacing:(_Bool)arg5;	// IMP=0x000000000026d2d6
- (id)initWithContainer:(id)arg1 traitCollection:(id)arg2 dataSourceSnapshot:(id)arg3;	// IMP=0x000000000026d2aa
