...
@interface _UISheetLayoutInfo : NSObject
{
    ...
    struct CGRect __containerBounds;	// 1024 = 0x400
    struct UIEdgeInsets __containerSafeAreaInsets;	// 1056 = 0x420
    struct CGRect __sourceFrame;	// 1088 = 0x440
    struct CGRect __keyboardFrame;	// 1120 = 0x460
    struct CGRect __remoteKeyboardFrame;	// 1152 = 0x480
    struct CGRect __dismissSourceFrame;	// 1184 = 0x4a0
    struct CGAffineTransform __transform;	// 1216 = 0x4c0
}

- (void).cxx_destruct;	// IMP=0x00000000003c1b30
...
- (id)_descendantDescription;	// IMP=0x00000000003c1514
@property(readonly, copy) NSString *description;
- (void)_layout;	// IMP=0x00000000003bffa9
...
- (void)_invalidateCurrentOffset;	// IMP=0x00000000003b9b61
- (void)_invalidateDetents;	// IMP=0x00000000003b9348
- (void)_boundingPathMayHaveChangedForView:(id)arg1 relativeToBoundsOriginOnly:(_Bool)arg2;	// IMP=0x00000000003b89b1
- (void)_invalidatePreferredSize;	// IMP=0x00000000003b895e
- (id)initWithMetrics:(id)arg1;	// IMP=0x00000000003b8689
