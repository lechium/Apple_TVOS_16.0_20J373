...
- (void).cxx_destruct;	// IMP=0x0000000000a20bd2
...
- (void)complete;	// IMP=0x0000000000a20b77
@property(readonly, retain, nonatomic) UIView *animatingView;
- (id)initWithHost:(id)arg1 startPlacement:(id)arg2 endPlacement:(id)arg3;	// IMP=0x0000000000a20999
