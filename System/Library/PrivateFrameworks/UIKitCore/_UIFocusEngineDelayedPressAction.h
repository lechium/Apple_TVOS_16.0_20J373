...
+ (void)sendDelayedPressWithType:(long long)arg1 timestamp:(double)arg2 sender:(id)arg3;	// IMP=0x0060000000610bf2
- (void).cxx_destruct;	// IMP=0x0000000000611059
...
- (void)_sendPressEvent;	// IMP=0x0000000000610ce4
- (id)_initWithPressType:(long long)arg1 timestamp:(double)arg2 sender:(id)arg3;	// IMP=0x0000000000610af9
