...
- (void).cxx_destruct;	// IMP=0x0000000000658d04
...
- (id)_trimEntries:(id)arg1 toFitCount:(long long)arg2;	// IMP=0x000000000065894b
- (id)entriesTrimmedToFitCount:(unsigned long long)arg1;	// IMP=0x000000000065851a
