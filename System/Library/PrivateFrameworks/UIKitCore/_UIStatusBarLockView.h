...
- (void).cxx_destruct;	// IMP=0x0000000000d5736f
...
- (void)animationDidStop:(id)arg1 finished:(_Bool)arg2;	// IMP=0x0000000000d572ac
- (void)jiggleWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000d56dcd
- (void)animateUnlockWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000d56a6a
- (struct CGSize)intrinsicContentSize;	// IMP=0x0000000000d56a54
- (void)resetLock;	// IMP=0x0000000000d5699a
@property(readonly, nonatomic) _Bool prefersBaselineAlignment;
- (void)applyStyleAttributes:(id)arg1;	// IMP=0x0000000000d5678a
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000d5667b
