...
- (void).cxx_destruct;	// IMP=0x00000000006f1709
@property(readonly, nonatomic) NSDictionary *subfeatures; // @synthesize subfeatures=_subfeatures;
- (void)_incorporateSample:(const struct _UISEGestureFeatureSample *)arg1;	// IMP=0x00000000006f1618
- (id)debugDictionary;	// IMP=0x00000000006f14c1
- (void)featureDidChangeState:(id)arg1;	// IMP=0x00000000006f13f6
- (id)initWithSettings:(id)arg1 createFeatureBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000000006f1343
