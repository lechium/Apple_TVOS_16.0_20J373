...
- (void).cxx_destruct;	// IMP=0x000000000070f531
@property(readonly, copy) NSString *description;
- (double)timestampForDelivery;	// IMP=0x000000000070f3f3
- (long long)phaseForDelivery;	// IMP=0x000000000070f3d8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000070f2f1
- (id)init;	// IMP=0x000000000070f29b
