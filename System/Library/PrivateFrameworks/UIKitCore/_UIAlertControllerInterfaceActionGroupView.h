...
- (void).cxx_destruct;	// IMP=0x0000000000060a5f
...
- (_Bool)_shouldInstallContentGuideConstraints;	// IMP=0x0000000000060a0a
- (_Bool)_shouldShowSeparatorAboveActionsSequenceView;	// IMP=0x00000000000609c1
- (id)defaultVisualStyleForTraitCollection:(id)arg1 presentationStyle:(long long)arg2;	// IMP=0x00000000000608e5
- (id)_alertController;	// IMP=0x00000000000608cc
- (id)initWithAlertController:(id)arg1 actionGroup:(id)arg2 actionHandlerInvocationDelegate:(id)arg3;	// IMP=0x0000000000060850
