...
- (void).cxx_destruct;	// IMP=0x000000000039b92a
...
- (void)setEnabled:(_Bool)arg1;	// IMP=0x000000000039b2fb
- (void)controlEventsGestureRecognizer:(id)arg1 recognizedControlEvent:(unsigned long long)arg2 withEvent:(id)arg3;	// IMP=0x000000000039b116
- (void)_didTapTextLabel;	// IMP=0x000000000039aefc
- (void)activateLabel;	// IMP=0x000000000039aeea
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000039a74d
