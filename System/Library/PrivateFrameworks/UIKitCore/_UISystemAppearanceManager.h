...
- (void).cxx_destruct;	// IMP=0x000000000024b81e
...
- (void)_logOrientationPreferencesChangeWithOldSupportedOrientations:(unsigned long long)arg1 newSupportedOrientations:(unsigned long long)arg2 oldPreferredOrientation:(long long)arg3 newPreferredOrientation:(long long)arg4 animationSettings:(id)arg5 fenced:(_Bool)arg6;	// IMP=0x000000000024b2f9
- (void)window:(id)arg1 didUpdateSupportedOrientations:(unsigned long long)arg2 preferredOrientation:(long long)arg3 prefersAnimation:(_Bool)arg4;	// IMP=0x000000000024aabf
- (void)updateMultitaskingDragExclusionRects;	// IMP=0x000000000024a655
- (void)updateWhitePointAdaptivityStyle;	// IMP=0x000000000024a533
- (void)updateUserInterfaceStyle;	// IMP=0x000000000024a47d
- (void)updateScreenEdgesDeferringSystemGestures;	// IMP=0x000000000024a477
- (void)updateHomeIndicatorAutoHidden;	// IMP=0x000000000024a471
- (void)_windowDrivingSystemAppearanceDidChange:(id)arg1;	// IMP=0x000000000024a45a
- (void)_handleWindowDidBecomeKeyNotification:(id)arg1;	// IMP=0x000000000024a2c0
- (id)_findWindowDrivingSystemAppearance;	// IMP=0x0000000000249f62
@property(nonatomic, getter=_scene, setter=_setScene:) __weak UIScene *_scene;
- (void)dealloc;	// IMP=0x0000000000249c58
- (id)initWithScene:(id)arg1;	// IMP=0x0000000000249b07
