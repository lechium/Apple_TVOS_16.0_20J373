...
- (void).cxx_destruct;	// IMP=0x0000000000de35f7
...
- (void)_endOrFail;	// IMP=0x0000000000de3518
- (void)_begin;	// IMP=0x0000000000de3501
- (void)reset;	// IMP=0x0000000000de34a9
- (void)pressesCancelled:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000de3497
- (void)pressesEnded:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000de3485
- (void)pressesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000de327f
- (void)dealloc;	// IMP=0x0000000000de3220
- (id)initWithTarget:(id)arg1 action:(SEL)arg2;	// IMP=0x0000000000de2ef5
