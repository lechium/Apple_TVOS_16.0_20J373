...
- (void).cxx_destruct;	// IMP=0x00000000010b830f
...
- (id)initWithPreferredFrameRateRange:(struct CAFrameRateRange)arg1 updateReason:(unsigned int)arg2 velocityUsableForVFD:(_Bool)arg3 callback:(CDUnknownBlockType)arg4;	// IMP=0x00000000010b8220
