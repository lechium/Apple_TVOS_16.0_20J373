...
- (void).cxx_destruct;	// IMP=0x0000000000364ebb
...
- (void)addStartupHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000364e1d
- (void)addCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000364dc5
- (void)startWithAnimator:(id)arg1;	// IMP=0x0000000000363da0
- (void)start;	// IMP=0x0000000000363d8c
...
- (id)description;	// IMP=0x0000000000363ca8
- (id)initWithView:(id)arg1 viewType:(long long)arg2 finalLayoutAttributes:(id)arg3 startFraction:(double)arg4 endFraction:(double)arg5 animateFromCurrentPostion:(_Bool)arg6 deleteAfterAnimation:(_Bool)arg7 customAnimations:(CDUnknownBlockType)arg8;	// IMP=0x0000000000363a3b
