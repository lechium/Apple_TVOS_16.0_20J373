...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000091dad2
- (void)renderEffectWithRenderer:(id)arg1 traits:(id)arg2;	// IMP=0x000000000091dab7
...
- (struct CGColor *)CGColor;	// IMP=0x000000000091da83
