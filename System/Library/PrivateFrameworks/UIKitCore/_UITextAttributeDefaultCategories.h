...
- (void).cxx_destruct;	// IMP=0x00000000002415ff
...
- (id)_textViewDefaults:(long long)arg1;	// IMP=0x0000000000241147
- (id)_textFieldDefaults:(long long)arg1;	// IMP=0x00000000002410fb
- (id)_labelDefaults:(long long)arg1;	// IMP=0x0000000000240fec
- (id)_genericDefaults:(long long)arg1;	// IMP=0x0000000000240e7d
- (id)initWithUserInterfaceIdiom:(long long)arg1;	// IMP=0x0000000000240c62
