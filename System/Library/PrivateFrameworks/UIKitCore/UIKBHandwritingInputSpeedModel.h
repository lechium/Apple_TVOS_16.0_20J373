...
- (void).cxx_destruct;	// IMP=0x00000000008cab1c
...
- (void)updatePreferences;	// IMP=0x00000000008ca8ff
- (double)timeoutForNextPage;	// IMP=0x00000000008ca741
- (double)smoothValueFromArray:(id)arg1;	// IMP=0x00000000008ca5ee
- (double)speedForCurrentStroke;	// IMP=0x00000000008ca2c4
- (void)endCharacter;	// IMP=0x00000000008ca1aa
- (void)endStroke;	// IMP=0x00000000008ca181
- (void)addPoint:(struct CGPoint)arg1 timestamp:(double)arg2;	// IMP=0x00000000008ca0ed
- (void)beginStroke;	// IMP=0x00000000008c9feb
- (id)init;	// IMP=0x00000000008c9f24
