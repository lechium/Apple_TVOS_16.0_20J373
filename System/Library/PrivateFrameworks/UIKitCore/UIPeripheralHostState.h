...
+ (id)stateWithGeometry:(struct UIPeripheralAnimationGeometry)arg1 inPositionIsDestination:(_Bool)arg2;	// IMP=0x0060000000aa312a
- (void).cxx_destruct;	// IMP=0x0000000000aa32d0
...
- (void)dealloc;	// IMP=0x0000000000aa31c9
