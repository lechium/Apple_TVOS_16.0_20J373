...
{
    _UINavigationBarVisualProviderLegacyIOS *_visualProvider;	// 176 = 0xb0
}

@property(nonatomic) _UINavigationBarVisualProviderLegacyIOS *visualProvider; // @synthesize visualProvider=_visualProvider;
- (void)layoutSubviews;	// IMP=0x00000000001572c4
- (void)_intrinsicContentSizeInvalidatedForChildView:(id)arg1;	// IMP=0x00000000001572a7
