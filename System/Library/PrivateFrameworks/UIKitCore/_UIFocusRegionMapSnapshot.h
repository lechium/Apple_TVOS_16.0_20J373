...
+ (id)combinedVisualRepresentationForSnapshots:(id)arg1 scaleFactor:(double)arg2;	// IMP=0x00100000006238bb
- (void).cxx_destruct;	// IMP=0x00000000006247d1
...
- (id)debugQuickLookObject;	// IMP=0x00000000006245eb
- (id)visualRepresentationWithMinimumArea:(struct CGRect)arg1;	// IMP=0x0000000000622609
...
- (void)_didChooseFocusCandidateRegion:(id)arg1;	// IMP=0x0000000000621d77
- (id)_snapshotByFulfillingPromiseFocusRegionEntry:(id)arg1;	// IMP=0x0000000000621157
- (id)focusableRegionMapEntriesLimitedByFocusContainerGuide:(id)arg1;	// IMP=0x0000000000620de9
@property(readonly, copy, nonatomic) NSArray *allFocusableRegionMapEntries;
- (void)_commit;	// IMP=0x0000000000620d97
- (void)_updateSortedFocusContainerGuideMapEntries;	// IMP=0x0000000000620d26
- (void)_updateFinalFocusableRegionMapEntries;	// IMP=0x0000000000620c8c
- (id)_sortedEligibleFocusContainerGuidesInArray:(id)arg1;	// IMP=0x0000000000620316
- (id)_finalFocusableRegionMapEntriesFromViewMapEntries:(id)arg1 guideMapEntries:(id)arg2;	// IMP=0x0000000000620021
- (id)_finalFocusableRegionMapEntriesFromMapEntries:(id)arg1;	// IMP=0x000000000061fa07
- (void)_punchHoleInMap:(id)arg1 atFrame:(struct CGRect)arg2;	// IMP=0x000000000061f772
- (void)_occludeFocusInFrame:(struct CGRect)arg1;	// IMP=0x000000000061f68b
- (void)_addFocusContainerGuide:(id)arg1 withFrame:(struct CGRect)arg2;	// IMP=0x000000000061f530
- (void)_addFocusableRegion:(id)arg1 isFocusGuide:(_Bool)arg2 withFrame:(struct CGRect)arg3;	// IMP=0x000000000061f275
- (struct CGRect)_clippedRegionFrame:(struct CGRect)arg1 isFocusGuide:(_Bool)arg2;	// IMP=0x000000000061f064
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000061ee2f
- (id)_initWithRequest:(id)arg1;	// IMP=0x000000000061eb54
