...
+ (id)itemMoveFromIndexIndexPath:(id)arg1 toIndexPath:(id)arg2 fromIndex:(long long)arg3 toIndex:(long long)arg4;	// IMP=0x006000000038a632
+ (id)itemMoveSection:(long long)arg1 toSection:(long long)arg2 fromRange:(struct _NSRange)arg3 toRange:(struct _NSRange)arg4;	// IMP=0x006000000038a57e
+ (id)itemDeleteItemAtIndexPath:(id)arg1 index:(long long)arg2;	// IMP=0x006000000038a4c2
+ (id)itemDeleteSection:(long long)arg1 deleteRange:(struct _NSRange)arg2;	// IMP=0x006000000038a438
+ (id)itemInsertItemAtIndexPath:(id)arg1 index:(long long)arg2;	// IMP=0x006000000038a37c
+ (id)itemInsertSection:(long long)arg1 insertRange:(struct _NSRange)arg2;	// IMP=0x006000000038a2f2
- (void).cxx_destruct;	// IMP=0x000000000038ad02
...
- (id)reverseUpdateItem;	// IMP=0x000000000038a8b9
- (id)description;	// IMP=0x000000000038a74e
