...
- (_Bool)_shouldFailInResponseToPresses:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000000098c14a
- (void)cancelPendingHoldToAction;	// IMP=0x000000000098c107
- (void)scheduleHoldToAction;	// IMP=0x000000000098c0ce
- (void)holdToAction:(id)arg1;	// IMP=0x000000000098c049
- (void)cancelPendingTooSlowForDoubleTap;	// IMP=0x000000000098c006
- (void)scheduleTooSlowForDoubleTap;	// IMP=0x000000000098bfd8
- (void)tooSlowForDoubleTap:(id)arg1;	// IMP=0x000000000098bf95
- (void)pressesEnded:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000000098be87
- (void)pressesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000000098bde5
- (void)reset;	// IMP=0x000000000098bd53
- (id)initWithTarget:(id)arg1 action:(SEL)arg2;	// IMP=0x000000000098bd24
