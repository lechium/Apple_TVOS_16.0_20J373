...
+ (id)sliceWithStart:(struct CGRect)arg1 end:(struct CGRect)arg2;	// IMP=0x0060000000b2959e
- (void).cxx_destruct;	// IMP=0x0000000000b2986b
...
- (id)description;	// IMP=0x0000000000b296c1
@property(readonly) _Bool hasGeometry;
- (void)addStartRect:(struct CGRect)arg1 end:(struct CGRect)arg2;	// IMP=0x0000000000b29604
- (id)init;	// IMP=0x0000000000b294ff
