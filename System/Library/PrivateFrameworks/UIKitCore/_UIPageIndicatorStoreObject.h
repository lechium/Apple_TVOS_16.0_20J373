...
- (void).cxx_destruct;	// IMP=0x0000000000b01cac
...
- (id)description;	// IMP=0x0000000000b01bbe
- (id)splitAtIndex:(long long)arg1 withImage:(id)arg2 active:(_Bool)arg3;	// IMP=0x0000000000b019b1
- (_Bool)validPageWithinBound:(long long)arg1;	// IMP=0x0000000000b0199a
- (void)invalidateLayoutInfo;	// IMP=0x0000000000b01956
- (void)_copyImagesFromObject:(id)arg1;	// IMP=0x0000000000b01892
@property(readonly, nonatomic) _Bool hasImage;
@property(readonly, nonatomic) struct CGSize resolvedSize;
- (id)initWithStartIndex:(long long)arg1 endIndex:(long long)arg2;	// IMP=0x0000000000b017a8
