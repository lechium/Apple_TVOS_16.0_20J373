...
- (void).cxx_destruct;	// IMP=0x00000000001c7aaf
...
- (void)sendWillLayoutSubviewsForSearchFieldContainerView:(id)arg1;	// IMP=0x00000000001c77f1
- (id)description;	// IMP=0x00000000001c7300
- (void)applyLayout;	// IMP=0x00000000001c6f44
- (void)updateLayout;	// IMP=0x00000000001c6256
- (double)searchFieldHeightUpdatingShrinkageAndFadeAlphas;	// IMP=0x00000000001c614c
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001c5c17
