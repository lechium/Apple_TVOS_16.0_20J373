...
- (void).cxx_destruct;	// IMP=0x000000000022b5ab
...
- (void)recordDictationTipReplacementText:(id)arg1;	// IMP=0x000000000022b50d
- (void)startRecodingReplacementText:(id)arg1;	// IMP=0x000000000022b4fb
- (void)finalizeRecordedText;	// IMP=0x000000000022b36f
- (void)recordDictationTipText:(id)arg1;	// IMP=0x000000000022b2cc
- (void)startRecodingText:(id)arg1;	// IMP=0x000000000022b211
- (void)resetHandler;	// IMP=0x000000000022b1b9
- (id)initWithDelegate:(id)arg1;	// IMP=0x000000000022b100
