...
- (void)loadView;	// IMP=0x00000000006757cc
- (void)dealloc;	// IMP=0x000000000067578c
- (id)initWithDOMHTMLInputElement:(id)arg1 datePickerMode:(long long)arg2;	// IMP=0x0000000000675700
