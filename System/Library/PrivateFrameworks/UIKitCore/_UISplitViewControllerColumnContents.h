...
- (void).cxx_destruct;	// IMP=0x0000000000496cfd
...
- (id)description;	// IMP=0x0000000000496bfb
@property(readonly, nonatomic) UIViewController *viewController; // @synthesize viewController=_viewController;
- (id)initWithViewController:(id)arg1 navigationController:(id)arg2 navigationControllerWrapper:(id)arg3;	// IMP=0x0000000000496a7e
