...
- (void).cxx_destruct;	// IMP=0x000000000010dc31
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000010dac6
- (id)_upcastIfReadOnly;	// IMP=0x000000000010da40
- (id)_copyWithModifications:(CDUnknownBlockType)arg1;	// IMP=0x000000000010d979
