...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000009b5656
- (void).cxx_destruct;	// IMP=0x00000000009b59ce
...
- (id)description;	// IMP=0x00000000009b58fb
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000009b581e
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000009b570c
- (id)initWithInterpretations:(id)arg1 isLowConfidence:(_Bool)arg2;	// IMP=0x00000000009b56e8
- (id)initWithInterpretations:(id)arg1;	// IMP=0x00000000009b565e
