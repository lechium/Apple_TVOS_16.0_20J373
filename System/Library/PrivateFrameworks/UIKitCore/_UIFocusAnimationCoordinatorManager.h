...
- (void).cxx_destruct;	// IMP=0x00000000005d9169
...
- (void)_performDelayedFocusingAnimationIfNecessary;	// IMP=0x00000000005d907c
- (void)_scheduleDelayedFocusingAnimationWithDelay:(double)arg1;	// IMP=0x00000000005d8fb8
- (void)didUpdateFocusInContext:(id)arg1 fromItem:(id)arg2;	// IMP=0x00000000005d8a41
- (id)willUpdateFocusInContext:(id)arg1;	// IMP=0x00000000005d88a6
- (id)init;	// IMP=0x00000000005d883b
