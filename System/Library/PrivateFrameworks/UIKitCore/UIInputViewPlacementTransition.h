...
+ (id)transitionFromPlacement:(id)arg1 toPlacement:(id)arg2 withAnimationStyle:(id)arg3;	// IMP=0x00600000009f1a5e
- (void).cxx_destruct;	// IMP=0x00000000009f1d23
...
- (void)dealloc;	// IMP=0x00000000009f1bfc
- (_Bool)didAdvanceAnimationToState:(int)arg1;	// IMP=0x00000000009f1b16
