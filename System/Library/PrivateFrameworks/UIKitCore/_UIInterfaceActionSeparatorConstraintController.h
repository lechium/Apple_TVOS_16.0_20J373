...
- (void).cxx_destruct;	// IMP=0x0000000000048b3d
...
- (_Bool)_isFixedWidth;	// IMP=0x0000000000048afb
- (void)_updateConstantSizedConstraints;	// IMP=0x0000000000048a3f
- (void)separatorViewDidUpdateConstraints;	// IMP=0x0000000000048a2d
@property(nonatomic) double constantAxisDimension; // @synthesize constantAxisDimension=_constantAxisDimension;
- (id)initWithSeparatorView:(id)arg1;	// IMP=0x00000000000486fc
