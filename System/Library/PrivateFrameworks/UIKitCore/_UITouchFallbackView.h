...
- (id)hitTest:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x000000000006001a
- (int)textEffectsVisibilityLevel;	// IMP=0x000000000006000f
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000005ff80
