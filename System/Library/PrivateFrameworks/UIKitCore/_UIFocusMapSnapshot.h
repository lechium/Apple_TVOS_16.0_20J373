...
- (void).cxx_destruct;	// IMP=0x0000000000633d61
...
- (void)addRegionsInContainers:(id)arg1;	// IMP=0x0000000000633aed
- (void)addRegionsInContainer:(id)arg1;	// IMP=0x0000000000632473
- (void)addRegions:(id)arg1;	// IMP=0x00000000006322ad
- (void)addRegion:(id)arg1;	// IMP=0x0000000000631de3
- (id)searchArea;	// IMP=0x0000000000631dd1
@property(readonly, nonatomic) id <UICoordinateSpace> coordinateSpace;
@property(readonly, nonatomic) __weak UIScreen *screen;
- (void)_capture;	// IMP=0x000000000063187c
@property(readonly, nonatomic) _Bool hasOnlyStaticContent;
- (void)markContainerAsProvidingDynamicContent;	// IMP=0x0000000000631702
- (struct CGRect)snapshotFrameForRegion:(id)arg1;	// IMP=0x00000000006315c1
- (id)_cachedNextFocusedItemForRegion:(id)arg1 withFocusMovementRequest:(id)arg2 inMap:(id)arg3;	// IMP=0x00000000006313b8
- (void)consumeRegionInformationForRegions:(id)arg1 fromSnapshot:(id)arg2;	// IMP=0x00000000006311a5
- (id)occludingRegionsForRegion:(id)arg1;	// IMP=0x000000000063108d
- (void)_trackOccludingRegion:(id)arg1 forRegion:(id)arg2;	// IMP=0x0000000000630fc7
- (id)originalRegionForRegion:(id)arg1;	// IMP=0x0000000000630e94
- (void)_trackSubregion:(id)arg1 forRegion:(id)arg2;	// IMP=0x0000000000630cdb
- (id)regionsForOriginalRegion:(id)arg1;	// IMP=0x0000000000630a5b
@property(readonly, copy, nonatomic) NSArray *originalRegions;
@property(readonly, copy, nonatomic) NSArray *regions;
- (void)dealloc;	// IMP=0x00000000006304ad
- (id)_initWithSnapshotter:(id)arg1 mapArea:(id)arg2 searchArea:(id)arg3;	// IMP=0x0000000000630073
- (id)init;	// IMP=0x000000000062ffec
- (id)_debugInfoWithFocusMapSearchInfo:(id)arg1;	// IMP=0x0000000000602a74
@property(readonly, nonatomic, getter=_debugInfo) _UIFocusMapSnapshotDebugInfo *debugInfo;
- (id)debugQuickLookObject;	// IMP=0x00000000006029af
