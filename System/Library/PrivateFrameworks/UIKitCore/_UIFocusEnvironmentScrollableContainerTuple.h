...
+ (id)tupleWithScrollView:(id)arg1;	// IMP=0x00600000005f38d7
+ (id)tupleWithOwningEnvironment:(id)arg1 scrollableContainer:(id)arg2;	// IMP=0x00600000005f386b
- (void).cxx_destruct;	// IMP=0x00000000005f3ec8
...
- (id)description;	// IMP=0x00000000005f3e37
- (unsigned long long)hash;	// IMP=0x00000000005f3daa
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000005f3923
- (id)initWithOwningEnvironment:(id)arg1 scrollableContainer:(id)arg2;	// IMP=0x00000000005f3645
