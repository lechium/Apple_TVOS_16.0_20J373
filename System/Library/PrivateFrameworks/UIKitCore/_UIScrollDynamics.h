...
- (void)recalculateForDecelerationTarget:(struct CGPoint)arg1;	// IMP=0x0000000001129489
- (void)calculateToReachDecelerationTarget;	// IMP=0x0000000001129483
- (void)calculateDecelerationTarget;	// IMP=0x000000000112947d
- (_Bool)isRubberBandingAfterDuration:(double)arg1;	// IMP=0x0000000001129475
- (struct CGPoint)positionAfterDuration:(double)arg1;	// IMP=0x000000000112945f
- (struct CGVector)velocityAfterDuration:(double)arg1;	// IMP=0x0000000001129453
- (double)speedAfterDuration:(double)arg1;	// IMP=0x000000000112944a
@property(readonly, nonatomic) double durationUntilStop;
- (id)initWithInitialContentOffset:(struct CGPoint)arg1 velocity:(struct CGVector)arg2 contentFrame:(struct CGRect)arg3 viewSize:(struct CGSize)arg4 screenScale:(double)arg5;	// IMP=0x0000000001129335
- (id)init;	// IMP=0x00000000011292ca
