...
+ (id)touchStateTaskForTouchState:(id)arg1 andTask:(CDUnknownBlockType)arg2;	// IMP=0x0010000000a8edee
- (void).cxx_destruct;	// IMP=0x0000000000a8f090
...
- (long long)compare:(id)arg1;	// IMP=0x0000000000a8ef56
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000a8ef09
- (id)initWithTouchState:(id)arg1 andTask:(CDUnknownBlockType)arg2;	// IMP=0x0000000000a8ee5e
