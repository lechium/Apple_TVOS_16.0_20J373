...
- (void).cxx_destruct;	// IMP=0x00000000006fc29c
...
- (void)_pickerDidSelectColor:(id)arg1 colorspace:(id)arg2 isVolatile:(_Bool)arg3;	// IMP=0x00000000006fc16e
- (void)_forwardToDelegate:(id)arg1;	// IMP=0x00000000006fc0a1
- (void)_displayLinkFired;	// IMP=0x00000000006fc051
- (id)init;	// IMP=0x00000000006fbf0e
