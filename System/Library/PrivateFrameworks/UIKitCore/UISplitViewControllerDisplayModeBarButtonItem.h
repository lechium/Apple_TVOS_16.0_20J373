...
- (void).cxx_destruct;	// IMP=0x0000000000482087
...
- (void)_wasUsed;	// IMP=0x0000000000481fe2
- (SEL)action;	// IMP=0x0000000000481fa4
- (id)target;	// IMP=0x0000000000481f57
- (void)_setOwningNavigationItem:(id)arg1;	// IMP=0x0000000000481ec5
