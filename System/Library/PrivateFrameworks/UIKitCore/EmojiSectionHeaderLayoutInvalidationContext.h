...
- (void).cxx_destruct;	// IMP=0x00000000009dbef1
@property(readonly, nonatomic) NSIndexSet *invalidatedSections; // @synthesize invalidatedSections=_invalidatedSections;
- (double)preferredWidthForHeaderInSection:(long long)arg1;	// IMP=0x00000000009dbe8d
- (void)dealloc;	// IMP=0x00000000009dbe47
