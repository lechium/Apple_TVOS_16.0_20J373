...
+ (id)_withDisabledAppearanceTransitions:(_Bool)arg1 forVisibleDescendantsOf:(id)arg2 perform:(CDUnknownBlockType)arg3;	// IMP=0x0010000000468101
- (void).cxx_destruct;	// IMP=0x0000000000476d62
...
- (void)_adjustNonOverlayLeadingScrollViewsForKeyboardInfo:(id)arg1;	// IMP=0x000000000047681a
- (void)_adjustForKeyboardInfo:(id)arg1;	// IMP=0x00000000004761ea
- (void)_stopObservingKeyboardNotifications;	// IMP=0x0000000000476143
- (void)_observeKeyboardNotificationsOnScreen:(id)arg1;	// IMP=0x000000000047605b
...
- (void)animateToRequest:(id)arg1 forceOverlay:(_Bool)arg2 withVelocity:(double)arg3;	// IMP=0x0000000000475c3d
- (void)animateToRequest:(id)arg1 forceOverlay:(_Bool)arg2;	// IMP=0x0000000000475c28
- (void)animateToRequest:(id)arg1;	// IMP=0x0000000000475c14
- (_Bool)isSupplementaryViewControllerVisibleAfterAnimation;	// IMP=0x0000000000475b76
- (_Bool)isTrailingViewControllerVisibleAfterAnimation;	// IMP=0x0000000000475ad8
- (_Bool)isLeadingViewControllerVisibleAfterAnimation;	// IMP=0x0000000000475a3a
@property(readonly, nonatomic) id <UIViewControllerTransitionCoordinator> transitionCoordinator;
- (void)_animateFromRequest:(id)arg1 toRequest:(id)arg2 withAffectedSides:(long long)arg3 forceOverlay:(_Bool)arg4 velocity:(double)arg5;	// IMP=0x00000000004749ab
- (struct CGSize)_expectedSecondaryColumnSizeAfterAnimatingToState:(id)arg1 getLeadingColumnSize:(struct CGSize *)arg2 trailingColumnSize:(struct CGSize *)arg3 supplementaryColumnSize:(struct CGSize *)arg4;	// IMP=0x00000000004742ab
- (void)stopAnimations;	// IMP=0x0000000000474294
- (void)_stopAnimationsBeginningInteraction:(_Bool)arg1;	// IMP=0x0000000000473c85
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0000000000473c06
- (void)_updateBorderViewsBackgroundColor:(id)arg1;	// IMP=0x0000000000473ab2
- (void)_setBorderViewsObserveViewBackgroundColor:(_Bool)arg1;	// IMP=0x0000000000473a42
- (id)_createOverlayEdgeShadowViewForEdge:(unsigned long long)arg1;	// IMP=0x0000000000473a04
- (id)_createBorderView;	// IMP=0x00000000004739bc
- (double)interpolatedMarginForPrimaryNavigationBar:(id)arg1 supplementaryOrSecondaryNavbar:(id)arg2 getInterpolatedAlpha:(double *)arg3;	// IMP=0x000000000047370c
- (void)_updateToNewPublicState:(id)arg1 withSize:(struct CGSize)arg2;	// IMP=0x000000000046bf3a
- (void)_unspecifiedUpdateToNewPublicState:(id)arg1 withSize:(struct CGSize)arg2;	// IMP=0x0000000000469d63
- (void)_performWrappedUpdate:(CDUnknownBlockType)arg1;	// IMP=0x0000000000469af5
- (void)_performSingleDeferredUpdatePass;	// IMP=0x0000000000468d2e
- (void)_performDeferredUpdate;	// IMP=0x0000000000468cd5
- (void)_setNeedsDeferredUpdate;	// IMP=0x0000000000468b39
- (void)_setNeedsLayoutAndPerformImmediately:(_Bool)arg1;	// IMP=0x0000000000468af8
- (void)__viewWillLayoutSubviews;	// IMP=0x0000000000468908
- (void)_layoutContainerViewDidMoveToWindow:(id)arg1;	// IMP=0x0000000000468902
- (void)_layoutContainerViewWillMoveToWindow:(id)arg1;	// IMP=0x000000000046878b
- (void)_withDisabledAppearanceTransitionsPerform:(CDUnknownBlockType)arg1;	// IMP=0x0000000000467a10
- (void)viewWillTransitionToSize:(struct CGSize)arg1 withTransitionCoordinator:(id)arg2 superBlock:(CDUnknownBlockType)arg3;	// IMP=0x0000000000465af7
- (void)traitCollectionDidChange:(id)arg1 toNewTraits:(id)arg2;	// IMP=0x0000000000465a3c
- (void)willTransitionToTraitCollection:(id)arg1 withTransitionCoordinator:(id)arg2 superBlock:(CDUnknownBlockType)arg3;	// IMP=0x000000000046583b
- (void)_expandWithTransitionCoordinator:(id)arg1;	// IMP=0x0000000000464d45
- (void)_collapseWithTransitionCoordinator:(id)arg1;	// IMP=0x0000000000463c86
- (void)_updateForTraitCollection:(id)arg1 oldTraitCollection:(id)arg2 withTransitionCoordinator:(id)arg3;	// IMP=0x0000000000463913
- (_Bool)_willExpandWithNewTraitCollection:(id)arg1 oldTraitCollection:(id)arg2;	// IMP=0x0000000000463838
- (_Bool)_willCollapseWithNewTraitCollection:(id)arg1 oldTraitCollection:(id)arg2;	// IMP=0x000000000046374b
- (id)gatherMultitaskingDragExclusionRectsFromVisibleColumns;	// IMP=0x0000000000463161
- (void)addWrapperBlockForNextUpdate:(CDUnknownBlockType)arg1;	// IMP=0x00000000004630d5
@property(readonly, nonatomic, getter=isCollapsed) _Bool collapsed;
@property(readonly, nonatomic) long long collapsedState;
- (_Bool)isAnimating;	// IMP=0x0000000000462ebe
- (void)setNeedsUpdate;	// IMP=0x0000000000462eac
- (id)allViewControllers;	// IMP=0x0000000000462cde
- (void)navigationControllerDidChangeNavigationBarHidden:(id)arg1;	// IMP=0x0000000000462cd8
- (void)preferredContentSizeDidChangeForChildContentContainer:(id)arg1;	// IMP=0x0000000000462cc6
- (void)removeChildViewController:(id)arg1;	// IMP=0x00000000004629cd
- (void)_removeIdentifiedChildViewController:(id)arg1;	// IMP=0x00000000004628bf
- (void)_addIdentifiedChildViewController:(id)arg1;	// IMP=0x00000000004625ab
- (void)loadView;	// IMP=0x0000000000462356
...
- (void)setSupplementaryViewController:(id)arg1 changingParentage:(_Bool)arg2;	// IMP=0x0000000000461cae
@property(retain, nonatomic) UIViewController *supplementaryViewController;
- (void)setTrailingViewController:(id)arg1 changingParentage:(_Bool)arg2;	// IMP=0x0000000000461b55
@property(retain, nonatomic) UIViewController *trailingViewController;
- (void)setLeadingViewController:(id)arg1 changingParentage:(_Bool)arg2;	// IMP=0x00000000004619fc
@property(retain, nonatomic) UIViewController *leadingViewController;
- (void)setMainViewController:(id)arg1 changingParentage:(_Bool)arg2;	// IMP=0x00000000004618a3
...
- (void)dealloc;	// IMP=0x00000000004617c3
@property(readonly, nonatomic) _Bool supportsColumnStyle;
- (id)initWithOwningViewController:(id)arg1;	// IMP=0x00000000004616b7
