...
- (void).cxx_destruct;	// IMP=0x0000000000272222
...
- (id)_dirtyItems;	// IMP=0x000000000027219d
- (void)_reset;	// IMP=0x000000000027212d
- (void)_setBehaviors:(id)arg1 forItem:(id)arg2;	// IMP=0x000000000027201c
@property(retain, nonatomic) NSArray *dynamicItems;
- (void)setBehaviors:(id)arg1 forItem:(id)arg2;	// IMP=0x0000000000271f38
- (id)behaviorsForItem:(id)arg1;	// IMP=0x0000000000271e2a
- (id)init;	// IMP=0x0000000000271db5
