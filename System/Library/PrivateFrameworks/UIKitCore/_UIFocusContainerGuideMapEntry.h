...
- (void).cxx_destruct;	// IMP=0x00000000006269ed
...
- (id)description;	// IMP=0x000000000062681f
- (void)drawVisualRepresentationInContext:(struct CGContext *)arg1 imageFrame:(struct CGRect)arg2;	// IMP=0x000000000062663d
- (id)visualRepresentationColor;	// IMP=0x0000000000626416
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000626379
