...
- (void).cxx_destruct;	// IMP=0x00000000000c408a
...
- (void)computeOutputSettingsUsingModel:(id)arg1;	// IMP=0x00000000000c39b8
- (_Bool)isBackdropVisible;	// IMP=0x00000000000c39b0
- (_Bool)requiresBackdropLayer;	// IMP=0x00000000000c39a8
- (void)setRequiresColorStatistics:(_Bool)arg1;	// IMP=0x00000000000c3977
- (void)copyAdditionalSettingsFromSettings:(id)arg1;	// IMP=0x00000000000c37d5
- (void)setDefaultValues;	// IMP=0x00000000000c37a0
