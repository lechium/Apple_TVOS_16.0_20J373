...
- (void).cxx_destruct;	// IMP=0x0000000000736f82
...
- (unsigned long long)_targetEdges;	// IMP=0x0000000000736ddc
- (void)_idleTimerElapsed:(id)arg1;	// IMP=0x0000000000736c93
- (void)_longPressTimerElapsed:(id)arg1;	// IMP=0x0000000000736b99
- (void)_incorporateIncrementalSampleAtLocation:(struct CGPoint)arg1 timestamp:(double)arg2 modifier:(long long)arg3 region:(unsigned long long)arg4 interfaceOrientation:(long long)arg5 forceState:(long long)arg6;	// IMP=0x0000000000735de8
- (void)_incorporateInitialTouchAtLocation:(struct CGPoint)arg1 timestamp:(double)arg2 modifier:(long long)arg3 region:(unsigned long long)arg4 interfaceOrientation:(long long)arg5 forceState:(long long)arg6;	// IMP=0x00000000007355ec
- (void)incorporateTouchSampleAtLocation:(struct CGPoint)arg1 timestamp:(double)arg2 modifier:(long long)arg3 region:(unsigned long long)arg4 interfaceOrientation:(long long)arg5 forceState:(long long)arg6;	// IMP=0x0000000000735561
- (unsigned long long)touchedEdgesForInterfaceOrientation:(long long)arg1;	// IMP=0x00000000007354d1
- (long long)_type;	// IMP=0x00000000007354c4
- (void)_setState:(long long)arg1;	// IMP=0x0000000000735375
@property(readonly, nonatomic) _Bool useGrapeFlags;
- (void)reset;	// IMP=0x00000000007352e0
- (void)dealloc;	// IMP=0x00000000007352a4
- (id)initWithType:(long long)arg1;	// IMP=0x0000000000735245
- (id)initWithType:(long long)arg1 settings:(id)arg2;	// IMP=0x000000000073505c
