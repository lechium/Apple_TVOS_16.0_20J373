...
@class NSString, NSTextAlternatives, UIDragRecognizer, UIGestureRecognizer, UITextCursorAssertionController, UITextRange, UITextSelectionView, UITouch, UIView, _UIKeyboardTextSelectionController;
