...
- (void).cxx_destruct;	// IMP=0x00000000008579a5
...
- (void)touchesMoved:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000000857877
- (void)touchesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x00000000008577c1
- (_Bool)shouldTrack;	// IMP=0x00000000008577b9
@property(readonly, nonatomic) unsigned long long numberOfSegments;
- (void)updateSelectionWithPoint:(struct CGPoint)arg1;	// IMP=0x000000000085769e
- (void)_populateSegmentViewsWithCount:(unsigned long long)arg1;	// IMP=0x00000000008570de
- (void)_removeAllSegmentViews;	// IMP=0x0000000000856f13
- (void)layoutSubviews;	// IMP=0x0000000000856e9e
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000856bee
