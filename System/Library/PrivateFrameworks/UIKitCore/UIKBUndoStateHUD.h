...
- (void).cxx_destruct;	// IMP=0x0000000000b7cf5e
...
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000000b7ce58
- (void)updateUndoStateHUDControlType:(long long)arg1 available:(_Bool)arg2;	// IMP=0x0000000000b7ccc1
- (id)initWithKeyboardAppearance:(long long)arg1;	// IMP=0x0000000000b7b7eb
