...
- (void).cxx_destruct;	// IMP=0x0000000000f67869
...
- (void)setDefaultResult;	// IMP=0x0000000000f673d6
- (void)setNoResult;	// IMP=0x0000000000f673bb
- (void)setAttachmentResult:(id)arg1;	// IMP=0x0000000000f67362
- (void)setAttributedStringResult:(id)arg1;	// IMP=0x0000000000f67349
- (void)setStringResult:(id)arg1;	// IMP=0x0000000000f6729f
- (id)initWithTextPasteCoordinator:(id)arg1;	// IMP=0x0000000000f67234
