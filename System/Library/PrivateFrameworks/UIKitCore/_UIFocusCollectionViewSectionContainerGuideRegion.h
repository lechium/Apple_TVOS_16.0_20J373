...
- (void).cxx_destruct;	// IMP=0x0000000000a22d2a
@property(nonatomic) struct CGRect sectionFrame; // @synthesize sectionFrame=_sectionFrame;
@property(nonatomic) long long section; // @synthesize section=_section;
@property(nonatomic) __weak UICollectionView *collectionView; // @synthesize collectionView=_collectionView;
- (id)_fallbackFocusItemForMovementRequest:(id)arg1 inFocusMap:(id)arg2 withSnapshot:(id)arg3;	// IMP=0x0000000000a223f5
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000a22273
- (id)_focusRegionWithAdjustedFrame:(struct CGRect)arg1 coordinateSpace:(id)arg2;	// IMP=0x0000000000a2218b
