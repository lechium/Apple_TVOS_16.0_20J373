...
+ (void)_addAnimations:(id)arg1 toDispatchGroup:(id)arg2;	// IMP=0x0010000000d87f65
+ (void)_addAnimations:(id)arg1 toPreparingAnimations:(id)arg2 exclusiveAnimations:(id)arg3 visitedDisplayItemIdentifiers:(id)arg4;	// IMP=0x0010000000d87489
+ (void)prepareAnimations:(id)arg1 forStatusBar:(id)arg2;	// IMP=0x0010000000d8725f
+ (id)animationWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x0010000000d86f18
+ (void)initialize;	// IMP=0x0010000000d86ec1
- (void).cxx_destruct;	// IMP=0x0000000000d896d0
...
- (id)description;	// IMP=0x0000000000d89389
- (id)_dependentItemIdentifiersEnabledOnly:(_Bool)arg1;	// IMP=0x0000000000d89147
@property(readonly, nonatomic) NSSet *effectiveDelayedItemIdentifiers;
- (void)addSubAnimation:(id)arg1 forDisplayItemWithIdentifier:(id)arg2;	// IMP=0x0000000000d88bc6
- (void)cancel;	// IMP=0x0000000000d889b6
- (void)addTimeout:(double)arg1 withHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000d8898c
- (void)performForStatusBar:(id)arg1;	// IMP=0x0000000000d881bf
- (void)_prepareForStatusBar:(id)arg1 preparingAnimations:(id)arg2 exclusiveAnimations:(id)arg3;	// IMP=0x0000000000d87990
- (void)addTotalCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000d87186
- (void)addCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000d870fa
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000d86fdd
