...
- (void).cxx_destruct;	// IMP=0x0000000000fb45de
...
- (void)setupToInsertResultForNewHypothesis:(id)arg1;	// IMP=0x0000000000fb448f
- (void)_displayLinkFired:(id)arg1;	// IMP=0x0000000000fb3bce
- (void)_startStreamingAnimations;	// IMP=0x0000000000fb3ab6
- (void)_stopStreamingAnimation;	// IMP=0x0000000000fb3a40
- (void)setWords:(id)arg1;	// IMP=0x0000000000fb396e
- (void)commitFinalResults;	// IMP=0x0000000000fb391e
- (id)initWithTextView:(id)arg1;	// IMP=0x0000000000fb38ae
