...
+ (_Bool)_allowsDeferredTransitions;	// IMP=0x00100000003b73af
- (void).cxx_destruct;	// IMP=0x00000000003b740e
...
- (id)_createVisualStyleForProvider:(id)arg1;	// IMP=0x00000000003b73bf
- (_Bool)_mayChildGrabPresentedViewControllerView;	// IMP=0x00000000003b73b7
- (_Bool)_isRootPresentation;	// IMP=0x00000000003b73a7
- (void)willTransitionToTraitCollection:(id)arg1 withTransitionCoordinator:(id)arg2;	// IMP=0x00000000003b72bc
...
- (id)_fullscreenPresentationSuperview;	// IMP=0x00000000003b7294
- (id)_parentTraitEnvironment;	// IMP=0x00000000003b7282
- (id)initWithPresentedViewController:(id)arg1 presentingWindow:(id)arg2;	// IMP=0x00000000003b720f
