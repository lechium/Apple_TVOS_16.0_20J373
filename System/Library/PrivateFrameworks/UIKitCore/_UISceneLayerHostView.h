...
- (void).cxx_destruct;	// IMP=0x00000000006991cc
...
- (id)hitTest:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x00000000006990b4
- (id)initWithSceneLayer:(id)arg1;	// IMP=0x0000000000698f65
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000698ede
