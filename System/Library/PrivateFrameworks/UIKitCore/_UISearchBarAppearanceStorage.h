...
- (void).cxx_destruct;	// IMP=0x00000000001bfcfa
...
- (id)imageForIcon:(long long)arg1 state:(unsigned long long)arg2;	// IMP=0x00000000001bfbce
- (void)setImage:(id)arg1 forIcon:(long long)arg2 state:(unsigned long long)arg3;	// IMP=0x00000000001bfb08
- (id)searchFieldBackgroundImageForState:(unsigned long long)arg1;	// IMP=0x00000000001bfaa1
- (void)setSearchFieldBackgroundImage:(id)arg1 forState:(unsigned long long)arg2;	// IMP=0x00000000001bf9bf
