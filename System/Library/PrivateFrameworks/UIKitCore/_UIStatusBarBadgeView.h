...
- (void).cxx_destruct;	// IMP=0x0000000000d4b0c7
...
- (id)viewForLastBaselineLayout;	// IMP=0x0000000000d4b068
- (void)applyStyleAttributes:(id)arg1;	// IMP=0x0000000000d4ad93
@property(copy, nonatomic) NSString *text;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000d4a947
