...
- (void).cxx_destruct;	// IMP=0x0000000000f936f2
...
- (_Bool)supportsCoalescing;	// IMP=0x0000000000f936a7
- (void)undoRedo;	// IMP=0x0000000000f936a1
- (id)initWithAffectedRange:(struct _NSRange)arg1 inputController:(id)arg2;	// IMP=0x0000000000f93614
