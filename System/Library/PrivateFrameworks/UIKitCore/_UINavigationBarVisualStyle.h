...
+ (id)visualStyleForIdiom:(long long)arg1;	// IMP=0x006000000016de65
...
- (id)_legacyButtonFontForStyle:(long long)arg1;	// IMP=0x000000000016e528
...
- (id)defaultTitleColorForUserInterfaceStyle:(long long)arg1 barStyle:(long long)arg2;	// IMP=0x000000000016e4c6
- (double)imageButtonMarginInNavigationBar:(id)arg1;	// IMP=0x000000000016e4b1
- (double)textButtonMarginInNavigationBar:(id)arg1;	// IMP=0x000000000016e49c
- (long long)navigationBar:(id)arg1 metricsForOrientation:(long long)arg2 hasPrompt:(_Bool)arg3;	// IMP=0x000000000016e476
- (double)leftBackTitleMarginForCustomBackButtonBackground:(id)arg1;	// IMP=0x000000000016e37b
- (_Bool)shouldForceLegacyLeftBackTitleMarginForCustomBackButtonBackground:(id)arg1;	// IMP=0x000000000016e36f
- (id)buttonFontForStyle:(long long)arg1;	// IMP=0x000000000016e311
...
- (double)leftBackTitleMarginLetterpressPadding;	// IMP=0x000000000016e19e
...
- (double)barHeightForMetrics:(long long)arg1;	// IMP=0x000000000016e0e6
...
- (double)backButtonAnimationClippingPadding;	// IMP=0x000000000016e0b3
...
- (id)timingFunctionForAnimationInView:(id)arg1 withKeyPath:(id)arg2 isInteractive:(_Bool)arg3;	// IMP=0x000000000016df38
- (id)initWithIdiom:(long long)arg1;	// IMP=0x000000000016defb
