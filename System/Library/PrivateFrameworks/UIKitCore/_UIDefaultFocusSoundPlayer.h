...
+ (id)sharedInstance;	// IMP=0x0010000000644737
- (void).cxx_destruct;	// IMP=0x0000000000645051
...
- (void)_playSystemSound:(unsigned int)arg1 withVolume:(double)arg2 pan:(double)arg3;	// IMP=0x0000000000644a93
- (void)playSoundWithFocusSound:(long long)arg1 volume:(double)arg2 pan:(double)arg3;	// IMP=0x00000000006449a5
- (void)playSoundWithURL:(id)arg1 volume:(double)arg2 pan:(double)arg3;	// IMP=0x0000000000644839
- (void)dealloc;	// IMP=0x000000000064479c
- (void)_registerForSystemSoundsIfNecessary;	// IMP=0x0000000000644543
- (id)_init;	// IMP=0x0000000000644374
