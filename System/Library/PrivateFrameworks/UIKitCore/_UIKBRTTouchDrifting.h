...
+ (_Bool)isEnabled;	// IMP=0x0060000000af1cf5
- (void).cxx_destruct;	// IMP=0x0000000000af7170
...
- (void)_updateDriftViewTimer:(id)arg1;	// IMP=0x0000000000af6a5e
- (void)_updateDriftView;	// IMP=0x0000000000af51d5
- (struct CGPoint)_pinOffset:(struct CGPoint)arg1;	// IMP=0x0000000000af50f2
- (struct CGPoint)_pointFromPoint:(struct CGPoint)arg1 plusOffset:(struct CGPoint)arg2;	// IMP=0x0000000000af50e4
- (struct CGPoint)_offsetForPoint:(struct CGPoint)arg1 fromPoint:(struct CGPoint)arg2;	// IMP=0x0000000000af50d6
- (void)_updateDriftForFingers:(id)arg1 leftHand:(_Bool)arg2 newestTouch:(id)arg3;	// IMP=0x0000000000af467f
- (void)_updateDriftWithTouchInfo:(id)arg1;	// IMP=0x0000000000af3c81
- (id)_touchDictWithFingerIds:(id)arg1;	// IMP=0x0000000000af3852
- (void)_updateHistory;	// IMP=0x0000000000af3809
- (void)removeTouchWithIdentifier:(id)arg1 touchCancelled:(_Bool)arg2;	// IMP=0x0000000000af349c
- (void)moveTouchWithIdentifier:(id)arg1 toLocation:(struct CGPoint)arg2 withRadius:(double)arg3 atTouchTime:(double)arg4;	// IMP=0x0000000000af31a2
- (void)ignoreTouchWithIdentifier:(id)arg1 withTouchTime:(double)arg2;	// IMP=0x0000000000af2dc8
- (void)updateTouchWithIdentifier:(id)arg1 withTouchTime:(double)arg2 resultingError:(struct CGPoint)arg3 rowOffsetFromHomeRow:(long long)arg4;	// IMP=0x0000000000af2b25
- (void)addTouchLocation:(struct CGPoint)arg1 withRadius:(double)arg2 withTouchTime:(double)arg3 withIdentifier:(id)arg4;	// IMP=0x0000000000af28cb
...
- (void)updateWithFCenter:(struct CGPoint)arg1 jCenter:(struct CGPoint)arg2 keySize:(struct CGSize)arg3 rowOffsets:(id)arg4 homeRowOffsetIndex:(int)arg5;	// IMP=0x0000000000af25a7
- (void)reset;	// IMP=0x0000000000af2354
- (void)_resetFeedback;	// IMP=0x0000000000af228b
- (void)dealloc;	// IMP=0x0000000000af224d
- (id)initWithParentView:(id)arg1;	// IMP=0x0000000000af21fc
- (id)init;	// IMP=0x0000000000af1d20
