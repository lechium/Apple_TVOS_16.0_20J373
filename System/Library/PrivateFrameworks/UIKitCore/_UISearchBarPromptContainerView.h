...
- (id)description;	// IMP=0x00000000001c0360
- (void)layoutSubviews;	// IMP=0x00000000001c0166
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000001c00d4
- (_Bool)useMini;	// IMP=0x00000000001c00bf
- (_Bool)_isKnownUISearchBarComponentContainer;	// IMP=0x00000000008280b8
