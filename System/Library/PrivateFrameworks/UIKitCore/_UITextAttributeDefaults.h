...
+ (id)_unspecifiedDefaults;	// IMP=0x0010000000241673
+ (id)_defaultsForUserInterfaceIdiom:(long long)arg1;	// IMP=0x001000000024163d
+ (void)_getFontSizesForUserInterfaceIdiom:(long long)arg1 labelFontSize:(double *)arg2 buttonFontSize:(double *)arg3 systemFontSize:(double *)arg4 smallSystemFontSize:(double *)arg5;	// IMP=0x0010000000241d08
- (void).cxx_destruct;	// IMP=0x0000000000241cf8
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000241bf8
@property(readonly, copy) NSString *description;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000241add
...
- (id)_initWithFallback:(id)arg1;	// IMP=0x0000000000241735
- (id)_init;	// IMP=0x00000000002416df
