...
- (void).cxx_destruct;	// IMP=0x000000000005f91d
...
- (void)interactionProgress:(id)arg1 didEnd:(_Bool)arg2;	// IMP=0x000000000005f8b1
- (void)interactionProgressDidUpdate:(id)arg1;	// IMP=0x000000000005f868
- (void)startInteractiveTransition:(id)arg1;	// IMP=0x000000000005f6f4
