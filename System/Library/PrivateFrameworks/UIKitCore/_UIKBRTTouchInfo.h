...
+ (id)createTouchInfoForTouch:(id)arg1 withIdentifier:(id)arg2 canLogTouch:(_Bool)arg3;	// IMP=0x0060000000af8ce7
+ (id)touchInfoForTouch:(id)arg1 withIdentifier:(id)arg2;	// IMP=0x0060000000af8c40
+ (void)setTouchInfo:(id)arg1 forIdentifier:(id)arg2;	// IMP=0x0060000000af8b9e
+ (id)touchDict;	// IMP=0x0060000000af8b2c
- (void).cxx_destruct;	// IMP=0x0000000000af99e8
...
- (_Bool)willChangeTouchInfo:(id)arg1 toState:(BOOL)arg2;	// IMP=0x0000000000af97cc
- (id)setOfTouchesToIgnoreWhenSettingTouchInfo:(id)arg1 toState:(BOOL)arg2;	// IMP=0x0000000000af9358
- (void)cleanup;	// IMP=0x0000000000af92e8
- (void)invalidateTimer;	// IMP=0x0000000000af9256
- (void)fireTimerNow;	// IMP=0x0000000000af91b0
- (void)setTimerWithTimeInterval:(double)arg1 onQueue:(id)arg2 do:(CDUnknownBlockType)arg3;	// IMP=0x0000000000af906f
- (void)updateTouch:(id)arg1;	// IMP=0x0000000000af8f7f
@property(readonly, nonatomic) _UIKBRTTouchInfo *nextTouch;
@property(readonly, nonatomic) _UIKBRTTouchInfo *previousTouch;
- (void)dealloc;	// IMP=0x0000000000af8f1d
- (id)initWithTouch:(id)arg1 withIdentifier:(id)arg2 canLogTouch:(_Bool)arg3;	// IMP=0x0000000000af8d82
