...
- (void).cxx_destruct;	// IMP=0x000000000082c269
...
- (void)dealloc;	// IMP=0x000000000082c146
@property(readonly, copy) NSString *description;
- (void)_invalidate;	// IMP=0x000000000082c01b
- (id)_initWithType:(unsigned long long)arg1 initialState:(_Bool)arg2 reason:(id)arg3 requiresExplicitInvalidation:(_Bool)arg4;	// IMP=0x000000000082bf87
