...
- (void).cxx_destruct;	// IMP=0x00000000001c56de
...
- (id)description;	// IMP=0x00000000001c53ab
- (void)applyLayout;	// IMP=0x00000000001c52f9
- (void)updateLayout;	// IMP=0x00000000001c4f79
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001c4ed9
- (double)scopeControlHeight;	// IMP=0x00000000001c4e74
