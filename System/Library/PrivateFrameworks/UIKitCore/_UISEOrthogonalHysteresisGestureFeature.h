...
- (void).cxx_destruct;	// IMP=0x00000000006f1a86
- (void)_incorporateSample:(const struct _UISEGestureFeatureSample *)arg1;	// IMP=0x00000000006f17e0
- (id)initWithSettings:(id)arg1 touchedEdgesProvider:(id)arg2;	// IMP=0x00000000006f174b
