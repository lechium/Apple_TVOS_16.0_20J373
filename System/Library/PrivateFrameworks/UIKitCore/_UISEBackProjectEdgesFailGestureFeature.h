...
- (void).cxx_destruct;	// IMP=0x00000000006e8250
@property(readonly, nonatomic) unsigned long long touchedEdges; // @synthesize touchedEdges=_touchedEdges;
- (void)_incorporateSample:(const struct _UISEGestureFeatureSample *)arg1;	// IMP=0x00000000006e803d
- (id)debugDictionary;	// IMP=0x00000000006e7f8e
- (id)initWithSettings:(id)arg1;	// IMP=0x00000000006e7ef8
