...
- (void).cxx_destruct;	// IMP=0x0000000000d9b818
...
- (id)_ui_descriptionBuilder;	// IMP=0x0000000000d9b6e3
- (id)type;	// IMP=0x0000000000d9b6bc
- (id)itemStates;	// IMP=0x0000000000d9b510
- (_Bool)isFulfilled;	// IMP=0x0000000000d9b35b
