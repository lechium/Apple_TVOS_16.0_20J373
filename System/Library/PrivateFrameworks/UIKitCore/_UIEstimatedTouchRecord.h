...
- (void).cxx_destruct;	// IMP=0x0000000000cdfb04
...
- (void)dispatchUpdateWithPressure:(double)arg1 stillEstimated:(_Bool)arg2;	// IMP=0x0000000000cdf8ab
- (void)removeTouchable:(id)arg1;	// IMP=0x0000000000cdf895
- (void)addTouchable:(id)arg1;	// IMP=0x0000000000cdf83b
- (id)initWithLiveTouch:(id)arg1 freezeTouch:(id)arg2 contextID:(id)arg3;	// IMP=0x0000000000cdf784
