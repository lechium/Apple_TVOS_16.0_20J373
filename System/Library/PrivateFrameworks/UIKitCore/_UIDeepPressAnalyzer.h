...
- (void).cxx_destruct;	// IMP=0x0000000000bc1729
...
- (double)_touchForceFromTouches:(id)arg1;	// IMP=0x0000000000bc151d
@property(readonly, nonatomic, getter=isDeepPressLikely) _Bool deepPressLikely;
- (void)analyzeTouchForce:(double)arg1 centroidAtLocation:(struct CGPoint)arg2;	// IMP=0x0000000000bc139b
- (void)analyzeTouches:(id)arg1;	// IMP=0x0000000000bc1317
- (id)init;	// IMP=0x0000000000bc1265
