...
- (_Bool)uiHasFilterWithName:(id)arg1;	// IMP=0x003000000042778c
- (void)setPerspectiveDistance:(double)arg1;	// IMP=0x0030000000b2e52a
- (long long)compareTextEffectsOrdering:(id)arg1;	// IMP=0x0030000000f60144
...
- (void)_setLabelMasksToBoundsForAnimation:(_Bool)arg1;	// IMP=0x00300000010dfc21
