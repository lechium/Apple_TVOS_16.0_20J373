...
- (void).cxx_destruct;	// IMP=0x00000000006dab67
...
- (void)configPageView;	// IMP=0x00000000006d994a
- (void)layoutSubviews;	// IMP=0x00000000006d9938
- (id)initWithImageView:(id)arg1;	// IMP=0x00000000006d97fe
