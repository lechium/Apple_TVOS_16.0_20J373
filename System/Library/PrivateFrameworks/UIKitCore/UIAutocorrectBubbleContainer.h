...
- (void).cxx_destruct;	// IMP=0x0000000000b9edf8
...
- (void)performReset;	// IMP=0x0000000000b9eae9
- (_Bool)isViewAnimating;	// IMP=0x0000000000b9ea50
- (void)reset;	// IMP=0x0000000000b9ea19
- (void)animateAutocorrectionAccepted;	// IMP=0x0000000000b9e6f6
- (void)dismissAutocorrectBubble;	// IMP=0x0000000000b9e697
- (void)didTapAutocorrectionBubble;	// IMP=0x0000000000b9e685
- (id)createTypedTextViewWithTypedText:(id)arg1;	// IMP=0x0000000000b9e2a9
- (void)updateSelfWithRect:(struct CGRect)arg1;	// IMP=0x0000000000b9dc67
- (void)updateBubbleWithAutocorrectionText:(id)arg1 referenceRect:(struct CGRect)arg2;	// IMP=0x0000000000b9d88c
- (void)updateFakeTextSelectionHighlightForRect:(struct CGRect)arg1;	// IMP=0x0000000000b9d2dd
- (void)updateWithAutocorrectionText:(id)arg1 typedText:(id)arg2 referenceTextView:(id)arg3 referenceRect:(struct CGRect)arg4;	// IMP=0x0000000000b9d21d
- (id)init;	// IMP=0x0000000000b9d1a3
