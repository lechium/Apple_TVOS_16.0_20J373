...
+ (_Bool)resolveInstanceMethod:(SEL)arg1;	// IMP=0x001000000081b045
- (void).cxx_destruct;	// IMP=0x000000000081b269
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000081aead
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000081adce
