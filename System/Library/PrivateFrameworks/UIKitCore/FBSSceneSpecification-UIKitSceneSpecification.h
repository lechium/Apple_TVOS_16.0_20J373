...
- (id)disconnectionHandlers;	// IMP=0x00300000006bd3a8
- (id)connectionHandlers;	// IMP=0x00300000006bd39b
...
- (id)coreSceneComponentClassDictionary;	// IMP=0x00300000006bd36d
