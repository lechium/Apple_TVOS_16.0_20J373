...
+ (id)leftShadowImage;	// IMP=0x0060000000805f62
+ (double)widthWithShadow:(_Bool)arg1;	// IMP=0x0060000000805f46
...
- (void)applyLayoutAttributes:(id)arg1;	// IMP=0x0000000000806563
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x0000000000806061
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000805fd9
