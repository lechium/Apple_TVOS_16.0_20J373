...
+ (id)overrideForResponder:(id)arg1 withTarget:(id)arg2 forType:(long long)arg3;	// IMP=0x0060000000c93efe
- (void).cxx_destruct;	// IMP=0x0000000000c94355
...
- (id)description;	// IMP=0x0000000000c94139
- (void)dealloc;	// IMP=0x0000000000c94092
