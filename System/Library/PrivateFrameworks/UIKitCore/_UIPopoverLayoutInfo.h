...
+ (id)_observationKeys;	// IMP=0x0010000001019a71
- (void).cxx_destruct;	// IMP=0x000000000101b477
...
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000000101b27d
- (void)_updateOutputs;	// IMP=0x000000000101a46c
- (struct CGSize)_popoverViewSizeForContentSize:(struct CGSize)arg1 arrowDirection:(unsigned long long)arg2;	// IMP=0x000000000101a2e0
- (id)candidates;	// IMP=0x000000000101a2cf
- (void)updateProperties:(CDUnknownBlockType)arg1;	// IMP=0x000000000101a268
- (id)description;	// IMP=0x0000000001019f87
- (void)dealloc;	// IMP=0x0000000001019e24
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000001019ca1
- (id)init;	// IMP=0x0000000001019af6
