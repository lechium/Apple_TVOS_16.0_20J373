...
+ (id)stateForKeyboardState:(id)arg1;	// IMP=0x0010000000873605
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000008735fd
- (void).cxx_destruct;	// IMP=0x0000000000873f3a
...
- (id)description;	// IMP=0x0000000000873d2b
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000873ad7
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000873a12
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000008738b9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000873812
- (void)createDocumentStateIfNecessary;	// IMP=0x0000000000873752
