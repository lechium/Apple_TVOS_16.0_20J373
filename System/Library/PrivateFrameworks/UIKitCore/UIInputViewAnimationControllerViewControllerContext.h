...
+ (id)contextWithHost:(id)arg1 startPlacement:(id)arg2 endPlacement:(id)arg3 transitionContext:(id)arg4;	// IMP=0x00100000005157fd
- (void).cxx_destruct;	// IMP=0x0000000000515908
...
- (void)dealloc;	// IMP=0x0000000000515792
- (id)initWithHost:(id)arg1 startPlacement:(id)arg2 endPlacement:(id)arg3 transitionContext:(id)arg4;	// IMP=0x0000000000514e73
