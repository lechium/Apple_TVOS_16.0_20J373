...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000ee3fa1
+ (id)_fullScreenConfiguration;	// IMP=0x0010000000ee360e
- (void).cxx_destruct;	// IMP=0x0000000000ee40c6
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000ee3d42
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000ee3afb
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000ee3646
- (id)init;	// IMP=0x0000000000ee3532
