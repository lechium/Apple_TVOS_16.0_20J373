...
- (void).cxx_destruct;	// IMP=0x000000000082bf74
...
- (id)traitCollection;	// IMP=0x000000000082bcbc
- (_Bool)pointInside:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x000000000082ba91
- (void)layoutSubviews;	// IMP=0x000000000082b8e2
- (void)setInlineText:(id)arg1 inlineRect:(struct CGRect)arg2 maxX:(double)arg3 layout:(_Bool)arg4;	// IMP=0x000000000082b0db
- (_Bool)shouldExtendUpwards;	// IMP=0x000000000082aeb1
- (void)adjustFrameForInlineText:(id)arg1 inlineRect:(struct CGRect)arg2 maxX:(double)arg3;	// IMP=0x000000000082a87b
- (struct CGRect)adjustedFrameFromDesiredFrame:(struct CGRect)arg1 textWidth:(double)arg2;	// IMP=0x000000000082a593
- (struct CGRect)adjustedFrameFromDesiredFrame:(struct CGRect)arg1 textHeight:(double)arg2;	// IMP=0x000000000082a0f2
- (_Bool)isAcceptableFrame:(struct CGRect)arg1 afterScrollBy:(double)arg2;	// IMP=0x000000000082986a
- (struct CGRect)adjustedInlineRectFromInlineText:(id)arg1 inlineRect:(struct CGRect)arg2;	// IMP=0x00000000008297e5
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000829725
