...
- (void).cxx_destruct;	// IMP=0x0000000000c1c43e
...
- (id)initWithLeadingDelta:(double)arg1 trailingDelta:(double)arg2;	// IMP=0x0000000000c1c396
- (id)init;	// IMP=0x0000000000c1c316
