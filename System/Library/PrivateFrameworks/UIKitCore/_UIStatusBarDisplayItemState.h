...
+ (void)setupRelationsBetweenDisplayItemStates:(id)arg1 visualProvider:(id)arg2;	// IMP=0x0010000000d97852
+ (id)stateForDisplayItemWithIdentifier:(id)arg1 statusBar:(id)arg2;	// IMP=0x0010000000d970a3
- (void).cxx_destruct;	// IMP=0x0000000000d9afd0
...
- (id)description;	// IMP=0x0000000000d9ab30
@property(readonly, nonatomic) long long priority;
@property(readonly, copy, nonatomic) NSArray *potentialPlacementRegionIdentifiers;
- (_Bool)isCurrentPlacement:(id)arg1;	// IMP=0x0000000000d9a798
- (_Bool)prepareAnimation:(id)arg1;	// IMP=0x0000000000d9a254
- (id)_animationWithUpdateAnimation:(id)arg1;	// IMP=0x0000000000d99fc4
- (void)_cancelObsoleteAnimations;	// IMP=0x0000000000d99dcd
@property(readonly, nonatomic, getter=_animationType) long long animationType;
- (id)_effectiveStyleAttributesFromStyleAttributes:(id)arg1 data:(id)arg2 styleAttributesChanged:(_Bool *)arg3;	// IMP=0x0000000000d998a2
- (id)_updateForUpdatedData:(id)arg1 updatedStyleAttributes:(id)arg2 updatedEnability:(id)arg3;	// IMP=0x0000000000d99684
- (id)_updateForItem:(id)arg1 data:(id)arg2 styleAttributes:(id)arg3;	// IMP=0x0000000000d993ca
- (id)updateWithData:(id)arg1 styleAttributes:(id)arg2;	// IMP=0x0000000000d98c62
- (_Bool)updatePlacement;	// IMP=0x0000000000d98b85
- (void)resetToPreferredPlacement;	// IMP=0x0000000000d98b6f
- (_Bool)_updatePlacementWithRecursionBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000d989e5
- (_Bool)_resolveDependentItemStatesWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000d98743
- (void)_updateStatuses;	// IMP=0x0000000000d98664
- (void)prepareForDataUpdate;	// IMP=0x0000000000d9864d
- (void)prepareForOverflowDataUpdate;	// IMP=0x0000000000d98637
- (id)placementStateForPlacement:(id)arg1;	// IMP=0x0000000000d9768d
- (void)addPlacement:(id)arg1 inRegion:(id)arg2;	// IMP=0x0000000000d974a9
- (_Bool)_updateToNextPlacementStateIfNeeded;	// IMP=0x0000000000d9741c
- (void)updateToNextEnabledPlacement;	// IMP=0x0000000000d973e5
@property(readonly, nonatomic) _UIStatusBarDisplayItemPlacementState *currentPlacementState;
- (_Bool)hasRunningAnimations;	// IMP=0x0000000000d97361
