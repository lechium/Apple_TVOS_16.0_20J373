...
+ (long long)typicalBarPosition;	// IMP=0x0060000000135a8c
- (void).cxx_destruct;	// IMP=0x0000000000135f16
...
- (id)representativeImageForIdiom:(long long)arg1;	// IMP=0x0000000000135d45
...
- (double)titleVerticalAdjustmentForBarMetrics:(long long)arg1;	// IMP=0x0000000000135c0a
- (void)setTitleVerticalAdjustment:(double)arg1 forBarMetrics:(long long)arg2;	// IMP=0x0000000000135af8
