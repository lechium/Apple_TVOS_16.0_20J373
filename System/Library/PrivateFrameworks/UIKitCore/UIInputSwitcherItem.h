...
+ (id)switcherItemWithIdentifier:(id)arg1;	// IMP=0x0060000000857cf8
- (void).cxx_destruct;	// IMP=0x0000000000857fe0
...
- (id)initWithIdentifier:(id)arg1;	// IMP=0x0000000000857da7
- (void)dealloc;	// IMP=0x0000000000857d41
