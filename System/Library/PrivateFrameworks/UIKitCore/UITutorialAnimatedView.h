...
- (void).cxx_destruct;	// IMP=0x0000000000114938
...
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x00000000001147f7
- (void)_setPackage:(id)arg1;	// IMP=0x0000000000113fd9
- (id)initWithKeyboardAppearance:(long long)arg1;	// IMP=0x0000000000113eb1
