...
- (void).cxx_destruct;	// IMP=0x000000000062ddd6
...
- (void)addDestinationRegion:(id)arg1;	// IMP=0x000000000062dcbc
- (void)addSnapshot:(id)arg1;	// IMP=0x000000000062dc39
@property(readonly, copy, nonatomic) NSArray *destinationRegions;
@property(readonly, copy, nonatomic) NSArray *snapshots;
- (id)init;	// IMP=0x000000000062db30
