...
- (void).cxx_destruct;	// IMP=0x0000000000618928
...
- (void)_searchForFocusRegionsInContext:(id)arg1;	// IMP=0x000000000061861d
- (id)_preferredFocusRegionCoordinateSpace;	// IMP=0x00000000006184fa
@property(readonly, nonatomic) id <UIFocusItemContainer> focusItemContainer;
@property(readonly, nonatomic) __weak id <UIFocusEnvironment> parentFocusEnvironment;
- (void)updateFocusIfNeeded;	// IMP=0x000000000061845b
- (void)setNeedsFocusUpdate;	// IMP=0x000000000061841e
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0000000000618398
- (_Bool)shouldUpdateFocusInContext:(id)arg1;	// IMP=0x0000000000618321
@property(readonly, copy, nonatomic) NSArray *preferredFocusEnvironments;
@property(readonly, copy) NSString *description;
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000061801d
- (id)_itemContainer;	// IMP=0x0000000000618007
- (id)_owningEnvironment;	// IMP=0x0000000000617ff1
- (id)initWithEnvironmentContainer:(id)arg1;	// IMP=0x0000000000617f01
- (id)initWithOwningEnvironment:(id)arg1 itemContainer:(id)arg2;	// IMP=0x0000000000617ea7
