...
- (void).cxx_destruct;	// IMP=0x00000000000e3978
...
- (id)description;	// IMP=0x00000000000e3822
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000e377b
- (id)initWithHost:(id)arg1;	// IMP=0x00000000000e373e
