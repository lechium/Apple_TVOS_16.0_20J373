...
+ (void)initialize;	// IMP=0x0060000000d93aa5
- (void).cxx_destruct;	// IMP=0x0000000000d95199
...
- (void)endCoalescingUpdatesForEntryKeys:(id)arg1;	// IMP=0x0000000000d94fcb
- (void)beginCoalescingUpdatesForEntryKeys:(id)arg1 delay:(double)arg2;	// IMP=0x0000000000d94de2
- (void)_coalescedUpdateForEntryKeys:(id)arg1;	// IMP=0x0000000000d94bcc
- (void)_updateForCoalescedKeysWithData:(id)arg1;	// IMP=0x0000000000d94851
@property(readonly, copy, nonatomic) NSSet *delayedEntryKeys;
- (void)endDelayingUpdatesForEntryKeys:(id)arg1;	// IMP=0x0000000000d94545
- (void)beginDelayingUpdatesForEntryKeys:(id)arg1;	// IMP=0x0000000000d943e9
- (void)_updateForDelayedKeysWithData:(id)arg1;	// IMP=0x0000000000d94343
- (void)_updateForOverlayWithData:(id)arg1;	// IMP=0x0000000000d942ed
- (void)_updateFromPendingUpdatesForKeys:(id)arg1 block:(CDUnknownBlockType)arg2;	// IMP=0x0000000000d93f6c
- (id)_updatedDataFromData:(id)arg1 delayedKeys:(id)arg2;	// IMP=0x0000000000d93c51
- (void)updateWithData:(id)arg1;	// IMP=0x0000000000d93bf6
- (id)initWithUpdateBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000d93aec
