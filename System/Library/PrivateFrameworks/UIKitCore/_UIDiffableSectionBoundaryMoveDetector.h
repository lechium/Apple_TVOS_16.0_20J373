...
- (void).cxx_destruct;	// IMP=0x0000000000804b77
...
- (id)_computeMovePairsSTL;	// IMP=0x000000000080337c
- (id)_computeMovePairsFoundation;	// IMP=0x0000000000802a4d
- (id)initWithItemDiffer:(id)arg1 beforeDataSourceState:(id)arg2 afterDataSourceState:(id)arg3;	// IMP=0x000000000080293e
