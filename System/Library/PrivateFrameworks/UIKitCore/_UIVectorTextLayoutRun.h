...
- (void).cxx_destruct;	// IMP=0x00000000010e365b
...
- (void)_enumerateGlyphsUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000010e3222
- (void)enumerateGlyphsUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000010e2ecc
- (void)renderInContext:(struct CGContext *)arg1;	// IMP=0x00000000010e2ca1
- (_Bool)shouldRender;	// IMP=0x00000000010e2c7d
- (id)font;	// IMP=0x00000000010e2c6f
- (id)string;	// IMP=0x00000000010e2b6c
- (struct _NSRange)stringRange;	// IMP=0x00000000010e2b4b
- (long long)glyphCount;	// IMP=0x00000000010e2b41
- (void)dealloc;	// IMP=0x00000000010e2b02
- (id)initWithCTRun:(struct __CTRun *)arg1 lineIndex:(unsigned long long)arg2 layoutInfo:(id)arg3;	// IMP=0x00000000010e2a74
