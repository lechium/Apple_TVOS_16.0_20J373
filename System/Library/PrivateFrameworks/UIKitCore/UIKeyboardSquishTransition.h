...
- (void).cxx_destruct;	// IMP=0x0000000000b35789
...
- (id)meshTransformForKeyplane:(id)arg1 toKeyplane:(id)arg2;	// IMP=0x0000000000b3380f
- (id)symmetricMeshTransformForKeyplane:(id)arg1;	// IMP=0x0000000000b31c62
- (_Bool)_allowFacesToAdjoinToAdjacentFaces;	// IMP=0x0000000000b31bfa
- (id)geometriesForKeyplane:(id)arg1;	// IMP=0x0000000000b31bc6
- (id)sortedCommonVisibleKeys;	// IMP=0x0000000000b31a50
- (void)updateOpacityAnimation:(id)arg1;	// IMP=0x0000000000b31870
- (void)updateWithProgress:(double)arg1;	// IMP=0x0000000000b31666
- (void)removeAllAnimations;	// IMP=0x0000000000b3153b
- (void)_updateTransition;	// IMP=0x0000000000b31375
- (id)_animationsForEnd;	// IMP=0x0000000000b30dd1
- (id)_animationsForStart;	// IMP=0x0000000000b30836
- (void)commitTransitionRebuild;	// IMP=0x0000000000b30776
- (void)rebuildWithStartKeyplane:(id)arg1 startView:(id)arg2 endKeyplane:(id)arg3 endView:(id)arg4;	// IMP=0x0000000000b302f5
- (void)dealloc;	// IMP=0x0000000000b302ac
