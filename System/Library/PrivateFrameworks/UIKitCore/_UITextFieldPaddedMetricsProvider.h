...
- (struct CGSize)intrinsicSizeForContentSize:(struct CGSize)arg1;	// IMP=0x000000000059d3d2
- (struct CGRect)contentFrameForBounds:(struct CGRect)arg1;	// IMP=0x000000000059d325
- (id)initWithPerEdgePadding:(struct UIEdgeInsets)arg1;	// IMP=0x000000000059d2de
- (id)initWithSymmetricalPadding:(struct CGSize)arg1;	// IMP=0x000000000059d282
- (id)init;	// IMP=0x000000000059d243
