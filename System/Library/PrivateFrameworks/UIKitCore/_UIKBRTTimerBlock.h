...
- (void).cxx_destruct;	// IMP=0x0000000000afa15a
...
- (void)timerFired:(id)arg1;	// IMP=0x0000000000af9d63
- (void)invalidate;	// IMP=0x0000000000af9cc2
- (void)fireNow;	// IMP=0x0000000000af9bd3
- (void)dealloc;	// IMP=0x0000000000af9b95
- (id)initWithTimeInterval:(double)arg1 onQueue:(id)arg2 do:(CDUnknownBlockType)arg3 owner:(id)arg4;	// IMP=0x0000000000af9a2a
