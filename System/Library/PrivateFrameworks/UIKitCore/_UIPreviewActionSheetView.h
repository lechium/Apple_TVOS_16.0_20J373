...
- (void).cxx_destruct;	// IMP=0x0000000000bb9a39
...
- (void)_performActionForPreviewAction:(id)arg1 interfaceAction:(id)arg2;	// IMP=0x0000000000bb986e
- (void)_setupViewHierarchy;	// IMP=0x0000000000bb8d6e
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000bb8d3f
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000bb8cf7
- (id)initWithFrame:(struct CGRect)arg1 title:(id)arg2 items:(id)arg3 contentInsets:(struct UIEdgeInsets)arg4;	// IMP=0x0000000000bb8c15
