...
- (void).cxx_destruct;	// IMP=0x00000000005faf8c
- (double)_convertOffset:(double)arg1;	// IMP=0x00000000005faeac
...
- (double)_baselineOffsetAtPosition:(id)arg1;	// IMP=0x00000000005fa738
- (id)initWithTextLayoutController:(id)arg1 typingAttributes:(id)arg2 usesLineFragmentOrigin:(_Bool)arg3 coordinateSpace:(id)arg4 scale:(double)arg5 fallbackTextContainerOrigin:(struct CGPoint)arg6;	// IMP=0x00000000005fa646
