...
+ (id)controlLableTextByType:(long long)arg1 style:(id)arg2 available:(_Bool)arg3;	// IMP=0x0060000000b76f4c
- (void).cxx_destruct;	// IMP=0x0000000000b77d92
...
- (id)viewForLastBaselineLayout;	// IMP=0x0000000000b77c06
- (id)viewForFirstBaselineLayout;	// IMP=0x0000000000b77bf1
- (_Bool)pointInside:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x0000000000b77b7e
- (unsigned int)_secureName;	// IMP=0x0000000000b77b64
- (void)layoutControlForType:(long long)arg1 andStyling:(id)arg2;	// IMP=0x0000000000b77048
- (id)controlImageByType:(long long)arg1;	// IMP=0x0000000000b76ed8
- (id)controlLabelImageNameByType:(long long)arg1 isRTL:(_Bool)arg2;	// IMP=0x0000000000b76e53
- (void)updateCoverWithTavelProcess:(double)arg1 isRTL:(_Bool)arg2;	// IMP=0x0000000000b76ae5
- (void)updateUndoControlStyle;	// IMP=0x0000000000b7673d
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000000b76737
- (id)initWithType:(long long)arg1 andStyling:(id)arg2;	// IMP=0x0000000000b7638d
