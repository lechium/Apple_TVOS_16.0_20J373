...
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x0000000000860470
- (void)setFrame:(struct CGRect)arg1;	// IMP=0x000000000086041e
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000860396
