...
+ (id)layoutForSource:(id)arg1 inTarget:(id)arg2 withSize:(struct CGSize)arg3;	// IMP=0x0060000000820438
- (void).cxx_destruct;	// IMP=0x0000000000822cd8
...
- (id)description;	// IMP=0x0000000000822b18
- (void)drawInContext:(struct CGContext *)arg1;	// IMP=0x0000000000822a40
- (_Bool)hasContents;	// IMP=0x0000000000822a26
