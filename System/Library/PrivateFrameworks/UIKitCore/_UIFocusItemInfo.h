...
+ (id)infoWithView:(id)arg1;	// IMP=0x00100000005f7ae4
+ (id)infoWithItem:(id)arg1 useFallbackAncestorScroller:(_Bool)arg2;	// IMP=0x00100000005f7a8a
+ (id)infoWithItem:(id)arg1;	// IMP=0x00100000005f7a3c
- (void).cxx_destruct;	// IMP=0x00000000005f8dfb
...
- (id)description;	// IMP=0x00000000005f8d50
- (void)invalidateFocusedRegion;	// IMP=0x00000000005f8d2a
- (struct CGRect)focusedRectInCoordinateSpace:(id)arg1;	// IMP=0x00000000005f8c6c
- (id)_createFocusedRegion;	// IMP=0x00000000005f7f62
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000005f7c15
- (id)_initWithItem:(id)arg1 containingView:(id)arg2 useFallbackAncestorScroller:(_Bool)arg3;	// IMP=0x00000000005f7b33
