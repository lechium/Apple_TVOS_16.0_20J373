...
- (void).cxx_destruct;	// IMP=0x00000000010b6dae
...
- (void)performWithoutLock:(CDUnknownBlockType)arg1;	// IMP=0x00000000010b6d48
- (void)performWithLock:(CDUnknownBlockType)arg1;	// IMP=0x00000000010b6ca4
- (void)setCompletionCallback:(CDUnknownBlockType)arg1;	// IMP=0x00000000010b6c7f
- (void)performCompletionCallbackFinished:(_Bool)arg1;	// IMP=0x00000000010b6c2e
@property(nonatomic) _Bool invalidated;
- (id)initWithAnimation:(id)arg1 completion:(CDUnknownBlockType)arg2 composer:(id)arg3;	// IMP=0x00000000010b6b2b
