...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000087429b
- (void).cxx_destruct;	// IMP=0x000000000087563d
...
- (id)description;	// IMP=0x000000000087515b
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000874c72
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000874a1d
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000874760
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000874659
- (void)setInputModeList:(long long)arg1 touchBegan:(double)arg2 fromLocation:(struct CGPoint)arg3 updatePoint:(struct CGPoint)arg4;	// IMP=0x0000000000874636
- (void)adjustTextPositionByCharacterOffset:(long long)arg1;	// IMP=0x0000000000874543
- (void)deleteBackward;	// IMP=0x0000000000874488
- (void)insertText:(id)arg1;	// IMP=0x0000000000874416
- (id)_currentKeyboardOutput;	// IMP=0x000000000087436d
- (void)_pushNewKeyboardOutput;	// IMP=0x00000000008742a3
