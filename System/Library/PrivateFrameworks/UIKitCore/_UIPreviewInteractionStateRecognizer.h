...
- (double)_currentTouchForceMultiplier;	// IMP=0x0000000000bc2f36
- (double)_normalizedTouchForceValue:(double)arg1;	// IMP=0x0000000000bc2f09
- (double)_denormalizedTouchForceValue:(double)arg1;	// IMP=0x0000000000bc2ed8
- (double)_thresholdForForceLevel:(long long)arg1;	// IMP=0x0000000000bc2e6f
- (void)_accessibilityForceSensitivityChanged:(id)arg1;	// IMP=0x0000000000bc2e5d
- (void)reset;	// IMP=0x0000000000bc2c71
- (void)evaluateWithTouchForce:(double)arg1 atTimestamp:(double)arg2 withCentroidAtLocation:(struct CGPoint)arg3;	// IMP=0x0000000000bc28ae
@property(readonly, nonatomic) double velocity; // @dynamic velocity;
- (double)currentProgressToState:(long long)arg1;	// IMP=0x0000000000bc2788
- (id)description;	// IMP=0x0000000000bc26b5
- (void)dealloc;	// IMP=0x0000000000bc2633
- (id)init;	// IMP=0x0000000000bc2521
