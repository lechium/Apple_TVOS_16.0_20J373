...
+ (id)mainBundleInfoParser;	// IMP=0x006000000068f9aa
- (void).cxx_destruct;	// IMP=0x00000000006909c9
...
- (_Bool)_isLinkedOnOrAfterYukon;	// IMP=0x000000000069089e
- (void)_computeSupportedUserInterfaceStyleFromInfo:(id)arg1;	// IMP=0x00000000006907d1
- (void)_computeSupportedInterfaceOrientationsWithInfo:(id)arg1;	// IMP=0x00000000006904fc
- (_Bool)_shouldUseHiResForClassic;	// IMP=0x00000000006904f4
- (id)_initWithApplicationPlistData:(id)arg1;	// IMP=0x000000000068fd1e
- (id)initWithApplicationProxy:(id)arg1;	// IMP=0x000000000068faa6
- (id)_initWithBundle:(id)arg1;	// IMP=0x000000000068fa50
