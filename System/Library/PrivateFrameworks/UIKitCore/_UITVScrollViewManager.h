...
- (void).cxx_destruct;	// IMP=0x00000000007594c1
...
- (void)_observeScrollViewDidScroll:(id)arg1;	// IMP=0x000000000075922d
- (id)_customScrollViewMaskForScrolling:(struct CGRect)arg1;	// IMP=0x0000000000759081
- (void)_removeScreenshotViewIfNeeded;	// IMP=0x0000000000759033
- (void)_scrollToContentOffset:(struct CGPoint)arg1;	// IMP=0x0000000000758bad
- (long long)_currentPage;	// IMP=0x0000000000758aee
- (void)_scrollAnimationDidEnd:(id)arg1;	// IMP=0x0000000000758a67
- (void)_tearDown;	// IMP=0x00000000007589cf
- (void)setContentOffset:(struct CGPoint)arg1 animated:(_Bool)arg2;	// IMP=0x000000000075871b
- (void)dealloc;	// IMP=0x0000000000758610
- (id)initWithScrollView:(id)arg1 scrollStyle:(long long)arg2;	// IMP=0x0000000000758497
