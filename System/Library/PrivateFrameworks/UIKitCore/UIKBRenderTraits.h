...
+ (id)traitsWithSymbolStyle:(id)arg1;	// IMP=0x001000000091db9e
+ (id)traitsWithGeometry:(id)arg1;	// IMP=0x001000000091db33
+ (id)emptyTraits;	// IMP=0x001000000091db1a
- (void).cxx_destruct;	// IMP=0x000000000091f3df
...
- (void)modifyForMasking;	// IMP=0x000000000091f04a
- (void)overlayWithTraits:(id)arg1;	// IMP=0x000000000091e88f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000091e5a2
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000091e27c
- (id)description;	// IMP=0x000000000091dd22
- (void)removeAllRenderEffects;	// IMP=0x000000000091dce7
- (void)addForegroundRenderEffect:(id)arg1;	// IMP=0x000000000091dc78
- (void)addRenderEffect:(id)arg1;	// IMP=0x000000000091dc09
