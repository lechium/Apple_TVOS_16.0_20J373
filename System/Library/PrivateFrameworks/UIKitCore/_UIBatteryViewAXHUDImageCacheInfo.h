...
- (void).cxx_destruct;	// IMP=0x0000000000d436ed
...
- (_Bool)cacheMatchesCapacity:(double)arg1 fillColor:(id)arg2 tintColor:(id)arg3 showingBolt:(_Bool)arg4 reverseLayout:(_Bool)arg5 scale:(double)arg6;	// IMP=0x0000000000d434e4
