...
- (void).cxx_destruct;	// IMP=0x00000000001c47e6
...
- (void)setLayoutCustomizationDelegateSearchFieldContainerWillLayoutSubviewsCallback:(CDUnknownBlockType)arg1;	// IMP=0x00000000001c4497
- (void)setDelegateSearchFieldFrameManipulationBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000001c443d
@property(readonly, copy) NSString *description;
- (void)cleanUpLayout;	// IMP=0x00000000001c35a3
- (void)applyScopeContainerSublayout;	// IMP=0x00000000001c3541
- (void)applyLayout;	// IMP=0x00000000001c2c22
- (void)ensureCorrectContainerViewOrdering;	// IMP=0x00000000001c2b83
- (double)minimumLayoutWidth;	// IMP=0x00000000001c2b4b
- (void)updateLayout;	// IMP=0x00000000001c2741
- (double)layout:(id)arg1 fontScaledValueForValue:(double)arg2;	// IMP=0x00000000001c268e
- (void)containerLayoutWillUpdateLayout:(id)arg1;	// IMP=0x00000000001c2625
- (void)prepareSublayouts;	// IMP=0x00000000001c25f7
- (void)prepareScopeContainerLayout;	// IMP=0x00000000001c24c2
- (void)prepareSearchContainerLayout;	// IMP=0x00000000001c2230
- (void)prepareBaseConfigurationForSublayout:(id)arg1;	// IMP=0x00000000001c21a4
- (void)setUpSearchContainerLayout;	// IMP=0x00000000001c2125
- (void)setUpScopeContainerLayout;	// IMP=0x00000000001c20a6
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001c127a
