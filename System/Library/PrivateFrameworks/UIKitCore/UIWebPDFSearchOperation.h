...
- (void)cancel;	// IMP=0x00000000012108a4
- (void)main;	// IMP=0x000000000121076a
- (void)_search;	// IMP=0x000000000121002e
- (id)sanitizedAttributedStringForAttributedString:(id)arg1;	// IMP=0x000000000120fb1a
- (struct __CTFont *)_fontWithPDFFont:(struct CGPDFFont *)arg1 size:(double)arg2;	// IMP=0x000000000120f81e
- (void)_notifyDelegateOfStatus;	// IMP=0x000000000120f6a3
- (_Bool)_hitSearchLimit;	// IMP=0x000000000120f678
- (void)dealloc;	// IMP=0x000000000120f610
- (id)init;	// IMP=0x000000000120f58b
