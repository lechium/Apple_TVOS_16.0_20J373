...
- (void).cxx_destruct;	// IMP=0x0000000000d02b4c
...
- (double)extraRightPadding;	// IMP=0x0000000000d02adf
- (id)shortenedTitleWithCompressionLevel:(int)arg1;	// IMP=0x0000000000d02a39
- (void)userDidActivateButton:(id)arg1;	// IMP=0x0000000000d029a2
- (long long)labelLineBreakMode;	// IMP=0x0000000000d02997
- (_Bool)updateForNewData:(id)arg1 actions:(int)arg2;	// IMP=0x0000000000d0278a
