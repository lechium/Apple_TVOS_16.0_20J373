...
+ (id)activeInstance;	// IMP=0x00600000010776b1
+ (id)sharedInstance;	// IMP=0x00600000010775fd
- (void).cxx_destruct;	// IMP=0x00000000010787d3
...
- (void)activate;	// IMP=0x0000000001078613
- (_Bool)_isAutomaticKeyboard;	// IMP=0x000000000107860b
- (void)didSuspend:(id)arg1;	// IMP=0x000000000107844a
- (void)willResume:(id)arg1;	// IMP=0x0000000001077f07
- (void)implBoundsHeightChangeDone:(double)arg1 suppressNotification:(_Bool)arg2;	// IMP=0x0000000001077d57
- (void)prepareForImplBoundsHeightChange:(double)arg1 suppressNotification:(_Bool)arg2;	// IMP=0x0000000001077c0c
- (struct UIPeripheralAnimationGeometry)geometryForHeightDelta:(double)arg1;	// IMP=0x0000000001077934
- (_Bool)isAutomatic;	// IMP=0x000000000107792c
- (_Bool)isActive;	// IMP=0x000000000107788b
- (void)maximize;	// IMP=0x0000000001077847
- (void)minimize;	// IMP=0x0000000001077803
- (void)dealloc;	// IMP=0x000000000107778e
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000010776c2
