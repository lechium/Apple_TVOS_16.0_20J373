...
- (void).cxx_destruct;	// IMP=0x0000000000517672
...
- (void)animateTransition:(id)arg1;	// IMP=0x0000000000516d57
- (double)transitionDuration:(id)arg1;	// IMP=0x0000000000516d45
- (void)dealloc;	// IMP=0x0000000000516d05
