...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000001062631
+ (id)descriptionForTransitionCoordinatorContext:(id)arg1;	// IMP=0x00100000010624b8
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000106280b
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000001062639
