...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000007b1fcf
- (_Bool)matchesSettings:(id)arg1 strength:(double)arg2;	// IMP=0x00000000007b1f55
- (void)dealloc;	// IMP=0x00000000007b1efc
