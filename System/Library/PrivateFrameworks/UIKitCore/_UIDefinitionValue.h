...
- (void).cxx_destruct;	// IMP=0x0000000000447ea4
...
- (id)description;	// IMP=0x0000000000447db9
- (id)initWithLocalizedDictionaryName:(id)arg1 term:(id)arg2 definition:(id)arg3 longDefinition:(id)arg4;	// IMP=0x0000000000447cac
