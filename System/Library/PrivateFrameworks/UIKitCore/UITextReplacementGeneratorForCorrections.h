...
- (void).cxx_destruct;	// IMP=0x0000000000f3d853
...
- (id)replacements;	// IMP=0x0000000000f3ce3a
- (void)addSpellingGuessesForString:(id)arg1 ToReplacements:(id)arg2;	// IMP=0x0000000000f3c820
- (void)addAutocorrectionGuessesToReplacements:(id)arg1;	// IMP=0x0000000000f3c45a
- (void)addPreviouslySuggestedAutocorrectionToReplacements:(id)arg1;	// IMP=0x0000000000f3c27f
- (id)addReplacementRevertingAutocorrectionToReplacements:(id)arg1;	// IMP=0x0000000000f3c088
- (_Bool)isStringToReplaceMisspelled;	// IMP=0x0000000000f3c035
- (_Bool)isStringMisspelled:(id)arg1;	// IMP=0x0000000000f3bf28
- (id)init;	// IMP=0x0000000000f3bedf
