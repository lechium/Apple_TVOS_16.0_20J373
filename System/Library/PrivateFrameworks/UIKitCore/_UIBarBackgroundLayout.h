...
- (void).cxx_destruct;	// IMP=0x00000000006f7c00
...
- (id)description;	// IMP=0x00000000006f7ac2
- (void)describeInto:(id)arg1;	// IMP=0x00000000006f79f3
...
- (_Bool)bg2HasHeight;	// IMP=0x00000000006f798a
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000006f7876
- (id)initWithLayout:(id)arg1;	// IMP=0x00000000006f77b3
- (id)init;	// IMP=0x00000000006f779f
