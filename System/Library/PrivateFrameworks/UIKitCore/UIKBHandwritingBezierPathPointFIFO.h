...
- (void).cxx_destruct;	// IMP=0x00000000008c0045
...
- (void)clear;	// IMP=0x00000000008bff36
- (void)flush;	// IMP=0x00000000008bfd2c
- (void)addPoint:(struct)arg1;	// IMP=0x00000000008bf63c
- (id)initWithFIFO:(id)arg1;	// IMP=0x00000000008bf582
