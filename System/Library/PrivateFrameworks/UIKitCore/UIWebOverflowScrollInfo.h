...
- (_Bool)coalesceScrollForNode:(id)arg1 offset:(struct CGPoint)arg2 isUserScroll:(_Bool)arg3;	// IMP=0x00000000011db873
- (void)dealloc;	// IMP=0x00000000011db838
- (id)initWithNode:(id)arg1 offset:(struct CGPoint)arg2 isUserScroll:(_Bool)arg3;	// IMP=0x00000000011db7bf
