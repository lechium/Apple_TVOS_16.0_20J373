...
- (void).cxx_destruct;	// IMP=0x0000000000e1b50f
...
- (id)description;	// IMP=0x0000000000e1b3a8
- (void)performWithEnforcedContainerSize:(struct CGSize)arg1 block:(CDUnknownBlockType)arg2;	// IMP=0x0000000000e1b375
- (struct CGRect)containerBounds;	// IMP=0x0000000000e1b33f
@property(readonly, nonatomic) struct CGSize containerSize;
@property(readonly, nonatomic) struct CGRect contentFrame;
- (void)layoutIfNeeded;	// IMP=0x0000000000e1b15d
- (void)setNeedsLayout;	// IMP=0x0000000000e1b128
- (struct CGRect)_updateAccessories:(id)arg1 previousAccessories:(id)arg2 withLayout:(id)arg3 edge:(unsigned long long)arg4;	// IMP=0x0000000000e1a030
- (void)_updateFromPreviousConfiguration:(id)arg1;	// IMP=0x0000000000e19c58
@property(readonly, nonatomic) UICellAccessoryConfiguration *currentConfiguration;
- (id)_configurationWithIdentifier:(id)arg1;	// IMP=0x0000000000e19c09
- (void)updateContainerView:(id)arg1;	// IMP=0x0000000000e19a74
- (id)initWithContainerView:(id)arg1;	// IMP=0x0000000000e199e2
