...
- (void).cxx_destruct;	// IMP=0x0000000000eab5a2
...
- (long long)inverseCompareIndexPaths:(id)arg1;	// IMP=0x0000000000eab54b
- (long long)compareIndexPaths:(id)arg1;	// IMP=0x0000000000eab528
