...
- (void).cxx_destruct;	// IMP=0x0000000000e289f9
...
- (void)invalidate;	// IMP=0x0000000000e288f0
- (void)dealloc;	// IMP=0x0000000000e288b2
- (id)_initWithReason:(id)arg1 options:(unsigned long long)arg2 controller:(id)arg3;	// IMP=0x0000000000e2880d
