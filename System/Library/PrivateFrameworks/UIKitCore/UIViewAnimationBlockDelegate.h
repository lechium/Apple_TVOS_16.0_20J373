...
+ (void)setAnimationBlockDelegateWithDuration:(double)arg1 options:(unsigned long long)arg2 start:(CDUnknownBlockType)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x0060000001185b80
+ (id)animationBlockDelegateWithDuration:(double)arg1 options:(unsigned long long)arg2 start:(CDUnknownBlockType)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x0060000001185aa7
- (void).cxx_destruct;	// IMP=0x0000000001186101
...
- (_Bool)_allowsHitTesting;	// IMP=0x00000000011860b6
- (_Bool)_allowsUserInteractionToCutOffEndOfAnimation;	// IMP=0x00000000011860ad
- (void)_sendDeferredCompletion:(id)arg1;	// IMP=0x0000000001186038
- (void)_didEndBlockAnimation:(id)arg1 finished:(id)arg2 context:(void *)arg3;	// IMP=0x0000000001185cc5
- (void)_willBeginBlockAnimation:(id)arg1 context:(id)arg2;	// IMP=0x0000000001185c9d
