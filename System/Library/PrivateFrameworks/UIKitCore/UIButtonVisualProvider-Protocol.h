...
@class NSAttributedString, NSString, UIButton, UIFocusAnimationCoordinator, UIFocusUpdateContext, UIImage, UIImageSymbolConfiguration, UIImageView, UILabel, UIScreen, UITraitCollection, UIView, UIVisualEffectView, UIWindow, _UIFocusAnimationConfiguration;
