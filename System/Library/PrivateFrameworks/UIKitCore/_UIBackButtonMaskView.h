...
{
    UIView *_maskExtensionView;	// 176 = 0xb0
    UIImageView *_maskImageView;	// 184 = 0xb8
}

- (void).cxx_destruct;	// IMP=0x000000000010603a
...
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000105c2b
