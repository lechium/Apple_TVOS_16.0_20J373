...
- (void).cxx_destruct;	// IMP=0x00000000009dbe36
...
- (long long)updateToCategoryWithOffsetPercentage:(double)arg1;	// IMP=0x00000000009dbe01
- (void)updateToCategory:(long long)arg1;	// IMP=0x00000000009dbdfb
