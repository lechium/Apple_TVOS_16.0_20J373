...
- (void).cxx_destruct;	// IMP=0x0000000000d9bacb
...
- (id)_ui_descriptionBuilder;	// IMP=0x0000000000d9b93f
- (id)type;	// IMP=0x0000000000d9b918
- (id)itemStates;	// IMP=0x0000000000d9b88d
- (_Bool)isFulfilled;	// IMP=0x0000000000d9b82b
