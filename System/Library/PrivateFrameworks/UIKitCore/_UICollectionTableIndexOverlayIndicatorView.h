...
- (void).cxx_destruct;	// IMP=0x0000000000e3888a
@property(copy, nonatomic) NSString *currentText;
- (void)layoutSubviews;	// IMP=0x0000000000e387fb
- (void)_willChangeToIdiom:(long long)arg1 onScreen:(id)arg2;	// IMP=0x0000000000e386f3
- (void)_tapGestureChanged:(id)arg1;	// IMP=0x0000000000e3869c
- (id)initWithHost:(id)arg1;	// IMP=0x0000000000e385a2
