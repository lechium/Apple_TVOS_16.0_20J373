...
- (void).cxx_destruct;	// IMP=0x0000000000595705
@property(retain, setter=_setProgress:) NSProgress *_progress; // @synthesize _progress=__progress;
- (_Bool)_really_cancel;	// IMP=0x000000000059569e
- (void)_really_loadImage:(CDUnknownBlockType)arg1;	// IMP=0x0000000000595514
- (id)initWithItemProvider:(id)arg1 typeIdentifier:(id)arg2;	// IMP=0x0000000000595430
