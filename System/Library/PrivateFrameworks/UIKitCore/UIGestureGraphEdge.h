...
- (void).cxx_destruct;	// IMP=0x00000000006fa0f4
...
- (id)description;	// IMP=0x00000000006f9fa8
@property(readonly, nonatomic, getter=isLoop) _Bool loop;
- (id)commonNode:(id)arg1;	// IMP=0x00000000006f9e22
- (id)oppositeNode:(id)arg1;	// IMP=0x00000000006f9de5
- (id)initWithLabel:(id)arg1 sourceNode:(id)arg2 targetNode:(id)arg3 directed:(_Bool)arg4;	// IMP=0x00000000006f9c66
