...
+ (id)replacementWithRange:(id)arg1 original:(id)arg2 replacement:(id)arg3 menuTitle:(id)arg4;	// IMP=0x0060000000f3b778
- (void).cxx_destruct;	// IMP=0x0000000000f3bab6
...
- (_Bool)_isNoReplacementsFoundItem;	// IMP=0x0000000000f3ba21
- (void)didReplaceTextWithTarget:(id)arg1;	// IMP=0x0000000000f3b845
