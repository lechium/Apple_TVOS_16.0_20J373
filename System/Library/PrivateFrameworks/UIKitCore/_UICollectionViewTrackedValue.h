...
- (void).cxx_destruct;	// IMP=0x0000000000363a2b
...
- (double)speed;	// IMP=0x00000000003638ef
- (void)addValue:(double)arg1;	// IMP=0x000000000036382b
- (id)init;	// IMP=0x00000000003636ce
