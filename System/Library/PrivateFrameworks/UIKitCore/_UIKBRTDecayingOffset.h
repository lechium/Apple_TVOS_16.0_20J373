...
- (void)updateOffsetTo:(struct CGPoint)arg1;	// IMP=0x0000000000af7612
- (void)reset;	// IMP=0x0000000000af75cc
- (id)initWithTimeoutDuration:(double)arg1 limitMovement:(_Bool)arg2;	// IMP=0x0000000000af758a
