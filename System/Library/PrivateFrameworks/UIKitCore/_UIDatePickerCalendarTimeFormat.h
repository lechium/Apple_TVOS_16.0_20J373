...
+ (id)formatWithCalendar:(id)arg1 locale:(id)arg2;	// IMP=0x00100000006a68d6
- (void).cxx_destruct;	// IMP=0x00000000006a8eab
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000006a8ba4
- (id)withTimeZone:(id)arg1;	// IMP=0x00000000006a8af8
- (id)withDisplaysTimeZone:(_Bool)arg1;	// IMP=0x00000000006a8aae
- (id)withForceDoubleDigitHours:(_Bool)arg1;	// IMP=0x00000000006a89a4
- (id)localizedTimeStringWithHours:(unsigned long long)arg1 minutes:(unsigned long long)arg2 isPM:(_Bool)arg3;	// IMP=0x00000000006a898f
- (id)localizedTimeStringWithHours:(unsigned long long)arg1 minutes:(unsigned long long)arg2 isPM:(_Bool)arg3 ranges:(CDStruct_a33ff3ce *)arg4;	// IMP=0x00000000006a7d10
- (id)initWithCalendar:(id)arg1 locale:(id)arg2 forceDoubleDigitHours:(_Bool)arg3 displaysTimeZone:(_Bool)arg4;	// IMP=0x00000000006a6952
