...
+ (id)defaultInfo;	// IMP=0x0060000000d9f5d5
- (void).cxx_destruct;	// IMP=0x0000000000d9f734
...
- (_Bool)shouldIncludeFocusItem:(id)arg1;	// IMP=0x0000000000d9f66c
- (id)initWithFocusEvaluator:(CDUnknownBlockType)arg1;	// IMP=0x0000000000d9f600
