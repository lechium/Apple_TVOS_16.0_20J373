...
- (void).cxx_destruct;	// IMP=0x0000000000e199ba
...
- (_Bool)alwaysNeedsLayout;	// IMP=0x0000000000e19991
- (id)description;	// IMP=0x0000000000e19676
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000e1947c
- (id)init;	// IMP=0x0000000000e19419
