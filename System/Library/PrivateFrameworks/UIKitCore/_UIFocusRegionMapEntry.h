...
- (void).cxx_destruct;	// IMP=0x0000000000625607
...
- (id)description;	// IMP=0x00000000006254a1
...
- (id)_uniqueElementFromArray:(id)arg1 forKey:(id)arg2;	// IMP=0x0000000000625182
- (void)_wasOccludedByFrame:(struct CGRect)arg1;	// IMP=0x000000000062505a
- (id)sliceWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000624fe7
- (id)_mapEntriesByOccludingWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000624957
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000006248c2
- (id)initWithFrame:(struct CGRect)arg1 originalRegionFrame:(struct CGRect)arg2;	// IMP=0x0000000000624853
