...
- (void).cxx_destruct;	// IMP=0x0000000000aa1d9b
@property(readonly, retain, nonatomic) NSArray *originatingStack; // @synthesize originatingStack=__creationStack;
- (void)execute:(id)arg1;	// IMP=0x0000000000aa1d7f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000aa1d3f
- (id)initWithTask:(CDUnknownBlockType)arg1;	// IMP=0x0000000000aa1c7c
