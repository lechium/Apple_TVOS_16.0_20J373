...
- (_Bool)isRubberBandingAfterDuration:(double)arg1;	// IMP=0x000000000112b707
- (struct CGPoint)positionAfterDuration:(double)arg1;	// IMP=0x000000000112b331
- (struct CGVector)velocityAfterDuration:(double)arg1;	// IMP=0x000000000112b2a1
- (double)speedAfterDuration:(double)arg1;	// IMP=0x000000000112b138
- (double)durationUntilStop;	// IMP=0x000000000112b126
- (void)calculateToReachDecelerationTarget;	// IMP=0x000000000112a6fb
- (void)calculateDecelerationTarget;	// IMP=0x000000000112981b
- (id)init;	// IMP=0x00000000011297d2
