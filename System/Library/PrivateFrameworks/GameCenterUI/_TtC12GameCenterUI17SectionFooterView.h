...
- (void).cxx_destruct;	// IMP=0x000000000030aea0
...
- (void)prepareForReuse;	// IMP=0x00000000003098d0
- (void)handleTapWithGestureRecognizer:(id)arg1;	// IMP=0x00000000003095a0
- (void)layoutSubviews;	// IMP=0x00000000003094b0
- (struct JUMeasurements)measurementsWithFitting:(struct CGSize)arg1 in:(id)arg2;	// IMP=0x0000000000308be0
@property(nonatomic) struct UIEdgeInsets layoutMargins;
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000308760
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000308730
