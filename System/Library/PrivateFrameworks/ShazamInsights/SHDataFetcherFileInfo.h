...
+ (id)dataFetcherForSourceURL:(id)arg1;	// IMP=0x006000000000cbf0
- (void).cxx_destruct;	// IMP=0x000000000000cfed
...
- (id)initWithDataURL:(id)arg1;	// IMP=0x000000000000cd5b
- (id)initWithDataURL:(id)arg1 suggestedFileName:(id)arg2;	// IMP=0x000000000000ccc2
- (id)initWithData:(id)arg1 suggestedFileName:(id)arg2;	// IMP=0x000000000000cc29
