...
+ (_Bool)sqliteDatabaseExistsAtURL:(id)arg1;	// IMP=0x006000000000a0ed
- (void).cxx_destruct;	// IMP=0x000000000000a8df
...
- (_Bool)isDataLoaded;	// IMP=0x000000000000a473
- (_Bool)hasNotPassedExpiryDate:(id)arg1 isForCountryCode:(id)arg2;	// IMP=0x000000000000a2ba
- (_Bool)isDataValid;	// IMP=0x000000000000a216
- (id)initWithClusterType:(long long)arg1 databaseMaxAge:(double)arg2 forStorefront:(id)arg3 databaseFilePathURL:(id)arg4;	// IMP=0x000000000000a165
