...
+ (id)sharedConnectionState;	// IMP=0x006000000000a688
- (void).cxx_destruct;	// IMP=0x000000000000ae35
...
- (id)sendMessageWithReplySync:(id)arg1;	// IMP=0x000000000000adaf
- (_Bool)sendMessage:(id)arg1;	// IMP=0x000000000000ac42
- (id)init;	// IMP=0x000000000000a755
- (void)cleanupState;	// IMP=0x000000000000a6dd
