...
+ (id)sharedConnectionState;	// IMP=0x0060000000000e65
- (void).cxx_destruct;	// IMP=0x00000000000017aa
...
- (id)sendMessageWithReplySync:(id)arg1;	// IMP=0x0000000000001580
- (_Bool)sendMessage:(id)arg1;	// IMP=0x000000000000139c
- (id)init;	// IMP=0x0000000000000f32
- (void)cleanupState;	// IMP=0x0000000000000eba
