...
- (void).cxx_destruct;	// IMP=0x0000000000005100
...
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x00000000000047e3
- (void)mediaPause;	// IMP=0x0000000000004658
- (void)imageViewTapped:(id)arg1;	// IMP=0x000000000000461b
- (void)viewWillLayoutSubviews;	// IMP=0x0000000000003e83
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0000000000003d93
@property(readonly, nonatomic) struct CGSize expectedContentSize;
- (void)setPreferredContentSize:(struct CGSize)arg1;	// IMP=0x0000000000003a68
- (void)loadView;	// IMP=0x000000000000369c
- (id)initWithNotification:(id)arg1 delegate:(id)arg2;	// IMP=0x00000000000028b5
