...
- (void)fulfilledWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000003a63
- (void)fulfill:(id)arg1;	// IMP=0x00000000000039ab
- (id)initWithFulfillmentQueue:(id)arg1;	// IMP=0x0000000000003885
