...
+ (id)sharedNotifier;	// IMP=0x0040000000001973
- (void).cxx_destruct;	// IMP=0x000000000000212b
...
- (id)_newRemoteConnection;	// IMP=0x0000000000001b10
- (id)_remoteConnection;	// IMP=0x00000000000019c8
@property(readonly, nonatomic) id <ConnectionProtocol> remoteObjectProxy;
- (id)init;	// IMP=0x00000000000016c9
