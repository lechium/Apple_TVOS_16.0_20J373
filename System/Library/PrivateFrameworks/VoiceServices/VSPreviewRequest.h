...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000017058
- (void).cxx_destruct;	// IMP=0x0000000000017265
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000170fd
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000017060
