...
- (void)_handleRequests;	// IMP=0x000000000002c42c
- (void)_notifyRequestHandled:(id)arg1;	// IMP=0x000000000002c3b2
- (void)invalidate;	// IMP=0x000000000002c36b
- (void)handleResults:(id)arg1 withHandler:(id)arg2;	// IMP=0x000000000002c291
- (void)setDelegate:(id)arg1;	// IMP=0x000000000002c259
- (void)dealloc;	// IMP=0x000000000002c20f
- (id)init;	// IMP=0x000000000002c1aa
