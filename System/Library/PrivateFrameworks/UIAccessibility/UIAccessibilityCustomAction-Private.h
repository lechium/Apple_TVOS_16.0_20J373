...
- (id)_accessibilityAXAttributedName;	// IMP=0x00300000000117a0
- (_Bool)_accessibilityMatchesCustomActionIdentifier:(id)arg1;	// IMP=0x0030000000011710
- (id)_accessibilityCustomActionIdentifier;	// IMP=0x00300000000115e0
