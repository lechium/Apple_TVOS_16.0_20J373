...
- (void).cxx_destruct;	// IMP=0x000000000001e787
...
- (void)onScenarioTriggers:(id)arg1 error:(id)arg2;	// IMP=0x000000000001e32a
- (id)stopMonitoringForScenarioTriggerTypes:(unsigned long long)arg1;	// IMP=0x000000000001e261
- (id)startMonitoringForScenarioTriggerTypes:(unsigned long long)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x000000000001e09c
- (id)init;	// IMP=0x000000000001e03f
