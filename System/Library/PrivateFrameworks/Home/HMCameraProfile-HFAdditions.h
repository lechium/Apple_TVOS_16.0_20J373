...
+ (unsigned long long)hf_cameraAccessModeSelectedOptionForCameraProfiles:(id)arg1 presenceType:(unsigned long long)arg2;	// IMP=0x0010000000142c61
- (id)hf_faceCropImageForSignificantEvent:(id)arg1;	// IMP=0x001000000014337f
- (id)hf_significantEventWithIdentifier:(id)arg1;	// IMP=0x0010000000142f98
- (void)hf_updateDoorbellChime:(_Bool)arg1;	// IMP=0x0010000000142a10
...
- (id)hf_updateUserNotificationSettings:(id)arg1;	// IMP=0x001000000022569e
@property(readonly, copy, nonatomic) HFUserNotificationServiceSettings *hf_userNotificationSettings;
- (id)hf_bulletinNotifications;	// IMP=0x0010000000225567
- (id)_hf_smartDetectionBulletinNotification;	// IMP=0x0010000000225517
- (id)_hf_legacyMotionSensorBulletinNotification;	// IMP=0x0010000000225493
- (id)_hf_doorbellBulletinNotification;	// IMP=0x001000000022540f
