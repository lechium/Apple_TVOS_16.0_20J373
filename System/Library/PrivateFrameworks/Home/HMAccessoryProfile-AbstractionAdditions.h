...
+ (id)_profilesWithNonStandardTileUI;	// IMP=0x001000000006ce83
- (id)hf_setTileSize:(id)arg1;	// IMP=0x0010000000062160
@property(readonly, nonatomic) NSString *hf_tileSize;
- (id)hf_updateShowInHomeDashboard:(_Bool)arg1;	// IMP=0x00100000000620e6
...
- (id)hf_updateIsVisibleInHomeStatus:(_Bool)arg1;	// IMP=0x001000000006208a
...
- (id)hf_updateIsFavorite:(_Bool)arg1;	// IMP=0x0010000000061f03
...
- (id)hf_moveToRoom:(id)arg1;	// IMP=0x0010000000061dc6
@property(readonly, nonatomic) HMRoom *hf_safeRoom;
- (_Bool)hf_isInRoom:(id)arg1;	// IMP=0x0010000000061ca5
...
- (id)hf_stateDumpBuilderWithContext:(id)arg1;	// IMP=0x00100000000aa6fd
- (id)hf_updateValue:(_Bool)arg1 forContextType:(unsigned long long)arg2;	// IMP=0x00100000001bb9e0
- (_Bool)hf_shouldHideForContextType:(unsigned long long)arg1;	// IMP=0x00100000001bb906
- (_Bool)hf_shouldBeOnForContextType:(unsigned long long)arg1;	// IMP=0x00100000001bb870
- (_Bool)hf_hasSetForContextType:(unsigned long long)arg1;	// IMP=0x00100000001bb81d
- (_Bool)hf_isOnForContextType:(unsigned long long)arg1;	// IMP=0x00100000001bb7ca
- (_Bool)hf_isValidObject;	// IMP=0x00100000001f8380
