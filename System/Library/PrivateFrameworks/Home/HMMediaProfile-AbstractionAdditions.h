...
- (id)hf_associatedAccessories;	// IMP=0x00200000000625f5
- (id)hf_containedProfiles;	// IMP=0x00200000000625e3
- (id)hf_containedCharacteristics;	// IMP=0x0020000000062577
- (id)hf_containedServices;	// IMP=0x0020000000062514
- (Class)hf_itemClass;	// IMP=0x0020000000062503
- (id)hf_accessoryLikeObject;	// IMP=0x00200000000623dd
- (id)hf_updateValue:(_Bool)arg1 forContextType:(unsigned long long)arg2;	// IMP=0x00200000001bceaf
- (_Bool)hf_shouldHideForContextType:(unsigned long long)arg1;	// IMP=0x00200000001bcdb6
- (_Bool)hf_shouldBeOnForContextType:(unsigned long long)arg1;	// IMP=0x00200000001bcd20
- (_Bool)hf_hasSetForContextType:(unsigned long long)arg1;	// IMP=0x00200000001bcccd
- (_Bool)hf_isOnForContextType:(unsigned long long)arg1;	// IMP=0x00200000001bcc7a
- (unsigned long long)hf_preferredUserSelectionType;	// IMP=0x00200000002331d2
- (id)hf_preferredMediaUser;	// IMP=0x0020000000233166
@property(readonly, nonatomic) _Bool hf_supportsPreferredMediaUser;
@property(readonly, nonatomic) _Bool hf_supportsHomeTheater;
- (id)hf_destination;	// IMP=0x0020000000232f9c
- (id)hf_updateDateAdded:(id)arg1;	// IMP=0x0020000000232f2b
@property(readonly, copy, nonatomic) NSDate *hf_dateAdded;
@property(readonly, copy, nonatomic) NSString *hf_displayName;
- (id)hf_stateDumpBuilderWithContext:(id)arg1;	// IMP=0x0020000000232e87
- (id)hf_updateShowInHomeDashboard:(_Bool)arg1;	// IMP=0x0020000000232e70
...
- (id)hf_updateIsFavorite:(_Bool)arg1;	// IMP=0x0020000000232dde
...
- (id)hf_fetchLog:(id)arg1 timeout:(double)arg2;	// IMP=0x0020000000232ca8
- (id)hf_fetchLogListWithTimeout:(double)arg1;	// IMP=0x0020000000232c2c
- (id)hf_idsDeviceIdentifierWithError:(id *)arg1;	// IMP=0x0020000000232b86
- (id)hf_siriLanguageOptionsManager;	// IMP=0x002000000023292e
- (id)hf_mediaAccessoryCommonSettingsManager;	// IMP=0x00200000002327fe
@property(readonly, nonatomic) HFHomeKitSettingsValueManager *hf_settingsValueManager;
- (id)hf_isEitherHomePodMediaAccountOrHomeMediaAccountPresent;	// IMP=0x0020000000231f0e
- (id)hf_homePodMediaAccountIsMismatchedWithHomeMediaAccount;	// IMP=0x00200000002315a0
- (id)hf_homePodSupportsMultiUserLanguage;	// IMP=0x0020000000231598
- (id)hf_appleMusicCurrentLoggedInAccountDSID;	// IMP=0x0020000000231590
- (id)hf_appleMusicCurrentLoggedInAccount;	// IMP=0x0020000000231588
...
- (_Bool)hf_offersAutomation;	// IMP=0x0020000000230442
...
- (id)hf_rootAccessoryLikeHomeKitObject;	// IMP=0x0020000000291881
