...
- (void).cxx_destruct;	// IMP=0x000000000000c1a0
...
- (id)initWithVisionIdentifier:(id)arg1 minConfidence:(double)arg2 commonBlockingTokens:(id)arg3 categoryBlockingTokens:(id)arg4 categoryBlockingTokensAnnex:(id)arg5;	// IMP=0x000000000000bfe0
