...
- (void).cxx_destruct;	// IMP=0x000000000005c300
- (id)computeCaptionForImageWithInputs:(id)arg1 genderOption:(int)arg2;	// IMP=0x000000000005b430
- (void)extractBeamID:(id *)arg1 tokenID:(id *)arg2 lstmAttnState:(CDStruct_0a65202a *)arg3 lstmLangState:(CDStruct_0a65202a *)arg4 fromFollowup:(id)arg5;	// IMP=0x000000000005b200
- (id)packBeamID:(id)arg1 tokenID:(id)arg2 lstmAttnState:(CDStruct_0a65202a *)arg3 lstmLangState:(CDStruct_0a65202a *)arg4 softmax:(CDStruct_0a65202a *)arg5;	// IMP=0x000000000005af10
- (void)dealloc;	// IMP=0x000000000005ae70
- (id)initWithOptions:(id)arg1 runTimeParams:(id)arg2;	// IMP=0x000000000005a170
