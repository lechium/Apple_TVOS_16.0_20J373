...
- (id).cxx_construct;	// IMP=0x0000000000040ce0
- (void).cxx_destruct;	// IMP=0x0000000000040bf0
...
- (void)_runBlockWithCopyOutputBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000000401b0
- (void)runBlockWithCopyInput:(float *)arg1 copyOutputBlock:(CDUnknownBlockType)arg2;	// IMP=0x0000000000040010
- (void)runBlockWithCopyInputBlock:(CDUnknownBlockType)arg1 copyOutputBlock:(CDUnknownBlockType)arg2;	// IMP=0x000000000003fdf0
- (void)copyOutputState:(id)arg1;	// IMP=0x000000000003f670
- (void)copyInputState:(id)arg1;	// IMP=0x000000000003f130
- (void)buildNetworkForSequenceLength:(unsigned long long)arg1 imageFeatures:(id)arg2;	// IMP=0x000000000003c200
- (_Bool)_loadNetwork:(id)arg1 modelIndex:(unsigned long long)arg2;	// IMP=0x000000000003afa0
- (void)dealloc;	// IMP=0x000000000003ae80
- (id)initWithOptions:(id)arg1 modelIndex:(unsigned long long)arg2 runTimeParams:(id)arg3;	// IMP=0x000000000003ac60
