...
- (void).cxx_destruct;	// IMP=0x0000000000032120
...
- (void)run:(id)arg1 block:(CDUnknownBlockType)arg2;	// IMP=0x0000000000031c20
- (id)initWithOptions:(id)arg1;	// IMP=0x0000000000031b10
