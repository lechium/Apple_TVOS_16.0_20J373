...
- (id)nextObject;	// IMP=0x0000000000004845
- (id)allObjects;	// IMP=0x000000000000472d
- (id)initWithFlatPlist:(id)arg1 offset:(unsigned long long)arg2 count:(unsigned long long)arg3;	// IMP=0x0000000000004688
