...
- (void).cxx_destruct;	// IMP=0x000000000009d7be
...
- (id)initWithQueue:(id)arg1 wakingTopics:(id)arg2 opportunisticTopics:(id)arg3 nonWakingTopics:(id)arg4 commands:(id)arg5;	// IMP=0x000000000009d5e4
