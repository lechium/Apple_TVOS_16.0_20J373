...
+ (id)notificationFromRemoteNotificationDictionary:(id)arg1;	// IMP=0x00600000000a44d1
+ (Class)__class;	// IMP=0x00600000000a4481
- (void).cxx_destruct;	// IMP=0x00000000000a453e
