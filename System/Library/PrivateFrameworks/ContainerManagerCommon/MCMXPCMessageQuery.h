...
- (void).cxx_destruct;	// IMP=0x000000000008d410
...
- (unsigned int)disposition;	// IMP=0x000000000008ced3
- (id)initWithXPCObject:(id)arg1 context:(id)arg2 error:(unsigned long long *)arg3;	// IMP=0x000000000008c4d1
