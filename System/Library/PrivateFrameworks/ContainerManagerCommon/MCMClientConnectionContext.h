...
- (void).cxx_destruct;	// IMP=0x000000000008daaa
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000008d814
- (id)clientConnectionContextForCurrentThread;	// IMP=0x000000000008d777
- (id)initForCurrentThreadContextWithXPCConnection:(id)arg1 userIdentityCache:(id)arg2;	// IMP=0x000000000008d695
