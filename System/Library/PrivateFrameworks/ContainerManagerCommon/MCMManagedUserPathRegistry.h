...
- (void).cxx_destruct;	// IMP=0x0000000000038483
...
- (void)_initPathPropertiesWithUserHomeDirectoryURL:(id)arg1 clientUser:(id)arg2;	// IMP=0x0000000000038079
- (id)initWithUserIdentity:(id)arg1 daemonUser:(id)arg2;	// IMP=0x0000000000037ed9
