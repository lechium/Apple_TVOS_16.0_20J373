...
+ (id)_readAndValidateReplaceFileAtUrl:(id)arg1 error:(id *)arg2;	// IMP=0x00100000000c5ad0
+ (_Bool)recoverFromReplaceOperationsWithError:(id *)arg1;	// IMP=0x00100000000c4e8e
+ (Class)incomingMessageClass;	// IMP=0x00100000000c4e52
+ (unsigned long long)command;	// IMP=0x00100000000c4e1c
- (void).cxx_destruct;	// IMP=0x00000000000c4dc8
...
- (_Bool)_writeToDiskReplaceAt:(id)arg1 old:(id)arg2 withNew:(id)arg3 usingStaging:(id)arg4 toDestination:(id)arg5 error:(id *)arg6;	// IMP=0x00000000000c479a
- (void)execute;	// IMP=0x00000000000c0a6b
- (_Bool)preflightClientAllowed;	// IMP=0x00000000000c09d2
- (id)initWithMessage:(id)arg1 context:(id)arg2 reply:(id)arg3;	// IMP=0x00000000000c08c6
- (id)initWithConcreteContainerIdentityOld:(id)arg1 concreteContainerIdentityNew:(id)arg2 preserveOldPathIdentifier:(_Bool)arg3 preserveOldInternalUUID:(_Bool)arg4 asyncReclaim:(_Bool)arg5 context:(id)arg6 resultPromise:(id)arg7;	// IMP=0x00000000000c07c4
