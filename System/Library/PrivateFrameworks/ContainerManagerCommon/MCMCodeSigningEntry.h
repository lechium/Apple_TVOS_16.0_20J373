...
- (void).cxx_destruct;	// IMP=0x00000000000bf29e
...
- (id)description;	// IMP=0x00000000000beec0
- (unsigned long long)hash;	// IMP=0x00000000000bed6d
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000bea67
- (id)serialize;	// IMP=0x00000000000be7a6
- (id)initWithSerializedDictionary:(id)arg1;	// IMP=0x00000000000be57b
- (id)initWithCodeSigningInfo:(id)arg1;	// IMP=0x00000000000be53c
- (id)initWithCodeSigningInfo:(id)arg1 andDataContainerClass:(unsigned long long)arg2;	// IMP=0x00000000000be486
