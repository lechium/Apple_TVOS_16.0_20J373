...
- (void).cxx_destruct;	// IMP=0x0000000000037dfc
...
- (void)_initPathPropertiesWithDaemonUser:(id)arg1;	// IMP=0x00000000000375c4
- (void)_addPaths:(id)arg1;	// IMP=0x000000000003756b
- (id)managedPathForURL:(id)arg1;	// IMP=0x0000000000037392
- (id)orderedPathsFromPaths:(id)arg1;	// IMP=0x000000000003700a
- (id)initWithDaemonUser:(id)arg1 privileged:(_Bool)arg2;	// IMP=0x0000000000036e73
