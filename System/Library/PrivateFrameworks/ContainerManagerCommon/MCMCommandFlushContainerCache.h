...
+ (Class)incomingMessageClass;	// IMP=0x0010000000019f7f
+ (unsigned long long)command;	// IMP=0x0010000000019f49
- (void).cxx_destruct;	// IMP=0x0000000000019f0b
...
- (void)execute;	// IMP=0x0000000000019b41
- (_Bool)preflightClientAllowed;	// IMP=0x0000000000019aa8
- (id)initWithMessage:(id)arg1 context:(id)arg2 reply:(id)arg3;	// IMP=0x00000000000199b6
