...
+ (Class)incomingMessageClass;	// IMP=0x0010000000072c73
+ (unsigned long long)command;	// IMP=0x0010000000072c3d
- (void).cxx_destruct;	// IMP=0x0000000000072bff
...
- (void)execute;	// IMP=0x0000000000072696
- (_Bool)preflightClientAllowed;	// IMP=0x00000000000725fd
- (id)initWithMessage:(id)arg1 context:(id)arg2 reply:(id)arg3;	// IMP=0x000000000007250b
