...
- (void).cxx_destruct;	// IMP=0x000000000009d942
@property(retain, nonatomic) RBSTerminationAssertion *termAssertion; // @synthesize termAssertion=_termAssertion;
- (void)dealloc;	// IMP=0x000000000009d844
- (void)invalidate;	// IMP=0x000000000009d77b
- (id)initWithBundleIdentifier:(id)arg1 reason:(id)arg2;	// IMP=0x000000000009d0c0
