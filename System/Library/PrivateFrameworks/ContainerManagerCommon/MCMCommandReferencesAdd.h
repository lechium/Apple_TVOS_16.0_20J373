...
+ (Class)incomingMessageClass;	// IMP=0x001000000001335e
+ (unsigned long long)command;	// IMP=0x0010000000013328
...
- (id)_resolveUserIdentity;	// IMP=0x0000000000012d74
- (void)execute;	// IMP=0x0000000000012215
- (_Bool)preflightClientAllowed;	// IMP=0x000000000001217c
- (id)initWithMessage:(id)arg1 context:(id)arg2 reply:(id)arg3;	// IMP=0x0000000000012037
