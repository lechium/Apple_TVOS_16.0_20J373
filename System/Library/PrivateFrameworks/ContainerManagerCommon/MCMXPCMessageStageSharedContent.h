...
- (void).cxx_destruct;	// IMP=0x0000000000052756
...
- (unsigned int)disposition;	// IMP=0x0000000000052655
- (id)initWithXPCObject:(id)arg1 context:(id)arg2 error:(unsigned long long *)arg3;	// IMP=0x0000000000052553
