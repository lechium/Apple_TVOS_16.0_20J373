...
+ (id)contextWithHomeDirectoryURL:(id)arg1 containerPath:(id)arg2 POSIXMode:(unsigned short)arg3 POSIXOwner:(id)arg4 containerClass:(unsigned long long)arg5 dataProtectionClass:(int)arg6 libraryRepair:(id)arg7 identifier:(id)arg8;	// IMP=0x006000000006b1b7
- (void).cxx_destruct;	// IMP=0x000000000006b14b
...
- (id)initWithHomeDirectoryURL:(id)arg1 containerPath:(id)arg2 POSIXMode:(unsigned short)arg3 POSIXOwner:(id)arg4 containerClass:(unsigned long long)arg5 dataProtectionClass:(int)arg6 libraryRepair:(id)arg7 identifier:(id)arg8;	// IMP=0x000000000006ae69
