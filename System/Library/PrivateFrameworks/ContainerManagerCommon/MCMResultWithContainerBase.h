...
- (void).cxx_destruct;	// IMP=0x0000000000092d13
...
- (void)dealloc;	// IMP=0x00000000000929c1
- (id)initWithMetadata:(id)arg1 sandboxToken:(const char *)arg2 includePath:(_Bool)arg3 includeInfo:(_Bool)arg4 resolvedLinks:(id)arg5;	// IMP=0x00000000000926dc
- (id)initWithContainerPath:(id)arg1 containerIdentity:(id)arg2 uuid:(id)arg3 sandboxToken:(const char *)arg4 includePath:(_Bool)arg5;	// IMP=0x00000000000924bd
- (id)initWithUUID:(id)arg1 containerPathIdentifier:(id)arg2 identifier:(id)arg3 containerClass:(unsigned long long)arg4 POSIXUser:(id)arg5 personaUniqueString:(id)arg6 sandboxToken:(const char *)arg7 existed:(_Bool)arg8 url:(id)arg9 info:(id)arg10 resolvedLinks:(id)arg11 transient:(_Bool)arg12;	// IMP=0x000000000009229f
- (_Bool)encodeResultOntoReply:(id)arg1;	// IMP=0x0000000000091d2d
