...
- (void).cxx_destruct;	// IMP=0x00000000000b5619
...
- (void)dealloc;	// IMP=0x00000000000b54a6
- (id)initWithPath:(id)arg1 existed:(_Bool)arg2 sandboxToken:(const char *)arg3;	// IMP=0x00000000000b53db
- (id)initWithURL:(id)arg1 existed:(_Bool)arg2 sandboxToken:(const char *)arg3;	// IMP=0x00000000000b531a
- (_Bool)encodeResultOntoReply:(id)arg1;	// IMP=0x00000000000b5177
