...
+ (Class)incomingMessageClass;	// IMP=0x001000000009399f
+ (unsigned long long)command;	// IMP=0x0010000000093969
...
- (void)execute;	// IMP=0x0000000000092f71
- (_Bool)preflightClientAllowed;	// IMP=0x0000000000092f3e
- (id)initWithMessage:(id)arg1 context:(id)arg2 reply:(id)arg3;	// IMP=0x0000000000092dcd
