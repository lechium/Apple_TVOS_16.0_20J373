...
- (void).cxx_destruct;	// IMP=0x00000000000be2f9
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000be1bd
- (id)description;	// IMP=0x00000000000be0bd
- (struct container_link_s *)createLibsystemLinkWithError:(unsigned long long *)arg1;	// IMP=0x00000000000bdf8a
- (id)initWithLibsystemLink:(struct container_link_s *)arg1 defaultUserIdentity:(id)arg2 userIdentityCache:(id)arg3 error:(unsigned long long *)arg4;	// IMP=0x00000000000bdde5
- (id)initWithOriginContainerIdentityForLibsystem:(id)arg1 containerIdentityForLibsystem:(id)arg2 attributes:(unsigned long long)arg3 implied:(_Bool)arg4;	// IMP=0x00000000000bdd13
