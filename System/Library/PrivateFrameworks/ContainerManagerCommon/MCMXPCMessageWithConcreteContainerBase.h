...
- (void).cxx_destruct;	// IMP=0x0000000000071216
...
- (id)initWithXPCObject:(id)arg1 context:(id)arg2 error:(unsigned long long *)arg3;	// IMP=0x0000000000070f40
- (id)initWithConcreteContainer:(id)arg1 context:(id)arg2;	// IMP=0x0000000000070ea5
