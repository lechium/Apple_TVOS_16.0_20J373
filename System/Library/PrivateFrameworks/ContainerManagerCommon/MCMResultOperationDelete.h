...
- (void).cxx_destruct;	// IMP=0x0000000000091848
@property(retain, nonatomic) NSObject<OS_xpc_object> *xpcToMerge; // @synthesize xpcToMerge=_xpcToMerge;
- (_Bool)encodeResultOntoReply:(id)arg1;	// IMP=0x0000000000091620
- (void)mergeWithXPCResult:(id)arg1;	// IMP=0x00000000000915e3
