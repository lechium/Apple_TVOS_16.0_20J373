...
- (void).cxx_destruct;	// IMP=0x000000000006e22c
...
- (void)dealloc;	// IMP=0x000000000006e0f4
- (_Bool)encodeResultOntoReply:(id)arg1;	// IMP=0x000000000006dfa2
- (id)initWithSandboxToken:(const char *)arg1 personaUniqueString:(id)arg2 url:(id)arg3;	// IMP=0x000000000006dea4
