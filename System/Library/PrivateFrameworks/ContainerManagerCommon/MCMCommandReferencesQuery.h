...
+ (Class)incomingMessageClass;	// IMP=0x0010000000067bcf
+ (unsigned long long)command;	// IMP=0x0010000000067b99
- (void).cxx_destruct;	// IMP=0x000000000006796d
...
- (void)execute;	// IMP=0x000000000006742a
- (_Bool)preflightClientAllowed;	// IMP=0x0000000000067391
- (id)initWithMessage:(id)arg1 context:(id)arg2 reply:(id)arg3;	// IMP=0x0000000000067273
