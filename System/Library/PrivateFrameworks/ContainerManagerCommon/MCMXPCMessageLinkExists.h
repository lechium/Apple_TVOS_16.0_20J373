...
- (void).cxx_destruct;	// IMP=0x0000000000038be1
...
- (unsigned int)disposition;	// IMP=0x0000000000038aa4
- (id)initWithXPCObject:(id)arg1 context:(id)arg2 error:(unsigned long long *)arg3;	// IMP=0x000000000003852c
