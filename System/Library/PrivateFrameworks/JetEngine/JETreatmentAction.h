...
+ (id)treatmentActionWithField:(id)arg1 configuration:(id)arg2 topic:(id)arg3;	// IMP=0x006000000002f43d
- (void).cxx_destruct;	// IMP=0x000000000003093b
- (id)performAction:(id)arg1 context:(id)arg2;	// IMP=0x00000000000300db
- (void)performActionWithContext:(id)arg1;	// IMP=0x000000000002fab9
- (id)initWithField:(id)arg1 configuration:(id)arg2;	// IMP=0x000000000002f62c
