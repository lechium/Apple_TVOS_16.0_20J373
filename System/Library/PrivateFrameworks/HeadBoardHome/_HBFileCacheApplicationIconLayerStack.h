...
- (void).cxx_destruct;	// IMP=0x000000000005e5cc
...
- (void)_deflateLayerStack;	// IMP=0x000000000005e3ff
- (void)_inflateLayerStack;	// IMP=0x000000000005dfb2
...
- (id)imageConfigurationForConfiguration:(id)arg1;	// IMP=0x000000000005de37
- (id)initWithApplication:(id)arg1;	// IMP=0x000000000005d993
