...
+ (id)_authenticationTypeFromStringedType:(id)arg1;	// IMP=0x0010000000090f65
+ (long long)_serviceTypeFromType:(long long)arg1;	// IMP=0x0010000000090e0a
- (void).cxx_destruct;	// IMP=0x00000000000910da
...
- (id)runAction;	// IMP=0x000000000009090f
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x00000000000900cf
