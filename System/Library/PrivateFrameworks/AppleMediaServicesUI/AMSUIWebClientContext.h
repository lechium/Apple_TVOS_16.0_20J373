...
@interface AMSUIWebClientContext : NSObject
{
    ...
    id <AMSBagProtocol> _backingBag;	// 144 = 0x90
}

+ (id)_createClientInfoFromAccount:(id)arg1 clientInfo:(id)arg2;	// IMP=0x006000000005bf74
+ (_Bool)_boolForKey:(id)arg1 defaultValue:(_Bool)arg2 domain:(struct __CFString *)arg3;	// IMP=0x006000000005bf0a
- (void).cxx_destruct;	// IMP=0x000000000005c5f5
...
- (void)updateBackingBag:(id)arg1;	// IMP=0x000000000005bef8
- (void)replaceCurrentAccount:(id)arg1 clientInfo:(id)arg2;	// IMP=0x000000000005b8f9
- (id)loadSnapshot;	// IMP=0x000000000005b608
- (id)JSAccountFromAccount:(id)arg1 store:(id)arg2;	// IMP=0x000000000005b02d
- (id)iTunesAccountFromJSDSID:(id)arg1;	// IMP=0x000000000005af13
- (id)iTunesAccountFromJSAccount:(id)arg1;	// IMP=0x000000000005aa58
...
- (id)initWithAccount:(id)arg1 clientInfo:(id)arg2 backingBag:(id)arg3;	// IMP=0x000000000005a7ff
