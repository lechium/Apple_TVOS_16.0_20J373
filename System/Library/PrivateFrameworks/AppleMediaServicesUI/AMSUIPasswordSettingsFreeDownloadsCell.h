...
- (void).cxx_destruct;	// IMP=0x000000000003d819
...
- (void)_toggleChanged:(id)arg1;	// IMP=0x000000000003d71b
- (long long)selectionStyle;	// IMP=0x000000000003d713
- (void)_setup;	// IMP=0x000000000003d605
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x000000000003d5b9
