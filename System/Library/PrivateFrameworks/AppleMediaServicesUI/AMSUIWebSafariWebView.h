...
+ (id)_createContentControllerWithScheme:(id)arg1 data:(id)arg2 messageHandler:(id)arg3;	// IMP=0x001000000008da0c
- (void).cxx_destruct;	// IMP=0x000000000008e088
...
- (void)webView:(id)arg1 stopURLSchemeTask:(id)arg2;	// IMP=0x000000000008d84e
- (void)webView:(id)arg1 startURLSchemeTask:(id)arg2;	// IMP=0x000000000008d34a
- (void)userContentController:(id)arg1 didReceiveScriptMessage:(id)arg2 replyHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000008d031
@property(nonatomic) double topInset;
- (id)initWithAppearance:(id)arg1 scheme:(id)arg2 data:(id)arg3 delegate:(id)arg4;	// IMP=0x000000000008ccac
