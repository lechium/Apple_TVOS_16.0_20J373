...
- (void).cxx_destruct;	// IMP=0x0000000000079519
...
- (id)_runMediaRequestWithType:(long long)arg1 clientIdentifier:(id)arg2 clientVersion:(id)arg3;	// IMP=0x0000000000079131
- (id)_runMediaRequestWithURL:(id)arg1 clientIdentifier:(id)arg2 clientVersion:(id)arg3;	// IMP=0x0000000000078cce
- (id)runAction;	// IMP=0x00000000000789fa
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x000000000007868f
