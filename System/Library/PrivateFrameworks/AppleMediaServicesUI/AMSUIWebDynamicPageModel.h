...
- (void).cxx_destruct;	// IMP=0x0000000000063a54
...
- (id)loadPage;	// IMP=0x00000000000635ba
@property(readonly, nonatomic) _Bool disableReappearPlaceholder;
- (id)createViewControllerForContainer:(id)arg1;	// IMP=0x0000000000063420
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x0000000000063070
