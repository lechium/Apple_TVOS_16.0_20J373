...
+ (id)_campaignAttributionTaskForURL:(id)arg1;	// IMP=0x006000000005a068
...
- (id)runAction;	// IMP=0x00000000000596a5
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x00000000000591d1
