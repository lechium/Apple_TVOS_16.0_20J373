...
- (void).cxx_destruct;	// IMP=0x000000000004a7da
...
- (void)viewTapped:(id)arg1;	// IMP=0x000000000004a672
- (_Bool)gestureRecognizer:(id)arg1 shouldReceiveTouch:(id)arg2;	// IMP=0x000000000004a5ef
- (void)mediaPause;	// IMP=0x000000000004a516
@property(readonly, nonatomic) struct CGSize expectedContentSize;
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000000004998d
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x000000000004989d
- (void)viewWillLayoutSubviews;	// IMP=0x0000000000048fbe
- (void)setPreferredContentSize:(struct CGSize)arg1;	// IMP=0x0000000000048f39
- (void)loadView;	// IMP=0x0000000000048b18
- (void)dealloc;	// IMP=0x0000000000048a56
- (id)initWithNotification:(id)arg1 delegate:(id)arg2;	// IMP=0x0000000000047c40
