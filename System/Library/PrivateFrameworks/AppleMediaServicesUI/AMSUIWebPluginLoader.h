...
- (void).cxx_destruct;	// IMP=0x0000000000085cf6
...
- (id)_loadInstalledPlugins;	// IMP=0x0000000000085966
- (id)pluginForBundleIdentifier:(id)arg1;	// IMP=0x00000000000850ac
@property(readonly, nonatomic) NSArray *loadedPlugins;
- (id)initWithContext:(id)arg1;	// IMP=0x0000000000084fb3
