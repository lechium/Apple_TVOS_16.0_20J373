...
- (void)updateContentSize;	// IMP=0x00000000000384df
- (void)setFrame:(struct CGRect)arg1;	// IMP=0x000000000003848d
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00000000000382b1
- (void)adjustedContentInsetDidChange;	// IMP=0x000000000003825b
- (void)layoutSubviews;	// IMP=0x0000000000037bde
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000378b4
