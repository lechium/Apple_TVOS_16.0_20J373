...
+ (id)_messageFromError:(id)arg1;	// IMP=0x0010000000065230
- (void).cxx_destruct;	// IMP=0x000000000006552f
...
- (id)loadPage;	// IMP=0x0000000000065217
@property(readonly, nonatomic) _Bool disableReappearPlaceholder;
- (id)createViewControllerForContainer:(id)arg1;	// IMP=0x00000000000651a6
@property(readonly, copy) NSString *description;
@property(readonly, nonatomic) NSString *errorMessage; // @synthesize errorMessage=_errorMessage;
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x000000000006495c
- (id)initWithError:(id)arg1 context:(id)arg2 actionBlock:(CDUnknownBlockType)arg3;	// IMP=0x00000000000646c5
