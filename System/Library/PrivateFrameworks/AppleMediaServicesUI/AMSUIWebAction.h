...
- (void).cxx_destruct;	// IMP=0x000000000004c663
...
- (id)runAction;	// IMP=0x000000000004c549
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x000000000004c3c4
- (id)initWithContext:(id)arg1;	// IMP=0x000000000004c359
