...
- (void).cxx_destruct;	// IMP=0x000000000007de32
...
- (id)_createSession;	// IMP=0x000000000007dc5f
- (id)runAction;	// IMP=0x000000000007c8bf
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x000000000007c24c
