...
- (void).cxx_destruct;	// IMP=0x0000000000087f07
...
- (id)loadPage;	// IMP=0x0000000000087dbe
@property(readonly, nonatomic) _Bool disableReappearPlaceholder;
- (id)createViewControllerForContainer:(id)arg1;	// IMP=0x0000000000087bfe
@property(readonly, copy) NSString *description;
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x00000000000872c1
