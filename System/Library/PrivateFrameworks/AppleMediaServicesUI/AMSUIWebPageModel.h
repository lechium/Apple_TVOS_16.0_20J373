...
- (id)loadPage;	// IMP=0x0000000000080f95
@property(readonly, nonatomic) _Bool disableReappearPlaceholder;
- (id)createViewControllerForContainer:(id)arg1;	// IMP=0x0000000000080f39
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x0000000000080c2a
