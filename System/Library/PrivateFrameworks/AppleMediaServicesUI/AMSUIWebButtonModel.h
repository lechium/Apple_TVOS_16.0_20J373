...
- (void).cxx_destruct;	// IMP=0x00000000000524e3
...
- (id)_imageForButtonWithNavStyle:(long long)arg1;	// IMP=0x0000000000052295
@property(readonly, copy) NSString *description;
- (id)createDialogAction;	// IMP=0x0000000000052156
- (id)_createProxCardItemWithTarget:(id)arg1 selector:(SEL)arg2;	// IMP=0x000000000005214e
- (id)_createSpinnerItem;	// IMP=0x0000000000052085
- (id)_createAppViewItemWithModel:(id)arg1;	// IMP=0x0000000000051b0a
- (long long)_barButtonItemStyle;	// IMP=0x0000000000051af1
- (id)createBarButtonItemWithTarget:(id)arg1 selector:(SEL)arg2 navBar:(id)arg3;	// IMP=0x00000000000517a8
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x0000000000051323
- (id)initWithAppViewObject:(id)arg1 context:(id)arg2;	// IMP=0x000000000005121e
