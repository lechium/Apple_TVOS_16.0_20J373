...
- (void).cxx_destruct;	// IMP=0x0000000000056cef
...
- (id)_createLabelWithLines:(long long)arg1 title:(_Bool)arg2;	// IMP=0x0000000000056bc6
- (id)_createButtonWithTarget:(id)arg1 selector:(SEL)arg2;	// IMP=0x0000000000056a0d
- (void)_bottomLinkSelected:(id)arg1;	// IMP=0x00000000000569c8
- (void)layoutSubviews;	// IMP=0x00000000000564b0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000562e5
