...
+ (id)timeoutWithTimeout:(double)arg1 queue:(id)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x006000000006ef70
...
- (void)reset;	// IMP=0x000000000006f5e7
- (void)pause;	// IMP=0x000000000006f3ab
- (void)start;	// IMP=0x000000000006eff8
- (id)initWithTimeout:(double)arg1 queue:(id)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x000000000006eeb9
