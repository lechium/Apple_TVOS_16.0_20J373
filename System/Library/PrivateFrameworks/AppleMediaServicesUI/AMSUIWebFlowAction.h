...
- (void).cxx_destruct;	// IMP=0x000000000006aaea
...
- (void)_runWithType:(long long)arg1 options:(id)arg2;	// IMP=0x000000000006a63f
- (id)runAction;	// IMP=0x000000000006a22a
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x0000000000069c27
- (id)initWithContext:(id)arg1;	// IMP=0x0000000000069be4
