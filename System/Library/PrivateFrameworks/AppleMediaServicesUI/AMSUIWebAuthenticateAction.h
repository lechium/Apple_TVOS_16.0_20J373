...
- (void).cxx_destruct;	// IMP=0x000000000004f1c1
...
- (id)_responseForAccount:(id)arg1;	// IMP=0x000000000004efd0
- (void)_updateContextWithAccountIfNeeded:(id)arg1;	// IMP=0x000000000004eea3
- (id)runAction;	// IMP=0x000000000004e7bd
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x000000000004df2a
