...
- (void).cxx_destruct;	// IMP=0x000000000000b374
...
- (id)_serviceContextWithResults:(id)arg1 parentViewController:(id)arg2;	// IMP=0x000000000000b133
- (id)performAuthenticate;	// IMP=0x000000000000aba4
- (id)initWithAuthRequest:(id)arg1 presentingViewController:(id)arg2;	// IMP=0x000000000000ab02
