...
- (void).cxx_destruct;	// IMP=0x0000000000076941
...
- (id)loadPage;	// IMP=0x00000000000768a0
@property(readonly, nonatomic) _Bool disableReappearPlaceholder;
- (id)createViewControllerForContainer:(id)arg1;	// IMP=0x0000000000076813
@property(readonly, copy) NSString *description;
- (id)initWithJSObject:(id)arg1 context:(id)arg2;	// IMP=0x0000000000076224
- (id)initWithContext:(id)arg1;	// IMP=0x00000000000761b9
