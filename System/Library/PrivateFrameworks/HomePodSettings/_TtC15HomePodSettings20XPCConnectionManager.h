...
- (void)removeProfileWithIdentifier:(NSString *)arg1 completionHandler:(void (^)(NSError *))arg2;	// IMP=0x000000000002f2a0
- (void)installedProfilesWithCompletionHandler:(void (^)(NSDictionary *, NSError *))arg1;	// IMP=0x000000000002ef40
- (void)installProfileWithData:(NSData *)arg1 completionHandler:(void (^)(NSString *, NSError *))arg2;	// IMP=0x000000000002e990
