...
+ (id)px_fetchAssetCollectionsWithAlbumSubtypes:(id)arg1 photoLibrary:(id)arg2;	// IMP=0x0010000000725d48
+ (id)px_fetchSmartAlbumCollectionsBySubtypeForAlbumSubtypes:(id)arg1 photoLibrary:(id)arg2;	// IMP=0x0010000000725918
+ (id)px_contentSyndicationVirtualCollection;	// IMP=0x00100000007258e8
+ (id)px_importHistoryAssetCollection;	// IMP=0x00100000007258b8
+ (id)px_sharedActivityVirtualCollection;	// IMP=0x0010000000725888
+ (id)px_completeMyMomentVirtualCollection;	// IMP=0x0010000000725858
+ (id)px_prototypeVirtualCollection;	// IMP=0x0010000000725828
+ (id)px_searchVirtualCollection;	// IMP=0x00100000007257f8
+ (id)px_sharedAlbumsVirtualCollection;	// IMP=0x00100000007257c8
+ (id)px_myAlbumsVirtualCollection;	// IMP=0x0010000000725798
+ (id)px_allAlbumsVirtualCollection;	// IMP=0x0010000000725768
+ (id)px_forYouVirtualCollection;	// IMP=0x0010000000725738
+ (id)px_memoriesVirtualCollection;	// IMP=0x0010000000725708
+ (id)px_peopleVirtualCollection;	// IMP=0x00100000007256d8
+ (id)px_photosVirtualCollection;	// IMP=0x00100000007256a8
+ (id)px_momentsVirtualCollection;	// IMP=0x0010000000725678
+ (id)px_fetchSmartAlbumWithSubtype:(long long)arg1;	// IMP=0x00100000007254f5
+ (id)px_smartAlbumWithSubtype:(long long)arg1;	// IMP=0x00100000007254a5
+ (id)px_regularAlbumWithTitle:(id)arg1;	// IMP=0x00100000007253a2
+ (id)px_otherAlbumsSubtypes;	// IMP=0x001000000072533f
+ (id)px_mediaTypeSmartAlbumSubtypes;	// IMP=0x00100000007252dc
+ (void)px_getType:(long long *)arg1 subtype:(long long *)arg2 forBuiltInAlbumName:(id)arg3;	// IMP=0x0010000000724ef4
+ (id)px_builtInAlbumNameForSubtype:(long long)arg1;	// IMP=0x0010000000724c93
...
- (id)localizedDateDescriptionWithOptions:(unsigned long long)arg1;	// IMP=0x0010000000530eef
...
- (void)px_assignStoryTitleCategoryIfNeeded;	// IMP=0x0010000000723579
- (_Bool)px_isTransientCollectionWithIdentifier:(id)arg1;	// IMP=0x00100000007234f9
...
- (id)px_debugDictionary;	// IMP=0x0010000000722b6c
- (unsigned long long)px_assetsDropMode;	// IMP=0x0010000000722acf
- (_Bool)px_shouldUseFacesRectForSmartCropping;	// IMP=0x0010000000722ac7
- (_Bool)px_fetchIsEmptyWithOptions:(id)arg1;	// IMP=0x0010000000722984
