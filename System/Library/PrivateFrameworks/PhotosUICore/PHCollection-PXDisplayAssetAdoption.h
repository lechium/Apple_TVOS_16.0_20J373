...
- (_Bool)px_isTransientCollectionWithIdentifier:(id)arg1;	// IMP=0x00200000007220d4
@property(readonly, nonatomic) NSDictionary *px_debugDictionary;
- (_Bool)px_fetchIsEmptyWithOptions:(id)arg1;	// IMP=0x0020000000721f66
- (_Bool)px_fetchIsEmpty;	// IMP=0x0020000000721eeb
- (id)px_fetchContainedAssetCollections;	// IMP=0x0020000000721e2e
- (id)px_fetchAncestryIncludingRoot:(_Bool)arg1;	// IMP=0x0020000000721c86
