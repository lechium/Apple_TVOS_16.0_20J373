...
+ (id)px_otherAlbumsCollectionListIncludeDeleted:(_Bool)arg1 includeHidden:(_Bool)arg2 includeDuplicates:(_Bool)arg3;	// IMP=0x0010000000724624
+ (id)_otherAlbumAssetCollectionsIncludingRecentlyDeleted:(_Bool)arg1 includeHidden:(_Bool)arg2 includeDuplicates:(_Bool)arg3 includingSharedLibrary:(_Bool)arg4 includingDebugAlbums:(_Bool)arg5;	// IMP=0x00100000007237a5
+ (id)_otherAlbumsCollectionListWithDeletedCollection:(_Bool)arg1 withHiddenCollection:(_Bool)arg2 withDuplicatesCollection:(_Bool)arg3;	// IMP=0x00100000007236dd
+ (id)px_mediaTypesCollectionList;	// IMP=0x00100000007236ad
+ (id)px_sharedAlbumsAndActivityCollectionList;	// IMP=0x001000000072367d
+ (id)px_sharedAlbumsCollectionList;	// IMP=0x001000000072364d
+ (id)px_rootAlbumCollectionList;	// IMP=0x00100000007235e6
+ (id)px_rootProjectCollectionList;	// IMP=0x001000000072357f
...
- (_Bool)px_isTransientCollectionWithIdentifier:(id)arg1;	// IMP=0x0010000000722661
- (_Bool)px_isContainedInCollectionList:(id)arg1;	// IMP=0x0010000000722535
...
- (_Bool)px_fetchIsEmptyWithOptions:(id)arg1;	// IMP=0x001000000072232e
