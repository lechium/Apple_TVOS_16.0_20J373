...
+ (_Bool)needsDisplayForKey:(id)arg1;	// IMP=0x006000000000a2f6
...
- (void)drawInContext:(struct CGContext *)arg1;	// IMP=0x000000000000a3b7
- (id)initWithLayer:(id)arg1;	// IMP=0x000000000000a109
- (id)init;	// IMP=0x0000000000009fd4
