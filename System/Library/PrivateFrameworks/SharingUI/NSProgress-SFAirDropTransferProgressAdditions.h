...
+ (id)sf_transferStateAsString:(long long)arg1;	// IMP=0x002000000002c4af
+ (id)sf_publishingKeyForApp:(id)arg1 sessionID:(id)arg2;	// IMP=0x002000000002bf7c
@property(readonly, nonatomic) NSString *sf_error;
- (void)sf_failedWithError:(id)arg1;	// IMP=0x001000000002c631
@property(nonatomic) long long sf_transferState;
@property(nonatomic) unsigned int sf_initiator;
- (id)sf_initWithFileURL:(id)arg1;	// IMP=0x001000000002c34c
...
- (id)sf_initWithAppBundle:(id)arg1 sessionID:(id)arg2 andPersonRealName:(id)arg3;	// IMP=0x001000000002bfa4
@end
