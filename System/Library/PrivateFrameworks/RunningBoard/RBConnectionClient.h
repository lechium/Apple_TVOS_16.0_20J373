...
- (void).cxx_destruct;	// IMP=0x000000000003bfac
- (id)captureState;	// IMP=0x000000000003bf70
@property(readonly, copy, nonatomic) NSString *stateCaptureTitle;
- (void)inheritanceManager:(id)arg1 didChangeInheritances:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000003ae57
@property(readonly, copy) NSString *description;
- (_Bool)hasEntitlementDomain:(unsigned long long)arg1;	// IMP=0x00000000000380ae
- (_Bool)hasEntitlement:(id)arg1;	// IMP=0x0000000000038095
- (id)init;	// IMP=0x000000000002f5f3
