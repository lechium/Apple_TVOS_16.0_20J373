...
- (id)asTableWithTransform:(id)arg1 schema:(id)arg2;	// IMP=0x003000000005203b
- (id)trackDerivatesInDBAtURL:(id)arg1 derivedTableName:(id)arg2;	// IMP=0x003000000008c115
@end
