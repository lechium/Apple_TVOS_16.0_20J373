...
- (id)pipelineForConfiguration:(id)arg1;	// IMP=0x0000000000014cb3
- (id)initWithDeviceSPI:(id)arg1 librarySPI:(id)arg2;	// IMP=0x0000000000014bb2
- (id)initWithDevice:(id)arg1 library:(id)arg2;	// IMP=0x0000000000014a93
