...
+ (id)animationWithDuration:(double)arg1 startValue:(unsigned long long)arg2 endValue:(unsigned long long)arg3 timingFunction:(id)arg4 applier:(CDUnknownBlockType)arg5;	// IMP=0x001000000001bf3c
- (void).cxx_destruct;	// IMP=0x000000000001c2e8
...
- (void)completeAnimation;	// IMP=0x000000000001c219
- (_Bool)isAnimating;	// IMP=0x000000000001c208
- (void)update:(double)arg1;	// IMP=0x000000000001c105
- (void)dealloc;	// IMP=0x000000000001c0a7
- (id)initWithDuration:(double)arg1 startValue:(unsigned long long)arg2 endValue:(unsigned long long)arg3 timingFunction:(id)arg4 applier:(CDUnknownBlockType)arg5;	// IMP=0x000000000001bfd0
