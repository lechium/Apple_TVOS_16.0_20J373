...
+ (id)animationWithDuration:(double)arg1 startValue:(id)arg2 endValue:(CDUnknownBlockType)arg3 timingFunction:applier: /* Error: Ran out of types for this method. */;	// IMP=0x001000000000f2bd
- (void).cxx_destruct;	// IMP=0x000000000000f63e
...
- (void)completeAnimation;	// IMP=0x000000000000f56b
- (_Bool)isAnimating;	// IMP=0x000000000000f554
- (void)update:(double)arg1;	// IMP=0x000000000000f492
- (void)dealloc;	// IMP=0x000000000000f434
- (id)initWithDuration:(double)arg1 startValue:(id)arg2 endValue:(CDUnknownBlockType)arg3 timingFunction:applier: /* Error: Ran out of types for this method. */;	// IMP=0x000000000000f353
