...
- (void)_updateUniformsWithSprite:(id)arg1;	// IMP=0x000000000000f210
- (void)_updateVertexAttributesWithSprite:(id)arg1 inContet:(id)arg2;	// IMP=0x000000000000ef8b
- (void *)uniformsBytes;	// IMP=0x000000000000ef81
- (void *)vertexAttributesBytes;	// IMP=0x000000000000ef77
- (id)initWithSprite:(id)arg1 inContext:(id)arg2;	// IMP=0x000000000000eed6
