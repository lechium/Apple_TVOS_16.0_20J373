...
- (void)_updateUniformsWithRing:(id)arg1 inContext:(id)arg2;	// IMP=0x000000000001e47c
- (void)_updateVertexAttributesWithRing:(id)arg1 inContext:(id)arg2;	// IMP=0x000000000001e080
- (void *)uniformsBytes;	// IMP=0x000000000001e073
- (void *)vertexAttributesBytes;	// IMP=0x000000000001e069
- (id)initWithRing:(id)arg1 inContext:(id)arg2;	// IMP=0x000000000001dfc5
