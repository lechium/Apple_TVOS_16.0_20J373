...
- (void).cxx_destruct;	// IMP=0x000000000001cc45
- (id)pipelineForConfiguration:(id)arg1;	// IMP=0x000000000001cafc
- (id)initWithDeviceSPI:(id)arg1 librarySPI:(id)arg2;	// IMP=0x000000000001c9d1
- (id)initWithDevice:(id)arg1 library:(id)arg2;	// IMP=0x000000000001c87f
