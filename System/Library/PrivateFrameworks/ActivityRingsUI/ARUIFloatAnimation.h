...
+ (id)animationWithDuration:(double)arg1 startValue:(float)arg2 endValue:(float)arg3 timingFunction:(id)arg4 applier:(CDUnknownBlockType)arg5;	// IMP=0x0010000000014024
- (void).cxx_destruct;	// IMP=0x000000000001437c
...
- (void)completeAnimation;	// IMP=0x00000000000142a9
- (_Bool)isAnimating;	// IMP=0x0000000000014292
- (void)update:(double)arg1;	// IMP=0x00000000000141f9
- (void)dealloc;	// IMP=0x000000000001419b
- (id)initWithDuration:(double)arg1 startValue:(float)arg2 endValue:(float)arg3 timingFunction:(id)arg4 applier:(CDUnknownBlockType)arg5;	// IMP=0x00000000000140ba
