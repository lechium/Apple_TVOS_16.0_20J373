...
- (void)didUpdateBasebandCodec:(const struct _VCRemoteCodecInfo *)arg1;	// IMP=0x00000000000b81e8
...
- (void)invalidate;	// IMP=0x00000000000b80a1
- (_Bool)canSetDirection:(unsigned char)arg1;	// IMP=0x00000000000b8058
- (void)updateClient:(id)arg1 direction:(unsigned char)arg2;	// IMP=0x00000000000b7a7b
- (void)dispatchedStopClient;	// IMP=0x00000000000b79af
- (_Bool)dispatchedStartClient:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000b763f
- (void)stopClient:(id)arg1;	// IMP=0x00000000000b7091
- (void)cleanupStreamOutput;	// IMP=0x00000000000b7064
- (void)cleanupOutputThread;	// IMP=0x00000000000b701f
- (_Bool)setupAndStartOutputClientThread;	// IMP=0x00000000000b6785
- (_Bool)startOutputForClient:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000b64e7
- (_Bool)startInputForClient:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000b5889
- (void)startClient:(id)arg1;	// IMP=0x00000000000b54b5
- (void)_packetThreadStop;	// IMP=0x00000000000b5476
- (_Bool)_packetThreadStartWithClientFormat:(const struct tagVCAudioFrameFormat *)arg1;	// IMP=0x00000000000b4e7b
- (void)dealloc;	// IMP=0x00000000000b4c0d
- (id)initWithStreamInputID:(long long)arg1 streamToken:(long long)arg2 networkClockID:(unsigned long long)arg3;	// IMP=0x00000000000b43bd
