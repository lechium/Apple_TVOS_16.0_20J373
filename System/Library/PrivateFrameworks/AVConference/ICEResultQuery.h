...
- (void)dealloc;	// IMP=0x000000000005958e
@property struct tagCONNRESULT *result;
- (id)initWithCallID:(unsigned int)arg1;	// IMP=0x00000000000594d3
- (id)initWithResult:(struct tagCONNRESULT *)arg1;	// IMP=0x0000000000059440
