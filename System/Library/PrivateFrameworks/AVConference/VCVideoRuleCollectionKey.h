...
- (id)description;	// IMP=0x00000000003f29cc
- (unsigned long long)hash;	// IMP=0x00000000003f299b
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000003f290e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003f28bd
- (id)initWithPayload:(int)arg1 transportType:(unsigned char)arg2 encodingType:(unsigned char)arg3;	// IMP=0x00000000003f2849
