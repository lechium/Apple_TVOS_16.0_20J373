...
- (id)description;	// IMP=0x0000000000063964
- (long long)compareBudget:(id)arg1;	// IMP=0x000000000006390d
- (void)addStream:(id)arg1;	// IMP=0x00000000000638a8
- (void)dealloc;	// IMP=0x000000000006384a
- (id)init;	// IMP=0x00000000000637d4
