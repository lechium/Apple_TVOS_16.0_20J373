...
- (unsigned char)processRemoteWRMSuggestion:(int)arg1 isRemoteDuplicating:(_Bool)arg2;	// IMP=0x0000000000127783
- (unsigned char)processLocalWRMNotification:(CDStruct_cd8cfafa *)arg1 isAudioOnly:(_Bool)arg2;	// IMP=0x0000000000127632
- (void)updateWRMNotificationRequestTime:(double)arg1;	// IMP=0x0000000000127627
- (_Bool)shouldRequestWRMNotificationWithDuplicationReason:(unsigned char)arg1 isDuplicationEnabled:(_Bool)arg2 isLocalUsingCellular:(_Bool)arg3 atTime:(double)arg4;	// IMP=0x0000000000127435
- (_Bool)shouldForceWRMRecommendationUsingUserDefaults;	// IMP=0x0000000000127328
- (id)init;	// IMP=0x00000000001272c9
