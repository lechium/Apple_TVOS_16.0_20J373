...
- (void)addNegotiatedHDRMode:(id)arg1;	// IMP=0x00000000002d769b
- (void)addPixelFormatSet:(id)arg1;	// IMP=0x00000000002d7685
- (void)addParameterSet:(id)arg1 payload:(int)arg2;	// IMP=0x00000000002d763b
- (void)addFeatureString:(id)arg1 payload:(int)arg2;	// IMP=0x00000000002d75f1
- (void)addVideoRules:(id)arg1 transportType:(unsigned char)arg2 payload:(int)arg3 encodingType:(unsigned char)arg4;	// IMP=0x00000000002d75db
- (void)dealloc;	// IMP=0x00000000002d7559
- (id)init;	// IMP=0x00000000002d74aa
