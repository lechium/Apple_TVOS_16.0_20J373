...
+ (unsigned int)encoderUsageTypeWithOperatingMode:(int)arg1;	// IMP=0x00600000003f1a34
...
- (void)featureListString;	// IMP=0x00000000003f1c5c
- (unsigned int)numTilesPerVideoFrameForHDRMode:(unsigned long long)arg1;	// IMP=0x00000000003f1b68
- (void)dealloc;	// IMP=0x00000000003f1afb
- (id)initWithMode:(int)arg1;	// IMP=0x00000000003f1a50
