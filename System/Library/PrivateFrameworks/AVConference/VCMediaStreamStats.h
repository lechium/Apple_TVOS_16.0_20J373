...
- (unsigned int)getBitrateKbpsSinceTime:(double)arg1;	// IMP=0x000000000016120f
- (double)getFramerateSinceTime:(double)arg1;	// IMP=0x0000000000161196
- (void)updateMinMaxSinceTime:(double)arg1;	// IMP=0x0000000000161133
@property(readonly, nonatomic) unsigned int bitrateKbps;
@property(readonly, nonatomic) double framerate;
- (void)recordDataWithSize:(double)arg1 atTime:(double)arg2;	// IMP=0x000000000016107c
- (void)dealloc;	// IMP=0x0000000000161015
- (id)init;	// IMP=0x0000000000160f3e
