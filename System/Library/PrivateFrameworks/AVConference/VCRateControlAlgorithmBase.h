...
- (void)updateCongestionStatusWhenRampDown:(double)arg1;	// IMP=0x00000000001d282e
- (void)updateCongestionStatusWhenRampUp;	// IMP=0x00000000001d27ae
- (_Bool)shouldRampDownDueToLossThreshold;	// IMP=0x00000000001d252e
- (_Bool)shouldRampDownDueToConsecutiveLoss;	// IMP=0x00000000001d24de
- (_Bool)shouldRampDownDueToLossEvent;	// IMP=0x00000000001d2482
- (_Bool)shouldBlockRampUpDueToLossEventThreshold;	// IMP=0x00000000001d235e
- (_Bool)allowRampUpWithContinuousTargetBitrate;	// IMP=0x00000000001d2293
- (double)rampUpTargetBitrateContinuousWithBandwidthDiff:(int)arg1;	// IMP=0x00000000001d2247
- (void)resetLossEventBandwidthLimit;	// IMP=0x00000000001d2236
- (void)updateLossEventBandwidthLimit:(unsigned int)arg1;	// IMP=0x00000000001d2146
- (void)resetLossEventBuffer;	// IMP=0x00000000001d2119
- (double)lossEventOverThresholdRatio;	// IMP=0x00000000001d205f
- (int)lossEventIncreasingCount;	// IMP=0x00000000001d201f
- (void)updateLossEvent;	// IMP=0x00000000001d1f14
@property(readonly, nonatomic) _Bool isLossBasedAdaptationOn;
- (_Bool)recentlyGoAboveRampUpBandwidth;	// IMP=0x00000000001d1e88
- (_Bool)keepOvershootingRampDownBandwidth;	// IMP=0x00000000001d1e51
- (void)checkBandwidthOvershootWithRemoteBandwidthEstimation:(unsigned int)arg1;	// IMP=0x00000000001d1d51
- (void)stateEnter;	// IMP=0x00000000001d1d32
- (void)stateExit;	// IMP=0x00000000001d1d0e
- (void)stateChangeTo:(int)arg1;	// IMP=0x00000000001d1cba
- (void)calculateCongestionMetricsFromOWRD:(double)arg1 time:(double)arg2;	// IMP=0x00000000001d1be0
- (unsigned short)getTimestampFromMicroTime:(double)arg1;	// IMP=0x00000000001d1bc7
- (double)getDoubleTimeFromTimestamp:(unsigned int)arg1 timestampTick:(unsigned int)arg2 wrapAroundCounter:(unsigned int)arg3;	// IMP=0x00000000001d1b9b
- (void)logToDumpFilesWithString:(id)arg1;	// IMP=0x00000000001d1adb
- (void)enableBasebandDump:(void *)arg1;	// IMP=0x00000000001d1ac9
- (void)enableLogDump:(void *)arg1 enablePeriodicLogging:(_Bool)arg2;	// IMP=0x00000000001d1ab1
- (_Bool)doRateControlWithStatistics:(CDStruct_7df19fcb)arg1;	// IMP=0x00000000001d1a50
- (void)configure:(struct VCRateControlAlgorithmConfig)arg1 restartRequired:(_Bool)arg2;	// IMP=0x00000000001d19ef
- (void)checkPaused;	// IMP=0x00000000001d17a2
@property(nonatomic, getter=isPaused) _Bool paused;
- (void)dealloc;	// IMP=0x00000000001d1727
- (id)init;	// IMP=0x00000000001d16b1
