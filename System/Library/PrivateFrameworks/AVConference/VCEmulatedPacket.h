...
- (id)initWithPacketID:(unsigned int)arg1 datagram:(char *)arg2 datagramSize:(unsigned int)arg3;	// IMP=0x00000000000ddcba
- (id)initWithPacketID:(unsigned int)arg1;	// IMP=0x00000000000ddc5c
