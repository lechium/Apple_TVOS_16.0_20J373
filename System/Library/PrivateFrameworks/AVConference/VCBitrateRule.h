...
- (void)dealloc;	// IMP=0x00000000003a1da1
- (id)description;	// IMP=0x00000000003a1d6d
- (long long)compare:(id)arg1;	// IMP=0x00000000003a1d29
- (id)initWithBitrate:(unsigned int)arg1 connectionType:(int)arg2 limitingRule:(id)arg3;	// IMP=0x00000000003a1ca0
