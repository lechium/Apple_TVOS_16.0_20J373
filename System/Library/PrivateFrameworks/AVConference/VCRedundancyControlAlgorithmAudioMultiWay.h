...
- (unsigned int)updateRedundancyPercentageWithPLRThresholds:(unsigned int *)arg1;	// IMP=0x0000000000258d06
- (void)computeRedundancyInfo;	// IMP=0x0000000000258c93
- (void)processRCNetworkStatistics:(CDStruct_7df19fcb)arg1;	// IMP=0x0000000000258b62
- (void)processNWConnectionStatistics:(CDStruct_7df19fcb)arg1;	// IMP=0x0000000000258ac8
- (void)updateRedundancyStrategyWithNetworkStatistics:(CDStruct_7df19fcb)arg1;	// IMP=0x0000000000258a9b
- (id)init;	// IMP=0x0000000000258a2b
