...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000db66a
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000db0b6
- (_Bool)isEqualPayloads:(id)arg1;	// IMP=0x00000000000daf74
- (_Bool)applyCipherSuiteOnMediaStreamConfig:(id)arg1 codecConfigs:(id)arg2;	// IMP=0x00000000000dad53
- (_Bool)areCodecsEqualTo:(id)arg1;	// IMP=0x00000000000dacf6
- (void)resetCodecs;	// IMP=0x00000000000dace0
- (void)removeCodec:(unsigned int)arg1;	// IMP=0x00000000000daca7
- (void)addCodec:(unsigned int)arg1;	// IMP=0x00000000000dac6e
- (void)resetPayloads;	// IMP=0x00000000000dac58
- (void)addPayload:(int)arg1;	// IMP=0x00000000000dac1f
- (void)dealloc;	// IMP=0x00000000000dabb2
- (id)init;	// IMP=0x00000000000dab2c
