...
- (unsigned long long)hash;	// IMP=0x00000000002265cc
...
- (id)description;	// IMP=0x000000000022653a
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000226493
- (id)initWithPayload:(int)arg1 isSecondary:(_Bool)arg2 sbr:(_Bool)arg3 samplesPerBlock:(unsigned int)arg4;	// IMP=0x00000000002263f4
- (id)init;	// IMP=0x00000000002263e6
