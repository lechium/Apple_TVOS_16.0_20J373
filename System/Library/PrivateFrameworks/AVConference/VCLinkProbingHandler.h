...
- (void)resetAggregatedProbingResults;	// IMP=0x000000000037fdd9
- (void)probingLockdownEnded;	// IMP=0x000000000037fcb8
- (void)updateLinkPreferenceOrder;	// IMP=0x000000000037f926
- (void)queryProbingResults;	// IMP=0x000000000037f643
- (void)setLinkProbingResultConfig;	// IMP=0x000000000037f605
- (void)loadStorebagValues;	// IMP=0x000000000037f170
- (id)getProbingResultsForLinkID:(id)arg1;	// IMP=0x000000000037f11b
- (void)removeProbingResultsForLinks:(id)arg1;	// IMP=0x000000000037efc6
- (_Bool)isValidProbingResult:(id)arg1;	// IMP=0x000000000037ef5b
- (void)flushProbingResults:(id)arg1;	// IMP=0x000000000037ee9f
- (void)dispatchedUpdateProbingResults:(id)arg1;	// IMP=0x000000000037e911
- (void)updateProbingResults:(id)arg1;	// IMP=0x000000000037e882
- (void)stopActiveProbingOnLinks:(id)arg1 resetStats:(_Bool)arg2;	// IMP=0x000000000037e4f7
- (void)startActiveProbingOnLinks:(id)arg1;	// IMP=0x000000000037e254
@property(readonly) _Bool isLinkProbingActive;
@property id <VCLinkProbingHandlerDelegate> linkProbingHandlerDelegate;
- (void)dealloc;	// IMP=0x000000000037e14b
- (id)initWithDelegate:(id)arg1;	// IMP=0x000000000037df3a
