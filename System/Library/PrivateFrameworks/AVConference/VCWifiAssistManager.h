...
+ (id)sharedInstance;	// IMP=0x00600000000f6a0d
@property(readonly) unsigned char wifiAssistState; // @synthesize wifiAssistState=_wifiAssistState;
- (void)removeDelegate:(id)arg1;	// IMP=0x00000000000f6a1b
- (void)addDelegate:(id)arg1;	// IMP=0x00000000000f6a15
@property(readonly) _Bool isAvailable;
- (id)init;	// IMP=0x00000000000f69f7
