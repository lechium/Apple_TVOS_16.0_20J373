...
- (void)updateBandwidthDivergeCountAtArrivalTime:(double)arg1 suddenChangeAbove:(_Bool)arg2 suddenChangeBelow:(_Bool)arg3;	// IMP=0x0000000000321a64
- (_Bool)isSuddenChangeDurationMetAtArrivalTime:(double)arg1;	// IMP=0x0000000000321a03
- (void)compensateSuddenChangeBandwidths;	// IMP=0x00000000003219b3
- (void)recordSuddenChangeBandwidth:(double)arg1;	// IMP=0x0000000000321998
- (void)detectSuddenChangeWithBandwidth:(double)arg1 suddenChangeAbove:(_Bool *)arg2 suddenChangeBelow:(_Bool *)arg3;	// IMP=0x00000000003216d6
- (void)updateInitialBandwidthEstimationForCellularAtTime:(double)arg1 bandwidth:(double)arg2;	// IMP=0x0000000000321669
- (void)initializeBandwidthEstimationAtTime:(double)arg1 mediaTimestamp:(unsigned int)arg2 probingSequence:(_Bool)arg3 probingSequenceID:(unsigned int)arg4;	// IMP=0x0000000000321643
- (double)updateBandwidthEstimation:(double)arg1 arrivalTime:(double)arg2;	// IMP=0x0000000000321389
- (double)resetBandwidthWithParameters:(double)arg1 probingSequenceDuration:(double)arg2 probingSequenceSize:(unsigned int)arg3 packetsInProbingSequence:(unsigned int)arg4;	// IMP=0x0000000000321325
- (_Bool)isPacketProcessedLateWithArrivalTime:(double)arg1;	// IMP=0x0000000000321306
- (void)updateQualificationParameters;	// IMP=0x000000000032113c
- (void)enableBWELogDump:(void *)arg1;	// IMP=0x000000000032112f
- (void)calculateBandwidthEstimationForBandwidthSample:(double)arg1 arrivalTime:(double)arg2;	// IMP=0x0000000000320fe4
- (void)calculateBandwidthEstimationAtTime:(double)arg1 mediaTimestamp:(unsigned int)arg2 mediaDataSize:(unsigned int)arg3 probingSequence:(_Bool)arg4 probingSequenceID:(unsigned int)arg5;	// IMP=0x0000000000320cca
- (void)dealloc;	// IMP=0x0000000000320948
- (id)init;	// IMP=0x0000000000320896
