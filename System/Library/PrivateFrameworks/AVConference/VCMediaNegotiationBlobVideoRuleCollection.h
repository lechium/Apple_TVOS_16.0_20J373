...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000033b5d7
- (unsigned long long)hash;	// IMP=0x000000000033b53d
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000033b45f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000033b3a2
- (void)copyTo:(id)arg1;	// IMP=0x000000000033b323
- (void)writeTo:(id)arg1;	// IMP=0x000000000033b255
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000033b248
- (id)dictionaryRepresentation;	// IMP=0x000000000033abe7
- (id)description;	// IMP=0x000000000033ab4d
...
- (int)StringAsOperation:(id)arg1;	// IMP=0x000000000033aa28
- (id)operationAsString:(int)arg1;	// IMP=0x000000000033a9e8
- (int)StringAsTransport:(id)arg1;	// IMP=0x000000000033a99c
- (id)transportAsString:(int)arg1;	// IMP=0x000000000033a95c
