...
+ (int)payloadForVideoPayload:(int)arg1;	// IMP=0x0010000000336552
+ (int)videoPayloadForPayload:(int)arg1;	// IMP=0x0010000000336534
+ (_Bool)convertVideoFormat:(int)arg1 width:(int *)arg2 height:(int *)arg3;	// IMP=0x00100000003363a3
+ (int)videoFormatForWidth:(int)arg1 height:(int)arg2;	// IMP=0x0010000000336247
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000087ab
- (unsigned long long)hash;	// IMP=0x000000000000865f
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000084b4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000837c
- (void)copyTo:(id)arg1;	// IMP=0x0000000000008282
- (void)writeTo:(id)arg1;	// IMP=0x00000000000080fd
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000080f0
- (id)dictionaryRepresentation;	// IMP=0x0000000000007614
- (id)description;	// IMP=0x000000000000757a
...
- (void)printWithLogFile:(void *)arg1;	// IMP=0x0000000000335fe5
@property(readonly, nonatomic) _Bool isSubStream;
- (id)newMultiwayVideoStream;	// IMP=0x0000000000335d76
- (id)initWithStreamConfig:(id)arg1;	// IMP=0x0000000000335b74
