...
- (id)description;	// IMP=0x00000000003c28ed
- (id)className;	// IMP=0x00000000003c28db
@property(readonly, nonatomic) unsigned int flags;
- (float)qualityForBitRate:(unsigned int)arg1;	// IMP=0x00000000003c27f9
- (void)dealloc;	// IMP=0x00000000003c278c
- (id)initWithConfigDict:(id)arg1;	// IMP=0x00000000003c2704
- (void)setupEncodeProperties:(id)arg1;	// IMP=0x00000000003c2319
- (void)createSupportedBitratesForEVS;	// IMP=0x00000000003c22f8
- (void)createSupportedBitratesForAMR16k;	// IMP=0x00000000003c22d7
- (void)createSupportedBitratesForAMR8k;	// IMP=0x00000000003c22b6
- (void)createSupportedBitratesForOpus;	// IMP=0x00000000003c2295
- (void)createSupportedBitratesForAACELD48;	// IMP=0x00000000003c2274
- (void)createSupportedBitratesForAACELD;	// IMP=0x00000000003c2253
- (void)createSupportedBitrates;	// IMP=0x00000000003c21d4
- (unsigned int)aacBitrate;	// IMP=0x00000000003c20a6
- (void)setUseSBR:(_Bool)arg1;	// IMP=0x00000000003c202b
- (_Bool)configure:(id)arg1;	// IMP=0x00000000003c1994
