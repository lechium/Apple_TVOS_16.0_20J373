...
+ (id)streamGroupIDsWithMediaBlob:(id)arg1;	// IMP=0x00100000000303e4
+ (_Bool)initializeLocalConfiguration:(id)arg1 negotiationData:(id)arg2 deviceRole:(int)arg3 preferredAudioPayload:(int)arg4;	// IMP=0x0010000000030383
...
- (unsigned int)remoteMaxBandwidthForOperatingMode:(int)arg1 connectionType:(int)arg2;	// IMP=0x0000000000030445
- (_Bool)processRemoteNegotiationData:(id)arg1;	// IMP=0x0000000000030322
- (id)negotiationData;	// IMP=0x00000000000302c1
- (id)getPreferredVideoPayloadList:(id)arg1;	// IMP=0x000000000002ff39
- (void)dealloc;	// IMP=0x000000000002fea2
- (id)initWithLocalSettings:(id)arg1;	// IMP=0x000000000002fa6c
