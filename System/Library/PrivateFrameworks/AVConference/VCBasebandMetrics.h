...
- (void)enableBasebandLogDump:(void *)arg1;	// IMP=0x000000000018a8c7
- (void)addBDCDListWithNotificationArrivalTime:(double)arg1 bdcd:(double)arg2 queuingDelay:(double)arg3;	// IMP=0x000000000018a7bb
- (void)resetBBNoteHistoryList;	// IMP=0x000000000018a7a0
- (void)resetBDCDList;	// IMP=0x000000000018a785
- (void)normalizeBDCD:(double)arg1;	// IMP=0x000000000018a524
- (double)updateTotalQueueDepth:(unsigned int)arg1;	// IMP=0x000000000018a4b5
- (void)calculateBitratesAndDelaysWithTotalQueueDepth:(unsigned int)arg1;	// IMP=0x000000000018a200
- (void)addInfoListWithNotification:(CDStruct_b203c80d *)arg1;	// IMP=0x000000000018a13d
- (CDStruct_7df19fcb)getBasebandMetricsWithNotification:(CDStruct_b203c80d *)arg1;	// IMP=0x0000000000189ede
- (void)dealloc;	// IMP=0x0000000000189e80
- (id)init;	// IMP=0x0000000000189dd9
