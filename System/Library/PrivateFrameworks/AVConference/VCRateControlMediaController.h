...
- (void)updateLargeFrameSizeWithBandwidth:(unsigned int)arg1;	// IMP=0x0000000000107aba
- (void)updateProbingLargeFrameSizeCap;	// IMP=0x0000000000107a04
- (_Bool)isProbingLargeFrameRequiredAtTime:(double)arg1;	// IMP=0x0000000000107738
- (void)printLargeFrameStatsAtTime:(double)arg1 timestamp:(unsigned int)arg2 timeSinceLastProbingSequence:(double)arg3 frameSize:(unsigned int)arg4 wastedBytes:(unsigned int)arg5 fecRatio:(double)arg6 isFrameRequested:(_Bool)arg7;	// IMP=0x000000000010756e
- (void)scheduleProbingSequenceAtTime:(double)arg1;	// IMP=0x000000000010746a
- (void)increaseBasebandFlushCountInternallyWithSuggestion:(struct VCRateControlMediaSuggestion *)arg1;	// IMP=0x00000000001073c2
- (_Bool)increaseFlushCountForVideoRefresh:(int)arg1 transactionID:(unsigned short)arg2;	// IMP=0x0000000000107351
- (void)recordVideoRefreshFrameWithTimestamp:(unsigned int)arg1 payloadType:(unsigned char)arg2 packetCount:(unsigned int)arg3 isKeyFrame:(_Bool)arg4;	// IMP=0x00000000001072be
- (void)scheduleProbingSequenceWithFrameSize:(unsigned int)arg1 paddingBytes:(unsigned int)arg2 timestamp:(unsigned int)arg3 fecRatio:(double)arg4 isProbingSequenceScheduled:(_Bool *)arg5;	// IMP=0x0000000000107101
...
- (_Bool)rampUpAudioFraction;	// IMP=0x0000000000106e55
- (_Bool)rampDownAudioFraction;	// IMP=0x0000000000106db8
- (_Bool)didMediaGetFlushedWithPayloadType:(unsigned char)arg1 transactionID:(unsigned short)arg2 packetDropped:(unsigned short)arg3 sequenceNumberArray:(unsigned short *)arg4;	// IMP=0x0000000000106be2
- (void)decreaseFlushCount:(int)arg1;	// IMP=0x0000000000106ab0
@property(readonly, nonatomic) _Bool isVideoStopped;
- (void)resumeVideoByVCRateControl;	// IMP=0x00000000001067f1
- (void)stopVideoByVCRateControl;	// IMP=0x00000000001066a5
- (void)pauseVideoByUser:(_Bool)arg1;	// IMP=0x00000000001064ec
- (void)updateAudioStallInMediaSuggestion:(struct VCRateControlMediaSuggestion *)arg1 isSuggestionNeeded:(_Bool *)arg2 atTime:(double)arg3;	// IMP=0x00000000001063fe
- (void)updateBasebandSuggestionWithStatistics:(CDStruct_7df19fcb)arg1;	// IMP=0x0000000000105c94
- (void)computePacketLossWithRemoteInfo:(struct VCRCMediaPLPFromRemoteInfo *)arg1;	// IMP=0x0000000000105c1c
- (void)getMediaQueueRateChangeCounter:(unsigned int *)arg1 rateChangeTime:(double *)arg2;	// IMP=0x0000000000105bff
- (void)getMediaQueueInVideoBitrate:(double *)arg1 outVideoBitrate:(double *)arg2 inAudioBitrate:(double *)arg3 outAudioBitrate:(double *)arg4;	// IMP=0x0000000000105bb2
- (void)enableBWELogDump:(void *)arg1;	// IMP=0x00000000001057af
- (void)enableBasebandLogDump:(void *)arg1;	// IMP=0x00000000001057a2
- (void)dealloc;	// IMP=0x0000000000105720
- (id)initWithMediaQueue:(struct tagHANDLE *)arg1 delegate:(id)arg2;	// IMP=0x00000000001055e2
