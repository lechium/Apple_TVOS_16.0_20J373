...
- (id)entryForQualityIndex:(unsigned int)arg1;	// IMP=0x00000000003c7fe9
- (_Bool)addTableEntry:(id)arg1;	// IMP=0x00000000003c7ea6
- (void)dealloc;	// IMP=0x00000000003c7e39
- (id)init;	// IMP=0x00000000003c7dba
