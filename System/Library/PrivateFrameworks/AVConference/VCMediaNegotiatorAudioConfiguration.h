...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002ec29f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002ec0dd
- (_Bool)isSecondaryPayload:(int)arg1;	// IMP=0x00000000002ec0a4
- (void)addAudioPayload:(int)arg1 isSecondary:(_Bool)arg2;	// IMP=0x00000000002ebf20
- (void)dealloc;	// IMP=0x00000000002ebeb3
- (id)initWithAllowAudioSwitching:(_Bool)arg1 allowAudioRecording:(_Bool)arg2 useSBR:(_Bool)arg3 ssrc:(unsigned int)arg4 audioUnitNumber:(unsigned int)arg5 audioRuleCollection:(id)arg6;	// IMP=0x00000000002ebc39
- (id)initWithAllowAudioSwitching:(_Bool)arg1 allowAudioRecording:(_Bool)arg2 useSBR:(_Bool)arg3 ssrc:(unsigned int)arg4 audioUnitNumber:(unsigned int)arg5;	// IMP=0x00000000002ebc1c
