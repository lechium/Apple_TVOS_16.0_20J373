...
+ (unsigned char)getVCCurrentVersion;	// IMP=0x0060000000380716
...
- (_Bool)supportSDPCompression;	// IMP=0x0000000000380709
- (void)setUserAgent:(id)arg1;	// IMP=0x00000000003805d2
- (struct VoiceIOFarEndVersionInfo)audioVersionInfo:(_Bool)arg1;	// IMP=0x0000000000380571
@property(readonly) _Bool supportsDynamicContentsRectWithAspectPreservation;
- (_Bool)updateWithLastDecodedFrameTime:(double)arg1 time:(double)arg2;	// IMP=0x0000000000380389
@property(readonly, nonatomic) _Bool requiresImplicitFeatureString;
- (void)dealloc;	// IMP=0x00000000003802ca
- (id)init;	// IMP=0x0000000000380100
