...
- (int)getRemainingAQMBudgetWithPacket:(id)arg1;	// IMP=0x000000000005d6d9
- (void)addPacketToBudgetBuffer:(id)arg1;	// IMP=0x000000000005d637
- (_Bool)shouldDropPacketWithCurrentAQMBudget:(id)arg1;	// IMP=0x000000000005d5c4
- (void)process:(id)arg1;	// IMP=0x000000000005d323
- (double)computeNetworkServiceRate;	// IMP=0x000000000005d24b
- (void)updateSettingsAtTime:(double)arg1 impairments:(id)arg2;	// IMP=0x000000000005cf28
- (id)init;	// IMP=0x000000000005ceca
