...
- (void)cleanupNwActivity;	// IMP=0x00000000000468ce
- (_Bool)applyConfigurationUsingClientDict:(id)arg1;	// IMP=0x00000000000466fd
- (_Bool)updateWithClientDictionary:(id)arg1;	// IMP=0x0000000000046557
@property(nonatomic) long long sessionMode; // @synthesize sessionMode=_sessionMode;
- (void)dealloc;	// IMP=0x00000000000463b1
- (id)initWithClientDictionary:(id)arg1;	// IMP=0x0000000000046372
- (id)init;	// IMP=0x0000000000046313
