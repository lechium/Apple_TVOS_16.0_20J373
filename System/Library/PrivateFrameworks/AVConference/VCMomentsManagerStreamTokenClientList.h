...
+ (long long)streamTokenFromClientContext:(id)arg1;	// IMP=0x006000000012462d
+ (_Bool)isValidContext:(id)arg1;	// IMP=0x0060000000124604
...
- (void)dealloc;	// IMP=0x0000000000124642
- (void)removeContext:(id)arg1;	// IMP=0x00000000001245ee
- (id)newContext;	// IMP=0x000000000012459b
- (id)initWithStreamToken:(long long)arg1 messenger:(id)arg2;	// IMP=0x000000000012450d
