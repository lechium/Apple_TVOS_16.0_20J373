...
- (id)description;	// IMP=0x00000000003704fa
- (unsigned char)getPLRTierFromPLREnvelope:(double)arg1;	// IMP=0x0000000000370444
- (void)updateLinkStatsWithArrivingNewValueMeanRTT:(double)arg1 arrivingNewValuePLR:(double)arg2;	// IMP=0x0000000000370293
- (void)updateProbingResult:(id)arg1 initialResult:(_Bool)arg2;	// IMP=0x000000000036fdec
- (void)mergeProbingResults:(id)arg1;	// IMP=0x000000000036fdd8
- (void)dealloc;	// IMP=0x000000000036fd5d
- (id)initWithProbingResults:(id)arg1 linkProbingResultConfig:(CDStruct_7421bd8e)arg2;	// IMP=0x000000000036fc51
