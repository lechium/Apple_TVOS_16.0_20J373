...
- (void)didResumeStreamInputCaptureSource;	// IMP=0x00000000002559d6
- (void)didSuspendStreamInputCaptureSource;	// IMP=0x00000000002558c5
- (void)didStopStreamInputCaptureSource;	// IMP=0x00000000002557a5
- (void)didStartStreamInputCaptureSource;	// IMP=0x0000000000255685
- (void)thermalLevelDidChange:(int)arg1;	// IMP=0x000000000025567f
- (_Bool)createRemoteReceiveQueue:(id)arg1;	// IMP=0x000000000025536f
@property(readonly) NSDictionary *reportingStats;
- (_Bool)isEqualFormat:(struct opaqueCMFormatDescription *)arg1;	// IMP=0x0000000000254ffa
- (struct opaqueCMFormatDescription *)streamFormat;	// IMP=0x0000000000254fe9
- (void)invalidate;	// IMP=0x0000000000254dea
@property(readonly, nonatomic) _Bool isStarted; // @synthesize isStarted=_isStarted;
- (void)dealloc;	// IMP=0x0000000000254b25
- (id)initWithStreamInputID:(id)arg1 format:(struct opaqueCMFormatDescription *)arg2 delegate:(id)arg3 delegateQueue:(id)arg4 remoteQueue:(id)arg5;	// IMP=0x0000000000254224
