...
- (void)setupInputs;	// IMP=0x000000000034a5f9
- (void)startWritingAtTime:(CDStruct_1b6d18a9)arg1;	// IMP=0x000000000034a4c1
- (void)appendMetaData;	// IMP=0x0000000000349fe6
- (void)processSampleQueue:(struct opaqueCMBufferQueue *)arg1 input:(id)arg2 lastPresentationTime:(CDStruct_1b6d18a9 *)arg3;	// IMP=0x0000000000349c99
- (void)setupInput:(id)arg1 queue:(struct opaqueCMBufferQueue *)arg2 dispatchGroup:(id)arg3 lastPresentationTime:(CDStruct_1b6d18a9 *)arg4;	// IMP=0x0000000000349ac3
- (id)setupAssetWriterWithWidth:(int)arg1 height:(int)arg2 transactionID:(id)arg3;	// IMP=0x0000000000349093
- (void)finishWritingWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000348bdf
- (void)setStillImageTime:(CDStruct_1b6d18a9)arg1;	// IMP=0x0000000000348ab9
- (_Bool)shouldFinishWritingSampleBuffer:(struct opaqueCMSampleBuffer *)arg1 RTPtimeStamp:(unsigned int)arg2 mediaType:(unsigned char)arg3;	// IMP=0x0000000000348561
- (_Bool)shouldAppendSampleBuffer:(struct opaqueCMSampleBuffer *)arg1 RTPtimeStamp:(unsigned int)arg2 mediaType:(unsigned char)arg3;	// IMP=0x00000000003483be
- (void)setEndRTPTimestampWithTimestamp:(unsigned int)arg1;	// IMP=0x00000000003483ab
- (void)appendAudioSampleBuffer:(struct opaqueCMSampleBuffer *)arg1 mediaType:(unsigned char)arg2;	// IMP=0x000000000034827f
- (void)appendVideoSampleBuffer:(struct opaqueCMSampleBuffer *)arg1 cameraStatus:(unsigned char)arg2 mediaType:(unsigned char)arg3;	// IMP=0x0000000000348279
- (void)setupContectRect:(struct CGRect)arg1 withCaptureHeight:(int)arg2;	// IMP=0x0000000000348156
- (void)setupWriterWithMode:(unsigned char)arg1;	// IMP=0x000000000034814a
- (void)dealloc;	// IMP=0x0000000000347ffa
- (id)initWithOutputURL:(id)arg1 transactionID:(id)arg2 videoCodec:(unsigned int)arg3;	// IMP=0x0000000000347e8c
