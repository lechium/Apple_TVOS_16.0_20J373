...
+ (_Bool)bundlingAppliedByCodecForPayload:(int)arg1 mode:(int)arg2;	// IMP=0x0060000000365882
+ (id)newAudioTierForPayloadConfig:(id)arg1 bundlingAppliedByCodec:(_Bool)arg2 audioCodecBitrate:(unsigned int)arg3 packetsPerBundle:(unsigned int)arg4 redNumPayloads:(unsigned int)arg5 headerSize:(unsigned int)arg6;	// IMP=0x0060000000365790
...
- (_Bool)isEqualTo:(id)arg1;	// IMP=0x0000000000365b8a
- (id)dictionary;	// IMP=0x0000000000365a1c
- (id)description;	// IMP=0x0000000000365977
- (id)initWithNetworkBitrate:(unsigned int)arg1 bundlingAppliedByCodec:(_Bool)arg2 audioCodecBitrate:(unsigned int)arg3 packetsPerBundle:(unsigned int)arg4 redNumPayloads:(unsigned int)arg5 payloadConfig:(id)arg6;	// IMP=0x00000000003658b7
