...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000003a82b
- (unsigned long long)hash;	// IMP=0x000000000003a628
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000003a4c8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000003a3bc
- (void)copyTo:(id)arg1;	// IMP=0x000000000003a2ee
- (void)writeTo:(id)arg1;	// IMP=0x000000000003a1c1
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000003a1b4
- (id)dictionaryRepresentation;	// IMP=0x000000000003996e
- (id)description;	// IMP=0x00000000000398d4
...
- (void)printWithLogFile:(void *)arg1;	// IMP=0x0000000000335974
- (id)newMultiwayAudioStream;	// IMP=0x00000000003357d1
- (void)setPayloadFlagsWithPayloads:(id)arg1;	// IMP=0x000000000033565d
- (id)initWithStreamConfig:(id)arg1;	// IMP=0x00000000003354b2
