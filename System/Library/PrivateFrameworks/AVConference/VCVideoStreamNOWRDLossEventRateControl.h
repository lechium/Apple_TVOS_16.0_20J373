...
- (id)className;	// IMP=0x0000000000051716
- (void)calculateNOWRD:(double)arg1 time:(double)arg2;	// IMP=0x00000000000512e7
- (void)calculateOWRDWithTimestamp:(unsigned int)arg1 sampleRate:(unsigned int)arg2 time:(double)arg3;	// IMP=0x0000000000050eae
- (void)resetLossEventBuffer;	// IMP=0x0000000000050e9d
- (int)lossEventCountThresholdForBitrate:(unsigned int)arg1;	// IMP=0x0000000000050e75
- (int)lossEventCount;	// IMP=0x0000000000050e4d
- (void)updatePacketLossRate:(double)arg1 time:(double)arg2;	// IMP=0x0000000000050dfd
- (_Bool)shouldRampUp;	// IMP=0x0000000000050d37
- (_Bool)shouldRampDown;	// IMP=0x0000000000050c83
- (unsigned short)rampDownTier;	// IMP=0x0000000000050c59
- (unsigned short)rampUpTier;	// IMP=0x0000000000050c3a
- (void)stateEnter;	// IMP=0x0000000000050c1b
- (void)stateExit;	// IMP=0x0000000000050c15
- (void)stateChange:(int)arg1;	// IMP=0x0000000000050abc
- (void)printRateControlFullInfoWithLogDump:(void *)arg1 time:(double)arg2 videoStall:(_Bool)arg3 videoFrozenDuration:(double)arg4 averageTargetBitrate:(unsigned int)arg5;	// IMP=0x000000000005099c
- (void)updateRTPReceiveWithTimestamp:(unsigned int)arg1 sampleRate:(unsigned int)arg2 time:(double)arg3;	// IMP=0x000000000005098a
- (void)doRateControlWithTime:(double)arg1 roundTripTime:(double)arg2 packetLossRate:(double)arg3 operatingTierIndex:(unsigned short)arg4 averageReceivedBitrate:(unsigned int)arg5;	// IMP=0x000000000005078d
@property(readonly, copy) NSString *description;
- (void)setMaxTierIndex:(unsigned short)arg1 minTierIndex:(unsigned short)arg2;	// IMP=0x00000000000506d7
- (id)init;	// IMP=0x00000000000504c7
