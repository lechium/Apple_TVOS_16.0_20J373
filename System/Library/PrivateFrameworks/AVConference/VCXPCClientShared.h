...
- (void)deregisterWithUUID:(id)arg1 service:(char *)arg2;	// IMP=0x00000000002ccf2f
- (void)registerBlockWithUUID:(id)arg1 service:(char *)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x00000000002cc7d1
- (void)deregisterFromNotifications;	// IMP=0x00000000002cc682
- (void)dealloc;	// IMP=0x00000000002cc5fa
- (id)init;	// IMP=0x00000000002cc4db
