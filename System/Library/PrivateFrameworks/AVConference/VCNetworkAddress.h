...
- (int)getSockaddrStorage:(struct sockaddr_storage *)arg1 size:(unsigned long long *)arg2;	// IMP=0x000000000036ddeb
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000036dd6f
- (id)description;	// IMP=0x000000000036dceb
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000036dc1f
- (_Bool)isIPv6;	// IMP=0x000000000036dc11
- (void)dealloc;	// IMP=0x000000000036dba4
