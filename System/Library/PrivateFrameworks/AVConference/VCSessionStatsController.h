...
- (void)flushRealTimeReportingStats;	// IMP=0x0000000000310a77
- (void)deregisterPeriodicTask;	// IMP=0x0000000000310a58
- (void)periodicTask:(void *)arg1;	// IMP=0x0000000000310822
- (void)registerPeriodicTask;	// IMP=0x00000000003107d2
@property(readonly) id reportingAgent;
- (void)resetHealthPrintCounters;	// IMP=0x000000000031079a
- (void)healthPrintForServerStats;	// IMP=0x0000000000310581
- (void)calculateInterCallbackDurationWithTime:(double)arg1;	// IMP=0x0000000000310543
- (void)handleRemoteSessionStats:(CDStruct_a6ed07b8 *)arg1;	// IMP=0x000000000031010f
- (void)statsReceiveStatsPayload;	// IMP=0x000000000030ff9f
- (void)triggerRateControlWithLocalSessionStats:(CDStruct_b5e1e8f2)arg1 time:(double)arg2 forUplink:(_Bool)arg3 forDownlink:(_Bool)arg4 fromVCRCExternalThread:(_Bool)arg5;	// IMP=0x000000000030fd30
- (unsigned short)translateTimestampFromMicro:(double)arg1;	// IMP=0x000000000030fd17
- (_Bool)isRemoteSessionStatsTooLateWithStatsId:(unsigned short)arg1;	// IMP=0x000000000030fbf6
- (void)updateRemoteSessionStats:(CDStruct_2756d7ac)arg1;	// IMP=0x000000000030f4f6
- (void)stopLocalSessionStatsUpdate;	// IMP=0x000000000030f3c6
- (void)startLocalSessionStatsSend;	// IMP=0x000000000030f139
- (void)startLocalSessionStatsReceive;	// IMP=0x000000000030eef7
- (void)startLocalSessionStatsUpdate;	// IMP=0x000000000030eec9
- (void)sendLocalStats;	// IMP=0x000000000030ee2c
- (void)reset;	// IMP=0x000000000030ed51
- (void)dealloc;	// IMP=0x000000000030ebc6
- (id)initWithDelegate:(id)arg1 connectionManager:(id)arg2 uplinkStatsCollector:(id)arg3 downlinkStatsCollector:(id)arg4 reportingAgent:(struct opaqueRTCReporting *)arg5 transportSessionID:(unsigned int)arg6 streamID:(unsigned short)arg7 mediaQueue:(struct tagVCMediaQueue *)arg8;	// IMP=0x000000000030e94b
