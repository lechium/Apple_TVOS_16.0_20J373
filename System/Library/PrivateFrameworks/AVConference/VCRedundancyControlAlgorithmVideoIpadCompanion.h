...
- (unsigned int)computeRedundancyWithBurstyLoss;	// IMP=0x0000000000057afe
- (unsigned int)computeRedundancyWithLossPercentage;	// IMP=0x0000000000057ad4
- (void)updateBurstyLoss:(unsigned int)arg1;	// IMP=0x0000000000057a88
- (void)updateRedundancyStrategyWithNetworkStatistics:(CDStruct_7df19fcb)arg1;	// IMP=0x00000000000579da
