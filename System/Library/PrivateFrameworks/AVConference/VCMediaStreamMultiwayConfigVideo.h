...
- (id)streamIds;	// IMP=0x00000000002c893f
- (void)addSubStreamConfig:(id)arg1;	// IMP=0x00000000002c8922
- (void)addPayload:(int)arg1;	// IMP=0x00000000002c88e2
- (void)dealloc;	// IMP=0x00000000002c8867
- (id)init;	// IMP=0x00000000002c87da
