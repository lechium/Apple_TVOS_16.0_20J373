...
- (void)deregisterPeriodicTask;	// IMP=0x000000000030cc98
- (void)setErrorResponseCallback:(CDUnknownBlockType)arg1;	// IMP=0x000000000030cc7c
- (id)sessionInfoSynchronizerDelegate;	// IMP=0x000000000030cc6e
@property(readonly) id reportingAgent;
- (void)setVCIDSSessionInfoPublishedStreamIDs:(id)arg1;	// IMP=0x000000000030c80c
- (void)sendVCIDSSessionInfoSubscribedStreamIDs:(id)arg1;	// IMP=0x000000000030c3e9
- (void)retryVCIDSSessionInfoSubscribedStreamIDs;	// IMP=0x000000000030c1bf
- (void)setVCIDSSessionInfoSubscribedStreamIDs:(id)arg1;	// IMP=0x000000000030be5c
- (void)dealloc;	// IMP=0x000000000030bd82
- (void)flushRealTimeReportingStats;	// IMP=0x000000000030e924
- (void)registerPeriodicTask;	// IMP=0x000000000030e8d1
- (void)periodicTask:(void *)arg1;	// IMP=0x000000000030e69b
- (void)optOutStreamIDsForNonPrimaryConnection:(id)arg1 sentOnConnection:(id)arg2;	// IMP=0x000000000030e425
- (void)optInStreamIDsForNewPrimaryConnection:(id)arg1 oldPrimaryConnection:(id)arg2;	// IMP=0x000000000030e3e3
- (void)optInAllStreamsForConnection:(id)arg1;	// IMP=0x000000000030e3ca
- (void)optInStreamIDsForConnection:(id)arg1;	// IMP=0x000000000030e10d
- (void)updateVCIDSSessionInfoResponse:(id)arg1;	// IMP=0x000000000030d336
- (void)checkVCIDSSessionInfoNeedUpdate:(unsigned char)arg1;	// IMP=0x000000000030d0ec
- (void)resetParticipantGenerationCounter;	// IMP=0x000000000030d011
@property(retain, nonatomic) NSNumber *duplicationLinkID;
@property(retain, nonatomic) NSNumber *primaryLinkID;
- (id)initWithDelegate:(id)arg1 connectionManager:(id)arg2 reportingAgent:(id)arg3;	// IMP=0x000000000030cd02
