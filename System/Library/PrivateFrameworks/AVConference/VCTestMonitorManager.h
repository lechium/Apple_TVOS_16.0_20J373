...
+ (id)sharedManager;	// IMP=0x00600000003972be
...
- (void)registerBlocksForService;	// IMP=0x0000000000397631
- (void)reportSessionMediaDaemonStats:(id)arg1;	// IMP=0x000000000039730d
- (void)dealloc;	// IMP=0x000000000039724e
- (id)init;	// IMP=0x00000000003971ac
