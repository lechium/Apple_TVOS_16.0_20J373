...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000002e3a77
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000002e3b96
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000002e3a7f
...
- (void)unserialize:(id)arg1;	// IMP=0x00000000002e365b
- (id)serialize;	// IMP=0x00000000002e3599
- (id)description;	// IMP=0x00000000002e354f
- (id)init;	// IMP=0x00000000002e34f4
