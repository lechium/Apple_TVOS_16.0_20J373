...
- (void)dealloc;	// IMP=0x0000000000313235
- (id)description;	// IMP=0x0000000000313169
- (_Bool)sendData:(const void *)arg1 size:(unsigned int)arg2 error:(id *)arg3;	// IMP=0x0000000000312ec7
- (void)receiveDataOnSocket:(unsigned short)arg1;	// IMP=0x0000000000312c70
- (void)readyToRead;	// IMP=0x0000000000312c5a
- (int)stop;	// IMP=0x0000000000312b5d
- (int)start;	// IMP=0x0000000000312a08
- (id)initWithSocket:(unsigned short)arg1 remoteAddress:(id)arg2 packetFilter:(id)arg3;	// IMP=0x0000000000312606
