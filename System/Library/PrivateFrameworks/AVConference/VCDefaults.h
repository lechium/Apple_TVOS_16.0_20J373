...
+ (id)copyStringValueForKey:(struct __CFString *)arg1;	// IMP=0x00600000003d4fb5
+ (_Bool)booleanValueForKey:(struct __CFString *)arg1 defaultValue:(_Bool)arg2;	// IMP=0x00600000003d4f92
+ (_Bool)booleanValueForKey:(struct __CFString *)arg1;	// IMP=0x00600000003d4f77
+ (long long)integerValueForKey:(struct __CFString *)arg1 defaultValue:(long long)arg2;	// IMP=0x00600000003d4e2a
+ (long long)integerValueForKey:(struct __CFString *)arg1;	// IMP=0x00600000003d4e0f
+ (double)getDoubleValueForKey:(struct __CFString *)arg1 defaultValue:(double)arg2;	// IMP=0x00600000003d4cba
+ (id)sharedInstance;	// IMP=0x00600000003d4bdb
...
- (_Bool)forceUseInternalRTPThreadingWithDefaultValue:(_Bool)arg1;	// IMP=0x00000000003d6dd4
...
- (_Bool)shouldOverrideEffectsFramerate:(unsigned int *)arg1;	// IMP=0x00000000003d6a9d
...
- (_Bool)enableAudioDumpParticipantLocal:(_Bool)arg1;	// IMP=0x00000000003d6774
- (_Bool)enableAudioDumpParticipantRemote:(_Bool)arg1;	// IMP=0x00000000003d6752
...
- (_Bool)forceWifiAssistOutOfBudget;	// IMP=0x00000000003d6487
- (_Bool)forceWifiAssist;	// IMP=0x00000000003d6467
...
- (unsigned int)forceThermalLevelFramerate:(unsigned int)arg1;	// IMP=0x00000000003d558b
...
- (void)seperateString:(id)arg1;	// IMP=0x00000000003d527e
...
- (id)autorelease;	// IMP=0x00000000003d5077
- (oneway void)release;	// IMP=0x00000000003d5071
- (unsigned long long)retainCount;	// IMP=0x00000000003d5064
- (id)retain;	// IMP=0x00000000003d505b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003d5052
- (id)allocWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000003d5045
- (id)init;	// IMP=0x00000000003d4ff3
