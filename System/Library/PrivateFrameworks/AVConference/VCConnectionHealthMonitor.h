...
- (_Bool)isPrimaryConnectionImprovedFromHistory:(struct ConnectionStatsHistory *)arg1 withIndex:(int)arg2 remoteStatsHistory:(struct ConnectionStatsHistory *)arg3;	// IMP=0x00000000002b820c
- (_Bool)isHistoryImproved:(char *)arg1 currentIndex:(int)arg2;	// IMP=0x00000000002b8191
- (_Bool)isHistoryValid:(char *)arg1;	// IMP=0x00000000002b8165
- (void)updateRatiosForHistory:(struct ConnectionStatsHistory *)arg1 withIndex:(int)arg2;	// IMP=0x00000000002b80f4
- (void)reportConnectionHealthWithStatsHistory:(struct ConnectionStatsHistory *)arg1 index:(int)arg2 isPeerStats:(_Bool)arg3;	// IMP=0x00000000002b7fe0
- (void)resetHistory:(struct ConnectionStatsHistory *)arg1;	// IMP=0x00000000002b7fbd
- (void)updateStatsHistory;	// IMP=0x00000000002b7e10
- (void)resetConnectionStats:(_Bool)arg1;	// IMP=0x00000000002b7db6
- (void)processPeerStatsBlob:(unsigned int)arg1;	// IMP=0x00000000002b7b03
- (unsigned int)generateStatsBlob;	// IMP=0x00000000002b7a5c
- (void)updateReceiveStats;	// IMP=0x00000000002b79a4
@property id <VCConnectionHealthMonitorDelegate> delegate; // @synthesize delegate=_delegate;
- (void)dealloc;	// IMP=0x00000000002b78fb
- (id)init;	// IMP=0x00000000002b777a
