...
- (void)printFlushAckToBasebandDump:(unsigned char)arg1 transactionID:(unsigned short)arg2 packetDropped:(unsigned short)arg3 sequenceNumberArray:(unsigned short *)arg4;	// IMP=0x000000000018afe6
- (void)processBasebandAck:(CDStruct_b203c80d *)arg1;	// IMP=0x000000000018ae9d
- (_Bool)isRadioAccessTechnologyOnCellular:(unsigned int)arg1;	// IMP=0x000000000018ae8e
- (void)enableBasebandLogDump:(void *)arg1;	// IMP=0x000000000018ae74
- (_Bool)processBasebandNotification:(CDStruct_b203c80d *)arg1 arrivalTime:(double)arg2 error:(id *)arg3;	// IMP=0x000000000018ac25
- (_Bool)processBasebandNotification:(id)arg1 metaData:(id)arg2 error:(id *)arg3;	// IMP=0x000000000018ab22
- (void)dealloc;	// IMP=0x000000000018a980
- (id)init;	// IMP=0x000000000018a911
