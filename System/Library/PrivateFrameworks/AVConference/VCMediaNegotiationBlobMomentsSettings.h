...
+ (unsigned int)capabilitiesBitmapWithCapabilities:(unsigned char)arg1;	// IMP=0x00100000003369b6
+ (unsigned int)avcMomentsCapabilitiesForMultiwayMomentsCapabilities:(int)arg1;	// IMP=0x0010000000336571
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000005e241
- (unsigned long long)hash;	// IMP=0x000000000005e1cf
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000005e119
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000005e076
- (void)copyTo:(id)arg1;	// IMP=0x000000000005e011
- (void)writeTo:(id)arg1;	// IMP=0x000000000005df71
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000005df64
- (id)dictionaryRepresentation;	// IMP=0x000000000005da9f
- (id)description;	// IMP=0x000000000005da05
...
- (id)newImageTypeSet;	// IMP=0x0000000000336923
- (id)newVideoCodecSet;	// IMP=0x0000000000336890
- (id)initWithVideoCodecs:(id)arg1 imageTypes:(id)arg2 capabilities:(unsigned char)arg3 multiwayCapabilities:(unsigned char)arg4;	// IMP=0x0000000000336589
