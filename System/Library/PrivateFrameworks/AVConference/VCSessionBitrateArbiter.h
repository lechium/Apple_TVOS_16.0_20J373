...
- (void)readStoreBagValues;	// IMP=0x000000000024499f
- (unsigned int)bitrateForStoreBagKey:(id)arg1 connectionType:(int)arg2 currentBitrate:(unsigned int)arg3 isExpensive:(_Bool)arg4;	// IMP=0x0000000000244791
- (void)readHardwareValues;	// IMP=0x0000000000244767
- (_Bool)rangeCheck:(unsigned int)arg1;	// IMP=0x00000000002446ee
- (void)dealloc;	// IMP=0x0000000000244690
- (id)init;	// IMP=0x000000000024460c
