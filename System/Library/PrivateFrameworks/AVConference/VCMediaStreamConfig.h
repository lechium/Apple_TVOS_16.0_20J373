...
- (int)jitterBufferModeFromAVCJitterBufferMode:(unsigned int)arg1;	// IMP=0x000000000036f069
- (void)applyMediaStreamClientDictionary:(id)arg1;	// IMP=0x000000000036eb97
- (void)setupMediaStreamConfig;	// IMP=0x000000000036eb0e
@property(readonly, nonatomic) long long primaryTxCodecType;
- (void)addTxPayloadType:(int)arg1 networkPayload:(unsigned int)arg2;	// IMP=0x000000000036e94e
- (void)addTxPayloadType:(int)arg1;	// IMP=0x000000000036e937
- (void)addRxPayloadType:(int)arg1 networkPayload:(unsigned int)arg2;	// IMP=0x000000000036e8cc
- (void)addRxPayloadType:(int)arg1;	// IMP=0x000000000036e8b5
- (id)description;	// IMP=0x000000000036e874
- (void)dealloc;	// IMP=0x000000000036e796
- (id)initWithClientDictionary:(id)arg1;	// IMP=0x000000000036e6cd
- (id)init;	// IMP=0x000000000036e65e
