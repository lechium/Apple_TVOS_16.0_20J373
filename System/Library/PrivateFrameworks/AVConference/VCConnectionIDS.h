...
+ (unsigned int)worstCaseNetworkOverheadInBytesWithNumOfStreamId:(int)arg1 isPriorityIncluded:(_Bool)arg2;	// IMP=0x001000000021f577
...
- (int)cellTechForSoMask:(unsigned int)arg1 fallbackTo:(int)arg2;	// IMP=0x000000000022002d
- (_Bool)matchesChannelTokenWithSourceDestinationInfo:(struct tagVCSourceDestinationInfo *)arg1;	// IMP=0x000000000021fffd
- (_Bool)matchesSourceDestinationInfo:(struct tagVCSourceDestinationInfo *)arg1;	// IMP=0x000000000021ffb6
@property(readonly) unsigned char linkID;
- (_Bool)isOnSameInterfacesAndQRSessionWithConnection:(id)arg1;	// IMP=0x000000000021fd92
- (_Bool)isOnSameQRSessionWithConnection:(id)arg1;	// IMP=0x000000000021fce1
- (_Bool)isOnSameInterfacesWithConnection:(id)arg1;	// IMP=0x000000000021fac4
- (unsigned short)updateMaxConnectionMTU:(unsigned short)arg1;	// IMP=0x000000000021f90d
- (_Bool)isSameAsConnection:(id)arg1;	// IMP=0x000000000021f897
@property int remoteCellTech;
@property int localCellTech;
- (void)setCellularMTU:(int)arg1;	// IMP=0x000000000021f80d
- (void)getSourceDestinationInfo:(struct tagVCSourceDestinationInfo *)arg1;	// IMP=0x000000000021f72d
...
- (int)networkOverheadInBytesWithNumOfStreamId:(int)arg1 isPriorityIncluded:(_Bool)arg2;	// IMP=0x000000000021f534
@property int connectionMTU;
- (id)connectionQRSessionID;	// IMP=0x000000000021f4f7
...
- (void)dealloc;	// IMP=0x000000000021eccd
- (id)initWithLinkContext:(id)arg1 dataChannelToken:(unsigned int)arg2;	// IMP=0x000000000021e8d4
