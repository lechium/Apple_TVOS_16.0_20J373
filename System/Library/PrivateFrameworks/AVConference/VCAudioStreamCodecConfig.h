...
- (void)setupEVSModesWithClientModeMask:(unsigned int)arg1;	// IMP=0x00000000000471ff
- (void)setupAMRWBModesWithClientModeMask:(unsigned int)arg1;	// IMP=0x0000000000046ff7
- (void)setupAMRModesWithClientModeMask:(unsigned int)arg1;	// IMP=0x0000000000046e24
- (void)setPreferredModeWithClientMode:(int)arg1;	// IMP=0x0000000000046e1b
- (void)setupCodecBandwidthsWithClientBandwidthMask:(unsigned int)arg1;	// IMP=0x0000000000046cb4
- (void)setupModesWithClientModeMask:(unsigned int)arg1;	// IMP=0x0000000000046c65
@property(readonly, nonatomic) _Bool isComfortNoise;
- (void)dealloc;	// IMP=0x0000000000046bbe
- (id)initWithCodecType:(long long)arg1;	// IMP=0x0000000000046b25
