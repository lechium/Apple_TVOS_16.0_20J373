...
+ (id)schedulerStreamWithKeyFrameInterval:(unsigned int)arg1 framerate:(unsigned int)arg2 weightFactor:(unsigned int)arg3;	// IMP=0x006000000029772b
...
- (id)description;	// IMP=0x000000000029783e
- (long long)compareWeightFactor:(id)arg1;	// IMP=0x00000000002977e7
- (id)initWithKeyFrameInterval:(unsigned int)arg1 framerate:(unsigned int)arg2 weightFactor:(unsigned int)arg3;	// IMP=0x0000000000297773
