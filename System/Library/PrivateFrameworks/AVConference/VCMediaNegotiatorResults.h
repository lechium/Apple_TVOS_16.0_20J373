...
- (unsigned int)maxBandwidthWithOperatingMode:(int)arg1 connectionType:(int)arg2;	// IMP=0x00000000002d420a
- (void)addBandwidthConfigurations:(id)arg1;	// IMP=0x00000000002d41d5
- (void)dealloc;	// IMP=0x00000000002d4161
- (id)init;	// IMP=0x00000000002d40e1
