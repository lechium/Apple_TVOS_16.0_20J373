...
- (void)dealloc;	// IMP=0x000000000031439c
- (_Bool)sendData:(const void *)arg1 size:(unsigned int)arg2 error:(id *)arg3;	// IMP=0x000000000031405c
- (void)readyToRead;	// IMP=0x0000000000314024
- (int)stop;	// IMP=0x0000000000313f04
- (int)start;	// IMP=0x00000000003137c0
- (id)initWithIDSDestination:(id)arg1;	// IMP=0x00000000003135b7
- (id)initWithIDSSocketDescriptor:(unsigned short)arg1;	// IMP=0x00000000003133ad
