...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000104d36
- (_Bool)isEqualFaceTimeSettings:(id)arg1;	// IMP=0x0000000000104c51
- (_Bool)isEqualMomentsVideoCodecs:(id)arg1;	// IMP=0x0000000000104ac5
- (_Bool)isEqualMomentsImageTypes:(id)arg1;	// IMP=0x0000000000104933
- (_Bool)isEqualFeatureStrings:(id)arg1;	// IMP=0x000000000010442e
- (_Bool)isEqualStreamGroupConfigs:(id)arg1;	// IMP=0x00000000001041f1
- (_Bool)isEqualMultiwayVideoStreamSet:(id)arg1;	// IMP=0x0000000000103fba
- (_Bool)isEqualMultiwayAudioStreamSet:(id)arg1;	// IMP=0x0000000000103d83
- (_Bool)isEqualBandwidthConfigurations:(id)arg1;	// IMP=0x0000000000103b7e
- (void)resetStreamGroups;	// IMP=0x0000000000103b65
- (void)addStreamGroupConfig:(id)arg1;	// IMP=0x0000000000103b4c
- (void)addMultiwayVideoStream:(id)arg1;	// IMP=0x0000000000103b36
- (void)addMultiwayAudioStream:(id)arg1;	// IMP=0x0000000000103b20
- (void)addBandwidthConfiguration:(id)arg1;	// IMP=0x0000000000103b0a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000103799
- (_Bool)setupBandwidthExtensionConfiguration:(id)arg1;	// IMP=0x0000000000103365
- (_Bool)setupBandwidthConfigurationsWithArbiter:(id)arg1;	// IMP=0x0000000000102e93
- (void)dealloc;	// IMP=0x0000000000102dbf
- (id)initWithBitrateArbiter:(id)arg1;	// IMP=0x0000000000102d76
- (id)init;	// IMP=0x00000000001029d8
