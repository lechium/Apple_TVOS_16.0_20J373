...
- (id)newTextureByBinarizingPixelBuffer:(struct __CVBuffer *)arg1 error:(id *)arg2;	// IMP=0x0000000000044302
- (id)initWithMetalContext:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000044190
- (id)init;	// IMP=0x000000000004417a
