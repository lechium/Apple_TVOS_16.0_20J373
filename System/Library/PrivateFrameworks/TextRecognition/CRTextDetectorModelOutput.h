...
- (void).cxx_destruct;	// IMP=0x0000000000019464
...
- (id)featureValueForName:(id)arg1;	// IMP=0x0000000000019395
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithF_score_act_sigmoid_output:(id)arg1 geometry_output:(id)arg2;	// IMP=0x0000000000019303
