...
+ (id)infoForFeature:(id)arg1 scale:(float)arg2 bounds:(struct CGRect)arg3 featureImageSize:(struct CGSize)arg4 rotatedROI:(struct CGRect)arg5;	// IMP=0x0010000000118c98
- (void).cxx_destruct;	// IMP=0x0000000000118f8d
