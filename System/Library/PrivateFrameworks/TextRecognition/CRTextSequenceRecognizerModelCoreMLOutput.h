...
- (void).cxx_destruct;	// IMP=0x0000000000019fb5
...
- (id)featureValueForName:(id)arg1;	// IMP=0x0000000000019f1e
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithOutput_label_prob_map:(id)arg1;	// IMP=0x0000000000019eba
