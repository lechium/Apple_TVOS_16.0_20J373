...
+ (_Bool)isDirectMessagingRequested:(id)arg1;	// IMP=0x006000000000de81
...
- (void)logConnectionStatisticsInPowerDictionary;	// IMP=0x0000000000013e3c
- (void)startPowerLogReportTimer;	// IMP=0x0000000000013d0f
- (void)clearPowerAssertion;	// IMP=0x0000000000013cb4
- (void)getPowerAssertion;	// IMP=0x0000000000013b2d
- (void)dequeueMessages;	// IMP=0x00000000000136b6
- (void)sendMessageWithParameters:(id)arg1 options:(id)arg2;	// IMP=0x00000000000128f2
- (void)failedToSendMessage:(id)arg1 responseCode:(long long)arg2;	// IMP=0x000000000001269f
- (void)suspendPendingAckTimer;	// IMP=0x0000000000012677
- (void)resumePendingAckTimer;	// IMP=0x000000000001264f
- (void)cancelPendingAckTimer;	// IMP=0x000000000001260e
- (id)createDispatchDataForMessageSend:(id)arg1 isAck:(_Bool)arg2 ackMessageId:(unsigned int)arg3;	// IMP=0x0000000000011b97
- (unsigned char)getMessageTypeForFirstMessage;	// IMP=0x00000000000119ee
- (void)sendAppAckWithGUID:(id)arg1;	// IMP=0x00000000000110ea
- (void)sendAckForMessageID:(unsigned int)arg1 guidToAck:(id)arg2;	// IMP=0x0000000000010e0d
- (void)processIncomingMessage:(id)arg1 messageType:(unsigned char)arg2 messageIdentifier:(unsigned int)arg3;	// IMP=0x000000000000fdc5
- (void)receiveMessages;	// IMP=0x000000000000f8cc
- (void)setupConnectionIfApplicable;	// IMP=0x000000000000f879
- (void)receivedDirectMessagingSocketWithContext:(id)arg1;	// IMP=0x000000000000f4b2
- (void)setupIDSDeviceConnection;	// IMP=0x000000000000f030
- (void)updateTrafficClass:(unsigned short)arg1;	// IMP=0x000000000000f018
- (void)updateConnection:(id)arg1;	// IMP=0x000000000000ed4e
- (void)resetConnection;	// IMP=0x000000000000ec4a
- (void)updateMetadata:(id)arg1;	// IMP=0x000000000000e768
- (void)updateConnectedDevices:(id)arg1;	// IMP=0x000000000000e317
- (_Bool)isMessageEligible:(id)arg1 options:(id)arg2 destinationDevice:(id)arg3;	// IMP=0x000000000000df63
- (_Bool)canUseDirectMessaging;	// IMP=0x000000000000de6a
- (void)setDestinationDevice:(id)arg1;	// IMP=0x000000000000dcfc
- (void)invalidate;	// IMP=0x000000000000dc00
- (void)cancel;	// IMP=0x000000000000db3d
- (id)description;	// IMP=0x000000000000daaa
- (void)dealloc;	// IMP=0x000000000000d9a8
- (void)parseDirectMessagingState;	// IMP=0x000000000000d820
- (id)initWithServiceName:(id)arg1 queue:(id)arg2 delegate:(id)arg3;	// IMP=0x000000000000d520
