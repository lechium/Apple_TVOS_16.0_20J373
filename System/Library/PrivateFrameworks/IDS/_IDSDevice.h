...
- (void).cxx_destruct;	// IMP=0x00000000000e6731
@property(readonly, nonatomic) IDSEndpointCapabilities *capabilities; // @synthesize capabilities=_capabilities;
- (void)_setService:(id)arg1;	// IMP=0x00000000000e6645
- (void)_setAccount:(id)arg1;	// IMP=0x00000000000e6563
- (void)_stateChanged;	// IMP=0x00000000000e63f1
- (void)_cloudConnectedStateChanged;	// IMP=0x00000000000e62b2
- (void)_connectedStateChanged;	// IMP=0x00000000000e6173
- (void)_nearbyStateChanged;	// IMP=0x00000000000e6034
- (_Bool)isTinker;	// IMP=0x00000000000e601c
- (void)_addIdentity:(id)arg1;	// IMP=0x00000000000e5cc8
...
- (id)compactDescription;	// IMP=0x00000000000e3fd5
- (id)description;	// IMP=0x00000000000e3b4b
- (id)fullDescription;	// IMP=0x00000000000e3697
...
- (void)dealloc;	// IMP=0x00000000000e2f89
- (id)initWithDictionary:(id)arg1;	// IMP=0x00000000000e27bc
