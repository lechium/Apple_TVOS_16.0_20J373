...
- (void).cxx_destruct;	// IMP=0x000000000011d818
...
- (id)accountForAlias:(id)arg1;	// IMP=0x000000000011d777
- (id)initWithAccountIdentity:(id)arg1 aliasToAccountsMap:(id)arg2 serviceName:(id)arg3;	// IMP=0x000000000011d6c0
