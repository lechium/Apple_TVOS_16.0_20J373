...
- (void).cxx_destruct;	// IMP=0x000000000007ea19
- (id)deviceConnectionKey;	// IMP=0x000000000007e9ec
- (void)_daemonDied:(id)arg1;	// IMP=0x000000000007e8b2
- (void)_cleanupCompletionBlock;	// IMP=0x000000000007e862
- (void)xpcObject:(id)arg1 objectContext:(id)arg2;	// IMP=0x000000000007e1f3
- (void)_close;	// IMP=0x000000000007dd5d
- (void)close;	// IMP=0x000000000007dcb1
- (_Bool)updateConnectionWithOptions:(id)arg1 error:(id *)arg2;	// IMP=0x000000000007d8fc
- (void)setStreamPairWithInputStream:(id)arg1 outputStream:(id)arg2;	// IMP=0x000000000007d731
...
- (void)_connect;	// IMP=0x000000000007d1c1
- (void)dealloc;	// IMP=0x000000000007d09f
- (id)initWithDevice:(id)arg1 options:(id)arg2 completionHandler:(CDUnknownBlockType)arg3 queue:(id)arg4;	// IMP=0x000000000007c1b8
