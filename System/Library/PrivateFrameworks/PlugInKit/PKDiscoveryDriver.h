...
- (void).cxx_destruct;	// IMP=0x000000000000c87e
...
- (void)removeWatchers;	// IMP=0x000000000000c608
- (void)installWatchers;	// IMP=0x000000000000c34a
- (void)cancel;	// IMP=0x000000000000c0d0
- (void)_performWithPreviousResults:(id)arg1 forceNotify:(_Bool)arg2 uninstalledProxies:(id)arg3;	// IMP=0x000000000000bb60
- (void)performWithPreviousResults:(id)arg1 forceNotify:(_Bool)arg2;	// IMP=0x000000000000b449
- (void)dealloc;	// IMP=0x000000000000b312
- (id)initWithAttributes:(id)arg1 flags:(unsigned long long)arg2 host:(id)arg3 report:(CDUnknownBlockType)arg4;	// IMP=0x000000000000aeb7
