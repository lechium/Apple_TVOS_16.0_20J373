...
- (id).cxx_construct;	// IMP=0x0000000000023be0
- (void).cxx_destruct;	// IMP=0x0000000000023b8a
@property(readonly) NSUUID *peer; // @synthesize peer=_peer;
- (long long)deviceProximity;	// IMP=0x0000000000023b6c
- (_Bool)proxReady;	// IMP=0x0000000000023af9
- (void)addSample:(struct BtProxData)arg1;	// IMP=0x0000000000023a74
- (id)initWithPeer:(id)arg1 andPeerModel:(id)arg2 withError:(id *)arg3;	// IMP=0x0000000000023734
- (id)init;	// IMP=0x00000000000236f6
