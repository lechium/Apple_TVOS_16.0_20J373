...
+ (id)identifierForPID:(int)arg1;	// IMP=0x0060000000001eb0
...
- (_Bool)updateFromListing:(id)arg1;	// IMP=0x000000000000224f
- (id)dictionaryRepresentation;	// IMP=0x0000000000002001
@property(readonly, nonatomic) NSString *identifier; // @dynamic identifier;
- (id)initWithPID:(int)arg1 bundleId:(id)arg2 name:(id)arg3 isProxy:(_Bool)arg4 connection:(id)arg5 debuggerAvailability:(unsigned long long)arg6;	// IMP=0x0000000000001ed5
