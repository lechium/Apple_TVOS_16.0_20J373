...
- (void).cxx_destruct;	// IMP=0x00000000000179f8
...
- (id)removeAllMessages;	// IMP=0x0000000000017969
- (void)addMessage:(id)arg1;	// IMP=0x000000000001784b
- (id)init;	// IMP=0x000000000001774f
