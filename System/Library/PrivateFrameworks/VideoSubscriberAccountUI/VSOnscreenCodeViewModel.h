...
- (void).cxx_destruct;	// IMP=0x000000000001da2f
...
- (id)formattedWebsiteURL;	// IMP=0x000000000001d4d7
- (id)websiteURLWithQueryParameters;	// IMP=0x000000000001cfbc
- (void)generateQRCode;	// IMP=0x000000000001cded
- (void)configureWithRequest:(id)arg1;	// IMP=0x000000000001cd89
