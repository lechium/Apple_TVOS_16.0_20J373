...
- (void).cxx_destruct;	// IMP=0x0000000000046cef
...
- (void)buttonAtIndexWasPressed:(unsigned long long)arg1;	// IMP=0x0000000000046bd5
- (void)configureWithRequest:(id)arg1;	// IMP=0x0000000000046a0b
- (id)init;	// IMP=0x0000000000046673
