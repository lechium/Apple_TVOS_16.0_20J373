...
- (void).cxx_destruct;	// IMP=0x0000000000046631
...
- (void)setupLocalizedStrings;	// IMP=0x0000000000046519
- (void)setupLayout;	// IMP=0x0000000000045cf7
- (void)setupViews;	// IMP=0x0000000000045a6b
- (id)init;	// IMP=0x00000000000459fd
