...
- (void).cxx_destruct;	// IMP=0x0000000000051ed7
...
- (void)configureWithRequest:(id)arg1;	// IMP=0x0000000000051c6a
- (void)didSelectManualSignInButton;	// IMP=0x0000000000051c1e
- (id)init;	// IMP=0x0000000000051b5a
