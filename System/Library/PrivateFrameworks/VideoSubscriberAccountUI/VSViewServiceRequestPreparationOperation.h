...
- (void).cxx_destruct;	// IMP=0x000000000002469a
...
- (void)cancel;	// IMP=0x000000000002442c
- (void)executionDidBegin;	// IMP=0x000000000002441a
- (void)_promptForPrivacyWithDisplayNameIfRequired:(id)arg1 providerID:(id)arg2 providerIsSupported:(_Bool)arg3 allowUI:(_Bool)arg4;	// IMP=0x00000000000240a6
- (void)_determineProviderDisplayNameWithUI:(_Bool)arg1;	// IMP=0x0000000000023ad1
- (void)_checkSupportedProviders;	// IMP=0x00000000000233f1
- (void)_finishWithSupportedProviders:(id)arg1;	// IMP=0x0000000000022b4e
- (void)_checkAvailability;	// IMP=0x00000000000229cb
- (void)_continueCheckPrivacyWithAccessStatus:(unsigned long long)arg1;	// IMP=0x000000000002282c
- (void)_checkPrivacy;	// IMP=0x000000000002204c
- (void)_checkEntitlement;	// IMP=0x0000000000021f04
- (void)_finishWithError:(id)arg1;	// IMP=0x0000000000021dee
- (id)_privacyServiceWithErrorHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000021d6b
- (void)dealloc;	// IMP=0x0000000000021d22
- (id)init;	// IMP=0x0000000000021acf
