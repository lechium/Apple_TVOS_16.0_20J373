...
- (void).cxx_destruct;	// IMP=0x000000000001cd38
...
- (void)setupLayout;	// IMP=0x000000000001c46b
- (void)setupSeparatorContainer;	// IMP=0x000000000001c406
- (void)setupWebsiteContainer;	// IMP=0x000000000001c371
- (void)setupQRCodeContainer;	// IMP=0x000000000001c30c
- (void)buttonLockupPressed;	// IMP=0x000000000001c2cf
- (void)updateUIWithViewModel:(id)arg1;	// IMP=0x000000000001c22f
- (void)setupViews;	// IMP=0x000000000001c1f4
- (id)initWithButtonLockup:(_Bool)arg1;	// IMP=0x000000000001c185
