...
+ (id)toVSSubscriptions:(id)arg1;	// IMP=0x0010000000050abb
- (void).cxx_destruct;	// IMP=0x0000000000050e12
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000050c83
- (id)toVSSubscription;	// IMP=0x0000000000050955
- (id)init;	// IMP=0x0000000000050877
