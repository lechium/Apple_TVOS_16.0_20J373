...
+ (id)makeFeatureJSObjectForFeature:(id)arg1;	// IMP=0x0010000000026ea3
...
- (void)messagePort:(id)arg1 didReceiveMessage:(id)arg2;	// IMP=0x00000000000270b2
- (id)initWithDOMNode:(id)arg1 featureName:(id)arg2;	// IMP=0x0000000000026fe4
