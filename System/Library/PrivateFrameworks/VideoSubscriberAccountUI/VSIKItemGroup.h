...
+ (id)makeFeatureJSObjectForFeature:(id)arg1;	// IMP=0x0010000000019653
+ (void)registerFeature;	// IMP=0x0010000000019621
- (void).cxx_destruct;	// IMP=0x0000000000019a57
...
- (id)initWithDOMNode:(id)arg1 featureName:(id)arg2;	// IMP=0x00000000000196ea
