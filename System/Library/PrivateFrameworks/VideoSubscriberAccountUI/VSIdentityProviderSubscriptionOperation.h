...
- (void).cxx_destruct;	// IMP=0x0000000000014551
...
- (void)cancel;	// IMP=0x000000000001440f
- (void)_registerSubscriptions:(id)arg1 withAuthorizedBundleIdentifiers:(id)arg2;	// IMP=0x0000000000014055
- (void)_removeSubscriptionsForBundleIdentifiers:(id)arg1 withAuthorizedBundleIdentifiers:(id)arg2;	// IMP=0x00000000000139a9
- (id)_authorizedBundleIdsFromAppDescriptions:(id)arg1;	// IMP=0x0000000000013808
- (void)executionDidBegin;	// IMP=0x0000000000012bcd
- (id)initWithRegistrationCenter:(id)arg1 andDeveloperSettingsFetchOperation:(id)arg2;	// IMP=0x0000000000012b32
- (id)init;	// IMP=0x0000000000012a49
