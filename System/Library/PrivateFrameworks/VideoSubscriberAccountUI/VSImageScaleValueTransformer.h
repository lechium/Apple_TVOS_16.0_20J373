...
+ (_Bool)allowsReverseTransformation;	// IMP=0x0060000000007ef6
+ (Class)transformedValueClass;	// IMP=0x0060000000007ee5
@property(nonatomic) struct CGSize preferredSize; // @synthesize preferredSize=_preferredSize;
- (id)transformedValue:(id)arg1;	// IMP=0x0000000000007efe
