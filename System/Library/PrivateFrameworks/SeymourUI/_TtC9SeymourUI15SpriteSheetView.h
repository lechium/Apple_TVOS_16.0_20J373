...
- (void).cxx_destruct;	// IMP=0x0000000000207580
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000207500
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000002074b0
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000206730
