...
+ (long long)activityCategory;	// IMP=0x00400000005b0aa0
- (void).cxx_destruct;	// IMP=0x00000000005b1170
- (id)init;	// IMP=0x00000000005b1110
- (void)performActivity;	// IMP=0x00000000005b10e0
- (void)prepareWithActivityItems:(id)arg1;	// IMP=0x00000000005b0f10
- (_Bool)canPerformWithActivityItems:(id)arg1;	// IMP=0x00000000005b0cb0
