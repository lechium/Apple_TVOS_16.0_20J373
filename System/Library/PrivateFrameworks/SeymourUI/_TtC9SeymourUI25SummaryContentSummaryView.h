...
- (void).cxx_destruct;	// IMP=0x0000000000161320
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000000161120
- (void)layoutSubviews;	// IMP=0x0000000000160e50
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000160e30
- (void)bookmarkButtonTapped;	// IMP=0x0000000000160dd0
@property(nonatomic, readonly) struct CGSize intrinsicContentSize;
- (void)updateConstraints;	// IMP=0x0000000000160c10
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000015fd00
