...
+ (long long)activityCategory;	// IMP=0x0040000000228310
- (void).cxx_destruct;	// IMP=0x0000000000228900
- (id)init;	// IMP=0x00000000002288a0
- (void)performActivity;	// IMP=0x0000000000228870
- (void)prepareWithActivityItems:(id)arg1;	// IMP=0x00000000002286a0
- (_Bool)canPerformWithActivityItems:(id)arg1;	// IMP=0x0000000000228440
