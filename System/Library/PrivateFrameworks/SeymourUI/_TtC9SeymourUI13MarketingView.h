...
- (void).cxx_destruct;	// IMP=0x000000000047daf0
- (void)dismissButtonTapped:(id)arg1;	// IMP=0x000000000047c840
- (void)actionItemButtonTapped:(id)arg1;	// IMP=0x000000000047c7f0
- (void)layoutSubviews;	// IMP=0x000000000047ae60
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000047a2f0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000047a2c0
