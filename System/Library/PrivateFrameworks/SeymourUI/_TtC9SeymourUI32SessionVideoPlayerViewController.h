...
- (void).cxx_destruct;	// IMP=0x00000000004c2690
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x00000000004c2610
- (void)viewSafeAreaInsetsDidChange;	// IMP=0x00000000004c25b0
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x00000000004c2350
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x00000000004c22a0
- (void)viewDidLoad;	// IMP=0x00000000004c2270
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000004c1fb0
