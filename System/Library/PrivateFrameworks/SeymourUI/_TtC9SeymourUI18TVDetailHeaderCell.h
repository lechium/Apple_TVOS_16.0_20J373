...
@interface _TtC9SeymourUI18TVDetailHeaderCell : UICollectionViewCell
{
    ...
    MISSING_TYPE *onElementDisappearance;	// 9834840 = 0x961158
    ...
    MISSING_TYPE *accessibilityMediaTags;	// 27 = 0x1b
}

- (void).cxx_destruct;	// IMP=0x0000000000223840
...
- (void)handleTappedButton:(id)arg1;	// IMP=0x00000000002236d0
- (void)layoutSubviews;	// IMP=0x00000000002222d0
- (void)prepareForReuse;	// IMP=0x00000000002221a0
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000222040
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000222010
