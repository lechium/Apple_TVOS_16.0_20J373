...
+ (long long)activityCategory;	// IMP=0x0040000000074440
- (void).cxx_destruct;	// IMP=0x0000000000074aa0
- (id)init;	// IMP=0x0000000000074a40
- (void)performActivity;	// IMP=0x0000000000074a10
- (void)prepareWithActivityItems:(id)arg1;	// IMP=0x0000000000074840
- (_Bool)canPerformWithActivityItems:(id)arg1;	// IMP=0x00000000000745e0
