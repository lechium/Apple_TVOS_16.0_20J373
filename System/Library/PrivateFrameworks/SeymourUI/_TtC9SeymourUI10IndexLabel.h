...
- (void).cxx_destruct;	// IMP=0x0000000000235230
- (void)textSizeUpdated:(id)arg1;	// IMP=0x0000000000234e40
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000234cb0
- (void)layoutSubviews;	// IMP=0x0000000000234c80
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000234a80
