...
- (void).cxx_destruct;	// IMP=0x00000000003d3d50
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000003d3c60
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000003d3c40
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000003d3c10
