...
- (void).cxx_destruct;	// IMP=0x000000000018b58b
...
- (_Bool)currentQueueIsValidationQueue;	// IMP=0x000000000018b520
- (id)init;	// IMP=0x000000000018b4de
- (id)initWithDatabasePath:(id)arg1;	// IMP=0x000000000018b38c
