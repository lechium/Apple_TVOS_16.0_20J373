...
- (void).cxx_destruct;	// IMP=0x00000000000b7aff
...
- (void)execute;	// IMP=0x00000000000b7999
- (id)initWithDatabasePath:(id)arg1 accountChangeObserver:(id)arg2;	// IMP=0x00000000000b78eb
