...
- (id).cxx_construct;	// IMP=0x0000000000146e32
- (void).cxx_destruct;	// IMP=0x0000000000146de2
...
- (_Bool)unregister;	// IMP=0x0000000000146b83
- (_Bool)registerWithConnection:(id)arg1;	// IMP=0x00000000001468ac
@property(readonly, nonatomic) NSString *name;
- (void)dealloc;	// IMP=0x000000000014682b
- (id)initWithDatabaseTable:(id)arg1;	// IMP=0x00000000001466a9
