...
- (void).cxx_destruct;	// IMP=0x000000000008fadb
- (id)nextObject;	// IMP=0x000000000008f8dc
- (id)initWithDirtyInsertsEnumerator:(id)arg1 connection:(id)arg2;	// IMP=0x000000000008f83a
