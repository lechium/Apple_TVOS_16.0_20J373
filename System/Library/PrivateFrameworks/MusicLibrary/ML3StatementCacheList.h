...
- (void).cxx_destruct;	// IMP=0x00000000000d0465
...
- (void)deleteAllNodes;	// IMP=0x00000000000d0418
- (void)deleteOldestNode;	// IMP=0x00000000000d03c0
- (id)oldestNode;	// IMP=0x00000000000d03b2
- (void)promoteNodeWithDictionaryKey:(id)arg1;	// IMP=0x00000000000d020e
- (void)appendNode:(id)arg1;	// IMP=0x00000000000d01ae
@property(readonly, nonatomic) unsigned long long count;
- (id)description;	// IMP=0x00000000000d0030
