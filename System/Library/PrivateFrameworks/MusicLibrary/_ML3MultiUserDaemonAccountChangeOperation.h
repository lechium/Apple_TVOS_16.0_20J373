...
- (void).cxx_destruct;	// IMP=0x000000000018c3b0
...
- (void)execute;	// IMP=0x000000000018bf6b
- (id)initWithInitialDSID:(id)arg1 finalDSID:(id)arg2 accountChangeObserver:(id)arg3;	// IMP=0x000000000018be7b
