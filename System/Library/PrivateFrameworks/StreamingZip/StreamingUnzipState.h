...
+ (id)unzipStateWithPath:(id)arg1 options:(id)arg2 error:(id *)arg3;	// IMP=0x0060000000021d3e
...
- (id)initWithPath:(id)arg1 options:(id)arg2 error:(id *)arg3;	// IMP=0x000000000001e038
- (_Bool)openCurrentOutputFDForPath:(id)arg1 withOpenFlags:(int)arg2 mode:(unsigned short)arg3 error:(id *)arg4;	// IMP=0x000000000001dc68
- (id)finishStream;	// IMP=0x000000000001db3f
- (id)updateHashFromOffset:(unsigned long long)arg1 withBytes:(const void *)arg2 length:(unsigned long long)arg3;	// IMP=0x000000000001db2a
- (id)updateHashFromOffset:(unsigned long long)arg1 withBytes:(const void *)arg2 length:(unsigned long long)arg3 onlyFinishCurrentChunk:(_Bool)arg4;	// IMP=0x000000000001d882
- (id)checkLastChunkPartialHash;	// IMP=0x000000000001d5bf
- (id)_checkHashForOffset:(unsigned long long)arg1;	// IMP=0x000000000001cf22
- (id)serializeState;	// IMP=0x000000000001c199
- (void)markResumptionPoint;	// IMP=0x000000000001c193
- (void)clearSavedState;	// IMP=0x000000000001c0d0
- (void)_internalSetStreamState:(unsigned char)arg1;	// IMP=0x000000000001bda2
@property(readonly, nonatomic) CDStruct_4686af4b *cmpState;
- (void)dealloc;	// IMP=0x000000000001bd37
- (id)init;	// IMP=0x000000000001bd14
