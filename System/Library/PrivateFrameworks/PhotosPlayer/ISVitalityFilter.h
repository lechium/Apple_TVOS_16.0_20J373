...
- (void).cxx_destruct;	// IMP=0x000000000002592a
...
- (void)inputDidChange;	// IMP=0x000000000002574d
- (void)_invalidateOutput;	// IMP=0x0000000000025736
- (void)performOutputChanges:(CDUnknownBlockType)arg1;	// IMP=0x000000000002565e
- (void)performInputChanges:(CDUnknownBlockType)arg1;	// IMP=0x00000000000255ce
- (id)initWithSettings:(id)arg1;	// IMP=0x0000000000025563
- (id)init;	// IMP=0x000000000002554f
