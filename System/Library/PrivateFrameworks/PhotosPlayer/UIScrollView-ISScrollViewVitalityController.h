...
- (id)is_scrollViewDelegate;	// IMP=0x00300000000246fe
- (void)is_didLayoutPlayerViews;	// IMP=0x00300000000246c1
- (id)is_vitalityControllerCreateIfNeeded:(_Bool)arg1;	// IMP=0x0030000000024645
