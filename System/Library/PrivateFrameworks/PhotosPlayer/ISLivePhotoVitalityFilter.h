...
- (void).cxx_destruct;	// IMP=0x0000000000013cb1
...
- (void)updateOutput;	// IMP=0x0000000000013c4c
- (void)invalidateOutput;	// IMP=0x0000000000013c35
- (void)performInputChanges:(CDUnknownBlockType)arg1;	// IMP=0x0000000000013ba5
- (void)setState:(long long)arg1;	// IMP=0x0000000000013b27
- (id)initWithSettings:(id)arg1;	// IMP=0x0000000000013abc
- (id)init;	// IMP=0x0000000000013aa8
