...
- (void).cxx_destruct;	// IMP=0x000000000001392b
...
- (void)cancelSettleToPhoto;	// IMP=0x0000000000013782
- (void)_didReachTransitionToPhotoTime;	// IMP=0x0000000000013548
- (void)_didReachTransitionTime;	// IMP=0x0000000000013430
- (void)_startVideoPlayback;	// IMP=0x0000000000013301
- (void)videoReadyForDisplayDidChange;	// IMP=0x0000000000013298
- (void)playVitality;	// IMP=0x0000000000013207
- (long long)behaviorType;	// IMP=0x00000000000131fc
- (void)_handleDidFinishPreroll;	// IMP=0x00000000000131a3
- (void)_handleDidSeekToStartTime;	// IMP=0x000000000001307e
- (void)_stopObservingVideo;	// IMP=0x0000000000012fe1
- (void)_startObservingVideo;	// IMP=0x0000000000012b97
- (void)prepareForVitality;	// IMP=0x00000000000128de
- (void)activeDidChange;	// IMP=0x0000000000012844
- (id)initWithInitialLayoutInfo:(id)arg1 playbackEndTime:(CDStruct_1b6d18a9)arg2 playDuration:(CDStruct_1b6d18a9)arg3 playRate:(float)arg4 photoTransitionDuration:(double)arg5 pauseDuringTransition:(_Bool)arg6 assetOptions:(unsigned long long)arg7;	// IMP=0x000000000001278e
- (void)dealloc;	// IMP=0x00000000000126d1
