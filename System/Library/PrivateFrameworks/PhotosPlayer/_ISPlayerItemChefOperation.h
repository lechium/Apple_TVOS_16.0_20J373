...
- (void).cxx_destruct;	// IMP=0x000000000001dc39
...
- (void)_preparePlayerItem;	// IMP=0x000000000001d039
- (void)_handleValuesDidLoad;	// IMP=0x000000000001cfd4
- (void)main;	// IMP=0x000000000001cf03
- (id)initWithAsset:(id)arg1 trimmedTimeRange:(CDStruct_e83c9415)arg2 photoTime:(CDStruct_1b6d18a9)arg3 includeAudio:(_Bool)arg4 includeVideo:(_Bool)arg5 resultHandler:(CDUnknownBlockType)arg6;	// IMP=0x000000000001cdbc
