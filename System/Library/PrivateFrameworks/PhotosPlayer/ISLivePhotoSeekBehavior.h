...
- (void).cxx_destruct;	// IMP=0x00000000000111a6
...
- (long long)behaviorType;	// IMP=0x0000000000011159
- (void)_handleDidSeekToSeekTime:(_Bool)arg1;	// IMP=0x0000000000011074
- (void)_callSeekCompletionHandler:(_Bool)arg1;	// IMP=0x0000000000010fdb
- (void)_seekIfNeeded;	// IMP=0x0000000000010f16
- (void)activeDidChange;	// IMP=0x0000000000010e13
- (id)initWithInitialLayoutInfo:(id)arg1 seekTime:(CDStruct_1b6d18a9)arg2;	// IMP=0x0000000000010d69
