...
- (void).cxx_destruct;	// IMP=0x0000000000002f99
...
- (void)_stopObservingPlayer;	// IMP=0x0000000000002ee4
- (void)dealloc;	// IMP=0x0000000000002ea6
- (void)cancel;	// IMP=0x0000000000002e90
- (void)_didReachTargetTime;	// IMP=0x0000000000002cfc
- (void)_stepDownRate;	// IMP=0x0000000000002a5f
- (void)start;	// IMP=0x000000000000279b
- (id)initWithTargetTime:(CDStruct_1b6d18a9)arg1 duration:(double)arg2 initialRate:(float)arg3 avPlayer:(id)arg4 progressHandler:(CDUnknownBlockType)arg5;	// IMP=0x00000000000026c6
