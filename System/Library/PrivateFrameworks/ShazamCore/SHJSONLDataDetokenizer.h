...
- (_Bool)closeWithError:(id *)arg1;	// IMP=0x0000000000005eb4
- (_Bool)processData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000005c28
- (_Bool)writeDataToDelegate:(id)arg1 withError:(id *)arg2;	// IMP=0x00000000000059f2
- (id)init;	// IMP=0x000000000000598c
