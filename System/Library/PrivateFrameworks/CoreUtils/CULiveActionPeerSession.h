...
- (void).cxx_destruct;	// IMP=0x0000000000064184
...
- (void)performRequest:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000063e64
- (void)setupWithRequest:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000063c0a
- (void)invalidate;	// IMP=0x0000000000063bd8
- (void)activateWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000000000639ed
