...
- (void).cxx_destruct;	// IMP=0x00000000000ba34c
...
- (unsigned int)_updateWithDeviceIE:(const char *)arg1 end:(const char *)arg2;	// IMP=0x00000000000b9796
- (id)description;	// IMP=0x00000000000b95ff
