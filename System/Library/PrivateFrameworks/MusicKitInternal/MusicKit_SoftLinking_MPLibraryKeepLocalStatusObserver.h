...
- (void).cxx_destruct;	// IMP=0x0000000000004c73
...
- (void)_handleUpdatedUnderlyingActiveKeepLocalStatus:(struct MPLibraryActiveKeepLocalStatus)arg1;	// IMP=0x0000000000004be5
- (struct MusicKit_SoftLinking_MPLibraryActiveKeepLocalStatus)_activeKeepLocalStatusFromUnderlyingStatus:(struct MPLibraryActiveKeepLocalStatus)arg1 underlyingDownloadPauseReasons:(unsigned long long)arg2;	// IMP=0x0000000000004bbe
- (void)calculateDownloadProgressWithChildren:(id)arg1;	// IMP=0x0000000000004941
@property(readonly, nonatomic) struct MusicKit_SoftLinking_MPLibraryActiveKeepLocalStatus currentStatus;
- (id)initWithIdentifyingModelObject:(id)arg1;	// IMP=0x0000000000004429
