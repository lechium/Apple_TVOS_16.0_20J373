...
- (void).cxx_destruct;	// IMP=0x0000000000003cfa
...
- (id)newOperationForDetailedKeepLocalStatusConfigurationForSectionAtIndex:(long long)arg1 responseHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000003971
- (id)initWithModelObject:(id)arg1 children:(id)arg2;	// IMP=0x00000000000038c6
