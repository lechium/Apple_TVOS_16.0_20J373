...
- (id)pipelineBinaries;	// IMP=0x000000000000e318
- (unsigned int)pipelineRef;	// IMP=0x000000000000e308
- (void)dealloc;	// IMP=0x000000000000e22e
@property(readonly) unsigned long long uniqueIdentifier; // @synthesize uniqueIdentifier=_uniqueIdentifier;
- (id)initWithDevice:(id)arg1 pipelineRef:(unsigned int)arg2 descriptor:(id)arg3;	// IMP=0x000000000000e035
