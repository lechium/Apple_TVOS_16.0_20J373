...
- (id)formattedDescription:(unsigned long long)arg1;	// IMP=0x0000000000008c58
- (id)newArgumentEncoderWithBufferIndex:(unsigned long long)arg1 reflection:(id *)arg2;	// IMP=0x0000000000008c50
- (id)newArgumentEncoderWithBufferIndex:(unsigned long long)arg1;	// IMP=0x0000000000008c48
@property(readonly) unsigned int functionRef;
- (void)dealloc;	// IMP=0x0000000000008b6a
- (id)initWithDevice:(id)arg1 functionType:(unsigned long long)arg2 functionRef:(unsigned int)arg3;	// IMP=0x0000000000008b04
