...
- (unsigned long long)constantOffsetAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000001546
- (unsigned long long)alignment;	// IMP=0x0000000000001535
- (unsigned long long)encodedLength;	// IMP=0x0000000000001524
- (_Bool)bufferLayoutMatchesFrontEndLayout;	// IMP=0x0000000000001514
- (void)dealloc;	// IMP=0x000000000000143f
- (id)initWithDevice:(id)arg1 reference:(unsigned int)arg2 data:(CDStruct_146dae35 *)arg3;	// IMP=0x00000000000013a0
