...
- (void).cxx_destruct;	// IMP=0x000000000005413b
...
- (_Bool)bindPropertiesToStatement:(struct sqlite3_stmt *)arg1 error:(id *)arg2;	// IMP=0x0000000000054054
- (id)initWithLocalZone:(id)arg1 modelClassName:(id)arg2;	// IMP=0x0000000000053ede
