...
+ (id)logCategory;	// IMP=0x001000000003e7cf
...
- (id)logIdentifier;	// IMP=0x000000000003e44f
@property(readonly, nonatomic, getter=isZoneRebuildInProgress) _Bool zoneRebuildInProgress;
- (void)handleZoneChanged;	// IMP=0x000000000003e441
- (void)handleIdentityLost;	// IMP=0x000000000003e11f
- (id)zoneStartUp;	// IMP=0x000000000003e106
- (void)rebuild;	// IMP=0x000000000003e03f
- (id)initWithCloudZone:(id)arg1;	// IMP=0x000000000003df41
