...
- (void).cxx_destruct;	// IMP=0x0000000000054e26
...
- (id)nextObject;	// IMP=0x0000000000054b40
- (_Bool)bindPropertiesToStatement:(struct sqlite3_stmt *)arg1 error:(id *)arg2;	// IMP=0x0000000000054a7a
- (id)initWithLocalZone:(id)arg1 modelID:(id)arg2;	// IMP=0x000000000005478a
