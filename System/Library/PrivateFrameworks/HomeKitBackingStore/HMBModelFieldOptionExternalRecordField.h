...
- (void).cxx_destruct;	// IMP=0x000000000009cf19
...
- (void)applyTo:(id)arg1;	// IMP=0x000000000009ce69
- (id)initWithExternalRecordField:(id)arg1 encrypted:(_Bool)arg2;	// IMP=0x000000000009cde9
