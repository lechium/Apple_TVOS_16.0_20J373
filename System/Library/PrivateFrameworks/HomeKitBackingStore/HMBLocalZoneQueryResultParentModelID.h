...
- (_Bool)bindPropertiesToStatement:(struct sqlite3_stmt *)arg1 error:(id *)arg2;	// IMP=0x00000000000542c4
- (id)initWithLocalZone:(id)arg1 parentModelID:(id)arg2;	// IMP=0x000000000005414e
