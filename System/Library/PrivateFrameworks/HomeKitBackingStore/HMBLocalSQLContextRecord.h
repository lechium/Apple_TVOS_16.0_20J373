...
- (void).cxx_destruct;	// IMP=0x0000000000080922
...
- (id)attributeDescriptions;	// IMP=0x00000000000807bc
- (id)initWithModel:(id)arg1 externalID:(id)arg2;	// IMP=0x000000000008071a
