...
- (id)description;	// IMP=0x00000000000326b1
- (id)debugDescription;	// IMP=0x0000000000032605
- (id)initWithZoneRow:(unsigned long long)arg1 name:(id)arg2 token:(id)arg3;	// IMP=0x0000000000032545
- (id)initWithZoneRow:(unsigned long long)arg1;	// IMP=0x0000000000032501
- (id)init;	// IMP=0x00000000000324d2
