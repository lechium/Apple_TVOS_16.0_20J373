...
- (void).cxx_destruct;	// IMP=0x0000000000024ad2
...
- (id)featureValueForName:(id)arg1;	// IMP=0x0000000000024a03
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithConfidence:(id)arg1 coordinates:(id)arg2;	// IMP=0x0000000000024971
