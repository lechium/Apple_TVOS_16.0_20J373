...
- (void).cxx_destruct;	// IMP=0x00000000000336d0
...
- (id)featureValueForName:(id)arg1;	// IMP=0x000000000003365c
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithLeaf_leaf_predictions_probabilities:(id)arg1;	// IMP=0x00000000000335d1
