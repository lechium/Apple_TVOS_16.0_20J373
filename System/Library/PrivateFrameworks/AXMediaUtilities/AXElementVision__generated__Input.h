...
- (id)featureValueForName:(id)arg1;	// IMP=0x0000000000024858
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithImage:(struct __CVBuffer *)arg1 iouThreshold:(double)arg2 confidenceThreshold:(double)arg3;	// IMP=0x000000000002481c
