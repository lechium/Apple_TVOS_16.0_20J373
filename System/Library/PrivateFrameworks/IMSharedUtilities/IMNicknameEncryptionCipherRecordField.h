...
+ (id)cipherRecordFieldWithFieldName:(id)arg1 dataRepresentation:(id)arg2 error:(id *)arg3;	// IMP=0x006000000000fa19
- (void).cxx_destruct;	// IMP=0x000000000000ffd4
...
- (id)description;	// IMP=0x000000000000fe64
- (id)dataRepresentationWithError:(id *)arg1;	// IMP=0x000000000000fd2e
- (id)initWithFieldName:(id)arg1 cipherData:(id)arg2 IV:(id)arg3 tag:(id)arg4;	// IMP=0x000000000000fc4c
