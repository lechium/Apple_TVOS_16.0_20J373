...
- (void).cxx_destruct;	// IMP=0x0000000000029448
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000290b9
- (unsigned long long)hash;	// IMP=0x0000000000028f10
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000028c15
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000289e8
- (void)copyTo:(id)arg1;	// IMP=0x0000000000028831
- (void)writeTo:(id)arg1;	// IMP=0x0000000000028675
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000028668
- (id)dictionaryRepresentation;	// IMP=0x0000000000027afb
- (id)description;	// IMP=0x0000000000027a4c
...
- (int)StringAsMetricType:(id)arg1;	// IMP=0x00000000000277ae
- (id)metricTypeAsString:(int)arg1;	// IMP=0x0000000000027742
