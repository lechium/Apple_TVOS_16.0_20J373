...
+ (Class)clientOperationType;	// IMP=0x00100000000119c7
+ (Class)operationGroupType;	// IMP=0x001000000001185d
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000013a79
- (unsigned long long)hash;	// IMP=0x0000000000013876
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000134ea
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000012fea
- (void)copyTo:(id)arg1;	// IMP=0x0000000000012cc9
- (void)writeTo:(id)arg1;	// IMP=0x00000000000128f5
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000128e8
- (id)dictionaryRepresentation;	// IMP=0x0000000000011b17
- (id)description;	// IMP=0x0000000000011a68
@property(nonatomic) _Bool hasReportClientOperationFrequencyBase;
@property(nonatomic) _Bool hasReportClientOperationFrequency;
- (id)clientOperationAtIndex:(unsigned long long)arg1;	// IMP=0x00000000000119aa
- (unsigned long long)clientOperationsCount;	// IMP=0x000000000001198d
- (void)addClientOperation:(id)arg1;	// IMP=0x0000000000011923
- (void)clearClientOperations;	// IMP=0x0000000000011906
@property(nonatomic) _Bool hasReportOperationGroupFrequencyBase;
@property(nonatomic) _Bool hasReportOperationGroupFrequency;
- (id)operationGroupAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000011840
- (unsigned long long)operationGroupsCount;	// IMP=0x0000000000011823
- (void)addOperationGroup:(id)arg1;	// IMP=0x00000000000117b9
- (void)clearOperationGroups;	// IMP=0x000000000001179c
