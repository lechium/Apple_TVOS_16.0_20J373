...
+ (Class)internalTestConfigType;	// IMP=0x001000000002ca7e
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000002ddec
- (unsigned long long)hash;	// IMP=0x000000000002dcab
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002da35
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002d719
- (void)copyTo:(id)arg1;	// IMP=0x000000000002d52f
- (void)writeTo:(id)arg1;	// IMP=0x000000000002d2f1
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000002d2e4
- (id)dictionaryRepresentation;	// IMP=0x000000000002cb3e
- (id)description;	// IMP=0x000000000002ca8f
- (id)internalTestConfigAtIndex:(unsigned long long)arg1;	// IMP=0x000000000002ca61
- (unsigned long long)internalTestConfigsCount;	// IMP=0x000000000002ca44
- (void)addInternalTestConfig:(id)arg1;	// IMP=0x000000000002c9da
- (void)clearInternalTestConfigs;	// IMP=0x000000000002c9bd
