...
+ (Class)networkPathInfoType;	// IMP=0x0010000000007782
- (void).cxx_destruct;	// IMP=0x000000000000d7eb
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000000cba1
- (unsigned long long)hash;	// IMP=0x000000000000c44d
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000ba41
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000b21a
- (void)copyTo:(id)arg1;	// IMP=0x000000000000abd3
- (void)writeTo:(id)arg1;	// IMP=0x000000000000a4e1
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000000a4d4
- (id)dictionaryRepresentation;	// IMP=0x0000000000007f19
- (id)description;	// IMP=0x0000000000007e6a
...
- (id)networkPathInfoAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000007765
- (unsigned long long)networkPathInfosCount;	// IMP=0x0000000000007748
- (void)addNetworkPathInfo:(id)arg1;	// IMP=0x00000000000076de
- (void)clearNetworkPathInfos;	// IMP=0x00000000000076c1
