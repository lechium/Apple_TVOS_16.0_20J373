...
- (void).cxx_destruct;	// IMP=0x000000000001eb72
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000001ea3b
- (unsigned long long)hash;	// IMP=0x000000000001e9b7
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000001e88b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001e7a1
- (void)copyTo:(id)arg1;	// IMP=0x000000000001e6fe
- (void)writeTo:(id)arg1;	// IMP=0x000000000001e667
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000001e65a
- (id)dictionaryRepresentation;	// IMP=0x000000000001e402
- (id)description;	// IMP=0x000000000001e353
