...
- (void).cxx_destruct;	// IMP=0x0000000000031783
...
- (void)layoutSubviews;	// IMP=0x0000000000031274
- (_Bool)pointInside:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x00000000000311ac
- (void)_setContinuousCornerRadius:(double)arg1;	// IMP=0x000000000003118f
- (double)_continuousCornerRadius;	// IMP=0x0000000000031172
- (struct CGRect)_mainBodyBounds;	// IMP=0x00000000000310ff
@property(readonly, nonatomic) struct CGRect tabViewBounds;
- (void)setTabHidden:(_Bool)arg1 left:(_Bool)arg2;	// IMP=0x0000000000030b80
- (id)initWithFrame:(struct CGRect)arg1 minimumStashTabSize:(struct CGSize)arg2;	// IMP=0x0000000000030447
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000030425
