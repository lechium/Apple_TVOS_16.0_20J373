...
- (void).cxx_destruct;	// IMP=0x000000000004236c
...
- (void)resetChevronState;	// IMP=0x000000000004231d
- (void)setChevronHidden:(_Bool)arg1 left:(_Bool)arg2;	// IMP=0x00000000000422e7
- (void)_setContinuousCornerRadius:(double)arg1;	// IMP=0x000000000004208c
- (void)layoutStashChevrons;	// IMP=0x0000000000041cd4
- (void)layoutSubviews;	// IMP=0x0000000000041ae6
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000414ac
