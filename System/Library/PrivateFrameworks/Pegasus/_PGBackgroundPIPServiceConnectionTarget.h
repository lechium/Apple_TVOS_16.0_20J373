...
- (void).cxx_destruct;	// IMP=0x0000000000013b3a
...
- (void)invalidate;	// IMP=0x00000000000139ff
- (oneway void)revokeAuthorization;	// IMP=0x00000000000139e8
- (oneway void)grantAuthorizationForActivitySessionWithIdentifier:(id)arg1 bundleIdentifier:(id)arg2;	// IMP=0x0000000000013942
@property(readonly, nonatomic, getter=isConnectionActive) _Bool connectionActive;
- (void)transitionToStateIfPossible:(long long)arg1;	// IMP=0x000000000001367f
@property(readonly, nonatomic) long long state;
@property(readonly, copy) NSString *bundleIdentifier;
@property(readonly, copy) NSString *activitySessionIdentifier;
- (id)initWithConnection:(id)arg1 delegate:(id)arg2;	// IMP=0x0000000000013547
