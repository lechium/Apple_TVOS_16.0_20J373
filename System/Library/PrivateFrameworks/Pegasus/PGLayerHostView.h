...
- (void).cxx_destruct;	// IMP=0x000000000000ce77
@property(nonatomic) double cornerRadiusScale; // @synthesize cornerRadiusScale=_cornerRadiusScale;
- (void)_manageSharingOfTouchesBetweenClientAndHostContext;	// IMP=0x000000000000cbf2
- (void)didMoveToWindow;	// IMP=0x000000000000cbe0
@property(retain, nonatomic) PGHostedWindowHostingHandle *hostedWindowHostingHandle;
- (void)dealloc;	// IMP=0x000000000000caa9
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000000ca17
