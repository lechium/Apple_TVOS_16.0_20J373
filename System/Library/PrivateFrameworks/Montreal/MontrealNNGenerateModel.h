...
- (void).cxx_destruct;	// IMP=0x00000000001e8a60
...
- (id)networkOutputs;	// IMP=0x00000000001e8750
- (id)networkInputs;	// IMP=0x00000000001e84b0
- (void)removeOutput:(id)arg1;	// IMP=0x00000000001e8360
- (void)addOutputs:(id)arg1;	// IMP=0x00000000001e8060
- (void)removeInput:(id)arg1;	// IMP=0x00000000001e7f10
- (void)addInputs:(id)arg1;	// IMP=0x00000000001e7c10
- (id)modelContainerPath;	// IMP=0x00000000001e7910
- (void *)generateModelContainer;	// IMP=0x00000000001e7750
- (void)merge:(id)arg1;	// IMP=0x00000000001e74f0
@property struct MontrealNeuralNetwork *nnObject; // @synthesize nnObject=_nnObject;
- (void)dealloc;	// IMP=0x00000000001e7430
- (id)initWithWeightFormat:(unsigned long long)arg1;	// IMP=0x00000000001e7340
