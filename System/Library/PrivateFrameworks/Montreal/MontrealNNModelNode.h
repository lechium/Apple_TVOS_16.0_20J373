...
- (void).cxx_destruct;	// IMP=0x00000000001393c0
...
- (id)createDataContainer;	// IMP=0x0000000000138fa0
- (void)generateJSONAtPath:(id)arg1;	// IMP=0x0000000000138e30
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000138d10
- (id)jsonDescription;	// IMP=0x0000000000138ac0
- (void)description:(id)arg1 indent:(id)arg2;	// IMP=0x0000000000138720
- (CDStruct_96916c69)parameters:(void *)arg1;	// IMP=0x0000000000138680
- (void)keepTensors:(id)arg1;	// IMP=0x0000000000138390
- (id)auditAndUpdateTensors:(id)arg1 dimensionTensors:(id)arg2;	// IMP=0x0000000000137f90
- (id)initWithDictionary:(id)arg1 tensors:(id)arg2 quantization:(id)arg3 jsonDir:(id)arg4;	// IMP=0x00000000001375a0
- (id)initWithName:(id)arg1 nodeStr:(id)arg2 activations:(id)arg3 properties:(id)arg4 weights:(id)arg5;	// IMP=0x00000000001373d0
- (id)checkForValidity;	// IMP=0x0000000000137190
