...
@interface NSURL (IC)
+ (id)ic_urlFromWeblocFileAtURL:(id)arg1;	// IMP=0x00200000000186f8
...
- (_Bool)ic_isSafeFileURLForAttachment;	// IMP=0x0010000000018302
...
- (void)ic_updateFlagToExcludeFromBackup:(_Bool)arg1;	// IMP=0x0010000000017aec
- (id)ic_dedupedURLWithProhibitedNames:(id)arg1;	// IMP=0x0010000000017845
- (void)ic_updateFlagToExcludeFromBackupNow:(_Bool)arg1;	// IMP=0x0010000000018700
@end
