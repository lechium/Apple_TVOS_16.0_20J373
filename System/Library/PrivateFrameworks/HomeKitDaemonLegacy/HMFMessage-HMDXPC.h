...
+ (id)nonSPIEntitledMessageWithName:(id)arg1 messagePayload:(id)arg2;	// IMP=0x00200000002c9c5e
+ (id)entitledMessageWithName:(id)arg1 identifier:(id)arg2 messagePayload:(id)arg3;	// IMP=0x00200000002c9be6
+ (id)entitledMessageWithName:(id)arg1 messagePayload:(id)arg2;	// IMP=0x00200000002c9abc
+ (id)internalMessageWithName:(id)arg1 destination:(id)arg2 messagePayload:(id)arg3;	// IMP=0x002000000051e37f
+ (id)internalMessageWithName:(id)arg1 messagePayload:(id)arg2 responseHandler:(CDUnknownBlockType)arg3;	// IMP=0x002000000051e330
+ (id)internalMessageWithName:(id)arg1 messagePayload:(id)arg2;	// IMP=0x002000000051e2e1
+ (id)homeLocationAuthorizedAndEntitledMessageWithName:(id)arg1 target:(id)arg2 messagePayload:(id)arg3;	// IMP=0x0020000000720c2f
+ (id)locationAuthorizedMessageWithName:(id)arg1 messagePayload:(id)arg2;	// IMP=0x0020000000720bc5
- (unsigned long long)homeManagerOptions;	// IMP=0x00100000002c9a6b
...
- (_Bool)_supportsFeature:(unsigned long long)arg1 forCapabilitiesKey:(id)arg2;	// IMP=0x00100000003dc9ae
- (_Bool)supportsRequestedFeature:(unsigned long long)arg1;	// IMP=0x00100000003dc995
- (_Bool)supportsRequiredFeature:(unsigned long long)arg1;	// IMP=0x00100000003dc97c
...
- (id)userForHome:(id)arg1;	// IMP=0x001000000091ae82
- (id)matchingRemoteIdentityUserForHome:(id)arg1;	// IMP=0x001000000091aaa7
- (_Bool)isSingleReadWriteRequest;	// IMP=0x0010000000abc80a
