...
- (id)hm_decodeSetOfConditionalObjects:(Class)arg1 forKey:(id)arg2;	// IMP=0x00300000005fefba
- (void)hm_encodeSetOfConditionalObjects:(id)arg1 forKey:(id)arg2;	// IMP=0x00300000005fed2e
- (id)hm_decodeArrayOfConditionalObjects:(Class)arg1 forKey:(id)arg2;	// IMP=0x00300000005febd7
- (void)hm_encodeArrayOfConditionalObjects:(id)arg1 forKey:(id)arg2;	// IMP=0x00300000005fe94b
