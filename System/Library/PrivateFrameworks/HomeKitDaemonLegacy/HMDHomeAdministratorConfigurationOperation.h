...
+ (id)logCategory;	// IMP=0x00100000006d126b
+ (double)timeout;	// IMP=0x00100000006d118d
- (void).cxx_destruct;	// IMP=0x00000000006d0d31
...
- (id)logIdentifier;	// IMP=0x00000000006d0c02
- (void)main;	// IMP=0x00000000006d07a4
- (id)initWithMessage:(id)arg1 home:(id)arg2 dispatcher:(id)arg3;	// IMP=0x00000000006d0659
