...
+ (id)assetWriterInputSelectionOptionWithAssetWriterInput:(id)arg1 displaysNonForcedSubtitles:(_Bool)arg2;	// IMP=0x006000000009dd5d
+ (id)assetWriterInputSelectionOptionWithAssetWriterInput:(id)arg1;	// IMP=0x006000000009dd27
...
- (id)propertyList;	// IMP=0x000000000009ec50
- (id)associatedMediaSelectionOptionInMediaSelectionGroup:(id)arg1;	// IMP=0x000000000009e99d
- (id)metadataForFormat:(id)arg1;	// IMP=0x000000000009e796
- (id)availableMetadataFormats;	// IMP=0x000000000009e59d
- (id)commonMetadata;	// IMP=0x000000000009e534
- (id)locale;	// IMP=0x000000000009e4f4
- (_Bool)_isDesignatedDefault;	// IMP=0x000000000009e4e4
- (_Bool)isPlayable;	// IMP=0x000000000009e47f
- (_Bool)_isAuxiliaryContent;	// IMP=0x000000000009e42e
- (id)_taggedCharacteristics;	// IMP=0x000000000009e376
- (id)mediaSubTypes;	// IMP=0x000000000009e203
- (id)_ancillaryDescription;	// IMP=0x000000000009e1f6
- (unsigned long long)hash;	// IMP=0x000000000009e14a
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000009e055
- (_Bool)_hasEqualValueForKey:(id)arg1 asObject:(id)arg2;	// IMP=0x000000000009dfe8
- (void)dealloc;	// IMP=0x000000000009df35
- (id)initWithAssetWriterInput:(id)arg1 displaysNonForcedSubtitles:(_Bool)arg2;	// IMP=0x000000000009ddac
- (id)initWithAssetWriterInput:(id)arg1;	// IMP=0x000000000009dd98
