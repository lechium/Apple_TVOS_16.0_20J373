...
- (void)flushSegment;	// IMP=0x000000000009ce79
- (void)flush;	// IMP=0x000000000009cdf7
- (void)transitionToFailedStatusWithError:(id)arg1;	// IMP=0x000000000009cc10
- (_Bool)_transitionToClientInitiatedTerminalStatus:(long long)arg1;	// IMP=0x000000000009ca0b
- (void)finishWritingWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000009c989
- (void)finishWriting;	// IMP=0x000000000009c907
- (void)cancelWriting;	// IMP=0x000000000009c901
- (void)endSessionAtSourceTime:(CDStruct_1b6d18a9)arg1;	// IMP=0x000000000009c87f
- (void)startSessionAtSourceTime:(CDStruct_1b6d18a9)arg1;	// IMP=0x000000000009c7fd
- (void)startWriting;	// IMP=0x000000000009c77b
- (void)addInputGroup:(id)arg1;	// IMP=0x000000000009c6f9
- (_Bool)canAddInputGroup:(id)arg1;	// IMP=0x000000000009c6f1
- (void)addInput:(id)arg1;	// IMP=0x000000000009c66f
- (_Bool)canAddInput:(id)arg1;	// IMP=0x000000000009c667
- (_Bool)_canApplyTrackReferences:(id)arg1 exceptionReason:(id *)arg2;	// IMP=0x000000000009c52a
- (_Bool)canApplyOutputSettings:(id)arg1 forMediaType:(id)arg2;	// IMP=0x000000000009c4b3
- (_Bool)_canApplyOutputSettings:(id)arg1 forMediaType:(id)arg2 sourceFormat:(struct opaqueCMFormatDescription *)arg3 exceptionReason:(id *)arg4;	// IMP=0x000000000009be8b
...
- (void)dealloc;	// IMP=0x000000000009b101
- (id)initWithConfigurationState:(id)arg1;	// IMP=0x000000000009b014
- (id)init;	// IMP=0x000000000009b000
