...
- (void)_requestMediaDataIfReady;	// IMP=0x00000000000c4966
- (void)invalidate;	// IMP=0x00000000000c48be
- (_Bool)_isInvalidatePending;	// IMP=0x00000000000c4896
- (void)_setInvalidatePending;	// IMP=0x00000000000c4871
- (void)startRequestingMediaData;	// IMP=0x00000000000c4810
- (void)dealloc;	// IMP=0x00000000000c47bb
- (id)init;	// IMP=0x00000000000c47a2
- (id)initWithMediaDataConsumer:(id)arg1 requestQueue:(id)arg2 requestBlock:(CDUnknownBlockType)arg3;	// IMP=0x00000000000c4601
