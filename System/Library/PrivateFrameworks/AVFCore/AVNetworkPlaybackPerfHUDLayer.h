...
- (void).cxx_destruct;	// IMP=0x0000000000057d5a
...
- (void)_hudUpdateTrigger;	// IMP=0x0000000000057a82
- (void)copyPropertiesFromStringGenerator:(id)arg1;	// IMP=0x00000000000579af
- (id)displayStringGenerator;	// IMP=0x00000000000578fb
- (void)updateHudWithDisplayString:(id)arg1;	// IMP=0x00000000000574e5
- (_Bool)valueLoadedForKey:(id)arg1 onObject:(id)arg2;	// IMP=0x00000000000573ad
- (void)currentItemTracksChanged;	// IMP=0x0000000000057231
- (void)currentItemChanged;	// IMP=0x00000000000571b1
- (float)getScaleFactorForDisplaySize:(struct CGSize)arg1;	// IMP=0x00000000000570f4
- (void)dealloc;	// IMP=0x0000000000057062
- (void)startDispatchTimer;	// IMP=0x0000000000056f37
- (void)readHudSettingsAndCallCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000056e56
- (void)getHudSetting;	// IMP=0x0000000000056c40
- (void)setColor:(int)arg1;	// IMP=0x0000000000056b18
- (void)updateBounds:(struct CGRect)arg1;	// IMP=0x0000000000056a44
- (id)init;	// IMP=0x0000000000056951
- (_Bool)hudEnabled;	// IMP=0x0000000000056941
