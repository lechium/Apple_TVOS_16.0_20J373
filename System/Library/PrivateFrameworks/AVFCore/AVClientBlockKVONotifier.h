...
- (void)cancelCallbacks;	// IMP=0x0000000000138ac5
- (void)callbackDidFireWithChangeDictionary:(id)arg1;	// IMP=0x0000000000138ab3
- (void)start;	// IMP=0x0000000000138a6a
@property(readonly, nonatomic) NSObject *observedObject;
- (void)dealloc;	// IMP=0x00000000001389b8
- (id)initWithCallbackContextRegistry:(id)arg1 observer:(id)arg2 object:(id)arg3 keyPath:(id)arg4 options:(unsigned long long)arg5 block:(CDUnknownBlockType)arg6;	// IMP=0x00000000001387d6
