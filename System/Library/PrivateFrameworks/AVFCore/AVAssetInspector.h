...
- (id)makePropertyListForProxyWithOptions:(id)arg1;	// IMP=0x00000000000e1bbb
...
- (_Bool)isCompatibleWithPhotosTranscodingServiceWithOptions:(id)arg1;	// IMP=0x00000000000e1b1c
@property(readonly, nonatomic, getter=isPlayable) _Bool playable;
- (_Bool)hasProtectedContent;	// IMP=0x00000000000e1b0c
...
- (id)metadataForFormat:(id)arg1;	// IMP=0x00000000000e1adb
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000e195b
