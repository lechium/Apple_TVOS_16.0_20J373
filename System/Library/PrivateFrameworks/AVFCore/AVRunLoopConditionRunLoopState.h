...
+ (id)runLoopStateWithRunLoop:(struct __CFRunLoop *)arg1;	// IMP=0x00600000000e10ed
...
- (void)dealloc;	// IMP=0x00000000000e1189
- (id)initWithRunLoop:(struct __CFRunLoop *)arg1;	// IMP=0x00000000000e1124
