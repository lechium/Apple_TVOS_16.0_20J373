...
- (float)_getAvailableOutputSampleRateFor:(float)arg1 rounding:(long long)arg2;	// IMP=0x0000000000115c3a
- (unsigned int)availableOutputChannelCountForDesiredChannelCount:(unsigned int)arg1 rounding:(long long)arg2;	// IMP=0x0000000000115ae1
- (float)applicableOutputSampleRateForDesiredSampleRate:(float)arg1 rounding:(long long)arg2;	// IMP=0x000000000011579e
...
- (void)setInputPropertiesFromASBD:(struct AudioStreamBasicDescription)arg1;	// IMP=0x00000000001156d3
- (void)_bringUpToDate;	// IMP=0x000000000011561b
- (id)_fetchApplicableOutputDataRates;	// IMP=0x000000000011557c
- (void)_buildApplicableDataRatesForSampleRates;	// IMP=0x0000000000114fbd
- (void)_buildAvailableSampleRates;	// IMP=0x0000000000114e7e
- (void)_buildAudioConverter;	// IMP=0x0000000000114db6
- (void)dealloc;	// IMP=0x0000000000114d4d
- (id)init;	// IMP=0x0000000000114cf2
