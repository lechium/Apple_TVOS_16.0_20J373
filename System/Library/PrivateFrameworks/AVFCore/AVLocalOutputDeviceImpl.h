...
- (void).cxx_destruct;	// IMP=0x00000000000cb342
@property __weak id <AVOutputDeviceImplSupport> implEventListener; // @synthesize implEventListener=_implSupportEventListener;
- (_Bool)supportsFitnessDataDestination;	// IMP=0x00000000000cb31b
- (void)configureUsingBlock:(CDUnknownBlockType)arg1 options:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000000cb2de
- (_Bool)setCurrentBluetoothListeningMode:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000cb2b8
...
- (_Bool)setHeadTrackedSpatialAudioMode:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000cb275
@property(readonly, nonatomic) NSString *headTrackedSpatialAudioMode;
- (_Bool)setAllowsHeadTrackedSpatialAudio:(_Bool)arg1 error:(id *)arg2;	// IMP=0x00000000000cb242
...
- (void)decreaseVolumeByCount:(long long)arg1;	// IMP=0x00000000000cb1ac
- (void)increaseVolumeByCount:(long long)arg1;	// IMP=0x00000000000cb1a6
- (void)setVolume:(float)arg1;	// IMP=0x00000000000cb1a0
@property(readonly) long long volumeControlType;
@property(readonly) _Bool canSetVolume;
@property(readonly) float volume;
- (void)setSecondDisplayMode:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000cb152
- (void)setSecondDisplayEnabled:(_Bool)arg1;	// IMP=0x00000000000cb14c
...
- (id)deviceClusterMembers;	// IMP=0x00000000000cb07c
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000cafe3
