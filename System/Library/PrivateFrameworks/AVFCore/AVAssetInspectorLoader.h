...
+ (void)initialize;	// IMP=0x00100000000e7f94
- (id)_createAVErrorForError:(id)arg1 andFigErrorCode:(int)arg2;	// IMP=0x00000000000e823d
- (void)loadValuesAsynchronouslyForKeys:(id)arg1 keysForCollectionKeys:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000000e8228
- (void)_ensureAllDependenciesOfKeyAreLoaded:(id)arg1;	// IMP=0x00000000000e8222
- (void)_setIsAssociatedWithFragmentMinder:(_Bool)arg1;	// IMP=0x00000000000e821c
...
- (void)cancelLoading;	// IMP=0x00000000000e810b
- (id)assetInspector;	// IMP=0x00000000000e8103
- (void)loadValuesAsynchronouslyForKeys:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000e80d8
- (long long)statusOfValueForKey:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000e80aa
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000e809f
- (void)dealloc;	// IMP=0x00000000000e8064
@property(readonly, nonatomic, getter=_weakReference) AVWeakReference *weakReference;
- (id)init;	// IMP=0x00000000000e7ffb
