...
+ (id)assetTrackInspectorWithAsset:(id)arg1 trackID:(int)arg2 trackIndex:(long long)arg3;	// IMP=0x00100000000ee901
- (struct OpaqueFigSampleCursorService *)_getFigSampleCursorServiceReportingTimeAccuracy:(_Bool *)arg1;	// IMP=0x00000000000ef31a
- (id)makeSampleCursorAtLastSampleInDecodeOrder;	// IMP=0x00000000000ef291
- (id)makeSampleCursorAtFirstSampleInDecodeOrder;	// IMP=0x00000000000ef208
- (id)makeSampleCursorWithPresentationTimeStamp:(CDStruct_1b6d18a9)arg1;	// IMP=0x00000000000ef0f5
...
- (id)metadataForFormat:(id)arg1;	// IMP=0x00000000000ef007
...
- (CDStruct_1b6d18a9)samplePresentationTimeForTrackTime:(CDStruct_1b6d18a9)arg1;	// IMP=0x00000000000eedf5
- (id)segmentForTrackTime:(CDStruct_1b6d18a9)arg1;	// IMP=0x00000000000eeded
...
- (void)loadValuesAsynchronouslyForKeys:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000eeaba
- (long long)statusOfValueForKey:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000eeaa3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000eea98
- (void)dealloc;	// IMP=0x00000000000eea32
- (id)_weakReference;	// IMP=0x00000000000eea21
- (id)init;	// IMP=0x00000000000eea04
- (id)_initWithAsset:(id)arg1 trackIndex:(long long)arg2;	// IMP=0x00000000000ee9ed
- (id)_initWithAsset:(id)arg1 trackID:(int)arg2;	// IMP=0x00000000000ee9d4
- (id)_initWithAsset:(id)arg1 trackID:(int)arg2 trackIndex:(long long)arg3;	// IMP=0x00000000000ee957
