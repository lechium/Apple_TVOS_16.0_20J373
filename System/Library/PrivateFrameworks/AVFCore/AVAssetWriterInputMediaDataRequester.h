...
- (void)requestMediaDataIfNecessary;	// IMP=0x00000000000b0056
@property __weak id <AVAssetWriterInputMediaDataRequesterDelegate> delegate;
- (void)dealloc;	// IMP=0x00000000000afe41
- (void)_collectUncollectables_invokedFromDeallocAndFinalize;	// IMP=0x00000000000afe13
- (id)init;	// IMP=0x00000000000afdfd
- (id)initWithRequestQueue:(id)arg1 requestBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000000000afcd6
