...
@interface AVPlayerItemInternal : NSObject
{
    ...
    unsigned int initialSetTimeFlags;	// 1116 = 0x45c
    CDStruct_1b6d18a9 initialMinSnapTime;	// 1120 = 0x460
    CDStruct_1b6d18a9 initialMaxSnapTime;	// 1144 = 0x478
    unsigned int nextSeekIDToGenerate;	// 1168 = 0x490
    int pendingSeekID;	// 1172 = 0x494
    ...
    int eqPreset;	// 1256 = 0x4e8
    NSDictionary *rampInOutInfo;	// 1264 = 0x4f0
    NSDictionary *audibleDRMInfo;	// 1272 = 0x4f8
    long long initialVariantIndex;	// 1280 = 0x500
    NSString *currentStableVariantID;	// 1288 = 0x508
    NSMutableDictionary *mediaOptionsSelectedByClient;	// 1296 = 0x510
    NSArray *timedMetadata;	// 1304 = 0x518
    NSMutableArray *handlersToCallWhenReadyForEnqueueing;	// 1312 = 0x520
    _Bool haveInitialSamples;	// 1320 = 0x528
    _Bool haveCPEProtector;	// 1321 = 0x529
    _Bool didInformObserversAboutAvailabilityOfTracks;	// 1322 = 0x52a
    _Bool didFireKVOForAssetForNonStreamingItem;	// 1323 = 0x52b
    AVAudioMix *mostRecentlyAppliedAudioMix;	// 1328 = 0x530
    _Bool audioSpatializationAllowed;	// 1336 = 0x538
    _Bool audioSpatializationAllowedWasSet;	// 1337 = 0x539
    unsigned long long allowedAudioSpatializationFormats;	// 1344 = 0x540
    _Bool allowedAudioSpatializationFormatsWasSet;	// 1352 = 0x548
    AVWeakReference *playerReference;	// 1360 = 0x550
    _Bool didSetAssetToAssetWithFigPlaybackItem;	// 1368 = 0x558
    struct OpaqueFigCPEProtector *figCPEProtector;	// 1376 = 0x560
}
