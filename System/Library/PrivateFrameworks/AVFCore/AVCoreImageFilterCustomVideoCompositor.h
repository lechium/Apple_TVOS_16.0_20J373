...
+ (void)initialize;	// IMP=0x001000000012cca4
...
- (void)cancelAllPendingVideoCompositionRequests;	// IMP=0x000000000012d2a8
- (void)startVideoCompositionRequest:(id)arg1;	// IMP=0x000000000012d06c
- (id)defaultCIContext;	// IMP=0x000000000012cf39
...
- (void)renderContextChanged:(id)arg1;	// IMP=0x000000000012ceba
@property(readonly, nonatomic) NSDictionary *requiredPixelBufferAttributesForRenderContext;
@property(readonly, nonatomic) NSDictionary *sourcePixelBufferAttributes;
- (void)dealloc;	// IMP=0x000000000012cd3a
- (void)_willDeallocOrFinalize;	// IMP=0x000000000012cd0c
- (id)init;	// IMP=0x000000000012ccb5
