...
- (long long)status;	// IMP=0x000000000009a903
- (void)cancelWriting;	// IMP=0x000000000009a7ec
- (void)_finishWritingOperationsDidFinish;	// IMP=0x000000000009a719
- (void)dealloc;	// IMP=0x000000000009a67e
- (id)initWithConfigurationState:(id)arg1 finishWritingOperations:(id)arg2 figAssetWriterCallbackContextToken:(void *)arg3;	// IMP=0x000000000009a40c
