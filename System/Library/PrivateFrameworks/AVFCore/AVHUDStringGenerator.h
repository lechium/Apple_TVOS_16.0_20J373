...
+ (id)descriptionStringForTracksOfPlayerItem:(id)arg1;	// IMP=0x0060000000054c09
+ (id)descriptionStringForVideoRangeOfFormatDescription:(struct opaqueCMFormatDescription *)arg1;	// IMP=0x0060000000054bde
+ (id)descriptionStringForBitRate:(double)arg1;	// IMP=0x0060000000054b73
+ (id)descriptionStringForFormatOfTrack:(id)arg1;	// IMP=0x0060000000054868
- (void).cxx_destruct;	// IMP=0x0000000000056933
...
- (void)update;	// IMP=0x00000000000560f8
- (void)updateFromPlayerItem;	// IMP=0x0000000000055430
- (void)updateFromPlayer;	// IMP=0x0000000000054f17
- (void)dealloc;	// IMP=0x0000000000054734
