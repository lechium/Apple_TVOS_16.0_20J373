...
+ (void)registerLocalDeviceDidChangeListener:(Class)arg1;	// IMP=0x0010000000006ba5
+ (void)localDeviceWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000006a3c
...
- (void)configureUsingBlock:(CDUnknownBlockType)arg1 options:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000008085
- (_Bool)supportsFitnessDataDestination;	// IMP=0x000000000000806f
...
- (void)_proposedGroupIDDidChangeForEndpointWithID:(struct __CFString *)arg1;	// IMP=0x0000000000007e4e
@property(readonly, copy, nonatomic) NSString *proposedGroupID;
@property(readonly, copy, nonatomic) NSString *groupID;
@property(readonly, nonatomic) _Bool canBeGrouped;
- (void)decreaseVolumeByCount:(long long)arg1;	// IMP=0x0000000000007d94
- (void)increaseVolumeByCount:(long long)arg1;	// IMP=0x0000000000007d8e
- (void)setVolume:(float)arg1;	// IMP=0x0000000000007d14
- (void)_volumeControlTypeDidChangeForEndpointWithID:(struct __CFString *)arg1;	// IMP=0x0000000000007caa
@property(readonly) long long volumeControlType;
- (void)_volumeControlSupportedDidChangeForEndpointWithID:(struct __CFString *)arg1;	// IMP=0x0000000000007b85
@property(readonly) _Bool canSetVolume;
- (void)_volumeDidChangeForEndpointWithID:(struct __CFString *)arg1;	// IMP=0x0000000000007ab7
@property(readonly) float volume;
@property(readonly, nonatomic, getter=isHeadTrackedSpatialAudioActive) _Bool headTrackedSpatialAudioActive;
- (_Bool)setHeadTrackedSpatialAudioMode:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000007a27
@property(readonly, nonatomic) NSString *headTrackedSpatialAudioMode;
- (_Bool)setAllowsHeadTrackedSpatialAudio:(_Bool)arg1 error:(id *)arg2;	// IMP=0x00000000000079fb
...
- (void)setSecondDisplayMode:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000079a3
- (void)setSecondDisplayEnabled:(_Bool)arg1;	// IMP=0x000000000000798d
- (_Bool)setCurrentBluetoothListeningMode:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000007977
...
- (void)dealloc;	// IMP=0x00000000000072dd
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000724d
- (id)initWithSyncController:(struct OpaqueAPSyncController *)arg1 secondaryImpl:(id)arg2;	// IMP=0x0000000000006cc9
