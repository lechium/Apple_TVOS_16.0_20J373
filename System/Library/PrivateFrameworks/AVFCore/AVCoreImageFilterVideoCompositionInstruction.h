...
- (void)dealloc;	// IMP=0x000000000012cbe8
- (id)initWithTimeRange:(CDStruct_e83c9415)arg1 sourceTrackIDs:(id)arg2 handler:(CDUnknownBlockType)arg3;	// IMP=0x000000000012cb35
- (id)init;	// IMP=0x000000000012cacf
