...
- (void)dealloc;	// IMP=0x000000000013200f
- (id)init;	// IMP=0x0000000000131ff6
- (id)initWithExternalDevice:(id)arg1 client:(id)arg2 reason:(id)arg3;	// IMP=0x0000000000131f16
