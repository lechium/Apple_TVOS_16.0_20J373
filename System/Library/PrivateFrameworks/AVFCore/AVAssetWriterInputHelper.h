...
- (id)associatedInputsWithTrackAssociationType:(id)arg1;	// IMP=0x00000000000ad029
- (id)availableTrackAssociationTypes;	// IMP=0x00000000000acff2
- (void)addTrackAssociationWithTrackOfInput:(id)arg1 type:(id)arg2;	// IMP=0x00000000000acf70
- (_Bool)canAddTrackAssociationWithTrackOfInput:(id)arg1 type:(id)arg2;	// IMP=0x00000000000acf68
...
- (void)markCurrentPassAsFinished;	// IMP=0x00000000000ace48
- (void)markAsFinished;	// IMP=0x00000000000acdc6
- (_Bool)prepareToFinishWritingReturningError:(id *)arg1;	// IMP=0x00000000000acdbe
- (void)prepareToEndSession;	// IMP=0x00000000000acdb8
- (void)didStartInitialSession;	// IMP=0x00000000000acdb2
- (_Bool)appendPixelBuffer:(struct __CVBuffer *)arg1 withPresentationTime:(CDStruct_1b6d18a9)arg2;	// IMP=0x00000000000acd30
- (long long)appendSampleBuffer:(struct opaqueCMSampleBuffer *)arg1 error:(id *)arg2;	// IMP=0x00000000000acca0
- (void)stopRequestingMediaData;	// IMP=0x00000000000acc1e
- (void)requestMediaDataWhenReadyOnQueue:(id)arg1 usingBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000000000acb9c
...
- (_Bool)canStartRespondingToEachPassDescriptionReturningReason:(id *)arg1;	// IMP=0x00000000000ac809
...
- (void)transitionAssetWriterAndAllInputsToFailedStatusWithError:(id)arg1;	// IMP=0x00000000000abd46
- (id)transitionToAndReturnTerminalHelperWithTerminalStatus:(long long)arg1;	// IMP=0x00000000000abcb9
@property(readonly, nonatomic) long long status;
- (id)description;	// IMP=0x00000000000abc28
- (void)dealloc;	// IMP=0x00000000000abbde
- (id)initWithConfigurationState:(id)arg1;	// IMP=0x00000000000abaf1
