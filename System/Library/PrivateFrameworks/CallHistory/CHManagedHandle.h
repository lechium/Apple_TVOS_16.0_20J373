...
+ (id)managedHandlesForHandles:(id)arg1 inManagedObjectContext:(id)arg2;	// IMP=0x008000000000c442
+ (id)managedHandleForHandle:(id)arg1 inManagedObjectContext:(id)arg2;	// IMP=0x008000000000c1d9
+ (id)fetchRequest;	// IMP=0x008000000000db29
- (id)copyWithContext:(id)arg1;	// IMP=0x000000000000c714
