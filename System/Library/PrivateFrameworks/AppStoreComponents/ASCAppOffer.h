...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000007260
- (void).cxx_destruct;	// IMP=0x0000000000008b7e
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000007f58
@property(readonly) unsigned long long hash;
- (id)offerWithMetrics:(id)arg1;	// IMP=0x0000000000007aa1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000007a96
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000077ba
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000007268
- (id)initWithID:(id)arg1 titles:(id)arg2 subtitles:(id)arg3 flags:(long long)arg4 ageRating:(id)arg5 metrics:(id)arg6 baseBuyParams:(id)arg7 metricsBuyParams:(id)arg8 additionalHeaders:(id)arg9 preflightPackageURL:(id)arg10 bundleID:(id)arg11 itemName:(id)arg12 vendorName:(id)arg13;	// IMP=0x0000000000007004
