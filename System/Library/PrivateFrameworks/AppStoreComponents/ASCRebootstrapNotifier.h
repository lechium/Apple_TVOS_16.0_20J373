...
+ (id)sharedNotifier;	// IMP=0x004000000003d319
...
- (void)postLocalNotification;	// IMP=0x000000000003d73f
- (void)postLocalNotificationIfNeeded;	// IMP=0x000000000003d6a4
- (void)dealloc;	// IMP=0x000000000003d648
- (id)_initSingleton;	// IMP=0x000000000003d37e
