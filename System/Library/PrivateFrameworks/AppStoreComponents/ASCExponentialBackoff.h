...
- (void)reset;	// IMP=0x00000000000153ea
- (double)nextSleepTimeInterval;	// IMP=0x0000000000015308
- (id)initWithBaseSleepTimeInterval:(double)arg1 maxSleepTimeInterval:(double)arg2;	// IMP=0x000000000001528c
