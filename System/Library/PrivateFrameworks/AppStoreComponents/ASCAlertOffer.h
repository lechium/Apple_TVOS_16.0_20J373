...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000026bb
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000002ff0
@property(readonly) unsigned long long hash;
- (id)offerWithMetrics:(id)arg1;	// IMP=0x0000000000002c33
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000002c28
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000029e8
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000026c3
- (id)initWithID:(id)arg1 titles:(id)arg2 subtitles:(id)arg3 flags:(long long)arg4 ageRating:(id)arg5 metrics:(id)arg6 alertTitle:(id)arg7 alertMessage:(id)arg8 alertButtonOffer:(id)arg9 alertButtonTitle:(id)arg10;	// IMP=0x00000000000024ea
