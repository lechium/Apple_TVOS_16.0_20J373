...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000001920b
- (void).cxx_destruct;	// IMP=0x0000000000019d22
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000001972b
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001959f
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000001940e
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000019213
- (id)initWithEditorsChoice:(_Bool)arg1 productRating:(float)arg2 productRatingBadge:(id)arg3 productDescription:(id)arg4 screenshots:(id)arg5 trailers:(id)arg6 developerName:(id)arg7;	// IMP=0x00000000000190ba
