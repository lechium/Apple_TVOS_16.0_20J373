...
- (void).cxx_destruct;	// IMP=0x00000000000309ac
...
- (void)cancelGestureDidChange:(id)arg1;	// IMP=0x00000000000308af
- (void)invalidate;	// IMP=0x00000000000305ff
- (void)installWithCancelBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000030121
- (void)dealloc;	// IMP=0x00000000000300e3
- (id)initWithView:(id)arg1;	// IMP=0x0000000000030065
