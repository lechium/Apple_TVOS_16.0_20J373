...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000415fa
- (void).cxx_destruct;	// IMP=0x0000000000042731
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000041e91
@property(readonly) unsigned long long hash;
- (id)offerWithMetrics:(id)arg1;	// IMP=0x0000000000041b22
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000041b17
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000004190b
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000041602
- (id)initWithID:(id)arg1 titles:(id)arg2 subtitles:(id)arg3 flags:(long long)arg4 ageRating:(id)arg5 metrics:(id)arg6 defaultOffer:(id)arg7 buyOffer:(id)arg8 openOffer:(id)arg9;	// IMP=0x0000000000041440
