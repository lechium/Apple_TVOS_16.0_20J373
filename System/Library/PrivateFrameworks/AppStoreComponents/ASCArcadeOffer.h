...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000000cbf8
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000d412
@property(readonly) unsigned long long hash;
- (id)offerWithMetrics:(id)arg1;	// IMP=0x000000000000d0f5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000d0ea
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000cf12
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000cc00
- (id)initWithID:(id)arg1 titles:(id)arg2 subtitles:(id)arg3 flags:(long long)arg4 ageRating:(id)arg5 metrics:(id)arg6 notSubscribedOffer:(id)arg7 subscribedOffer:(id)arg8;	// IMP=0x000000000000ca53
