...
+ (id)sharedContext;	// IMP=0x004000000003ccf9
- (void).cxx_destruct;	// IMP=0x000000000003d2e6
...
- (id)description;	// IMP=0x000000000003d1b7
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000003cf87
- (unsigned long long)hash;	// IMP=0x000000000003cea7
- (id)initWithArtworkFetcher:(id)arg1 lockupFetcher:(id)arg2 appOfferStateCenter:(id)arg3;	// IMP=0x000000000003cdf0
