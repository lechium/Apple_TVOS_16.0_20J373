...
+ (id)daemonDefaults;	// IMP=0x00400000000136e9
- (void).cxx_destruct;	// IMP=0x0000000000014243
@property(readonly, copy, nonatomic) NSString *bundleID; // @synthesize bundleID=_bundleID;
- (id)description;	// IMP=0x000000000001419b
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000014095
- (unsigned long long)hash;	// IMP=0x000000000001401a
...
- (id)objectForKey:(id)arg1;	// IMP=0x0000000000013848
- (void)setObject:(id)arg1 forKey:(id)arg2;	// IMP=0x00000000000137c8
- (id)initWithBundleID:(id)arg1;	// IMP=0x0000000000013755
