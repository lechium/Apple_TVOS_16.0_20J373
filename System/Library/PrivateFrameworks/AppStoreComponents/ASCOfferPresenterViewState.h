...
- (void).cxx_destruct;	// IMP=0x0000000000039584
...
- (id)description;	// IMP=0x0000000000039494
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000039301
- (unsigned long long)hash;	// IMP=0x000000000003924f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000039244
- (id)initWithMetadata:(id)arg1 theme:(id)arg2;	// IMP=0x000000000003918b
