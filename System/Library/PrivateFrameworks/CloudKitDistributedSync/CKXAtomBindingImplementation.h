...
- (void).cxx_destruct;	// IMP=0x00000000000da037
@property(retain, nonatomic) CKXSchema *schema; // @synthesize schema=_schema;
- (id)orcHelpers;	// IMP=0x00000000000d9f85
- (Class)mutableProxyClassForStructToken:(unsigned long long)arg1;	// IMP=0x00000000000d9e77
- (Class)proxyClassForStructToken:(unsigned long long)arg1;	// IMP=0x00000000000d9d69
- (unsigned long long)structTokenForClass:(Class)arg1;	// IMP=0x00000000000d9b7e
- (unsigned long long)topLevelStructToken;	// IMP=0x00000000000d9b74
- (id)init;	// IMP=0x00000000000d9afa
