...
- (id).cxx_construct;	// IMP=0x00000000001059b8
- (void).cxx_destruct;	// IMP=0x000000000010597e
@property(readonly, nonatomic) __weak CKXStructProxyBase *proxy; // @synthesize proxy=_proxy;
- (id)structListProxyForListReference:(unsigned long long)arg1 mutable:(_Bool)arg2;	// IMP=0x000000000010580a
- (id)structProxyForStructReference:(unsigned long long)arg1 mutable:(_Bool)arg2;	// IMP=0x00000000001056ac
- (void)reset;	// IMP=0x000000000010565d
- (id)initWithProxy:(id)arg1;	// IMP=0x00000000001055e5
