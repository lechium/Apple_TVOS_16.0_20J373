...
- (void).cxx_destruct;	// IMP=0x000000000002f784
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002f5bb
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000002f3ff
...
- (_Bool)writeToURL:(id)arg1 error:(id *)arg2;	// IMP=0x000000000002db1a
- (id)initWithModel:(id)arg1;	// IMP=0x000000000002da9b
- (id)initWithContentsOfURL:(id)arg1 error:(id *)arg2;	// IMP=0x000000000002c350
