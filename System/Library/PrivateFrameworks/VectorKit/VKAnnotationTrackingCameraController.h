...
- (id).cxx_construct;	// IMP=0x00000000002f81a9
- (void).cxx_destruct;	// IMP=0x00000000002f8156
...
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x00000000002f7eb3
- (void)resumeAnimation;	// IMP=0x00000000002f7db8
- (void)pauseAnimation;	// IMP=0x00000000002f7d57
- (_Bool)isAnimating;	// IMP=0x00000000002f7cf3
@property(readonly, nonatomic) _Bool shouldForceZoomToFit;
- (void)setGesturing:(_Bool)arg1;	// IMP=0x00000000002f7c5d
- (void)stopTrackingAnnotation;	// IMP=0x00000000002f7af5
- (void)startTrackingAnnotation:(id)arg1 trackHeading:(_Bool)arg2 animated:(_Bool)arg3 duration:(double)arg4 timingFunction:(CDUnknownBlockType)arg5;	// IMP=0x00000000002f7754
- (void)_rotateToHeadingAnimated:(_Bool)arg1 duration:(double)arg2;	// IMP=0x00000000002f774e
- (void)_goToAnnotationAnimated:(_Bool)arg1 duration:(double)arg2 timingFunction:(CDUnknownBlockType)arg3 isInitial:(_Bool)arg4;	// IMP=0x00000000002f7748
- (void)updateFramerate;	// IMP=0x00000000002f762e
@property(readonly, nonatomic, getter=isTrackingHeading) _Bool trackingHeading;
- (void)dealloc;	// IMP=0x00000000002f74d6
- (id)initWithMapDataAccess:(struct MapDataAccess *)arg1 animationRunner:(struct AnimationRunner *)arg2 runLoopController:(struct RunLoopController *)arg3 cameraDelegate:(id)arg4;	// IMP=0x00000000002f7479
