...
- (id).cxx_construct;	// IMP=0x000000000008a05c
...
- (CDUnknownBlockType)annotationCoordinateTest;	// IMP=0x0000000000089e15
- (CDUnknownBlockType)annotationRectTest;	// IMP=0x0000000000089c69
- (Box_3d7e3c2c)_expandedBoundingRect;	// IMP=0x0000000000089bc9
- (_Bool)containsGroundPoint:(const void *)arg1;	// IMP=0x0000000000089aad
- (_Bool)rejectsRect:(const void *)arg1;	// IMP=0x00000000000898a2
- (void)computeFromCamera:(id)arg1;	// IMP=0x0000000000089285
