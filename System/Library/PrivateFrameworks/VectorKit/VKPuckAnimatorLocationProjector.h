...
- (id).cxx_construct;	// IMP=0x00000000006bb930
- (void).cxx_destruct;	// IMP=0x00000000006bb908
...
- (id)detailedDescription;	// IMP=0x00000000006bb724
...
- (void)projectFromLocation:(id)arg1 routeMatch:(id)arg2 speedMultiplier:(double)arg3 routeLine:(id)arg4;	// IMP=0x00000000006baf5c
- (void)_updateCourseAndPositionFromRouteMatch:(id)arg1;	// IMP=0x00000000006bacdc
- (void)reset;	// IMP=0x00000000006bac80
- (void)dealloc;	// IMP=0x00000000006bac0d
- (id)init;	// IMP=0x00000000006bab91
