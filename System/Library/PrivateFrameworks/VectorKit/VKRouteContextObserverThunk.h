...
- (id).cxx_construct;	// IMP=0x0000000000488d05
- (void).cxx_destruct;	// IMP=0x0000000000488ceb
- (void)routeContextStateDidChange:(id)arg1;	// IMP=0x0000000000488c41
- (void)dealloc;	// IMP=0x0000000000488bc5
- (id)initWithRouteContext:(id)arg1 transitSupport:(void *)arg2;	// IMP=0x0000000000488b0e
