...
- (id).cxx_construct;	// IMP=0x00000000005a8f5f
- (void).cxx_destruct;	// IMP=0x00000000005a8f37
...
- (id)initWithName:(id)arg1 shieldGroup:(id)arg2 offset:(struct PolylineCoordinate)arg3;	// IMP=0x00000000005a8e49
