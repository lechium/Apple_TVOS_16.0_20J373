...
- (id).cxx_construct;	// IMP=0x0000000000085aed
- (void).cxx_destruct;	// IMP=0x0000000000085a97
...
- (void)updateCamera:(shared_ptr_46708168)arg1;	// IMP=0x0000000000085791
- (CameraFrame_b765d6d7)cameraFrame;	// IMP=0x0000000000085619
- (View_a667aa2f)view:(struct ViewSize)arg1;	// IMP=0x000000000008556f
...
- (void)adjustClipPlanes;	// IMP=0x000000000008537c
- (float)zoomAtCentrePoint;	// IMP=0x000000000008535f
- (float)zoomAtPoint:(struct CGPoint)arg1;	// IMP=0x00000000000852b1
- (double)depthForViewWidth:(double)arg1;	// IMP=0x0000000000085280
- (double)widthOfViewAtDepth:(double)arg1;	// IMP=0x0000000000085257
- (struct CGPoint)screenPointFromGroundPoint:(const void *)arg1;	// IMP=0x000000000008516e
- (optional_67826ebe)groundPointFromScreenPoint:(struct CGPoint)arg1 atGroundLevel:(double)arg2;	// IMP=0x0000000000084fcc
- (optional_67826ebe)groundPointFromScreenPoint:(struct CGPoint)arg1;	// IMP=0x0000000000084faa
- (void)updateIfNeeded;	// IMP=0x000000000008454a
- (void)setNeedsUpdate;	// IMP=0x000000000008451b
- (CDUnknownBlockType)annotationCoordinateTest;	// IMP=0x0000000000084505
- (CDUnknownBlockType)annotationRectTest;	// IMP=0x00000000000844ef
- (Matrix_6e1d3589)groundPlaneIntersectionPoint;	// IMP=0x00000000000843f0
@property(nonatomic) struct VKCameraState cameraState;
@property(readonly, nonatomic) double yaw;
@property(readonly, nonatomic) double pitch;
- (double)displayZoomLevel;	// IMP=0x0000000000084132
...
- (Mercator3_d8bb135c)mercatorPosition;	// IMP=0x0000000000083b51
- (void)setMercatorPosition:(const void *)arg1;	// IMP=0x00000000000839f8
- (void)_setPosition:(const void *)arg1;	// IMP=0x00000000000839cd
- (id)descriptionDictionaryRepresentation;	// IMP=0x00000000000836ac
- (id)description;	// IMP=0x00000000000834d3
- (id)detailedDescription;	// IMP=0x00000000000834c1
- (id)initWithRunLoopController:(struct RunLoopController *)arg1;	// IMP=0x0000000000083338
