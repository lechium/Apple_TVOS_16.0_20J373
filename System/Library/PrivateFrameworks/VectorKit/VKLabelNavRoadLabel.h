...
- (id).cxx_construct;	// IMP=0x00000000006fda3b
- (void).cxx_destruct;	// IMP=0x00000000006fda0c
...
- (id)description;	// IMP=0x00000000006fd8cf
- (id)displayGroup;	// IMP=0x00000000006fd71d
- (void)layoutForStagingWithNavContext:(struct NavContext *)arg1;	// IMP=0x00000000006fd70c
- (void)layoutWithNavContext:(struct NavContext *)arg1;	// IMP=0x00000000006fd6da
...
- (id)initWithNavFeature:(id)arg1 label:(const void *)arg2 navLabelType:(int)arg3;	// IMP=0x00000000006fd560
