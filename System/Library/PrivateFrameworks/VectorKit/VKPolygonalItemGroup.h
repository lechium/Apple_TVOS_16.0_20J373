...
- (id).cxx_construct;	// IMP=0x00000000003eb30a
- (void).cxx_destruct;	// IMP=0x00000000003eb107
...
- (void)clearRouteAttributes;	// IMP=0x00000000003eb0c8
- (void)setRouteAttributes:(const struct PolygonRouteAttributes *)arg1;	// IMP=0x00000000003eb09c
- (void)updateCachedStyles;	// IMP=0x00000000003ea8bf
@property(readonly, nonatomic) const void *featureIds;
- (_Bool)hasFeatureId:(unsigned long long)arg1;	// IMP=0x00000000003ea88b
- (_Bool)canAcceptPolygon:(void *)arg1;	// IMP=0x00000000003ea7d7
- (void)didFinishAddingData;	// IMP=0x00000000003ea539
- (void)willAddDataWithAccessor:(struct ResourceAccessor *)arg1;	// IMP=0x00000000003ea03b
- (unsigned char)indexForGeoFeatureAttributes:(const void *)arg1;	// IMP=0x00000000003e9c97
- (const void *)commitRangesToVerticalVenueWallStrokeRenderItemBatcher:(void *)arg1 forMeshAtIndex:(unsigned long long)arg2 cullingMask:(unsigned int)arg3;	// IMP=0x00000000003e9be3
- (const void *)commitRangesToHorizontalVenueWallStrokeRenderItemBatcher:(void *)arg1 forMeshAtIndex:(unsigned long long)arg2 cullingMask:(unsigned int)arg3;	// IMP=0x00000000003e9b2f
- (const void *)commitRangesToVenueWallEndCapRenderItemBatcher:(void *)arg1 forMeshAtIndex:(unsigned long long)arg2 cullingMask:(unsigned int)arg3;	// IMP=0x00000000003e9a7b
- (const void *)commitRangesToVenueWallRenderItemBatcher:(void *)arg1 forMeshAtIndex:(unsigned long long)arg2 cullingMask:(unsigned int)arg3;	// IMP=0x00000000003e99c7
- (const void *)commitRangesToStrokeRenderItemBatcher:(void *)arg1 forMeshAtIndex:(unsigned long long)arg2 cullingMask:(unsigned int)arg3 featureIdPredicate:(function_ce5c9822)arg4;	// IMP=0x00000000003e9904
- (const void *)commitRangesToFillRenderItemBatcher:(void *)arg1 forMeshAtIndex:(unsigned long long)arg2 cullingMask:(unsigned int)arg3 featureIdPredicate:(function_ce5c9822)arg4;	// IMP=0x00000000003e9841
@property(readonly, nonatomic) void *fillMeshes;
@property(readonly, nonatomic) float tileZoom;
- (void *)styleQueries:(const struct StyleQueryOverride *)arg1;	// IMP=0x00000000003e9455
...
- (const void *)attributeSets;	// IMP=0x00000000003e93f2
- (unsigned char)maxAttributeSetsPerGroup;	// IMP=0x00000000003e93e7
- (id)initWithStyleQuery:(void *)arg1 tileZoom:(float)arg2 fixedAroundCentroid:(const void *)arg3 contentScale:(float)arg4 storage:(shared_ptr_fb8448a7)arg5;	// IMP=0x00000000003e8e61
- (id)initWithStyleQuery:(void *)arg1 tileZoom:(float)arg2 fixedAroundCentroid:(const void *)arg3 contentScale:(float)arg4;	// IMP=0x00000000003e8dba
