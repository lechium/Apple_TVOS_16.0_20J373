...
- (id).cxx_construct;	// IMP=0x00000000006c187b
- (void).cxx_destruct;	// IMP=0x00000000006c15ab
...
- (struct __IOSurface *)flipImage;	// IMP=0x00000000006c155f
- (void *)debugConsoleForId:(int)arg1;	// IMP=0x00000000006c14a4
- (struct CGPoint)convertPoint:(struct CGPoint)arg1 toLayer:(id)arg2;	// IMP=0x00000000006c148e
@property(readonly, nonatomic) float averageFPS;
- (void)renderWithTimestamp:(double)arg1 completion:(function_2e574590)arg2;	// IMP=0x00000000006c0dd9
- (_Bool)hasRenderTarget;	// IMP=0x00000000006c0dcb
- (void)destroyRenderTarget;	// IMP=0x00000000006c0d14
- (void)createRenderTarget;	// IMP=0x00000000006c0c3f
...
- (void)didEnterBackground;	// IMP=0x00000000006c0a4e
- (void)didReceiveMemoryWarning;	// IMP=0x00000000006c0a48
- (shared_ptr_fa6aa836)bitmapData;	// IMP=0x00000000006c09c8
- (void)_didReadPixels:(void *)arg1;	// IMP=0x00000000006c089d
- (void)drawInContext:(struct CGContext *)arg1;	// IMP=0x00000000006c01f5
- (void)setBackgroundColor:(struct CGColor *)arg1;	// IMP=0x00000000006c01df
- (void)setContentsGravity:(id)arg1;	// IMP=0x00000000006c01c9
- (void)setOpaque:(_Bool)arg1;	// IMP=0x00000000006c01b3
- (void)setNeedsDisplayOnBoundsChange:(_Bool)arg1;	// IMP=0x00000000006c019d
- (void)expandedPerformanceHUD:(id)arg1;	// IMP=0x00000000006c0137
- (void)disablePerformanceHUD:(id)arg1;	// IMP=0x00000000006c0120
- (void)enablePerformanceHUD:(id)arg1;	// IMP=0x00000000006c0106
@property(readonly, nonatomic) void *renderer;
- (void)didPresent;	// IMP=0x00000000006bfeef
- (void)willPresent;	// IMP=0x00000000006bfe4b
- (void)didUpdateFrameTexture;	// IMP=0x00000000006bfda7
- (void)willUpdateFrameTexture;	// IMP=0x00000000006bfd03
- (void)drawToTexture:(void *)arg1 withRenderQueue:(void *)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000006bf9d8
- (void)drawToTexture:(void *)arg1 withRenderQueue:(void *)arg2;	// IMP=0x00000000006bf9c3
- (void *)_renderQueueForTimestamp:(double)arg1 prepareHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000006bf92d
- (void *)renderQueueForTimestamp:(double)arg1;	// IMP=0x00000000006bf901
- (_Bool)isDelayedRenderQueueConsumptionSupported;	// IMP=0x00000000006bf8b6
- (void)prepareTargetsForPlatormsWithoutFramebufferFetch:(const void *)arg1 isDrawable:(_Bool)arg2;	// IMP=0x00000000006beba4
- (void)prepareTargetsForPlatormsWithFramebufferFetch:(const void *)arg1;	// IMP=0x00000000006be77d
- (void)_prepareTexture:(const void *)arg1 isDrawable:(_Bool)arg2;	// IMP=0x00000000006be6ca
- (void)prepareTexture:(const void *)arg1;	// IMP=0x00000000006be6b3
- (void)dealloc;	// IMP=0x00000000006be43b
- (id)initWithContentScale:(double)arg1 useMultisampling:(_Bool)arg2 extraColorFormats:(const void *)arg3 shouldRasterize:(_Bool)arg4 allowBlitToDrawable:(_Bool)arg5 taskContext:(const void *)arg6 device:(void *)arg7 sharedResources:(id)arg8 signpostId:(unsigned long long)arg9;	// IMP=0x00000000006bdaea
