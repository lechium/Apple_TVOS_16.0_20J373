...
- (id).cxx_construct;	// IMP=0x000000000052f577
- (void).cxx_destruct;	// IMP=0x000000000052f4ae
...
- (double)boundsUnitsPerMeter;	// IMP=0x000000000052f2eb
- (Matrix_08d701e4)maneuverTransform;	// IMP=0x000000000052f259
- (Matrix_08d701e4)inverseManeuverTransform;	// IMP=0x000000000052f205
- (vector_9022e479)maneuverPoints;	// IMP=0x000000000052ee9a
- (void)_updateBounds:(id)arg1 boundsInflation:(float)arg2;	// IMP=0x000000000052e4e5
- (void)forEachSection:(CDUnknownBlockType)arg1;	// IMP=0x000000000052e41f
- (void)splitRouteLineAtAnnotation:(id)arg1;	// IMP=0x000000000052de27
- (optional_db527fce)snapRouteMatch:(id)arg1;	// IMP=0x000000000052d238
- (_Bool)needsUpdateForViewingScale:(double)arg1;	// IMP=0x000000000052d119
- (_Bool)isTrafficUptoDate:(double)arg1;	// IMP=0x000000000052d0ea
- (_Bool)isTrafficUpToDate;	// IMP=0x000000000052d0b3
- (void)createMeshIfNecessary:(long long)arg1;	// IMP=0x000000000052cfdb
- (void)generateArrowsForManeuverDisplayMode:(int)arg1 routeLineWidth:(double)arg2;	// IMP=0x000000000052c928
- (_Bool)buildRouteLine:(id)arg1 matchToRoads:(_Bool)arg2 shouldGenerateSnapPath:(_Bool)arg3 viewUnitsPerPoint:(double)arg4 force:(_Bool)arg5 boundsInflation:(float)arg6 isGradientTraffic:(_Bool)arg7 currentLegIndex:(unsigned int)arg8;	// IMP=0x0000000000529ffd
- (void)_updateTilesCovered:(id)arg1;	// IMP=0x0000000000529dda
@property(readonly, nonatomic) GEOComposedRoute *composedRoute;
- (void)dealloc;	// IMP=0x0000000000529d0e
- (id)initWithPolylineOverlay:(id)arg1;	// IMP=0x0000000000529bdc
