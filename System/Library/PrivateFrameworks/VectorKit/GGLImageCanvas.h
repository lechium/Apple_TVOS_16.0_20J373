...
- (id).cxx_construct;	// IMP=0x00000000004eb876
- (void).cxx_destruct;	// IMP=0x00000000004eb6e7
...
- (void *)debugConsoleForId:(int)arg1;	// IMP=0x00000000004eb566
- (void)didDrawView;	// IMP=0x00000000004eb55c
- (void)willDrawView;	// IMP=0x00000000004eb500
- (void)renderWithTimestamp:(double)arg1 completion:(function_2e574590)arg2;	// IMP=0x00000000004eafb3
- (_Bool)hasRenderTarget;	// IMP=0x00000000004eafa2
- (void)destroyRenderTarget;	// IMP=0x00000000004ead80
- (void)createRenderTarget;	// IMP=0x00000000004ea0a8
- (struct __IOSurface *)flipImage;	// IMP=0x00000000004e9ec3
...
- (shared_ptr_fa6aa836)bitmapData;	// IMP=0x00000000004e9ca9
@property(readonly, nonatomic) void *imageTexture;
@property(readonly, nonatomic) _Bool shouldRasterize;
- (void)dealloc;	// IMP=0x00000000004e9c3f
- (id)initWithSize:(struct CGSize)arg1 scale:(double)arg2 useMultisampling:(_Bool)arg3 extraColorFormats:(const void *)arg4 taskContext:(const void *)arg5 device:(void *)arg6 signpostId:(unsigned long long)arg7;	// IMP=0x00000000004e8f30
- (void *)_internalRenderTarget;	// IMP=0x00000000004e8f26
@property(readonly, nonatomic) void *finalRenderTarget;
@property(readonly, nonatomic) struct CGSize sizeInPixels;
- (void)willDealloc;	// IMP=0x00000000004e8bd7
- (void *)finalSurface;	// IMP=0x00000000004e8bcd
