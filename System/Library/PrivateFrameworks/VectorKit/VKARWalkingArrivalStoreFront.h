...
- (id).cxx_construct;	// IMP=0x00000000004f516a
- (void).cxx_destruct;	// IMP=0x00000000004f5164
...
- (id)description;	// IMP=0x00000000004f5055
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000004f4ee8
...
- (id)initWithOrientedRect:(const void *)arg1 undulationProvider:(CDUnknownBlockType)arg2;	// IMP=0x00000000004f47a4
- (id)initWithYaw:(float)arg1 pitch:(float)arg2 roll:(float)arg3 x:(double)arg4 y:(double)arg5 z:(double)arg6 w:(float)arg7 h:(float)arg8 undulationProvider:(CDUnknownBlockType)arg9;	// IMP=0x00000000004f4582
- (id)initWithGEOOrientedBox:(id)arg1 undulationProvider:(CDUnknownBlockType)arg2;	// IMP=0x00000000004f4301
- (id)initWithOrientedRect:(const void *)arg1;	// IMP=0x00000000004f42ed
