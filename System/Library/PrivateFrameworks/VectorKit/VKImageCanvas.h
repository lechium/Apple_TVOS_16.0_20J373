...
- (id).cxx_construct;	// IMP=0x00000000004f7410
- (void).cxx_destruct;	// IMP=0x00000000004f73b8
...
- (void)didReceiveMemoryWarning:(_Bool)arg1;	// IMP=0x00000000004f7368
- (void)renderSceneWithEngine:(void *)arg1 completion:(function_2e574590)arg2;	// IMP=0x00000000004f715f
- (void)cancelLoad;	// IMP=0x00000000004f7135
- (void)loadScene;	// IMP=0x00000000004f710f
@property(readonly, nonatomic) VKCamera *vkCamera;
@property(readonly, nonatomic) double pitch;
@property(readonly, nonatomic) double yaw;
@property(readonly, nonatomic) GEOMapRegion *mapRegion;
- (void)setCenterCoordinate:(CDStruct_c3b9c2ee)arg1 altitude:(double)arg2 yaw:(double)arg3 pitch:(double)arg4;	// IMP=0x00000000004f6fce
- (void)setMapRegion:(id)arg1 pitch:(double)arg2 yaw:(double)arg3;	// IMP=0x00000000004f6f16
- (void)cancelTileRequests;	// IMP=0x00000000004f6f10
- (void)clearScene;	// IMP=0x00000000004f6f0a
- (void)didLayout;	// IMP=0x00000000004f6f04
- (void)updateWithTimestamp:(double)arg1 withContext:(void *)arg2;	// IMP=0x00000000004f6eee
@property(readonly, nonatomic) shared_ptr_e963992e taskContext;
- (id)initWithMapEngine:(void *)arg1;	// IMP=0x00000000004f6ba0
