...
- (id).cxx_construct;	// IMP=0x00000000005a8d1e
- (void).cxx_destruct;	// IMP=0x00000000005a8bb6
...
- (unsigned char)computeRoutePositionForPOIAtPixel:(const void *)arg1 currentPosition:(unsigned char)arg2 context:(struct NavContext *)arg3;	// IMP=0x00000000005a8aba
- (_Bool)_updateActiveRouteRange;	// IMP=0x00000000005a7bba
- (_Bool)_findRouteOverlappingJunctionFrom:(long long)arg1 routeJunctions:(void *)arg2 lookBackward:(_Bool)arg3 firstOverlap:(long long *)arg4 secondOverlap:(long long *)arg5;	// IMP=0x00000000005a79e8
- (void)_updateCurrentRoadInfo;	// IMP=0x00000000005a769b
- (void)_initalizeCurrentRoadInfo;	// IMP=0x00000000005a767e
- (void)_dedupOffRouteRoads;	// IMP=0x00000000005a6da1
- (void)_updatePreferredLabelPlacements;	// IMP=0x00000000005a6a86
- (void)_updateRoadsInGuidance;	// IMP=0x00000000005a6530
- (void)_updateRoadStarts;	// IMP=0x00000000005a609d
- (void)_updateUniqueOffRouteRoads;	// IMP=0x00000000005a5aea
- (_Bool)_addJunctionsForTile:(const void *)arg1;	// IMP=0x00000000005a4a32
- (void)_addLabelsForJunctions:(id)arg1 withContext:(struct NavContext *)arg2 maxLabelsToAdd:(unsigned long long)arg3 useAllJunctions:(_Bool)arg4 placeShieldsFrontToBack:(_Bool)arg5;	// IMP=0x00000000005a3c1f
- (void)_addLabelsAtJunctions:(id)arg1 withContext:(struct NavContext *)arg2 maxLabelsToAdd:(unsigned long long)arg3;	// IMP=0x00000000005a3600
- (void)_addVisibleSigns;	// IMP=0x00000000005a353c
- (void)layoutWithNavContext:(struct NavContext *)arg1 avoidanceRects:(const void *)arg2;	// IMP=0x00000000005a0bb8
- (unsigned char)orientationForRoadSign:(id)arg1 roadLabel:(id)arg2 navContext:(struct NavContext *)arg3;	// IMP=0x00000000005a0a42
- (unsigned char)resolveOrientation:(struct NavContext *)arg1 road:(id)arg2 currentOrientation:(unsigned char)arg3;	// IMP=0x00000000005a08f7
- (struct RoadSignOrientationResolver)createRoadSignOrientationResolver:(id)arg1 navContext:(struct NavContext *)arg2;	// IMP=0x00000000005a085f
- (void)_generateCurrentRoadSignWithContext:(struct NavContext *)arg1;	// IMP=0x000000000059fc12
- (void)styleManagerDidFinishAnimating;	// IMP=0x000000000059fc05
- (void)styleManagerDidStartAnimating;	// IMP=0x000000000059fbf6
- (void)styleManagerDidChange:(_Bool)arg1;	// IMP=0x000000000059fbdf
- (_Bool)_collideLabel:(id)arg1 activeLabel:(id)arg2 labelsToRemove:(id)arg3;	// IMP=0x000000000059f35a
- (void)_tryAddLabel:(id)arg1 navContext:(struct NavContext *)arg2 labelCollisionEnabled:(_Bool)arg3;	// IMP=0x000000000059df93
- (void)_tryAddRoadSignForRoad:(id)arg1 isShield:(_Bool)arg2 navContext:(struct NavContext *)arg3 labelCollisionEnabled:(_Bool)arg4;	// IMP=0x000000000059daf8
- (void)_createOrUpdateLabelForRoad:(id)arg1 isShield:(_Bool)arg2 navContext:(struct NavContext *)arg3 hopOffsetDistance:(float)arg4;	// IMP=0x000000000059d988
- (void)_tryAddRoadSignForJunction:(id)arg1 navContext:(struct NavContext *)arg2 labelCollisionEnabled:(_Bool)arg3;	// IMP=0x000000000059d810
- (void)grabTilesFromScene:(const void *)arg1;	// IMP=0x000000000059d4f9
- (void)_refreshGuidanceRoadNames;	// IMP=0x000000000059d26c
- (void)_reloadRouteJunctions;	// IMP=0x000000000059cf74
- (void)clearSceneIsMemoryWarning:(_Bool)arg1;	// IMP=0x000000000059ce81
- (_Bool)isNavMode;	// IMP=0x000000000059ce69
- (void)setMaxVisibleRoadsigns:(unsigned int)arg1;	// IMP=0x000000000059cce6
- (void)setStyleManager:(shared_ptr_3e3c7f86)arg1;	// IMP=0x000000000059cad2
- (id)init;	// IMP=0x000000000059c54c
@property(readonly, nonatomic) float currentRoadSignPixelHeight;
@property(readonly, nonatomic) void *currentRoadSign;
- (void)drawNavOverlayDebugView:(void *)arg1 navContext:(struct NavContext *)arg2;	// IMP=0x000000000049b6d7
- (void)drawRoadSignOrientationDebugView:(void *)arg1 navContext:(struct NavContext *)arg2;	// IMP=0x000000000049a839
- (void)debugDraw:(id)arg1 overlayConsole:(void *)arg2 navContext:(struct NavContext *)arg3;	// IMP=0x000000000049a6c6
- (_Bool)needsDebugDraw;	// IMP=0x000000000049a5d0
