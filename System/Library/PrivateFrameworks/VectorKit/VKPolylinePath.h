...
- (id).cxx_construct;	// IMP=0x00000000003137e1
- (void).cxx_destruct;	// IMP=0x000000000031378e
...
- (id)description;	// IMP=0x00000000003136ce
- (Matrix_811b2232)convertCoordinateToTile:(const CDStruct_071ac149 *)arg1;	// IMP=0x00000000003135c7
@property(readonly) _Bool isMapMatched;
@property(readonly) _Bool hasCompletedMapMatching;
- (float)laneHalfWidthAtIndex:(unsigned int)arg1;	// IMP=0x000000000031359d
...
- (const struct GradientTraffic *)gradientTrafficAtIndex:(unsigned int)arg1;	// IMP=0x0000000000313564
- (id)initWithOverlay:(id)arg1 section:(id)arg2 routeStartIndex:(unsigned int)arg3 routeEndIndex:(unsigned int)arg4 matchedPathSegments:(id)arg5;	// IMP=0x0000000000312a2c
- (id)initWithOverlay:(id)arg1 section:(id)arg2 matchedPathSegments:(id)arg3;	// IMP=0x0000000000312928
