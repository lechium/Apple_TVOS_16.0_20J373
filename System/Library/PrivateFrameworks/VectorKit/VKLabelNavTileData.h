...
- (id).cxx_construct;	// IMP=0x00000000007057bc
- (void).cxx_destruct;	// IMP=0x0000000000705762
...
- (void)findOppositeCarriagewayJunctionsWithRouteFeatures:(void *)arg1 distanceThreshold:(double)arg2;	// IMP=0x0000000000704d5f
- (void)appendNavJunctionsInWorldRect:(const void *)arg1 junctions:(id)arg2;	// IMP=0x0000000000704bd5
- (void)initializeJunctionInfos;	// IMP=0x000000000070485a
- (id)findTileEdgeJunctionAtCoordinate:(Matrix_8746f91e)arg1;	// IMP=0x0000000000704691
- (void)_findTileEdgeJunctions;	// IMP=0x0000000000704554
- (void)addJunction:(id)arg1;	// IMP=0x00000000007044c0
- (id)junctionAtCoordinate:(Matrix_8746f91e)arg1;	// IMP=0x0000000000704335
- (id)junctionForGeoJunction:(struct GeoCodecsConnectivityJunction *)arg1;	// IMP=0x000000000070431f
- (id)initWithTile:(const void *)arg1;	// IMP=0x0000000000704200
