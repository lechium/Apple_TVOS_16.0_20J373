...
- (id).cxx_construct;	// IMP=0x0000000000636a18
- (void).cxx_destruct;	// IMP=0x000000000063699e
- (void)purgeExpired:(double)arg1;	// IMP=0x0000000000636919
- (void)reportCorruptTile:(const struct _GEOTileKey *)arg1;	// IMP=0x0000000000636903
- (void)cancelRequests;	// IMP=0x000000000063684d
- (void)updateJobPriority:(void *)arg1;	// IMP=0x0000000000636796
- (void)cancelJob:(void *)arg1;	// IMP=0x00000000006366d6
- (void)fetchDataForJob:(void *)arg1;	// IMP=0x0000000000635d69
- (shared_ptr_97fa0047)getJobForKey:(const struct _GEOTileKey *)arg1;	// IMP=0x0000000000635cef
- (id)initWithToken:(id)arg1;	// IMP=0x0000000000635b22
