...
- (id).cxx_construct;	// IMP=0x00000000007bd850
- (void).cxx_destruct;	// IMP=0x00000000007bd7d3
...
- (void)experimentConfigurationDidChange:(id)arg1;	// IMP=0x00000000007bd2dc
- (void)resourceManifestManager:(id)arg1 didChangeActiveTileGroup:(id)arg2 fromOldTileGroup:(id)arg3;	// IMP=0x00000000007bd1d9
- (void)resourceManifestManagerWillChangeActiveTileGroup:(id)arg1;	// IMP=0x00000000007bd153
- (void)dealloc;	// IMP=0x00000000007bd022
- (id)initWithQueue:(id)arg1;	// IMP=0x00000000007bcf0a
