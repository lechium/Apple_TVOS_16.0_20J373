...
- (void).cxx_destruct;	// IMP=0x00000000000031c3
...
- (id)initWithPrincipalClass:(Class)arg1 intentsSupported:(id)arg2 intentsRestrictedWhileLocked:(id)arg3;	// IMP=0x00000000000030da
