...
+ (id)resultFromLegacyDictionary:(id)arg1;	// IMP=0x00100000000b0fde
- (void).cxx_destruct;	// IMP=0x00000000002423a6
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000242202
- (unsigned long long)hash;	// IMP=0x0000000000242091
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000241f65
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000241e81
- (void)copyTo:(id)arg1;	// IMP=0x0000000000241de3
- (void)writeTo:(id)arg1;	// IMP=0x0000000000241d3d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000241d30
- (id)dictionaryRepresentation;	// IMP=0x000000000024182d
- (id)description;	// IMP=0x000000000024177e
@property(readonly, nonatomic) _Bool hasPlaybackCrop;
@property(readonly, nonatomic) _Bool hasKeyFrame;
- (id)exportToLegacyDictionary;	// IMP=0x00000000000b1450
