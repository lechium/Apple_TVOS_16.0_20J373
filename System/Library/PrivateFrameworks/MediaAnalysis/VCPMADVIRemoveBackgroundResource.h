...
+ (id)sharedResource;	// IMP=0x00600000000370e4
...
- (void)purge;	// IMP=0x0000000000037222
- (long long)inactiveCost;	// IMP=0x00000000000371e9
- (long long)activeCost;	// IMP=0x00000000000371af
