...
+ (_Bool)_isColocatingAnimalObservation:(id)arg1 withFaceObservations:(id)arg2 orTorsoObservations:(id)arg3;	// IMP=0x001000000005b1fc
+ (double)_calculateIoUBetweenObservation:(id)arg1 andObservation:(id)arg2;	// IMP=0x001000000005b0a7
+ (double)_calculateOverlappingBetweenFaceObservation:(id)arg1 andHumanObservation:(id)arg2;	// IMP=0x001000000005af9d
+ (id)facesFromPHFetchResult:(id)arg1 copyOption:(long long)arg2;	// IMP=0x001000000005a6bc
+ (id)faceFromPHFace:(id)arg1 copyOption:(long long)arg2;	// IMP=0x0010000000059a91
+ (id)facesFromFaceObservations:(id)arg1 humanObservations:(id)arg2 animalObservations:(id)arg3 sourceWidth:(unsigned long long)arg4 sourceHeight:(unsigned long long)arg5 visionRequests:(id)arg6 blurScorePerFace:(id)arg7 exposureScorePerFace:(id)arg8 tooSmallFaceObservations:(id)arg9 processingVersion:(int)arg10;	// IMP=0x001000000005740d
+ (id)faceFromFaceObservation:(id)arg1 humanObservation:(id)arg2 sourceWidth:(unsigned long long)arg3 sourceHeight:(unsigned long long)arg4 visionRequests:(id)arg5 processingVersion:(int)arg6 force:(_Bool)arg7 andError:(id *)arg8;	// IMP=0x0010000000054ddf
+ (id)faceWithLocalIdentifier:(id)arg1;	// IMP=0x0010000000054d7a
- (void).cxx_destruct;	// IMP=0x000000000005bd10
...
- (double)photosFaceRepresentationQuality;	// IMP=0x000000000005b8ba
- (double)photosFaceRepresentationRoll;	// IMP=0x000000000005b8a8
- (id)photosFaceRepresentationLocalIdentifier;	// IMP=0x000000000005b896
- (long long)photosFaceRepresentationClusterSequenceNumber;	// IMP=0x000000000005b884
- (long long)photosFaceRepresentationQualityMeasure;	// IMP=0x000000000005b872
- (_Bool)photosFaceRepresentationIsRightEyeClosed;	// IMP=0x000000000005b860
- (_Bool)photosFaceRepresentationIsLeftEyeClosed;	// IMP=0x000000000005b84e
- (_Bool)photosFaceRepresentationHasSmile;	// IMP=0x000000000005b83c
- (double)photosFaceRepresentationBlurScore;	// IMP=0x000000000005b82a
- (double)photosFaceRepresentationSize;	// IMP=0x000000000005b818
- (double)photosFaceRepresentationCenterY;	// IMP=0x000000000005b806
- (double)photosFaceRepresentationCenterX;	// IMP=0x000000000005b7f4
- (long long)photosFaceRepresentationSourceHeight;	// IMP=0x000000000005b7e2
- (long long)photosFaceRepresentationSourceWidth;	// IMP=0x000000000005b7d0
- (long long)qualityMeasureWithCountOfFacesOnAsset:(unsigned long long)arg1;	// IMP=0x000000000005b674
- (id)gist;	// IMP=0x000000000005ad9b
- (struct CGRect)normalizedFaceRect;	// IMP=0x000000000005ad1a
- (_Bool)setCenterAndSizeFromNormalizedFaceRect:(struct CGRect)arg1;	// IMP=0x000000000005ac7b
- (void)replaceCoordinatesAndFeaturesFromDetectedFace:(id)arg1;	// IMP=0x000000000005a8f6
- (id)initWithLocalIdentifier:(id)arg1;	// IMP=0x0000000000054c50
