...
+ (_Bool)supportVectorForward;	// IMP=0x006000000024423d
+ (_Bool)supportGPU;	// IMP=0x0060000000244235
- (void).cxx_destruct;	// IMP=0x00000000002442c7
...
- (int)execute;	// IMP=0x0000000000244253
- (id)initNewContext:(_Bool)arg1;	// IMP=0x0000000000244245
