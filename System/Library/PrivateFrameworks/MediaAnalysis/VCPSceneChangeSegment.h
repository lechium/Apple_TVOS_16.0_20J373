...
- (void)finalizeAtTime:(CDStruct_1b6d18a9)arg1;	// IMP=0x0000000000254dff
- (void)mergeSegment:(id)arg1;	// IMP=0x0000000000254d00
- (void)resetSegment:(CDStruct_1b6d18a9)arg1;	// IMP=0x0000000000254c7c
- (void)updateSegment:(CDStruct_1b6d18a9)arg1;	// IMP=0x0000000000254c12
- (id)init;	// IMP=0x0000000000254b9e
