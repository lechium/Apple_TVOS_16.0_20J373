...
+ (void)unimplementedExceptionForMethodName:(id)arg1;	// IMP=0x00800000002640b3
- (id)typeDescription;	// IMP=0x0000000000264236
...
- (struct __CVBuffer *)imageWithPreferredDimension:(unsigned long long)arg1 orientation:(unsigned int *)arg2;	// IMP=0x000000000026441a
- (struct __CVBuffer *)imageWithPreferredDimension:(unsigned long long)arg1;	// IMP=0x00000000002643f6
...
- (struct CGSize)originalMovieSize;	// IMP=0x0000000000264650
- (id)originalMovie;	// IMP=0x000000000026462c
- (id)streamedMovie;	// IMP=0x0000000000264624
- (_Bool)isMovieResourceLocalAvailable;	// IMP=0x0000000000264600
- (id)movie;	// IMP=0x00000000002645dc
