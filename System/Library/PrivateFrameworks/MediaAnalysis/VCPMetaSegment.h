...
- (void)finalizeAtTime:(CDStruct_1b6d18a9)arg1;	// IMP=0x0000000000085743
- (void)mergeSegment:(id)arg1;	// IMP=0x0000000000085644
- (void)resetSegment:(CDStruct_1b6d18a9)arg1;	// IMP=0x00000000000855c0
- (void)updateSegment:(CDStruct_1b6d18a9)arg1;	// IMP=0x0000000000085556
- (id)init;	// IMP=0x00000000000854e2
