...
+ (id)resultFromLegacyDictionary:(id)arg1;	// IMP=0x001000000001c80a
- (void).cxx_destruct;	// IMP=0x0000000000022134
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000021d69
- (unsigned long long)hash;	// IMP=0x00000000000212f9
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000210fa
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000020e53
- (void)copyTo:(id)arg1;	// IMP=0x0000000000020cb2
- (void)writeTo:(id)arg1;	// IMP=0x0000000000020a45
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000020a38
...
- (id)exportToLegacyDictionary;	// IMP=0x000000000001cf7c
