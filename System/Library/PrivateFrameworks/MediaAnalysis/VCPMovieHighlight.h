...
- (void).cxx_destruct;	// IMP=0x00000000000a1e8e
...
- (void)checkAutoPlayable;	// IMP=0x00000000000a1bf4
- (void)copyScoresFrom:(id)arg1;	// IMP=0x00000000000a1a8d
- (_Bool)isShort;	// IMP=0x00000000000a1a42
- (void)mergeSegment:(id)arg1;	// IMP=0x00000000000a154b
- (id)initWithTimeRange:(CDStruct_e83c9415)arg1;	// IMP=0x00000000000a14c6
