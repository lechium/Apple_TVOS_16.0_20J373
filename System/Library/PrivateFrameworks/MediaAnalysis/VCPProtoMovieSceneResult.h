...
+ (id)resultFromLegacyDictionary:(id)arg1;	// IMP=0x00100000001ac942
- (void).cxx_destruct;	// IMP=0x000000000000ca34
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000000c8e2
- (unsigned long long)hash;	// IMP=0x000000000000c4d2
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000c39a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000c2ac
- (void)copyTo:(id)arg1;	// IMP=0x000000000000c1f8
- (void)writeTo:(id)arg1;	// IMP=0x000000000000c131
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000000c124
- (id)dictionaryRepresentation;	// IMP=0x000000000000bbce
- (id)description;	// IMP=0x000000000000bb1f
...
- (id)exportToLegacyDictionary;	// IMP=0x00000000001acc10
