...
- (void).cxx_destruct;	// IMP=0x000000000022636f
@property(readonly, retain, nonatomic) NSArray *results;
- (int)finalizeAnalysis;	// IMP=0x00000000002262ca
- (void)addSegmentToResults;	// IMP=0x000000000022609d
- (int)processFrameMetadata:(id)arg1;	// IMP=0x0000000000225e65
- (id)init;	// IMP=0x0000000000225d7f
