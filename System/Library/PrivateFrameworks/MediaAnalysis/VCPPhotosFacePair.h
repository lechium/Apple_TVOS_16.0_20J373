...
+ (id)pairWithFace:(id)arg1 andFace:(id)arg2 distance:(double)arg3;	// IMP=0x0060000000230e9f
- (void).cxx_destruct;	// IMP=0x0000000000230f46
...
- (id)initWithFace:(id)arg1 andFace:(id)arg2 distance:(double)arg3;	// IMP=0x0000000000230df7
