...
- (id).cxx_construct;	// IMP=0x00000000000f1595
- (void).cxx_destruct;	// IMP=0x00000000000f1537
- (id)results;	// IMP=0x00000000000f14c1
- (int)finalizeAnalysisAtTime:(const CDStruct_1b6d18a9 *)arg1;	// IMP=0x00000000000f0d5a
- (int)processAudioSamples:(struct AudioBufferList *)arg1 timestamp:(struct AudioTimeStamp)arg2;	// IMP=0x00000000000f0502
- (void)dealloc;	// IMP=0x00000000000f048a
- (int)setupWithSample:(struct opaqueCMSampleBuffer *)arg1 andSampleBatchSize:(int)arg2;	// IMP=0x00000000000f031d
- (id)init;	// IMP=0x00000000000f0278
