...
+ (id)resultFromLegacyDictionary:(id)arg1;	// IMP=0x00100000000f1dfb
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000bbdfd
- (unsigned long long)hash;	// IMP=0x00000000000bbd87
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000bbc9f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000bbbfc
- (void)copyTo:(id)arg1;	// IMP=0x00000000000bbb7c
- (void)writeTo:(id)arg1;	// IMP=0x00000000000bbad5
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000bbac8
- (id)dictionaryRepresentation;	// IMP=0x00000000000bb594
- (id)description;	// IMP=0x00000000000bb4e5
@property(nonatomic) _Bool hasLoopStart;
@property(nonatomic) _Bool hasLoopPeriod;
@property(nonatomic) _Bool hasLoopFadeLen;
- (id)exportToLegacyDictionary;	// IMP=0x00000000000f201a
