...
+ (_Bool)isLivePhotoKeyFrameEnabled;	// IMP=0x00600000000aa793
- (void).cxx_destruct;	// IMP=0x00000000000aca8b
...
- (void)printStats;	// IMP=0x00000000000ac72e
- (_Bool)hasGoodSubjectAction;	// IMP=0x00000000000ac709
- (float)computeScoreFromExposure;	// IMP=0x00000000000ac6d6
- (float)computeScoreFromColorfulness;	// IMP=0x00000000000ac6ac
- (float)computeExpressionScore;	// IMP=0x00000000000ac397
- (float)computeScoreFromAction;	// IMP=0x00000000000ac350
- (void)computeCurationScore;	// IMP=0x00000000000ac2bf
- (void)computeCurationScoreComponents;	// IMP=0x00000000000ac235
- (void)storeFrameResults;	// IMP=0x00000000000ab942
- (float)computePenaltyScore;	// IMP=0x00000000000ab592
- (float)computeContentScore;	// IMP=0x00000000000ab528
- (float)computeVisualPleasingScore;	// IMP=0x00000000000ab4be
- (float)computeGlobalQuality;	// IMP=0x00000000000ab447
- (void)computeGlobalQualityForLivePhoto;	// IMP=0x00000000000ab3f9
- (void)setMotionStatsFlag:(_Bool)arg1 cameraMotion:(float)arg2 subjectAction:(float)arg3 interestingness:(float)arg4 obstruction:(float)arg5 colorfulness:(float)arg6 exposureScore:(float)arg7 humanActionStatsFlag:(_Bool)arg8 humanPoseScore:(float)arg9 humanActionScore:(float)arg10 subMb:(_Bool)arg11;	// IMP=0x00000000000ab398
- (void)setFaceStatsFlag:(_Bool)arg1 detectedFaces:(id)arg2;	// IMP=0x00000000000ab1f3
- (void)resetStatsFlag;	// IMP=0x00000000000ab1e5
- (int)loadKeyFrameResult:(id)arg1 timestamp:(CDStruct_1b6d18a9)arg2;	// IMP=0x00000000000aa97e
- (void)copyFrom:(id)arg1;	// IMP=0x00000000000aa79b
- (id)initWithLivePhoto:(_Bool)arg1;	// IMP=0x00000000000aa636
