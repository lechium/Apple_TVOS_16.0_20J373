...
+ (unsigned long long)flagsFromKeypoints:(id)arg1 withMinConfidence:(float)arg2;	// IMP=0x00600000000f800d
- (void).cxx_destruct;	// IMP=0x00000000000f82c3
...
- (id)init;	// IMP=0x00000000000f7fa0
