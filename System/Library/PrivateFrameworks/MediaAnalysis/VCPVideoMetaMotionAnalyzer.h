...
- (id).cxx_construct;	// IMP=0x0000000000074fb2
- (void).cxx_destruct;	// IMP=0x0000000000074f76
@property(readonly, retain, nonatomic) NSArray *results;
- (int)finalizeAnalysis;	// IMP=0x0000000000074b07
- (void)mergeSimilarSegments;	// IMP=0x0000000000074991
- (int)processFrameMetadata:(id)arg1;	// IMP=0x00000000000746fc
- (_Bool)decideSegmentPointBasedOn:(float)arg1;	// IMP=0x0000000000074666
- (id)init;	// IMP=0x000000000007452f
