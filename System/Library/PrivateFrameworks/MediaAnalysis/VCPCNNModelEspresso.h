...
- (id).cxx_construct;	// IMP=0x0000000000076ac8
- (void).cxx_destruct;	// IMP=0x0000000000076a5b
...
- (void)dealloc;	// IMP=0x00000000000768e7
- (int)getPlanPhase;	// IMP=0x00000000000768d9
- (void *)getEspressoContext;	// IMP=0x00000000000768c3
- (int)softmax;	// IMP=0x0000000000076804
- (void)normalization:(float *)arg1;	// IMP=0x00000000000765ea
- (int)espressoForwardInputs:(vector_aebc2d99)arg1;	// IMP=0x000000000007656f
- (int)espressoForward:(float *)arg1;	// IMP=0x000000000007653f
- (int)prepareModelInputs:(vector_aebc2d99)arg1;	// IMP=0x000000000007648e
- (int)prepareModelInput:(float *)arg1;	// IMP=0x0000000000076438
- (int)prepareModelWithConfig:(id)arg1;	// IMP=0x000000000007605c
- (id)initWithParameters:(id)arg1 inputNames:(id)arg2 outputNames:(id)arg3 properties:(id)arg4;	// IMP=0x0000000000075bb0
