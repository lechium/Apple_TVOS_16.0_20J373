...
- (void).cxx_destruct;	// IMP=0x0000000000003c72
...
- (id)debugDescriptionWithWhitespacePrefix:(id)arg1;	// IMP=0x00000000000038bf
- (id)debugDescription;	// IMP=0x00000000000038a6
- (id)initWithEntryLevel:(unsigned long long)arg1;	// IMP=0x0000000000003845
