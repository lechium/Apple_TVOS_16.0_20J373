...
- (void).cxx_destruct;	// IMP=0x00000000001880ec
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000018802c
- (id)initWithMainMenuItems:(id)arg1 genreMenuItems:(id)arg2;	// IMP=0x0000000000187f93
