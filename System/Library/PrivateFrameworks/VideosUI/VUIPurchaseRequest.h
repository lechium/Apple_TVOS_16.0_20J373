...
+ (_Bool)shouldPlayWhenDoneForActionRef:(id)arg1;	// IMP=0x0060000000052e78
+ (long long)getPurchaseTypeFromActionRef:(id)arg1;	// IMP=0x0060000000052cd6
- (void).cxx_destruct;	// IMP=0x000000000005336c
...
- (void)_recordErrorLog:(id)arg1;	// IMP=0x0000000000052f8e
- (void)handleRequestCompletionWithResult:(id)arg1 andError:(id)arg2;	// IMP=0x0000000000052a8f
- (void)enqueueWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000005295a
- (id)initWithBuyParams:(id)arg1 ofPurchaseType:(long long)arg2;	// IMP=0x0000000000052725
