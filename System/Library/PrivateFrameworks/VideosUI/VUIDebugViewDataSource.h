...
- (void).cxx_destruct;	// IMP=0x00000000000ae0cb
...
- (id)_createMetricsDataSource;	// IMP=0x00000000000addcc
- (id)_createDefaultsDataSource;	// IMP=0x00000000000ada4f
- (id)init;	// IMP=0x00000000000ad9bd
