...
- (void).cxx_destruct;	// IMP=0x00000000000c23e7
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000c208c
@property(readonly) unsigned long long hash;
@property(readonly, copy, nonatomic) NSString *imageIdentifier; // @synthesize imageIdentifier=_imageIdentifier;
- (id)init;	// IMP=0x00000000000c1ece
- (id)initWithMediaItem:(id)arg1 andImageType:(unsigned long long)arg2;	// IMP=0x00000000000c1e21
