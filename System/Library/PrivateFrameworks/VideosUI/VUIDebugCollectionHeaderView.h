...
- (void).cxx_destruct;	// IMP=0x0000000000021fc8
...
- (void)layoutSubviews;	// IMP=0x0000000000021d58
- (void)configureHeaderViewWithTitle:(id)arg1;	// IMP=0x0000000000021d1d
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000021b2c
