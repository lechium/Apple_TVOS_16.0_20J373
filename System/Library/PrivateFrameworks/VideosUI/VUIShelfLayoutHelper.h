...
- (void).cxx_destruct;	// IMP=0x000000000005a8d5
...
- (void)_freeBuffers;	// IMP=0x000000000005a821
- (void)_compute;	// IMP=0x0000000000059c25
- (struct CGRect)frameForItemAtIndexPath:(id)arg1;	// IMP=0x0000000000059b87
- (struct UIEdgeInsets)insetForSection:(long long)arg1;	// IMP=0x0000000000059b4c
- (struct CGRect)frameForHeaderInSection:(long long)arg1;	// IMP=0x0000000000059b11
- (void)dealloc;	// IMP=0x0000000000059ad3
- (id)initWithShelfViewLayout:(id)arg1;	// IMP=0x0000000000059a5f
