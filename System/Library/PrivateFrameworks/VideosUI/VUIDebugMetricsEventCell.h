...
- (void).cxx_destruct;	// IMP=0x000000000001910c
...
- (void)prepareForReuse;	// IMP=0x0000000000018e51
- (void)layoutSubviews;	// IMP=0x00000000000186fd
@property(copy, nonatomic) UIImage *tabImage;
- (void)setSubhead3LabelColor:(id)arg1;	// IMP=0x000000000001863e
- (void)setSubhead2LabelColor:(id)arg1;	// IMP=0x0000000000018621
- (void)setSubhead1LabelColor:(id)arg1;	// IMP=0x0000000000018604
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x0000000000017d17
