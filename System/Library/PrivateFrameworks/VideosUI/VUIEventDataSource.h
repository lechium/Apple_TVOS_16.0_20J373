...
+ (id)_actionForKey:(id)arg1 eventDict:(id)arg2 appContext:(id)arg3;	// IMP=0x0060000000227cc0
+ (id)_documentDataSourceWithDict:(id)arg1;	// IMP=0x0060000000227ca7
+ (id)attachPrefetchedDict:(id)arg1 eventDict:(id)arg2;	// IMP=0x0060000000227bb0
+ (id)eventDataSourceWithEventDict:(id)arg1 appContext:(id)arg2;	// IMP=0x00600000002278f3
+ (id)selectEventDataSourceWithLibraryMediaEntity:(id)arg1;	// IMP=0x0060000000227ed7
- (void).cxx_destruct;	// IMP=0x0000000000227e0d
...
- (id)_initWithLibraryMediaEntity:(id)arg1;	// IMP=0x0000000000227e6c
