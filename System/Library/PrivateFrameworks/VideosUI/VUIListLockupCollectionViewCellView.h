...
- (void)vui_prepareForReuse;	// IMP=0x000000000004cf0b
- (struct CGSize)vui_layoutSubviews:(struct CGSize)arg1 computationOnly:(_Bool)arg2;	// IMP=0x000000000004bbce
- (void)vui_setHighlighted:(_Bool)arg1;	// IMP=0x000000000004bb6c
- (void)setHighlighted:(_Bool)arg1;	// IMP=0x000000000004bb21
- (void)setSemanticContentAttribute:(long long)arg1;	// IMP=0x000000000004ba9b
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000004b714
