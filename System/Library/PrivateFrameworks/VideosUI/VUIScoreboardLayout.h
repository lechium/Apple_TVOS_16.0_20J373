...
+ (int)_textBlendMode;	// IMP=0x00600000001764a4
+ (id)_textColor:(long long)arg1;	// IMP=0x0060000000176445
+ (id)scoreboardCLayoutWithInnerMargin:(double)arg1;	// IMP=0x0060000000176242
+ (id)scoreboardBLayout;	// IMP=0x0060000000176012
+ (id)scoreboardALayout;	// IMP=0x0060000000175dd4
