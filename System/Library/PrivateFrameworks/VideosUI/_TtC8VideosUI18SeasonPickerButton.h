...
- (void).cxx_destruct;	// IMP=0x00000000003debb0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000003deb50
...
- (struct CGSize)vui_layoutSubviews:(struct CGSize)arg1 computationOnly:(_Bool)arg2;	// IMP=0x00000000003dea70
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000003de250
- (id)init;	// IMP=0x00000000003de230
