...
- (void).cxx_destruct;	// IMP=0x0000000000190bdc
...
- (id)initWithPosition:(unsigned long long)arg1 duration:(unsigned long long)arg2 eventData:(id)arg3;	// IMP=0x00000000001909d2
