...
+ (id)keyPathsForValuesAffectingExpirationDate;	// IMP=0x00800000000b3d9c
+ (id)keyPathsForValuesAffectingLocalPlaybackURL;	// IMP=0x00800000000b3d7c
+ (id)fetchRequest;	// IMP=0x00800000000b9801
