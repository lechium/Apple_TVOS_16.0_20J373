...
- (void).cxx_destruct;	// IMP=0x00000000003c2120
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000003c20c0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000003c1fe0
...
- (void)vui_prepareForReuse;	// IMP=0x00000000003c1d70
- (struct CGSize)vui_layoutSubviews:(struct CGSize)arg1 computationOnly:(_Bool)arg2;	// IMP=0x00000000003c1c10
