...
- (void).cxx_destruct;	// IMP=0x00000000001c05c2
...
- (void)_notifyClientOfProgress:(float)arg1;	// IMP=0x00000000001c03bf
- (void)_stopProgressTimer;	// IMP=0x00000000001c036c
- (void)_startProgressTimer;	// IMP=0x00000000001c0218
- (void)executionDidBegin;	// IMP=0x00000000001bfee9
- (id)initWithMediaLibrary:(id)arg1;	// IMP=0x00000000001bfe44
- (id)init;	// IMP=0x00000000001bfdd5
