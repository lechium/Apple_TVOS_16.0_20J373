...
+ (id)sharedInstance;	// IMP=0x006000000008a9b4
- (void).cxx_destruct;	// IMP=0x000000000008b333
...
- (void)sendRequestForItemID:(id)arg1 itemType:(id)arg2 channelID:(id)arg3 adamID:(id)arg4;	// IMP=0x000000000008aac0
- (id)init;	// IMP=0x000000000008aa7f
- (id)_init;	// IMP=0x000000000008aa19
