...
- (void).cxx_destruct;	// IMP=0x00000000000526f2
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000524c0
- (id)sortingPropertyDescriptorForName:(id)arg1;	// IMP=0x00000000000523fa
- (id)propertyDescriptorForName:(id)arg1;	// IMP=0x0000000000052377
- (id)initWithMediaEntityClassName:(id)arg1;	// IMP=0x00000000000520d5
- (id)init;	// IMP=0x0000000000052066
