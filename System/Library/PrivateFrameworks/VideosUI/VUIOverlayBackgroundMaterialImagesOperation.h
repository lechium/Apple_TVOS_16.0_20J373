...
- (id)_blurredMaterialImageWithSourceBackgroundImage:(id)arg1 forRect:(struct CGRect)arg2 croppedRect:(struct CGRect)arg3;	// IMP=0x00000000001437fe
- (void)main;	// IMP=0x0000000000143385
- (id)init;	// IMP=0x0000000000143316
- (id)initWithSourceBackgroundImage:(id)arg1;	// IMP=0x00000000001432a8
