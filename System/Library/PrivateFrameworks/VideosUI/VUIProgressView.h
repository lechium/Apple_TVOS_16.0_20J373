...
- (void).cxx_destruct;	// IMP=0x00000000001bf50a
...
- (void)_updateForStyleChange;	// IMP=0x00000000001bf27d
- (id)_maskImageForProgressBar;	// IMP=0x00000000001bf0ab
- (void)_layoutMaterialView;	// IMP=0x00000000001bef9a
- (void)setSelected:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x00000000001beaed
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000001be7a1
- (void)layoutSubviews;	// IMP=0x00000000001be46f
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000001be19a
