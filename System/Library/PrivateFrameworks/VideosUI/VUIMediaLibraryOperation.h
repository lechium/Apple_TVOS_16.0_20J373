...
- (void).cxx_destruct;	// IMP=0x00000000000c510e
...
- (void)cancel;	// IMP=0x00000000000c5024
- (id)initWithMediaLibrary:(id)arg1;	// IMP=0x00000000000c4f7f
- (id)init;	// IMP=0x00000000000c4f10
