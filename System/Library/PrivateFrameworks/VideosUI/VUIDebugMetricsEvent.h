...
- (void).cxx_destruct;	// IMP=0x00000000001950d0
...
- (id)objectForKeyedSubscript:(id)arg1;	// IMP=0x0000000000194e8f
...
- (id)_sortKeys:(id)arg1;	// IMP=0x0000000000194bd8
- (id)initWithEventDictionary:(id)arg1 termCollater:(id)arg2;	// IMP=0x0000000000193ef9
