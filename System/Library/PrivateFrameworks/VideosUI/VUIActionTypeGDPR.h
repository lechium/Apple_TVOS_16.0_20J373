...
- (void).cxx_destruct;	// IMP=0x000000000008bafa
...
- (void)performWithTargetResponder:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000008b3e5
- (id)initWithContextData:(id)arg1 appContext:(id)arg2;	// IMP=0x000000000008b343
