...
- (void).cxx_destruct;	// IMP=0x00000000001bfd82
...
- (void)setgradientEndColor:(id)arg1;	// IMP=0x00000000001bfb60
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x00000000001bf5f2
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000001bf590
