...
- (void).cxx_destruct;	// IMP=0x000000000008c5de
...
- (id)_logNameForContentViewType:(unsigned long long)arg1;	// IMP=0x000000000008c4da
- (id)_createAlertViewWithTitle:(id)arg1 description:(id)arg2;	// IMP=0x000000000008c34f
- (void)configureCurrentViewFrameForBounds:(struct CGRect)arg1;	// IMP=0x000000000008bdf0
- (void)setRootViewForViewController:(id)arg1;	// IMP=0x000000000008bd90
