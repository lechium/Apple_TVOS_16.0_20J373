...
+ (id)_changeSetFromMediaItemEntityTypes:(id)arg1 toMediaItemEntityTypes:(id)arg2;	// IMP=0x00600000000ded8e
- (void).cxx_destruct;	// IMP=0x00000000000deea6
...
- (void)executionDidBegin;	// IMP=0x00000000000de9a8
- (id)initWithMediaLibrary:(id)arg1 fetchReason:(long long)arg2;	// IMP=0x00000000000de964
- (id)initWithMediaLibrary:(id)arg1;	// IMP=0x00000000000de8f5
