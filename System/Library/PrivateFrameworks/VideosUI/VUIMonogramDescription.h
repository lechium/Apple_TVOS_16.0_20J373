...
- (void).cxx_destruct;	// IMP=0x0000000000068b8e
...
- (unsigned long long)preferedMonogramType;	// IMP=0x0000000000068780
- (unsigned long long)hash;	// IMP=0x0000000000068636
- (struct CGPoint)specialOffsetForString:(id)arg1;	// IMP=0x0000000000068539
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000006774e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000673ac
- (id)copyWithType:(unsigned long long)arg1;	// IMP=0x0000000000067300
- (id)init;	// IMP=0x00000000000672e4
- (id)initWithFirstName:(id)arg1 lastName:(id)arg2 imageURL:(id)arg3 font:(id)arg4;	// IMP=0x000000000006716f
