...
- (void).cxx_destruct;	// IMP=0x0000000000107cb8
...
- (void)performWithTargetResponder:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000107b67
- (id)initWithContextData:(id)arg1 appContext:(id)arg2;	// IMP=0x0000000000107ab3
