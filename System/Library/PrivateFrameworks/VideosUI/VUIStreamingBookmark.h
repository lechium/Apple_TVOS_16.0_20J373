...
- (void).cxx_destruct;	// IMP=0x00000000000732c8
...
- (id)initWithAbsoluteResumeTime:(id)arg1 absoluteTimestamp:(id)arg2 relativeResumeTime:(id)arg3 relativeBookmarkTimestamp:(id)arg4;	// IMP=0x000000000007310d
