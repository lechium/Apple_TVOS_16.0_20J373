...
- (id)init;	// IMP=0x00000000005fe550
- (id)copyWithZone:(void *)arg1;	// IMP=0x00000000005fe520
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000005fe480
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000005fe3e0
