...
- (void).cxx_destruct;	// IMP=0x000000000018c366
...
- (id)initWithParams:(id)arg1 scaleToSize:(struct CGSize)arg2 cropToFit:(_Bool)arg3;	// IMP=0x000000000018c194
- (id)init;	// IMP=0x000000000018c125
