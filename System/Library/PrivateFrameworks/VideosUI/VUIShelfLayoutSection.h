...
- (struct CGRect)lastItemFrame;	// IMP=0x0000000000056b3d
- (struct CGRect)firstItemFrame;	// IMP=0x0000000000056b12
- (void)setItemFrame:(struct CGRect)arg1 atIndex:(long long)arg2;	// IMP=0x0000000000056af3
- (struct CGRect)itemFrameAtIndex:(long long)arg1;	// IMP=0x0000000000056ad2
- (void)dealloc;	// IMP=0x0000000000056a48
