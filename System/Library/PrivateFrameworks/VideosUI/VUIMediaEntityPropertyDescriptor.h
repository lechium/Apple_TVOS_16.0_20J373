...
+ (id)_classNameFromPropertyType:(unsigned long long)arg1;	// IMP=0x001000000017bd62
- (void).cxx_destruct;	// IMP=0x000000000017bf64
...
- (void)_updateSourceSupportsFiltering;	// IMP=0x000000000017be24
- (id)description;	// IMP=0x000000000017b73e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000017b64f
- (id)init;	// IMP=0x000000000017b30c
