...
+ (id)getMobileGestaltString:(struct __CFString *)arg1;	// IMP=0x00100000001a5520
- (void).cxx_destruct;	// IMP=0x00000000001a559c
...
- (void)dealloc;	// IMP=0x00000000001a523d
- (id)initWithAppContext:(id)arg1;	// IMP=0x00000000001a4ed8
