...
- (void).cxx_destruct;	// IMP=0x0000000000051fbe
...
- (void)setSelected:(_Bool)arg1 animated:(_Bool)arg2 withAnimationCoordinator:(id)arg3;	// IMP=0x0000000000051d92
- (struct CGSize)computeSizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000051d0d
- (void)layoutOfferSubviewsWithSize:(struct CGSize)arg1;	// IMP=0x00000000000510a9
- (struct CGSize)vui_layoutSubviews:(struct CGSize)arg1 computationOnly:(_Bool)arg2;	// IMP=0x0000000000051073
- (double)_chinHeightForSize:(struct CGSize)arg1;	// IMP=0x0000000000050a9f
- (void)setSemanticContentAttribute:(long long)arg1;	// IMP=0x00000000000509f1
- (void)prepareForCellReuse;	// IMP=0x00000000000504c2
