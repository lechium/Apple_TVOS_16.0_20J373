...
- (void).cxx_destruct;	// IMP=0x0000000000191fc5
...
- (id)itemsBetweenStartOverallPosition:(unsigned long long)arg1 endOverallPosition:(unsigned long long)arg2;	// IMP=0x0000000000191d5c
- (id)itemAtOverallPosition:(unsigned long long)arg1 rangeOptions:(long long)arg2;	// IMP=0x0000000000191b83
- (id)initWithPlayer:(id)arg1;	// IMP=0x0000000000190bec
