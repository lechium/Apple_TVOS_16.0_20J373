...
- (void).cxx_destruct;	// IMP=0x000000000068def0
@property(nonatomic, readonly) double accessibilityProgress;
- (struct CGSize)vui_layoutSubviews:(struct CGSize)arg1 computationOnly:(_Bool)arg2;	// IMP=0x000000000068cb90
- (void)vui_setSelected:(_Bool)arg1 animated:(_Bool)arg2 withAnimationCoordinator:(id)arg3;	// IMP=0x000000000068c930
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000068c8e0
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000068c8b0
