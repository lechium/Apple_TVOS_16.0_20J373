...
- (void).cxx_destruct;	// IMP=0x00000000002f8c00
@property(nonatomic, readonly) VUILabel *accessibilityTitleLabel;
- (struct CGSize)vui_layoutSubviews:(struct CGSize)arg1 computationOnly:(_Bool)arg2;	// IMP=0x00000000002f8b20
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000002f77e0
@property(nonatomic, readonly) _Bool vuiDebugUI;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000002f77a0
