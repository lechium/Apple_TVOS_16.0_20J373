...
+ (id)sharedInstance;	// IMP=0x00600000000489bf
- (void).cxx_destruct;	// IMP=0x0000000000048fc5
...
- (void)sendRequestForDeleteID:(id)arg1 isContinueWatching:(_Bool)arg2;	// IMP=0x0000000000048acb
- (id)init;	// IMP=0x0000000000048a8a
- (id)_init;	// IMP=0x0000000000048a24
