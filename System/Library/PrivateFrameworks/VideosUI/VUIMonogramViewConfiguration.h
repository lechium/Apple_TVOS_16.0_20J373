...
- (void).cxx_destruct;	// IMP=0x000000000010b387
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000010b055
- (id)initWithShadowImages:(_Bool)arg1;	// IMP=0x000000000010af1e
- (id)initWithStyle:(long long)arg1;	// IMP=0x000000000010abd6
