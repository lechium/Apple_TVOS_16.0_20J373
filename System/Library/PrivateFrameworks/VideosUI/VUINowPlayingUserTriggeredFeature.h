...
- (void).cxx_destruct;	// IMP=0x000000000002404a
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000023f73
@property(readonly) unsigned long long hash;
@property(readonly, copy) NSString *description;
- (id)initWithType:(unsigned long long)arg1;	// IMP=0x0000000000023e10
- (id)init;	// IMP=0x0000000000023df7
