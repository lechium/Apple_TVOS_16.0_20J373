...
- (void).cxx_destruct;	// IMP=0x000000000015088f
...
- (id)_textColorForDarkMode;	// IMP=0x000000000015075d
- (void)_configureLabels;	// IMP=0x00000000001503c0
- (void)_configureAgeRatingBadge;	// IMP=0x000000000015020f
- (_Bool)canBecomeFocused;	// IMP=0x00000000001501ea
@property(readonly, nonatomic) VUIAppInstallView *installView;
- (void)_layoutForIos;	// IMP=0x000000000014f9c0
- (void)_layoutForTvos;	// IMP=0x000000000014f472
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000014f1fd
