...
- (void).cxx_destruct;	// IMP=0x000000000013c3d5
...
- (void)performWithTargetResponder:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000013c272
- (id)initWithContextData:(id)arg1;	// IMP=0x000000000013c17a
