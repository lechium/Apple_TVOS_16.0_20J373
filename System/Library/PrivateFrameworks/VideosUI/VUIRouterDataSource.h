...
- (void).cxx_destruct;	// IMP=0x000000000006a777
...
- (id)initWithRouterData:(id)arg1 prefetchedData:(id)arg2;	// IMP=0x000000000006a602
- (id)initWithRouterData:(id)arg1 appContext:(id)arg2;	// IMP=0x000000000006a431
- (id)initWithLibraryMediaEntity:(id)arg1;	// IMP=0x000000000006a7aa
