...
+ (id)sharedInstance;	// IMP=0x0010000000113972
- (void).cxx_destruct;	// IMP=0x0000000000113e24
...
- (void)environmentMonitorDidChangeNetworkReachability:(id)arg1;	// IMP=0x0000000000113df7
- (void)environmentMonitorDidChangeNetworkType:(id)arg1;	// IMP=0x0000000000113de5
- (void)_notifyObservers;	// IMP=0x0000000000113c78
- (void)airplaneModeChanged;	// IMP=0x0000000000113c66
...
- (void)dealloc;	// IMP=0x0000000000113aba
- (id)init;	// IMP=0x00000000001139c7
