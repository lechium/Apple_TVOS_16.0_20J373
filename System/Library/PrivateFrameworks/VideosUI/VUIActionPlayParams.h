...
+ (id)playParamsWithMediaInfo:(id)arg1 watchType:(long long)arg2 isRentAndWatchNow:(_Bool)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x006000000011da15
- (void).cxx_destruct;	// IMP=0x000000000011db27
