...
- (void).cxx_destruct;	// IMP=0x00000000001bbb84
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001bb6e3
@property(readonly) unsigned long long hash;
@property(readonly, copy, nonatomic) NSString *imageIdentifier; // @synthesize imageIdentifier=_imageIdentifier;
- (id)init;	// IMP=0x00000000001bb50d
- (id)initWithImageURL:(id)arg1 baseImageIdentifier:(id)arg2 imageType:(unsigned long long)arg3;	// IMP=0x00000000001bb3e8
