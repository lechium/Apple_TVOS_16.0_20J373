...
- (void).cxx_destruct;	// IMP=0x00000000000a565d
...
- (struct CGSize)_calculateMetricsOfScorecard;	// IMP=0x00000000000a47ad
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x00000000000a3f04
- (void)_calculateColumnSpacing;	// IMP=0x00000000000a3c59
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000000a3c1a
- (void)invalidateData;	// IMP=0x00000000000a3bb2
