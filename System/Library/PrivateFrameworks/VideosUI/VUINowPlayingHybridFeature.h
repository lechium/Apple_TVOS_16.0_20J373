...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000245d7
@property(readonly) unsigned long long hash;
@property(readonly, copy) NSString *description;
- (id)initWithType:(unsigned long long)arg1 startTime:(double)arg2 duration:(double)arg3;	// IMP=0x0000000000024406
- (id)init;	// IMP=0x00000000000243e2
