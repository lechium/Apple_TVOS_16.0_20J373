...
- (void).cxx_destruct;	// IMP=0x000000000004dd19
...
- (id)description;	// IMP=0x000000000004d606
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000004d32c
- (unsigned long long)hash;	// IMP=0x000000000004d1e5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000004d16b
@property(readonly, nonatomic, getter=isDownloadInProgress) _Bool downloadInProgress;
- (id)init;	// IMP=0x000000000004d104
