...
- (void).cxx_destruct;	// IMP=0x00000000001dc86a
...
- (id)description;	// IMP=0x00000000001dc69e
- (id)initWithMediaItemEntityTypesChangeSet:(id)arg1 localMediaItemsAvailableDidChange:(_Bool)arg2;	// IMP=0x00000000001dc628
- (id)init;	// IMP=0x00000000001dc5b9
