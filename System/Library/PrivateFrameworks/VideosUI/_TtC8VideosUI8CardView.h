...
- (void).cxx_destruct;	// IMP=0x0000000000395fa0
...
- (struct CGSize)vui_layoutSubviews:(struct CGSize)arg1 computationOnly:(_Bool)arg2;	// IMP=0x0000000000399550
@property(nonatomic, readonly) _Bool vuiDebugUI;
- (void)dealloc;	// IMP=0x0000000000395f00
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000395e30
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000395e00
