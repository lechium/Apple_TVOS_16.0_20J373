...
- (void).cxx_destruct;	// IMP=0x000000000019fcbc
...
- (void)executionDidBegin;	// IMP=0x000000000019f8ec
- (id)initWithDatabase:(id)arg1;	// IMP=0x000000000019f847
- (id)init;	// IMP=0x000000000019f7d8
