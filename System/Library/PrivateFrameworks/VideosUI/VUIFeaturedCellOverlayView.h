...
- (void).cxx_destruct;	// IMP=0x00000000001d5807
...
- (void)_layoutSubviews;	// IMP=0x00000000001d421e
- (struct CGSize)vui_layoutSubviews:(struct CGSize)arg1 computationOnly:(_Bool)arg2;	// IMP=0x00000000001d41bf
- (void)applyAlphaToFadeableView:(double)arg1;	// IMP=0x00000000001d3f77
