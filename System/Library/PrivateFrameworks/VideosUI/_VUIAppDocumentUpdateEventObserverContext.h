...
- (void).cxx_destruct;	// IMP=0x00000000000e4e47
...
- (void)_cancelAllRefreshTimers;	// IMP=0x00000000000e4d67
- (void)_cancelRefreshTimers:(id)arg1;	// IMP=0x00000000000e4c3d
- (void)_cancelRefreshTimer:(id)arg1;	// IMP=0x00000000000e4c29
- (void)_startRefreshTimer:(id)arg1;	// IMP=0x00000000000e4c15
- (id)_refreshTimerWithRefreshTimeEventDescriptor:(id)arg1;	// IMP=0x00000000000e4a27
- (void)updateDescriptorsWithDescriptors:(id)arg1;	// IMP=0x00000000000e46e8
- (void)invalidate;	// IMP=0x00000000000e4399
- (void)dealloc;	// IMP=0x00000000000e435b
