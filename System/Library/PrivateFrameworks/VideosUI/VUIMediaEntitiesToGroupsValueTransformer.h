...
+ (_Bool)allowsReverseTransformation;	// IMP=0x006000000019e424
+ (Class)transformedValueClass;	// IMP=0x006000000019e413
- (void).cxx_destruct;	// IMP=0x000000000019ec5b
...
- (id)transformedValue:(id)arg1;	// IMP=0x000000000019e42c
- (id)initWithIdentifierKeyPath:(id)arg1;	// IMP=0x000000000019e362
- (id)init;	// IMP=0x000000000019e2f3
