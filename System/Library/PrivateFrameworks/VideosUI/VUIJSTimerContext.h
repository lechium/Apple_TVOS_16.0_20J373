...
- (void).cxx_destruct;	// IMP=0x000000000009fe68
...
- (void)dealloc;	// IMP=0x000000000009fdf7
- (void)removeManagedReferences;	// IMP=0x000000000009fcc4
- (id)description;	// IMP=0x000000000009fc42
- (id)initWithCallback:(id)arg1 callbackArgs:(id)arg2 repeating:(_Bool)arg3 ownerObject:(id)arg4 timer:(id)arg5;	// IMP=0x000000000009fa92
