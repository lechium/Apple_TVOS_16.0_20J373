...
+ (_Bool)_viewBackgroundImageNeedsUpdatingWithFrame:(struct CGRect)arg1 currentBackgroundImage:(id)arg2;	// IMP=0x006000000015e742
- (void).cxx_destruct;	// IMP=0x000000000015eafa
...
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000000015e7e0
- (_Bool)_textBadgeBackgroundImageNeedsUpdating;	// IMP=0x000000000015e68e
- (void)_cancelPendingOperation;	// IMP=0x000000000015e534
- (void)_redrawView:(id)arg1 withDuration:(double)arg2;	// IMP=0x000000000015e43b
- (void)_redrawTextBadgeWithDuration:(double)arg1;	// IMP=0x000000000015e426
- (void)_updateBackgroundImagesWithCompletedOperation:(id)arg1;	// IMP=0x000000000015e30e
- (void)_updateBackgroundMaterialImagesWithBackgroundImageSize:(struct CGSize)arg1 performSynchronously:(_Bool)arg2 overlayViewFrame:(struct CGRect)arg3;	// IMP=0x000000000015de96
- (void)setBackgroundImageForMaterialRendering:(id)arg1 imageSize:(struct CGSize)arg2 overlayViewFrame:(struct CGRect)arg3;	// IMP=0x000000000015ddff
- (void)setBackgroundImageForMaterialRendering:(id)arg1 imageSize:(struct CGSize)arg2 overlayViewFrame:(struct CGRect)arg3 operationQueue:(id)arg4;	// IMP=0x000000000015dd38
- (void)_setBackgroundImageForMaterialRendering:(id)arg1;	// IMP=0x000000000015dcf6
- (void)_imageLoaded;	// IMP=0x000000000015dcc8
- (struct CGSize)_textSize;	// IMP=0x000000000015db1b
- (void)_invalidateTimer;	// IMP=0x000000000015dae3
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x000000000015d387
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000015d261
- (struct CGSize)vui_layoutSubviews:(struct CGSize)arg1 computationOnly:(_Bool)arg2;	// IMP=0x000000000015d238
- (void)dealloc;	// IMP=0x000000000015d157
- (void)reset;	// IMP=0x000000000015d068
- (void)rentalExpirationLabelNeedsRelayout:(id)arg1;	// IMP=0x000000000015cfe6
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000015cba5
