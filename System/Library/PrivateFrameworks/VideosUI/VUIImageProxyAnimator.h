...
- (void).cxx_destruct;	// IMP=0x00000000000670a3
...
- (void)_displayIntervalTimerFired:(id)arg1;	// IMP=0x0000000000066eea
- (void)_fetchNext;	// IMP=0x0000000000066b32
- (void)_updateImageWithIndex:(unsigned long long)arg1;	// IMP=0x000000000006661b
- (void)loadImageProxy:(id)arg1 withWeakObject:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000000663d9
- (void)_setImage:(id)arg1 animated:(_Bool)arg2;	// IMP=0x0000000000066220
- (void)stopAnimation;	// IMP=0x00000000000661b7
- (void)startAnimation;	// IMP=0x00000000000660f6
- (id)initWithImageView:(id)arg1 andProxies:(id)arg2;	// IMP=0x0000000000066027
- (id)init;	// IMP=0x0000000000065fe5
