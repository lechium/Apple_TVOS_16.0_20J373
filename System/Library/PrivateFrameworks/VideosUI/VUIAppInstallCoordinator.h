...
- (void).cxx_destruct;	// IMP=0x00000000000e1c2e
...
- (void)_installAppWithChannel:(id)arg1 punchoutURL:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000000000e136f
- (void)installAppWithPunchoutURL:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000000e1291
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000e11ca
- (unsigned long long)hash;	// IMP=0x00000000000e115c
- (id)initWithChannelDetails:(id)arg1 contentTitle:(id)arg2;	// IMP=0x00000000000e10a0
