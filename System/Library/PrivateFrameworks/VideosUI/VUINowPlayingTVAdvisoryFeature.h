...
- (void).cxx_destruct;	// IMP=0x0000000000024978
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000024809
@property(readonly) unsigned long long hash;
@property(nonatomic, getter=isSkippable) _Bool skippable;
- (id)initWithType:(unsigned long long)arg1 startTime:(double)arg2 duration:(double)arg3;	// IMP=0x0000000000024786
