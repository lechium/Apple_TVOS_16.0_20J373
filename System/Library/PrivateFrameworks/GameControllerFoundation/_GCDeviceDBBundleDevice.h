...
- (void).cxx_destruct;	// IMP=0x000000000002d7cf
...
- (id)personalities;	// IMP=0x000000000002d737
- (id)init;	// IMP=0x000000000002d70c
- (id)initWithBundle:(id)arg1 dictionary:(id)arg2 error:(out id *)arg3;	// IMP=0x000000000002c61e
