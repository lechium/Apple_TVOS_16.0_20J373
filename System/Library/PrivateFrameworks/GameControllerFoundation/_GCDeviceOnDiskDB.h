...
- (void).cxx_destruct;	// IMP=0x0000000000022c2b
@property(readonly, copy) NSArray *configurationBundles; // @synthesize configurationBundles=_configurationBundles;
- (id)bestModelMatchingDevice:(id)arg1;	// IMP=0x0000000000022196
- (id)init;	// IMP=0x000000000002217d
- (id)initWithBundles:(id)arg1;	// IMP=0x0000000000021f60
