...
- (id)gc_snapshot;	// IMP=0x0020000000018588
- (id)debugDescription;	// IMP=0x002000000001ff2d
- (id)valueForKey:(id)arg1;	// IMP=0x002000000001fe0a
- (id)valueForElementKey:(id)arg1;	// IMP=0x002000000001fcdd
