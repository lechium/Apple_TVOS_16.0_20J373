...
- (void).cxx_destruct;	// IMP=0x0000000000014bfa
...
- (id)debugDescription;	// IMP=0x0000000000014aef
- (id)redactedDescription;	// IMP=0x0000000000014a5c
- (id)description;	// IMP=0x00000000000149c9
@property(readonly) NSString *identifier;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000149ac
- (id)init;	// IMP=0x0000000000014981
- (id)initWithPath:(id)arg1;	// IMP=0x000000000001496d
- (id)initWithPath:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000013a71
