...
- (void).cxx_destruct;	// IMP=0x00000000000390e7
@property(readonly, nonatomic) NSDateInterval *requestInterval; // @synthesize requestInterval=_requestInterval;
- (id)telemetryDataWithEndTime:(double)arg1;	// IMP=0x0000000000038df7
- (void)beginOperationWithIntervals:(id)arg1 shouldReset:(_Bool)arg2;	// IMP=0x0000000000037e63
...
- (void)invalidate;	// IMP=0x0000000000037c75
@property(readonly, copy) NSString *debugDescription;
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x000000000003752e
- (id)initWithRequestInterval:(id)arg1 delegate:(id)arg2 osTimerProvider:(id)arg3;	// IMP=0x0000000000037466
