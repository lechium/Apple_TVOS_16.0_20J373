...
- (void).cxx_destruct;	// IMP=0x000000000004d47c
- (void)requestDatesOperation:(id)arg1 didTimeoutPendingEnvironments:(id)arg2;	// IMP=0x000000000004d40b
- (void)requestDatesOperation:(id)arg1 environment:(id)arg2 didProvideSpecifiers:(id)arg3 forPresentationInterval:(id)arg4 isComplete:(_Bool)arg5;	// IMP=0x000000000004d17f
- (void)lock_completeAllTimelineEntries;	// IMP=0x000000000004cf93
- (void)callCompletionIfDone;	// IMP=0x000000000004cedb
- (void)calculateWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000004c9a8
