...
- (void).cxx_destruct;	// IMP=0x0000000000002bb3
...
- (id)bls_shortLoggingString;	// IMP=0x0000000000002a39
- (id)bls_loggingString;	// IMP=0x0000000000002921
@property(readonly, copy) NSString *description;
- (void)releaseSurface;	// IMP=0x0000000000002909
...
- (id)initWithPresentationTime:(unsigned long long)arg1 frameId:(unsigned long long)arg2 specifier:(id)arg3 memoryUsage:(unsigned long long)arg4;	// IMP=0x0000000000002864
