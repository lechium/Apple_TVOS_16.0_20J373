...
+ (id)activateForAttribute:(id)arg1 fromAssertion:(id)arg2 forService:(id)arg3 attributeHandler:(id)arg4;	// IMP=0x0010000000041b49
- (void).cxx_destruct;	// IMP=0x0000000000041e1e
...
- (void)invalidate;	// IMP=0x0000000000041dd6
- (_Bool)reactivateIfPossible;	// IMP=0x0000000000041dce
- (id)initForAttribute:(id)arg1 fromAssertion:(id)arg2 forService:(id)arg3;	// IMP=0x0000000000041d17
