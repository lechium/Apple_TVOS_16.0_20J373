...
+ (id)activateForAttribute:(id)arg1 fromAssertion:(id)arg2 forService:(id)arg3 attributeHandler:(id)arg4;	// IMP=0x0010000000056564
- (void).cxx_destruct;	// IMP=0x0000000000056722
...
- (void)invalidate;	// IMP=0x00000000000566da
- (_Bool)reactivateIfPossible;	// IMP=0x00000000000566d2
- (id)initForAttribute:(id)arg1 fromAssertion:(id)arg2 forService:(id)arg3;	// IMP=0x000000000005661b
