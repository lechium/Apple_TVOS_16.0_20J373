...
- (void).cxx_destruct;	// IMP=0x000000000001768f
@property(readonly, nonatomic) BLSHBacklightEnvironmentPresentation *presentation; // @synthesize presentation=_presentation;
- (id)telemetryDataWithEndTime:(double)arg1 reasonEnded:(id)arg2 preventedSleepDuration:(double)arg3;	// IMP=0x000000000001612f
- (void)prepareAndRenderFrameSpecifier:(id)arg1;	// IMP=0x0000000000015547
- (void)invalidate;	// IMP=0x000000000001536f
...
- (void)dealloc;	// IMP=0x0000000000014ced
- (id)initWithDelegate:(id)arg1 flipbook:(id)arg2 presentation:(id)arg3 osInterfaceProvider:(id)arg4;	// IMP=0x0000000000014927
