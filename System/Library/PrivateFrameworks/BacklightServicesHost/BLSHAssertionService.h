...
+ (id)serviceForService:(id)arg1 withOSTimerProvider:(id)arg2;	// IMP=0x0060000000061537
- (void).cxx_destruct;	// IMP=0x0000000000061a02
...
- (id)initWithService:(id)arg1 osTimerProvider:(id)arg2;	// IMP=0x00000000000615a3
