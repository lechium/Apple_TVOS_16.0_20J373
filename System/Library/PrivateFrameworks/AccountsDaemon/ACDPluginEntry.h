...
- (id)debugDescription;	// IMP=0x000000000006f7bc
- (id)description;	// IMP=0x000000000006f719
- (_Bool)principalObjectRespondsToSelector:(SEL)arg1;	// IMP=0x000000000006f6e4
...
- (id)initWithBundle:(id)arg1;	// IMP=0x000000000006f2cd
- (id)init;	// IMP=0x000000000006f2a2
