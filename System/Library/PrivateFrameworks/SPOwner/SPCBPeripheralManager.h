...
+ (id)remoteInterface;	// IMP=0x0010000000035ffc
- (void).cxx_destruct;	// IMP=0x0000000000036fb4
...
- (id)_enforceRateLimit;	// IMP=0x0000000000036bea
- (void)fetch;	// IMP=0x0000000000036366
- (void)timerFiredForActivity:(id)arg1;	// IMP=0x00000000000361bd
- (double)timeIntervalToNextFireDateFromDate:(id)arg1;	// IMP=0x0000000000036147
- (id)descriptionForVendorIdentifierList:(id)arg1;	// IMP=0x0000000000036068
- (void)invalidationHandler:(id)arg1;	// IMP=0x0000000000035c16
- (void)interruptionHandler:(id)arg1;	// IMP=0x0000000000035b71
- (void)successfulConnectionForPeripheral:(id)arg1 leMAC:(id)arg2 ltk:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x0000000000035590
- (void)enableSystemWakesForUpdate:(_Bool)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000000353a5
- (void)stopSessionForUserIdentifier:(id)arg1 bundleId:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0000000000034d58
- (void)startSessionForUserIdentifier:(id)arg1 bundleId:(id)arg2 vendorIdentifierList:(id)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x0000000000034799
- (id)init;	// IMP=0x0000000000034463
- (void)handleDarwinNotificationNamed:(id)arg1;	// IMP=0x00000000000343a7
