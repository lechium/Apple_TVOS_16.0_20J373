...
- (void).cxx_destruct;	// IMP=0x000000000000cff9
...
- (void)resume;	// IMP=0x000000000000ced7
- (void)pause;	// IMP=0x000000000000ce5f
- (void)stop;	// IMP=0x000000000000cdf8
- (void)start;	// IMP=0x000000000000cc7a
- (unsigned long long)powerState;	// IMP=0x000000000000cc72
- (_Bool)isNetworkUp;	// IMP=0x000000000000cc2e
- (id)initWithBeaconManager:(id)arg1 delegateQueue:(id)arg2;	// IMP=0x000000000000cb53
