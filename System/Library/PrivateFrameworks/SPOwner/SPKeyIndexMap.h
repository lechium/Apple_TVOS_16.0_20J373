...
- (void).cxx_destruct;	// IMP=0x000000000002fcf6
...
- (id)headerString;	// IMP=0x000000000002fc3b
- (id)initWithBeaconIdentifier:(id)arg1 keySequence:(unsigned char)arg2 mapHandle:(CDStruct_e66c82b6 *)arg3;	// IMP=0x000000000002fbba
- (void)dealloc;	// IMP=0x000000000002fb80
- (id)init;	// IMP=0x000000000002fb55
