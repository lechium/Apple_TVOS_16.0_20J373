...
- (void)enumerateMomentChangeRequestsForUUIDs:(id)arg1 inPhotoLibrary:(id)arg2 usingBlock:(CDUnknownBlockType)arg3;	// IMP=0x00200000003a6511
- (void)clearCurations;	// IMP=0x00200000003a64d1
