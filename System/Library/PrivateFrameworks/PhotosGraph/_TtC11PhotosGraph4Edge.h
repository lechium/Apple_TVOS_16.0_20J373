...
- (void).cxx_destruct;	// IMP=0x00000000000d4980
- (id)init;	// IMP=0x00000000000d4920
- (id)copyWithZone:(void *)arg1;	// IMP=0x00000000000d4900
- (void)resolveIdentifier:(unsigned long long)arg1;	// IMP=0x00000000000d48e0
- (id)oppositeNodeFromNode:(id)arg1;	// IMP=0x00000000000d4890
- (id)initWithIdentifier:(unsigned long long)arg1 labels:(id)arg2 properties:(id)arg3 sourceNode:(id)arg4 targetNode:(id)arg5;	// IMP=0x00000000000d4650
