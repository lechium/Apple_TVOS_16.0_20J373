...
+ (id)fetchParentDayGroupHighlightsForDayHighlights:(id)arg1;	// IMP=0x00100000003a67a8
- (unsigned short)visibilityStateForHighlightFilter:(unsigned short)arg1;	// IMP=0x0010000000293f8c
- (id)keyAssetForHighlightFilter:(unsigned short)arg1;	// IMP=0x0010000000293e4a
@property(readonly, nonatomic) NSArray *extendedCuratedAssets;
@property(readonly, nonatomic) id modelObject;
- (unsigned long long)numberOfAssetsInExtendedForSharingFilter:(unsigned short)arg1;	// IMP=0x0010000000293d1f
...
- (id)changeRequest;	// IMP=0x00100000003a64b5
- (double)nonDefaultCurationScorePercentageForPhotoLibrary:(id)arg1;	// IMP=0x00100000003a634e
- (double)sceneAnalysisProgressForPhotoLibrary:(id)arg1;	// IMP=0x00100000003a6329
- (double)faceAnalysisProgressForPhotoLibrary:(id)arg1;	// IMP=0x00100000003a630c
