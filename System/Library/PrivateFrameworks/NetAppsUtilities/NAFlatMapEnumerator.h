...
- (id)allObjects;	// IMP=0x00000000000042b6
- (id)nextObject;	// IMP=0x0000000000004213
- (id)initWithEnumerator:(id)arg1 map:(CDUnknownBlockType)arg2;	// IMP=0x000000000000415e
