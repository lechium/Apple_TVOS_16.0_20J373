...
- (void).cxx_destruct;	// IMP=0x0000000000004a7f
...
- (void)willAddCompletionBlock;	// IMP=0x000000000000479d
- (id)initWithBlock:(CDUnknownBlockType)arg1 scheduler:(id)arg2;	// IMP=0x000000000000468c
