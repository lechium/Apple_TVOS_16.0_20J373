...
- (void).cxx_destruct;	// IMP=0x00000000000183d8
...
- (void)invalidate;	// IMP=0x000000000001830a
- (void)performObserverBlock;	// IMP=0x00000000000182b1
- (id)initWithWeakObserver:(id)arg1 notificationName:(id)arg2 observerQueue:(id)arg3 observerBlock:(CDUnknownBlockType)arg4;	// IMP=0x0000000000018069
