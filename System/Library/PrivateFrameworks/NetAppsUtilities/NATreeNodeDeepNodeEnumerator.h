...
- (void).cxx_destruct;	// IMP=0x0000000000002f8e
@property(readonly, copy, nonatomic) NATreeNode *node; // @synthesize node=_node;
@property(readonly, copy, nonatomic) NSArray *allObjects;
- (id)nextObject;	// IMP=0x0000000000002cf9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000002c90
- (id)initWithNode:(id)arg1;	// IMP=0x0000000000002c16
