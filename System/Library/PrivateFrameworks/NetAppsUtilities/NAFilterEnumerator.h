...
- (void).cxx_destruct;	// IMP=0x000000000000412d
...
- (id)allObjects;	// IMP=0x0000000000004064
- (id)nextObject;	// IMP=0x0000000000003f91
- (id)initWithEnumerator:(id)arg1 filter:(CDUnknownBlockType)arg2;	// IMP=0x0000000000003edc
