...
+ (_Bool)shouldAdjustTimeoutIntervalForBeginDate;	// IMP=0x00600000000675d0
- (void).cxx_destruct;	// IMP=0x00000000000679d2
...
- (void)invalidate;	// IMP=0x00000000000678d3
- (void)triggerTimeout;	// IMP=0x0000000000067836
- (void)timerCallback;	// IMP=0x00000000000677a1
- (id)initWithHandle:(id)arg1 beginDate:(id)arg2 timeoutInterval:(double)arg3 delegate:(id)arg4;	// IMP=0x00000000000675d8
