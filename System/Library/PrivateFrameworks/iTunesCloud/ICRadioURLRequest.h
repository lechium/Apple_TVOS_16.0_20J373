...
- (void).cxx_destruct;	// IMP=0x00000000001a8162
...
- (void)_decorateHeaderPropertiesForURLRequest:(id)arg1 withBuilderProperties:(id)arg2;	// IMP=0x00000000001a7e47
- (void)buildStoreURLRequestWithURLRequest:(id)arg1 builderProperties:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000000001a7c3c
- (id)initWithURLRequest:(id)arg1 requestContext:(id)arg2;	// IMP=0x00000000001a7bf9
