...
- (void).cxx_destruct;	// IMP=0x000000000019c686
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000019c5b7
- (unsigned long long)hash;	// IMP=0x000000000019c55d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000019c552
- (id)initWithDSID:(id)arg1 carrierBundleDeviceIdentifier:(id)arg2 delegatedDSID:(id)arg3;	// IMP=0x000000000019c46c
