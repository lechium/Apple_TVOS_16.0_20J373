...
- (void).cxx_destruct;	// IMP=0x0000000000134708
- (unsigned long long)hash;	// IMP=0x000000000013385d
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000132a98
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000131f72
- (void)writeTo:(id)arg1;	// IMP=0x000000000013165c
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000012fc62
- (id)dictionaryRepresentation;	// IMP=0x000000000012ea75
- (id)description;	// IMP=0x000000000012e9c6
