...
- (void).cxx_destruct;	// IMP=0x000000000017c885
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000017c3c6
- (id)description;	// IMP=0x000000000017c21c
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000017c15b
- (unsigned long long)hash;	// IMP=0x000000000017c111
- (id)initWithTXTRecordData:(id)arg1;	// IMP=0x000000000017bd89
