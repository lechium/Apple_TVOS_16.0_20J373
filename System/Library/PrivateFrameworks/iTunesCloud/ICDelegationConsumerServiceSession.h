...
- (void).cxx_destruct;	// IMP=0x0000000000183162
...
- (void)_stop;	// IMP=0x0000000000182f8d
- (void)_handleTimeout;	// IMP=0x0000000000182eab
- (void)stop;	// IMP=0x0000000000182e60
- (void)start;	// IMP=0x0000000000182e15
- (_Bool)delegationServiceConnection:(id)arg1 didReceiveRequest:(id)arg2;	// IMP=0x0000000000182aff
- (void)delegationServiceConnection:(id)arg1 didEncouterError:(id)arg2;	// IMP=0x0000000000182a74
- (void)delegationServiceConnectionDidClose:(id)arg1;	// IMP=0x00000000001829e9
- (void)delegationConsumerNetService:(id)arg1 didAcceptConnectionWithInputStream:(id)arg2 outputStream:(id)arg3;	// IMP=0x000000000018291f
- (void)dealloc;	// IMP=0x00000000001828e1
- (id)initWithRequest:(id)arg1 responseHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000018277c
