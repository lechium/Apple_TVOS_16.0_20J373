...
- (void).cxx_destruct;	// IMP=0x00000000001acfcc
...
- (void)_addEvents:(id)arg1 toReportString:(id)arg2 eventLevel:(long long)arg3;	// IMP=0x00000000001acbb7
@property(readonly, nonatomic) NSString *formattedReport;
- (void)endEvent:(id)arg1 withError:(id)arg2;	// IMP=0x00000000001ac769
- (void)endEvent:(id)arg1;	// IMP=0x00000000001ac755
- (void)startEvent:(id)arg1 withParentEvent:(id)arg2;	// IMP=0x00000000001ac5f3
- (void)startEvent:(id)arg1;	// IMP=0x00000000001ac5df
- (id)init;	// IMP=0x00000000001ac55a
