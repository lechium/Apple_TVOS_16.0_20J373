...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000009b9b2
- (unsigned long long)hash;	// IMP=0x000000000009b9a4
- (id)initWithAccountID:(unsigned long long)arg1 fairPlaySessionID:(unsigned long long)arg2;	// IMP=0x000000000009b95c
