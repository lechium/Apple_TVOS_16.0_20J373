...
- (void).cxx_destruct;	// IMP=0x000000000012ddce
- (unsigned long long)hash;	// IMP=0x000000000012dc8e
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000012da62
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000012d8dc
- (void)writeTo:(id)arg1;	// IMP=0x000000000012d79a
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000012d78d
- (id)dictionaryRepresentation;	// IMP=0x000000000012d527
- (id)description;	// IMP=0x000000000012d478
