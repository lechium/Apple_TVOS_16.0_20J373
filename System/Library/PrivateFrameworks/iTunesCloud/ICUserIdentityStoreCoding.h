...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000c968a
- (void).cxx_destruct;	// IMP=0x00000000000c964c
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000c950f
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000c9360
- (void)lock:(CDUnknownBlockType)arg1;	// IMP=0x00000000000c92f6
- (id)initWithIdentityStoreStyle:(long long)arg1;	// IMP=0x00000000000c92a5
- (id)_initCommon;	// IMP=0x00000000000c926a
