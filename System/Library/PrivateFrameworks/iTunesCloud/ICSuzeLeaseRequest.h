...
- (void).cxx_destruct;	// IMP=0x000000000012cb8d
...
- (void)performWithResponseHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000012ca23
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000012c959
- (id)initWithRequestContext:(id)arg1 requestType:(long long)arg2 leaseID:(id)arg3 mediaType:(long long)arg4 clientData:(id)arg5;	// IMP=0x000000000012c852
