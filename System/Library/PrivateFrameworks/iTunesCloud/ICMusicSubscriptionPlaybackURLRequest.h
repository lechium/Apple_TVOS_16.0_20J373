...
- (void).cxx_destruct;	// IMP=0x000000000015a936
...
- (id)_signpostRequestInfo;	// IMP=0x000000000015a6bd
- (id)description;	// IMP=0x000000000015a5d3
- (void)_populateItemIdentifiers:(id)arg1;	// IMP=0x000000000015a3f5
- (id)_actionType;	// IMP=0x000000000015a3bf
- (void)buildStoreURLRequestWithURLRequest:(id)arg1 builderProperties:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000015a2e7
