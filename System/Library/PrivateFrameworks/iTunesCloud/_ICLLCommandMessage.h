...
- (void).cxx_destruct;	// IMP=0x0000000000083033
- (unsigned long long)hash;	// IMP=0x0000000000082eba
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000082bea
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000829b3
- (void)writeTo:(id)arg1;	// IMP=0x0000000000082851
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000082844
- (id)dictionaryRepresentation;	// IMP=0x0000000000082467
- (id)description;	// IMP=0x00000000000823b8
