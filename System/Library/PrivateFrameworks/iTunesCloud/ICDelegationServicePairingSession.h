...
- (void).cxx_destruct;	// IMP=0x00000000001360d3
...
- (void)_sendData:(id)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000135f5f
- (void)_receivedData:(id)arg1;	// IMP=0x0000000000135cdd
- (_Bool)_deriveEncryptionKeysReturningError:(id *)arg1;	// IMP=0x00000000001357a1
- (void)_handlePairingSessionCompletionWithError:(id)arg1;	// IMP=0x000000000013555d
- (id)_encryptedDataForData:(id)arg1;	// IMP=0x00000000001353e3
- (void)getEncryptedDataForData:(id)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000013532c
- (void)getDecryptedDataForEncryptedData:(id)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000135275
- (void)receievedData:(id)arg1;	// IMP=0x00000000001351ea
- (void)prepareEncryptedSessionWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000013515f
- (void)dealloc;	// IMP=0x0000000000135120
- (id)initWithRole:(long long)arg1 securitySettings:(id)arg2;	// IMP=0x000000000013506d
