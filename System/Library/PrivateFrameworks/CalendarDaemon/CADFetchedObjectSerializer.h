...
- (void).cxx_destruct;	// IMP=0x000000000003b802
...
- (id)_fetchedObjectDictionaryForEntity:(void *)arg1;	// IMP=0x000000000003b57c
- (id)_properties:(id)arg1 forEntityIfNotSeen:(void *)arg2 objectExists:(_Bool *)arg3;	// IMP=0x000000000003ae59
@property(readonly, nonatomic) NSArray *fetchedObjectWrappers;
- (id)addEntity:(void *)arg1;	// IMP=0x000000000003aada
- (id)initWithConnection:(id)arg1 defaultPropertiesToLoad:(id)arg2 relatedObjectPropertiesToLoad:(id)arg3;	// IMP=0x000000000003a9ad
- (id)initWithConnection:(id)arg1 defaultPropertiesToLoad:(id)arg2;	// IMP=0x000000000003a998
