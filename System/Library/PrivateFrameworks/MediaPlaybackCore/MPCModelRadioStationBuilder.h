...
- (void).cxx_destruct;	// IMP=0x000000000009cec6
@property(readonly, copy, nonatomic) MPPropertySet *requestedProperties; // @synthesize requestedProperties=_requestedProperties;
- (id)modelRadioStationForMetadata:(id)arg1 userIdentity:(id)arg2;	// IMP=0x000000000009ca3b
- (id)initWithRequestedProperties:(id)arg1;	// IMP=0x000000000009c9c8
