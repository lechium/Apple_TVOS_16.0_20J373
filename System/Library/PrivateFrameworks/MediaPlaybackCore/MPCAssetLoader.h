...
- (void).cxx_destruct;	// IMP=0x00000000000a019c
...
- (void)cancelLoading;	// IMP=0x00000000000a0113
- (void)loadAssetFor:(id)arg1 token:(long long)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000009fe7b
- (id)initWithDelegate:(id)arg1;	// IMP=0x000000000009fdb7
