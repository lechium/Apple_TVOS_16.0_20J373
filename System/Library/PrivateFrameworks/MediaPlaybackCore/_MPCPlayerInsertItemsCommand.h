...
- (_Bool)_isSupportedPlaybackIntent:(id)arg1 forRemotePlayer:(_Bool)arg2 atInsertionPosition:(int)arg3;	// IMP=0x000000000010b563
- (id)_createRadioStationCommandRequest;	// IMP=0x000000000010b3a6
- (id)_insertWithOptions:(id)arg1;	// IMP=0x000000000010b17a
- (id)insertAtEndOfTracklistWithPlaybackIntent:(id)arg1;	// IMP=0x000000000010b01d
- (id)insertPlaybackIntent:(id)arg1 afterItem:(id)arg2;	// IMP=0x000000000010adf7
- (id)insertAfterPlayingItemWithPlaybackIntent:(id)arg1;	// IMP=0x000000000010aa00
