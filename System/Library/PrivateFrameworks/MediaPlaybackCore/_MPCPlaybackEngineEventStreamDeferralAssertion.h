...
- (void).cxx_destruct;	// IMP=0x00000000001646e9
...
- (void)invalidate;	// IMP=0x0000000000164510
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x0000000000164485
- (id)initWithEventStream:(id)arg1 reason:(id)arg2 timeout:(double)arg3;	// IMP=0x0000000000164308
