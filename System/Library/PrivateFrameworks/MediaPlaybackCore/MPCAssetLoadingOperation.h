...
- (void).cxx_destruct;	// IMP=0x000000000009fba2
...
- (_Bool)_configureItem:(id)arg1 error:(id *)arg2;	// IMP=0x000000000009f641
- (void)main;	// IMP=0x000000000009eedb
- (_Bool)isFinished;	// IMP=0x000000000009eecb
- (_Bool)isExecuting;	// IMP=0x000000000009eebb
- (void)start;	// IMP=0x000000000009eca1
- (id)initWithPlayerItem:(id)arg1 configurator:(id)arg2 delegate:(id)arg3 token:(long long)arg4 callbackQueue:(id)arg5 completion:(CDUnknownBlockType)arg6;	// IMP=0x000000000009eb72
