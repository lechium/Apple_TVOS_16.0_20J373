...
- (void).cxx_destruct;	// IMP=0x000000000019c115
...
- (void)_presentServerDialog:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000019bf25
- (void)_performDefaultHandlingForButtonAction:(id)arg1;	// IMP=0x000000000019be9c
- (void)_fireAndForgetServerDialog:(id)arg1;	// IMP=0x000000000019be50
- (void)performWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000019be3f
- (id)nextStepWithError:(id)arg1;	// IMP=0x000000000019bdc0
- (id)initWithPreviousStep:(id)arg1;	// IMP=0x000000000019bd1f
- (id)initWithGetTracksRequest:(id)arg1 siriAssetInfo:(id)arg2 playActivityController:(id)arg3;	// IMP=0x000000000019b89e
