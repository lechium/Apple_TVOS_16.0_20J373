...
- (void).cxx_destruct;	// IMP=0x0000000000194b37
...
- (unsigned long long)reportingEventType;	// IMP=0x0000000000194b01
- (_Bool)isValidReportingEvent;	// IMP=0x0000000000194af3
