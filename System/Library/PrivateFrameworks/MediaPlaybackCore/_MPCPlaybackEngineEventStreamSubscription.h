...
- (void).cxx_destruct;	// IMP=0x0000000000160ab5
...
- (void)_onQueue_flush;	// IMP=0x00000000001601f6
- (void)subscribeToEventType:(id)arg1 options:(unsigned long long)arg2 handler:(CDUnknownBlockType)arg3;	// IMP=0x000000000015ff02
- (void)subscribeToEventType:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x000000000015feeb
- (void)flushEventsWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000015fd5f
- (void)cancelSubscription;	// IMP=0x000000000015fc31
@property(readonly, copy) NSString *debugDescription;
- (id)initWithConsumer:(id)arg1 eventStream:(id)arg2;	// IMP=0x000000000015f9c6
