...
- (void).cxx_destruct;	// IMP=0x00000000000cfe6d
...
- (void)setCancellationHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000000cfd2b
- (CDUnknownBlockType)cancellationHandler;	// IMP=0x00000000000cfc6c
- (id)_handlePlaybackResponse:(id)arg1 withPlaybackCacheRequest:(id)arg2 error:(id *)arg3;	// IMP=0x00000000000cf70d
- (id)_loadResultsFromServerObjectDatabaseAssets:(id)arg1 hlsAsset:(id)arg2 playbackAuthorizationToken:(id)arg3;	// IMP=0x00000000000cefcd
- (id)_loadResultsFromServerObjectDatabaseAssetsWithMiniSinf:(id)arg1 playbackAuthorizationToken:(id)arg2;	// IMP=0x00000000000ce989
- (_Bool)_canRetrieveLoadResultsFromServerObjectDatabaseWithAssets:(id *)arg1 hlsAsset:(id *)arg2;	// IMP=0x00000000000ce3ce
- (_Bool)_canRetrieveLoadResultsFromMiniSinfWithAssets:(id *)arg1;	// IMP=0x00000000000ce005
- (void)execute;	// IMP=0x00000000000cce2c
- (void)cancel;	// IMP=0x00000000000ccdcc
- (id)description;	// IMP=0x00000000000ccd12
- (id)init;	// IMP=0x00000000000cccae
