...
+ (id)enumeratorWithQueueController:(id)arg1 mode:(long long)arg2 options:(unsigned long long)arg3 startPosition:(id)arg4 endPosition:(id)arg5;	// IMP=0x006000000012c3f5
- (void).cxx_destruct;	// IMP=0x000000000012c2da
...
- (void)_buildEnumerator;	// IMP=0x000000000012bd3e
- (id)_init;	// IMP=0x000000000012bd0f
- (id)nextObject;	// IMP=0x000000000012bc56
