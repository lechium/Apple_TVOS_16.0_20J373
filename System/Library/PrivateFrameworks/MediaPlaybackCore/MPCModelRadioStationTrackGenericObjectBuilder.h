...
- (void).cxx_destruct;	// IMP=0x000000000008d500
@property(readonly, copy, nonatomic) MPPropertySet *requestedProperties; // @synthesize requestedProperties=_requestedProperties;
- (id)genericObjectForRadioStationTrack:(id)arg1 containerUniqueID:(id)arg2 userIdentity:(id)arg3;	// IMP=0x000000000008cf1a
- (id)initWithRequestedProperties:(id)arg1;	// IMP=0x000000000008cea7
