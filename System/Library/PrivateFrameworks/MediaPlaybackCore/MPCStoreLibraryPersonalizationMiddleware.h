...
- (void).cxx_destruct;	// IMP=0x00000000000067fa
...
- (id)operationsForPlayerRequest:(id)arg1;	// IMP=0x0000000000006708
- (id)operationsForRequest:(id)arg1;	// IMP=0x000000000000669b
- (id)playerModelObject:(id)arg1 propertySet:(id)arg2 atIndexPath:(id)arg3 chain:(id)arg4;	// IMP=0x0000000000006822
