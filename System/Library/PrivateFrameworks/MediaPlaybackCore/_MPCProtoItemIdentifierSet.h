...
- (unsigned long long)hash;	// IMP=0x000000000006775d
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000067585
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000067424
- (void)writeTo:(id)arg1;	// IMP=0x00000000000672fb
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000672ee
- (id)dictionaryRepresentation;	// IMP=0x000000000006707f
- (id)description;	// IMP=0x0000000000066fd0
