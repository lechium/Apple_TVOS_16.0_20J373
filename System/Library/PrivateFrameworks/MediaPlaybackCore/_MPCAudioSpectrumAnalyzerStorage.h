...
- (void)analyzeAudioData:(void *)arg1 numberFrames:(unsigned int)arg2 observers:(id)arg3;	// IMP=0x0000000000003039
- (void)analyzeFrequencies:(struct AudioBufferList *)arg1 numberFrames:(unsigned long long)arg2 observers:(id)arg3;	// IMP=0x0000000000002f60
- (void)_freeBuffers;	// IMP=0x0000000000002f24
- (void)_destroyFFTSetup;	// IMP=0x0000000000002efe
- (void)_prepareBuffers;	// IMP=0x0000000000002ea9
- (void)dealloc;	// IMP=0x0000000000002e56
- (id)initWithMaximumNumberOfFrames:(long long)arg1 sampleRate:(float)arg2;	// IMP=0x0000000000002db7
