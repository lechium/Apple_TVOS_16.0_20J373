...
- (void).cxx_destruct;	// IMP=0x00000000001ad364
...
- (void)reset;	// IMP=0x00000000001ad311
- (void)reloadItemsKeepingCurrentItem:(_Bool)arg1;	// IMP=0x00000000001ad2c5
@property(readonly, nonatomic) NSArray *items;
@property(nonatomic) _Bool shouldDeferItemLoading;
@property(nonatomic) _Bool shouldExpectEmptyQueue;
@property(readonly, nonatomic) MPAVItem *currentItem;
- (id)initWithStackController:(id)arg1;	// IMP=0x00000000001ad1ed
