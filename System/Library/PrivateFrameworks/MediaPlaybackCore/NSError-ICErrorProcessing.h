...
+ (_Bool)_isAgeVerificationError:(id)arg1;	// IMP=0x0010000000019c68
+ (id)errorForICError:(id)arg1 response:(id)arg2;	// IMP=0x0010000000019a55
+ (id)payloadValueFromJSONValue:(id)arg1;	// IMP=0x001000000018720a
- (id)mpc_remoteCommandDialog;	// IMP=0x00100000000beae0
...
- (_Bool)mpc_isSubscriptionRequiredError;	// IMP=0x00100000000ccbc9
...
- (id)mpc_errorByRemovingUnserializableUserInfo;	// IMP=0x001000000018515f
- (id)mpc_jsonValue;	// IMP=0x0010000000184ff7
