...
- (void).cxx_destruct;	// IMP=0x0000000000143ef0
...
- (id)changeValue:(_Bool)arg1;	// IMP=0x0000000000143c93
- (id)initWithResponse:(id)arg1 mediaRemoteCommand:(unsigned int)arg2;	// IMP=0x0000000000143c51
