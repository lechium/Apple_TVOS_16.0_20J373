...
+ (id)metadataIdentifiers;	// IMP=0x00400000001c8477
+ (_Bool)supportsSecureCoding;	// IMP=0x00400000001c846f
- (void).cxx_destruct;	// IMP=0x00000000001c6494
...
- (id)newOperationWithResponseHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000001c6353
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001c62c4
- (id)initWithGenericObject:(id)arg1 timedMetadataGroups:(id)arg2 storeRequestContext:(id)arg3;	// IMP=0x00000000001c61d2
