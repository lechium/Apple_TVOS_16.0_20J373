...
- (void).cxx_destruct;	// IMP=0x0000000000064660
...
- (void)_personalizationResponseDidInvalidateNotification:(id)arg1;	// IMP=0x00000000000645a5
- (void)dealloc;	// IMP=0x0000000000064510
- (id)initWithRequest:(id)arg1 personalizationResponse:(id)arg2 firstResponse:(_Bool)arg3 finalResponse:(_Bool)arg4;	// IMP=0x00000000000643bc
