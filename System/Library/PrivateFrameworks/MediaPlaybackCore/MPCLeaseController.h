...
- (void).cxx_destruct;	// IMP=0x00000000001995b8
...
- (void)relinquishLeaseForItem:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000199297
- (void)requestLeaseForItem:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000198f82
- (id)initWithTranslator:(id)arg1 leaseManager:(id)arg2;	// IMP=0x0000000000198ee9
