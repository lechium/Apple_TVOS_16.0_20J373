...
- (void).cxx_destruct;	// IMP=0x000000000009e5a4
...
- (void)engine:(id)arg1 willChangeToItem:(id)arg2 fromItem:(id)arg3;	// IMP=0x000000000009de9b
- (id)initWithPlaybackEngine:(id)arg1;	// IMP=0x000000000009ddc7
