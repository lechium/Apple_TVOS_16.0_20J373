...
- (void).cxx_destruct;	// IMP=0x000000000018d9fd
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000018d768
- (id)description;	// IMP=0x000000000018d674
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000018d3f1
- (unsigned long long)hash;	// IMP=0x000000000018d396
- (id)initWithDelegatedUserIdentity:(id)arg1;	// IMP=0x000000000018d323
- (id)initWithUserIdentity:(id)arg1 subscriptionStatus:(id)arg2;	// IMP=0x000000000018d28a
