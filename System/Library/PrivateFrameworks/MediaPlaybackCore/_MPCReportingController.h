...
- (void).cxx_destruct;	// IMP=0x0000000000198d5c
...
- (void)recordLyricsViewEvent:(id)arg1;	// IMP=0x0000000000198cfa
- (id)initWithPlaybackEngine:(id)arg1;	// IMP=0x0000000000198c4a
