...
- (void).cxx_destruct;	// IMP=0x0000000000144a04
...
- (id)_seekCommandWithMediaRemoteCommand:(unsigned int)arg1 options:(id)arg2;	// IMP=0x00000000001447db
- (id)changePositionToElapsedInterval:(double)arg1;	// IMP=0x000000000014470a
- (id)jumpByInterval:(double)arg1;	// IMP=0x0000000000144574
- (id)endSeek;	// IMP=0x000000000014452f
- (id)beginSeekWithDirection:(long long)arg1;	// IMP=0x00000000001444ce
- (id)initWithResponse:(id)arg1 seekSupport:(unsigned long long)arg2;	// IMP=0x000000000014448a
