...
+ (id)identifier;	// IMP=0x00100000000c4703
- (void).cxx_destruct;	// IMP=0x00000000000c4782
...
- (void)unsubscribeFromEventStream:(id)arg1;	// IMP=0x00000000000c475e
- (void)subscribeToEventStream:(id)arg1;	// IMP=0x00000000000c4710
