...
- (void).cxx_destruct;	// IMP=0x0000000000006fdd
...
- (void)tearDownObservations;	// IMP=0x0000000000006e7c
- (void)setupObservations;	// IMP=0x0000000000006c5c
- (void)restoreSessionSettingsFromSnapshot;	// IMP=0x0000000000006bee
- (void)snapshotSessionSettings;	// IMP=0x0000000000006b01
- (void)updateAudioSession:(id)arg1 options:(unsigned long long)arg2 routeSharingPolicy:(unsigned long long)arg3;	// IMP=0x0000000000006a72
- (void)dealloc;	// IMP=0x0000000000006a34
- (id)init;	// IMP=0x00000000000069a7
