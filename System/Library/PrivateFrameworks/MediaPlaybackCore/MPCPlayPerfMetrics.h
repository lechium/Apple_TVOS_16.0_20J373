...
+ (id)playMetricsWithErrorSignature:(id)arg1 event:(id)arg2 cursor:(id)arg3;	// IMP=0x00600000001c0105
+ (id)playMetricsWithFirstFrameEvent:(id)arg1 cursor:(id)arg2;	// IMP=0x00600000001bda95
- (void).cxx_destruct;	// IMP=0x00000000001bd9a4
@property(retain, nonatomic) NSMutableDictionary *data; // @synthesize data=_data;
- (void)addEnvironmentInfoWithCursor:(id)arg1;	// IMP=0x00000000001bd8dd
- (void)addAssetLoadInfoWithCursor:(id)arg1 itemIDPayload:(id)arg2;	// IMP=0x00000000001bcb9d
- (void)addSharePlayWithCursor:(id)arg1;	// IMP=0x00000000001bcb13
- (void)addPlaybackBehaviorWithCursor:(id)arg1;	// IMP=0x00000000001bc929
- (void)addQueueMetadata:(id)arg1;	// IMP=0x00000000001bc87b
- (id)humanDescription;	// IMP=0x00000000001bbb2b
- (id)description;	// IMP=0x00000000001bb91d
...
- (id)init;	// IMP=0x00000000001baeb1
