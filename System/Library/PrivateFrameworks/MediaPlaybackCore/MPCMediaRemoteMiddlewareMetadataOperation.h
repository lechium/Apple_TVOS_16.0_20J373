...
- (void).cxx_destruct;	// IMP=0x000000000001b3b4
...
- (id)_itemGenericObjectPropertySetForContentItem:(id)arg1 propertySet:(id)arg2;	// IMP=0x000000000001ad17
- (id)_genericObjectPropertySetForContentItem:(id)arg1 preferredRelationships:(id)arg2 propertySet:(id)arg3;	// IMP=0x000000000001a800
- (struct _MSVSignedRange)rangeFromTracklistRange:(CDStruct_912cb5d2)arg1;	// IMP=0x000000000001a7dc
@property(readonly, nonatomic) NSArray *outputProtocols;
@property(readonly, nonatomic) NSArray *inputProtocols;
- (id)timeoutDescription;	// IMP=0x000000000001a631
- (void)execute;	// IMP=0x000000000001a56a
- (void)_loadPlayingIdentifierWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000001a34c
- (void)_loadItemsWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000019dc0
- (id)initWithMiddleware:(id)arg1 request:(id)arg2;	// IMP=0x0000000000019d1e
