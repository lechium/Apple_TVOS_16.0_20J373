...
- (void).cxx_destruct;	// IMP=0x00000000001acd18
...
- (id)newOperationWithResponseHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000001acc54
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001acc01
