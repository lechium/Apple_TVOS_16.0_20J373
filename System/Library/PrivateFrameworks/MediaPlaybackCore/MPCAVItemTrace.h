...
+ (id)traceIntervalWithName:(id)arg1 item:(id)arg2 beginEvent:(unsigned int)arg3 endEvent:(unsigned int)arg4;	// IMP=0x006000000019dda4
+ (void)traceWithName:(id)arg1 item:(id)arg2 event:(unsigned int)arg3;	// IMP=0x006000000019dcc0
- (void).cxx_destruct;	// IMP=0x000000000019dc9a
...
- (void)cancel;	// IMP=0x000000000019da8a
- (void)endInterval;	// IMP=0x000000000019d8fa
- (void)dealloc;	// IMP=0x000000000019d8bc
