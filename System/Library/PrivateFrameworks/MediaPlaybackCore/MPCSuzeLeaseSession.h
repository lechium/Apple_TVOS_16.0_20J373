...
- (void).cxx_destruct;	// IMP=0x0000000000189bd3
@property(readonly, nonatomic) ICSuzeLeaseSession *icSuzeLeaseSession; // @synthesize icSuzeLeaseSession=_icSuzeLeaseSession;
- (void)endAutomaticallyRefreshingLease;	// IMP=0x0000000000189bb3
- (void)beginAutomaticallyRefreshingLease;	// IMP=0x0000000000189b9d
- (id)initWithICSuzeLeaseSession:(id)arg1;	// IMP=0x0000000000189b32
