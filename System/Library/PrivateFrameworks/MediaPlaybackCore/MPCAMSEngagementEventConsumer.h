...
+ (id)identifier;	// IMP=0x001000000014a942
- (void).cxx_destruct;	// IMP=0x000000000014b5ee
...
- (id)_JSONEncodableEvent:(id)arg1;	// IMP=0x000000000014b455
- (_Bool)_enqueueDataForPlaybackChangingEvent:(id)arg1 cursor:(id)arg2;	// IMP=0x000000000014ab1a
- (void)unsubscribeFromEventStream:(id)arg1;	// IMP=0x000000000014aae1
- (void)subscribeToEventStream:(id)arg1;	// IMP=0x000000000014a94f
