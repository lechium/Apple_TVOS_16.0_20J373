...
+ (id)identifier;	// IMP=0x00100000000428d4
- (void).cxx_destruct;	// IMP=0x00000000000452fa
...
- (_Bool)_logAccountEvent:(id)arg1 subscription:(id)arg2 cursor:(id)arg3;	// IMP=0x0000000000044ad1
- (void)unsubscribeFromEventStream:(id)arg1;	// IMP=0x0000000000044a98
- (void)subscribeToEventStream:(id)arg1;	// IMP=0x00000000000428e1
