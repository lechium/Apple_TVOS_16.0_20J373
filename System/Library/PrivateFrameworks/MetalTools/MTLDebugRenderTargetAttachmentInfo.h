...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000006a3ed
- (unsigned long long)hash;	// IMP=0x000000000006a3df
- (unsigned long long)intersectsTexture:(id)arg1;	// IMP=0x000000000006a249
- (id)initWithDesc:(const struct MTLRenderPassAttachmentDescriptorPrivate *)arg1 renderTargetArrayLength:(unsigned long long)arg2;	// IMP=0x000000000006a0b0
