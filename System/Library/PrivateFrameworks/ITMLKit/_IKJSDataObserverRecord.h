...
+ (id)hashForObserver:(id)arg1;	// IMP=0x0060000000024ea5
...
- (_Bool)isAffectedByPropertyPathWithString:(id)arg1 subpathString:(id *)arg2;	// IMP=0x0000000000024fd3
- (id)initWithObserver:(id)arg1 pathString:(id)arg2;	// IMP=0x0000000000024eca
