...
+ (id)_prototypeGroupsByTypeForDOMElement:(id)arg1;	// IMP=0x0010000000094389
+ (id)_parsedMutationRulesForDOMElement:(id)arg1;	// IMP=0x0010000000093eda
+ (id)instantiateDOMElementForItem:(id)arg1 withPrototype:(id)arg2 parentDOMElement:(id)arg3 existingDOMElement:(id)arg4;	// IMP=0x0010000000092d80
+ (id)domBindingControllerForDOMElement:(id)arg1;	// IMP=0x001000000009150b
+ (void)prepareForDOMElement:(id)arg1;	// IMP=0x0010000000091451
+ (id)parsedBindingForDOMElement:(id)arg1;	// IMP=0x0010000000090c35
- (void).cxx_destruct;	// IMP=0x00000000000963ad
...
- (void)_evaluateMutationRules;	// IMP=0x00000000000960c8
- (void)_resolveBinding;	// IMP=0x0000000000094dcc
- (_Bool)_canBeReused;	// IMP=0x0000000000094b4d
- (void)dataObservable:(id)arg1 didChangePropertyPathWithString:(id)arg2 extraInfo:(id)arg3;	// IMP=0x00000000000935ac
- (id)findPrototypeForDataItem:(id)arg1;	// IMP=0x00000000000931aa
- (void)scheduleUpdateUsingPreUpdate:(CDUnknownBlockType)arg1 update:(CDUnknownBlockType)arg2;	// IMP=0x000000000009266a
- (void)dealloc;	// IMP=0x00000000000925b9
- (id)initWithDOMElement:(id)arg1;	// IMP=0x0000000000091520
