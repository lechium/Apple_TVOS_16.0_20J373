...
- (void).cxx_destruct;	// IMP=0x00000000000e1786
...
- (id)_sparseObjectFromObject:(id)arg1 usingPropertyPaths:(id)arg2;	// IMP=0x00000000000e0e35
- (void)updateUsageIndexesWithChangeSet:(id)arg1;	// IMP=0x00000000000e0cf7
- (void)removeUsageForIndex:(long long)arg1;	// IMP=0x00000000000e0ce1
- (void)addUsageForIndex:(long long)arg1;	// IMP=0x00000000000e0c89
@property(readonly, copy, nonatomic) NSIndexSet *usageIndexes;
- (id)initWithPrototype:(id)arg1 dataItem:(id)arg2;	// IMP=0x00000000000e0a92
- (void)dsepm_setViewElement:(id)arg1;	// IMP=0x0000000000002883
- (id)dsepm_viewElement;	// IMP=0x0000000000002872
