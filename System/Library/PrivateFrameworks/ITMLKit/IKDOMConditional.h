...
- (void).cxx_destruct;	// IMP=0x0000000000011b45
@property(readonly, copy, nonatomic) NSString *identifier; // @synthesize identifier=_identifier;
@property(readonly, nonatomic) __weak IKDOMElement *domElement; // @synthesize domElement=_domElement;
- (void)mutateWithDOMElement:(id)arg1;	// IMP=0x0000000000011a3e
- (_Bool)passesForDataItem:(id)arg1 default:(_Bool)arg2;	// IMP=0x0000000000011736
...
- (id)initWithDOMElement:(id)arg1;	// IMP=0x00000000000111dd
