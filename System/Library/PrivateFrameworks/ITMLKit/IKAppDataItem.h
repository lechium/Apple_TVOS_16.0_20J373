...
- (void).cxx_destruct;	// IMP=0x00000000000e1c8c
...
- (id)valueForPropertyPath:(id)arg1;	// IMP=0x00000000000e1bc2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000e1bb7
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000e1919
- (unsigned long long)hash;	// IMP=0x00000000000e18d5
- (id)initWithType:(id)arg1 identifier:(id)arg2 prototypeIdentifier:(id)arg3 dataDictionary:(id)arg4;	// IMP=0x00000000000e17c2
