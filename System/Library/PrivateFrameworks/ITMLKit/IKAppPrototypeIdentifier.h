...
- (void).cxx_destruct;	// IMP=0x00000000000e0a5f
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000e07c8
- (unsigned long long)hash;	// IMP=0x00000000000e0784
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000e0779
- (id)initWithIdentifier:(id)arg1 selector:(id)arg2 groupingValues:(id)arg3;	// IMP=0x00000000000e0693
