...
- (void).cxx_destruct;	// IMP=0x000000000001c049
...
- (id)bufferedDataWithError:(id *)arg1;	// IMP=0x000000000001bfb4
- (unsigned long long)headerLength;	// IMP=0x000000000001bf52
@property(readonly, nonatomic) unsigned long long clientBytesWritten;
@property(readonly, nonatomic) _Bool hasBytesRemaining;
- (id)initWithData:(id)arg1 userInfo:(id)arg2;	// IMP=0x000000000001bd54
