...
+ (id)acknowledgeTimerIdentifier;	// IMP=0x00600000000093af
- (void).cxx_destruct;	// IMP=0x0000000000009430
@property(nonatomic) __weak id <CATIDSServiceConnectionInvitationInboxDelegate> delegate; // @synthesize delegate=_delegate;
- (void)acknowledgeTimerFiredWithInvitationIdentifier:(id)arg1;	// IMP=0x000000000000922e
- (void)receiveAcknowledgeForInvitationIdentifier:(id)arg1 connectionIdentifier:(id)arg2;	// IMP=0x0000000000008f0f
- (void)receiveInvitationWithIdentifier:(id)arg1 senderAppleID:(id)arg2 senderAddress:(id)arg3 messagingVersion:(unsigned long long)arg4 userInfo:(id)arg5;	// IMP=0x0000000000008912
- (id)initWithTimerSource:(id)arg1 assertionProvider:(id)arg2 workQueue:(id)arg3 acknowledgeTimeout:(double)arg4;	// IMP=0x0000000000008814
- (void)dealloc;	// IMP=0x00000000000086b4
