...
- (void).cxx_destruct;	// IMP=0x000000000001c5e5
...
- (id)bufferedDataWithError:(id *)arg1;	// IMP=0x000000000001c2f5
@property(readonly, nonatomic) unsigned long long clientBytesWritten;
@property(readonly, nonatomic) _Bool hasBytesRemaining;
- (void)dealloc;	// IMP=0x000000000001c1f0
- (id)initWithStream:(id)arg1 length:(unsigned long long)arg2 bufferSize:(unsigned long long)arg3 userInfo:(id)arg4;	// IMP=0x000000000001c07c
