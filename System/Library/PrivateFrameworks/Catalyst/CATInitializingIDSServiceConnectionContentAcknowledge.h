...
+ (id)instanceWithDictionary:(id)arg1;	// IMP=0x0010000000041deb
- (void).cxx_destruct;	// IMP=0x0000000000041e61
...
- (id)initWithConnectionIdentifier:(id)arg1;	// IMP=0x0000000000041cae
