...
+ (id)instanceWithDictionary:(id)arg1;	// IMP=0x0010000000049c07
- (void).cxx_destruct;	// IMP=0x0000000000049dd7
...
- (id)initWithInvitationIdentifier:(id)arg1 content:(id)arg2;	// IMP=0x00000000000499d8
