...
+ (id)instanceWithDictionary:(id)arg1;	// IMP=0x0010000000002170
- (void).cxx_destruct;	// IMP=0x0000000000002326
...
- (id)initWithMessageType:(long long)arg1;	// IMP=0x0000000000001f8e
- (id)initWithMessageIdentifier:(id)arg1 messageType:(long long)arg2 messagingVersion:(long long)arg3;	// IMP=0x0000000000001f0d
