...
+ (id)missingContentTimerIdentifier;	// IMP=0x001000000000c03c
- (void).cxx_destruct;	// IMP=0x000000000000c10b
@property(nonatomic) __weak id <CATIDSServiceConnectionDataAggregatorDelegate> delegate; // @synthesize delegate=_delegate;
- (id)description;	// IMP=0x000000000000c096
- (void)dataAggregationCompleted:(id)arg1;	// IMP=0x000000000000beaa
- (void)missingContentTimerDidFire:(id)arg1 fireCount:(unsigned long long)arg2;	// IMP=0x000000000000bdd7
- (void)updateMissingContentTrackingForDataContent:(id)arg1;	// IMP=0x000000000000ba74
- (void)updateExistingDataWindowWithContent:(id)arg1;	// IMP=0x000000000000b93e
- (void)processNewDataWindowWithContent:(id)arg1;	// IMP=0x000000000000b84f
- (void)receiveExpectedSequenceNumber:(unsigned long long)arg1;	// IMP=0x000000000000b779
- (void)receiveDataContent:(id)arg1;	// IMP=0x000000000000b654
@property(readonly, nonatomic) unsigned long long receivedSequenceNumber;
- (id)missingSequenceNumbers;	// IMP=0x000000000000b5ab
- (id)initWithWorkQueue:(id)arg1 timerSource:(id)arg2 missingItemInterval:(double)arg3 supportsSequenceCorrection:(_Bool)arg4;	// IMP=0x000000000000b4c5
