...
- (void).cxx_destruct;	// IMP=0x00000000000223e0
...
- (id)initWithInvitationIdentifier:(id)arg1 appleID:(id)arg2 assertion:(id)arg3 userInfo:(id)arg4;	// IMP=0x00000000000222b0
