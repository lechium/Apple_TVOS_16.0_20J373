...
- (void).cxx_destruct;	// IMP=0x000000000001f37f
...
- (void)didFailWithError:(id)arg1;	// IMP=0x000000000001f31b
- (void)didSendData;	// IMP=0x000000000001f307
- (void)didEncodeData:(id)arg1;	// IMP=0x000000000001f231
- (void)main;	// IMP=0x000000000001ef67
- (_Bool)isAsynchronous;	// IMP=0x000000000001ef5f
