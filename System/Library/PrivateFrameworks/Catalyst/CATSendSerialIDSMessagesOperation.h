...
- (void).cxx_destruct;	// IMP=0x0000000000022ad6
- (void)didSendMessagesWithError:(id)arg1;	// IMP=0x0000000000022aaf
- (void)sendMessages;	// IMP=0x00000000000225c8
- (void)main;	// IMP=0x00000000000225b6
- (_Bool)isAsynchronous;	// IMP=0x00000000000225ae
- (id)initWithIDSPrimitives:(id)arg1 workQueue:(id)arg2 messages:(id)arg3 destinationAddress:(id)arg4 sourceAppleID:(id)arg5 options:(id)arg6;	// IMP=0x000000000002241e
