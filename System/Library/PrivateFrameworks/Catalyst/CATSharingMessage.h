...
+ (id)instanceWithDictionary:(id)arg1;	// IMP=0x001000000004a002
- (void).cxx_destruct;	// IMP=0x000000000004a1ad
...
- (id)initWithMessageType:(long long)arg1 contentDictionary:(id)arg2;	// IMP=0x0000000000049e8b
- (id)initWithContentMessage:(id)arg1;	// IMP=0x0000000000049dff
