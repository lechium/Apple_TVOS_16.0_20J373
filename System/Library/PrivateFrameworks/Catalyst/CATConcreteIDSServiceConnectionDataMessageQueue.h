...
+ (id)flushTimerIdentifier;	// IMP=0x0010000000041583
- (void).cxx_destruct;	// IMP=0x0000000000041923
@property(nonatomic) __weak id <CATIDSServiceConnectionDataMessageQueueDelegate> delegate; // @synthesize delegate=_delegate;
- (void)retransmitContent:(id)arg1;	// IMP=0x00000000000417bc
- (void)flushTimerDidFire:(id)arg1 fireCount:(unsigned long long)arg2;	// IMP=0x0000000000041726
- (void)scheduleFlushTimer;	// IMP=0x00000000000415a8
- (void)retransmitSequenceNumbers:(id)arg1;	// IMP=0x0000000000041477
- (void)receiveRemoteSequenceNumber:(unsigned long long)arg1;	// IMP=0x000000000004133c
- (void)receiveData:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000040ec2
- (id)initWithWorkQueue:(id)arg1 timerSource:(id)arg2 dataChunker:(id)arg3 flushPromptInterval:(double)arg4 supportsRetransmit:(_Bool)arg5;	// IMP=0x0000000000040dd6
