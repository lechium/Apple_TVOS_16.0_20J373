...
- (void).cxx_destruct;	// IMP=0x0000000000023553
@property(nonatomic) __weak id <CATIDSServiceConnectionMessageProcessorDelegate> delegate; // @synthesize delegate=_delegate;
- (void)receiveMessage:(id)arg1;	// IMP=0x0000000000022e01
- (id)initWithWorkQueue:(id)arg1 connectionIdentifier:(id)arg2;	// IMP=0x0000000000022d68
