...
+ (id)helperForBundle:(id)arg1;	// IMP=0x006000000000c4c9
- (void).cxx_destruct;	// IMP=0x000000000000cd29
@property(readonly, nonatomic) __weak NSBundle *bundle; // @synthesize bundle=_bundle;
- (id)stringsForKey:(id)arg1 value:(id)arg2 table:(id)arg3;	// IMP=0x000000000000cade
- (id)stringByKeyForTableName:(id)arg1;	// IMP=0x000000000000c7bd
- (id)initWithBundle:(id)arg1;	// IMP=0x000000000000c6c0
