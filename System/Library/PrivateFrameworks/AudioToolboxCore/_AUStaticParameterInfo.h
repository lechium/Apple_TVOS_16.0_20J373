...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000df09b
- (void).cxx_destruct;	// IMP=0x00000000000df073
...
- (void)dealloc;	// IMP=0x00000000000def84
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000decca
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000deb94
