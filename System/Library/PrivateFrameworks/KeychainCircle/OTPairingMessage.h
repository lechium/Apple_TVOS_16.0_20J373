...
- (void).cxx_destruct;	// IMP=0x000000000000f4d8
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000000f2da
- (unsigned long long)hash;	// IMP=0x000000000000f237
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000000f0d7
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000efbf
- (void)copyTo:(id)arg1;	// IMP=0x000000000000eefc
- (void)writeTo:(id)arg1;	// IMP=0x000000000000ee48
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000000eb24
- (id)dictionaryRepresentation;	// IMP=0x000000000000e96b
- (id)description;	// IMP=0x000000000000e8bc
