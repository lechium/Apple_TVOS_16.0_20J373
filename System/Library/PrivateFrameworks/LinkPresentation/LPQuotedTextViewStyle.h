...
- (void).cxx_destruct;	// IMP=0x000000000003f76b
...
- (id)adjustedForString:(id)arg1;	// IMP=0x000000000003f66d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000003f5c8
- (id)initWithPlatform:(long long)arg1 fontScalingFactor:(double)arg2;	// IMP=0x000000000003edfb
