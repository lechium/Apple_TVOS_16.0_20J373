...
- (void).cxx_destruct;	// IMP=0x0000000000043b68
...
- (id)rightAccessory;	// IMP=0x00000000000439bc
- (id)leftAccessory;	// IMP=0x0000000000043978
- (id)rightIcon;	// IMP=0x0000000000043934
- (id)leftIcon;	// IMP=0x00000000000438f0
- (id)initWithPlatform:(long long)arg1 sizeClass:(unsigned long long)arg2 fontScalingFactor:(double)arg3;	// IMP=0x0000000000042dbe
