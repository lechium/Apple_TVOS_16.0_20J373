...
+ (id)iconPlatterCornerRadius;	// IMP=0x0060000000051436
+ (id)iconPlatterPaddingForReason:(long long)arg1;	// IMP=0x00600000000513be
+ (void)addClient:(id)arg1;	// IMP=0x00600000000510f7
+ (id)themeWithStyle:(long long)arg1 icon:(id)arg2 platform:(long long)arg3 sizeClass:(unsigned long long)arg4 sizeClassParameters:(id)arg5 hasButton:(_Bool)arg6 preferredContentSizeCategory:(id)arg7;	// IMP=0x006000000004436b
+ (id)secondaryLabelColor;	// IMP=0x0060000000044352
+ (id)primaryLabelColor;	// IMP=0x0060000000044339
+ (double)largestIconSizeInPoints;	// IMP=0x006000000004432b
+ (id)regularTheme;	// IMP=0x00600000000442f9
+ (void)invalidateThemeCache;	// IMP=0x00600000000516b9
...
- (id)CSSTextForProperty:(id)arg1 withValue:(id)arg2;	// IMP=0x00000000000512a0
- (id)CSSTextForThemeProperty:(id)arg1;	// IMP=0x000000000005121a
- (id)valueForThemeProperty:(id)arg1;	// IMP=0x0000000000051175
- (id)valueForUndefinedKey:(id)arg1;	// IMP=0x000000000005116d
- (void)adjustForStyle;	// IMP=0x0000000000044f93
- (id)initWithStyle:(long long)arg1 icon:(id)arg2 platform:(long long)arg3 sizeClass:(unsigned long long)arg4 sizeClassParameters:(id)arg5 hasButton:(_Bool)arg6 preferredContentSizeCategory:(id)arg7;	// IMP=0x00000000000445e6
