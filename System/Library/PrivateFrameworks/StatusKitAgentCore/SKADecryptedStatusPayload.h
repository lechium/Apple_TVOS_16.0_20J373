...
- (void).cxx_destruct;	// IMP=0x000000000004ab4e
...
- (id)description;	// IMP=0x000000000004aa84
- (id)initWithStatusPayload:(id)arg1 invitation:(id)arg2;	// IMP=0x000000000004a9eb
