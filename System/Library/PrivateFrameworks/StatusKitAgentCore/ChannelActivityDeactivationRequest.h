...
- (void).cxx_destruct;	// IMP=0x0000000000038c1c
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000038ac4
- (unsigned long long)hash;	// IMP=0x0000000000038a2e
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000038905
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000038820
- (void)copyTo:(id)arg1;	// IMP=0x000000000003877c
- (void)writeTo:(id)arg1;	// IMP=0x00000000000386dd
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000386d0
- (id)dictionaryRepresentation;	// IMP=0x0000000000038294
- (id)description;	// IMP=0x00000000000381e5
