...
- (void).cxx_destruct;	// IMP=0x000000000004a998
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000000004a7d7
- (unsigned long long)hash;	// IMP=0x000000000004a700
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000004a56c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000004a43d
- (void)copyTo:(id)arg1;	// IMP=0x000000000004a355
- (void)writeTo:(id)arg1;	// IMP=0x000000000004a271
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000004a264
- (id)dictionaryRepresentation;	// IMP=0x0000000000049cd4
- (id)description;	// IMP=0x0000000000049c25
...
- (int)StringAsRequestFlag:(id)arg1;	// IMP=0x0000000000049b23
- (id)requestFlagAsString:(int)arg1;	// IMP=0x0000000000049ada
