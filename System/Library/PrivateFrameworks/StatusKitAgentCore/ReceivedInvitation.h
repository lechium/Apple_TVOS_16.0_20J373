...
+ (id)statusTypeIdentifierKeyPath;	// IMP=0x0040000000046f14
+ (id)senderHandleKeyPath;	// IMP=0x0040000000046f07
+ (id)dateInvitationCreatedKeyPath;	// IMP=0x0040000000046efa
+ (id)predicateForStatusTypeIdentifier:(id)arg1;	// IMP=0x004000000004701d
+ (id)predicateForSenderHandleString:(id)arg1;	// IMP=0x0040000000046f83
+ (id)predicateForSenderHandle:(id)arg1;	// IMP=0x0040000000046f21
+ (id)sortDescriptorForSenderHandleOrderedAscending:(_Bool)arg1;	// IMP=0x0040000000047126
+ (id)sortDescriptorForDateInvitationCreatedOrderedAscending:(_Bool)arg1;	// IMP=0x00400000000470b7
+ (id)fetchRequest;	// IMP=0x0040000000065dfa
