...
- (void).cxx_destruct;	// IMP=0x00000000000f66b9
...
- (void)removeAllAttachments;	// IMP=0x00000000000f64e4
- (void)addAttachments:(id)arg1;	// IMP=0x00000000000f6206
- (void)updateAttachments:(id)arg1;	// IMP=0x00000000000f6131
- (id)initWithContentItem:(id)arg1 eventStore:(id)arg2;	// IMP=0x00000000000f5f79
