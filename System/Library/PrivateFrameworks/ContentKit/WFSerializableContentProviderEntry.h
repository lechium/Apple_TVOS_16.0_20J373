...
- (void).cxx_destruct;	// IMP=0x000000000003cb1a
...
- (id)initWithSerializedRepresentationBlock:(CDUnknownBlockType)arg1 deserializationBlock:(CDUnknownBlockType)arg2;	// IMP=0x000000000003ca3e
