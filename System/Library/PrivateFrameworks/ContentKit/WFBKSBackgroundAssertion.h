...
+ (id)backgroundAssertionWithName:(id)arg1 expirationHandler:(CDUnknownBlockType)arg2;	// IMP=0x006000000007c9e2
- (void).cxx_destruct;	// IMP=0x000000000007c57f
...
- (void)end;	// IMP=0x000000000007c3dc
- (id)initWithName:(id)arg1 expirationHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000007c043
