...
- (void).cxx_destruct;	// IMP=0x000000000006553e
...
- (unsigned long long)hash;	// IMP=0x000000000006546f
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000652b4
- (id)description;	// IMP=0x0000000000065187
- (id)maAssetQueryDescription;	// IMP=0x0000000000064fde
- (id)initWithDeviceAssetQuery:(id)arg1 installedOnly:(_Bool)arg2 imperfectMatch:(_Bool)arg3 fallback:(_Bool)arg4;	// IMP=0x0000000000064e98
