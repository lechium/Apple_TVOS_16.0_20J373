...
- (id)correctedString;	// IMP=0x000000000002d63b
- (id)correctionResult;	// IMP=0x000000000002d631
- (id)description;	// IMP=0x000000000002d5ca
- (void)dealloc;	// IMP=0x000000000002d580
- (id)initWithCorrectionResult:(id)arg1 correctedString:(id)arg2;	// IMP=0x000000000002d502
