...
+ (void)setTypologyRecordsLimit:(unsigned long long)arg1;	// IMP=0x006000000001b065
+ (void)resetTypologyRecords;	// IMP=0x006000000001afcb
+ (void)writeTypologyRecords;	// IMP=0x006000000001ad59
+ (id)currentTypologyRecord;	// IMP=0x006000000001a661
+ (id)openTypologyRecordWithString:(id)arg1 range:(struct _NSRange)arg2 languageObject:(id)arg3 languages:(id)arg4 topLanguages:(id)arg5 autocorrect:(_Bool)arg6 initialCapitalize:(_Bool)arg7 autocapitalize:(_Bool)arg8 keyEventArray:(id)arg9 appIdentifier:(id)arg10 selectedRangeValue:(id)arg11;	// IMP=0x006000000001a3e1
- (void)closeTypologyRecordWithResults:(id)arg1;	// IMP=0x000000000001b104
- (id)dictionaryRepresentation;	// IMP=0x000000000001a808
- (void)addCandidate:(id)arg1;	// IMP=0x000000000001a7e7
- (void)addCorrection:(id)arg1;	// IMP=0x000000000001a7c6
- (void)dealloc;	// IMP=0x000000000001a35f
- (id)initWithString:(id)arg1 offset:(unsigned long long)arg2 range:(struct _NSRange)arg3 languageObject:(id)arg4 languages:(id)arg5 topLanguages:(id)arg6 autocorrect:(_Bool)arg7 initialCapitalize:(_Bool)arg8 autocapitalize:(_Bool)arg9 keyEventArray:(id)arg10 appIdentifier:(id)arg11 selectedRangeValue:(id)arg12;	// IMP=0x000000000001a234
