...
- (id)description;	// IMP=0x000000000006202e
- (void)dealloc;	// IMP=0x0000000000061ff4
- (id)initWithCursor:(struct _LXCursor *)arg1 replacementsCount:(unsigned long long)arg2 insertionsCount:(unsigned long long)arg3 deletionsCount:(unsigned long long)arg4 transpositionsCount:(unsigned long long)arg5 advancementLength:(unsigned long long)arg6;	// IMP=0x0000000000061f74
