...
- (void).cxx_destruct;	// IMP=0x0000000000045f3f
...
- (void)systemInfoResponse:(id)arg1 error:(id)arg2;	// IMP=0x0000000000045d85
- (void)pairVerify;	// IMP=0x0000000000045aea
- (void)invalidate;	// IMP=0x0000000000045aa0
