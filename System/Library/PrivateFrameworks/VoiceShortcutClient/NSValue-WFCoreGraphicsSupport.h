...
+ (id)wf_valueWithCGAffineTransform:(struct CGAffineTransform)arg1;	// IMP=0x0020000000062627
+ (id)wf_valueWithCGRect:(struct CGRect)arg1;	// IMP=0x0020000000062615
+ (id)wf_valueWithCGSize:(struct CGSize)arg1;	// IMP=0x0020000000062603
+ (id)wf_valueWithCGVector:(struct CGVector)arg1;	// IMP=0x00200000000625f1
+ (id)wf_valueWithCGPoint:(struct CGPoint)arg1;	// IMP=0x00200000000625df
