...
- (void).cxx_destruct;	// IMP=0x000000000000f315
...
- (void)invalidate;	// IMP=0x000000000000f247
- (void)performObserverBlock;	// IMP=0x000000000000f1ee
- (id)initWithWeakObserver:(id)arg1 notificationName:(id)arg2 observerQueue:(id)arg3 observerBlock:(CDUnknownBlockType)arg4;	// IMP=0x000000000000efa6
