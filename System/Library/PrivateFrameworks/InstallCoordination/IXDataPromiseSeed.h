...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000044312
- (void).cxx_destruct;	// IMP=0x0000000000044476
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000004431a
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000441cc
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000044062
