...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000002e272
- (void).cxx_destruct;	// IMP=0x000000000002e3fe
...
- (Class)clientPromiseClass;	// IMP=0x000000000002e365
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002e27a
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000002e0fe
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000002df7f
