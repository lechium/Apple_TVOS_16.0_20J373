...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000055f44
- (void).cxx_destruct;	// IMP=0x000000000005662b
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000005647f
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000562a4
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000055f4c
