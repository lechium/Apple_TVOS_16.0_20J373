...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000002d0ee
- (void).cxx_destruct;	// IMP=0x000000000002d294
...
- (Class)clientPromiseClass;	// IMP=0x000000000002d1e1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002d0f6
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000002cf82
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000002cdb3
