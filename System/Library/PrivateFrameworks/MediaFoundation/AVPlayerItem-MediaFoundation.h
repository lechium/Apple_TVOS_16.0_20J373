...
+ (double)HLSDownloadedDurationThreshold;	// IMP=0x001000000002b4d0
+ (double)DownloadedDurationThreshold;	// IMP=0x001000000002b4c0
...
- (id)initWithUrl:(id)arg1 contentItemID:(id)arg2 repeatIndex:(long long)arg3 isVideoContent:(_Bool)arg4 prefersSeekOverSkip:(_Bool)arg5;	// IMP=0x001000000002b6b0
@end
