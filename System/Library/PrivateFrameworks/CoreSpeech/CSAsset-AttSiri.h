...
+ (unsigned long long)getSSVDeviceType;	// IMP=0x002000000000ef09
+ (unsigned int)SSVDefaultDistanceChannelCount;	// IMP=0x002000000000eeab
+ (unsigned int)SSVDefaultLKFSChannelCount;	// IMP=0x002000000000ee58
+ (unsigned int)SSVDefaultNoiseChannelCount;	// IMP=0x002000000000edfa
- (_Bool)isHSVoiceTrigger:(id)arg1;	// IMP=0x00100000000085e9
- (id)getCategoryKeyWithRecordCtx:(id)arg1;	// IMP=0x0010000000008584
- (_Bool)shouldRunSpkrIdForCategory:(id)arg1;	// IMP=0x0010000000008562
- (id)nldaConfigFileForCategory:(id)arg1;	// IMP=0x00100000000084b0
- (id)mitigationConfigFileForCategory:(id)arg1;	// IMP=0x00100000000083fe
...
- (id)nldaConfigFile;	// IMP=0x0010000000008261
@property(readonly, nonatomic) float mitigationModelDefaultAFTMScore;
- (id)mitigatonConfigFile;	// IMP=0x0010000000008167
@property(readonly, nonatomic) NSDictionary *SSVParameterDirectionary;
- (id)_getNumberFromASVDictionaryForKey:(id)arg1 category:(id)arg2 default:(id)arg3;	// IMP=0x001000000001142e
...
- (id)_adaptiveSiriVolumeDictionary;	// IMP=0x001000000000e1ee
@property(readonly, nonatomic) NSString *flexKwdThresholdFile;
@property(readonly, nonatomic) NSString *flexKwdConfigFile;
- (id)_sha256:(id)arg1;	// IMP=0x001000000004fd4a
- (id)_sha1:(id)arg1;	// IMP=0x001000000004fc59
- (id)localeMapWithName:(id)arg1;	// IMP=0x001000000004fab0
- (id)rtModelLocaleMapWithModelType:(long long)arg1;	// IMP=0x001000000004fa7c
- (id)remoraRTModelLocaleMap;	// IMP=0x001000000004fa63
- (id)jarvisRTModelLocaleMap;	// IMP=0x001000000004fa4a
- (id)hearstRTModelLocaleMap;	// IMP=0x001000000004fa31
- (id)hearstRTModelWithMajorVersion:(unsigned long long)arg1 minorVersion:(unsigned long long)arg2 locale:(id)arg3;	// IMP=0x001000000004fa14
- (id)remoraRTModelWithMajorVersion:(unsigned long long)arg1 minorVersion:(unsigned long long)arg2 locale:(id)arg3;	// IMP=0x001000000004f9f4
- (id)rtModelWithAccessoryRTModelType:(long long)arg1 majorVersion:(unsigned long long)arg2 minorVersion:(unsigned long long)arg3 locale:(id)arg4;	// IMP=0x001000000004f1d0
- (id)latestHearstRTModelForLocale:(id)arg1;	// IMP=0x001000000004ee02
- (id)RTModelWithFallbackLanguage:(id)arg1;	// IMP=0x001000000004ed9c
- (id)createRTModelWithLocale:(id)arg1;	// IMP=0x001000000004ed68
...
- (float)satScoreThresholdForPhId:(unsigned long long)arg1;	// IMP=0x0010000000080cde
@property(readonly, nonatomic) _Bool containsSpeakerRecognitionCategory;
- (unsigned long long)_mapInputOriginFromAssetToCSAudioRecordType:(id)arg1;	// IMP=0x00100000000ad233
