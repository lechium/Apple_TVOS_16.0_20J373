...
- (void)start;	// IMP=0x0000000000006049
- (void)finishExecuting;	// IMP=0x0000000000005f46
- (void)cancel;	// IMP=0x0000000000005e85
- (id)initWithRemoteOverlay:(id)arg1;	// IMP=0x0000000000005e17
