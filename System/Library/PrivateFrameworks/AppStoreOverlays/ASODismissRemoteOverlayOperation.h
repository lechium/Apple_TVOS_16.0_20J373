...
- (void)start;	// IMP=0x0000000000001beb
- (void)finishExecuting;	// IMP=0x0000000000001ae8
- (void)cancel;	// IMP=0x0000000000001a27
- (id)initWithContextProvider:(id)arg1;	// IMP=0x00000000000019c0
