...
- (void).cxx_destruct;	// IMP=0x000000000000365e
...
- (id)initWithBoundingBox:(struct CGRect)arg1 text:(id)arg2 color:(id)arg3 opacity:(float)arg4 value:(float)arg5;	// IMP=0x00000000000034f9
