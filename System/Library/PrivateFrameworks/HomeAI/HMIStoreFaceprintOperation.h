...
+ (id)logCategory;	// IMP=0x006000000000fe99
- (void).cxx_destruct;	// IMP=0x000000000000fecf
...
- (void)main;	// IMP=0x000000000000fb64
- (id)initWithDataSource:(id)arg1 faceprint:(id)arg2;	// IMP=0x000000000000faba
