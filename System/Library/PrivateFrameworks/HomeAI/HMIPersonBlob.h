...
- (void).cxx_destruct;	// IMP=0x0000000000032675
...
- (id)shortDescription;	// IMP=0x0000000000032358
- (_Bool)isExpiredAtTimeStamp:(CDStruct_1b6d18a9)arg1;	// IMP=0x00000000000322e2
- (float)similarityToPersonBlob:(id)arg1;	// IMP=0x0000000000031aff
- (void)trackPersonBlob:(id)arg1;	// IMP=0x0000000000031ab0
- (id)initWithNewPersonEvent:(id)arg1 timeStamp:(CDStruct_1b6d18a9)arg2;	// IMP=0x000000000003187b
