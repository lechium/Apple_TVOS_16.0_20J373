...
+ (id)observableForExpression:(id)arg1 inEngine:(id)arg2;	// IMP=0x0060000000005194
- (id)addObserver:(id)arg1;	// IMP=0x000000000000584e
- (id)addObserverBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000000580e
- (_Bool)_overrideUseFastBlockObservers;	// IMP=0x0000000000005806
- (void)dealloc;	// IMP=0x0000000000005239
