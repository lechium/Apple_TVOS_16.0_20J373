...
- (id)makeChildRules;	// IMP=0x0000000000003009
@property(readonly, copy) NSString *identifier;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000002f76
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000002f24
- (void)dealloc;	// IMP=0x0000000000002eda
