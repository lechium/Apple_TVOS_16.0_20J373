...
- (void).cxx_destruct;	// IMP=0x0000000000029a09
...
- (void)consumeStream:(struct __FSEventStream *)arg1 forVolume:(id)arg2;	// IMP=0x000000000002946b
- (void)callback:(id)arg1;	// IMP=0x000000000002871f
- (void)dealloc;	// IMP=0x00000000000286a8
- (id)initWithConsumer:(CDUnknownBlockType)arg1 identifier:(id)arg2;	// IMP=0x00000000000285bb
