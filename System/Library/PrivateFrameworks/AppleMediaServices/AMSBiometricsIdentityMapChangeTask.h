...
- (void).cxx_destruct;	// IMP=0x00000000001533cc
...
- (id)perform;	// IMP=0x0000000000152859
- (id)initWithAccount:(id)arg1 session:(id)arg2 task:(id)arg3;	// IMP=0x0000000000152793
