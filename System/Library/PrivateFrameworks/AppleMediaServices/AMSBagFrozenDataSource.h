...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000135524
- (void).cxx_destruct;	// IMP=0x0000000000135572
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000135210
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000135017
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000134efe
- (void)setDefaultValue:(id)arg1 forKey:(id)arg2;	// IMP=0x0000000000134ef8
- (id)valueForURLVariable:(id)arg1 account:(id)arg2;	// IMP=0x0000000000134e2c
- (void)loadWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000134dab
- (id)defaultValueForKey:(id)arg1;	// IMP=0x0000000000134c7c
@property(readonly, copy) NSString *description;
@property(readonly, nonatomic, getter=isLoaded) _Bool loaded;
- (id)_initWithProfile:(id)arg1 profileVersion:(id)arg2 data:(id)arg3 expirationDate:(id)arg4 account:(id)arg5 processInfo:(id)arg6 defaultValues:(id)arg7;	// IMP=0x0000000000134a28
