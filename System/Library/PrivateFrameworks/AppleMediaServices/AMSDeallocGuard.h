...
- (void).cxx_destruct;	// IMP=0x000000000017de0b
...
- (void)invalidate;	// IMP=0x000000000017ddbb
- (id)initWithDeallocGuardBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000017dd3d
- (void)dealloc;	// IMP=0x000000000017dcb8
