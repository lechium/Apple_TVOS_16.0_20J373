...
- (void).cxx_destruct;	// IMP=0x00000000001b0100
...
- (void)removeServiceType:(id)arg1;	// IMP=0x00000000001b003d
- (void)addServiceType:(id)arg1;	// IMP=0x00000000001affcb
- (void)removePlacement:(id)arg1;	// IMP=0x00000000001aff59
- (void)addPlacement:(id)arg1;	// IMP=0x00000000001afee7
@property(readonly, nonatomic) NSSet *serviceTypes;
@property(readonly, nonatomic) NSSet *placements;
- (id)initWithQueue:(id)arg1;	// IMP=0x00000000001afd4a
