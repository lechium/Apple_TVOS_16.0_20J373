...
- (void).cxx_destruct;	// IMP=0x0000000000214260
...
- (double)_calculateThrottleInterval;	// IMP=0x0000000000214179
- (void)throttle;	// IMP=0x00000000002140f2
- (_Bool)shouldThrottle;	// IMP=0x00000000002140a5
- (void)reset;	// IMP=0x0000000000214073
- (id)initWithBaseSleepInterval:(double)arg1 maxSleepInterval:(double)arg2;	// IMP=0x0000000000214009
