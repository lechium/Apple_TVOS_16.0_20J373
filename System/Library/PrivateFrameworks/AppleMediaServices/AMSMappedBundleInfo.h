...
+ (id)_clientVersionFromProcessInfo:(id)arg1 clientName:(id)arg2;	// IMP=0x004000000020208c
+ (id)_clientNameFromProcessInfo:(id)arg1;	// IMP=0x0040000000201f53
+ (id)_accountMediaTypeForClientName:(id)arg1 bundleID:(id)arg2;	// IMP=0x0040000000201cd4
+ (id)bundleInfoForMobileAppStoreWithProcessInfo:(id)arg1;	// IMP=0x004000000020169e
+ (id)currentBundleInfo;	// IMP=0x0040000000201638
+ (id)bundleInfoForProcessInfo:(id)arg1;	// IMP=0x0040000000201538
+ (id)accountMediaTypeInfoForProcessInfo:(id)arg1;	// IMP=0x0040000000201530
- (void).cxx_destruct;	// IMP=0x000000000020236a
...
- (id)_initWithClient:(long long)arg1 processInfo:(id)arg2;	// IMP=0x00000000002016f0
