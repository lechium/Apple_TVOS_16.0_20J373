...
- (void).cxx_destruct;	// IMP=0x00000000002663c6
...
- (id)description;	// IMP=0x0000000000266211
- (id)initWithPhoneNumber:(id)arg1 simLabel:(id)arg2 uuid:(id)arg3 isVoicePreferred:(_Bool)arg4;	// IMP=0x000000000026614f
