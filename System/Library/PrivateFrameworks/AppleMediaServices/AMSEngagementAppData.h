...
- (void).cxx_destruct;	// IMP=0x00000000001a792d
...
- (id)exportObject;	// IMP=0x00000000001a7477
- (id)initWithIdentifier:(id)arg1 cacheObject:(id)arg2;	// IMP=0x00000000001a6f0e
