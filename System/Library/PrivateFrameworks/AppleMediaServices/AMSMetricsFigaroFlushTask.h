...
- (void).cxx_destruct;	// IMP=0x00000000002359ff
...
- (_Bool)_shouldClearEventsDespiteError:(id)arg1 result:(id)arg2;	// IMP=0x00000000002356e1
- (id)_postBatch:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000234b5c
- (id)_nextBatchWithConfig:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000233cb9
- (id)_mescalSignatureWithBodyData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000233a7e
- (id)performFlush;	// IMP=0x0000000000233359
- (void)cancel;	// IMP=0x00000000002331de
@property(readonly, nonatomic) AMSURLSession *URLSession; // @synthesize URLSession=_URLSession;
- (id)initWithDataSource:(id)arg1 bag:(id)arg2;	// IMP=0x0000000000233010
