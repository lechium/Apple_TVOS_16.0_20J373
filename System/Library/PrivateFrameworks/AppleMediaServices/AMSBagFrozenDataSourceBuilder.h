...
- (void).cxx_destruct;	// IMP=0x0000000000136606
...
- (id)createFrozenDataSource;	// IMP=0x000000000013626e
- (id)createFrozenBag;	// IMP=0x0000000000135820
- (id)initWithFrozenDataSource:(id)arg1;	// IMP=0x00000000001355d1
