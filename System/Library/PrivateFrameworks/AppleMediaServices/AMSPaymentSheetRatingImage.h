...
- (void).cxx_destruct;	// IMP=0x000000000025a1cd
...
- (long long)_ratingTypeForType:(id)arg1;	// IMP=0x000000000025a017
...
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000259823
- (id)initWithURLString:(id)arg1;	// IMP=0x00000000002597a8
