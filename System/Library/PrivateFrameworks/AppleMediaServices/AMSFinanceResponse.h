...
+ (id)valueForProtocolKey:(id)arg1 inResponse:(id)arg2;	// IMP=0x00600000001d4da0
- (void).cxx_destruct;	// IMP=0x00000000001d55cf
...
- (id)_valueForProtocolKey:(id)arg1;	// IMP=0x00000000001d54b1
- (id)_performerForPaymentSheetWithDelegateAuthentication:(_Bool)arg1;	// IMP=0x00000000001d5377
- (id)_performerForDialog;	// IMP=0x00000000001d5208
- (id)_performerForCreditDisplay;	// IMP=0x00000000001d5126
- (id)_performerForAuthenticate;	// IMP=0x00000000001d501e
- (id)_performerForActionDictionary;	// IMP=0x00000000001d4f6c
...
- (id)initWithTaskInfo:(id)arg1 decodedObject:(id)arg2;	// IMP=0x00000000001d443c
