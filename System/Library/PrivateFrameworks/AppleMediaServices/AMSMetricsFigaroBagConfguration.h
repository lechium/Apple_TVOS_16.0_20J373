...
+ (id)configurationWithBag:(id)arg1 error:(id *)arg2;	// IMP=0x006000000022ffc2
- (void).cxx_destruct;	// IMP=0x0000000000230901
...
- (id)_generateModifiersIfNeeded;	// IMP=0x0000000000230503
@property(readonly, nonatomic) NSArray *overrides; // @synthesize overrides=_overrides;
- (id)modifierForEvent:(id)arg1;	// IMP=0x00000000002301df
- (void)prepareForFlush;	// IMP=0x00000000002300d4
- (id)initWithMetricsDictionary:(id)arg1;	// IMP=0x000000000022ff0b
