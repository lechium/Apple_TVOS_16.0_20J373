...
+ (_Bool)isDelegateAuthChallengeForTaskInfo:(id)arg1;	// IMP=0x00100000001c8698
- (void).cxx_destruct;	// IMP=0x00000000001c89c2
...
- (id)performWithTaskInfo:(id)arg1;	// IMP=0x00000000001c8868
- (id)initWithResponseDictionary:(id)arg1 taskInfo:(id)arg2;	// IMP=0x00000000001c85ff
