...
- (void).cxx_destruct;	// IMP=0x00000000002a3088
...
- (id)_newSelectSQLWithProperties:(id)arg1 columns:(id)arg2;	// IMP=0x00000000002a291e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002a282c
