...
- (void).cxx_destruct;	// IMP=0x000000000019eff4
...
- (id)description;	// IMP=0x000000000019ed76
- (void)removeNode:(id)arg1;	// IMP=0x000000000019eb24
- (void)removeAllNodes;	// IMP=0x000000000019eaeb
- (id)insertObject:(id)arg1;	// IMP=0x000000000019ea7f
- (void)insertNode:(id)arg1;	// IMP=0x000000000019e90d
- (id)appendObject:(id)arg1;	// IMP=0x000000000019e8a1
- (void)appendNode:(id)arg1;	// IMP=0x000000000019e72f
@property(readonly, nonatomic) NSArray *allNodes;
- (id)init;	// IMP=0x000000000019e5fa
