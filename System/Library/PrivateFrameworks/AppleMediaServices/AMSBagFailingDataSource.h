...
- (void)setDefaultValue:(id)arg1 forKey:(id)arg2;	// IMP=0x0000000000243783
- (id)defaultValueForKey:(id)arg1;	// IMP=0x000000000024377b
- (id)valueForURLVariable:(id)arg1 account:(id)arg2;	// IMP=0x0000000000243773
- (void)loadWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000000024357e
@property(readonly, nonatomic, getter=isLoaded) _Bool loaded;
- (id)initWithProfile:(id)arg1 profileVersion:(id)arg2 error:(id)arg3 delay:(double)arg4;	// IMP=0x0000000000243479
