...
+ (id)sharedTaskQueue;	// IMP=0x00400000002d6a7a
+ (id)sharedTaskStore;	// IMP=0x00400000002d6a25
+ (void)removeTaskInfoForTask:(id)arg1;	// IMP=0x00400000002d5d6b
+ (id)createTaskInfoForTask:(id)arg1;	// IMP=0x00400000002d5b28
+ (id)taskInfoForTask:(id)arg1;	// IMP=0x00400000002d5950
- (void).cxx_destruct;	// IMP=0x00000000002d6b30
...
- (void)performSyncBlockWithExclusiveAccess:(CDUnknownBlockType)arg1;	// IMP=0x00000000002d6918
- (void)performSyncBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000002d6885
- (void)performAsyncBlockWithData:(CDUnknownBlockType)arg1;	// IMP=0x00000000002d672d
- (void)performAsyncBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000002d66cd
- (void)migrateFromTaskInfo:(id)arg1;	// IMP=0x00000000002d6591
- (id)createMetricsContextForDecodedObject:(id)arg1;	// IMP=0x00000000002d64ec
- (void)assertIsOnPrivateQueue;	// IMP=0x00000000002d64b7
- (void)assertHasExclusiveAccess;	// IMP=0x00000000002d6474
- (void)appendData:(id)arg1;	// IMP=0x00000000002d63f1
- (void)addRetryIdentifier:(id)arg1;	// IMP=0x00000000002d6398
...
- (id)initWithTask:(id)arg1;	// IMP=0x00000000002d5841
