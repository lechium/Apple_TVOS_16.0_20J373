...
- (void).cxx_destruct;	// IMP=0x000000000020f14d
...
- (id)_devicePlatform;	// IMP=0x000000000020ee01
- (void)_addSearchTerm:(id)arg1;	// IMP=0x000000000020ec1c
- (void)_addItemIdentifiers:(id)arg1;	// IMP=0x000000000020e9f3
- (void)_addCharts:(id)arg1;	// IMP=0x000000000020e8d4
- (void)_addBundleIdentifiers:(id)arg1;	// IMP=0x000000000020e72a
- (id)_queryItemsWithLanguage:(id)arg1;	// IMP=0x000000000020df32
- (id)_pathPromise;	// IMP=0x000000000020d9cf
- (id)_languagePromise;	// IMP=0x000000000020d5dd
- (id)_hostPromise;	// IMP=0x000000000020d518
- (id)_verifyConfiguration;	// IMP=0x000000000020d1fd
- (id)build;	// IMP=0x000000000020ce7d
- (id)initWithConfig:(id)arg1 clientVersion:(id)arg2 bag:(id)arg3;	// IMP=0x000000000020cda8
