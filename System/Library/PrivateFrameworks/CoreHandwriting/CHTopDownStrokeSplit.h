...
+ (id)writingDirectionOrderedStrokes:(id)arg1 substrokesByStrokeIdentifier:(id)arg2;	// IMP=0x00600000000e0a70
- (void).cxx_destruct;	// IMP=0x00000000000e0e80
...
- (long long)_substrokeCountForStrokes:(id)arg1 substrokesByStrokeIdentifier:(id)arg2;	// IMP=0x00000000000e07f0
- (id)initWithStrokes:(id)arg1 substrokesByStrokeIdentifier:(id)arg2 splitIndex:(long long)arg3;	// IMP=0x00000000000e02b0
