...
- (void).cxx_destruct;	// IMP=0x00000000000db1c0
...
- (void)dealloc;	// IMP=0x00000000000db040
- (id)initWithModelName:(id)arg1 featureIndex:(long long)arg2;	// IMP=0x00000000000d9e90
- (id)initWithModelName:(id)arg1;	// IMP=0x00000000000d9e70
