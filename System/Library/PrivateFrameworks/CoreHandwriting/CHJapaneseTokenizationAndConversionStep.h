...
- (void).cxx_destruct;	// IMP=0x00000000001b0d00
...
- (void)dealloc;	// IMP=0x00000000001b0b90
- (id)process:(id)arg1 options:(id)arg2;	// IMP=0x00000000001adf20
- (id)_extendedConversionCandidates:(id)arg1 withPhraseCandidates:(id)arg2;	// IMP=0x00000000001adc00
- (id)_updatedTokenFromToken:(id)arg1 withString:(id)arg2;	// IMP=0x00000000001ad940
- (id)initWithMecabra:(id)arg1 wordLanguageModel:(void *)arg2 ovsStringChecker:(id)arg3 promoteKanaConversion:(_Bool)arg4;	// IMP=0x00000000001ad830
