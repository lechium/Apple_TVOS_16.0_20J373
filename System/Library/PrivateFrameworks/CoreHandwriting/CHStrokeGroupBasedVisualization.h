...
- (void).cxx_destruct;	// IMP=0x00000000001015d0
...
- (void)_markStrokeGroupsAsActive:(id)arg1;	// IMP=0x00000000001012a0
- (void)toggleVisualizationRegionAtPoint:(struct CGPoint)arg1;	// IMP=0x0000000000100d80
- (void)drawVisualizationInRect:(struct CGRect)arg1 context:(struct CGContext *)arg2 viewBounds:(struct CGRect)arg3;	// IMP=0x0000000000100c40
- (void)recognitionSessionDidUpdateRecognitionResult;	// IMP=0x0000000000100740
- (struct CGRect)dirtyRectForStrokeGroup:(id)arg1;	// IMP=0x0000000000100700
