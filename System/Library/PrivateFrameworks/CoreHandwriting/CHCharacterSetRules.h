...
+ (unsigned long long)characterTypeFromString:(id)arg1;	// IMP=0x006000000015e090
+ (unsigned long long)characterType:(unsigned int)arg1;	// IMP=0x006000000015df40
+ (unsigned long long)expectedMaxDotCount:(unsigned int)arg1;	// IMP=0x006000000015ddf0
+ (unsigned long long)expectedMinStrokeCount:(unsigned int)arg1;	// IMP=0x006000000015dca0
+ (unsigned long long)expectedMaxStrokeCount:(unsigned int)arg1;	// IMP=0x006000000015db50
+ (id)sharedCharacterSetRules;	// IMP=0x006000000015dae0
- (id).cxx_construct;	// IMP=0x0000000000160690
- (void).cxx_destruct;	// IMP=0x00000000001604b0
...
- (unsigned long long)_expectedMaxDotCount:(unsigned int)arg1;	// IMP=0x000000000015fd90
- (unsigned long long)_characterType:(unsigned int)arg1;	// IMP=0x000000000015f6b0
- (unsigned long long)_expectedMinStrokeCount:(unsigned int)arg1;	// IMP=0x000000000015f110
- (unsigned long long)_expectedMaxStrokeCount:(unsigned int)arg1;	// IMP=0x000000000015e920
- (id)init;	// IMP=0x000000000015e1e0
