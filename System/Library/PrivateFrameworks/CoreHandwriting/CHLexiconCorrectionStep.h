...
+ (id)validatedTokenForCorrectedToken:(id)arg1 rawToken:(id)arg2;	// IMP=0x00600000001920f0
- (void).cxx_destruct;	// IMP=0x0000000000198680
...
- (id)process:(id)arg1 options:(id)arg2;	// IMP=0x00000000001969f0
- (id)createPseudoTokensFromToken:(id)arg1;	// IMP=0x0000000000195f80
- (id)applyCorrectionsAcrossToken:(id)arg1 isFirstToken:(_Bool)arg2 contextBeforeToken:(id)arg3 shouldCapitalizeGivenHistory:(_Bool)arg4 textReplacements:(id)arg5 isSingleIsolatedCharacter:(_Bool)arg6;	// IMP=0x0000000000195560
- (id)applyCorrectionsOnSingleToken:(id)arg1 isFirstToken:(_Bool)arg2 contextBeforeToken:(id)arg3 shouldCapitalizeGivenHistory:(_Bool)arg4 textReplacements:(id)arg5 isSingleIsolatedCharacter:(_Bool)arg6 allowSpellChecker:(_Bool)arg7;	// IMP=0x0000000000194250
- (id)applyLexiconCorrections:(id)arg1 shouldCapitalizeWord:(_Bool)arg2 shouldSkipEntryCorrection:(_Bool)arg3 outBestTokenIndex:(long long *)arg4 bestLexiconTokenScore:(double *)arg5 textReplacements:(id)arg6 contextBeforeToken:(id)arg7 allowSpellChecker:(_Bool)arg8;	// IMP=0x00000000001931d0
- (id)getSpellCorrectedToken:(id)arg1 contextBeforeToken:(id)arg2;	// IMP=0x0000000000192cf0
- (void)dealloc;	// IMP=0x0000000000192c10
- (id)initWithAutoCapitalizationMode:(int)arg1 shouldAutoCorrect:(_Bool)arg2 shouldAutoCapitalize:(_Bool)arg3 locale:(id)arg4 staticLexicon:(struct _LXLexicon *)arg5 customLexicon:(struct _LXLexicon *)arg6 phraseLexicon:(struct _LXLexicon *)arg7 customPhraseLexicon:(struct _LXLexicon *)arg8 spellChecker:(id)arg9 lmVocabulary:(void *)arg10 ovsStringChecker:(id)arg11 textReplacements:(id)arg12;	// IMP=0x0000000000192990
