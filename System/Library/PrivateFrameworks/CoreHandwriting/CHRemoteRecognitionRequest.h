...
+ (id)loadFromFile:(id)arg1;	// IMP=0x0010000000090c70
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000908c0
- (void).cxx_destruct;	// IMP=0x0000000000092700
...
- (id)description;	// IMP=0x0000000000092190
- (unsigned long long)hash;	// IMP=0x0000000000091ed0
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000091e50
- (_Bool)isEqualToRemoteRecognitionRequest:(id)arg1;	// IMP=0x0000000000091850
- (id)recognizerConfigurationKeyWithLocale:(id)arg1;	// IMP=0x0000000000090d20
@property(readonly, nonatomic) _Bool shouldRemoveUnnaturalGaps;
- (id)writeToFileInFolder:(id)arg1 basename:(id)arg2;	// IMP=0x00000000000908d0
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000090660
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000008fe30
- (id)initWithLocales:(id)arg1 recognitionMode:(int)arg2 drawing:(id)arg3 options:(id)arg4 priority:(long long)arg5;	// IMP=0x000000000008fc00
