...
+ (_Bool)supportsSecureCoding;	// IMP=0x006000000009e0c0
- (id).cxx_construct;	// IMP=0x000000000009e150
- (void).cxx_destruct;	// IMP=0x000000000009e0f0
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000009d650
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000009d1b0
- (struct CGPath *)newEstimatedBaselineForSubStrokes:(id)arg1 tokens:(id)arg2 tokenSubStrokeIndexes:(id)arg3 estimatedDescenderLocations:(id)arg4;	// IMP=0x000000000009b1d0
- (const struct CGPath *)newEstimatedBaselineForStrokesWithTokens:(id)arg1 tokenStrokeIdentifiers:(id)arg2;	// IMP=0x000000000009a8e0
- (id)coalescedLastSubstrokes;	// IMP=0x000000000009a8c0
- (long long)lastSubstrokeIndexBeforeMerge;	// IMP=0x000000000009a8a0
- (struct CGVector)averageStrokeDeviation;	// IMP=0x000000000009a880
- (struct CGVector)averageWritingOrientation;	// IMP=0x000000000009a860
- (struct CGVector)localWritingOrientationAtStrokeIndex:(long long)arg1;	// IMP=0x000000000009a840
- (void *)localStrokeWritingOrientations;	// IMP=0x000000000009a830
- (id)writingDirectionSortedSubstrokes;	// IMP=0x000000000009a810
- (id)groupByAddingStrokeIdentifiers:(id)arg1 removingStrokeIdentifiers:(id)arg2 firstStrokeIdentifier:(id)arg3 lastStrokeIdentifier:(id)arg4 bounds:(struct CGRect)arg5 writingDirectionSortedSubstrokes:(id)arg6 averageWritingOrientation:(struct CGVector)arg7 averageStrokeDeviation:(struct CGVector)arg8 writingDirectionSortedStrokeIdentifiers:(id)arg9 localStrokeWritingOrientations:(const void *)arg10 coalescedLastSubstrokes:(id)arg11 groupingConfidence:(double)arg12 lastSubstrokeIndexBeforeMerge:(long long)arg13 firstStrokeOrigin:(struct CGPoint)arg14;	// IMP=0x000000000009a600
