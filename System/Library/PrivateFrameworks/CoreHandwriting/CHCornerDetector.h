...
- (id).cxx_construct;	// IMP=0x0000000000079350
- (void).cxx_destruct;	// IMP=0x00000000000792d0
...
- (id)_resolveResampledDirectionChangePointIndexes:(id)arg1;	// IMP=0x0000000000078e90
- (_Bool)_isLine:(id)arg1 usingThreshold:(double)arg2 p1:(long long)arg3 p2:(long long)arg4;	// IMP=0x0000000000078dd0
- (long long)_strokeHalfwayCorner:(id)arg1 p1:(long long)arg2 p2:(long long)arg3;	// IMP=0x0000000000078bc0
- (id)_postProcessCorners:(id)arg1 corners:(id)arg2 straws:(id)arg3;	// IMP=0x00000000000788d0
- (void)_removeAdjacentCorners:(id)arg1 corners:(id)arg2 straws:(id)arg3;	// IMP=0x00000000000785f0
- (void)_removeColinearCorners:(id)arg1 usingDistanceThreshold:(double)arg2 usingLowerThreshold:(double)arg3 usingUpperThreshold:(double)arg4 corners:(id)arg5;	// IMP=0x0000000000078350
- (void)_removeColinearCorners:(id)arg1 usingThreshold:(double)arg2 corners:(id)arg3;	// IMP=0x00000000000781a0
- (double)_pathDistance:(id)arg1 p1:(long long)arg2 p2:(long long)arg3;	// IMP=0x00000000000780f0
- (double)_distance:(id)arg1 p1:(long long)arg2 p2:(long long)arg3;	// IMP=0x0000000000078030
- (double)_resamplingDistance:(id)arg1;	// IMP=0x0000000000077ee0
- (id)_resampleDrawing:(id)arg1 outputPointMap:(void *)arg2;	// IMP=0x0000000000077e60
- (void)_detectCorners;	// IMP=0x0000000000077300
- (unsigned long long)_detectDirectionalChanges;	// IMP=0x0000000000076ad0
- (id)directionChangeCornerIndexes;	// IMP=0x0000000000076a90
- (id)cornerIndexes;	// IMP=0x0000000000076a50
- (id)init;	// IMP=0x00000000000768a0
