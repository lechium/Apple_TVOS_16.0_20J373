...
+ (long long)indexForSegmentID:(id)arg1 fromSegments:(id)arg2;	// IMP=0x006000000005e490
+ (struct CGRect)boundingBoxFromSegmentID:(long long)arg1 toSegmentID:(long long)arg2 withSegments:(id)arg3 withSourceDrawing:(id)arg4;	// IMP=0x006000000005e310
+ (id)generateSegmentsFromDrawing:(id)arg1;	// IMP=0x006000000005e110
- (void).cxx_destruct;	// IMP=0x000000000005e660
...
- (_Bool)isSinglePointSegment;	// IMP=0x000000000005e070
- (long long)strokeCount;	// IMP=0x000000000005e020
- (id)strokeIndexSet;	// IMP=0x000000000005df60
- (id)initWithSegmentID:(id)arg1 startCutPoint:(id)arg2 endCutPoint:(id)arg3 referenceDrawing:(id)arg4;	// IMP=0x000000000005dd50
