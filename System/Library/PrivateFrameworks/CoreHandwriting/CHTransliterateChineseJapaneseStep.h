...
- (void)dealloc;	// IMP=0x00000000001a5ef0
- (id)handleChineseLigaturesInString:(id)arg1;	// IMP=0x00000000001a5d60
- (id)process:(id)arg1 options:(id)arg2;	// IMP=0x00000000001a50c0
- (id)initWithTransliterateSentences:(_Bool)arg1;	// IMP=0x00000000001a4fe0
