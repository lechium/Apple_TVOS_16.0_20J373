...
- (void).cxx_destruct;	// IMP=0x000000000018e6b0
...
- (_Bool)isValidForLocale:(id)arg1;	// IMP=0x000000000018e440
- (_Bool)meetsContextRequirementWithLeftContext:(id)arg1 rightContext:(id)arg2;	// IMP=0x000000000018e2b0
- (id)initWithConfusion:(id)arg1 correction:(id)arg2 locales:(id)arg3 leftContext:(id)arg4 rightContext:(id)arg5 requiresLexiconMatch:(_Bool)arg6;	// IMP=0x000000000018e1a0
