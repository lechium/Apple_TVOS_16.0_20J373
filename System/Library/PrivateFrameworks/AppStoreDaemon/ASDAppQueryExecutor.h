...
- (void).cxx_destruct;	// IMP=0x0000000000026c10
@property(nonatomic) long long queryOptions; // @synthesize queryOptions=_queryOptions;
- (void)executeQueryWithPredicate:(id)arg1 onPairedDevice:(id)arg2 withResultHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000025a8b
- (id)initWithServiceBroker:(id)arg1;	// IMP=0x00000000000259d2
- (id)init;	// IMP=0x00000000000259be
