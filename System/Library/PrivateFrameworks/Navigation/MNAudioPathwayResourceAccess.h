...
- (void).cxx_destruct;	// IMP=0x00000000000e1857
...
- (void)removeObserver:(id)arg1;	// IMP=0x00000000000e1823
- (void)addObserver:(id)arg1;	// IMP=0x00000000000e181d
- (id)initWithHFPEnabled:(_Bool)arg1;	// IMP=0x00000000000e17cf
