...
- (void).cxx_destruct;	// IMP=0x000000000001519c
...
- (id)initWithToken:(id)arg1;	// IMP=0x0000000000014df0
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000014c59
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000014852
