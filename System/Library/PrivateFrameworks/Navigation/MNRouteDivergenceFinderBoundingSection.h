...
- (id).cxx_construct;	// IMP=0x0000000000090acd
- (void).cxx_destruct;	// IMP=0x0000000000090aa5
...
- (void)_appendDescription:(id)arg1 indent:(unsigned long long)arg2;	// IMP=0x0000000000090931
- (id)description;	// IMP=0x00000000000907df
- (id)boundsDescription;	// IMP=0x00000000000906e8
- (id)treeDescription;	// IMP=0x0000000000090680
- (void)traverseWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000000905fd
- (id)leafSectionsIntersectingSection:(id)arg1 paddingMapPoints:(double)arg2;	// IMP=0x000000000009032a
