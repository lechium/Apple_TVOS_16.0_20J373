...
- (void).cxx_destruct;	// IMP=0x00000000000d3e94
@property(readonly, nonatomic) GEOComposedRouteLeg *arrivalLeg; // @synthesize arrivalLeg=_arrivalLeg;
@property(readonly, nonatomic) GEOComposedRoute *route; // @synthesize route=_route;
- (id)_arrivalRegionsDepartureConditions;	// IMP=0x00000000000d3c96
- (id)_defaultDepartureConditions;	// IMP=0x00000000000d3888
- (void)_initConditions;	// IMP=0x00000000000d364c
- (_Bool)allowDepartureForLocation:(id)arg1;	// IMP=0x00000000000d3052
@property(readonly, nonatomic) unsigned long long arrivalWaypointLegIndex;
- (id)initWithRoute:(id)arg1 arrivalLegIndex:(unsigned long long)arg2;	// IMP=0x00000000000d2f3c
