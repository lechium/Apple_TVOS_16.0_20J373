...
- (void).cxx_destruct;	// IMP=0x00000000000d2176
- (double)scoreForLocation:(id)arg1;	// IMP=0x00000000000d1dad
- (id)initWithUpdater:(id)arg1 distanceThreshold:(double)arg2;	// IMP=0x00000000000d1d15
