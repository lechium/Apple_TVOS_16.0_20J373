...
- (void).cxx_destruct;	// IMP=0x000000000001e6d5
@property(nonatomic) __weak id <MNArrivalRegionTimerDelegate> delegate; // @synthesize delegate=_delegate;
- (void)updateForLocation:(id)arg1;	// IMP=0x000000000001e341
- (void)dealloc;	// IMP=0x000000000001e2ff
- (id)initWithArrivalRegion:(id)arg1;	// IMP=0x000000000001e248
- (id)init;	// IMP=0x000000000001e21e
