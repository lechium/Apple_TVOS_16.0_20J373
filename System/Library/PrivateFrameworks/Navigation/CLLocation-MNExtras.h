...
+ (_Bool)_navigation_isLocation:(id)arg1 equalTo:(id)arg2;	// IMP=0x0020000000081b50
+ (id)_navigation_stringWithType:(int)arg1;	// IMP=0x00200000000814f2
- (CDStruct_39925896)_navigation_geoCoordinate3D;	// IMP=0x0010000000081e37
- (id)_navigation_geoLocation;	// IMP=0x0010000000081dcb
...
- (double)_navigation_speedAccuracy;	// IMP=0x0010000000081c5f
- (_Bool)_navigation_isEqualToLocationCoordinate:(struct CLLocationCoordinate2D)arg1;	// IMP=0x0010000000081bda
...
- (id)initWithGeoLocation:(id)arg1;	// IMP=0x001000000008168a
- (id)initWithCoordinate:(struct CLLocationCoordinate2D)arg1 rawCoordinate:(struct CLLocationCoordinate2D)arg2 course:(double)arg3 rawCourse:(double)arg4 courseAccuracy:(double)arg5 speed:(double)arg6 speedAccuracy:(double)arg7 altitude:(double)arg8 timestamp:(double)arg9 horizontalAccuracy:(double)arg10 verticalAccuracy:(double)arg11 type:(int)arg12 referenceFrame:(int)arg13 serializedCoarseMetaData:(id)arg14;	// IMP=0x001000000008152d
- (id)initWithCoordinate:(struct CLLocationCoordinate2D)arg1 rawCoordinate:(struct CLLocationCoordinate2D)arg2 course:(double)arg3 rawCourse:(double)arg4 courseAccuracy:(double)arg5 speed:(double)arg6 speedAccuracy:(double)arg7 altitude:(double)arg8 timestamp:(double)arg9 horizontalAccuracy:(double)arg10 verticalAccuracy:(double)arg11 type:(int)arg12 referenceFrame:(int)arg13;	// IMP=0x0010000000081515
@end
