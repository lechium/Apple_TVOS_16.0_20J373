...
+ (id)proactiveDevice;	// IMP=0x00100000000e18f4
- (void).cxx_destruct;	// IMP=0x00000000000e2973
...
- (void)_notifyDelegateOfPlayerStateChange;	// IMP=0x00000000000e27c7
- (void)_notifyDelegateOfStateChange;	// IMP=0x00000000000e26b2
- (void)controllerWillReloadForInvalidation:(id)arg1;	// IMP=0x00000000000e261e
- (void)controller:(id)arg1 didFailWithError:(id)arg2;	// IMP=0x00000000000e2528
- (void)controller:(id)arg1 didUpdateResponse:(id)arg2;	// IMP=0x00000000000e2516
- (void)controller:(id)arg1 didLoadResponse:(id)arg2;	// IMP=0x00000000000e244c
- (void)_checkIfAirPlayPossible;	// IMP=0x00000000000e220f
- (void)prepare;	// IMP=0x00000000000e2073
...
- (void)dealloc;	// IMP=0x00000000000e1c60
- (id)dictionaryRepresentation;	// IMP=0x00000000000e1a57
- (id)initWithUID:(id)arg1;	// IMP=0x00000000000e1924
