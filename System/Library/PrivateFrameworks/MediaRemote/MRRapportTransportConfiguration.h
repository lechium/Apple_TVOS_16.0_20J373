...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000001fdfa
- (void).cxx_destruct;	// IMP=0x0000000000020025
...
- (id)description;	// IMP=0x000000000001ff8c
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000001fe70
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000001fe02
