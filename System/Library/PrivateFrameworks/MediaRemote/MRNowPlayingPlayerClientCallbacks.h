...
- (void).cxx_destruct;	// IMP=0x00000000001d109f
...
- (_Bool)removePlaybackQueueDataSourceCallback:(id)arg1;	// IMP=0x00000000001d0e09
- (void)registerNowPlayingInfoArtworkAssetCallback:(id)arg1;	// IMP=0x00000000001d0a1c
- (void)registerNowPlayingInfoAssetCallbacks:(id)arg1;	// IMP=0x00000000001d0682
- (void)registerNowPlayingInfoCallbacks:(id)arg1;	// IMP=0x00000000001d01ea
- (void)registerNowPlayingInfoBackedPlaybackQueueDataSourceCallbacks;	// IMP=0x00000000001d0182
@property(readonly, copy, nonatomic) NSArray *commandHandlerBlocks;
- (void)removeCommandHandlerBlockForKey:(id)arg1;	// IMP=0x00000000001cff89
- (void)addCommandHandlerBlock:(CDUnknownBlockType)arg1 forKey:(id)arg2;	// IMP=0x00000000001cfe7b
- (unsigned long long)_onQueue_capabilities;	// IMP=0x00000000001cfda8
...
- (id)initWithPlayerPath:(id)arg1 queue:(id)arg2;	// IMP=0x00000000001ce923
