...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000016396d
- (void).cxx_destruct;	// IMP=0x00000000001639d7
...
- (id)description;	// IMP=0x0000000000163975
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001638c8
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000163524
- (id)initWithItem:(id)arg1 request:(id)arg2;	// IMP=0x0000000000163307
