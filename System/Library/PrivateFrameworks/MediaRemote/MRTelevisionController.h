...
+ (Class)externalDeviceClass;	// IMP=0x001000000016d5c6
- (void).cxx_destruct;	// IMP=0x000000000016d953
...
- (void)externalDeviceController:(id)arg1 didRemoveDevice:(id)arg2;	// IMP=0x000000000016d770
- (void)externalDeviceController:(id)arg1 didDiscoverDevice:(id)arg2;	// IMP=0x000000000016d5d7
- (id)init;	// IMP=0x000000000016d56d
