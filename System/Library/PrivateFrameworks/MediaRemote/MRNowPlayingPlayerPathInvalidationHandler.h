...
- (void).cxx_destruct;	// IMP=0x00000000001d896c
...
- (id)description;	// IMP=0x00000000001d8938
- (id)initWithPlayerPath:(id)arg1 queue:(id)arg2 invalidationCallback:(CDUnknownBlockType)arg3;	// IMP=0x00000000001d8819
