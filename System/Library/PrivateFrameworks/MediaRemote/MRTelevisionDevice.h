...
- (void).cxx_destruct;	// IMP=0x00000000000e89bf
...
- (void)handleTextActionPayload:(id)arg1;	// IMP=0x00000000000e87ca
- (void)wake;	// IMP=0x00000000000e87c4
- (void)exitHiliteMode;	// IMP=0x00000000000e87be
- (void)processVoiceInputAudioDataForDeviceID:(unsigned int)arg1 withBuffer:(id)arg2 time:(CDStruct_ace97b7a)arg3 gain:(float)arg4;	// IMP=0x00000000000e87b8
- (void)registerVoiceInputDeviceWithDescriptor:(id)arg1 replyQueue:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000000000e87b2
- (void)sendGameControllerEvent:(id)arg1 controllerID:(unsigned long long)arg2;	// IMP=0x00000000000e87ac
- (void)unregisterGameController:(unsigned long long)arg1;	// IMP=0x00000000000e87a6
- (void)registerGameControllerWithProperties:(id)arg1 queue:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000000000e87a0
- (void)getRTISessionWithReplyQueue:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000000e879a
- (void)clearActiveTextEditingSessionData;	// IMP=0x00000000000e8794
- (void)deleteBackwardInActiveTextEditingSession;	// IMP=0x00000000000e878e
- (void)setTextOnActiveTextEditingSessionWithText:(id)arg1;	// IMP=0x00000000000e8788
- (void)insertTextIntoActiveTextEditingSessionWithText:(id)arg1;	// IMP=0x00000000000e8782
- (void)getTextEditingSessionWithReplyQueue:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000000e877c
- (void)sendTouchEvent:(struct _MRHIDTouchEvent)arg1 toVirtualDeviceWithID:(unsigned long long)arg2;	// IMP=0x00000000000e8776
- (void)registerTouchDeviceWithDescriptor:(id)arg1 replyQueue:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000000000e8770
- (id)currentClientUpdatesConfigMessage;	// IMP=0x00000000000e865b
- (void)setHiliteModeCallback:(CDUnknownBlockType)arg1 withQueue:(id)arg2;	// IMP=0x00000000000e8655
- (void)setVoiceRecordingStateCallback:(CDUnknownBlockType)arg1 withQueue:(id)arg2;	// IMP=0x00000000000e864f
- (void)setRTICallback:(CDUnknownBlockType)arg1 withQueue:(id)arg2;	// IMP=0x00000000000e8649
- (void)setTextEditingCallback:(CDUnknownBlockType)arg1 withQueue:(id)arg2;	// IMP=0x00000000000e8643
- (void)setGameControllerPropertiesCallback:(CDUnknownBlockType)arg1 withQueue:(id)arg2;	// IMP=0x00000000000e863d
- (void)setGameControllerInputModeCallback:(CDUnknownBlockType)arg1 withQueue:(id)arg2;	// IMP=0x00000000000e8637
