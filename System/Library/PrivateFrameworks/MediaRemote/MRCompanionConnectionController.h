...
- (void).cxx_destruct;	// IMP=0x000000000013ac92
...
- (id)debugDescription;	// IMP=0x000000000013aa62
- (void)_maybeAttemptToDiscoverAndConnectToCompanionWithReason:(id)arg1;	// IMP=0x000000000013a38f
- (_Bool)_shouldAttemptToDiscoverAndConnectToCompanion;	// IMP=0x000000000013a2a9
- (void)_handleExternalDeviceConnectionStateDidChangeNotification:(id)arg1;	// IMP=0x000000000013a0ab
- (void)_handleCompanionDeviceConnectedNotification:(id)arg1;	// IMP=0x000000000013a092
- (id)init;	// IMP=0x0000000000139ad6
