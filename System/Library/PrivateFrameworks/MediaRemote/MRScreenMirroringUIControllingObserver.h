...
- (void).cxx_destruct;	// IMP=0x000000000002b269
...
- (void)_mirrorStateChanged:(_Bool)arg1 screenType:(unsigned int)arg2;	// IMP=0x000000000002b095
- (id)init;	// IMP=0x000000000002aea4
