...
- (void).cxx_destruct;	// IMP=0x0000000000111a7b
...
- (id)description;	// IMP=0x00000000001119ce
- (void)updateWithValue:(unsigned long long)arg1;	// IMP=0x000000000011192f
- (id)init;	// IMP=0x00000000001118d1
