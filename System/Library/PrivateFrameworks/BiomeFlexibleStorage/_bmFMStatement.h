...
- (void).cxx_destruct;	// IMP=0x000000000000e241
...
- (id)description;	// IMP=0x000000000000e158
- (void)reset;	// IMP=0x000000000000e136
- (void)close;	// IMP=0x000000000000e10c
- (void)dealloc;	// IMP=0x000000000000e0ce
