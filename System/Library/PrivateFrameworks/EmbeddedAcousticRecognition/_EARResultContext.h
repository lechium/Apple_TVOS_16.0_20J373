...
- (id).cxx_construct;	// IMP=0x000000000008fa5d
- (void).cxx_destruct;	// IMP=0x000000000008f9e8
...
- (void)updateLoggableResultWithCurrentResult:(const void *)arg1 currentCosts:(const void *)arg2 startMilliseconds:(unsigned int)arg3;	// IMP=0x000000000008f6ad
- (id)description;	// IMP=0x000000000008f5cf
- (void)resetPartialResultContext;	// IMP=0x000000000008f57c
- (void)addPartialResultToContext:(const void *)arg1;	// IMP=0x000000000008f3bf
- (void)incrementCountOfIsFinalFalseAlreadyWritten;	// IMP=0x000000000008f3b5
