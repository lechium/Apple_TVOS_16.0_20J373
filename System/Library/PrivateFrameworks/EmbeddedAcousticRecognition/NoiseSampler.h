...
- (id).cxx_construct;	// IMP=0x0000000000048b2e
- (void).cxx_destruct;	// IMP=0x0000000000048af4
- (unsigned long long)drawNoise;	// IMP=0x00000000000489fc
- (id)initWithUnigram:(float *)arg1 ofSize:(unsigned long long)arg2;	// IMP=0x00000000000481a6
- (id)initWithZipfOfSize:(unsigned long long)arg1;	// IMP=0x0000000000048030
- (id)init;	// IMP=0x0000000000048022
