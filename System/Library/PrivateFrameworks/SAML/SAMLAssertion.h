...
+ (id)createElement:(id *)arg1;	// IMP=0x006000000000b815
- (id)authorizationForResource:(id)arg1;	// IMP=0x000000000000c168
- (_Bool)isValidForRequestor:(id)arg1;	// IMP=0x000000000000bfc1
- (_Bool)meetsConditions:(id *)arg1;	// IMP=0x000000000000bf6e
- (_Bool)isValid:(id *)arg1;	// IMP=0x000000000000be51
