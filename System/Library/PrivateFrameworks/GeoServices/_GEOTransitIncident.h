...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000117b42b
- (void).cxx_destruct;	// IMP=0x000000000117c398
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000117b89e
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000117b546
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000117b49e
- (id)initWithIncident:(id)arg1;	// IMP=0x000000000117b433
