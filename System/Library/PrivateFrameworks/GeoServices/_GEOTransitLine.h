...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000117ca9d
- (void).cxx_destruct;	// IMP=0x000000000117cc67
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000117cbc7
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000117caa5
...
- (id)initWithLine:(id)arg1 system:(id)arg2 locationHint:(CDStruct_c3b9c2ee)arg3;	// IMP=0x000000000117c5b8
