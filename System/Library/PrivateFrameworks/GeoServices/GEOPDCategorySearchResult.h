...
- (void).cxx_destruct;	// IMP=0x000000000051f0c3
- (unsigned long long)hash;	// IMP=0x000000000051ee29
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000051e9ff
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000051e0ed
- (void)writeTo:(id)arg1;	// IMP=0x000000000051d51e
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000051d50f
- (id)jsonRepresentation;	// IMP=0x000000000051c9fd
- (id)dictionaryRepresentation;	// IMP=0x000000000051b7cd
- (id)description;	// IMP=0x000000000051b71e
- (id)initWithData:(id)arg1;	// IMP=0x0000000000518789
- (id)init;	// IMP=0x000000000051872d
