...
- (void).cxx_destruct;	// IMP=0x000000000041f4cc
- (unsigned long long)hash;	// IMP=0x000000000041ead8
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000041e6e1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000041e310
- (void)writeTo:(id)arg1;	// IMP=0x000000000041df7c
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000041df6f
- (id)jsonRepresentation;	// IMP=0x000000000041daf0
- (id)dictionaryRepresentation;	// IMP=0x000000000041d053
- (id)description;	// IMP=0x000000000041cfa4
- (id)initWithData:(id)arg1;	// IMP=0x000000000041c0a0
- (id)init;	// IMP=0x000000000041c044
