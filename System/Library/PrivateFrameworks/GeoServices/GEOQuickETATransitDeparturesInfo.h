...
- (void).cxx_destruct;	// IMP=0x00000000012c877c
...
- (id)_chooseMostImportantTransitLegInRoute:(id)arg1;	// IMP=0x00000000012c85f2
- (id)description;	// IMP=0x00000000012c8538
- (id)initWithComposedRoute:(id)arg1;	// IMP=0x00000000012c8493
