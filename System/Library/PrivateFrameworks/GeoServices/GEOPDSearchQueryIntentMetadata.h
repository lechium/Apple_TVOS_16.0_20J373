...
- (void).cxx_destruct;	// IMP=0x0000000000ae5486
- (unsigned long long)hash;	// IMP=0x0000000000ae5006
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000ae4957
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000ae410b
- (void)writeTo:(id)arg1;	// IMP=0x0000000000ae38b3
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000ae38a4
- (id)jsonRepresentation;	// IMP=0x0000000000ad68e7
- (id)dictionaryRepresentation;	// IMP=0x0000000000ad44b8
- (id)description;	// IMP=0x0000000000ad4409
- (void)dealloc;	// IMP=0x0000000000ad1bd0
- (id)initWithData:(id)arg1;	// IMP=0x0000000000ad1b74
- (id)init;	// IMP=0x0000000000ad1b18
