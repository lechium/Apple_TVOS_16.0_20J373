...
- (void).cxx_destruct;	// IMP=0x0000000000e0d846
- (unsigned long long)hash;	// IMP=0x0000000000e0d74f
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000e0d568
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000e0d2cd
- (void)writeTo:(id)arg1;	// IMP=0x0000000000e0d041
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000e0d032
- (id)jsonRepresentation;	// IMP=0x0000000000e0ca32
- (id)dictionaryRepresentation;	// IMP=0x0000000000e0c392
- (id)description;	// IMP=0x0000000000e0c2e3
- (id)initWithData:(id)arg1;	// IMP=0x0000000000e0b291
- (id)init;	// IMP=0x0000000000e0b235
