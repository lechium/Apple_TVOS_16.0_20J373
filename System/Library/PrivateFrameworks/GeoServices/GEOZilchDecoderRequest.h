...
- (id).cxx_construct;	// IMP=0x0000000001032929
- (void).cxx_destruct;	// IMP=0x0000000001032871
...
- (void)cancel;	// IMP=0x0000000001032778
- (void)decodeWithPathHandler:(CDUnknownBlockType)arg1 errorHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000010318d0
- (void)_finishedDecodingWithPath:(Path_3f73a495)arg1;	// IMP=0x0000000001031744
- (id)initWithDecoder:(id)arg1 message:(shared_ptr_27244a92)arg2;	// IMP=0x000000000103154c
