...
- (void).cxx_destruct;	// IMP=0x00000000007506e4
- (void)cancel;	// IMP=0x000000000075065e
- (void)submitWithHandler:(CDUnknownBlockType)arg1 networkActivity:(CDUnknownBlockType)arg2;	// IMP=0x0000000000750391
- (id)initWithVendorIdentifier:(id)arg1 mapItemIdentifier:(id)arg2 range:(struct _NSRange)arg3 traits:(id)arg4;	// IMP=0x000000000075024e
