...
- (void).cxx_destruct;	// IMP=0x0000000000aa5b1c
- (unsigned long long)hash;	// IMP=0x0000000000aa59a1
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000aa56f0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000aa53b4
- (void)writeTo:(id)arg1;	// IMP=0x0000000000aa50a9
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000aa509a
- (id)jsonRepresentation;	// IMP=0x0000000000aa4e1c
- (id)dictionaryRepresentation;	// IMP=0x0000000000aa4559
- (id)description;	// IMP=0x0000000000aa44aa
- (id)initWithData:(id)arg1;	// IMP=0x0000000000aa360a
- (id)init;	// IMP=0x0000000000aa35ae
