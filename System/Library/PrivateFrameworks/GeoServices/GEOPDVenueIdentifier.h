...
- (void).cxx_destruct;	// IMP=0x00000000011b9bd7
- (unsigned long long)hash;	// IMP=0x00000000011b96b1
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000011b946f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000011b91d7
- (void)writeTo:(id)arg1;	// IMP=0x00000000011b8eaf
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000011b8ea0
- (id)jsonRepresentation;	// IMP=0x00000000011b7b83
- (id)dictionaryRepresentation;	// IMP=0x00000000011b758d
- (id)description;	// IMP=0x00000000011b74de
- (void)dealloc;	// IMP=0x00000000011b621c
- (id)initWithData:(id)arg1;	// IMP=0x00000000011b61c0
- (id)init;	// IMP=0x00000000011b6164
- (id)initWithIdentifier:(id)arg1;	// IMP=0x0000000000a43884
- (id)initWithVenueID:(unsigned long long)arg1 featureID:(unsigned long long)arg2 businessID:(unsigned long long)arg3 componentIdentifier:(id)arg4;	// IMP=0x0000000000a4345d
- (id)initWithVenueID:(unsigned long long)arg1 featureID:(unsigned long long)arg2 businessID:(unsigned long long)arg3;	// IMP=0x0000000000a4335b
