...
- (void).cxx_destruct;	// IMP=0x0000000000af04d7
- (unsigned long long)hash;	// IMP=0x0000000000af01fb
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000aefe3a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000aef791
- (void)writeTo:(id)arg1;	// IMP=0x0000000000aef1d1
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000aef1c2
- (id)jsonRepresentation;	// IMP=0x0000000000aee2e3
- (id)dictionaryRepresentation;	// IMP=0x0000000000aed764
- (id)description;	// IMP=0x0000000000aed6b5
- (id)initWithData:(id)arg1;	// IMP=0x0000000000aec245
- (id)init;	// IMP=0x0000000000aec1e9
