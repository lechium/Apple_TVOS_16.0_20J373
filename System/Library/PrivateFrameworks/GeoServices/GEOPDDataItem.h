...
- (void).cxx_destruct;	// IMP=0x0000000000bef95c
- (unsigned long long)hash;	// IMP=0x0000000000bef40d
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000bef25b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000beefe7
- (void)writeTo:(id)arg1;	// IMP=0x0000000000beecf7
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000beece8
- (id)jsonRepresentation;	// IMP=0x0000000000bec9c2
- (id)dictionaryRepresentation;	// IMP=0x0000000000bec54c
- (id)description;	// IMP=0x0000000000bec49d
- (id)initWithData:(id)arg1;	// IMP=0x0000000000beb52b
- (id)init;	// IMP=0x0000000000beb4cf
- (id)locationName;	// IMP=0x0000000000a4270c
- (id)categoryName;	// IMP=0x0000000000a42691
