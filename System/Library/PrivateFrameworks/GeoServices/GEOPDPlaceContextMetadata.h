...
- (void).cxx_destruct;	// IMP=0x0000000000c8fa68
- (unsigned long long)hash;	// IMP=0x0000000000c8f7b1
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000c8f67c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000c8f471
- (void)writeTo:(id)arg1;	// IMP=0x0000000000c8f233
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000c8f224
- (id)jsonRepresentation;	// IMP=0x0000000000c8c7fb
- (id)dictionaryRepresentation;	// IMP=0x0000000000c8c347
- (id)description;	// IMP=0x0000000000c8c298
- (id)initWithData:(id)arg1;	// IMP=0x0000000000c8ba36
- (id)init;	// IMP=0x0000000000c8b9da
