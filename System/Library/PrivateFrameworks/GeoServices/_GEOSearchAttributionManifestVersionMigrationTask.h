...
- (void).cxx_destruct;	// IMP=0x0000000001284024
...
- (void)removeOldData:(id)arg1;	// IMP=0x00000000012837b3
- (void)_completeWithError:(id)arg1;	// IMP=0x0000000001283669
- (void)populateTileGroup:(id)arg1;	// IMP=0x0000000001283663
- (void)cancel;	// IMP=0x00000000012835d5
- (void)_handleResponse:(id)arg1 withData:(id)arg2 error:(id)arg3;	// IMP=0x0000000001283046
- (void)startWithCompletionHandler:(CDUnknownBlockType)arg1 callbackQueue:(id)arg2;	// IMP=0x0000000001282831
@property(readonly) NSProgress *progress;
@property(readonly, nonatomic) long long estimatedWeight;
- (void)dealloc;	// IMP=0x00000000012827ce
- (id)initWithMigrator:(id)arg1 newSearchAttributionManifestURL:(id)arg2 oldTileGroup:(id)arg3;	// IMP=0x00000000012825b8
- (id)init;	// IMP=0x000000000128258e
