...
- (void).cxx_destruct;	// IMP=0x000000000060c1e5
- (unsigned long long)hash;	// IMP=0x000000000060bcff
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000060b5f2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000060afec
- (void)writeTo:(id)arg1;	// IMP=0x000000000060a9d2
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000060a9c3
- (id)jsonRepresentation;	// IMP=0x000000000060a8b1
- (id)dictionaryRepresentation;	// IMP=0x0000000000608d74
- (id)description;	// IMP=0x0000000000608cc5
- (void)dealloc;	// IMP=0x0000000000604e0a
- (id)initWithData:(id)arg1;	// IMP=0x0000000000604dae
- (id)init;	// IMP=0x0000000000604d52
- (id)initWithSearchQuery:(id)arg1 entryMetadata:(id)arg2 metadata:(id)arg3 autocompleteEntry:(id)arg4 retainedSearch:(id)arg5 maxResults:(unsigned int)arg6 traits:(id)arg7 routeInfo:(id)arg8;	// IMP=0x000000000136c260
