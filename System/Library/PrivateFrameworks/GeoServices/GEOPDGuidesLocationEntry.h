...
- (void).cxx_destruct;	// IMP=0x0000000000c35092
- (unsigned long long)hash;	// IMP=0x0000000000c34fa4
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000c34ddc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000c34b56
- (void)writeTo:(id)arg1;	// IMP=0x0000000000c348a3
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000c34894
- (id)jsonRepresentation;	// IMP=0x0000000000c33bc0
- (id)dictionaryRepresentation;	// IMP=0x0000000000c33703
- (id)description;	// IMP=0x0000000000c33654
- (void)dealloc;	// IMP=0x0000000000c322c9
- (id)initWithData:(id)arg1;	// IMP=0x0000000000c3226d
- (id)init;	// IMP=0x0000000000c32211
