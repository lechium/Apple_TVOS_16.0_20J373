...
- (void).cxx_destruct;	// IMP=0x0000000000874b85
...
- (id)_placecardLayoutConfiguration;	// IMP=0x0000000000874b5d
- (id)_relatedPlaceListForComponentIdentifier:(int)arg1;	// IMP=0x0000000000874b55
...
- (id)_businessClaim;	// IMP=0x0000000000874b0d
- (_Bool)_hasBusinessClaim;	// IMP=0x0000000000874b05
- (id)_mapItemByStrippingOptionalData;	// IMP=0x0000000000874afc
@property(readonly, nonatomic, getter=_photos) NSArray *photos;
@property(readonly, nonatomic, getter=_reviews) NSArray *reviews;
- (id)_asPlaceInfo;	// IMP=0x0000000000874aa4
...
- (id)_yelpID;	// IMP=0x000000000087484a
...
- (id)_urlForWritingAReview;	// IMP=0x0000000000874832
- (id)_urlForReview:(id)arg1;	// IMP=0x000000000087482a
- (id)_urlForPhotoWithUID:(id)arg1;	// IMP=0x0000000000874822
...
- (_Bool)_hasLocalizedCategoryNamesForType:(unsigned int)arg1;	// IMP=0x000000000087479f
- (id)_localizedCategoryNamesForType:(unsigned int)arg1;	// IMP=0x0000000000874797
...
- (id)_arrivalMapRegionForTransportType:(int)arg1;	// IMP=0x00000000008743fa
- (unsigned int)_travelDistanceForTransportType:(int)arg1;	// IMP=0x00000000008743b8
- (unsigned int)_travelTimeForTransportType:(int)arg1;	// IMP=0x0000000000874376
- (_Bool)_hasTravelTimeForTransportType:(int)arg1;	// IMP=0x0000000000874359
- (int)_recommendedTransportType;	// IMP=0x000000000087434e
- (id)_spokenAddressForLocale:(id)arg1;	// IMP=0x0000000000874331
...
- (id)weatherDisplayName;	// IMP=0x0000000000874289
- (id)addressObject;	// IMP=0x00000000008741d6
...
- (id)spokenNameForLocale:(id)arg1;	// IMP=0x0000000000873bf7
@property(readonly, nonatomic) NSString *name;
@property(readonly, nonatomic) int referenceFrame;
@property(readonly, nonatomic, getter=isValid) _Bool valid;
- (_Bool)isEqualToMapItem:(id)arg1;	// IMP=0x0000000000873b3a
@property(readonly) unsigned long long hash;
@property(readonly, copy) NSString *description;
- (id)initWithPlace:(id)arg1;	// IMP=0x0000000000873956
- (id)initWithPlaceResult:(id)arg1;	// IMP=0x000000000087387d
