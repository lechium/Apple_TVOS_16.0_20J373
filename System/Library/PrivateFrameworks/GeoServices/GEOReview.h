...
- (void).cxx_destruct;	// IMP=0x0000000000ff9402
- (unsigned long long)hash;	// IMP=0x0000000000ff912a
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000ff8f29
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000ff8c8a
- (void)writeTo:(id)arg1;	// IMP=0x0000000000ff89b9
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000ff89aa
- (id)jsonRepresentation;	// IMP=0x0000000000ff8629
- (id)dictionaryRepresentation;	// IMP=0x0000000000ff7fcf
- (id)description;	// IMP=0x0000000000ff7f20
- (id)initWithData:(id)arg1;	// IMP=0x0000000000ff7527
- (id)init;	// IMP=0x0000000000ff74cb
