...
- (void).cxx_destruct;	// IMP=0x0000000000614450
- (unsigned long long)hash;	// IMP=0x000000000061408f
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000613a93
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000612d78
- (void)writeTo:(id)arg1;	// IMP=0x00000000006122ad
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000061229e
- (id)jsonRepresentation;	// IMP=0x000000000061218c
- (id)dictionaryRepresentation;	// IMP=0x00000000006104c2
- (id)description;	// IMP=0x0000000000610413
- (id)initWithData:(id)arg1;	// IMP=0x000000000060c393
- (id)init;	// IMP=0x000000000060c337
