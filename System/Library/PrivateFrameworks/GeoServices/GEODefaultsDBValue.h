...
+ (id)dbValue:(id)arg1 type:(id)arg2 value:(id)arg3;	// IMP=0x006000000029fc49
- (void).cxx_destruct;	// IMP=0x000000000029fd3e
...
- (id)initWithParent:(id)arg1 type:(id)arg2 value:(id)arg3;	// IMP=0x000000000029fb97
