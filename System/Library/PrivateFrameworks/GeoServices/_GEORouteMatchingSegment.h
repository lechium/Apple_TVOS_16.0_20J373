...
- (void).cxx_destruct;	// IMP=0x00000000011dac8f
...
- (id)description;	// IMP=0x00000000011dab2f
- (double)distanceFromCoordinate:(CDStruct_c3b9c2ee)arg1 outCoordinateOnSegment:(CDStruct_c3b9c2ee *)arg2 outRouteCoordinate:(struct PolylineCoordinate *)arg3;	// IMP=0x00000000011da9fe
