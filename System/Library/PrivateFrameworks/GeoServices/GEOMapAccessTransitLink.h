...
- (id).cxx_construct;	// IMP=0x000000000035b421
- (void).cxx_destruct;	// IMP=0x000000000035b39b
...
- (double)distanceInMetersFrom:(CDStruct_c3b9c2ee)arg1 outClosestCoordinateOnLine:(CDStruct_c3b9c2ee *)arg2;	// IMP=0x000000000035b16b
...
- (id)initWithMap:(id)arg1 transitEdge:(shared_ptr_24ebf3c0)arg2;	// IMP=0x000000000035ac4f
