...
- (void).cxx_destruct;	// IMP=0x0000000000aec185
- (unsigned long long)hash;	// IMP=0x0000000000aebe7e
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000aebafc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000aeb4a9
- (void)writeTo:(id)arg1;	// IMP=0x0000000000aeaee7
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000aeaed8
- (id)jsonRepresentation;	// IMP=0x0000000000aeaec9
- (id)dictionaryRepresentation;	// IMP=0x0000000000aea238
- (id)description;	// IMP=0x0000000000aea189
- (id)initWithData:(id)arg1;	// IMP=0x0000000000ae8b9e
- (id)init;	// IMP=0x0000000000ae8b42
