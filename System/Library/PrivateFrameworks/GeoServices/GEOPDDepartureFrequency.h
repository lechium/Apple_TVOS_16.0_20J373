...
+ (_Bool)isValid:(id)arg1;	// IMP=0x0010000000bf55d4
- (void).cxx_destruct;	// IMP=0x0000000000bf5ff6
- (void)clearUnknownFields:(_Bool)arg1;	// IMP=0x0000000000bf5fb0
@property(readonly, nonatomic) PBUnknownFields *unknownFields;
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000bf5ebd
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000bf5c6b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000bf5b62
- (void)copyTo:(id)arg1;	// IMP=0x0000000000bf5a84
- (void)writeTo:(id)arg1;	// IMP=0x0000000000bf597b
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000bf596c
- (void)readAll:(_Bool)arg1;	// IMP=0x0000000000bf4fc0
- (id)initWithJSON:(id)arg1;	// IMP=0x0000000000bf4fae
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000bf4c5d
- (id)jsonRepresentation;	// IMP=0x0000000000bf4b4b
- (id)dictionaryRepresentation;	// IMP=0x0000000000bf478b
...
- (_Bool)isValidAtDate:(id)arg1;	// IMP=0x000000000117e5f0
