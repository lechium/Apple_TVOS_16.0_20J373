...
+ (_Bool)isValid:(id)arg1;	// IMP=0x0010000000ea29f1
- (void).cxx_destruct;	// IMP=0x0000000000ea42fb
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000ea40df
- (unsigned long long)hash;	// IMP=0x0000000000ea3cd2
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000ea3916
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000ea3595
- (void)copyTo:(id)arg1;	// IMP=0x0000000000ea331d
- (void)writeTo:(id)arg1;	// IMP=0x0000000000ea2fb1
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000ea2fa4
- (void)readAll:(_Bool)arg1;	// IMP=0x0000000000ea27a6
- (id)initWithJSON:(id)arg1;	// IMP=0x0000000000ea2794
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000ea2024
- (id)jsonRepresentation;	// IMP=0x0000000000ea2015
- (id)dictionaryRepresentation;	// IMP=0x0000000000ea1a05
- (id)description;	// IMP=0x0000000000ea1956
...
- (id)initWithData:(id)arg1;	// IMP=0x0000000000ea0278
- (id)init;	// IMP=0x0000000000ea021c
