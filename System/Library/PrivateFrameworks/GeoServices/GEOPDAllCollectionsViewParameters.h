...
- (void).cxx_destruct;	// IMP=0x00000000004c25d5
- (unsigned long long)hash;	// IMP=0x00000000004c2383
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000004c2240
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000004c2013
- (void)writeTo:(id)arg1;	// IMP=0x00000000004c1d8c
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000004c1d7d
- (id)jsonRepresentation;	// IMP=0x00000000004c0d90
- (id)dictionaryRepresentation;	// IMP=0x00000000004c0a06
- (id)description;	// IMP=0x00000000004c0957
- (id)initWithData:(id)arg1;	// IMP=0x00000000004bfd1b
- (id)init;	// IMP=0x00000000004bfcbf
