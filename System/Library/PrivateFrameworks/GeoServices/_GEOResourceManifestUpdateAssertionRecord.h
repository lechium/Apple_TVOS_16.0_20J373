...
- (void).cxx_destruct;	// IMP=0x0000000000b2c2d3
...
- (id)initWithProcess:(id)arg1 reason:(id)arg2 creationTimestamp:(double)arg3;	// IMP=0x0000000000b2c145
- (id)init;	// IMP=0x0000000000b2c11b
