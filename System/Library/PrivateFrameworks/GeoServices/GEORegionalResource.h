...
- (void).cxx_destruct;	// IMP=0x00000000006d7790
- (unsigned long long)hash;	// IMP=0x00000000006d768a
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000006d74af
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000006d6f13
- (void)writeTo:(id)arg1;	// IMP=0x00000000006d69ff
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000006d69f0
- (id)jsonRepresentation;	// IMP=0x00000000006d666f
- (id)dictionaryRepresentation;	// IMP=0x00000000006d604f
- (id)description;	// IMP=0x00000000006d5fa0
- (void)dealloc;	// IMP=0x00000000006d4bf4
- (id)initWithData:(id)arg1;	// IMP=0x00000000006d4b98
- (id)init;	// IMP=0x00000000006d4b3c
