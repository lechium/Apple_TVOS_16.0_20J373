...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000013d5cbe
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000013d5e1c
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000013d5d6f
- (id)initWithWorkload:(unsigned long long)arg1 timeWindowDuration:(double)arg2;	// IMP=0x00000000013d5d21
- (id)initWithWorkload:(unsigned long long)arg1 timeWindowStartTime:(double)arg2 timeWindowDuration:(double)arg3;	// IMP=0x00000000013d5cc6
