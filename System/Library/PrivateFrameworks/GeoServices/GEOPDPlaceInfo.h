...
+ (id)placeInfoForPlaceData:(id)arg1;	// IMP=0x0010000000a3b891
- (void).cxx_destruct;	// IMP=0x0000000000c92469
- (unsigned long long)hash;	// IMP=0x0000000000c92267
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000c92039
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000c91d78
- (void)writeTo:(id)arg1;	// IMP=0x0000000000c91b07
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000c91af8
- (id)jsonRepresentation;	// IMP=0x0000000000c9120a
- (id)dictionaryRepresentation;	// IMP=0x0000000000c90c06
- (id)description;	// IMP=0x0000000000c90b57
- (id)initWithData:(id)arg1;	// IMP=0x0000000000c8fb17
- (id)init;	// IMP=0x0000000000c8fabb
