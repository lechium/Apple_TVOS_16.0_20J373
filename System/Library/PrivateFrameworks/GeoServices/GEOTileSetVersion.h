...
- (void).cxx_destruct;	// IMP=0x000000000138fb08
- (unsigned long long)hash;	// IMP=0x000000000138fa31
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000138f8d1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000138f6a0
- (void)writeTo:(id)arg1;	// IMP=0x000000000138f393
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000138f384
- (id)jsonRepresentation;	// IMP=0x000000000138f272
- (id)dictionaryRepresentation;	// IMP=0x000000000138ed1d
- (id)description;	// IMP=0x000000000138ec6e
- (void)dealloc;	// IMP=0x000000000138dda2
- (id)initWithData:(id)arg1;	// IMP=0x000000000138dd46
- (id)init;	// IMP=0x000000000138dcea
