...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000002b3d4f
...
- (id)description;	// IMP=0x00000000002b405e
- (double)currentReferenceTime;	// IMP=0x00000000002b3f61
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000002b3ea5
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000002b3dcc
- (id)initWithRefTime:(double)arg1 refError:(double)arg2 kernTime:(double)arg3 bootTime:(struct timeval)arg4;	// IMP=0x00000000002b3d57
