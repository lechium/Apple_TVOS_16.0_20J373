...
- (void).cxx_destruct;	// IMP=0x0000000000e075e8
- (unsigned long long)hash;	// IMP=0x0000000000e06cc8
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000e06b16
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000e068a2
- (void)writeTo:(id)arg1;	// IMP=0x0000000000e06417
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000e06408
- (id)jsonRepresentation;	// IMP=0x0000000000e01137
- (id)dictionaryRepresentation;	// IMP=0x0000000000e00c12
- (id)description;	// IMP=0x0000000000e00b63
- (id)initWithData:(id)arg1;	// IMP=0x0000000000dffbd2
- (id)init;	// IMP=0x0000000000dffb76
