...
+ (id)lineSectionsForNearbyTransitGroup:(id)arg1 departureSequenceContainers:(id)arg2 departureSequences:(id)arg3;	// IMP=0x001000000117fb79
- (void).cxx_destruct;	// IMP=0x000000000117fed6
...
- (id)initWithTransitScheduleGroup:(id)arg1 departureSequenceContainers:(id)arg2 scheduledDepartureSequences:(id)arg3 incidentsMap:(id)arg4;	// IMP=0x000000000117f94d
