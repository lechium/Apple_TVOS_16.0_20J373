...
- (void).cxx_destruct;	// IMP=0x0000000000c53576
- (unsigned long long)hash;	// IMP=0x0000000000c53486
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000c532e9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000c52f50
- (void)writeTo:(id)arg1;	// IMP=0x0000000000c52c16
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000c52c07
- (id)jsonRepresentation;	// IMP=0x0000000000c522ec
- (id)dictionaryRepresentation;	// IMP=0x0000000000c51d05
- (id)description;	// IMP=0x0000000000c51c56
- (id)initWithData:(id)arg1;	// IMP=0x0000000000c50bb8
- (id)init;	// IMP=0x0000000000c50b5c
