...
- (void).cxx_destruct;	// IMP=0x0000000000529fc5
- (unsigned long long)hash;	// IMP=0x0000000000529e7d
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000529c47
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000529987
- (void)writeTo:(id)arg1;	// IMP=0x0000000000529674
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000529665
- (id)jsonRepresentation;	// IMP=0x00000000005292e4
- (id)dictionaryRepresentation;	// IMP=0x0000000000528b93
- (id)description;	// IMP=0x0000000000528ae4
- (void)dealloc;	// IMP=0x00000000005278db
- (id)initWithData:(id)arg1;	// IMP=0x000000000052787f
- (id)init;	// IMP=0x0000000000527823
