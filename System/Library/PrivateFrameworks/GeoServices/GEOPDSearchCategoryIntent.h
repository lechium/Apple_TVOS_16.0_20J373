...
- (void).cxx_destruct;	// IMP=0x0000000000a994b5
- (unsigned long long)hash;	// IMP=0x0000000000a993d3
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000a991f1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000a98abc
- (void)writeTo:(id)arg1;	// IMP=0x0000000000a9845b
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000a9844c
- (id)jsonRepresentation;	// IMP=0x0000000000a981ce
- (id)dictionaryRepresentation;	// IMP=0x0000000000a97ba0
- (id)description;	// IMP=0x0000000000a97af1
- (id)initWithData:(id)arg1;	// IMP=0x0000000000a96a05
- (id)init;	// IMP=0x0000000000a969a9
