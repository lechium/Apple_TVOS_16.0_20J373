...
- (void).cxx_destruct;	// IMP=0x0000000000566909
- (unsigned long long)hash;	// IMP=0x0000000000566441
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000565fa5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000565af7
- (void)writeTo:(id)arg1;	// IMP=0x000000000056551f
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000565510
- (id)jsonRepresentation;	// IMP=0x000000000056518f
- (id)dictionaryRepresentation;	// IMP=0x00000000005642bf
- (id)description;	// IMP=0x0000000000564210
- (id)initWithData:(id)arg1;	// IMP=0x0000000000562405
- (id)init;	// IMP=0x00000000005623a9
