...
- (void).cxx_destruct;	// IMP=0x000000000119dfdd
- (unsigned long long)priority;	// IMP=0x000000000119dfd2
- (_Bool)updateRouteMatch:(id)arg1 previousRouteMatch:(id)arg2 forLocation:(id)arg3;	// IMP=0x000000000119ddcb
- (id)initWithRoute:(id)arg1 tripSegment:(id)arg2;	// IMP=0x000000000119dc01
