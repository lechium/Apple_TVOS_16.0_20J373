...
- (void).cxx_destruct;	// IMP=0x00000000007500ce
- (void)_handleResponse:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000074fe6e
- (void)_submitRequest:(id)arg1 auditToken:(id)arg2 timeout:(double)arg3 withHandler:(CDUnknownBlockType)arg4 networkActivity:(CDUnknownBlockType)arg5;	// IMP=0x000000000074fd11
- (void)_processRequest:(id)arg1 auditToken:(id)arg2 timeout:(double)arg3 withHandler:(CDUnknownBlockType)arg4 refinedHandler:(CDUnknownBlockType)arg5 networkActivity:(CDUnknownBlockType)arg6;	// IMP=0x000000000074f274
- (id)initWithRequest:(id)arg1 locationShifter:(CDUnknownBlockType)arg2 traits:(id)arg3;	// IMP=0x000000000074f1d3
