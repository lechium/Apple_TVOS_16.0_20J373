...
- (void).cxx_destruct;	// IMP=0x0000000000682ad7
- (unsigned long long)hash;	// IMP=0x0000000000682837
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000068268f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000006822fc
- (void)writeTo:(id)arg1;	// IMP=0x0000000000681fcb
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000681fbc
- (id)jsonRepresentation;	// IMP=0x00000000006811b4
- (id)dictionaryRepresentation;	// IMP=0x0000000000680bc7
- (id)description;	// IMP=0x0000000000680b18
- (id)initWithData:(id)arg1;	// IMP=0x000000000067fadc
- (id)init;	// IMP=0x000000000067fa80
