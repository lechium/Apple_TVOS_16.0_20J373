...
- (void).cxx_destruct;	// IMP=0x00000000011a4195
...
- (void)dataSession:(id)arg1 didCompleteTask:(id)arg2;	// IMP=0x00000000011a2416
- (void)dataSession:(id)arg1 shouldConvertDataTask:(id)arg2 toDownloadTaskForEstimatedResponseSize:(unsigned long long)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00000000011a2287
...
- (double)startTime;	// IMP=0x00000000011a210a
- (double)elapsed;	// IMP=0x00000000011a20ba
- (void)clearAllRelatedOperations;	// IMP=0x00000000011a2088
- (void)cancel;	// IMP=0x00000000011a1ee1
- (void)start;	// IMP=0x00000000011a18bc
@property(readonly, copy) NSString *description;
@property(readonly, nonatomic) unsigned long long contentLength;
@property(readonly, nonatomic) NSURL *URL;
@property unsigned int priority;
- (id)initWithRequest:(id)arg1 delegateQueue:(id)arg2 delegate:(id)arg3;	// IMP=0x00000000011a0fce
- (id)init;	// IMP=0x00000000011a0fc0
