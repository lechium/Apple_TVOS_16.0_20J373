...
- (void).cxx_destruct;	// IMP=0x00000000007626a4
- (id)firstFactoidForSemantic:(int)arg1;	// IMP=0x0000000000762547
- (id)factoidAtIndex:(int)arg1;	// IMP=0x0000000000762497
...
- (id)initWithPlaceData:(id)arg1 attributionMap:(id)arg2;	// IMP=0x0000000000761f0c
