...
- (void).cxx_destruct;	// IMP=0x000000000100378c
- (unsigned long long)hash;	// IMP=0x0000000001003682
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000100346b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000001002f99
- (void)writeTo:(id)arg1;	// IMP=0x0000000001002ad9
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000001002aca
- (id)jsonRepresentation;	// IMP=0x0000000001002749
- (id)dictionaryRepresentation;	// IMP=0x0000000001001d03
- (id)description;	// IMP=0x0000000001001c54
- (void)dealloc;	// IMP=0x0000000001000acb
- (id)initWithData:(id)arg1;	// IMP=0x0000000001000a6f
- (id)init;	// IMP=0x0000000001000a13
