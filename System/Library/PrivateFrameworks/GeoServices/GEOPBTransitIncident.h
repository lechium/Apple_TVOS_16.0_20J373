...
- (void).cxx_destruct;	// IMP=0x0000000000e44b49
- (unsigned long long)hash;	// IMP=0x0000000000e44748
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000e443ae
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000e43eb5
- (void)writeTo:(id)arg1;	// IMP=0x0000000000e43a0b
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000e439fc
- (id)jsonRepresentation;	// IMP=0x0000000000e41a04
- (id)dictionaryRepresentation;	// IMP=0x0000000000e41074
- (id)description;	// IMP=0x0000000000e40fc5
- (id)initWithData:(id)arg1;	// IMP=0x0000000000e3f164
- (id)init;	// IMP=0x0000000000e3f108
