...
+ (id)factoidsForPlaceData:(id)arg1;	// IMP=0x0010000000a413a5
+ (_Bool)factoidPairAvailableForPlaceData:(id)arg1;	// IMP=0x0010000000a412ab
- (void).cxx_destruct;	// IMP=0x0000000000c28490
- (unsigned long long)hash;	// IMP=0x0000000000c28246
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000c27ff3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000c27be7
- (void)writeTo:(id)arg1;	// IMP=0x0000000000c27847
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000c27838
- (id)jsonRepresentation;	// IMP=0x0000000000c26d08
- (id)dictionaryRepresentation;	// IMP=0x0000000000c26643
- (id)description;	// IMP=0x0000000000c26594
- (id)initWithData:(id)arg1;	// IMP=0x0000000000c25167
- (id)init;	// IMP=0x0000000000c2510b
- (id)bestLocalizedPlaceName;	// IMP=0x0000000000a414f8
