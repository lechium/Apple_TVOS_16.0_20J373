...
- (void).cxx_destruct;	// IMP=0x0000000000b00c19
- (unsigned long long)hash;	// IMP=0x0000000000b003d8
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000afffdb
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000affaf2
- (void)writeTo:(id)arg1;	// IMP=0x0000000000aff652
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000aff643
- (id)jsonRepresentation;	// IMP=0x0000000000aff634
- (id)dictionaryRepresentation;	// IMP=0x0000000000afeb9f
- (id)description;	// IMP=0x0000000000afeaf0
- (void)dealloc;	// IMP=0x0000000000afd8a8
- (id)initWithData:(id)arg1;	// IMP=0x0000000000afd84c
- (id)init;	// IMP=0x0000000000afd7f0
