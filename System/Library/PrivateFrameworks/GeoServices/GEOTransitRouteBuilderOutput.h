...
- (void).cxx_destruct;	// IMP=0x000000000139b430
...
- (void)setSectionOptions:(id)arg1;	// IMP=0x000000000139b3ea
- (void)setRideSelections:(id)arg1;	// IMP=0x000000000139b3d6
- (void)setIsWalkingOnlyRoute:(_Bool)arg1;	// IMP=0x000000000139b3c6
