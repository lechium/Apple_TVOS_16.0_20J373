...
- (void).cxx_destruct;	// IMP=0x00000000009fc660
- (_Bool)isFinished;	// IMP=0x00000000009fc650
- (_Bool)isExecuting;	// IMP=0x00000000009fc640
- (void)_completeOperation;	// IMP=0x00000000009fc57c
- (void)start;	// IMP=0x00000000009fc4ce
- (id)initWithRemoteProxy:(id)arg1 runQueue:(id)arg2 completionQueue:(id)arg3 completionBlock:(CDUnknownBlockType)arg4;	// IMP=0x00000000009fc393
