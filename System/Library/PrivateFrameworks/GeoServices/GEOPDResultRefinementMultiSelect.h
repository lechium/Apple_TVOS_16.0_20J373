...
- (void).cxx_destruct;	// IMP=0x0000000000e15e96
- (unsigned long long)hash;	// IMP=0x0000000000e15d90
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000e15bb4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000e157f9
- (void)writeTo:(id)arg1;	// IMP=0x0000000000e154a4
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000e15495
- (id)jsonRepresentation;	// IMP=0x0000000000e15114
- (id)dictionaryRepresentation;	// IMP=0x0000000000e14b06
- (id)description;	// IMP=0x0000000000e14a57
- (id)initWithData:(id)arg1;	// IMP=0x0000000000e137fa
- (id)init;	// IMP=0x0000000000e1379e
