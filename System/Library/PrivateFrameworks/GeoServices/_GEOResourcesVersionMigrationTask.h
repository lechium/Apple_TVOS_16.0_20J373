...
+ (id)_resourcesDirectory:(id)arg1;	// IMP=0x0010000000a2fafa
+ (Class)_resourceLoaderClass;	// IMP=0x0010000000a2fae9
- (void).cxx_destruct;	// IMP=0x0000000000a33680
...
- (id)_staleResourceForResource:(id)arg1;	// IMP=0x0000000000a324db
- (void)_loadImmediateResources:(id)arg1 conditionalWifiResources:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000a31c60
- (void)removeOldData:(id)arg1;	// IMP=0x0000000000a31376
- (void)populateTileGroup:(id)arg1;	// IMP=0x0000000000a30e87
- (void)cancel;	// IMP=0x0000000000a30c68
- (void)startWithCompletionHandler:(CDUnknownBlockType)arg1 callbackQueue:(id)arg2;	// IMP=0x0000000000a2fb53
- (id)_resourcesDirectory;	// IMP=0x0000000000a2fb2b
@property(readonly) NSProgress *progress;
@property(readonly, nonatomic) long long estimatedWeight;
- (id)initWithMigrator:(id)arg1 manifestConfiguration:(id)arg2 newTileGroup:(id)arg3 inResourceManifest:(id)arg4 dataSet:(id)arg5 oldTileGroup:(id)arg6 activeScales:(id)arg7 activeScenarios:(id)arg8;	// IMP=0x0000000000a2f833
- (id)init;	// IMP=0x0000000000a2f809
