...
- (void).cxx_destruct;	// IMP=0x00000000004ffa03
- (unsigned long long)hash;	// IMP=0x00000000004ff772
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000004ff357
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000004fec84
- (void)writeTo:(id)arg1;	// IMP=0x00000000004fdf29
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000004fdf1a
- (id)jsonRepresentation;	// IMP=0x00000000004fd56a
- (id)dictionaryRepresentation;	// IMP=0x00000000004fc692
- (id)description;	// IMP=0x00000000004fc5e3
- (id)initWithData:(id)arg1;	// IMP=0x00000000004fa596
- (id)init;	// IMP=0x00000000004fa53a
