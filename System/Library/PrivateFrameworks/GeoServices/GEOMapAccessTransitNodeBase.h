...
- (id).cxx_construct;	// IMP=0x0000000000359a11
- (void).cxx_destruct;	// IMP=0x00000000003599c9
...
- (id)findAccessPoints:(CDUnknownBlockType)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000035998a
- (double)distanceInMetersFrom:(CDStruct_c3b9c2ee)arg1;	// IMP=0x000000000035994f
- (id)findGeometryWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000000003596af
@property(readonly, copy) NSString *description;
@property(readonly, nonatomic) NSString *internalName;
@property(readonly, nonatomic) unsigned long long transitID;
@property(readonly, nonatomic) CDStruct_c3b9c2ee coordinate;
- (void)dealloc;	// IMP=0x0000000000359585
- (id)initWithMap:(id)arg1 node:(shared_ptr_52e51bdf)arg2;	// IMP=0x0000000000359496
