...
- (void).cxx_destruct;	// IMP=0x0000000000329863
- (unsigned long long)hash;	// IMP=0x00000000003293d5
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000003290ee
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000328c9d
- (void)writeTo:(id)arg1;	// IMP=0x00000000003287d5
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000003287c6
- (id)jsonRepresentation;	// IMP=0x0000000000328548
- (id)dictionaryRepresentation;	// IMP=0x0000000000327c0e
- (id)description;	// IMP=0x0000000000327b5f
- (void)dealloc;	// IMP=0x00000000003267d4
- (id)initWithData:(id)arg1;	// IMP=0x0000000000326778
- (id)init;	// IMP=0x000000000032671c
