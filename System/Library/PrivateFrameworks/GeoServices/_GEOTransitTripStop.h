...
+ (id)transitTripStopsForPlaceData:(id)arg1;	// IMP=0x00100000011138a3
- (void).cxx_destruct;	// IMP=0x000000000111406c
...
- (id)initWithTransitSnippet:(id)arg1 departureSequence:(id)arg2;	// IMP=0x0000000001113d40
