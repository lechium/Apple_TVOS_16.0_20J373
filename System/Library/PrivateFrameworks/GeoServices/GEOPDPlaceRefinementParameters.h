...
- (void).cxx_destruct;	// IMP=0x000000000059ebcf
- (unsigned long long)hash;	// IMP=0x000000000059e755
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000059e4b9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000059e05f
- (void)writeTo:(id)arg1;	// IMP=0x000000000059dc07
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000059dbf8
- (id)jsonRepresentation;	// IMP=0x000000000059c7f8
- (id)dictionaryRepresentation;	// IMP=0x000000000059bf24
- (id)description;	// IMP=0x000000000059be75
- (id)initWithData:(id)arg1;	// IMP=0x000000000059a7bb
- (id)init;	// IMP=0x000000000059a75f
- (_Bool)_routeHypothesisPlaceRefinementParametersIsEqual:(id)arg1;	// IMP=0x000000000114e4e6
- (unsigned long long)_routeHypothesisPlaceRefinementParametersHash;	// IMP=0x000000000114e471
- (_Bool)_hasRequiredFields;	// IMP=0x000000000114e445
- (id)initWithSearchURLQuery:(id)arg1 identifier:(id)arg2;	// IMP=0x000000000136b8be
- (id)initWithMapItemToRefine:(id)arg1 coordinate:(CDStruct_c3b9c2ee)arg2;	// IMP=0x000000000136b61a
- (id)initWithIdentifier:(id)arg1 placeNameHint:(id)arg2 locationHint:(CDStruct_c3b9c2ee)arg3;	// IMP=0x000000000136b3f4
