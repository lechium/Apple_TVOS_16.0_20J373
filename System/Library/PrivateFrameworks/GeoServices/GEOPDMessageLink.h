...
+ (id)messageLinkForPlaceData:(id)arg1;	// IMP=0x0010000000a41884
- (void).cxx_destruct;	// IMP=0x0000000000c564db
- (unsigned long long)hash;	// IMP=0x0000000000c563bb
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000c5619e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000c55da2
- (void)writeTo:(id)arg1;	// IMP=0x0000000000c55a2d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000c55a1e
- (id)jsonRepresentation;	// IMP=0x0000000000c55844
- (id)dictionaryRepresentation;	// IMP=0x0000000000c551ee
- (id)description;	// IMP=0x0000000000c5513f
- (id)initWithData:(id)arg1;	// IMP=0x0000000000c53ca5
- (id)init;	// IMP=0x0000000000c53c49
