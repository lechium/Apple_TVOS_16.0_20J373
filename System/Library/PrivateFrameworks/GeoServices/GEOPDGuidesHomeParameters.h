...
- (void).cxx_destruct;	// IMP=0x0000000000538852
- (unsigned long long)hash;	// IMP=0x0000000000538793
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000538614
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000005383d8
- (void)writeTo:(id)arg1;	// IMP=0x00000000005380fb
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000005380ec
- (id)jsonRepresentation;	// IMP=0x0000000000537d6b
- (id)dictionaryRepresentation;	// IMP=0x0000000000537727
- (id)description;	// IMP=0x0000000000537678
- (void)dealloc;	// IMP=0x00000000005363d6
- (id)initWithData:(id)arg1;	// IMP=0x000000000053637a
- (id)init;	// IMP=0x000000000053631e
