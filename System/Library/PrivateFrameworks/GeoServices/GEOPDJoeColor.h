...
- (void).cxx_destruct;	// IMP=0x0000000000c3eba6
- (unsigned long long)hash;	// IMP=0x0000000000c3eacd
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000c3e916
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000c3e695
- (void)writeTo:(id)arg1;	// IMP=0x0000000000c3e469
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000c3e45a
- (id)jsonRepresentation;	// IMP=0x0000000000c3e348
- (id)dictionaryRepresentation;	// IMP=0x0000000000c3dd64
- (id)description;	// IMP=0x0000000000c3dcb5
- (id)initWithData:(id)arg1;	// IMP=0x0000000000c3d166
- (id)init;	// IMP=0x0000000000c3d10a
