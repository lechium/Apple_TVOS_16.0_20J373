...
+ (id)_etaFilterWithTransportTypes:(int *)arg1 transportTypesCount:(unsigned long long)arg2 automobileOptions:(id)arg3 transitOptions:(id)arg4 walkingOptions:(id)arg5 cyclingOptions:(id)arg6;	// IMP=0x0010000000a440e0
+ (id)etaFilterForRouteAttributes:(id)arg1;	// IMP=0x0010000000a43eb9
+ (id)etaFilterForTraits:(id)arg1;	// IMP=0x0010000000a43c93
- (void).cxx_destruct;	// IMP=0x0000000000c080eb
- (unsigned long long)hash;	// IMP=0x0000000000c07fa0
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000c07d4e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000c07a84
- (void)writeTo:(id)arg1;	// IMP=0x0000000000c077e0
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000c077d1
- (id)jsonRepresentation;	// IMP=0x0000000000c06ec3
- (id)dictionaryRepresentation;	// IMP=0x0000000000c06607
- (id)description;	// IMP=0x0000000000c06558
- (void)dealloc;	// IMP=0x0000000000c0524a
- (id)initWithData:(id)arg1;	// IMP=0x0000000000c051ee
- (id)init;	// IMP=0x0000000000c05192
