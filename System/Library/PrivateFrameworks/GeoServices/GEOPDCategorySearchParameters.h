...
- (void).cxx_destruct;	// IMP=0x0000000000518663
- (unsigned long long)hash;	// IMP=0x0000000000518098
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000517beb
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000051775a
- (void)writeTo:(id)arg1;	// IMP=0x00000000005171d7
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000005171c8
- (id)jsonRepresentation;	// IMP=0x0000000000516957
- (id)dictionaryRepresentation;	// IMP=0x00000000005156f5
- (id)description;	// IMP=0x0000000000515646
- (void)dealloc;	// IMP=0x000000000051295e
- (id)initWithData:(id)arg1;	// IMP=0x0000000000512902
- (id)init;	// IMP=0x00000000005128a6
