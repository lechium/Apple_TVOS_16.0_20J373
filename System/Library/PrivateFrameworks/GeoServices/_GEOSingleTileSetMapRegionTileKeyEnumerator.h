...
- (void).cxx_destruct;	// IMP=0x0000000001232623
@property(readonly, nonatomic) unsigned long long count;
- (_Bool)continueEnumeratingTileKeysWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000001232242
- (id)initWithMapRegion:(id)arg1 tileSet:(id)arg2 zoomMode:(long long)arg3;	// IMP=0x0000000001231f8a
