...
+ (id)captionedPhotosForPlaceData:(id)arg1;	// IMP=0x0010000000a402ea
- (void).cxx_destruct;	// IMP=0x0000000000b656d0
- (unsigned long long)hash;	// IMP=0x0000000000b64e57
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000b64b0d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000b6478a
- (void)writeTo:(id)arg1;	// IMP=0x0000000000b6447f
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000b64470
- (id)jsonRepresentation;	// IMP=0x0000000000b62fc4
- (id)dictionaryRepresentation;	// IMP=0x0000000000b6293c
- (id)description;	// IMP=0x0000000000b6288d
- (id)initWithData:(id)arg1;	// IMP=0x0000000000b60ef6
- (id)init;	// IMP=0x0000000000b60e9a
