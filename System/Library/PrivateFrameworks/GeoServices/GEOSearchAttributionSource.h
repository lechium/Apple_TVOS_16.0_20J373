...
- (void).cxx_destruct;	// IMP=0x00000000010caa20
- (unsigned long long)hash;	// IMP=0x00000000010ca8ee
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000010ca6b4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000010ca011
- (void)writeTo:(id)arg1;	// IMP=0x00000000010c99e5
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000010c99d6
- (id)jsonRepresentation;	// IMP=0x00000000010c99c7
- (id)dictionaryRepresentation;	// IMP=0x00000000010c8ff1
- (id)description;	// IMP=0x00000000010c8f42
- (void)dealloc;	// IMP=0x00000000010c738c
- (id)initWithData:(id)arg1;	// IMP=0x00000000010c7330
- (id)init;	// IMP=0x00000000010c72d4
