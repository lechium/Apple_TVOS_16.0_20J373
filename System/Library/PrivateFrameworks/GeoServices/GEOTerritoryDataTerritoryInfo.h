...
- (void).cxx_destruct;	// IMP=0x0000000000d75d5f
- (unsigned long long)hash;	// IMP=0x0000000000d75c74
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000d75ac3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000d75880
- (void)writeTo:(id)arg1;	// IMP=0x0000000000d755c0
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000d755b3
- (id)jsonRepresentation;	// IMP=0x0000000000d75343
- (id)dictionaryRepresentation;	// IMP=0x0000000000d74e57
- (id)description;	// IMP=0x0000000000d74da8
- (void)dealloc;	// IMP=0x0000000000d73e39
- (id)initWithData:(id)arg1;	// IMP=0x0000000000d73ddd
- (id)init;	// IMP=0x0000000000d73d81
