...
- (void).cxx_destruct;	// IMP=0x0000000001420da6
- (unsigned long long)hash;	// IMP=0x0000000001420c9e
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000001420acc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000001420647
- (void)writeTo:(id)arg1;	// IMP=0x00000000014200ab
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000000142009c
- (id)jsonRepresentation;	// IMP=0x000000000141eed8
- (id)dictionaryRepresentation;	// IMP=0x000000000141e69b
- (id)description;	// IMP=0x000000000141e5ec
- (id)initWithData:(id)arg1;	// IMP=0x000000000141d372
- (id)init;	// IMP=0x000000000141d316
