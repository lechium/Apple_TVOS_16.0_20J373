...
- (void).cxx_destruct;	// IMP=0x0000000000557a29
- (unsigned long long)hash;	// IMP=0x00000000005577f0
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000557609
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000055736e
- (void)writeTo:(id)arg1;	// IMP=0x00000000005570d8
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000005570c9
- (id)jsonRepresentation;	// IMP=0x000000000055686e
- (id)dictionaryRepresentation;	// IMP=0x00000000005563a4
- (id)description;	// IMP=0x00000000005562f5
- (id)initWithData:(id)arg1;	// IMP=0x000000000055519a
- (id)init;	// IMP=0x000000000055513e
