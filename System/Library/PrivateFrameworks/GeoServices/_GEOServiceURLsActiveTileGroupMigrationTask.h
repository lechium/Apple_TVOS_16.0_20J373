...
- (void).cxx_destruct;	// IMP=0x000000000119ef4f
...
- (void)removeOldData:(id)arg1;	// IMP=0x000000000119ef13
- (void)populateTileGroup:(id)arg1;	// IMP=0x000000000119eea3
- (void)cancel;	// IMP=0x000000000119ee9d
- (void)startWithCompletionHandler:(CDUnknownBlockType)arg1 callbackQueue:(id)arg2;	// IMP=0x000000000119edbb
@property(readonly) NSProgress *progress;
@property(readonly, nonatomic) long long estimatedWeight;
- (id)initWithMigrator:(id)arg1 manifestConfiguration:(id)arg2 newTileGroup:(id)arg3 inResourceManifest:(id)arg4 oldTileGroup:(id)arg5 dataSet:(id)arg6;	// IMP=0x000000000119ec33
- (id)init;	// IMP=0x000000000119ec09
