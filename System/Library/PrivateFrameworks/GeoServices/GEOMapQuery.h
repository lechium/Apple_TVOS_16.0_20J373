...
- (void).cxx_destruct;	// IMP=0x0000000000d6dbd8
- (unsigned long long)hash;	// IMP=0x0000000000d6d96c
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000d6d5f1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000d6d255
- (void)writeTo:(id)arg1;	// IMP=0x0000000000d6cc93
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000d6cc86
- (id)jsonRepresentation;	// IMP=0x0000000000d6ca16
- (id)dictionaryRepresentation;	// IMP=0x0000000000d6c2af
- (id)description;	// IMP=0x0000000000d6c200
- (id)initWithData:(id)arg1;	// IMP=0x0000000000d6af0b
- (id)init;	// IMP=0x0000000000d6aeaf
