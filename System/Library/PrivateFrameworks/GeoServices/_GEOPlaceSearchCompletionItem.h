...
- (void).cxx_destruct;	// IMP=0x0000000000754bb7
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000007547a9
@property(readonly, nonatomic) NSData *metadata;
@property(readonly, nonatomic) NSData *entryMetadata;
- (void)sendFeedback;	// IMP=0x00000000007546b3
- (_Bool)getCoordinate:(CDStruct_c3b9c2ee *)arg1;	// IMP=0x0000000000754541
...
- (id)calloutTitle;	// IMP=0x00000000007541a2
- (id)queryLine;	// IMP=0x0000000000754083
- (id)highlightsForLine:(unsigned long long)arg1;	// IMP=0x0000000000754034
- (id)initWithEntry:(id)arg1 traits:(id)arg2 entryListIndex:(int)arg3 entryIndex:(int)arg4 mapItems:(id)arg5 collections:(id)arg6 publishers:(id)arg7;	// IMP=0x0000000000752a72
