...
+ (Class)eaProtocolStringsType;	// IMP=0x00100000000069ec
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000006114
- (unsigned long long)hash;	// IMP=0x000000000000550d
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000004dc6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000004740
- (void)copyTo:(id)arg1;	// IMP=0x00000000000042b3
- (void)writeTo:(id)arg1;	// IMP=0x0000000000003d60
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000002d7b
- (id)dictionaryRepresentation;	// IMP=0x00000000000022e2
- (id)description;	// IMP=0x0000000000002233
...
- (id)eaProtocolStringsAtIndex:(unsigned long long)arg1;	// IMP=0x0000000000002177
- (unsigned long long)eaProtocolStringsCount;	// IMP=0x000000000000215a
- (void)addEaProtocolStrings:(id)arg1;	// IMP=0x00000000000020f0
- (void)clearEaProtocolStrings;	// IMP=0x00000000000020d3
