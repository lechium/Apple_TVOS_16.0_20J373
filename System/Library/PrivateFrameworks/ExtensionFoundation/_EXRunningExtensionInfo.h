...
+ (id)extensionInfoForCurrentProcess;	// IMP=0x0010000000019daf
+ (void)notifyExtensionMainCalled;	// IMP=0x0010000000019d7e
- (void).cxx_destruct;	// IMP=0x000000000001a12c
...
- (id)initForCurrentProcess;	// IMP=0x0000000000019e1f
