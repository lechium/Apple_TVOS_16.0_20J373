...
+ (id)_derivedExtensionAuxiliaryHostProtocolWithContextClass:(Class)arg1;	// IMP=0x0010000000010078
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000010070
+ (id)_extensionContextForIdentifier:(id)arg1;	// IMP=0x001000000000ffe9
+ (id)_extensionContextVendorProtocolWithAllowedErrorClasses:(id)arg1;	// IMP=0x001000000000fe99
+ (id)_defaultExtensionContextVendorProtocol;	// IMP=0x001000000000fe13
+ (id)_extensionContextHostProtocolWithAllowedPayloadCompletionClasses:(id)arg1 AllowedErrorClasses:(id)arg2;	// IMP=0x001000000000fa80
+ (id)_extensionContextHostProtocolAllowedClassesForItems;	// IMP=0x001000000000f84b
- (void).cxx_destruct;	// IMP=0x0000000000012d19
...
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x00000000000128f7
- (void)___nsx_pingHost:(CDUnknownBlockType)arg1;	// IMP=0x00000000000128ec
- (void)_willPerformHostCallback:(CDUnknownBlockType)arg1;	// IMP=0x0000000000012783
@property(readonly, copy) NSString *description;
- (void)_openURL:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000000124fc
- (void)_loadPreviewImageForPayload:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000012391
- (void)_loadItemForPayload:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000012053
- (void)openURL:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000000011de3
- (void)cancelRequestWithError:(id)arg1;	// IMP=0x0000000000011b19
- (void)completeRequestReturningItems:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000000111eb
- (void)_completeRequestReturningItemsSecondHalf:(CDUnknownBlockType)arg1;	// IMP=0x00000000000111e0
- (_Bool)_isHost;	// IMP=0x00000000000111ad
- (void)dealloc;	// IMP=0x0000000000011158
- (void)invalidate;	// IMP=0x0000000000011048
- (void)_initializeAuxillaryConnectionWithListenerEndpoint:(id)arg1;	// IMP=0x0000000000010b2b
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000010ab2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000010aa7
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000010953
- (id)initWithInputItems:(id)arg1 listenerEndpoint:(id)arg2 contextUUID:(id)arg3 extensionContext:(id)arg4;	// IMP=0x0000000000010341
