...
+ (id)springAnimation;	// IMP=0x001000000001971b
+ (id)init;	// IMP=0x00100000000195ae
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000019715
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000001961b
- (id)commonInit;	// IMP=0x00000000000195ed
