...
- (void).cxx_destruct;	// IMP=0x0000000000012847
...
- (void)_deactivateMarqueeAnimationIfNecessary;	// IMP=0x0000000000012645
- (void)_activateMarqueeAnimationIfNecessary;	// IMP=0x0000000000012378
- (void)updateConstraints;	// IMP=0x0000000000011b7e
- (void)layoutSubviews;	// IMP=0x0000000000011969
- (id)initWithFrame:(struct CGRect)arg1 pillView:(id)arg2;	// IMP=0x00000000000115bf
