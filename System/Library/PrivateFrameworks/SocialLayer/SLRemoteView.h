...
- (void).cxx_destruct;	// IMP=0x000000000001c9da
...
- (void)serviceProxyDidDisconnect:(id)arg1;	// IMP=0x000000000001c8f9
- (void)serviceProxyDidConnect:(id)arg1;	// IMP=0x000000000001c859
- (void)remoteContentIsLoadedValueChanged;	// IMP=0x000000000001c853
- (CDUnknownBlockType)_contentProviderForCurrentConfiguration;	// IMP=0x000000000001c3e8
- (id)_finalSlotStyleForStyle:(id)arg1;	// IMP=0x000000000001c3d2
- (void)renderRemoteContentForLayerContextID:(unsigned long long)arg1 style:(id)arg2 yield:(CDUnknownBlockType)arg3;	// IMP=0x000000000001c3cc
- (id)makePlaceholderSlotContentForStyle:(id)arg1;	// IMP=0x000000000001c3c4
- (_Bool)shouldInvalidatePreviousPlaceHolderSlotContent:(id)arg1 forStyle:(id)arg2;	// IMP=0x000000000001c3bc
- (id)initWithServiceProxyClass:(Class)arg1 maxWidth:(double)arg2;	// IMP=0x000000000001bc80
