...
+ (void)unpackPackedCpuTypeAndSubType:(id)arg1 cputype:(int *)arg2 subtype:(int *)arg3;	// IMP=0x0060000000006530
+ (id)packedNumberForCPUType:(int)arg1 subtype:(int)arg2;	// IMP=0x006000000000650e
...
- (_Bool)performHashWithError:(id *)arg1;	// IMP=0x0000000000005b41
- (id)_hashSliceAtOffset:(long long)arg1 withSize:(long long)arg2 machHeaderAndCommands:(const struct mach_header *)arg3 dictionaryKey:(id *)arg4 error:(id *)arg5;	// IMP=0x0000000000004782
- (void)dealloc;	// IMP=0x0000000000004726
- (id)initWithExecutable:(id)arg1 searchForSectionNamed:(id)arg2;	// IMP=0x0000000000004686
