...
+ (id)timeRef;	// IMP=0x0060000000048e59
...
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000000048f07
- (id)initWithUUID:(unsigned char [16])arg1 continuous:(unsigned long long)arg2;	// IMP=0x0000000000048ed8
