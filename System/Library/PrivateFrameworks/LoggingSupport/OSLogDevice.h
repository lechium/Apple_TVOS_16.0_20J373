...
- (void).cxx_destruct;	// IMP=0x0000000000010d41
...
- (id)initWithSimualatedDevice:(id)arg1;	// IMP=0x0000000000010c4f
- (id)initWithMobileDevice:(void *)arg1 andID:(id)arg2;	// IMP=0x0000000000010be5
- (id)description;	// IMP=0x00000000000109cf
- (id)init;	// IMP=0x0000000000010964
