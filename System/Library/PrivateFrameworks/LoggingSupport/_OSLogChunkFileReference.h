...
- (void).cxx_destruct;	// IMP=0x000000000001680b
...
- (id)copyMappedChunkFile:(id *)arg1;	// IMP=0x00000000000166df
- (_Bool)readXattrForTimespan:(id *)arg1;	// IMP=0x000000000001649e
- (void)dealloc;	// IMP=0x0000000000016464
- (id)initWithCollection:(id)arg1 subpath:(const char *)arg2;	// IMP=0x00000000000163e6
