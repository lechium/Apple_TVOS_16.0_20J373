...
- (void).cxx_destruct;	// IMP=0x0000000000018077
...
- (void)enumerateSubchunksUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000017da4
- (void)unionWithRange:(struct _NSRange)arg1;	// IMP=0x0000000000017d7f
...
- (void)dealloc;	// IMP=0x0000000000017d0e
- (id)initWithStore:(id)arg1 index:(id)arg2 fileHeader:(struct tracev3_chunk_s *)arg3 range:(struct _NSRange)arg4 chunk:(struct tracev3_chunk_s *)arg5;	// IMP=0x0000000000017c1f
