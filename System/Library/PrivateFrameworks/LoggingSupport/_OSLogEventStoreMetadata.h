...
- (void).cxx_destruct;	// IMP=0x000000000004990b
...
- (id)timeRefForTTLClass:(unsigned char)arg1;	// IMP=0x00000000000498d7
- (id)initWithCollection:(id)arg1 localStorePlist:(id)arg2 liveDataDescriptor:(int)arg3;	// IMP=0x0000000000049615
- (id)initWithDictionary:(id)arg1;	// IMP=0x000000000004906f
