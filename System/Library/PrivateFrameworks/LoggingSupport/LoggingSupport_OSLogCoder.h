...
- (void)appendBytes:(const void *)arg1 length:(unsigned long long)arg2;	// IMP=0x000000000002c2f2
- (void)setTruncated;	// IMP=0x000000000002c2ea
- (void)setPublic;	// IMP=0x000000000002c2c9
- (void)_initBlob;	// IMP=0x000000000002c21b
