...
+ (id)localDBRefWithError:(id *)arg1;	// IMP=0x0060000000029064
+ (id)referenceWithURL:(id)arg1 error:(id *)arg2;	// IMP=0x0060000000028c4f
...
- (void)close;	// IMP=0x0000000000028bc8
- (id)initWithDiagnosticsDirectory:(id)arg1 timesyncDirectory:(id)arg2 UUIDTextDirectory:(id)arg3;	// IMP=0x0000000000028b11
