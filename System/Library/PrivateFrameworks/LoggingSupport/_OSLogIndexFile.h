...
- (id)copyMappedChunkStore:(id *)arg1;	// IMP=0x0000000000016f8b
- (_Bool)_determineTimespan;	// IMP=0x0000000000016dcc
- (_Bool)_loadCatalogMetadataForTimespan;	// IMP=0x0000000000016ba5
- (_Bool)_loadHeaderMetadata:(id)arg1;	// IMP=0x0000000000016adf
- (void)dealloc;	// IMP=0x0000000000016aa5
- (id)initWithChunkStore:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000169e7
- (id)initWithTraceFile:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000168b2
