...
+ (_Bool)allowsReverseTransformation;	// IMP=0x006000000000107b
- (void).cxx_destruct;	// IMP=0x000000000000104a
...
- (id)reverseTransformedValue:(id)arg1;	// IMP=0x0000000000000fb6
- (id)transformedValue:(id)arg1;	// IMP=0x0000000000000f44
- (id)initWithForwardTransformation:(CDUnknownBlockType)arg1 reverseTransformation:(CDUnknownBlockType)arg2;	// IMP=0x0000000000000e7d
