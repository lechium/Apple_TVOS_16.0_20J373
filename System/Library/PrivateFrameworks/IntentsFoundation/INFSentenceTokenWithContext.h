...
+ (id)sentenceResolvedTokenWithOriginalToken:(id)arg1 placeholderName:(id)arg2;	// IMP=0x0060000000001cd2
- (void).cxx_destruct;	// IMP=0x0000000000001c9f
...
- (id)initWithToken:(id)arg1 variableName:(id)arg2;	// IMP=0x0000000000001ba5
