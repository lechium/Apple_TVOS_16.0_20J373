...
+ (id)mtURLForScheme:(id)arg1;	// IMP=0x00200000000409fd
+ (id)mtURLForClockAppSection:(int)arg1 timerManager:(id)arg2;	// IMP=0x002000000004079d
+ (id)mtURLForClockAppSection:(int)arg1;	// IMP=0x0020000000040789
