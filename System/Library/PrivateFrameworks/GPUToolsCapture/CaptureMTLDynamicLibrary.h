...
- (void).cxx_destruct;	// IMP=0x0000000000067789
@property(retain, nonatomic) id <MTLLibrary> parentLibrary; // @synthesize parentLibrary;
- (_Bool)serializeToURL:(id)arg1 options:(unsigned long long)arg2 error:(id *)arg3;	// IMP=0x0000000000067708
- (id)formattedDescription:(unsigned long long)arg1;	// IMP=0x00000000000676f2
- (void)dealloc;	// IMP=0x0000000000067604
...
- (_Bool)conformsToProtocol:(id)arg1;	// IMP=0x00000000000673b0
- (_Bool)respondsToSelector:(SEL)arg1;	// IMP=0x000000000006739f
@property(readonly, copy) NSString *description;
- (id)forwardingTargetForSelector:(SEL)arg1;	// IMP=0x00000000000672de
@property(readonly) unsigned long long streamReference;
@property(readonly) struct GTTraceStream *traceStream;
@property(readonly) struct GTTraceContext *traceContext;
- (void)touch;	// IMP=0x000000000006727e
- (id)originalObject;	// IMP=0x0000000000067270
- (_Bool)serializeToURL:(id)arg1 error:(id *)arg2;	// IMP=0x00000000000670bb
@property(readonly) id <MTLDynamicLibrary> baseObject;
- (id)initWithBaseObject:(id)arg1 captureDevice:(id)arg2;	// IMP=0x0000000000066fcf
