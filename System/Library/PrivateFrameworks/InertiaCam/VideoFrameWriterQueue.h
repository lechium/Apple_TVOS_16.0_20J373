...
- (void)DrainIfAbove:(unsigned int)arg1 downTo:(unsigned int)arg2;	// IMP=0x000000000001e461
- (void)StartWatchingForFrames;	// IMP=0x000000000001e39e
- (void)FrameRequestCallback;	// IMP=0x000000000001decb
- (id)FindFrameWithIndex:(long long)arg1;	// IMP=0x000000000001dde4
- (_Bool)WaitForFinish;	// IMP=0x000000000001db95
- (unsigned long long)FramesInQueue;	// IMP=0x000000000001db46
- (void)AddAFrame:(id)arg1;	// IMP=0x000000000001dabd
- (void)dealloc;	// IMP=0x000000000001da8e
- (id)initWithOutputURL:(id)arg1 forMovieDimensions:(struct CGSize)arg2 outputTransform:(struct CGAffineTransform)arg3 startTime:(CDStruct_1b6d18a9)arg4 endTime:(CDStruct_1b6d18a9)arg5;	// IMP=0x000000000001d66f
