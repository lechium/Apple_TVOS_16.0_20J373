...
+ (long long)content_typeForObject:(id)arg1;	// IMP=0x006000000000e759
+ (long long)content_typeForMutableObject:(id)arg1;	// IMP=0x006000000000e6ff
+ (Class)content_mutableClassForType:(long long)arg1;	// IMP=0x006000000000e6d1
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000000e3a3
- (id)init;	// IMP=0x000000000000e315
