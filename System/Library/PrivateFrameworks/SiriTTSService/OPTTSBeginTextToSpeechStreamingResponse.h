...
- (void).cxx_destruct;	// IMP=0x00000000000222b3
- (id)flatbuffData;	// IMP=0x0000000000022171
- (Offset_afb4d078)addObjectToBuffer:(void *)arg1;	// IMP=0x0000000000021e0e
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000002198d
- (id)initWithFlatbuffData:(id)arg1 root:(const struct BeginTextToSpeechStreamingResponse *)arg2 verify:(_Bool)arg3;	// IMP=0x00000000000217b0
- (id)initWithFlatbuffData:(id)arg1 root:(const struct BeginTextToSpeechStreamingResponse *)arg2;	// IMP=0x000000000002179a
- (id)initAndVerifyWithFlatbuffData:(id)arg1;	// IMP=0x000000000002177f
- (id)initWithFlatbuffData:(id)arg1;	// IMP=0x0000000000021767
