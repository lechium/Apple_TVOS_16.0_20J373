...
- (id)flatbuffData;	// IMP=0x000000000001e00a
- (Offset_91732649)addObjectToBuffer:(void *)arg1;	// IMP=0x000000000001d5e4
...
- (void)context_info_enumerateObjectsUsingBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000000001cc96
- (unsigned long long)context_info_count;	// IMP=0x000000000001cbf1
- (id)context_info_objectAtIndex:(unsigned long long)arg1;	// IMP=0x000000000001cad2
...
- (id)initWithFlatbuffData:(id)arg1 root:(const struct TextToSpeechRequest *)arg2 verify:(_Bool)arg3;	// IMP=0x000000000001c532
- (id)initWithFlatbuffData:(id)arg1 root:(const struct TextToSpeechRequest *)arg2;	// IMP=0x000000000001c51c
- (id)initAndVerifyWithFlatbuffData:(id)arg1;	// IMP=0x000000000001c501
- (id)initWithFlatbuffData:(id)arg1;	// IMP=0x000000000001c4e9
