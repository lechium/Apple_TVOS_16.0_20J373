...
+ (void)processServerLogs:(id)arg1;	// IMP=0x006000000002aa5c
- (void).cxx_destruct;	// IMP=0x000000000002b5be
...
- (id)initWithOspreyPartialResponse:(id)arg1;	// IMP=0x000000000002a789
