...
- (void).cxx_destruct;	// IMP=0x000000000000668e
...
- (struct CGPath *)circlePathForRect:(struct CGRect)arg1;	// IMP=0x0000000000006606
- (void)layoutSublayers;	// IMP=0x00000000000063b1
- (void)setup;	// IMP=0x00000000000061be
