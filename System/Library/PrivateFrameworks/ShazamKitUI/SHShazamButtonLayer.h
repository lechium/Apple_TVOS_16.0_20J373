...
- (void).cxx_destruct;	// IMP=0x00000000000047f0
...
- (struct CGPath *)bottomStrokePath;	// IMP=0x0000000000004588
- (struct CGPath *)topStrokePath;	// IMP=0x0000000000004470
- (struct CGPath *)bottomStrokeLongPath;	// IMP=0x0000000000004270
- (struct CGPath *)topStrokeLongPath;	// IMP=0x0000000000004070
- (id)strokeLayerWithPath:(struct CGPath *)arg1 color:(struct CGColor *)arg2;	// IMP=0x0000000000003fa3
- (void)drawSolidShapeWithDuration:(double)arg1 delay:(double)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0000000000003823
- (void)drawSolidShape;	// IMP=0x0000000000003670
- (void)removeTransparentShapeWithDuration:(double)arg1 delay:(double)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000000329d
- (void)drawTransparentShape;	// IMP=0x0000000000002ed8
- (void)removeTransparentShape;	// IMP=0x0000000000002e39
- (void)performFadeInIntroAnimation:(double)arg1 delay:(double)arg2;	// IMP=0x0000000000002aea
- (void)performSDrawingAnimationWithDuration:(double)arg1 delay:(double)arg2;	// IMP=0x0000000000002982
- (void)performSDrawingIntroAnimation;	// IMP=0x000000000000292b
- (void)skipIntroAnimation;	// IMP=0x00000000000028f8
- (void)layoutSublayers;	// IMP=0x0000000000002550
- (void)setup;	// IMP=0x000000000000219e
