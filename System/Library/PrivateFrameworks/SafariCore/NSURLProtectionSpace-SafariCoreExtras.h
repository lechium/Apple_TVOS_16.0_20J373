...
+ (id)safari_passkeySidecarProtectionSpaceForRelyingPartyIdentifier:(id)arg1;	// IMP=0x002000000004e4ff
+ (id)safari_HTMLFormProtectionSpaceForURL:(id)arg1;	// IMP=0x002000000004e3f0
@property(readonly, nonatomic) _Bool safari_allowsCredentialSaving;
- (_Bool)isEqualToProtectionSpaceForPasswordManager:(id)arg1;	// IMP=0x001000000004efba
- (id)safari_creationDateOfCredentialWithUser:(id)arg1;	// IMP=0x001000000004edea
...
- (long long)safari_compareToHighLevelDomainFromProtectionSpace:(id)arg1;	// IMP=0x001000000004e9f7
- (long long)safari_compareToHighLevelDomainFromProtectionSpaceOrderingDecimalCharactersLast:(id)arg1;	// IMP=0x001000000004e83b
