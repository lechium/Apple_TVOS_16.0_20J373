...
- (void).cxx_destruct;	// IMP=0x000000000001501f
- (void)interfaceReachabilityChanged:(id)arg1;	// IMP=0x0000000000014ee5
- (void)interfaceLinkQualityChanged:(id)arg1 previousLinkQuality:(int)arg2;	// IMP=0x0000000000014d18
- (void)_callDelegateOnIvarQueueWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000000014bf8
...
- (int)_linkQualityOnIvarQueue;	// IMP=0x00000000000147f9
@property(readonly, nonatomic) long long interfaceIdentifier;
- (void)setTrackedTimeInterval:(double)arg1;	// IMP=0x0000000000014772
- (void)setThresholdOffTransitionCount:(unsigned long long)arg1;	// IMP=0x00000000000146f9
- (void)setTrackUsability:(_Bool)arg1;	// IMP=0x0000000000014645
- (void)_forwardConfigurationOnIvarQueue;	// IMP=0x00000000000145f7
- (void)_addMonitor;	// IMP=0x0000000000014537
- (void)dealloc;	// IMP=0x00000000000144f3
- (id)initWithDelegateQueue:(id)arg1;	// IMP=0x0000000000014370
