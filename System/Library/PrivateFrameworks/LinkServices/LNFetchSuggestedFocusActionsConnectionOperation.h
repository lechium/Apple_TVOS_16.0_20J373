...
- (void)finishWithError:(id)arg1;	// IMP=0x000000000002f406
- (void)start;	// IMP=0x000000000002f259
- (id)initWithConnectionInterface:(id)arg1 actionMetadata:(id)arg2 suggestionContext:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x000000000002f02c
