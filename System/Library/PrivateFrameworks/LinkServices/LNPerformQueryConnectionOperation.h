...
- (void)finishWithError:(id)arg1;	// IMP=0x000000000001b9c9
- (void)start;	// IMP=0x000000000001b903
- (id)initWithConnectionInterface:(id)arg1 query:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000001b68b
