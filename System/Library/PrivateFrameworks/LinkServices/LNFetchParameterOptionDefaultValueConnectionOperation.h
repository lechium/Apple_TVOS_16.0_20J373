...
- (void)finishWithError:(id)arg1;	// IMP=0x0000000000024446
- (void)start;	// IMP=0x000000000002424b
- (id)initWithConnectionInterface:(id)arg1 actionMetadata:(id)arg2 parameterIdentifier:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x0000000000023fa7
