...
- (void)newValue:(id)arg1 oldValue:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000000000d89d
- (id)initWithTarget:(id)arg1;	// IMP=0x000000000000d839
