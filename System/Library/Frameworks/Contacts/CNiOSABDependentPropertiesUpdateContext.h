...
+ (_Bool)shouldSetWatchChanges;	// IMP=0x00600000000b9f4c
+ (id)os_log;	// IMP=0x00600000000b906b
- (void).cxx_destruct;	// IMP=0x00000000000ba150
...
- (_Bool)setWatchChangesforThumbnailImageDataToPerson:(void *)arg1 error:(id *)arg2;	// IMP=0x00000000000b9f54
- (_Bool)flushPendingImageChangesToPerson:(void *)arg1 logger:(id)arg2 error:(id *)arg3;	// IMP=0x00000000000b92b4
- (_Bool)logIfConditionFailed:(_Bool)arg1 message:(id)arg2 error:(struct __CFError **)arg3;	// IMP=0x00000000000b92ac
- (void)resetAllData;	// IMP=0x00000000000b9204
