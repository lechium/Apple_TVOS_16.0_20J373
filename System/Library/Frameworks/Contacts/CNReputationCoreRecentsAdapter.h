...
- (void).cxx_destruct;	// IMP=0x00000000000d04f6
@property(readonly, nonatomic) CRRecentContactsLibrary *library; // @synthesize library=_library;
- (id)recentContactsForHandle:(id)arg1;	// IMP=0x00000000000cffde
- (id)initWithRecentContactsLibrary:(id)arg1;	// IMP=0x00000000000cff60
- (id)init;	// IMP=0x00000000000cfe6d
