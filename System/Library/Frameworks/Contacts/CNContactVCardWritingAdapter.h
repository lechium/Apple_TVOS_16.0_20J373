...
+ (id)descriptorForAllSupportedKeys;	// IMP=0x001000000009fc8d
+ (id)adapterWithContact:(id)arg1;	// IMP=0x001000000009fc44
- (void).cxx_destruct;	// IMP=0x00000000000a1055
...
- (id)largeImageHashOfType:(id)arg1;	// IMP=0x00000000000a0e1f
...
- (id)vCardPropertyItemsForProperty:(id)arg1 valueTransform:(CDUnknownBlockType)arg2;	// IMP=0x00000000000a0ae8
- (id)vCardPropertyItemsForProperty:(id)arg1;	// IMP=0x00000000000a0ad4
...
- (id)initWithContact:(id)arg1;	// IMP=0x000000000009ffc0
