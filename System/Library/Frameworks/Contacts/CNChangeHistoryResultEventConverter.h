...
- (void).cxx_destruct;	// IMP=0x000000000003787d
...
- (id)eventsFromResult:(id)arg1;	// IMP=0x0000000000036903
- (id)initWithContactStore:(id)arg1 additionalContactKeyDescriptors:(id)arg2;	// IMP=0x0000000000036835
