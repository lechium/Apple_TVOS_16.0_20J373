...
- (void).cxx_destruct;	// IMP=0x00000000000543ab
...
- (id)indexPathForContainerInstance:(id)arg1;	// IMP=0x00000000000542dc
- (id)indexPathForGroupInstance:(id)arg1;	// IMP=0x00000000000542c6
- (id)indexPathForContactInstance:(id)arg1;	// IMP=0x00000000000542b0
- (void)_populateSaveRequestIndexTables;	// IMP=0x0000000000053e40
- (void)dealloc;	// IMP=0x0000000000053e01
@property(readonly, nonatomic) void *addressBook;
- (id)initWithSaveRequest:(id)arg1 response:(id)arg2 addressBook:(void *)arg3;	// IMP=0x0000000000053c0d
