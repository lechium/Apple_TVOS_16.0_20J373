...
- (void).cxx_destruct;	// IMP=0x00000000000a7e5c
...
- (void)interpretUnknownsAsEmailAddresses;	// IMP=0x00000000000a7ad2
- (void)interpretPhoneNumbers;	// IMP=0x00000000000a783f
- (void)interpretEmailAddresses;	// IMP=0x00000000000a76a8
- (void)interpretValues;	// IMP=0x00000000000a765b
- (id)description;	// IMP=0x00000000000a75d5
- (id)initWithHandleStringClassification:(id)arg1;	// IMP=0x00000000000a7507
- (id)init;	// IMP=0x00000000000a74ca
