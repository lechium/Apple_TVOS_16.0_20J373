...
- (void)dealloc;	// IMP=0x00000000002bd9d9
- (id)initWithClientBundleIdentifier:(id)arg1 clientPersonaIdentifier:(id)arg2 dispatchQueue:(id)arg3;	// IMP=0x00000000002bd850
- (void)debug;	// IMP=0x00000000002bd7f2
- (struct FigOpaqueAssertion *)acquireAssertion;	// IMP=0x00000000002bd6dc
