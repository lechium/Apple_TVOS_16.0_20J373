...
- (void).cxx_destruct;	// IMP=0x000000000002bc51
...
- (void)dealloc;	// IMP=0x000000000002bb9c
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x000000000002bad4
- (void)invalidate;	// IMP=0x000000000002babe
- (id)initWithToken:(id)arg1;	// IMP=0x000000000002b96e
