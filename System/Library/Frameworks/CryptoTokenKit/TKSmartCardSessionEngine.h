...
- (void)dealloc;	// IMP=0x000000000001b7db
- (void)terminateWithReply:(CDUnknownBlockType)arg1;	// IMP=0x000000000001b797
- (void)setSessionEndPolicy:(long long)arg1;	// IMP=0x000000000001b78d
- (void)transmit:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x000000000001b46b
- (id)initWithSlot:(id)arg1 connection:(id)arg2;	// IMP=0x000000000001b3ce
