...
+ (id)changesetWithDownloadID:(id)arg1 state:(long long)arg2;	// IMP=0x0010000000006a32
- (void).cxx_destruct;	// IMP=0x0000000000006f65
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000006d99
- (id)copyXPCEncoding;	// IMP=0x0000000000006cdc
- (id)initWithXPCEncoding:(id)arg1;	// IMP=0x0000000000006ad0
