...
- (void).cxx_destruct;	// IMP=0x0000000000015645
...
- (double)transitionDuration:(id)arg1;	// IMP=0x0000000000015610
- (void)animateTransition:(id)arg1;	// IMP=0x00000000000155fe
- (void)dismissRemoteViewController:(id)arg1;	// IMP=0x0000000000015511
- (id)initWithViewController:(id)arg1;	// IMP=0x00000000000154a9
