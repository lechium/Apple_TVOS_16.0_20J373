...
- (void)_addRemoteView;	// IMP=0x000000000001be85
- (void)_requestRemoteViewController;	// IMP=0x000000000001ba4e
- (void)remoteReviewViewControllerTerminatedWithError:(id)arg1;	// IMP=0x000000000001ba38
- (void)_didFinishWithResult:(unsigned long long)arg1 error:(id)arg2;	// IMP=0x000000000001b938
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x000000000001b897
- (void)viewDidLoad;	// IMP=0x000000000001b7eb
- (void)dealloc;	// IMP=0x000000000001b750
- (id)initWithReviewRequestToken:(id)arg1;	// IMP=0x000000000001b668
