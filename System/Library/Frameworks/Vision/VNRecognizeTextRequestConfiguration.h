...
- (void).cxx_destruct;	// IMP=0x000000000021e3d2
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000021e225
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x000000000021e131
