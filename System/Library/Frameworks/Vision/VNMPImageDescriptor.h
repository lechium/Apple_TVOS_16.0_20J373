...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000001d78f4
+ (unsigned long long)currentVersion;	// IMP=0x00100000001d78e9
- (void).cxx_destruct;	// IMP=0x00000000001d78c1
...
- (id)initWithRawColorGaborDescriptor:(id)arg1;	// IMP=0x00000000001d75c6
@property(readonly) NSData *rawColorGaborDescriptor;
- (float)computeFinalDescriptorBasedDistanceForColorDistance:(float)arg1 andSceneClassifierDistance:(float)arg2;	// IMP=0x00000000001d755c
- (float)distanceFromDescriptor:(id)arg1;	// IMP=0x00000000001d74d9
- (_Bool)computeRegistrationFeaturesForImageData:(id)arg1 context:(id)arg2 error:(id *)arg3;	// IMP=0x00000000001d74d1
- (_Bool)computeDescriptorForImageData:(id)arg1 context:(id)arg2 error:(id *)arg3;	// IMP=0x00000000001d7219
- (_Bool)computeConvnetDescriptorForImageData:(id)arg1 context:(id)arg2 error:(id *)arg3;	// IMP=0x00000000001d7211
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000001d7044
- (unsigned long long)hash;	// IMP=0x00000000001d6f30
- (void)dealloc;	// IMP=0x00000000001d6ef0
- (id)initWithState:(id)arg1 byteOffset:(unsigned long long *)arg2 error:(id *)arg3;	// IMP=0x00000000001d6ba8
- (unsigned long long)serializeStateIntoData:(id)arg1 startingAtByteOffset:(unsigned long long)arg2 error:(id *)arg3;	// IMP=0x00000000001d6922
@property(readonly, nonatomic) unsigned long long serializedLength;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001d666b
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001d60e3
- (id)initWithImageData:(id)arg1 andCustomQualityScore:(float)arg2 context:(id)arg3 error:(id *)arg4;	// IMP=0x00000000001d60b4
- (id)initWithImageData:(id)arg1 context:(id)arg2 error:(id *)arg3;	// IMP=0x00000000001d5e83
