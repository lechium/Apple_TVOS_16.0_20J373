...
- (void).cxx_destruct;	// IMP=0x00000000000df1a6
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000df05b
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x00000000000deff8
