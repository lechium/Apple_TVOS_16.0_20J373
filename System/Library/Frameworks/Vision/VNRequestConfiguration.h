...
- (void).cxx_destruct;	// IMP=0x0000000000095536
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000009537b
- (id)description;	// IMP=0x00000000000950a9
@property(readonly, copy, nonatomic) VNProcessingDevice *resolvedProcessingDevice;
- (id)_allPropertyNames;	// IMP=0x0000000000094eef
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x0000000000094e3c
