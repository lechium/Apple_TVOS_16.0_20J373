...
- (void).cxx_destruct;	// IMP=0x00000000002499fa
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000024992c
- (void)updateWithPropertiesOfModel:(id)arg1;	// IMP=0x00000000002498c9
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x0000000000249886
