...
- (void).cxx_destruct;	// IMP=0x0000000000037088
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000036f4f
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x0000000000036ecf
