...
- (void).cxx_destruct;	// IMP=0x000000000012c54e
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000012c44f
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x000000000012c35c
