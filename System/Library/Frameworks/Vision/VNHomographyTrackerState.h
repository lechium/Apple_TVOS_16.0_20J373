...
- (id).cxx_construct;	// IMP=0x00000000001a4321
- (void).cxx_destruct;	// IMP=0x00000000001a42f2
- (void)ICReportFrameAnalysis:(id)arg1 forPresentationTime:(CDStruct_1b6d18a9)arg2 withStats:(id)arg3;	// IMP=0x00000000001a3e8c
- (_Bool)ICShouldBeCanceled;	// IMP=0x00000000001a3e84
- (void)dealloc;	// IMP=0x00000000001a3e08
- (id)init;	// IMP=0x00000000001a3ccb
