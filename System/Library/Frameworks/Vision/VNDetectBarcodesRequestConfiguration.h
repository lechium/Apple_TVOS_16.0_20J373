...
- (void).cxx_destruct;	// IMP=0x000000000010f30d
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000010f1c7
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x000000000010f135
- (void)setDefaultSymbologiesForRevision:(unsigned long long)arg1;	// IMP=0x000000000010f04a
