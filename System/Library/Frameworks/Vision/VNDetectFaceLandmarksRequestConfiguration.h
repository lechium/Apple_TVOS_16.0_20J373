...
+ (_Bool)revision:(unsigned long long)arg1 supportsConstellation:(unsigned long long)arg2;	// IMP=0x006000000012db2f
- (void).cxx_destruct;	// IMP=0x000000000012db1c
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000012d957
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x000000000012d89d
