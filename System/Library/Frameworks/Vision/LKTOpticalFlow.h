...
- (_Bool)_validateOutputImage:(struct __CVBuffer *)arg1 error:(id *)arg2;	// IMP=0x0000000000275101
- (_Bool)_validateInputImage:(struct __CVBuffer *)arg1 error:(id *)arg2;	// IMP=0x0000000000275046
- (_Bool)estimateFlowStream:(struct __CVBuffer *)arg1 error:(id *)arg2;	// IMP=0x0000000000275001
- (_Bool)estimateFlowFromReference:(struct __CVBuffer *)arg1 target:(struct __CVBuffer *)arg2 error:(id *)arg3;	// IMP=0x0000000000274fbc
- (_Bool)setOutputUV:(struct __CVBuffer *)arg1 error:(id *)arg2;	// IMP=0x0000000000274f77
- (void)waitUntilCompleted;	// IMP=0x0000000000274f71
- (id)initWithWidth:(int)arg1 height:(int)arg2 numScales:(int)arg3;	// IMP=0x0000000000274f18
