...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000001a28c4
- (void).cxx_destruct;	// IMP=0x00000000001a2891
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001a27e2
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001a2589
