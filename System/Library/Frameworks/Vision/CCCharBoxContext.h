...
- (void)releaseAllocations;	// IMP=0x00000000002099e8
- (_Bool)makeAllocationsForWidth:(unsigned long long)arg1;	// IMP=0x000000000020991c
- (void)dealloc;	// IMP=0x00000000002098a9
- (void)resetBoxBounds;	// IMP=0x0000000000209898
- (void)copyFlagValue:(unsigned long long)arg1 toTarget:(unsigned long long)arg2 atIndex:(unsigned int)arg3;	// IMP=0x0000000000209867
- (unsigned int)checkFlag:(unsigned long long)arg1 atIndex:(unsigned int)arg2;	// IMP=0x0000000000209852
- (void)clearFlag:(unsigned long long)arg1 atIndex:(unsigned int)arg2;	// IMP=0x000000000020983f
- (void)setFlag:(unsigned long long)arg1 atIndex:(unsigned int)arg2;	// IMP=0x000000000020982f
