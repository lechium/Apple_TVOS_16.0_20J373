...
- (void).cxx_destruct;	// IMP=0x0000000000203d57
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000203b8d
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x0000000000203ac7
