...
- (void).cxx_destruct;	// IMP=0x000000000028a20c
...
- (void)setDetectorConfigurationOption:(id)arg1 value:(id)arg2;	// IMP=0x000000000028a09e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000289fbf
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x0000000000289ef8
