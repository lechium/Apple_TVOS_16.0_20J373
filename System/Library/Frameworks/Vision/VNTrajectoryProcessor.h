...
- (void).cxx_destruct;	// IMP=0x00000000001484b1
- (id)processVNImageBuffer:(id)arg1 regionOfInterest:(struct CGRect)arg2 withOptions:(id)arg3 warningRecorder:(id)arg4 requestUUID:(id)arg5 error:(id *)arg6;	// IMP=0x0000000000145e92
- (id)_VNPointsFromCGPoints:(const void *)arg1;	// IMP=0x0000000000145d32
- (struct __CVBuffer *)_createCroppedAndScaledBufferFromVNImageBuffer:(id)arg1 regionOfInterest:(struct CGRect)arg2 withOptions:(id)arg3 error:(id *)arg4;	// IMP=0x0000000000145af7
- (void)dealloc;	// IMP=0x0000000000145a85
- (id)initWithFrameAnalysisSpacing:(CDStruct_1b6d18a9)arg1 trajectoryLength:(long long)arg2;	// IMP=0x0000000000145127
