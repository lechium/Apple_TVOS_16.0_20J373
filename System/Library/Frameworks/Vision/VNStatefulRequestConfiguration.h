...
- (void).cxx_destruct;	// IMP=0x00000000001c83bb
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001c82e6
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x00000000001c8279
