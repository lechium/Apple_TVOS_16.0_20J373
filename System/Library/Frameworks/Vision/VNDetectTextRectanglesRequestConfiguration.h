...
- (void).cxx_destruct;	// IMP=0x00000000000d6a49
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000d6849
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x00000000000d67b2
