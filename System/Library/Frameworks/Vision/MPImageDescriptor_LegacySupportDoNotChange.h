...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000001a3cbb
- (void).cxx_destruct;	// IMP=0x00000000001a3c88
...
- (void)dealloc;	// IMP=0x00000000001a3b27
- (unsigned long long)serializeStateIntoData:(id)arg1 startingAtByteOffset:(unsigned long long)arg2 error:(id *)arg3;	// IMP=0x00000000001a3845
- (unsigned long long)serializedLength;	// IMP=0x00000000001a3825
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001a3803
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001a3342
