...
- (void).cxx_destruct;	// IMP=0x00000000002061c8
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000020608c
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x0000000000205f9f
