...
- (void).cxx_destruct;	// IMP=0x00000000001d7ca4
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001d79fc
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x00000000001d78fc
