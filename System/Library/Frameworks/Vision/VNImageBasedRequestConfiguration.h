...
- (void).cxx_destruct;	// IMP=0x000000000015bf45
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000015be0e
- (id)initWithRequestClass:(Class)arg1;	// IMP=0x000000000015bdbc
