...
- (void).cxx_destruct;	// IMP=0x000000000004031d
...
- (void)applyToAllTextViewStyles:(CDUnknownBlockType)arg1;	// IMP=0x000000000004020e
- (id)initWithPlatform:(long long)arg1 sizeClass:(unsigned long long)arg2 fontScalingFactor:(double)arg3;	// IMP=0x000000000003f9c2
