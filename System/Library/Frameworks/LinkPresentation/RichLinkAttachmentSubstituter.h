...
- (void).cxx_destruct;	// IMP=0x00000000000529ac
...
- (id)unarchiver:(id)arg1 didDecodeObject:(id)arg2;	// IMP=0x000000000005291e
- (id)applyAttachmentSubstitutionForObject:(id)arg1;	// IMP=0x00000000000522ca
- (id)archiver:(id)arg1 willEncodeObject:(id)arg2;	// IMP=0x0000000000051fbd
- (id)init;	// IMP=0x0000000000051f4f
