...
- (void).cxx_destruct;	// IMP=0x0000000000077adb
...
- (id)primaryIconView;	// IMP=0x0000000000077a24
- (id)playable;	// IMP=0x0000000000077a07
- (id)subtitleButton;	// IMP=0x000000000007794c
- (id)button;	// IMP=0x00000000000778e0
- (void)_buildViewsForCaptionBarIfNeeded;	// IMP=0x0000000000076452
- (struct CGSize)_layoutCaptionBarForSize:(struct CGSize)arg1 applyingLayout:(_Bool)arg2;	// IMP=0x0000000000072909
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000000728f5
- (void)layoutComponentView;	// IMP=0x00000000000728a7
- (void)animationDidStop:(id)arg1 finished:(_Bool)arg2;	// IMP=0x0000000000072800
- (void)animateInWithBaseAnimation:(id)arg1 currentTime:(double)arg2;	// IMP=0x00000000000724a4
- (void)animateOut;	// IMP=0x00000000000721f7
- (void)setPlaybackInformation:(id)arg1;	// IMP=0x0000000000072181
- (id)initWithHost:(id)arg1 style:(id)arg2 presentationProperties:(id)arg3;	// IMP=0x0000000000072012
- (id)initWithHost:(id)arg1;	// IMP=0x0000000000072004
