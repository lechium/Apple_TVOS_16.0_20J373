...
- (void).cxx_destruct;	// IMP=0x000000000003ed86
...
- (id)adjustedForString:(id)arg1;	// IMP=0x000000000003ebcf
- (void)_adjustForString:(id)arg1;	// IMP=0x000000000003eb10
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000003e9de
- (id)initWithPlatform:(long long)arg1 fontScalingFactor:(double)arg2;	// IMP=0x000000000003e870
