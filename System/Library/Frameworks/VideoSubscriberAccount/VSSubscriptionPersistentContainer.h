...
- (void).cxx_destruct;	// IMP=0x0000000000065aa8
...
- (void)performBlockAndWait:(CDUnknownBlockType)arg1;	// IMP=0x00000000000659ef
- (void)performBlock:(CDUnknownBlockType)arg1;	// IMP=0x00000000000659db
- (void)_performBlock:(CDUnknownBlockType)arg1 andWait:(_Bool)arg2;	// IMP=0x0000000000065660
- (_Bool)_setupPersistenceIfNeeded:(id *)arg1;	// IMP=0x0000000000064b7e
- (void)_removePersistentStore;	// IMP=0x0000000000064a65
- (id)init;	// IMP=0x0000000000064623
