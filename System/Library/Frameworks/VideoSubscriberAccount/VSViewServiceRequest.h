...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000001fc25
- (void).cxx_destruct;	// IMP=0x000000000002014d
...
- (id)description;	// IMP=0x000000000001fd66
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000001fd0c
- (unsigned long long)hash;	// IMP=0x000000000001fcd3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000001fc83
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000001fc2d
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000001fba5
- (id)init;	// IMP=0x000000000001fb41
