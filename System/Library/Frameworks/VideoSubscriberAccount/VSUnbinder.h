...
- (void).cxx_destruct;	// IMP=0x00000000000212a6
...
- (void)binder:(id)arg1 didTearDownBinding:(id)arg2;	// IMP=0x0000000000021110
- (void)binder:(id)arg1 didEstablishBinding:(id)arg2;	// IMP=0x0000000000020fad
- (void)dealloc;	// IMP=0x0000000000020ca9
- (id)init;	// IMP=0x0000000000020c43
