...
- (id)standardizedFetchOptionsFromOptions:(id)arg1 withSecurityTask:(id)arg2;	// IMP=0x000000000003b9b0
- (id)subscriptionFetchOptionsAllowedForSecurityTask:(id)arg1;	// IMP=0x000000000003b251
