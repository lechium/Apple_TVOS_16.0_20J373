...
- (void).cxx_destruct;	// IMP=0x0000000000077568
...
- (void)transitionToDoneState;	// IMP=0x00000000000773d3
- (void)transitionToFetchingScriptState;	// IMP=0x0000000000076e5f
- (void)transitionToEnqueueingNextUrlState;	// IMP=0x0000000000076c50
- (void)start;	// IMP=0x0000000000076ac0
- (id)initWithApp:(id)arg1 urls:(id)arg2;	// IMP=0x00000000000768bd
