...
- (id)vs_JSONValueTransformer;	// IMP=0x003000000002a24c
...
- (id)vs_propertyListValueTransformer;	// IMP=0x0030000000029bb1
...
- (_Bool)vs_isSuitableForPurpose:(long long)arg1;	// IMP=0x0030000000029a44
...
- (void)vs_setUserInfoValue:(id)arg1 forKey:(id)arg2;	// IMP=0x00300000000297b1
@end
