...
- (id)description;	// IMP=0x0000000000042578
@property(copy, nonatomic) NSData *data;
- (void)didAccessValueForKey:(id)arg1;	// IMP=0x000000000004249e
- (void)willAccessValueForKey:(id)arg1;	// IMP=0x0000000000042412
- (void)willChangeValueForKey:(id)arg1;	// IMP=0x0000000000042315
- (id)changedValues;	// IMP=0x0000000000041fd9
- (id)committedValueForKey:(id)arg1;	// IMP=0x0000000000041f56
- (id)committedValuesForKeys:(id)arg1;	// IMP=0x0000000000041ed8
- (void)setPrimitiveValue:(id)arg1 forKey:(id)arg2;	// IMP=0x0000000000041cbf
- (id)primitiveValueForKey:(id)arg1;	// IMP=0x0000000000041bab
@property(readonly, nonatomic) _Bool hasPersistentChangedValues;
@property(readonly, nonatomic) _Bool hasChanges;
- (void)_setCommittedValues:(id)arg1 registeringUndo:(_Bool)arg2;	// IMP=0x00000000000419f2
- (id)initWithItemKind:(id)arg1 insertIntoEditingContext:(id)arg2;	// IMP=0x00000000000416d4
- (id)init;	// IMP=0x0000000000041665
