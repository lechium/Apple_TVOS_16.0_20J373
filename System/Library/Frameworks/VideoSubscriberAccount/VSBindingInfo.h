...
- (void).cxx_destruct;	// IMP=0x000000000004b21b
...
- (void)requireExpectedConcurrency;	// IMP=0x000000000004af26
@property(retain, nonatomic) id value;
- (id)initWithObservedObject:(id)arg1 keyPath:(id)arg2 options:(id)arg3;	// IMP=0x000000000004a9a0
- (id)init;	// IMP=0x000000000004a931
