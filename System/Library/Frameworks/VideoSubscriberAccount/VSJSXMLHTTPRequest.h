...
- (void).cxx_destruct;	// IMP=0x00000000000695e6
...
- (void)_notifyWithFunctionName:(id)arg1 eventName:(id)arg2 info:(id)arg3;	// IMP=0x0000000000068fb9
- (void)_cancelCurrentRequestAndNotify:(_Bool)arg1;	// IMP=0x0000000000068e16
- (void)setRequestHeader:(id)arg1:(id)arg2;	// IMP=0x0000000000068c06
- (id)getResponseHeader:(id)arg1;	// IMP=0x0000000000068b17
- (id)getAllResponseHeaders;	// IMP=0x000000000006890e
- (void)abort;	// IMP=0x00000000000688fa
- (void)send:(id)arg1;	// IMP=0x00000000000681f9
- (void)open:(id)arg1:(id)arg2:(id)arg3:(id)arg4:(id)arg5;	// IMP=0x0000000000068058
- (id)initWithContext:(id)arg1;	// IMP=0x0000000000068014
- (id)init;	// IMP=0x0000000000067f41
