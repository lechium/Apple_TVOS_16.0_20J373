...
- (void).cxx_destruct;	// IMP=0x0000000000013fad
...
- (void)destroyBuffer:(id)arg1;	// IMP=0x0000000000013e63
- (id)newBufferWithLength:(unsigned long long)arg1 type:(unsigned long long)arg2;	// IMP=0x0000000000013ae7
- (id)initWithCapacity:(unsigned long long)arg1 allocator:(id)arg2;	// IMP=0x00000000000139a4
