...
- (id)bestMoveForActivePlayer;	// IMP=0x000000000002f2a6
- (_Bool)validateRandomSource;	// IMP=0x000000000002f231
- (_Bool)validateGameModel:(id)arg1;	// IMP=0x000000000002f0ea
- (void)dealloc;	// IMP=0x000000000002f09c
- (id)init;	// IMP=0x000000000002f011
