...
+ (void)enumerateExtensionsInDirectoryAtURL:(id)arg1 block:(CDUnknownBlockType)arg2;	// IMP=0x006000000003db22
- (void).cxx_destruct;	// IMP=0x000000000003e836
...
- (id)nextObject;	// IMP=0x000000000003e79a
- (id)initWithCacheURLs:(id)arg1 paths:(id)arg2;	// IMP=0x000000000003e117
- (id)initWithCacheURLs:(id)arg1;	// IMP=0x000000000003e0fe
