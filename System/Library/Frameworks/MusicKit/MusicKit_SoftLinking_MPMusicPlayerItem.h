...
+ (id)playerItemForMediaItem:(id)arg1;	// IMP=0x006000000000755b
...
- (id)description;	// IMP=0x000000000000923b
- (void)_initializeAdditionalAttributesWithMediaItem:(id)arg1;	// IMP=0x0000000000007bc2
- (void)_initializeArtworkCatalogWithMediaItem:(id)arg1;	// IMP=0x00000000000077dd
- (void)_initializeBasicPropertiesWithMediaItem:(id)arg1;	// IMP=0x000000000000763d
- (id)_initWithMediaItem:(id)arg1;	// IMP=0x00000000000075ad
