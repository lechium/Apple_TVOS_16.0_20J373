...
- (void)setEndTime:(double)arg1 forItemWithPlayParameters:(id)arg2;	// IMP=0x0000000000004065
- (void)setStartTime:(double)arg1 forItemWithPlayParameters:(id)arg2;	// IMP=0x000000000000400b
@property(readonly, nonatomic) MPMusicPlayerPlayParametersQueueDescriptor *_underlyingQueueDescriptor;
- (id)initWithPlayParametersQueue:(id)arg1;	// IMP=0x0000000000003c09
