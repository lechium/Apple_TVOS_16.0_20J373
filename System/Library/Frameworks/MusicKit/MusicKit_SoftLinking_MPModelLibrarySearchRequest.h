...
- (void)performWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000003434
- (id)initWithSearchTerm:(id)arg1 scopes:(id)arg2 limit:(long long)arg3;	// IMP=0x000000000000323f
