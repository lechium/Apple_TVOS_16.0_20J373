...
- (_Bool)shouldRunWithSamplingRate:(id)arg1;	// IMP=0x000000000000f7ee
- (unsigned int)hostHash;	// IMP=0x000000000000f7c3
- (id)initWithConfiguration:(id)arg1;	// IMP=0x000000000000f617
