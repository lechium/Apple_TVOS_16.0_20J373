...
- (void).cxx_destruct;	// IMP=0x00000000000e2c95
...
- (struct __SecIdentity *)identityWithError:(id *)arg1;	// IMP=0x00000000000e25bd
- (id)executeRequest;	// IMP=0x00000000000e21c7
- (_Bool)valueForBooleanDefault:(id)arg1;	// IMP=0x00000000000e2150
- (id)processReply:(id)arg1;	// IMP=0x00000000000e112c
- (id)acmeRequest;	// IMP=0x00000000000e0aba
- (id)pollForStatus:(id)arg1 until:(id)arg2;	// IMP=0x00000000000e0a7c
- (id)sendRequestToXPCService:(id)arg1 response:(id *)arg2;	// IMP=0x00000000000e0558
- (int)errorStatusWithHTTPErrorCode:(int)arg1;	// IMP=0x00000000000e04f0
- (id)attestationChainPEMRepresentation;	// IMP=0x00000000000e0421
- (id)createCertificate;	// IMP=0x00000000000e02fe
- (id)createAttestation;	// IMP=0x00000000000e004d
- (id)attestationObjectWithCertificates:(id)arg1;	// IMP=0x00000000000dfc8d
- (id)requestAttestationChainWithError:(id *)arg1;	// IMP=0x00000000000dfc23
- (_Bool)deviceAttestationSupported;	// IMP=0x00000000000dfc1b
- (id)createCSR;	// IMP=0x00000000000dfb24
- (id)createKeyPair;	// IMP=0x00000000000dfa49
- (id)sanitizeParameters;	// IMP=0x00000000000df918
- (id)sanitizeSubject;	// IMP=0x00000000000df821
- (id)serialNumber;	// IMP=0x00000000000df726
- (void)dealloc;	// IMP=0x00000000000df685
- (id)initWithSubject:(id)arg1 parameters:(id)arg2;	// IMP=0x00000000000df5b9
