...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000000c635
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000c724
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000c63d
- (void)dealloc;	// IMP=0x000000000000c5f2
- (id)initForRequest:(id)arg1;	// IMP=0x000000000000c565
