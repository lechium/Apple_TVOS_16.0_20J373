...
+ (id)migrationStoreOptionsFromStoreOptions:(id)arg1;	// IMP=0x00600000001fa28f
+ (id)destinationURLForMigrationSourceURL:(id)arg1 createDocumentReplacementDirectory:(_Bool)arg2 error:(id *)arg3;	// IMP=0x00600000001fb63e
+ (void)setMigrationDebugLevel:(int)arg1;	// IMP=0x00600000001fb51a
+ (int)migrationDebugLevel;	// IMP=0x00600000001fb501
- (id)migrateStoreAtURL:(id)arg1 withManager:(id)arg2 metadata:(id)arg3 options:(id)arg4 error:(id *)arg5;	// IMP=0x00000000001fb3c0
- (id)createMigrationManagerForSourceModel:(id)arg1 destinationModel:(id)arg2 error:(id *)arg3;	// IMP=0x00000000001fb23e
- (id)sourceModelForStoreAtURL:(id)arg1 metadata:(id)arg2 error:(id *)arg3;	// IMP=0x00000000001faa18
- (void)dealloc;	// IMP=0x00000000001fa3f0
