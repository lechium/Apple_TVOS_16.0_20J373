...
- (id)description;	// IMP=0x0000000000133080
- (void)updateWithChange:(id)arg1;	// IMP=0x0000000000132fac
- (void)dealloc;	// IMP=0x0000000000132f3a
- (id)initWithOriginalChange:(id)arg1;	// IMP=0x0000000000132e2c
