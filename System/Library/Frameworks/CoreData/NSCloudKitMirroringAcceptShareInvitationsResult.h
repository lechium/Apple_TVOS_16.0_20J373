...
- (void)dealloc;	// IMP=0x0000000000234a2f
- (id)initWithRequest:(id)arg1 acceptedShares:(id)arg2 acceptedShareMetadatas:(id)arg3 error:(id)arg4;	// IMP=0x00000000002348cc
