...
- (void)dealloc;	// IMP=0x000000000028dd3c
- (id)initWithStore:(id)arg1 metadataContext:(id)arg2 databaseScope:(long long)arg3 metricsClient:(id)arg4;	// IMP=0x000000000028dc8c
