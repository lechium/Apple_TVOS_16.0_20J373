...
- (void)dealloc;	// IMP=0x00000000000e3055
- (_Bool)_isDeallocating;	// IMP=0x00000000000e302c
- (_Bool)_tryRetain;	// IMP=0x00000000000e3024
- (unsigned long long)retainCount;	// IMP=0x00000000000e3017
- (oneway void)release;	// IMP=0x00000000000e2fe9
- (id)retain;	// IMP=0x00000000000e2fdc
