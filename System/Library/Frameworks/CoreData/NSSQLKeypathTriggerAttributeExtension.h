...
- (_Bool)isEqualToExtension:(id)arg1;	// IMP=0x000000000024390c
- (_Bool)validate:(id *)arg1;	// IMP=0x000000000024140c
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x00000000002412ec
- (id)initWithObjectFromUserInfo:(id)arg1 onAttributeNamed:(id)arg2 onEntity:(id)arg3;	// IMP=0x0000000000241237
