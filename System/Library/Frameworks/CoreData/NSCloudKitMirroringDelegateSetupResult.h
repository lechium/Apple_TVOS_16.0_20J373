...
- (void)dealloc;	// IMP=0x00000000002b6001
- (id)initWithRequest:(id)arg1 success:(_Bool)arg2 error:(id)arg3 container:(id)arg4 database:(id)arg5;	// IMP=0x00000000002b5f83
