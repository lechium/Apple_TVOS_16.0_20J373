...
- (void).cxx_destruct;	// IMP=0x00000000002b84b2
- (id)description;	// IMP=0x00000000002b739e
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002b71d0
- (void)dealloc;	// IMP=0x00000000002b7161
- (id)initWithStore:(id)arg1;	// IMP=0x00000000002b710f
