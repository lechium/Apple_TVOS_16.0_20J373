...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000000cbaf
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000cdce
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000cbb7
- (void)dealloc;	// IMP=0x000000000000cb4b
- (id)initForRequest:(id)arg1;	// IMP=0x000000000000ca20
