...
- (_Bool)validate:(id *)arg1;	// IMP=0x000000000023e854
- (_Bool)isEqualToExtension:(id)arg1;	// IMP=0x000000000023e662
...
- (void)dealloc;	// IMP=0x000000000023e588
- (id)initWithObjectFromUserInfo:(id)arg1 onAttributeNamed:(id)arg2 onEntity:(id)arg3;	// IMP=0x000000000023e318
