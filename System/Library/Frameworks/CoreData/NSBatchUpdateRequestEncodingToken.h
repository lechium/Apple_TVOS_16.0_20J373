...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000000bb3c
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000bd75
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000bb44
- (void)dealloc;	// IMP=0x000000000000bad8
- (id)initForRequest:(id)arg1;	// IMP=0x000000000000b7f1
