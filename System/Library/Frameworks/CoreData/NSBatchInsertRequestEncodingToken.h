...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000000b097
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000000b45c
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000000b09f
- (void)dealloc;	// IMP=0x000000000000b033
- (id)initForRequest:(id)arg1;	// IMP=0x000000000000af85
