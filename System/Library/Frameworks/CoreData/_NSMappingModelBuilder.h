...
+ (void)setMigrationDebugLevel:(int)arg1;	// IMP=0x006000000005ac19
+ (int)migrationDebugLevel;	// IMP=0x006000000005ac00
- (void)dealloc;	// IMP=0x000000000005ac9b
- (id)initWithSourceModel:(id)arg1 destinationModel:(id)arg2;	// IMP=0x000000000005ac32
