...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000142a13
- (void)dealloc;	// IMP=0x00000000001429c9
- (id)initWithObjectID:(id)arg1 recordName:(id)arg2;	// IMP=0x0000000000142960
