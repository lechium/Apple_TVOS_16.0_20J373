...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000246ea2
- (id)copy;	// IMP=0x0000000000246e59
- (void)dealloc;	// IMP=0x0000000000246e00
- (id)initWithDatabase:(id)arg1 options:(id)arg2;	// IMP=0x0000000000246d8c
