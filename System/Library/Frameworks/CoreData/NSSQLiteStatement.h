...
- (id)bindIntarrays;	// IMP=0x00000000001eef97
- (id)bindVariables;	// IMP=0x00000000001eeec4
- (id)sqlString;	// IMP=0x00000000001eee80
- (id)entity;	// IMP=0x00000000001eee76
- (void)dealloc;	// IMP=0x00000000001eedf7
- (id)initWithEntity:(id)arg1;	// IMP=0x00000000001eed7c
- (id)description;	// IMP=0x00000000001eed0a
- (id)initWithEntity:(id)arg1 sqlString:(id)arg2;	// IMP=0x00000000001eeca8
