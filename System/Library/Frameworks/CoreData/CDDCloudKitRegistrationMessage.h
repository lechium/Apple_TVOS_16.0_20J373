...
+ (_Bool)supportsSecureCoding;	// IMP=0x00600000001929ff
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001928db
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000192723
- (void)dealloc;	// IMP=0x0000000000192685
