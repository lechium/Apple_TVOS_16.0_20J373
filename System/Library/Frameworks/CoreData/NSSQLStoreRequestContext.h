...
- (void)executeEpilogue;	// IMP=0x0000000000060144
- (_Bool)executeRequestUsingConnection:(id)arg1;	// IMP=0x000000000005fc52
- (_Bool)executeRequestCore:(id *)arg1;	// IMP=0x000000000005fc24
- (void)executePrologue;	// IMP=0x000000000005fc1e
@property(readonly, nonatomic) _Bool isWritingRequest;
@property(readonly, nonatomic) NSSQLRowCache *rowCache;
- (void)dealloc;	// IMP=0x000000000005faae
- (id)initWithRequest:(id)arg1 context:(id)arg2 sqlCore:(id)arg3;	// IMP=0x000000000005f940
