...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000020f661
- (id)copy;	// IMP=0x000000000020f61d
- (void)dealloc;	// IMP=0x000000000020f591
- (id)initWithOptions:(id)arg1 monitor:(id)arg2 assetStorageURL:(id)arg3 workQueue:(id)arg4 andDatabase:(id)arg5;	// IMP=0x000000000020f4ed
