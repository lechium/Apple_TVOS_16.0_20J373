...
- (void).cxx_destruct;	// IMP=0x000000000027199c
- (void)applicationWillDeactivate:(id)arg1;	// IMP=0x000000000027193a
- (void)applicationDidActivate:(id)arg1;	// IMP=0x000000000027192c
- (void)dealloc;	// IMP=0x00000000002718ab
- (id)init;	// IMP=0x000000000027111b
