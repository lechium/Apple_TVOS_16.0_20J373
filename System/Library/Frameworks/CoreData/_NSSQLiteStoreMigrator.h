...
+ (void)_setAnnotatesMigrationMetadata:(_Bool)arg1;	// IMP=0x006000000020f69e
+ (_Bool)_annotatesMigrationMetadata;	// IMP=0x006000000020f674
...
- (void)dealloc;	// IMP=0x000000000020fa04
