...
- (void)dealloc;	// IMP=0x0000000000030a8f
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x00000000000309fa
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x000000000003099b
- (void)dismiss;	// IMP=0x000000000003095d
- (void)show;	// IMP=0x000000000003080b
