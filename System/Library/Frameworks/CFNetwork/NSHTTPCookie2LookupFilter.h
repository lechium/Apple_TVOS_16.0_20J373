...
- (void).cxx_destruct;	// IMP=0x000000000012cdf5
...
- (_Bool)matchCookie:(id)arg1;	// IMP=0x000000000012c43f
- (long long)_flags;	// IMP=0x000000000012bf24
- (id)initWithCookie:(id)arg1;	// IMP=0x000000000012bd92
