...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000001a2cc0
- (id).cxx_construct;	// IMP=0x00000000001a2b02
- (void).cxx_destruct;	// IMP=0x00000000001a2a57
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001a26b4
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001a21cc
