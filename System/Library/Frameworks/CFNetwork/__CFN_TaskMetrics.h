...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000164a57
- (void).cxx_destruct;	// IMP=0x0000000000164a19
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000016490c
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001646b9
