...
- (id)uploadTaskWithStreamedRequest:(id)arg1;	// IMP=0x00000000001bf7eb
- (id)dataTaskWithRequest:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000000001bf770
- (id)dataTaskWithRequest:(id)arg1;	// IMP=0x00000000001bf708
- (id)forwardingTargetForSelector:(SEL)arg1;	// IMP=0x00000000001bf6d7
- (void)dealloc;	// IMP=0x00000000001bf68d
