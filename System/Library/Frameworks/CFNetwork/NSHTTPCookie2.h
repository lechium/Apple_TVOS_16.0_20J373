...
- (void).cxx_destruct;	// IMP=0x0000000000082e2f
...
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000082b10
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000082b05
- (id)description;	// IMP=0x00000000000828f9
@property(readonly) NSDate *expirationDate;
@property(readonly) NSDate *creationDate; // @synthesize creationDate;
- (id)initWithName:(id)arg1 value:(id)arg2 domain:(id)arg3;	// IMP=0x00000000000826be
