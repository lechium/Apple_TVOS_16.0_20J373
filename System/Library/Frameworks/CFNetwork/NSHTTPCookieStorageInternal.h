...
- (void)dealloc;	// IMP=0x00000000001f6e5d
- (void)_syncCookies;	// IMP=0x00000000001f6de7
- (void)registerForPostingNotificationsWithContext:(id)arg1;	// IMP=0x00000000001f6c85
