...
- (void)reset;	// IMP=0x00000000000291e4
- (void)evaluateForState:(long long)arg1;	// IMP=0x0000000000028f16
- (id)initWithScrollView:(id)arg1 axis:(long long)arg2;	// IMP=0x0000000000028dc3
