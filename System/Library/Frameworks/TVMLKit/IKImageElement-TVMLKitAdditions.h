...
- (id)tv_urlWithLayout:(id)arg1;	// IMP=0x0030000000062c1b
- (id)tv_urlWithSize:(struct CGSize)arg1 focusSizeIncrease:(double)arg2;	// IMP=0x0030000000062b65
- (id)tv_urlWithSize:(struct CGSize)arg1 focusSizeIncrease:(double)arg2 centerGrowth:(_Bool)arg3 cropCode:(id)arg4;	// IMP=0x0030000000062938
...
- (id)tv_imageProxyWithLayout:(id)arg1;	// IMP=0x00300000000624a4
...
- (id)tv_associatedViewElement;	// IMP=0x00300000000d1c92
@end
