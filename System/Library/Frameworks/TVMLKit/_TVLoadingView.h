...
- (void).cxx_destruct;	// IMP=0x00000000000f25f8
...
- (void)_showSpinner;	// IMP=0x00000000000f23ac
- (_Bool)canBecomeFocused;	// IMP=0x00000000000f23a4
- (void)layoutSubviews;	// IMP=0x00000000000f1ee8
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000f1c71
