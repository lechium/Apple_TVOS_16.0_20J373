...
- (void).cxx_destruct;	// IMP=0x0000000000077fdc
...
- (id)impressionableElementsContainedInDocument:(id)arg1;	// IMP=0x0000000000077c8f
- (long long)_positionFromView:(id)arg1;	// IMP=0x0000000000077c6d
- (struct CGSize)_contentSizeThatFits:(struct CGSize)arg1;	// IMP=0x000000000007774f
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x0000000000077663
- (id)preferredFocusEnvironments;	// IMP=0x000000000007740d
- (_Bool)canBecomeFocused;	// IMP=0x0000000000077405
- (void)tv_setShowcaseFactor:(double)arg1;	// IMP=0x00000000000771c7
- (void)setSelected:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x00000000000771b2
- (void)setSelected:(_Bool)arg1 animated:(_Bool)arg2 withAnimationCoordinator:(id)arg3;	// IMP=0x0000000000076cfa
- (void)layoutSubviews;	// IMP=0x0000000000075871
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000000000756b1
- (struct UIEdgeInsets)tv_alignmentInsetsForExpectedWidth:(double)arg1;	// IMP=0x000000000007415c
@property(nonatomic) double cornerRadius;
- (void)setComponentsNeedUpdate;	// IMP=0x0000000000072cf1
@property(nonatomic) __weak UIView *preferredFocusedComponent;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000000072be0
