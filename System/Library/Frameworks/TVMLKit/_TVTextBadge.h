...
+ (id)textBadgeViewWithElement:(id)arg1 existingView:(id)arg2;	// IMP=0x0060000000050871
- (void).cxx_destruct;	// IMP=0x0000000000050fd1
...
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x0000000000050d0c
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000000050c0a
