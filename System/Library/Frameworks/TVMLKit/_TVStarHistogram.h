...
+ (id)_histogramViewWithElement:(id)arg1 existingView:(id)arg2;	// IMP=0x006000000014ec49
+ (id)histogramViewWithElement:(id)arg1 existingView:(id)arg2;	// IMP=0x006000000014e961
- (void).cxx_destruct;	// IMP=0x000000000014ffbd
...
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x000000000014f589
- (_Bool)canBecomeFocused;	// IMP=0x000000000014f581
