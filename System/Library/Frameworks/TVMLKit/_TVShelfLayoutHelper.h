...
- (void).cxx_destruct;	// IMP=0x0000000000099f98
...
- (void)_freeBuffers;	// IMP=0x0000000000099ee4
- (void)_compute;	// IMP=0x00000000000992af
- (struct CGRect)frameForItemAtIndexPath:(id)arg1;	// IMP=0x0000000000099211
- (struct UIEdgeInsets)insetForSection:(long long)arg1;	// IMP=0x00000000000991d6
- (struct CGRect)frameForHeaderInSection:(long long)arg1;	// IMP=0x000000000009919b
- (void)dealloc;	// IMP=0x000000000009915d
- (id)initWithShelfViewLayout:(id)arg1;	// IMP=0x00000000000990e9
