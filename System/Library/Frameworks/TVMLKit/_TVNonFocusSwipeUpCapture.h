...
- (void).cxx_destruct;	// IMP=0x00000000000b2703
...
- (void)_onPan:(id)arg1;	// IMP=0x00000000000b233e
- (_Bool)gestureRecognizer:(id)arg1 shouldRecognizeSimultaneouslyWithGestureRecognizer:(id)arg2;	// IMP=0x00000000000b22ad
- (id)initWithTarget:(id)arg1 action:(SEL)arg2;	// IMP=0x00000000000b21e0
