...
- (void).cxx_destruct;	// IMP=0x00000000000b9120
...
- (void)layoutSubviews;	// IMP=0x00000000000b8110
@property(readonly, nonatomic) long long listAlignment;
- (void)adjustScrollForListView:(id)arg1;	// IMP=0x00000000000b7f91
- (id)preferredFocusEnvironments;	// IMP=0x00000000000b7f18
- (void)setOverlayBlurOffset:(double)arg1;	// IMP=0x00000000000b7db5
- (void)setSemanticContentAttribute:(long long)arg1;	// IMP=0x00000000000b780d
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000000000b773a
