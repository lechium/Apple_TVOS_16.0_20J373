...
- (void).cxx_destruct;	// IMP=0x00000000000293fa
...
- (void)addDerivedTemplateNode:(id)arg1;	// IMP=0x000000000002935a
@property(readonly, copy, nonatomic) NSArray *derivedTemplateNodes;
- (id)initWithTemplateName:(id)arg1 styleSheetURLs:(id)arg2 abstract:(_Bool)arg3;	// IMP=0x000000000002927d
- (id)initWithTemplateName:(id)arg1 styleSheetURLs:(id)arg2;	// IMP=0x0000000000029268
