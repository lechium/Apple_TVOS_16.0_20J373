...
- (void)tv_resolveWithTextLayoutDirection:(long long)arg1 layoutObserver:(CDUnknownBlockType)arg2;	// IMP=0x003000000009ec3d
- (void)tv_setImage:(id)arg1;	// IMP=0x003000000009e96d
...
- (void)tv_setResolving:(_Bool)arg1;	// IMP=0x003000000009e801
@property(readonly, nonatomic, getter=tv_isResolving) _Bool tv_resolving;
- (void)tv_setImageProxy:(id)arg1;	// IMP=0x003000000009e755
- (id)tv_imageProxy;	// IMP=0x003000000009e744
@end
