...
- (void).cxx_destruct;	// IMP=0x000000000004a9f1
@property(nonatomic) __weak UIView<TVAuxiliaryViewSelecting> *selectingView; // @synthesize selectingView=_selectingView;
- (struct UIEdgeInsets)selectionMarginsForSize:(struct CGSize)arg1;	// IMP=0x000000000004a96f
- (void)layoutSubviews;	// IMP=0x000000000004a6f8
