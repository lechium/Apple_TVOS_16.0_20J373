...
- (void).cxx_destruct;	// IMP=0x0000000000154a93
...
- (void)animateTransition:(id)arg1;	// IMP=0x0000000000154548
- (double)transitionDuration:(id)arg1;	// IMP=0x0000000000154476
- (id)initWithInlineFrame:(struct CGRect)arg1 playerViewController:(id)arg2;	// IMP=0x00000000001543f8
