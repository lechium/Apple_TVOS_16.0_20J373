...
- (void)rotateByAngle:(float)arg1;	// IMP=0x000000000002d464
- (double)normalizeAngle:(double)arg1;	// IMP=0x000000000002d407
- (id)initWithNode:(id)arg1;	// IMP=0x000000000002d332
