...
- (id).cxx_construct;	// IMP=0x0000000000241104
- (void).cxx_destruct;	// IMP=0x00000000002410d3
- (id)nextObject;	// IMP=0x0000000000240fb4
- (id)initWithElectrocardiogram:(id)arg1 leadIMicroVoltsBegin:(__wrap_iter_9551a0eb)arg2 end:(__wrap_iter_9551a0eb)arg3;	// IMP=0x0000000000240e2d
