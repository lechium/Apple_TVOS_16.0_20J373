...
+ (_Bool)supportsSecureCoding;	// IMP=0x00600000001d69ff
- (void).cxx_destruct;	// IMP=0x00000000001d6bad
@property(nonatomic) unsigned long long limit; // @synthesize limit=_limit;
@property(copy, nonatomic) HKSampleIteratorQueryCursor *queryCursor; // @synthesize queryCursor=_queryCursor;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001d6ac9
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001d6a07
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001d6989
