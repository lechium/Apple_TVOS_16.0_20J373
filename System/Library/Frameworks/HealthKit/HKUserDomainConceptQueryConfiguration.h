...
+ (_Bool)supportsSecureCoding;	// IMP=0x00600000000bd95b
- (void).cxx_destruct;	// IMP=0x00000000000bdbbe
@property(nonatomic) unsigned long long limit; // @synthesize limit=_limit;
@property(copy, nonatomic) HKQueryAnchor *anchor; // @synthesize anchor=_anchor;
@property(copy, nonatomic) NSArray *sortDescriptors; // @synthesize sortDescriptors=_sortDescriptors;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000bda9a
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000bd963
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000bd892
