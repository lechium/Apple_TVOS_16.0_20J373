...
- (void).cxx_destruct;	// IMP=0x00000000000aacbd
...
- (id)_parseCDADate:(id)arg1;	// IMP=0x00000000000aaae1
- (id)_personNameFrom:(id)arg1 familyTagRule:(id)arg2 givenTagRule:(id)arg3 nilOnFail:(_Bool)arg4;	// IMP=0x00000000000aa8df
- (id)_firstFrom:(id)arg1 tagRule:(id)arg2 nilOnFail:(_Bool)arg3;	// IMP=0x00000000000aa83f
- (void)extractHeaderFieldsFromDocumentData:(id)arg1;	// IMP=0x00000000000aa57f
- (id)initWithDocumentData:(id)arg1;	// IMP=0x00000000000aa517
