...
+ (_Bool)supportsSecureCoding;	// IMP=0x0060000000147005
- (void).cxx_destruct;	// IMP=0x000000000014726b
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000147188
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000014700d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000146f8f
