...
- (void).cxx_destruct;	// IMP=0x00000000000a0baa
@property(copy, nonatomic) NSCharacterSet *characterSet; // @synthesize characterSet=_characterSet;
- (unsigned long long)_minimumLength;	// IMP=0x00000000000a0b79
- (id)_label;	// IMP=0x00000000000a0b6c
- (_Bool)_scanValue:(id *)arg1 withScanner:(id)arg2;	// IMP=0x000000000001b591
