...
+ (id)ruleIdentifier;	// IMP=0x001000000012c4b4
- (void).cxx_destruct;	// IMP=0x000000000012c609
@property(retain, nonatomic) NSString *modelNumberPrefix; // @synthesize modelNumberPrefix=_modelNumberPrefix;
- (_Bool)evaluate;	// IMP=0x000000000012c51a
- (void)processUserInfo:(id)arg1;	// IMP=0x000000000012c4c1
