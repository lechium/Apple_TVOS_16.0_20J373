...
+ (_Bool)supportsSecureCoding;	// IMP=0x0060000000017edb
- (void).cxx_destruct;	// IMP=0x0000000000011643
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000008d8d0
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000001bc4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000008d810
