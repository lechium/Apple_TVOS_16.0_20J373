...
+ (id)nodeWithChildren:(id)arg1 rule:(id)arg2 rangeOfString:(struct _NSRange)arg3;	// IMP=0x0060000000019ca3
- (void).cxx_destruct;	// IMP=0x0000000000019e1e
@property(readonly, nonatomic) _HKCFGReplacementRule *rule; // @synthesize rule=_rule;
- (id)evaluate;	// IMP=0x0000000000019e73
