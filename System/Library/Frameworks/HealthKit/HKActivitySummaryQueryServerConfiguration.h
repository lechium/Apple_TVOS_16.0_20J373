...
+ (_Bool)supportsSecureCoding;	// IMP=0x00600000000ea208
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000ea2eb
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000ea210
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000ea15f
