...
+ (_Bool)supportsSecureCoding;	// IMP=0x00600000000b2050
- (void).cxx_destruct;	// IMP=0x00000000000b2264
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000b2140
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000b2058
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000b1fc2
