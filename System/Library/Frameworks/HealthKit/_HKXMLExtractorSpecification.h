...
- (void).cxx_destruct;	// IMP=0x00000000001d2a42
...
- (_Bool)matchesElementStack:(id)arg1;	// IMP=0x00000000001d28f2
- (id)initWithSpecificationString:(id)arg1;	// IMP=0x00000000001d266c
