...
+ (id)ruleIdentifier;	// IMP=0x00100000001f9541
- (void).cxx_destruct;	// IMP=0x00000000001f96f9
@property(retain, nonatomic) NSString *buildVersion; // @synthesize buildVersion=_buildVersion;
- (_Bool)evaluate;	// IMP=0x00000000001f95c3
- (void)processUserInfo:(id)arg1;	// IMP=0x00000000001f954e
