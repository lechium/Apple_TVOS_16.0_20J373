...
- (void).cxx_destruct;	// IMP=0x0000000000019de6
...
- (void)increaseLengthAllowance:(unsigned long long)arg1;	// IMP=0x0000000000019808
- (void)decreaseLengthAllowance:(unsigned long long)arg1;	// IMP=0x0000000000019405
- (void)decrementRecursiveDepth;	// IMP=0x0000000000019812
- (void)incrementRecursiveDepth;	// IMP=0x000000000001940f
- (id)initWithScanner:(id)arg1 lengthAllowance:(unsigned long long)arg2;	// IMP=0x0000000000018990
