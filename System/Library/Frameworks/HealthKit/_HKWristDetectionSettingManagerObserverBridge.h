...
- (void).cxx_destruct;	// IMP=0x0000000000136828
@property(readonly, nonatomic) HKObserverBridgeHandle *handle; // @synthesize handle=_handle;
- (void)wristDetectionSettingManagerDidObserveWristDetectChange:(id)arg1;	// IMP=0x00000000001366c0
- (id)initWithHandle:(id)arg1;	// IMP=0x0000000000136655
