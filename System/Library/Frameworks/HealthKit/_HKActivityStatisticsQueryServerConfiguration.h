...
+ (_Bool)supportsSecureCoding;	// IMP=0x006000000012b561
- (void).cxx_destruct;	// IMP=0x000000000012b9e4
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000012b791
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000012b569
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000012b4a1
