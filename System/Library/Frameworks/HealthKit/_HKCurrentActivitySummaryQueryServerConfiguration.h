...
+ (_Bool)supportsSecureCoding;	// IMP=0x0060000000004fc8
- (void).cxx_destruct;	// IMP=0x0000000000017e0c
@property(copy, nonatomic) NSDictionary *collectionIntervals; // @synthesize collectionIntervals=_collectionIntervals;
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001362c4
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000002675
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000013625f
