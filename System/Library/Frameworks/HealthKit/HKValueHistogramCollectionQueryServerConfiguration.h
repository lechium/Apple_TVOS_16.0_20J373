...
+ (_Bool)supportsSecureCoding;	// IMP=0x00600000001eff2b
- (void).cxx_destruct;	// IMP=0x00000000001f01a7
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001f0087
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001eff33
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001efeb7
