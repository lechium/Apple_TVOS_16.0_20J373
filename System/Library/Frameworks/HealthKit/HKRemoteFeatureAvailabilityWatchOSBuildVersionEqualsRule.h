...
+ (id)ruleIdentifier;	// IMP=0x001000000005a948
- (void).cxx_destruct;	// IMP=0x000000000005aae4
@property(retain, nonatomic) NSString *buildVersion; // @synthesize buildVersion=_buildVersion;
- (_Bool)evaluate;	// IMP=0x000000000005a9ae
- (void)processUserInfo:(id)arg1;	// IMP=0x000000000005a955
