...
- (void).cxx_destruct;	// IMP=0x00000000000a0ea9
@property(copy, nonatomic) NSCharacterSet *characterSet; // @synthesize characterSet=_characterSet;
- (unsigned long long)_minimumLength;	// IMP=0x00000000000a0e78
- (id)_label;	// IMP=0x00000000000a0e6b
- (_Bool)_scanValue:(id *)arg1 withScanner:(id)arg2;	// IMP=0x00000000000a0dff
