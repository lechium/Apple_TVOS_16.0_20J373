...
+ (_Bool)supportsSecureCoding;	// IMP=0x0060000000008f17
- (void).cxx_destruct;	// IMP=0x0000000000017ddb
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000dfd93
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000028ae
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000dfca0
