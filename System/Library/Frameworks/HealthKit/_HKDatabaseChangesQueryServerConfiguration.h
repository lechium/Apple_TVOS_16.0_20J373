...
+ (_Bool)supportsSecureCoding;	// IMP=0x00600000001fa6bb
- (void).cxx_destruct;	// IMP=0x00000000001fa9ef
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000001fa84b
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000001fa6c3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000001fa5fc
