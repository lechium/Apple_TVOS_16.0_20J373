...
+ (_Bool)supportsSecureCoding;	// IMP=0x0060000000172c26
- (void).cxx_destruct;	// IMP=0x000000000017309b
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000172e3f
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000172c2e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000172b20
