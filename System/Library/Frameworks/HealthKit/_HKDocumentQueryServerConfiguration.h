...
+ (_Bool)supportsSecureCoding;	// IMP=0x006000000022dbd1
- (void).cxx_destruct;	// IMP=0x000000000022de2c
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000022dd08
- (id)initWithCoder:(id)arg1;	// IMP=0x000000000022dbd9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000022db42
