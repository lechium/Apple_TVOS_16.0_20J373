...
- (void)createConnection;	// IMP=0x0000000000030f2a
- (void)didSmoothLocations:(id)arg1 ofType:(id)arg2;	// IMP=0x0000000000030e65
- (void)dealloc;	// IMP=0x0000000000030dd6
- (id)initWithCLLocationSmoother:(id)arg1;	// IMP=0x0000000000030ccd
