...
+ (const char *)trackerStateTypeName;	// IMP=0x0060000000010814
+ (unsigned long long)trackerStateSize;	// IMP=0x0060000000010809
- (void *)identifier;	// IMP=0x0000000000010821
- (_Bool)dumpState:(void *)arg1 withSize:(unsigned long long)arg2 hints:(struct os_state_hints_s *)arg3;	// IMP=0x0000000000010653
- (void)updateState:(CDUnknownBlockType)arg1;	// IMP=0x0000000000010296
...
- (void)dealloc;	// IMP=0x000000000000db3b
- (id)initWithQueue:(id)arg1 identifier:(void *)arg2 state:(CDUnknownBlockType)arg3;	// IMP=0x000000000000d6bb
- (id)initWithQueue:(id)arg1 identifier:(void *)arg2;	// IMP=0x000000000000d6a6
- (id)initInSilo:(id)arg1 withIdentifier:(void *)arg2 state:(CDUnknownBlockType)arg3;	// IMP=0x000000000000d645
- (id)initInSilo:(id)arg1 withIdentifier:(void *)arg2;	// IMP=0x000000000000d630
