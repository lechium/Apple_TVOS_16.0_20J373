...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000053241
- (_Bool)inUseLevelIsAtLeast:(int)arg1;	// IMP=0x0000000000053235
- (_Bool)isAuthorizedForServiceType:(unsigned long long)arg1;	// IMP=0x0000000000053216
- (_Bool)isAuthorizedForServiceTypeMask:(unsigned long long)arg1;	// IMP=0x00000000000531cf
- (_Bool)isNonProvisionallyAuthorizedForServiceType:(unsigned long long)arg1;	// IMP=0x00000000000531b0
- (_Bool)isNonProvisionallyAuthorizedForServiceTypeMask:(unsigned long long)arg1;	// IMP=0x000000000005318a
- (id)description;	// IMP=0x0000000000053149
- (id)authorizationContextByANDingServiceMaskTuple:(struct CLClientServiceTypeMaskTuple)arg1;	// IMP=0x00000000000530c0
- (id)initWithInUseLevel:(int)arg1 registrationResult:(int)arg2 transientAwareRegistrationResult:(int)arg3 serviceMaskTuple:(struct CLClientServiceTypeMaskTuple)arg4 authorizedForWidgetUpdates:(_Bool)arg5;	// IMP=0x0000000000053059
