...
- (void)dealloc;	// IMP=0x0000000000010ddf
- (void)invalidate;	// IMP=0x0000000000010dca
- (void)performCourtesyPromptIfNeeded;	// IMP=0x0000000000010d91
- (void)cancelLingeringRangingRequest;	// IMP=0x0000000000010d5a
- (_Bool)hasLingeringRangingRequest;	// IMP=0x0000000000010c65
- (void)cancelRangingRequest;	// IMP=0x0000000000010c04
- (void)cancelLocationRequest;	// IMP=0x0000000000010bc1
- (void)stopUpdatingLocationAutoPaused;	// IMP=0x0000000000010b80
- (_Bool)showsBackgroundLocationIndicator;	// IMP=0x0000000000010b6a
- (void)setShowsBackgroundLocationIndicator:(_Bool)arg1;	// IMP=0x0000000000010b3c
- (_Bool)allowsBackgroundLocationUpdates;	// IMP=0x0000000000010b26
- (void)setAllowsBackgroundLocationUpdates:(_Bool)arg1;	// IMP=0x0000000000010af8
- (int)PausesLocationUpdatesAutomatically;	// IMP=0x0000000000010ae2
- (void)setPausesLocationUpdatesAutomatically:(int)arg1;	// IMP=0x0000000000010a9a
- (id)initWithInfo:(id)arg1 bundleIdentifier:(id)arg2 bundlePath:(id)arg3 websiteIdentifier:(id)arg4 delegate:(id)arg5 silo:(id)arg6;	// IMP=0x0000000000010832
