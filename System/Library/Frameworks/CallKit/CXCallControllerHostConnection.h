...
- (void).cxx_destruct;	// IMP=0x0000000000044b70
...
- (oneway void)requestTransaction:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x000000000004496f
- (oneway void)requestCalls:(CDUnknownBlockType)arg1;	// IMP=0x0000000000044869
- (oneway void)removeCall:(id)arg1;	// IMP=0x00000000000447f7
- (oneway void)addOrUpdateCall:(id)arg1;	// IMP=0x0000000000044785
...
- (void)dealloc;	// IMP=0x0000000000044533
- (id)initWithConnection:(id)arg1 serialQueue:(id)arg2;	// IMP=0x0000000000043f1a
- (id)init;	// IMP=0x0000000000043f0c
