...
- (void).cxx_destruct;	// IMP=0x000000000004e63f
...
- (void)sendNetworkExtensionMessage:(id)arg1 forBundleIdentifier:(id)arg2 reply:(CDUnknownBlockType)arg3;	// IMP=0x000000000004e3f1
- (void)invalidate;	// IMP=0x000000000004e391
...
- (void)dealloc;	// IMP=0x000000000004e2af
- (id)initWithConnection:(id)arg1;	// IMP=0x000000000004de74
