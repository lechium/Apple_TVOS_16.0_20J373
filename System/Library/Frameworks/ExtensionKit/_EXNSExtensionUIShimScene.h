...
- (void).cxx_destruct;	// IMP=0x00000000000076ab
@property(retain) UIViewController *viewController; // @synthesize viewController;
- (_Bool)shouldAcceptConnection:(id)arg1;	// IMP=0x00000000000075ca
- (void)connectToSession:(id)arg1;	// IMP=0x0000000000007428
- (id)makePrincipalObjectForExtension:(id)arg1;	// IMP=0x000000000000732b
