...
- (void).cxx_destruct;	// IMP=0x00000000000045b9
...
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x00000000000041f2
- (void)makeSceneHostViewController;	// IMP=0x0000000000004192
- (void)requestRemoteViewController;	// IMP=0x0000000000003f23
- (void)_internalQueue_prepareToHost;	// IMP=0x0000000000002f20
- (void)_invalidateSession;	// IMP=0x0000000000002e6c
- (void)processDidInvalidate:(id)arg1;	// IMP=0x0000000000002db3
- (void)invalidate;	// IMP=0x0000000000002d79
- (void)resume;	// IMP=0x0000000000002cd1
- (id)makeXPCConnectionWithError:(id *)arg1;	// IMP=0x00000000000022fe
- (void)dealloc;	// IMP=0x000000000000218b
- (id)initWithConfiguration:(id)arg1;	// IMP=0x0000000000001fc0
