...
- (void)_computeUsageForArguments:(id)arg1 function:(id)arg2;	// IMP=0x0000000000117714
- (_Bool)matchesRenderPassDescriptor:(id)arg1;	// IMP=0x00000000001175b1
- (id)description;	// IMP=0x0000000000116ee4
- (void)dealloc;	// IMP=0x0000000000116e4e
- (id)init;	// IMP=0x0000000000116e14
