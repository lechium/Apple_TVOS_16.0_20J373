...
- (void)dealloc;	// IMP=0x000000000027cafc
- (_Bool)isOpaque;	// IMP=0x000000000027caec
- (id)textureSource;	// IMP=0x000000000027c9fd
- (id)prepareWindowIfNeeded;	// IMP=0x000000000027c7a9
- (_Bool)supportsMetal;	// IMP=0x000000000027c7a1
- (id)init;	// IMP=0x000000000027c772
