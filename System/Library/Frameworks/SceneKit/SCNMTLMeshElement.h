...
- (void)setPrimitiveRange:(CDStruct_912cb5d2)arg1;	// IMP=0x0000000000118680
@property(readonly, nonatomic) long long effectivePrimitiveCount;
@property(readonly, nonatomic) long long primitiveCount;
- (void)setupWithElement:(struct __C3DMeshElement *)arg1;	// IMP=0x0000000000118497
- (id)description;	// IMP=0x000000000011840b
- (void)dealloc;	// IMP=0x00000000001183cb
