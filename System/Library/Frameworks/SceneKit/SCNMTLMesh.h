...
- (id)bufferForAttribute:(long long)arg1;	// IMP=0x000000000011829a
- (void)dealloc;	// IMP=0x0000000000118234
- (id)description;	// IMP=0x0000000000117fca
...
- (void)buildTessellationVertexDescriptorIfNeeded;	// IMP=0x0000000000117bd4
