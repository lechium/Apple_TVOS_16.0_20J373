...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000179a15
...
- (void)dealloc;	// IMP=0x0000000000179b24
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000179ad3
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000179a1d
