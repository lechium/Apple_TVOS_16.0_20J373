...
- (id)newSubBufferWithBytes:(const void *)arg1 length:(unsigned long long)arg2 renderContext:(id)arg3;	// IMP=0x0000000000100a96
- (id)_newSubBuffer;	// IMP=0x000000000010087d
- (void)dealloc;	// IMP=0x0000000000100833
- (id)initWithDevice:(id)arg1 fixedSizeElement:(unsigned long long)arg2 buffersize:(unsigned long long)arg3 name:(id)arg4;	// IMP=0x000000000010076d
