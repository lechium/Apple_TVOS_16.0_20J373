...
+ (id)animationWithSCNAnimation:(id)arg1;	// IMP=0x00200000001c19b5
@property(copy, nonatomic) NSArray *animationEvents;
- (void)setCommitsOnCompletion:(_Bool)arg1;	// IMP=0x00100000001c190f
- (_Bool)commitsOnCompletion;	// IMP=0x00100000001c18dd
