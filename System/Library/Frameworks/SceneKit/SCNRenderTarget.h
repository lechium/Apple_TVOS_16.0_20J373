...
- (id)ciImage;	// IMP=0x000000000008da78
- (id)textureForSliceIndex:(unsigned long long)arg1;	// IMP=0x000000000008d8eb
- (_Bool)matchesDescription:(CDStruct_ace98575 *)arg1 size:(unsigned long long)arg2 arrayLength: /* Error: Ran out of types for this method. */;	// IMP=0x000000000008d7e6
@property(readonly, nonatomic) unsigned char renderBufferFormat;
@property(readonly, nonatomic) _Bool viewportDependant;
- (id)description;	// IMP=0x000000000008d733
- (void)dealloc;	// IMP=0x000000000008d6db
- (id)initWithDescription:(CDStruct_ace98575 *)arg1 size:(unsigned long long)arg2 arrayLength: /* Error: Ran out of types for this method. */;	// IMP=0x000000000008d681
