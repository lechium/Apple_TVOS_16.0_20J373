...
- (CDUnknownBlockType)requestDataForPasteboard:(struct __CFPasteboard *)arg1 generation:(long long)arg2 immediatelyAvailableResult:(CDStruct_55991ab6 *)arg3;	// IMP=0x000000000006aa12
- (void)resolveClientPromisedDataWithQueue:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000000006a6e9
- (unsigned char)resolveLocalPromisedData;	// IMP=0x000000000006a63e
- (void)promiseDataWithBlock:(CDUnknownBlockType)arg1 forPasteboard:(struct __CFPasteboard *)arg2 generation:(long long)arg3;	// IMP=0x000000000006a515
- (id)createXPCObjectWithMetadataOnly:(unsigned char)arg1;	// IMP=0x000000000006a3dd
- (id)initFromXPCObject:(id)arg1 fromConnection:(id)arg2;	// IMP=0x000000000006a02b
@property(readonly) unsigned char promisorExistsInCurrentProcess;
- (void)_setLocalPromiseState:(unsigned char)arg1;	// IMP=0x0000000000069ed0
@property(readonly) unsigned char hasLocalPromise;
- (const struct __CFData *)createDataAndReturnError:(int *)arg1;	// IMP=0x0000000000069d7f
- (id)_createXPCData;	// IMP=0x0000000000069d2a
- (void)setData:(struct __CFData *)arg1;	// IMP=0x0000000000069c94
@property(readonly) unsigned char hasData;
- (id)description;	// IMP=0x0000000000069aea
- (void)dealloc;	// IMP=0x0000000000069a1a
- (id)initWithFlavorName:(const struct __CFString *)arg1 itemIdentifier:(int)arg2;	// IMP=0x000000000006997e
- (void)promiseDataWithFetchOperation:(id)arg1;	// IMP=0x000000000009079b
