...
- (void).cxx_destruct;	// IMP=0x000000000017d95f
- (id)_parsedContentNode:(id)arg1 additionalAttributesFromParent:(id)arg2;	// IMP=0x000000000017d69d
- (id)_parsedElements:(id)arg1;	// IMP=0x000000000017d472
- (id)_parsedSectionedCollection;	// IMP=0x000000000017cca0
@property(readonly, nonatomic) MPSectionedCollection *results;
- (id)initWithRawResponseOutput:(id)arg1 sectionBuilder:(id)arg2 contentItemBuilder:(id)arg3 filteredFCKinds:(id)arg4 userIdentity:(id)arg5;	// IMP=0x000000000017cb3f
