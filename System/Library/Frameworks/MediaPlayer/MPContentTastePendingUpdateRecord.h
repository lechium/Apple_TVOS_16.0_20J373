...
- (void).cxx_destruct;	// IMP=0x000000000029d79f
...
- (void)_initializeWithType:(long long)arg1 tasteType:(long long)arg2;	// IMP=0x000000000029d72c
- (id)initWithStoreAdamID:(long long)arg1 tasteType:(long long)arg2;	// IMP=0x000000000029d6c6
- (id)initWithPlaylistGlobalID:(id)arg1 tasteType:(long long)arg2;	// IMP=0x000000000029d632
