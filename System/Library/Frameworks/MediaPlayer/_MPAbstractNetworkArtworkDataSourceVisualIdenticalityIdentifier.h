...
- (void).cxx_destruct;	// IMP=0x00000000000f8499
...
- (id)stringRepresentation;	// IMP=0x00000000000f83a2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000f834f
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000f82a2
