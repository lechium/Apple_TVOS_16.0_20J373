...
@interface _MPMediaLibraryEntityPropertyTranslator : NSObject
{
    ...
    shared_ptr_a9db792c _propertiesToFetchMap;	// 32 = 0x20
    shared_ptr_a9db792c _propertiesToSortMap;	// 48 = 0x30
}

- (id).cxx_construct;	// IMP=0x00000000002a57ec
- (void).cxx_destruct;	// IMP=0x00000000002a57a7
