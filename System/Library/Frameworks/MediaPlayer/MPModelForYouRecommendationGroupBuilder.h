...
+ (id)allSupportedItemProperties;	// IMP=0x006000000020ee73
+ (id)allSupportedGroupProperties;	// IMP=0x006000000020ed99
- (void).cxx_destruct;	// IMP=0x000000000020e348
...
- (id)modelObjectForRecommendationDictionary:(id)arg1 userIdentity:(id)arg2;	// IMP=0x000000000020de6c
- (id)initWithRequestedGroupPropertySet:(id)arg1 requestedItemPropertySet:(id)arg2 storeItemMetadataResults:(id)arg3 flatSectionedItems:(id)arg4;	// IMP=0x000000000020dd57
