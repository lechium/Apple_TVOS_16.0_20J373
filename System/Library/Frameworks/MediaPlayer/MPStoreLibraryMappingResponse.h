...
- (void).cxx_destruct;	// IMP=0x0000000000143b23
@property(nonatomic) long long libraryAddedStatus; // @synthesize libraryAddedStatus=_libraryAddedStatus;
- (void)setLibraryIdentifierSet:(id)arg1 forIdentifierSet:(id)arg2;	// IMP=0x0000000000143a6f
- (id)libraryIdentifierSetForIdentifierSet:(id)arg1;	// IMP=0x0000000000143a59
