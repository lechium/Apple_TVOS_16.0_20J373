...
- (void).cxx_destruct;	// IMP=0x000000000023a071
...
- (unsigned long long)hash;	// IMP=0x0000000000239fa2
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000239ec0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000239e02
- (void)copyTo:(id)arg1;	// IMP=0x0000000000239d08
- (void)writeTo:(id)arg1;	// IMP=0x0000000000239c0e
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000239c01
- (id)dictionaryRepresentation;	// IMP=0x0000000000239af7
- (id)description;	// IMP=0x0000000000239a48
@property(nonatomic) _Bool hasComparisonType;
@property(readonly, nonatomic) _Bool hasValue;
@property(readonly, nonatomic) _Bool hasProperty;
- (void)dealloc;	// IMP=0x0000000000239982
