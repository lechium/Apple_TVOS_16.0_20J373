...
- (void).cxx_destruct;	// IMP=0x0000000000059f0f
...
- (id)_startEntryProxy;	// IMP=0x0000000000059df7
- (id)nextObject;	// IMP=0x0000000000059d12
- (id)nextObjectWithExclusiveAccessToken:(id)arg1;	// IMP=0x0000000000059408
- (id)initWithSectionedIdentifierList:(id)arg1 options:(unsigned long long)arg2 startEntry:(id)arg3 endEntry:(id)arg4 withExclusiveAccessToken:(id)arg5;	// IMP=0x0000000000059031
