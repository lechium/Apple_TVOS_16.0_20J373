...
- (void).cxx_destruct;	// IMP=0x0000000000281bd5
...
- (unsigned long long)hash;	// IMP=0x0000000000281ae6
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002819c4
- (id)initWithArtworkCatalog:(id)arg1 representativeSize:(struct CGSize)arg2;	// IMP=0x000000000028192b
