...
- (void).cxx_destruct;	// IMP=0x0000000000058c4a
...
- (id)nextObject;	// IMP=0x0000000000058ac3
- (id)nextObjectWithExclusiveAccessToken:(id)arg1;	// IMP=0x0000000000058590
- (id)initWithSectionedIdentifierList:(id)arg1 options:(unsigned long long)arg2 startEntry:(id)arg3 endEntry:(id)arg4 withExclusiveAccessToken:(id)arg5;	// IMP=0x0000000000057c6d
