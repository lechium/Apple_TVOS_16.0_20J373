...
+ (id)allSupportedItemProperties;	// IMP=0x00600000001be2dc
+ (id)allSupportedGroupProperties;	// IMP=0x00600000001be1e1
- (void).cxx_destruct;	// IMP=0x00000000001bc795
...
- (id)modelObjectForRecommendationDictionary:(id)arg1 userIdentity:(id)arg2;	// IMP=0x00000000001bc3f9
- (id)modelObjectForItemsArray:(id)arg1 userIdentity:(id)arg2;	// IMP=0x00000000001bc2d3
- (id)modelObjectForRecentlyPlayedArray:(id)arg1 userIdentity:(id)arg2;	// IMP=0x00000000001bc1ad
- (void)initializeRequestedGroupProperties;	// IMP=0x00000000001bbebd
- (id)initWithRequestedGroupPropertySet:(id)arg1 requestedItemPropertySet:(id)arg2 storeItemMetadataResults:(id)arg3 flatSectionedItems:(id)arg4 storeURLBag:(id)arg5 isListenNow:(_Bool)arg6;	// IMP=0x00000000001bbd75
