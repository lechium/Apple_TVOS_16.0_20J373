...
+ (id)endEntry;	// IMP=0x0010000000058f4f
+ (id)startEntry;	// IMP=0x0010000000058f2e
...
- (id)trackingEntryResult;	// IMP=0x0000000000058f14
- (id)itemResult;	// IMP=0x0000000000058f0c
