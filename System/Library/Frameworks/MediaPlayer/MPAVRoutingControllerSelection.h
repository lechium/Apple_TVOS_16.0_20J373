...
- (void).cxx_destruct;	// IMP=0x0000000000077ec8
...
- (id)description;	// IMP=0x0000000000077e15
- (id)initWithRoutes:(id)arg1 selectionOperation:(long long)arg2;	// IMP=0x0000000000077d9f
