...
- (unsigned long long)hash;	// IMP=0x0000000000228992
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002288ac
- (id)initWithPersistentID:(unsigned long long)arg1 size:(struct CGSize)arg2;	// IMP=0x0000000000228851
