...
- (void).cxx_destruct;	// IMP=0x000000000022bc4a
...
- (void)_cancelNotificationTimerWithReason:(id)arg1;	// IMP=0x000000000022ba03
- (void)_startNotificationTimerWithEventHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000022b7b3
- (void)ingestNotificationName:(id)arg1;	// IMP=0x000000000022b3db
- (id)initWithDelegate:(id)arg1;	// IMP=0x000000000022b27c
