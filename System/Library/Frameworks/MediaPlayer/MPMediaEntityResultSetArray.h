...
- (void).cxx_destruct;	// IMP=0x00000000001141eb
- (id)sectionInfo;	// IMP=0x00000000001141da
@property(readonly, nonatomic) id <MPMediaLibraryResultSet> resultSet; // @synthesize resultSet=_resultSet;
- (id)objectAtIndex:(unsigned long long)arg1;	// IMP=0x00000000001140fe
- (_Bool)isQueryResultSetInvalidated;	// IMP=0x00000000001140ac
- (unsigned long long)count;	// IMP=0x000000000011408f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000114084
- (id)initWithResultSet:(id)arg1 queryCriteria:(id)arg2 entityType:(long long)arg3 library:(id)arg4;	// IMP=0x0000000000113e0f
