...
- (void).cxx_destruct;	// IMP=0x00000000002a1985
...
- (unsigned long long)hash;	// IMP=0x00000000002a1615
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000002a14a2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000002a1374
- (void)copyTo:(id)arg1;	// IMP=0x00000000002a11e1
- (void)writeTo:(id)arg1;	// IMP=0x00000000002a10a3
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000002a1096
- (id)dictionaryRepresentation;	// IMP=0x00000000002a0e6f
- (id)description;	// IMP=0x00000000002a0dc0
...
- (void)dealloc;	// IMP=0x00000000002a0c16
