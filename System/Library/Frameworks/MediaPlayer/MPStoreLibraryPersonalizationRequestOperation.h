...
+ (id)personalizedResponseForContentDescriptor:(id)arg1 requestedProperties:(id)arg2;	// IMP=0x006000000016eacc
- (void).cxx_destruct;	// IMP=0x000000000016ccd6
@property(copy, nonatomic) CDUnknownBlockType responseHandler; // @synthesize responseHandler=_responseHandler;
@property(copy, nonatomic) MPStoreLibraryPersonalizationRequest *request; // @synthesize request=_request;
- (void)execute;	// IMP=0x000000000016b9b5
- (void)cancel;	// IMP=0x000000000016b96c
