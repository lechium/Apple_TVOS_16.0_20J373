...
+ (id)allSupportedProperties;	// IMP=0x0060000000222bf5
- (void).cxx_destruct;	// IMP=0x0000000000222764
...
- (id)modelObjectForRecommendationChildDictionary:(id)arg1 parentGroup:(id)arg2 subgroupsAccumulator:(id)arg3 userIdentity:(id)arg4;	// IMP=0x0000000000221b10
- (id)initWithRequestedPropertySet:(id)arg1 storeItemMetadataResults:(id)arg2 flatSectionedItems:(id)arg3;	// IMP=0x0000000000221a31
