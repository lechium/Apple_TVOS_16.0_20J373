...
- (void).cxx_destruct;	// IMP=0x00000000002d1c64
...
- (void)downloadManager:(id)arg1 downloadPurchaseDidFinish:(id)arg2;	// IMP=0x00000000002d1ad1
- (void)downloadManager:(id)arg1 downloadDidFinish:(id)arg2;	// IMP=0x00000000002d195a
- (id)initWithDownload:(id)arg1;	// IMP=0x00000000002d184a
