...
- (void).cxx_destruct;	// IMP=0x000000000010d363
@property(readonly, nonatomic) MPArtworkCatalog *artworkCatalog;
- (struct CGRect)bounds;	// IMP=0x000000000010d1fc
- (id)initWithArtworkCatalog:(id)arg1;	// IMP=0x000000000010d1e8
- (id)initWithArtworkCatalog:(id)arg1 allowsNetworking:(_Bool)arg2;	// IMP=0x000000000010d112
