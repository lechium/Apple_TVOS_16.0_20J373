...
- (void).cxx_destruct;	// IMP=0x00000000000f0dcf
...
- (id)numberFromCString:(const char *)arg1;	// IMP=0x00000000000f0a94
- (void)extractAndSetModelDetailsFromArchive:(void *)arg1;	// IMP=0x00000000000effde
