...
- (void).cxx_destruct;	// IMP=0x00000000000ff408
...
- (id)_makeFeatureValueAndReturnError:(id *)arg1;	// IMP=0x00000000000fea21
@property(readonly) MLFeatureValue *featureValue;
- (_Bool)bindAndReturnError:(id *)arg1;	// IMP=0x00000000000fe555
- (id)initWithPort:(struct e5rt_io_port *)arg1 featureDescription:(id)arg2;	// IMP=0x00000000000fe4af
