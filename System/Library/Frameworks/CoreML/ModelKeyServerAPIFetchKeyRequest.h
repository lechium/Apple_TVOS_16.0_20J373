...
- (void).cxx_destruct;	// IMP=0x00000000000d84e3
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000d83c1
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000d81f2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000d810e
- (void)copyTo:(id)arg1;	// IMP=0x00000000000d806b
- (void)writeTo:(id)arg1;	// IMP=0x00000000000d7fcc
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000000000d7d84
- (id)dictionaryRepresentation;	// IMP=0x00000000000d7c76
