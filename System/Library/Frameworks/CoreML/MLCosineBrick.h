...
- (void).cxx_destruct;	// IMP=0x000000000007b2ae
...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x000000000007b0af
- (_Bool)hasGPUSupport;	// IMP=0x000000000007b0a7
- (id)initWithParameters:(id)arg1;	// IMP=0x000000000007af6e
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x000000000007af58
