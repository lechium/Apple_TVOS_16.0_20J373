...
+ (id)sharedHandle;	// IMP=0x0060000000156d9a
...
- (id)predictVectorForString:(void *)arg1 inputString:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000156b5f
- (id)predictLabelForWordString:(void *)arg1 inputString:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000156a10
- (id)predictLabelsForSentenceString:(void *)arg1 inputString:(id)arg2 error:(id *)arg3;	// IMP=0x00000000001568c4
- (id)predictTokensLabelsLocationsLengthsForString:(void *)arg1 inputString:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000156778
- (const void *)initializeEmbeddingModelWithData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000156730
- (const void *)initializeGazetteerModelWithData:(id)arg1 error:(id *)arg2;	// IMP=0x00000000001566eb
- (const void *)initializeSentenceClassifierModelWithData:(id)arg1 error:(id *)arg2;	// IMP=0x00000000001566a6
- (const void *)initializeWordTaggingModelWithData:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000156661
- (id)init;	// IMP=0x00000000001563b1
