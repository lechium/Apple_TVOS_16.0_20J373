...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x00000000000d764f
- (id)computeDynamicOutputShape:(id)arg1;	// IMP=0x00000000000d736c
- (_Bool)hasDynamicOutputShape:(unsigned long long)arg1;	// IMP=0x00000000000d735f
- (_Bool)hasGPUSupport;	// IMP=0x00000000000d7357
- (id)initWithParameters:(id)arg1;	// IMP=0x00000000000d70c2
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x00000000000d6f79
