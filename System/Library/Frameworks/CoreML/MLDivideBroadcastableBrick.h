...
- (void).cxx_destruct;	// IMP=0x00000000000b8e0c
...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x00000000000b8435
- (_Bool)hasGPUSupport;	// IMP=0x00000000000b842d
- (id)initWithParameters:(id)arg1;	// IMP=0x00000000000b81ec
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x00000000000b7ecb
