...
- (void).cxx_destruct;	// IMP=0x00000000000b9f65
...
- (id)predictionFromFeatures:(id)arg1 options:(id)arg2 error:(id *)arg3;	// IMP=0x00000000000b99a7
- (id)featureValueFromScenePrint:(id)arg1 elementSize:(unsigned long long)arg2;	// IMP=0x00000000000b95e9
- (id)initWithModelDescription:(id)arg1 parameterDictionary:(id)arg2 error:(id *)arg3;	// IMP=0x00000000000b8e4a
