...
- (void).cxx_destruct;	// IMP=0x00000000000b2754
...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x00000000000b1b4f
- (_Bool)hasGPUSupport;	// IMP=0x00000000000b1b47
- (id)initWithParameters:(id)arg1;	// IMP=0x00000000000b18ae
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x00000000000b14d8
