...
- (void).cxx_destruct;	// IMP=0x000000000002b051
...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x000000000002aa08
- (_Bool)hasGPUSupport;	// IMP=0x000000000002aa00
- (id)initWithParameters:(id)arg1;	// IMP=0x000000000002a793
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x000000000002a3ed
