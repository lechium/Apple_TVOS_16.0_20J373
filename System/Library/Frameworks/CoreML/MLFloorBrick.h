...
- (void).cxx_destruct;	// IMP=0x00000000000af8b7
...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x00000000000af6b8
- (_Bool)hasGPUSupport;	// IMP=0x00000000000af6b0
- (id)initWithParameters:(id)arg1;	// IMP=0x00000000000af577
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x00000000000af561
