...
- (void).cxx_destruct;	// IMP=0x0000000000023169
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000000022fc1
- (unsigned long long)hash;	// IMP=0x0000000000022eed
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000022d55
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000022c23
- (void)copyTo:(id)arg1;	// IMP=0x0000000000022b40
- (void)writeTo:(id)arg1;	// IMP=0x0000000000022a8c
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000022a7f
- (id)dictionaryRepresentation;	// IMP=0x00000000000228be
- (id)description;	// IMP=0x000000000002280f
- (void)clearOneofValuesForKey;	// IMP=0x00000000000227af
- (int)StringAsKey:(id)arg1;	// IMP=0x000000000002271d
- (id)keyAsString:(int)arg1;	// IMP=0x00000000000226d5
