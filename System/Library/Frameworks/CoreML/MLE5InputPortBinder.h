...
- (void).cxx_destruct;	// IMP=0x0000000000021a1a
...
- (_Bool)bindFeatureValue:(id)arg1 error:(id *)arg2;	// IMP=0x000000000002107e
- (id)initWithPort:(struct e5rt_io_port *)arg1;	// IMP=0x0000000000021041
