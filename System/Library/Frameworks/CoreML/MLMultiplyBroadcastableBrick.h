...
- (void).cxx_destruct;	// IMP=0x00000000000780d8
...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x0000000000077730
- (_Bool)hasGPUSupport;	// IMP=0x0000000000077728
- (id)initWithParameters:(id)arg1;	// IMP=0x00000000000774e7
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x00000000000771c6
