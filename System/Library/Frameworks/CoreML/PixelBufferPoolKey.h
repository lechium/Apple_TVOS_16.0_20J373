...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000004c5c6
- (unsigned long long)hash;	// IMP=0x000000000004c536
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000004c42d
- (id)initWithSize:(struct CGSize)arg1 pixelFormatType:(unsigned int)arg2;	// IMP=0x000000000004c3d4
