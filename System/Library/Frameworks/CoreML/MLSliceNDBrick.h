...
- (void).cxx_destruct;	// IMP=0x00000000000f78c1
...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x00000000000f6bcc
- (_Bool)hasGPUSupport;	// IMP=0x00000000000f6bc4
- (id)initWithParameters:(id)arg1;	// IMP=0x00000000000f6867
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x00000000000f61bb
