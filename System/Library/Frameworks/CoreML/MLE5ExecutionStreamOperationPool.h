...
- (void).cxx_destruct;	// IMP=0x0000000000013289
...
- (void)putBack:(id)arg1;	// IMP=0x0000000000013164
- (id)takeOut;	// IMP=0x0000000000013060
- (id)initWithE5BundleAtURL:(id)arg1 functionName:(id)arg2 outputDescriptionsByName:(id)arg3;	// IMP=0x0000000000012ea9
