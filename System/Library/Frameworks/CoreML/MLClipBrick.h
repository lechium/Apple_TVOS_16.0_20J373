...
- (void).cxx_destruct;	// IMP=0x00000000001534d0
...
- (void)computeOnCPUWithInputTensors:(id)arg1 outputTensors:(id)arg2;	// IMP=0x000000000015324a
- (_Bool)hasGPUSupport;	// IMP=0x0000000000153242
- (id)initWithParameters:(id)arg1;	// IMP=0x0000000000153109
- (id)setupForInputShapes:(id)arg1 withParameters:(id)arg2;	// IMP=0x0000000000153060
