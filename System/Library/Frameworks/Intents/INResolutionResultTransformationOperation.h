...
- (void).cxx_destruct;	// IMP=0x00000000001ba5e8
...
- (_Bool)isExecuting;	// IMP=0x00000000001ba572
- (_Bool)isFinished;	// IMP=0x00000000001ba562
- (void)start;	// IMP=0x00000000001ba466
- (id)initWithResult:(id)arg1 intent:(id)arg2 intentSlotDescription:(id)arg3 optionsProvider:(id)arg4;	// IMP=0x00000000001ba36f
