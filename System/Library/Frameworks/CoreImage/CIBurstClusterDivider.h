...
- (long long)compareActionAmounts:(id)arg1;	// IMP=0x000000000001cda5
- (long long)compareIndices:(id)arg1;	// IMP=0x000000000001cd36
- (long long)compareDividers:(id)arg1;	// IMP=0x000000000001ccbd
