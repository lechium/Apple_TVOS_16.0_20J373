...
- (id)outputImage;	// IMP=0x000000000010f822
- (id)outputImage:(id)arg1 horizontal:(_Bool)arg2;	// IMP=0x000000000010ee91
- (id)noiseColorKernel;	// IMP=0x000000000010ee13
- (id)_noiseGeneratorKernel;	// IMP=0x000000000010eda6
- (id)_kernel:(_Bool)arg1 withAddedNoise:(_Bool)arg2;	// IMP=0x000000000010eca2
