...
+ (id)customAttributes;	// IMP=0x0060000000046848
...
- (id)outputImage;	// IMP=0x0000000000046bce
- (_Bool)_isIdentity;	// IMP=0x0000000000046bc6
- (id)_kernel;	// IMP=0x0000000000046828
