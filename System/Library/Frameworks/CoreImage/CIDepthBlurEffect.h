...
+ (id)customAttributes;	// IMP=0x00600000001b7a98
+ (int)getDraftMode:(id)arg1;	// IMP=0x00600000001bc3c0
+ (struct CGImageMetadata *)augmentMetadataWithRenderingPropertiesForImage:(id)arg1;	// IMP=0x00600000001bc2e9
+ (struct CGImageMetadata *)metadataFromDictionary:(id)arg1 metadata:(struct CGImageMetadata *)arg2;	// IMP=0x00600000001bc220
+ (id)tuningParametersFromMetadata:(struct CGImageMetadata *)arg1;	// IMP=0x00600000001bc213
+ (struct CGImageMetadata *)replaceRenderingParameters:(struct CGImageMetadata *)arg1 tuningParameters:(id)arg2;	// IMP=0x00600000001bc20b
...
- (id)outputImage;	// IMP=0x00000000001b85bb
- (id)_getFocusRect:(id)arg1 focusRect:(id)arg2;	// IMP=0x00000000001b82de
- (void)setValue:(id)arg1 forUndefinedKey:(id)arg2;	// IMP=0x00000000001b80f6
- (void)prewarm:(id)arg1;	// IMP=0x00000000001b7a2a
