...
- (id)outputImage;	// IMP=0x0000000000113507
- (id)_ourBlendKernelMetal;	// IMP=0x00000000001134aa
- (id)nonMetalKernelYCC;	// IMP=0x000000000011344d
- (id)nonMetalKernel;	// IMP=0x00000000001133f0
- (id)_blendKernel:(_Bool)arg1;	// IMP=0x0000000000113327
