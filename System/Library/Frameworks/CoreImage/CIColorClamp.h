...
+ (id)customAttributes;	// IMP=0x006000000003eefc
...
- (id)outputImage;	// IMP=0x000000000003f0e8
- (id)_kernelAlphaPreserving;	// IMP=0x000000000003eeb9
- (id)_kernel;	// IMP=0x000000000003ee99
