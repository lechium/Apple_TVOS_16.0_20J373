...
+ (id)customAttributes;	// IMP=0x00600000000e6014
...
- (id)outputImage;	// IMP=0x00000000000e6387
- (id)cpuParams;	// IMP=0x00000000000e61dc
- (id)kernel;	// IMP=0x00000000000e617f
- (id)mtlKernel;	// IMP=0x00000000000e6112
