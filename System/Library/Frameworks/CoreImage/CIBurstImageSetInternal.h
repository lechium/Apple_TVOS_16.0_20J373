...
+ (id)defaultVersionString;	// IMP=0x00600000000286f9
...
- (_Bool)isAction;	// IMP=0x00000000000339e6
- (_Bool)isPortrait;	// IMP=0x00000000000339b1
- (_Bool)isFaceDetectionForced;	// IMP=0x0000000000033992
- (id)imageClusterForIdentifier:(id)arg1;	// IMP=0x000000000003359c
- (id)bestImageIdentifiers;	// IMP=0x000000000002f63b
- (void)selectCoverPhotoFromMultiple:(id)arg1 burstSize:(int)arg2;	// IMP=0x000000000002f100
- (id)findBestImage:(id)arg1 useActionScores:(_Bool)arg2;	// IMP=0x000000000002e8cf
- (void)computeAllImageScores;	// IMP=0x000000000002d109
- (float)computeBeginningVsEndAEMatrixDiffVsAverageAdjacent;	// IMP=0x000000000002cdaf
- (float)computeCameraTravelDistance;	// IMP=0x000000000002c87b
- (void)performEmotionalRejectionOnCluster:(id)arg1;	// IMP=0x000000000002c1e8
- (int)computeEmotion:(id)arg1;	// IMP=0x000000000002c088
- (void)addImageFromIOSurface:(struct __IOSurface *)arg1 properties:(id)arg2 identifier:(id)arg3 completionBlock:(CDUnknownBlockType)arg4;	// IMP=0x000000000002bf02
- (void)addYUVImage:(id)arg1 properties:(id)arg2 identifier:(id)arg3 imageProps:(id)arg4 completionBlock:(CDUnknownBlockType)arg5;	// IMP=0x000000000002ba1c
- (void)processClusters:(_Bool)arg1;	// IMP=0x00000000000294de
- (float)computeActionSelectionThreshold;	// IMP=0x0000000000029140
- (void)dealloc;	// IMP=0x0000000000028edf
- (id)initWithOptions:(id)arg1;	// IMP=0x0000000000028809
- (id)burstDocumentDirectory;	// IMP=0x0000000000028775
