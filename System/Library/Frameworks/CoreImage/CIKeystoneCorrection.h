...
+ (id)customAttributes;	// IMP=0x006000000027eded
- (id).cxx_construct;	// IMP=0x000000000027f699
...
- (id)outputImage;	// IMP=0x000000000027f52b
@property(readonly, nonatomic) CIFilter *outputRotationFilter;
@property(readonly, nonatomic) CDStruct_d80e62f2 outputTransform;
- (void)computeRotation;	// IMP=0x000000000027f1fe
- (void)computeCameraIntrinsics;	// IMP=0x000000000027f073
