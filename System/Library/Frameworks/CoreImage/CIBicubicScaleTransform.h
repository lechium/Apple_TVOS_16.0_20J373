...
+ (id)customAttributes;	// IMP=0x000000000016372c
...
- (id)outputImage;	// IMP=0x0000000000163d64
- (_Bool)_isIdentity;	// IMP=0x0000000000163bfc
- (struct vec2)_scale;	// IMP=0x0000000000163b81
