...
- (_Bool)compute;	// IMP=0x0000000000123b79
- (void)dealloc;	// IMP=0x0000000000123b3e
- (id)initWithContext:(id)arg1 image:(id)arg2 config:(const CDStruct_58ac58eb *)arg3;	// IMP=0x00000000001239ec
