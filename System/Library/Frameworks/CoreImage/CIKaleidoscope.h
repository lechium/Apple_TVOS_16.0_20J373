...
+ (id)customAttributes;	// IMP=0x00600000000d35fc
...
- (id)outputImage;	// IMP=0x00000000000d2dec
- (struct CGRect)_outputExtent;	// IMP=0x00000000000d2748
- (id)_kernel;	// IMP=0x00000000000d2728
