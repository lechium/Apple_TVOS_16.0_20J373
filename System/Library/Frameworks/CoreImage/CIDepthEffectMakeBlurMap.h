...
+ (id)customAttributes;	// IMP=0x00600000001ae111
...
- (id)outputImage;	// IMP=0x00000000001b2b1a
- (id)unifiedRenderingOutputImage:(struct CGImageMetadata *)arg1;	// IMP=0x00000000001b1fa1
- (id)blurMapV4:(id)arg1 shiftmap:(id)arg2 alphaImage:(id)arg3 hairImage:(id)arg4;	// IMP=0x00000000001b0a4b
- (id)blurMapV3:(id)arg1 shiftmap:(id)arg2 alphaImage:(id)arg3;	// IMP=0x00000000001b06bf
- (id)refineShiftMapV3WithMainImage:(id)arg1 shiftmap:(id)arg2 lensModel:(id)arg3;	// IMP=0x00000000001afed0
- (id)blurMapV2:(id)arg1;	// IMP=0x00000000001afe0a
- (id)smoothShiftMapV2:(id)arg1;	// IMP=0x00000000001afd4a
- (id)faceMaskDelta:(id)arg1 extent:(struct CGRect)arg2 parameters:(id)arg3 distanceToAdd:(float *)arg4;	// IMP=0x00000000001af94e
- (id)faceMaskApply:(id)arg1 blurMap:(id)arg2;	// IMP=0x00000000001af75e
- (id)faceMaskParams:(id)arg1 useNormalizedCoords:(_Bool)arg2;	// IMP=0x00000000001af18f
- (_Bool)needToRunFaceMask;	// IMP=0x00000000001af082
- (id)lensModelApply:(id)arg1 shiftMap:(id)arg2;	// IMP=0x00000000001aef14
- (id)lensModelParams:(id)arg1;	// IMP=0x00000000001aece0
- (id)upsampledShiftMap:(id)arg1;	// IMP=0x00000000001aea6a
- (float)intrinsicMatrixFocalLength;	// IMP=0x00000000001aea2b
- (struct CGSize)originalShiftMapSize;	// IMP=0x00000000001ae952
- (id)calibrationData;	// IMP=0x00000000001ae91b
- (void)setValue:(id)arg1 forUndefinedKey:(id)arg2;	// IMP=0x00000000001ae8bb
