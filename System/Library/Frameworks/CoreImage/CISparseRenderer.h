...
+ (id)customAttributes;	// IMP=0x0060000000110354
...
- (id)outputImage;	// IMP=0x00000000001113cd
- (id)_kernel:(_Bool)arg1 alpha:(_Bool)arg2;	// IMP=0x0000000000111297
- (id)_lutKernel:(_Bool)arg1 alpha:(_Bool)arg2;	// IMP=0x0000000000111161
- (id)baseVecsLUT:(unsigned int)arg1;	// IMP=0x0000000000111075
- (id)stepsLUT:(unsigned int)arg1;	// IMP=0x0000000000110f59
- (id)baseVecsLUTGenerator;	// IMP=0x0000000000110eec
- (id)stepsLUTGenerator;	// IMP=0x0000000000110e7f
- (_Bool)_useD2XRenderer;	// IMP=0x0000000000110d5e
- (id)_packageParams:(_Bool)arg1 extent:(struct CGRect)arg2 image:(id)arg3 haveAlpha:(_Bool)arg4;	// IMP=0x00000000001104c8
