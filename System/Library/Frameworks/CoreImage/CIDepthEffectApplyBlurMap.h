...
+ (id)customAttributes;	// IMP=0x00600000001b5fdc
...
- (id)outputImage;	// IMP=0x00000000001b687d
- (id)unifiedRenderingOutputImage:(struct CGImageMetadata *)arg1;	// IMP=0x00000000001b63ea
