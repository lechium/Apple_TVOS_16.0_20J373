...
+ (id)customAttributes;	// IMP=0x00600000000a43ee
- (id)outputImage;	// IMP=0x00000000000a49f8
- (id)_focalPlanePreProcessorKernelPow2;	// IMP=0x00000000000a497a
- (id)_focalPlanePreProcessorKernel;	// IMP=0x00000000000a48fc
