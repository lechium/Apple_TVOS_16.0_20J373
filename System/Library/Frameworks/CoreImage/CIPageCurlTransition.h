...
+ (id)customAttributes;	// IMP=0x00600000000fe0b5
...
- (id)outputImage;	// IMP=0x00000000000fc413
- (id)_CIPageCurlTransNoEmap;	// IMP=0x00000000000fc3f3
- (id)_CIPageCurlTransition;	// IMP=0x00000000000fc3d3
