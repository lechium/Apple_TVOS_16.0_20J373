...
- (struct CGRect)faceRect;	// IMP=0x00000000001c4952
- (id)description;	// IMP=0x00000000001c4914
- (id)initWithBounds:(struct CGRect)arg1 andImage:(id)arg2 usingContext:(id)arg3;	// IMP=0x00000000001c457c
