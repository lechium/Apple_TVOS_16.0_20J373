...
- (id)parameterNamesForChannel:(int)arg1;	// IMP=0x00000000001da3fe
- (id)filterNameForChannel:(int)arg1;	// IMP=0x00000000001da3db
- (id)outputImage;	// IMP=0x00000000001da094
