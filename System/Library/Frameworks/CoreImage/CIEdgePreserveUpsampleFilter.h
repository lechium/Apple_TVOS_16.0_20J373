...
+ (id)customAttributes;	// IMP=0x006000000008a0f5
...
- (id)outputImage;	// IMP=0x000000000008a42e
- (id)_kernelGuideMono;	// IMP=0x000000000008a40e
- (id)_kernelGuideCombine4;	// IMP=0x000000000008a3ee
- (id)_kernelGuideCombine;	// IMP=0x000000000008a3ce
- (id)_kernelJointUpsampRG;	// IMP=0x000000000008a3ae
- (id)_kernelJointUpsamp;	// IMP=0x000000000008a38e
