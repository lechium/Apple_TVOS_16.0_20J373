...
+ (id)customAttributes;	// IMP=0x00600000000397c0
...
- (id)outputImage;	// IMP=0x0000000000038f57
- (id)_CICMYK_black;	// IMP=0x0000000000038f37
- (id)_CICMYK_yellow;	// IMP=0x0000000000038f17
- (id)_CICMYK_magenta;	// IMP=0x0000000000038ef7
- (id)_CICMYK_cyan;	// IMP=0x0000000000038ed7
- (id)_CICMYK_convert;	// IMP=0x0000000000038eb7
- (id)_CIWhite;	// IMP=0x0000000000038e97
