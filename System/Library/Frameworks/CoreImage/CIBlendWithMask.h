...
+ (id)customAttributes;	// IMP=0x0060000000017b7e
...
- (id)outputImage;	// IMP=0x0000000000017d49
- (float)_maskFillColorValue;	// IMP=0x0000000000017cbf
- (id)_kernelB0;	// IMP=0x0000000000017c9f
- (id)_kernel;	// IMP=0x0000000000017c7f
