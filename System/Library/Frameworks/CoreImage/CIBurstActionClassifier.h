...
- (_Bool)isBurstAction;	// IMP=0x000000000001ca8d
- (float)predictResult;	// IMP=0x000000000001c9bb
- (double)computeKernelValueWithSupportVector:(const struct CIBurstSupportVector *)arg1;	// IMP=0x000000000001c943
- (void)scaleVector;	// IMP=0x000000000001c7ef
- (id)initWithVersion:(int)arg1;	// IMP=0x000000000001c786
- (id)init;	// IMP=0x000000000001c73b
