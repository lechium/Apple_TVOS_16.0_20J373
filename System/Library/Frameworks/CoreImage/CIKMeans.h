...
+ (id)customAttributes;	// IMP=0x0060000000143119
...
- (id)outputImage;	// IMP=0x0000000000143b51
- (id)defuse:(id)arg1 seed:(int)arg2;	// IMP=0x00000000001438e4
- (id)_kernelKmeans;	// IMP=0x00000000001438c4
- (id)_combine:(id)arg1;	// IMP=0x00000000001433fa
