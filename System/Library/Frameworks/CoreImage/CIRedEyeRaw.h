...
- (id)outputImage;	// IMP=0x00000000000818db
- (id)skinProtectionMaskWithThreshold:(float)arg1;	// IMP=0x00000000000817d9
- (id)irisProtectionMaskWithThresholdIris:(float)arg1 thresholdSclera:(float)arg2 thresholdSkin:(float)arg3;	// IMP=0x000000000008166d
