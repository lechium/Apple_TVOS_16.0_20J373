...
+ (id)customAttributes;	// IMP=0x00600000000eabbe
- (id)outputImage;	// IMP=0x00000000000eaf69
- (id)_polyKernel;	// IMP=0x00000000000eaf49
- (id)_shadowKernel;	// IMP=0x00000000000eaf29
