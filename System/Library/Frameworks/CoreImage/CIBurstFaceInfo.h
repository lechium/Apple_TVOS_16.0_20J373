...
- (float)overlapWithSwRect:(struct CGRect)arg1;	// IMP=0x000000000001d37a
- (float)overlapWithHwRect:(struct CGRect)arg1;	// IMP=0x000000000001d2b5
- (struct CGRect)swFaceRect;	// IMP=0x000000000001d1ee
- (struct CGRect)hwFaceRect;	// IMP=0x000000000001d127
- (id)init;	// IMP=0x000000000001d018
