...
+ (id)customAttributes;	// IMP=0x00600000000f91dd
...
- (id)outputImage;	// IMP=0x00000000000f94af
- (_Bool)_doMinimum;	// IMP=0x00000000000f94a7
- (_Bool)_isIdentity;	// IMP=0x00000000000f945a
