...
- (id).cxx_construct;	// IMP=0x00000000001835ba
- (void).cxx_destruct;	// IMP=0x000000000018353c
...
- (void)computeTransform;	// IMP=0x0000000000182480
- (void)computeGuides;	// IMP=0x000000000018191a
- (void)clusterLineSegments;	// IMP=0x0000000000180305
- (void)extractLineSegments;	// IMP=0x000000000017fcff
- (void)rangeLimitGradientMap;	// IMP=0x000000000017fa5a
- (void)thresholdGradientMap;	// IMP=0x000000000017f87f
- (void)normalizeGradientMap;	// IMP=0x000000000017f52e
- (void)createGradientMap;	// IMP=0x000000000017f1fc
- (void)standardizeImage;	// IMP=0x000000000017ef9c
- (double)confidence;	// IMP=0x000000000017ef17
- (_Bool)compute;	// IMP=0x000000000017e6b0
- (void)dealloc;	// IMP=0x000000000017e66f
- (id)initWithContext:(id)arg1 image:(id)arg2 config:(const CDStruct_58ac58eb *)arg3;	// IMP=0x000000000017e478
