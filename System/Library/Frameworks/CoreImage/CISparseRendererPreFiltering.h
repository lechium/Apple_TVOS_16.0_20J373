...
- (id)outputImage;	// IMP=0x00000000001101b7
- (void)dumpImage:(id)arg1 extent:(struct CGRect)arg2 prefixFilename:(id)arg3;	// IMP=0x000000000010ff4f
- (id)outputImage:(id)arg1 horizontal:(_Bool)arg2 width:(double)arg3;	// IMP=0x000000000010fae1
- (id)_kernel:(_Bool)arg1;	// IMP=0x000000000010fa18
