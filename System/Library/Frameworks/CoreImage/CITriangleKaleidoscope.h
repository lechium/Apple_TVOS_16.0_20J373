...
+ (id)customAttributes;	// IMP=0x006000000017322a
...
- (id)outputImage;	// IMP=0x0000000000173593
- (id)_geomKernel;	// IMP=0x0000000000173573
- (id)_colorKernel;	// IMP=0x0000000000173553
