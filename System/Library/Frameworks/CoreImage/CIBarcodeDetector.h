...
- (id)featuresInImage:(id)arg1;	// IMP=0x0000000000012a9b
- (id)featuresInImage:(id)arg1 options:(id)arg2;	// IMP=0x0000000000011e7d
- (void)dealloc;	// IMP=0x0000000000011e27
- (id)initWithContext:(id)arg1 options:(id)arg2;	// IMP=0x0000000000011ce0
