...
+ (id)customAttributes;	// IMP=0x00000000000a2c2f
...
- (id)outputImage;	// IMP=0x00000000000a3237
- (id)_geomKernel;	// IMP=0x00000000000a3217
- (id)_colorKernel;	// IMP=0x00000000000a31f7
