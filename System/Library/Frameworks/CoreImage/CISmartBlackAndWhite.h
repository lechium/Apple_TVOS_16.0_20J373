...
+ (id)customAttributes;	// IMP=0x006000000015b805
...
- (id)outputImage;	// IMP=0x000000000015bd77
- (id)_kernel;	// IMP=0x000000000015bd57
- (id)hueArrayImage:(float *)arg1;	// IMP=0x000000000015b652
- (float *)createHueArray;	// IMP=0x000000000015b506
- (void)getNonNormalizedSettings:(CDStruct_31328b19 *)arg1;	// IMP=0x000000000015b1ef
