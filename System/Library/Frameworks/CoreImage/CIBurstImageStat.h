...
- (float *)colorHistogram;	// IMP=0x000000000003767c
- (long long)compareImageOrder:(id)arg1;	// IMP=0x000000000003761b
- (long long)compareImageStats:(id)arg1;	// IMP=0x0000000000037613
- (float)computeScore:(float)arg1;	// IMP=0x00000000000374df
- (unsigned short *)aeMatrix;	// IMP=0x00000000000374d2
- (void)computeAEMatrix:(id)arg1;	// IMP=0x0000000000037305
- (int)setAEMatrix:(id)arg1;	// IMP=0x000000000003728f
- (float)computeAEMatrixDifference:(id)arg1;	// IMP=0x0000000000037255
- (float)computeImageDistance:(id)arg1;	// IMP=0x0000000000037206
- (float)computeSmilePercentage;	// IMP=0x00000000000370f0
- (float)computeRuleOfThreeDistance;	// IMP=0x0000000000036e40
- (float)computeFacialFocusScoreSum;	// IMP=0x00000000000368c2
- (void)collapseSharpnessGrid;	// IMP=0x00000000000365de
- (void)computeImageData:(id)arg1 faceIDCounts:(id)arg2;	// IMP=0x00000000000363b2
- (void)writeGridROI:(id)arg1;	// IMP=0x00000000000362e1
- (int)canRegister;	// IMP=0x00000000000362c0
- (void)computeImageProjections:(id)arg1;	// IMP=0x0000000000036217
- (void)performRegistration:(id)arg1 deltaCol:(float *)arg2 deltaRow:(float *)arg3;	// IMP=0x000000000003555e
- (void)flagAsGarbage;	// IMP=0x000000000003553c
- (void)updateROI:(struct GridROI_t)arg1;	// IMP=0x0000000000035422
- (float)computeSmoothedGridROI:(id)arg1 nextStat:(id)arg2;	// IMP=0x0000000000035176
- (void)computeBlurStatsOnGrid:(id)arg1;	// IMP=0x0000000000034e84
- (void)computeImageSharpnessOnGrid:(id)arg1;	// IMP=0x0000000000034d0a
- (struct GridROI_t)getSharpnessAndBlurLimits;	// IMP=0x0000000000034cfb
- (void)computeImageColorHistogram:(id)arg1;	// IMP=0x0000000000034b83
- (void)dealloc;	// IMP=0x0000000000034af6
- (id)initWithIdentifier:(id)arg1;	// IMP=0x0000000000034a30
- (void)assignMeanStdBuffers:(float *)arg1;	// IMP=0x0000000000034985
- (void)allocateMeanStdPingPongBuffers:(float **)arg1:(float **)arg2:(float **)arg3:(float **)arg4;	// IMP=0x00000000000348cf
