...
- (float)computeMergeCost:(id)arg1:(int *)arg2:(int)arg3;	// IMP=0x0000000000038147
- (void)addItemsFromCluster:(id)arg1;	// IMP=0x000000000003812d
- (void)releaseImage;	// IMP=0x00000000000380ef
- (void)dealloc;	// IMP=0x0000000000038097
- (id)initWithImageData:(id)arg1 dict:(id)arg2 identifier:(id)arg3 imageProps:(id)arg4 completionBlock:(CDUnknownBlockType)arg5;	// IMP=0x0000000000037ce0
- (id)init;	// IMP=0x0000000000037c84
