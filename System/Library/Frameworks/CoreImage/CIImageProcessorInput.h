...
- (void)dealloc;	// IMP=0x00000000000ccfd6
- (id)initWithSurface:(struct __IOSurface *)arg1 texture:(struct Texture)arg2 digest:(unsigned long long)arg3 allowSRGB:(_Bool)arg4 bounds:(struct CGRect)arg5 context:(void *)arg6;	// IMP=0x00000000000ccf81
