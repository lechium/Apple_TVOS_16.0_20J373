...
+ (id)customAttributes;	// IMP=0x006000000027e2d2
- (id).cxx_construct;	// IMP=0x000000000027edb7
...
- (id)outputImage;	// IMP=0x000000000027e935
@property(readonly, nonatomic) CDStruct_d80e62f2 outputTransform;
- (void)computeCameraIntrinsics;	// IMP=0x000000000027e571
