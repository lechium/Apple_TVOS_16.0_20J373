...
+ (id)customAttributes;	// IMP=0x006000000017b760
@property(retain, nonatomic) NSNumber *inputRadius; // @synthesize inputRadius;
@property(retain, nonatomic) NSNumber *inputIntensity; // @synthesize inputIntensity;
@property(retain, nonatomic) CIImage *inputImage; // @synthesize inputImage;
- (id)outputImage;	// IMP=0x000000000017ba5c
- (id)_kernel;	// IMP=0x000000000017ba3c
- (_Bool)_isIdentity;	// IMP=0x000000000017ba07
