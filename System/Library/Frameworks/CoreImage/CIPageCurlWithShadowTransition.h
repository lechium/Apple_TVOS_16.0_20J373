...
+ (id)customAttributes;	// IMP=0x00600000000ffd82
...
- (id)outputImage;	// IMP=0x00000000000fe3b7
- (id)_CIPageCurlNoShadowTransition;	// IMP=0x00000000000fe397
- (id)_CIPageCurlWithShadowTransition;	// IMP=0x00000000000fe377
