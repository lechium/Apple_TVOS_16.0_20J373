...
- (void)dealloc;	// IMP=0x0000000000055da0
- (id)executionTimesLog;	// IMP=0x0000000000055d80
- (id)processingResolutionsLog;	// IMP=0x0000000000055d60
- (void)appendProcessingResolution:(int)arg1 andTime:(double)arg2;	// IMP=0x0000000000055ce6
- (double)lastExecutionTime;	// IMP=0x0000000000055c99
- (int)lastProcessingResolution;	// IMP=0x0000000000055c4d
- (int)filterProcessingCount;	// IMP=0x0000000000055c37
- (id)CIImageProcessorDigestObject;	// IMP=0x0000000000055c1e
- (id)init;	// IMP=0x0000000000055b93
