...
+ (id)customAttributes;	// IMP=0x00600000001ad7be
...
- (id)outputImage;	// IMP=0x00000000001adc36
- (id)alphaImageForMainImage:(id)arg1 disparity:(id)arg2;	// IMP=0x00000000001ad92f
