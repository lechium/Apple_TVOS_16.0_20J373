...
+ (id)customAttributes;	// IMP=0x0060000000111f00
...
- (id)outputImage;	// IMP=0x000000000011240d
- (double)effectiveScale;	// IMP=0x0000000000112379
- (id)sensorSize;	// IMP=0x0000000000112255
