...
- (id)init;	// IMP=0x000000000000568e
- (void)layoutSublayers;	// IMP=0x00000000000053f4
- (id)initWithDisplayScale:(double)arg1 placeholderImage:(struct CGImage *)arg2 opaque:(_Bool)arg3 videoRectWhenPIPBegan:(struct CGRect)arg4;	// IMP=0x0000000000005338
