...
- (void).cxx_destruct;	// IMP=0x00000000001152b6
...
- (void)_handleValueChangeForKeyPath:(id)arg1 ofObject:(id)arg2 oldValue:(id)arg3 newValue:(id)arg4 context:(void *)arg5;	// IMP=0x00000000001151a5
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0000000000115086
- (void)stopObserving;	// IMP=0x0000000000114f23
- (void)startObserving:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000000114b80
- (id)initWithObservedObject:(id)arg1 observer:(id)arg2 keyPaths:(id)arg3 retainingObservedObject:(_Bool)arg4 includeInitialValue:(_Bool)arg5 includeChanges:(_Bool)arg6 changesBlock:(CDUnknownBlockType)arg7;	// IMP=0x0000000000114a21
