...
+ (id)airMessageParser;	// IMP=0x004000000007de7f
- (void).cxx_destruct;	// IMP=0x000000000007c9b4
...
- (id)partsWithData:(id)arg1;	// IMP=0x000000000007c706
- (id)init;	// IMP=0x000000000007c547
- (id)initWithLineSeparator:(id)arg1 headerBodySeparator:(id)arg2 bodyLengthKey:(id)arg3 compressionMethodKey:(id)arg4;	// IMP=0x000000000007c456
