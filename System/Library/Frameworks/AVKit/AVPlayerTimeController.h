...
+ (id)keyPathsForValuesAffectingReadyToPlay;	// IMP=0x00100000001182f4
+ (id)keyPathsForValuesAffectingSeekableTimeRanges;	// IMP=0x00100000001182d4
+ (id)keyPathsForValuesAffectingContentDurationWithinEndTimes;	// IMP=0x00100000001182a8
+ (id)keyPathsForValuesAffectingContentDuration;	// IMP=0x0010000000118288
+ (id)keyPathsForValuesAffectingForwardPlaybackEndTime;	// IMP=0x0010000000118268
+ (id)keyPathsForValuesAffectingMaxTime;	// IMP=0x0010000000118248
+ (id)keyPathsForValuesAffectingReversePlaybackEndTime;	// IMP=0x0010000000118228
- (void).cxx_destruct;	// IMP=0x0000000000118029
...
- (void)_updateMinAndMaxTiming;	// IMP=0x0000000000117eee
- (void)_updateTiming;	// IMP=0x0000000000117cf2
- (void)seekToTime:(double)arg1 toleranceBefore:(double)arg2 toleranceAfter:(double)arg3;	// IMP=0x0000000000117c8e
...
- (CDStruct_1b6d18a9)forwardPlaybackEndTime;	// IMP=0x0000000000117a9c
@property(readonly, nonatomic) double maxTime;
- (CDStruct_1b6d18a9)reversePlaybackEndTime;	// IMP=0x0000000000117991
@property(readonly, nonatomic) double minTime;
- (void)stopTimingObservation;	// IMP=0x00000000001178d3
- (void)startTimingObservation;	// IMP=0x000000000011773d
- (void)dealloc;	// IMP=0x00000000001176fb
- (id)initWithPlayer:(id)arg1;	// IMP=0x0000000000117663
