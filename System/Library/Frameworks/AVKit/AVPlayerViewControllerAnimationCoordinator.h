...
- (void).cxx_destruct;	// IMP=0x000000000005e7e0
...
- (void)didFinishAnimations:(_Bool)arg1;	// IMP=0x000000000005e622
- (void)performCoordinatedAnimations;	// IMP=0x000000000005e486
- (void)addCoordinatedAnimations:(CDUnknownBlockType)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000000005e34e
- (id)init;	// IMP=0x000000000005e2b1
