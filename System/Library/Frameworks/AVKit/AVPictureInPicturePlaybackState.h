...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000011ec51
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000011ec46
- (id)initWithElapsedTime:(double)arg1 timelineDuration:(double)arg2 timelineRate:(double)arg3 paused:(_Bool)arg4;	// IMP=0x000000000011eb4e
