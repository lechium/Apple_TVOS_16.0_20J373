...
+ (id)avkit_autoOption;	// IMP=0x00200000000e1d06
+ (id)avkit_offOption;	// IMP=0x00200000000e1cf5
@property(readonly, nonatomic) NSString *shortLocalizedDisplayName;
@property(readonly, nonatomic) NSString *localizedDisplayName;
- (id)avkit_title;	// IMP=0x00000000000f1ece
- (id)avkit_mediaRemoteIdentifier;	// IMP=0x00000000000f1da4
- (long long)languageCompare:(id)arg1 currentLanguageCode:(id)arg2 currentLanguageIdentifier:(id)arg3;	// IMP=0x000000000012df8d
