...
+ (id)allocWithZone:(struct _NSZone *)arg1;	// IMP=0x006000000011880d
...
- (Class)classForCoder;	// IMP=0x000000000011877b
- (void)setValueTiming:(id)arg1;	// IMP=0x0000000000118d6a
