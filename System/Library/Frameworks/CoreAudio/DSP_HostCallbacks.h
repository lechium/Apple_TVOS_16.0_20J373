...
- (id).cxx_construct;	// IMP=0x00000000001887b0
- (void).cxx_destruct;	// IMP=0x0000000000188756
...
- (void)requestMutation:(id)arg1;	// IMP=0x0000000000188268
- (void)notifyClientsOfCustomPropertyChange:(struct AudioObjectPropertyAddress)arg1;	// IMP=0x000000000018816d
