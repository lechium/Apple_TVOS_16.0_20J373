...
- (void)assertion:(id)arg1 didInvalidateWithError:(id)arg2;	// IMP=0x000000000036e146
- (void)assertionWillInvalidate:(id)arg1;	// IMP=0x000000000036e010
- (void)dealloc;	// IMP=0x000000000036dfc6
