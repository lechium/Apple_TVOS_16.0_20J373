...
+ (id)textRangeWithState:(_Bool)arg1 isRange:(_Bool)arg2 isEditable:(_Bool)arg3 startRect:(struct CGRect)arg4 endRect:(struct CGRect)arg5 selectionRects:(id)arg6 selectedTextLength:(unsigned long long)arg7;	// IMP=0x006000000078dad0
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000078ddd7
- (_Bool)isEmpty;	// IMP=0x000000000078ddc2
- (id)end;	// IMP=0x000000000078dd65
- (id)start;	// IMP=0x000000000078dd08
- (id)description;	// IMP=0x000000000078dc23
- (void)dealloc;	// IMP=0x000000000078dbe1
- (_Bool)_isRanged;	// IMP=0x000000000078dabb
- (_Bool)_isCaret;	// IMP=0x000000000078daa9
