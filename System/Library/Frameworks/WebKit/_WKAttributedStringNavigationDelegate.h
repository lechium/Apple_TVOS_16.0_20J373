...
- (void)webView:(id)arg1 didFinishNavigation:(id)arg2;	// IMP=0x0000000000189040
- (void)webView:(id)arg1 didFailNavigation:(id)arg2 withError:(id)arg3;	// IMP=0x0000000000189021
- (void)webView:(id)arg1 didFailProvisionalNavigation:(id)arg2 withError:(id)arg3;	// IMP=0x0000000000189002
- (void)webView:(id)arg1 decidePolicyForNavigationAction:(id)arg2 decisionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000000188fd9
- (void)webViewWebContentProcessDidTerminate:(id)arg1;	// IMP=0x0000000000188fc0
- (void)dealloc;	// IMP=0x0000000000188f46
