...
- (id).cxx_construct;	// IMP=0x0000000000774dd4
- (void).cxx_destruct;	// IMP=0x0000000000774d6a
...
- (id)initWithFocusedElementInformation:(const void *)arg1 isUserInitiated:(_Bool)arg2 userObject:(id)arg3;	// IMP=0x0000000000774bb2
