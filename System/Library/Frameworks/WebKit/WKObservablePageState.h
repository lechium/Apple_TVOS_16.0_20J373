...
- (id).cxx_construct;	// IMP=0x000000000018764d
- (void).cxx_destruct;	// IMP=0x0000000000187606
...
- (void)dealloc;	// IMP=0x0000000000187391
- (id)initWithPage:(void *)arg1;	// IMP=0x00000000001872c0
