...
- (id).cxx_construct;	// IMP=0x00000000002f9bfe
- (void).cxx_destruct;	// IMP=0x00000000002f9bdd
- (void *)command;	// IMP=0x00000000002f9bd3
- (id)initWithWebEditCommandProxy:(void *)arg1;	// IMP=0x00000000002f9b70
