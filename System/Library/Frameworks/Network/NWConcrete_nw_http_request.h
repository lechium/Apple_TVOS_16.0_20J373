...
- (void).cxx_destruct;	// IMP=0x000000000079f710
- (id)description;	// IMP=0x000000000079f680
- (void)dealloc;	// IMP=0x000000000079f5f0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000079f5e0
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000079f580
- (id)init;	// IMP=0x000000000079f290
