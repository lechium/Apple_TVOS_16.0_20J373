...
- (void).cxx_destruct;	// IMP=0x0000000000140e80
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x0000000000140dc0
- (id)initWithType:(int)arg1 member:(id)arg2 groupID:(unsigned char [16])arg3;	// IMP=0x0000000000140770
