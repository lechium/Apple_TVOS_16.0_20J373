...
- (void).cxx_destruct;	// IMP=0x0000000000717500
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000717440
- (id)redactedDescription;	// IMP=0x0000000000717420
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x0000000000717350
- (id)init;	// IMP=0x0000000000717050
