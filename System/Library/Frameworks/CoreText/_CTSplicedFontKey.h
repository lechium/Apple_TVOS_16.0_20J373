...
- (id)description;	// IMP=0x000000000008534a
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000000000850e0
- (unsigned long long)hash;	// IMP=0x00000000000850d6
- (void)dealloc;	// IMP=0x0000000000085085
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000008507a
