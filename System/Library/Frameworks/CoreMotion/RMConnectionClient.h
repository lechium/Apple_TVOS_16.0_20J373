...
- (void).cxx_destruct;	// IMP=0x0000000000121b25
- (void)endpoint:(id)arg1 didReceiveMessage:(id)arg2 withData:(id)arg3 replyBlock:(CDUnknownBlockType)arg4;	// IMP=0x0000000000121b0d
- (void)endpoint:(id)arg1 didReceiveStreamedData:(id)arg2;	// IMP=0x0000000000121af9
- (void)endpointWasInvalidated:(id)arg1;	// IMP=0x00000000001215f9
- (void)endpointWasInterrupted:(id)arg1;	// IMP=0x0000000000121361
