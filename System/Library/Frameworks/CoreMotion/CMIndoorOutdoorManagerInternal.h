...
- (void)_lastKnownIndoorOutdoorStateWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000000014d9be
- (void)_stopIndoorOutdoorUpdates;	// IMP=0x000000000014d6fb
- (void)_startIndoorOutdoorUpdates;	// IMP=0x000000000014d1c7
- (void)_teardown;	// IMP=0x000000000014d13e
- (void)dealloc;	// IMP=0x000000000014d0fc
- (id)init;	// IMP=0x000000000014cd1a
