...
- (void)simulateMotionStateYouthWithState:(long long)arg1;	// IMP=0x0000000000187993
- (void)simulateMotionState:(_Bool)arg1 withState:(long long)arg2;	// IMP=0x0000000000187755
- (void)overrideOscarSideband:(_Bool)arg1 withState:(long long)arg2;	// IMP=0x0000000000187517
- (void)stopActivityUpdatesPrivate;	// IMP=0x0000000000187329
- (void)startActivityUpdatesWithHandlerPrivate:(CDUnknownBlockType)arg1;	// IMP=0x0000000000187168
- (void)disconnect;	// IMP=0x0000000000187138
- (void)connect;	// IMP=0x000000000018674e
- (void)dealloc;	// IMP=0x00000000001866cc
- (id)init;	// IMP=0x000000000018667e
