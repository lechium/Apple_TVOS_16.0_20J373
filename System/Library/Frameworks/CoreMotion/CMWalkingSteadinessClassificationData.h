...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000116e32
...
- (id)description;	// IMP=0x0000000000116f40
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000116ed5
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000116e3a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000116ddf
- (void)dealloc;	// IMP=0x0000000000116db0
- (id)initWithLowerBound:(double)arg1 upperBound:(double)arg2 classificationType:(long long)arg3;	// IMP=0x0000000000116d55
