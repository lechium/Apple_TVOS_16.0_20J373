...
- (void).cxx_destruct;	// IMP=0x000000000007d32c
...
- (id)featureValueForName:(id)arg1;	// IMP=0x000000000007d1f4
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWith_9:(id)arg1 classLabel:(id)arg2;	// IMP=0x000000000007d13b
