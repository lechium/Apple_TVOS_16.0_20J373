...
- (void).cxx_destruct;	// IMP=0x000000000007c148
...
- (id)featureValueForName:(id)arg1;	// IMP=0x000000000007bf9e
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithInput1:(id)arg1 stateIn:(id)arg2 detectedHistoryIn:(id)arg3;	// IMP=0x000000000007bec7
- (id)initWithInput1:(id)arg1;	// IMP=0x000000000007beb0
