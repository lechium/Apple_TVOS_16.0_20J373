...
- (id).cxx_construct;	// IMP=0x000000000001fde4
- (void).cxx_destruct;	// IMP=0x000000000001fdbe
- (id)predictionFromFeatures:(id)arg1 options:(id)arg2 error:(id *)arg3;	// IMP=0x000000000001fd05
