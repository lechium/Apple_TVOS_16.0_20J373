...
- (id).cxx_construct;	// IMP=0x0000000000052c96
- (void).cxx_destruct;	// IMP=0x0000000000052c24
- (id)predictionFromFeatures:(id)arg1 options:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000052326
