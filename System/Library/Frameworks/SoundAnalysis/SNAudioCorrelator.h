...
- (id).cxx_construct;	// IMP=0x0000000000017985
- (void).cxx_destruct;	// IMP=0x0000000000017954
- (_Bool)adaptToSystemConfiguration:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000016d5e
- (id)resultsFromBox:(void *)arg1 renderedWithFrameCount:(int)arg2;	// IMP=0x00000000000168c1
- (id)sharedProcessorConfiguration;	// IMP=0x00000000000168b9
