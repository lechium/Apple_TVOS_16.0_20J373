...
- (void).cxx_destruct;	// IMP=0x0000000000078c1e
...
- (id)featureValueForName:(id)arg1;	// IMP=0x0000000000078a74
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithInput1:(id)arg1 stateIn:(id)arg2 detectedHistoryIn:(id)arg3;	// IMP=0x000000000007899d
- (id)initWithInput1:(id)arg1;	// IMP=0x0000000000078986
