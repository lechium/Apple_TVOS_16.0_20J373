...
- (void).cxx_destruct;	// IMP=0x000000000076a2d2
- (id)init;	// IMP=0x000000000076a283
- (void)scene:(id)arg1 willConnectToSession:(id)arg2 options:(id)arg3;	// IMP=0x000000000076a1cf
