...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000257154
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000000025701f
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000256ef1
- (id)description;	// IMP=0x0000000000256e5a
- (void)dealloc;	// IMP=0x0000000000256ded
