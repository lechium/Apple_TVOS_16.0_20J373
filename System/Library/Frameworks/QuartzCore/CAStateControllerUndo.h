...
- (void)dealloc;	// IMP=0x00000000000243b4
- (void)addTransition:(id)arg1;	// IMP=0x0000000000024377
- (void)willAddLayer:(id)arg1;	// IMP=0x0000000000024371
- (void)addElement:(id)arg1;	// IMP=0x0000000000024334
