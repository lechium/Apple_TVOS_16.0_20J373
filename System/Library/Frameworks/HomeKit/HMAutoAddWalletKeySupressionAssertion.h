...
- (void).cxx_destruct;	// IMP=0x0000000000263383
...
- (void)invalidate;	// IMP=0x00000000002630e9
- (void)acquireWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000000262dce
- (id)initWithHomeManager:(id)arg1 homeUUID:(id)arg2;	// IMP=0x0000000000262cf9
