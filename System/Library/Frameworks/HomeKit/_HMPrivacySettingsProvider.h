...
- (void)requestAccessWithQueue:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000000000209ff
- (unsigned long long)queryAuthorizationStatus;	// IMP=0x00000000000209d7
