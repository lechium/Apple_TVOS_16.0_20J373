...
- (void).cxx_destruct;	// IMP=0x000000000022b75f
...
- (void)main;	// IMP=0x000000000022b1d3
- (id)initWithHomeManager:(id)arg1 timeout:(double)arg2;	// IMP=0x000000000022b162
- (id)initWithHomeManager:(id)arg1;	// IMP=0x000000000022b14d
