...
- (void).cxx_destruct;	// IMP=0x000000000014f69b
...
- (id)description;	// IMP=0x000000000014f5a2
- (void)sendMessage:(id)arg1;	// IMP=0x000000000014f0ef
- (void)notifyObservers:(id)arg1 withApplications:(id)arg2;	// IMP=0x000000000014ecda
- (void)clear;	// IMP=0x000000000014ecc4
- (void)removeApplication:(id)arg1;	// IMP=0x000000000014eb14
- (void)addApplication:(id)arg1;	// IMP=0x000000000014eac4
- (void)stopTimer;	// IMP=0x000000000014ea0e
- (void)dealloc;	// IMP=0x000000000014e9cc
- (id)initWithQueue:(id)arg1;	// IMP=0x000000000014e8fc
