...
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000002700f
- (void).cxx_destruct;	// IMP=0x00000000000276eb
...
- (id)initWithContext:(struct LSContext *)arg1 unitID:(unsigned int)arg2;	// IMP=0x000000000002727c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000271d7
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000027017
