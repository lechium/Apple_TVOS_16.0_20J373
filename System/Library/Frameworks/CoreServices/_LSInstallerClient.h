...
+ (id)revertInstallerWithBundleID:(id)arg1 options:(id)arg2 callbackBlock:(CDUnknownBlockType)arg3;	// IMP=0x001000000014cd8a
+ (id)installerWithBundleID:(id)arg1 bundleURL:(id)arg2 options:(id)arg3 callbackBlock:(CDUnknownBlockType)arg4;	// IMP=0x001000000014cca8
+ (id)unInstallerWithBundleID:(id)arg1 options:(id)arg2 callbackBlock:(CDUnknownBlockType)arg3;	// IMP=0x001000000014cbe8
- (void).cxx_destruct;	// IMP=0x000000000014d937
...
- (void)_invalidate;	// IMP=0x000000000014d064
- (void)_waitForAllCallbackMessagesToExecute;	// IMP=0x000000000014d00e
- (void)_beginOperation;	// IMP=0x000000000014cfbf
@property(readonly) _Bool allCallbacksDeleviered; // @synthesize allCallbacksDeleviered=_allCallbacksDeleviered;
- (void)callbackDeliveryComplete;	// IMP=0x000000000014cf2b
- (void)updateCallbackWithData:(id)arg1;	// IMP=0x000000000014ce4a
- (id)initWithMICall:(id)arg1 options:(id)arg2 callbackBlock:(CDUnknownBlockType)arg3;	// IMP=0x000000000014ca3d
