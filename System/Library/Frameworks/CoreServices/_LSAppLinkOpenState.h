...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000048bb6
- (id).cxx_construct;	// IMP=0x0000000000048fbd
- (void).cxx_destruct;	// IMP=0x0000000000048f74
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000048cee
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000048bbe
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000048ac5
- (id)debugDescription;	// IMP=0x0000000000048968
