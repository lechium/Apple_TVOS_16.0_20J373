...
- (id).cxx_construct;	// IMP=0x00000000000d25eb
- (void).cxx_destruct;	// IMP=0x00000000000d25aa
@property(retain) LSApplicationRecord *parentApplicationRecord; // @synthesize parentApplicationRecord=_parentApplicationRecord;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000d250f
- (_Bool)_getObject:(id *)arg1 atIndex:(unsigned long long)arg2 context:(struct LSContext *)arg3;	// IMP=0x00000000000d246c
- (_Bool)_prepareWithContext:(struct LSContext *)arg1 error:(id *)arg2;	// IMP=0x00000000000d2232
