...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000159b56
- (void).cxx_destruct;	// IMP=0x0000000000159e29
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000159cad
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000159c0c
- (id)initWithNotification:(int)arg1 bundleIDs:(id)arg2 plugins:(_Bool)arg3 options:(id)arg4;	// IMP=0x0000000000159b5e
