...
+ (_Bool)canHandleURLComponents:(id)arg1;	// IMP=0x006000000004ada0
+ (id)plugInClasses;	// IMP=0x006000000004ad34
- (void).cxx_destruct;	// IMP=0x000000000004b046
...
- (id)appLinksWithContext:(struct LSContext *)arg1 error:(id *)arg2;	// IMP=0x000000000004af9d
