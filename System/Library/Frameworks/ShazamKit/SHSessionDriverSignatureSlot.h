...
- (long long)appendBuffer:(id)arg1 atTime:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000003d75
@property(readonly, nonatomic) SHSignatureGenerator *signatureGenerator; // @synthesize signatureGenerator=_signatureGenerator;
- (void)reset;	// IMP=0x0000000000003c9c
- (id)initWithMaximumSignatureDuration:(double)arg1;	// IMP=0x0000000000003c41
