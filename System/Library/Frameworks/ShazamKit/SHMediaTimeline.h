...
+ (double)nextEventForRange:(id)arg1 atMatchOffset:(double)arg2;	// IMP=0x006000000000cbed
+ (double)countdownForMatchedMediaItem:(id)arg1;	// IMP=0x006000000000c8d5
+ (id)blankMediaItemWhenNothingIsInScope:(id)arg1;	// IMP=0x006000000000c69f
- (void).cxx_destruct;	// IMP=0x000000000000ccdd
...
- (id)earliestInscopeRangeForMatchedMediaItem:(id)arg1;	// IMP=0x000000000000c478
- (id)sortMediaItems:(id)arg1;	// IMP=0x000000000000c27d
@property(readonly, nonatomic) NSArray *inScopeMediaItems;
@property(readonly, nonatomic) NSNumber *timeToNextMediaItemScopeChange;
- (void)cancelTimerSource;	// IMP=0x000000000000bd05
- (void)startTimerForNextEvent;	// IMP=0x000000000000ba6d
- (_Bool)finished;	// IMP=0x000000000000ba3a
- (void)stopGenerating;	// IMP=0x000000000000ba28
- (void)startGenerating;	// IMP=0x000000000000ba16
- (id)initWithMatch:(id)arg1;	// IMP=0x000000000000b89f
- (void)dealloc;	// IMP=0x000000000000b861
