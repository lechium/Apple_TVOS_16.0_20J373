...
- (void).cxx_destruct;	// IMP=0x00000000000cb7bf
@property(retain, nonatomic) CNContact *existingContact; // @synthesize existingContact=_existingContact;
- (void)contactViewController:(id)arg1 didCompleteWithContact:(id)arg2;	// IMP=0x00000000000cb6ce
- (void)performActionWithSender:(id)arg1;	// IMP=0x00000000000cb2db
