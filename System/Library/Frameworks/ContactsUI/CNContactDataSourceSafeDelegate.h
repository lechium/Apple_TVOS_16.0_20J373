...
- (void).cxx_destruct;	// IMP=0x00000000000c969d
@property(nonatomic) __weak id <CNContactDataSourceDelegate> delegate; // @synthesize delegate=_delegate;
- (void)contactDataSourceDidChange:(id)arg1;	// IMP=0x00000000000c95cf
- (id)initWithDelegate:(id)arg1;	// IMP=0x00000000000c9554
