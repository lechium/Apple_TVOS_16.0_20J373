...
+ (_Bool)sortUsingCoreDuetAvailable;	// IMP=0x00600000000c1352
+ (id)managerForContact:(id)arg1;	// IMP=0x00600000000c1244
- (void).cxx_destruct;	// IMP=0x00000000000c1a71
...
- (id)sortedActions:(id)arg1;	// IMP=0x00000000000c16fe
- (void)_updateDuetInteractionsIfNeeded;	// IMP=0x00000000000c16f8
- (void)updateCachedEnabledStateForAction:(id)arg1;	// IMP=0x00000000000c164f
- (void)cacheEnabledStateForAction:(id)arg1;	// IMP=0x00000000000c159b
- (double)scoreForAction:(id)arg1;	// IMP=0x00000000000c14e7
- (void)actionPerformed:(id)arg1;	// IMP=0x00000000000c1457
- (id)init;	// IMP=0x00000000000c135a
