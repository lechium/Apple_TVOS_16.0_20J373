...
- (void).cxx_destruct;	// IMP=0x000000000009f923
...
- (CDUnknownBlockType)_animationForReusableView:(id)arg1 toLayoutAttributes:(id)arg2 type:(unsigned long long)arg3;	// IMP=0x000000000009f717
- (void)_updateLayoutMetrics;	// IMP=0x000000000009ed44
- (id)layoutAttributesForItemAtIndexPath:(id)arg1;	// IMP=0x000000000009eaa0
- (id)layoutAttributesForElementsInRect:(struct CGRect)arg1;	// IMP=0x000000000009e776
- (void)prepareForCollectionViewUpdates:(id)arg1;	// IMP=0x000000000009e747
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000009e672
