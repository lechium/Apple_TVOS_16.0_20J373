...
- (void).cxx_destruct;	// IMP=0x00000000000ae961
...
- (long long)localizedCompare:(id)arg1;	// IMP=0x00000000000ae80f
- (id)arrayForDisplay:(_Bool)arg1;	// IMP=0x00000000000ae512
- (void)_setSelected:(_Bool)arg1;	// IMP=0x00000000000ae091
- (id)initWithType:(long long)arg1;	// IMP=0x00000000000ade61
