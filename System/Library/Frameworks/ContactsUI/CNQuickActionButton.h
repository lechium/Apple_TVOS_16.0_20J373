...
- (void).cxx_destruct;	// IMP=0x000000000009e610
...
- (void)onLongPress:(id)arg1;	// IMP=0x000000000009e28e
- (void)performAction;	// IMP=0x000000000009e1b1
- (void)updateConstraints;	// IMP=0x000000000009dd73
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000009d823
