...
+ (id)sharedWorkQueue;	// IMP=0x001000000005b47e
- (void).cxx_destruct;	// IMP=0x000000000005c7e3
...
- (void)_requestStatusOnMainQueue:(_Bool)arg1;	// IMP=0x000000000005b9dd
- (void)idStatusUpdatedForDestinations:(id)arg1 service:(id)arg2;	// IMP=0x000000000005b918
@property(readonly, nonatomic) _Bool cancelled;
- (void)cancel;	// IMP=0x000000000005b830
- (void)cleanupDelegate;	// IMP=0x000000000005b78b
- (id)initWithPropertyItems:(id)arg1 service:(id)arg2 postToMainQueue:(_Bool)arg3 resultBlock:(CDUnknownBlockType)arg4;	// IMP=0x000000000005b501
