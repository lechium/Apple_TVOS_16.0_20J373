...
- (void).cxx_destruct;	// IMP=0x00000000001732b8
...
- (id)_legendStringForDistanceString:(id)arg1 appendUnits:(_Bool)arg2 index:(int)arg3;	// IMP=0x00000000001730d2
@property(readonly, nonatomic) NSString *zeroUnitsString; // @synthesize zeroUnitsString=_zeroUnitsString;
- (id)_uncachedLegendStringsForDistanceString:(id)arg1;	// IMP=0x0000000000172df6
...
- (_Bool)canDisplaySegment:(unsigned long long)arg1;	// IMP=0x000000000017283a
- (void)_calculateLegend:(_Bool)arg1;	// IMP=0x00000000001720e1
- (void)setUnits:(id)arg1;	// IMP=0x0000000000171e8b
- (double)_widthForString:(id)arg1 attributes:(id)arg2;	// IMP=0x0000000000171d82
- (void)clearCaches:(id)arg1;	// IMP=0x0000000000171d65
- (id)init;	// IMP=0x0000000000171b5f
