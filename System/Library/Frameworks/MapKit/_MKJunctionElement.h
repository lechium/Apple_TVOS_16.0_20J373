...
- (struct CGPoint)rightEdgePointAtDistanceFromBase:(double)arg1;	// IMP=0x00000000001f78e0
- (struct CGPoint)leftEdgePointAtDistanceFromBase:(double)arg1;	// IMP=0x00000000001f7874
