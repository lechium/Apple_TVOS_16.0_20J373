...
- (void).cxx_destruct;	// IMP=0x0000000000156507
...
- (void)_contentSizeDidChange;	// IMP=0x00000000001563f7
- (struct UIEdgeInsets)collectionView:(id)arg1 layout:(id)arg2 insetForSectionAtIndex:(long long)arg3;	// IMP=0x00000000001563dd
- (struct CGSize)collectionView:(id)arg1 layout:(id)arg2 sizeForItemAtIndexPath:(id)arg3;	// IMP=0x0000000000156200
- (void)collectionView:(id)arg1 didSelectItemAtIndexPath:(id)arg2;	// IMP=0x0000000000156104
- (void)_updateAppearance;	// IMP=0x0000000000156064
- (void)_setupConstraints;	// IMP=0x0000000000155ca1
- (void)_setupCollectionView;	// IMP=0x00000000001559dd
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000015596b
