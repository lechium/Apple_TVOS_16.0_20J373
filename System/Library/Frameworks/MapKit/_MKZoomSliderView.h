...
- (void).cxx_destruct;	// IMP=0x000000000009079c
@property(nonatomic, getter=isActive) _Bool active; // @synthesize active=_active;
@property(nonatomic) double zoomFraction; // @synthesize zoomFraction=_zoomFraction;
- (void)updateConstraints;	// IMP=0x000000000008fa34
- (void)setBounds:(struct CGRect)arg1;	// IMP=0x000000000008f9e2
- (void)didMoveToWindow;	// IMP=0x000000000008f899
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000008ea3a
