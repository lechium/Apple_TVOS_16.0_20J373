...
- (void).cxx_destruct;	// IMP=0x00000000000d42f5
...
- (void)cancel;	// IMP=0x00000000000d4186
- (_Bool)isFinished;	// IMP=0x00000000000d4176
- (_Bool)isExecuting;	// IMP=0x00000000000d4166
- (void)markOperationAsComplete;	// IMP=0x00000000000d402e
- (void)main;	// IMP=0x00000000000d3872
- (void)start;	// IMP=0x00000000000d37c4
- (id)initWithUrl:(id)arg1 downloadCache:(id)arg2 cacheId:(id)arg3;	// IMP=0x00000000000d36d0
