...
- (id).cxx_construct;	// IMP=0x00000000001e3ef0
- (void).cxx_destruct;	// IMP=0x00000000001e3e68
- (void)flush;	// IMP=0x00000000001e3d76
- (void)setPins:(id)arg1 forMapType:(unsigned long long)arg2 pinColor:(id)arg3 traits:(id)arg4;	// IMP=0x00000000001e3957
- (id)pinsWithMapType:(unsigned long long)arg1 pinColor:(id)arg2 traits:(id)arg3;	// IMP=0x00000000001e372e
- (id)init;	// IMP=0x00000000001e350c
