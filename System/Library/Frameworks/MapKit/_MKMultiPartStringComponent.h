...
- (void).cxx_destruct;	// IMP=0x000000000007000e
...
- (id)description;	// IMP=0x000000000006ff23
- (id)initWithAttributedString:(id)arg1 range:(struct _NSRange)arg2;	// IMP=0x000000000006fe8a
