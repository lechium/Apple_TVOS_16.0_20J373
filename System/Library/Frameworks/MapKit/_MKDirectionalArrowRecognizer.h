...
- (void).cxx_destruct;	// IMP=0x000000000009dc8a
...
- (void)keyUp:(id)arg1;	// IMP=0x000000000009db8c
- (void)keyDown:(id)arg1;	// IMP=0x000000000009da8e
- (void)handleArrowMask:(long long)arg1;	// IMP=0x000000000009d9d1
- (id)initWithTarget:(id)arg1 action:(SEL)arg2;	// IMP=0x000000000009d8e9
