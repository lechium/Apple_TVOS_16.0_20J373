...
- (void).cxx_destruct;	// IMP=0x0000000000184016
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000183f9b
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000183e89
- (unsigned long long)hash;	// IMP=0x0000000000183e39
- (id)initWithSize:(struct CGSize)arg1 headingString:(id)arg2 compassViewStyle:(long long)arg3;	// IMP=0x0000000000183d92
