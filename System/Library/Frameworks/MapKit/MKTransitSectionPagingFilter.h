...
+ (_Bool)_newStationCardUIEnabled;	// IMP=0x006000000005d722
+ (unsigned long long)_kMaxLinesInSectionBeforePage;	// IMP=0x006000000005d710
+ (unsigned long long)_kNumLinesFallbackValue;	// IMP=0x006000000005d6eb
+ (id)defaultFilterForInactiveLines;	// IMP=0x006000000005d66a
+ (id)defaultFilterForDepartures;	// IMP=0x006000000005d5e9
