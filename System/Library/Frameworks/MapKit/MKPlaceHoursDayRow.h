...
- (void).cxx_destruct;	// IMP=0x00000000000725b4
...
- (void)hoursViewDidUpdate:(id)arg1;	// IMP=0x000000000007236b
- (void)_setUpConstraints;	// IMP=0x0000000000072064
- (void)_setUpViewsForPlaceHoursDayRow;	// IMP=0x0000000000071ff1
- (id)initWithBusinessHours:(id)arg1 frame:(struct CGRect)arg2;	// IMP=0x0000000000071f2d
