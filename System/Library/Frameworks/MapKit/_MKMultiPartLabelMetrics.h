...
- (void).cxx_destruct;	// IMP=0x000000000014f3a3
...
- (void)reset;	// IMP=0x000000000014f068
- (_Bool)_shiftLocationOfStrings:(id)arg1 startingAtIndex:(unsigned long long)arg2 shiftValue:(long long)arg3;	// IMP=0x000000000014ef87
- (_Bool)replaceSeparatorAtIndex:(unsigned long long)arg1 withString:(id)arg2;	// IMP=0x000000000014ec4e
- (id)initWithMultiPartString:(id)arg1;	// IMP=0x000000000014e70f
