...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000c7281
- (void).cxx_destruct;	// IMP=0x00000000000c7755
...
- (void)setCustomFeature:(id)arg1;	// IMP=0x00000000000c7410
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000c7342
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000c7289
