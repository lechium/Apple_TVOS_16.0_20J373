...
+ (id)markerStyleForTraitCollection:(id)arg1 state:(long long)arg2 styleAttributes:(id)arg3 coordinate:(struct CLLocationCoordinate2D)arg4;	// IMP=0x006000000002cb4b
- (void).cxx_destruct;	// IMP=0x000000000002d3f3
