...
- (void).cxx_destruct;	// IMP=0x00000000001c3806
...
- (_Bool)hasAdditionalSnappingAngle;	// IMP=0x00000000001c3721
- (void)updateSnappedToNorth;	// IMP=0x00000000001c3526
- (void)snapToNorthAnimated:(_Bool)arg1 forceTrueNorth:(_Bool)arg2;	// IMP=0x00000000001c3347
- (void)stopRotatingWithFocusPoint:(struct CGPoint)arg1;	// IMP=0x00000000001c32ff
- (void)updateRotationWithFocusPoint:(struct CGPoint)arg1 newValue:(double)arg2;	// IMP=0x00000000001c3054
- (void)startRotatingWithFocusPoint:(struct CGPoint)arg1 withSnapping:(_Bool)arg2;	// IMP=0x00000000001c2f3a
- (id)initWithMapLayer:(id)arg1;	// IMP=0x00000000001c2ed6
- (id)init;	// IMP=0x00000000001c2eac
