...
- (void).cxx_destruct;	// IMP=0x000000000011e563
...
- (void)_didUpdateETAResult;	// IMP=0x000000000011e4e4
- (void)invalidateETAForTransportType:(unsigned long long)arg1;	// IMP=0x000000000011e490
- (_Bool)isValidETA:(id)arg1;	// IMP=0x000000000011e3e7
- (void)expireETAsIfNoLongerValid;	// IMP=0x000000000011e15c
- (_Bool)shouldUpdateEstimatedTravelTimeForNewOrigin:(struct CLLocationCoordinate2D)arg1;	// IMP=0x000000000011e066
...
- (_Bool)isUsingCurrentLocationForOrigin;	// IMP=0x000000000011de20
- (void)requestNewETAForTransportType:(unsigned long long)arg1 additionalTransportTypes:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000000011d75a
- (id)routeETAForTransportType:(unsigned long long)arg1;	// IMP=0x000000000011d6f3
- (void)_resetState;	// IMP=0x000000000011d686
- (void)dealloc;	// IMP=0x000000000011d36b
- (id)init;	// IMP=0x000000000011d2a6
