...
- (void).cxx_destruct;	// IMP=0x0000000000156d08
@property(readonly, nonatomic) MKTransitSystemFilterView *filterView; // @synthesize filterView=_filterView;
@property(retain, nonatomic) NSString *titleText;
- (void)_contentSizeDidChange;	// IMP=0x0000000000156c2a
- (void)_setupConstraints;	// IMP=0x00000000001567a4
- (void)_setupSubviews;	// IMP=0x00000000001565ec
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000000015657a
