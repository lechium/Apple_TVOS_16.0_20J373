...
- (void).cxx_destruct;	// IMP=0x0000000000005777
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000000000053fe
- (unsigned long long)hash;	// IMP=0x00000000000051bf
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000004f29
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000004d3a
- (void)copyTo:(id)arg1;	// IMP=0x0000000000004bb9
- (void)writeTo:(id)arg1;	// IMP=0x0000000000004a3d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000000004a30
- (id)dictionaryRepresentation;	// IMP=0x00000000000041d0
- (id)description;	// IMP=0x0000000000004121
...
- (_Bool)_setObject:(id)arg1;	// IMP=0x000000000004f852
- (id)initWithObjectValue:(id)arg1;	// IMP=0x000000000004f7d9
