...
- (void).cxx_destruct;	// IMP=0x00000000000ac7b3
...
- (void)faultIfNeededForObject:(id)arg1;	// IMP=0x00000000000ac6fa
- (id)initWithRootObject:(id)arg1;	// IMP=0x00000000000ac68f
