...
+ (id)classesForKey;	// IMP=0x0060000000118145
- (void).cxx_destruct;	// IMP=0x00000000001186ba
...
- (id)createAlarm:(id *)arg1;	// IMP=0x000000000011841a
- (id)initWithAlarm:(id)arg1;	// IMP=0x00000000001182fd
