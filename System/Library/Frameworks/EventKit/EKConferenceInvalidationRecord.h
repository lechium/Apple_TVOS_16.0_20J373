...
- (void).cxx_destruct;	// IMP=0x0000000000112a17
...
- (void)finishWithURL:(id)arg1 error:(id)arg2;	// IMP=0x0000000000112811
- (void)generateNewValidURLForOriginalURL:(id)arg1;	// IMP=0x00000000001124bf
