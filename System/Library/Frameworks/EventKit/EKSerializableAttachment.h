...
+ (id)classesForKey;	// IMP=0x00600000000e2194
- (void).cxx_destruct;	// IMP=0x00000000000e2249
...
- (id)createAttachment;	// IMP=0x00000000000e21d0
- (id)initWithAttachment:(id)arg1;	// IMP=0x00000000000e21a1
