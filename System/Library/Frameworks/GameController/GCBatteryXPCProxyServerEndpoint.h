...
- (void).cxx_destruct;	// IMP=0x00000000000d33fe
...
- (void)fetchObjectIdentifierWithReply:(CDUnknownBlockType)arg1;	// IMP=0x00000000000d3332
- (void)invalidateConnection;	// IMP=0x00000000000d327f
- (void)fetchBatteryWithReply:(CDUnknownBlockType)arg1;	// IMP=0x00000000000d31d6
- (_Bool)acceptClient:(id)arg1 onConnection:(id)arg2 error:(id *)arg3;	// IMP=0x00000000000d2dbb
- (void)invalidateClient;	// IMP=0x00000000000d2cfa
@property(readonly, nonatomic) id <_GCControllerComponentDescription> receiverDescription;
- (id)initWithInitialValue:(id)arg1;	// IMP=0x00000000000d2c3e
- (id)initWithIdentifier:(id)arg1 initialValue:(id)arg2;	// IMP=0x00000000000d2b98
