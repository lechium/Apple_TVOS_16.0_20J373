...
- (void)fetchObjectIdentifierWithReply:(CDUnknownBlockType)arg1;	// IMP=0x000000000001f434
- (void)invalidateConnection;	// IMP=0x000000000001f381
- (void)fetchSensorsActiveWithReply:(CDUnknownBlockType)arg1;	// IMP=0x000000000001f2d8
- (void)newSensorsActive:(_Bool)arg1;	// IMP=0x000000000001f22e
- (_Bool)acceptClient:(id)arg1 onConnection:(id)arg2 error:(id *)arg3;	// IMP=0x000000000001ee3e
- (void)invalidateClient;	// IMP=0x000000000001ed7d
@property(readonly, nonatomic) id <_GCControllerComponentDescription> receiverDescription;
- (id)initWithInitialValue:(_Bool)arg1;	// IMP=0x000000000001ece3
- (id)initWithIdentifier:(id)arg1 initialValue:(_Bool)arg2;	// IMP=0x000000000001ec63
