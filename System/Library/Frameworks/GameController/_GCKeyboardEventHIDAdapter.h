...
- (void).cxx_destruct;	// IMP=0x000000000001cf0c
...
- (id)observeKeyboardEvents:(CDUnknownBlockType)arg1;	// IMP=0x000000000001cb38
- (void)dealloc;	// IMP=0x000000000001cadf
- (id)init;	// IMP=0x000000000001cab4
- (id)initWithSource:(id)arg1 service:(id)arg2;	// IMP=0x000000000001c784
