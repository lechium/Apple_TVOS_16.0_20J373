...
- (void)fetchObjectIdentifierWithReply:(CDUnknownBlockType)arg1;	// IMP=0x0000000000010761
- (void)invalidateConnection;	// IMP=0x00000000000106bd
- (void)refreshStatuses;	// IMP=0x0000000000010590
- (void)newStatuses:(id)arg1;	// IMP=0x0000000000010472
- (void)_remoteEndpointHasSetStatuses:(id)arg1;	// IMP=0x0000000000010324
- (void)setController:(id)arg1;	// IMP=0x000000000001027e
- (void)setRemoteEndpoint:(id)arg1 connection:(id)arg2;	// IMP=0x0000000000010056
- (id)init;	// IMP=0x000000000001002b
- (id)initWithIdentifier:(id)arg1 initialStatuses:(id)arg2;	// IMP=0x000000000000fe3e
