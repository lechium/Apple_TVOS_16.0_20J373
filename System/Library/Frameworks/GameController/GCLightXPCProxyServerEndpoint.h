...
- (void).cxx_destruct;	// IMP=0x000000000005fd1f
...
- (void)fetchObjectIdentifierWithReply:(CDUnknownBlockType)arg1;	// IMP=0x000000000005fc53
- (void)invalidateConnection;	// IMP=0x000000000005fba0
- (void)fetchLightWithReply:(CDUnknownBlockType)arg1;	// IMP=0x000000000005faf7
- (void)newLight:(id)arg1;	// IMP=0x000000000005f9eb
- (_Bool)acceptClient:(id)arg1 onConnection:(id)arg2 error:(id *)arg3;	// IMP=0x000000000005f5d0
- (void)invalidateClient;	// IMP=0x000000000005f50f
@property(readonly, nonatomic) id <_GCControllerComponentDescription> receiverDescription;
- (id)initWithInitialValue:(id)arg1;	// IMP=0x000000000005f453
- (id)initWithIdentifier:(id)arg1 initialValue:(id)arg2;	// IMP=0x000000000005f3ad
