...
- (double)lastEventTimestamp;	// IMP=0x00000000000bb9ea
- (_Bool)isSnapshot;	// IMP=0x00000000000bb990
- (id)popTransaction;	// IMP=0x00000000000bb627
- (void)setDevice:(id)arg1;	// IMP=0x00000000000bb505
- (void)dealloc;	// IMP=0x00000000000bb32e
- (id)initWithFacade:(id)arg1 elements:(id)arg2;	// IMP=0x00000000000bb1b1
