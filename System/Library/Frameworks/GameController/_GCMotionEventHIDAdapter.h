...
- (void).cxx_destruct;	// IMP=0x000000000000f6a1
...
- (id)observeMotionEvents:(CDUnknownBlockType)arg1;	// IMP=0x000000000000f2cd
- (void)dealloc;	// IMP=0x000000000000f274
- (id)init;	// IMP=0x000000000000f249
- (id)initWithSource:(id)arg1 service:(id)arg2;	// IMP=0x000000000000ec36
