...
- (double)lastEventTimestamp;	// IMP=0x000000000007087a
- (_Bool)isSnapshot;	// IMP=0x000000000007063c
- (id)description;	// IMP=0x00000000000705a3
- (_Bool)allowsWeakReference;	// IMP=0x000000000007056a
- (void)dealloc;	// IMP=0x00000000000704fa
