...
- (id)observeGamepadEvents:(CDUnknownBlockType)arg1;	// IMP=0x000000000007161c
- (void)dealloc;	// IMP=0x00000000000715c3
- (id)init;	// IMP=0x0000000000071598
- (id)initWithSource:(id)arg1 service:(id)arg2;	// IMP=0x00000000000712c2
