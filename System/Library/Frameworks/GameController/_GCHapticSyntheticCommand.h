...
- (void).cxx_destruct;	// IMP=0x000000000000deb6
...
- (id)description;	// IMP=0x000000000000de43
...
- (void)cancel;	// IMP=0x000000000000ddf0
- (void)preprocessCommand:(const void *)arg1;	// IMP=0x000000000000dd60
- (id)initWithHapticCommand:(const void *)arg1;	// IMP=0x000000000000dc6f
