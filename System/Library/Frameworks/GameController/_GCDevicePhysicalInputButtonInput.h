...
- (void)invokeCallbacksForInputChangedState:(unsigned char)arg1 withElement:(id)arg2;	// IMP=0x0000000000026663
...
- (id)init;	// IMP=0x0000000000026300
- (id)initWith:(id)arg1 context:(id)arg2;	// IMP=0x00000000000261aa
- (id)initWithParams:(struct _GCDevicePhysicalInputButtonInputParams)arg1;	// IMP=0x0000000000026153
