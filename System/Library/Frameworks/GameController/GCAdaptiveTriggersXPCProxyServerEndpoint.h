...
- (void).cxx_destruct;	// IMP=0x000000000001129d
...
- (void)fetchObjectIdentifierWithReply:(CDUnknownBlockType)arg1;	// IMP=0x000000000001119b
- (void)invalidateConnection;	// IMP=0x00000000000110e8
- (void)newAdaptiveTriggerPayload:(id)arg1 index:(int)arg2;	// IMP=0x0000000000010fea
- (void)fetchStatusesWithReply:(CDUnknownBlockType)arg1;	// IMP=0x0000000000010f41
- (_Bool)acceptClient:(id)arg1 onConnection:(id)arg2 error:(id *)arg3;	// IMP=0x0000000000010b1b
- (void)invalidateClient;	// IMP=0x0000000000010a5a
@property(readonly, nonatomic) id <_GCControllerComponentDescription> receiverDescription;
- (id)initWithInitialStatuses:(id)arg1;	// IMP=0x000000000001099e
- (id)initWithIdentifier:(id)arg1 initialStatuses:(id)arg2;	// IMP=0x000000000001089e
