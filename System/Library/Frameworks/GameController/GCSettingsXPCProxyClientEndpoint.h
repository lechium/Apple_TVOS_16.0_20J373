...
- (void).cxx_destruct;	// IMP=0x000000000006c7a8
...
- (void)fetchObjectIdentifierWithReply:(CDUnknownBlockType)arg1;	// IMP=0x000000000006c705
- (void)invalidateConnection;	// IMP=0x000000000006c661
- (void)refreshProfile;	// IMP=0x000000000006c542
- (void)newProfile:(id)arg1;	// IMP=0x000000000006c42f
- (void)_remoteEndpointHasSetProfile:(id)arg1;	// IMP=0x000000000006c2f3
- (void)setController:(id)arg1;	// IMP=0x000000000006c2e2
- (void)setRemoteEndpoint:(id)arg1 connection:(id)arg2;	// IMP=0x000000000006c0d3
- (id)init;	// IMP=0x000000000006c0a8
- (id)initWithIdentifier:(id)arg1 initialValueForProfile:(id)arg2;	// IMP=0x000000000006bf67
