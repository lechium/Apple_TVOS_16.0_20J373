...
- (void).cxx_destruct;	// IMP=0x000000000001ff72
- (void)stopAllHaptics;	// IMP=0x000000000001fe57
- (_Bool)hasClients;	// IMP=0x000000000001fe3a
- (void)unregisterHapticClient:(id)arg1;	// IMP=0x000000000001fe24
- (void)registerHapticClient:(id)arg1;	// IMP=0x000000000001fe0e
- (id)initWithIdentifier:(id)arg1 clientConnection:(id)arg2;	// IMP=0x000000000001fc3d
