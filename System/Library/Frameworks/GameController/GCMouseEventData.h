...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000d63d6
...
- (id)debugDescription;	// IMP=0x00000000000d637e
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000d62ae
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000000d61b8
