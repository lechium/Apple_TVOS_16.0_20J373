...
- (void)fetchObjectIdentifierWithReply:(CDUnknownBlockType)arg1;	// IMP=0x000000000006cf2a
- (void)invalidateConnection;	// IMP=0x000000000006ce77
- (void)fetchProfileWithReply:(CDUnknownBlockType)arg1;	// IMP=0x000000000006cdce
- (_Bool)acceptClient:(id)arg1 onConnection:(id)arg2 error:(id *)arg3;	// IMP=0x000000000006ca17
- (void)invalidateClient;	// IMP=0x000000000006c967
@property(readonly, nonatomic) id <_GCControllerComponentDescription> receiverDescription;
- (id)initWithInitialValueForProfile:(id)arg1;	// IMP=0x000000000006c8ab
- (id)initWithIdentifier:(id)arg1 initialValueForProfile:(id)arg2;	// IMP=0x000000000006c805
