...
- (id)changedElements;	// IMP=0x00000000000beead
- (long long)changeForElement:(id)arg1;	// IMP=0x00000000000bedf0
- (id)nextInputState;	// IMP=0x00000000000bed87
@property long long inputStateQueueDepth;
@property(copy) CDUnknownBlockType inputStateAvailableHandler;
- (id)capture;	// IMP=0x00000000000bebd7
@property(copy) CDUnknownBlockType elementValueDidChangeHandler;
- (id)objectForKeyedSubscript:(id)arg1;	// IMP=0x00000000000beb1c
...
- (id)init;	// IMP=0x00000000000be988
- (id)initWith:(id)arg1 context:(id)arg2;	// IMP=0x00000000000be92c
