...
- (void).cxx_destruct;	// IMP=0x00000000000c0742
...
- (void)fetchObjectIdentifierWithReply:(CDUnknownBlockType)arg1;	// IMP=0x00000000000c0676
- (void)invalidateConnection;	// IMP=0x00000000000c05c3
- (void)fetchPlayerIndexWithReply:(CDUnknownBlockType)arg1;	// IMP=0x00000000000c051a
- (void)newPlayerIndex:(long long)arg1;	// IMP=0x00000000000c046c
- (_Bool)acceptClient:(id)arg1 onConnection:(id)arg2 error:(id *)arg3;	// IMP=0x00000000000c007b
- (void)invalidateClient;	// IMP=0x00000000000bffba
@property(readonly, nonatomic) id <_GCControllerComponentDescription> receiverDescription;
- (id)initWithInitialValue:(long long)arg1;	// IMP=0x00000000000bff20
- (id)initWithIdentifier:(id)arg1 initialValue:(long long)arg2;	// IMP=0x00000000000bfea0
