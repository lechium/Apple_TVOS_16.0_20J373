...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000000683ce
...
- (id)debugDescription;	// IMP=0x000000000006838a
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000000682ff
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000068258
