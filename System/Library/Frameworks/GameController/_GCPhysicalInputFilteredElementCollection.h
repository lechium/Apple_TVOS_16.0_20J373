...
- (void).cxx_destruct;	// IMP=0x000000000009b969
- (id)elementEnumerator;	// IMP=0x000000000009b947
- (id)elementForAlias:(id)arg1;	// IMP=0x000000000009b8dd
- (id)elementAtIndex:(unsigned long long)arg1;	// IMP=0x000000000009b8ae
- (unsigned long long)count;	// IMP=0x000000000009b88c
