...
- (void).cxx_destruct;	// IMP=0x0000000000179584
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000017942e
- (unsigned long long)hash;	// IMP=0x00000000001793a1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000179396
- (id)initWithEnvironmentName:(id)arg1 namedDelegatePort:(id)arg2;	// IMP=0x00000000001792dd
