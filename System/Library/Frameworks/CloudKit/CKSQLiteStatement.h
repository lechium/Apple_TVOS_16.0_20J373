...
- (void).cxx_destruct;	// IMP=0x00000000001a5fc6
- (void)bindText:(id)arg1 atIndex:(unsigned long long)arg2;	// IMP=0x00000000001a56c5
- (void)invalidate:(id)arg1;	// IMP=0x00000000001a534d
