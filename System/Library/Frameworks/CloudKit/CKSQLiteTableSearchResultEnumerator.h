...
- (void).cxx_destruct;	// IMP=0x000000000005b512
@property(retain, nonatomic) CKSQLiteCompiledStatement *statement; // @synthesize statement=_statement;
@property(readonly, nonatomic) NSError *error; // @synthesize error=_error;
- (id)nextObject;	// IMP=0x000000000005ae4f
- (void)invalidate;	// IMP=0x000000000005acff
- (void)dealloc;	// IMP=0x000000000005acc1
- (id)initWithTable:(id)arg1 statement:(id)arg2;	// IMP=0x000000000005ac1f
- (id)cksqlcs_appendSQLConstantValueToString:(id)arg1;	// IMP=0x0000000000057ed7
