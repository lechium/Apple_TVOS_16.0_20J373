...
- (void)setupStatement:(id)arg1;	// IMP=0x000000000005aa16
- (void)orderDescendingByProperty:(id)arg1;	// IMP=0x000000000005a99c
- (void)orderAscendingByProperty:(id)arg1;	// IMP=0x000000000005a922
