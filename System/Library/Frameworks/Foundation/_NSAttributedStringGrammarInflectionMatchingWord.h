...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000005ce6f2
- (void)dealloc;	// IMP=0x00000000005ce685
- (id)initWithWordToken:(id)arg1 matchingGrammar:(id)arg2;	// IMP=0x00000000005ce5e8
