...
+ (id)_replacementsFromMetadataArray:(id)arg1;	// IMP=0x00600000004da0cd
...
- (void)dealloc;	// IMP=0x00000000004da06f
- (id)_initWithMetadata:(id)arg1;	// IMP=0x00000000004d9d71
