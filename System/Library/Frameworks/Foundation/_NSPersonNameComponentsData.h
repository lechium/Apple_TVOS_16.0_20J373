...
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000004af632
...
- (void)dealloc;	// IMP=0x00000000004af9f3
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000000004af8f6
- (id)initWithCoder:(id)arg1;	// IMP=0x00000000004af63a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000004af578
- (id)init;	// IMP=0x00000000004af50a
