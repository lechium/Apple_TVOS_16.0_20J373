...
+ (_Bool)supportsSecureCoding;	// IMP=0x0010000000651e3d
...
- (void)dealloc;	// IMP=0x00000000006520bd
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000651f3a
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000000651e45
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000000651cd9
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000651c70
