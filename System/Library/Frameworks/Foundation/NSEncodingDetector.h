...
+ (CDUnknownFunctionPointerType)recognizeFuncForCFStringEncoding:(unsigned int)arg1;	// IMP=0x0060000000538565
+ (id)detectorForCFStringEncoding:(unsigned int)arg1 allowBackupDetectors:(_Bool)arg2;	// IMP=0x00600000005384ca
...
- (unsigned long long)recognizeString:(const char *)arg1 withDataLength:(unsigned long long)arg2 intoBuffer:(id)arg3;	// IMP=0x0000000000538551
- (double)multiBytesRatio;	// IMP=0x0000000000538446
- (double)_singleByte_confidence;	// IMP=0x0000000000538374
- (double)_ASCII_confidence;	// IMP=0x00000000005382e8
- (double)confidenceWith2Chars;	// IMP=0x0000000000538249
- (double)confidence;	// IMP=0x0000000000538136
- (id)initWithNSStringEncoding:(unsigned long long)arg1 CFStringEncoding:(unsigned int)arg2 recognizeFunc:(CDUnknownFunctionPointerType)arg3;	// IMP=0x00000000005380a6
- (unsigned long long)maxSkipBytes;	// IMP=0x0000000000538061
- (double)bytesRatio;	// IMP=0x0000000000538012
- (void)softReset;	// IMP=0x0000000000537fc6
- (void)reset;	// IMP=0x0000000000537f68
