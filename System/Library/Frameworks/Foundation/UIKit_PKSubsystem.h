...
+ (id)initForPlugInKit;	// IMP=0x001000000065824f
+ (id)initForPlugInKitWithOptions:(id)arg1;	// IMP=0x0010000000658236
+ (id)sharedInstance;	// IMP=0x001000000065819e
...
- (void)endUsing:(id)arg1;	// IMP=0x0000000000658198
- (void)beginUsing:(id)arg1 withBundle:(id)arg2;	// IMP=0x0000000000657f7d
- (void)dealloc;	// IMP=0x0000000000657f1f
