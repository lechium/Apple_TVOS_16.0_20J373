...
- (_Bool)assetPacksBecameUnavailable:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000559e3f
- (_Bool)assetPacksBecameAvailable:(id)arg1 error:(id *)arg2;	// IMP=0x0000000000559d31
- (id)description;	// IMP=0x0000000000559ca7
- (void)dealloc;	// IMP=0x0000000000559bcb
- (id)initWithBundle:(id)arg1;	// IMP=0x00000000005594d9
