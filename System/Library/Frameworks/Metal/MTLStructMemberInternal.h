...
- (unsigned long long)argumentIndex;	// IMP=0x00000000000afdcb
...
- (unsigned long long)dataType;	// IMP=0x00000000000afd98
- (unsigned long long)offset;	// IMP=0x00000000000afd87
- (id)name;	// IMP=0x00000000000afd76
- (id)formattedDescription:(unsigned long long)arg1;	// IMP=0x00000000000afb81
- (id)dataTypeDescription;	// IMP=0x00000000000afb70
- (_Bool)isMemberLayoutThreadSafeWith:(id)arg1;	// IMP=0x00000000000af9f7
- (id)indirectArgumentType;	// IMP=0x00000000000af9e6
- (void)setOffset:(unsigned long long)arg1;	// IMP=0x00000000000af9d5
- (id)pointerType;	// IMP=0x00000000000af99b
- (id)textureReferenceType;	// IMP=0x00000000000af961
- (id)structType;	// IMP=0x00000000000af93e
- (id)arrayType;	// IMP=0x00000000000af91b
- (unsigned long long)indirectArgumentIndex;	// IMP=0x00000000000af90a
- (void)dealloc;	// IMP=0x00000000000af8a4
- (id)initWithName:(id)arg1 offset:(unsigned long long)arg2 dataType:(unsigned long long)arg3 pixelFormat:(unsigned long long)arg4 aluType:(unsigned long long)arg5 indirectArgumentIndex:(unsigned long long)arg6 render_target:(unsigned long long)arg7 raster_order_group:(unsigned long long)arg8 details:(id)arg9;	// IMP=0x00000000000af783
