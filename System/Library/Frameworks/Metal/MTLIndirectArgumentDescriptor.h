...
+ (id)indirectArgumentDescriptor;	// IMP=0x00600000000540dd
+ (id)allocWithZone:(struct _NSZone *)arg1;	// IMP=0x006000000005406a
+ (id)alloc;	// IMP=0x0060000000054060
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000540d5
