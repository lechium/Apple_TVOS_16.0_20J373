...
- (id)description;	// IMP=0x000000000003aa86
- (id)formattedDescription:(unsigned long long)arg1;	// IMP=0x000000000003a91d
- (id)describe;	// IMP=0x000000000003a890
- (void)dealloc;	// IMP=0x000000000003a849
- (id)initWithValue:(const void *)arg1 type:(unsigned long long)arg2 index:(unsigned long long)arg3;	// IMP=0x000000000003a7cb
