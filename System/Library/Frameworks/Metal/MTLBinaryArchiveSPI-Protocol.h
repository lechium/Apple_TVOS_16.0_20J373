...
@class MTLBinaryEntry, MTLBinaryKey, MTLComputePipelineDescriptor, MTLRenderPipelineDescriptor, MTLStitchedLibraryDescriptor, MTLTileRenderPipelineDescriptor, NSArray, NSMutableArray, NSObject, NSString, NSURL;
