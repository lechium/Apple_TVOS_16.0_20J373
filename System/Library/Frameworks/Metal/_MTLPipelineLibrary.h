...
- (id)newRenderPipelineDescriptorWithName:(id)arg1 error:(id *)arg2;	// IMP=0x000000000006aa01
- (id)newComputePipelineDescriptorWithName:(id)arg1 error:(id *)arg2;	// IMP=0x000000000006a9c6
- (id)newRenderPipelineStateWithName:(id)arg1 options:(unsigned long long)arg2 reflection:(id *)arg3 error:(id *)arg4;	// IMP=0x000000000006a91a
- (id)newComputePipelineStateWithName:(id)arg1 options:(unsigned long long)arg2 reflection:(id *)arg3 error:(id *)arg4;	// IMP=0x000000000006a86e
...
- (void)dealloc;	// IMP=0x000000000006a77b
- (id)initWithDevice:(id)arg1 pipelineLibraryData:(void *)arg2;	// IMP=0x000000000006a707
