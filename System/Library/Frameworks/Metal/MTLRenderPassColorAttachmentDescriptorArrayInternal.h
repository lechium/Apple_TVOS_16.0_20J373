...
- (id)_descriptorAtIndex:(unsigned long long)arg1;	// IMP=0x00000000000a7686
- (void)setObject:(id)arg1 atIndexedSubscript:(unsigned long long)arg2;	// IMP=0x00000000000a75c3
- (id)objectAtIndexedSubscript:(unsigned long long)arg1;	// IMP=0x00000000000a7548
- (void)dealloc;	// IMP=0x00000000000a74cc
