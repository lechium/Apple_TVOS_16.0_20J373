...
- (id)_descriptorAtIndex:(unsigned long long)arg1;	// IMP=0x00000000000a7b96
- (void)setObject:(id)arg1 atIndexedSubscript:(unsigned long long)arg2;	// IMP=0x00000000000a7b17
- (id)objectAtIndexedSubscript:(unsigned long long)arg1;	// IMP=0x00000000000a7a9c
- (void)dealloc;	// IMP=0x00000000000a7a3c
