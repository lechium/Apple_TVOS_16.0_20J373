...
- (id)description;	// IMP=0x00000000000b1114
- (id)formattedDescription:(unsigned long long)arg1;	// IMP=0x00000000000b0f2f
- (void)dealloc;	// IMP=0x00000000000b0ee5
- (id)initWithAirMDType:(id)arg1 dataType:(unsigned long long)arg2 pixelFormat:(unsigned long long)arg3 aluType:(unsigned long long)arg4 name:(id)arg5 offset:(unsigned long long)arg6;	// IMP=0x00000000000b0e5d
