...
- (void).cxx_destruct;	// IMP=0x00200000000186c8
...
- (id)description;	// IMP=0x001000000001848b
- (_Bool)hasEntitlement:(id)arg1;	// IMP=0x0010000000018437
- (id)entitlementValueForKey:(id)arg1;	// IMP=0x0010000000018380
@property(readonly) int pid;
- (void)dead;	// IMP=0x00100000000182a7
- (void)dying;	// IMP=0x001000000001825c
- (void)dealloc;	// IMP=0x001000000001821d
- (id)initWithConnection:(id)arg1 server:(id)arg2;	// IMP=0x001000000001789e
