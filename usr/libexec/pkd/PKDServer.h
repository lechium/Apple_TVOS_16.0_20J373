...
+ (id)server;	// IMP=0x00200000000023eb
...
- (void)stop;	// IMP=0x00100000000034f5
- (void)unholdClient:(id)arg1;	// IMP=0x0010000000003259
- (void)unholdToken:(id)arg1 silent:(_Bool)arg2;	// IMP=0x0010000000002f7b
- (void)addHold:(id)arg1 silent:(_Bool)arg2;	// IMP=0x0010000000002edc
- (id)holdOnPlugIn:(id)arg1;	// IMP=0x0010000000002c10
- (void)terminatePlugIns:(id)arg1 synchronously:(_Bool)arg2 reply:(CDUnknownBlockType)arg3;	// IMP=0x0010000000002533
- (void)removedPlugIns:(id)arg1;	// IMP=0x0010000000002455
- (void)run;	// IMP=0x00100000000023fc
- (id)initWithConnection:(id)arg1 queue:(id)arg2 database:(id)arg3 proxyFactory:(id)arg4;	// IMP=0x0010000000001f14
- (id)initForService:(const char *)arg1 database:(id)arg2 proxyFactory:(id)arg3;	// IMP=0x0010000000001e41
- (void)_startSandbox;	// IMP=0x0010000000001e3b
