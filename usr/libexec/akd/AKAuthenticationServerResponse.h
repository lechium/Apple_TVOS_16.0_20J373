...
@interface AKAuthenticationServerResponse : NSObject
{
    ...
    NSString *_firstName;	// 400 = 0x190
    NSString *_lastName;	// 408 = 0x198
    NSString *_imageURLString;	// 416 = 0x1a0
    NSString *_federatedAuthURL;	// 424 = 0x1a8
    NSData *_federatedAuthRequestPayload;	// 432 = 0x1b0
    NSDictionary *_federatedAuthSamlRequest;	// 440 = 0x1b8
    NSArray *_federatedAuthURLWhiteList;	// 448 = 0x1c0
}

+ (id)decodedConfigurationInfo:(id)arg1;	// IMP=0x004000000000b92e
- (void).cxx_destruct;	// IMP=0x002000000000f14d
...
- (id)_numberFormatter;	// IMP=0x001000000000eda5
- (id)_decodeBase64String:(id)arg1;	// IMP=0x001000000000ed1c
- (void)_updateDSIDWithRawValue:(id)arg1;	// IMP=0x001000000000ec1b
- (_Bool)updateWithSecondaryAuthenticationResponse:(id)arg1 shouldUpdateDSID:(_Bool)arg2;	// IMP=0x001000000000dda3
- (_Bool)updateWithSecondaryAuthenticationResponse:(id)arg1;	// IMP=0x001000000000dd8f
- (void)_updateAccountInformationWithResultsDictionary:(id)arg1;	// IMP=0x001000000000d919
- (void)updateWithSecondaryAuthenticationBody:(id)arg1;	// IMP=0x001000000000d866
@property(readonly, nonatomic) _Bool isUpdateable;
- (void)_setHeartbeatToken:(id)arg1;	// IMP=0x001000000000d83b
@property(readonly, nonatomic) AKToken *inheritanceBeneficiarySetupToken;
@property(readonly, nonatomic) AKToken *heartbeatToken;
- (void)_setPasswordEquivalentToken:(id)arg1;	// IMP=0x001000000000d7e4
@property(readonly, nonatomic) AKToken *passwordEquivalentToken;
- (void)_harvestManagedAppleIDInfoFromDictionary:(id)arg1;	// IMP=0x001000000000d457
- (void)_harvestCommonFieldsFromBody:(id)arg1;	// IMP=0x001000000000cefb
- (void)_harvestCommonFieldsFromResponse:(id)arg1;	// IMP=0x001000000000cc54
- (id)initWithServerResponse:(id)arg1 responseBody:(id)arg2;	// IMP=0x001000000000cb9c
- (id)initWithServerResponse:(id)arg1 forAppleID:(id)arg2;	// IMP=0x001000000000cae9
- (id)_federatedPayloadFromInfo:(id)arg1;	// IMP=0x001000000000ca0e
- (id)initWithSRPContext:(id)arg1;	// IMP=0x001000000000bb0b
