...
+ (id)queryWithString:(id)arg1;	// IMP=0x0040000000095bf0
- (void).cxx_destruct;	// IMP=0x002000000009620b
...
- (_Bool)_bindStatement:(struct sqlite3_stmt *)arg1 withParameter:(id)arg2 atPosition:(int)arg3;	// IMP=0x00100000000960b9
- (void)bindParameters:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000095e37
- (void)bindParameter:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000095c46
