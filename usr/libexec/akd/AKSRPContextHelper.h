...
- (void).cxx_destruct;	// IMP=0x002000000009e586
...
- (_Bool)eligibleForContinuationKeyAuthentication;	// IMP=0x001000000009e409
@property(readonly, nonatomic) NSString *passwordResetToken;
@property(readonly, nonatomic) NSString *continuationToken;
- (void)clearContinuationTokenIfSupported;	// IMP=0x001000000009df1a
- (void)_addExperimentalFeaturesInfoToClientProvidedData:(id)arg1;	// IMP=0x001000000009dd8a
- (void)authenticationParametersWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000009c389
@property(readonly, nonatomic, getter=isContextSecretValidForSRP) _Bool contextSecretValidForSRP;
- (id)initWithContext:(id)arg1;	// IMP=0x001000000009c2db
