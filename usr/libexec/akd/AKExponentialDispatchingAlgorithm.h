...
- (void)_decrementQueueSize;	// IMP=0x001000000001a652
- (_Bool)_incrementQueueSize;	// IMP=0x001000000001a631
- (void)_incrementCounter;	// IMP=0x001000000001a61a
- (id);	// IMP=0x001000000001a595
- (id)nextCalculation;	// IMP=0x001000000001a3f7
- (id)initWithBase:(double)arg1 maxQueueSize:(unsigned long long)arg2;	// IMP=0x001000000001a3ab
