...
- (void).cxx_destruct;	// IMP=0x002000000001ae18
...
- (id)itemAttributes;	// IMP=0x001000000001ad2e
- (id)initWithAttributes:(id)arg1;	// IMP=0x001000000001ac72
- (id)initWithDescriptor:(id)arg1 value:(id)arg2;	// IMP=0x001000000001abd9
