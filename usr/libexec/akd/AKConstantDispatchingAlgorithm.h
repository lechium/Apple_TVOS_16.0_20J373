...
- (void)_decrementQueueSize;	// IMP=0x001000000001a8d2
- (_Bool)_incrementQueueSize;	// IMP=0x001000000001a8b1
@property(readonly, copy) NSString *debugDescription;
- (id)nextCalculation;	// IMP=0x001000000001a6c9
- (id)initWithDelay:(double)arg1 maxQueueSize:(unsigned long long)arg2;	// IMP=0x001000000001a67d
