...
- (void).cxx_destruct;	// IMP=0x002000000005c7df
...
- (id)value;	// IMP=0x001000000005c618
- (void)setValue:(id)arg1;	// IMP=0x001000000005c594
- (id)initWithMaxWait:(double)arg1 description:(id)arg2;	// IMP=0x001000000005c4a6
- (id)init;	// IMP=0x001000000005c48f
