...
- (void).cxx_destruct;	// IMP=0x0020000000063218
...
- (void)invalidate;	// IMP=0x001000000006319a
- (void)activate;	// IMP=0x001000000006314e
- (void)prepareWithController:(id)arg1 queue:(id)arg2;	// IMP=0x001000000006310e
- (void)dealloc;	// IMP=0x0010000000063095
- (id)initWithPresenceSID:(id)arg1;	// IMP=0x001000000006302a
