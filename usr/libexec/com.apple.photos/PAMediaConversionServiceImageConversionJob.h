...
- (void).cxx_destruct;	// IMP=0x0020000000010a04
...
- (void)dealloc;	// IMP=0x001000000001063b
...
- (long long)requestedOrCalculatedMaximumLongSideLength;	// IMP=0x001000000000f9b2
- (_Bool)_validateOutputSize;	// IMP=0x001000000000f823
- (_Bool)_validateOrientation;	// IMP=0x001000000000f6fa
- (_Bool)_validateMetadata;	// IMP=0x001000000000f572
- (_Bool)_validateSource;	// IMP=0x001000000000f341
- (void)_validate;	// IMP=0x001000000000f1d9
- (_Bool)validateSourceAndOptions;	// IMP=0x001000000000f1a0
- (id)initWithRequestIdentifier:(id)arg1 sourceResourceURLCollection:(id)arg2 outputFileType:(id)arg3;	// IMP=0x001000000000f043
