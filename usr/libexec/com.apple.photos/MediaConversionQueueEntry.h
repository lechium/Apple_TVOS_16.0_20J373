...
- (void).cxx_destruct;	// IMP=0x002000000000af1d
...
- (_Bool)allRequestsAreBackground;	// IMP=0x001000000000ad3e
- (_Bool)allRequestsAreOptional;	// IMP=0x001000000000ac9f
- (_Bool)allRequestsHaveRequestPriority:(long long)arg1;	// IMP=0x001000000000abf9
- (long long)compareProcessingOrderToEntry:(id)arg1;	// IMP=0x001000000000aa0a
@property(readonly) NSArray *clientRequestsSnapshot;
- (void)videoConversionTask:(id)arg1 didUpdateFractionCompleted:(double)arg2;	// IMP=0x001000000000a86b
- (id)requestIdentifiersForConnectionIdentifier:(id)arg1;	// IMP=0x001000000000a78d
- (id)anyDestinationURLCollection;	// IMP=0x001000000000a6ba
- (id)clientRequestForIdentifier:(id)arg1;	// IMP=0x001000000000a5a6
- (id)removeAndReturnClientRequestWithIdentifier:(id)arg1 remainingRequestCount:(long long *)arg2;	// IMP=0x001000000000a369
- (_Bool)clientRequestIsDuplicate:(id)arg1 identicalDestination:(_Bool *)arg2;	// IMP=0x001000000000a27c
- (void)didDequeueAndStartProcessingQueueEntry;	// IMP=0x001000000000a263
- (void)withLockEnumerateClientRequests:(CDUnknownBlockType)arg1;	// IMP=0x001000000000a1b7
- (void)addClientRequest:(id)arg1;	// IMP=0x001000000000a0d8
- (id)description;	// IMP=0x001000000000a007
- (void)dealloc;	// IMP=0x0010000000009ede
- (id)initWithIdentifier:(id)arg1 initialConversionOptions:(id)arg2;	// IMP=0x0010000000009daa
