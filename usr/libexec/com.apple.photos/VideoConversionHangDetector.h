...
- (void).cxx_destruct;	// IMP=0x00200000000142e7
...
- (void)updateCurrentProgress:(double)arg1;	// IMP=0x00100000000141e0
- (id)initWithThresholdTimeInterval:(double)arg1;	// IMP=0x0010000000014119
