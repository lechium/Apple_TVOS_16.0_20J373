...
+ (id)temporaryFileURLWithNameComponent:(id)arg1 pathExtension:(id)arg2;	// IMP=0x00200000000152c9
+ (_Bool)supportsDeduplication;	// IMP=0x00100000000152c1
- (void).cxx_destruct;	// IMP=0x0020000000015211
...
- (_Bool)requiresPhotosAdjustmentRendering;	// IMP=0x0010000000014f6c
- (_Bool)isMetadataTrackExtractionConversion;	// IMP=0x0010000000014ef7
- (_Bool)isPassthroughConversion;	// IMP=0x0010000000014e82
- (void)startProgressUpdateTimerAndMarkStartTime;	// IMP=0x0010000000014e7c
- (void)cancel;	// IMP=0x0010000000014e76
- (void)performConversion;	// IMP=0x0010000000014df9
- (void)didEnqueue;	// IMP=0x0010000000014d97
- (_Bool)wantsResultAsData;	// IMP=0x0010000000014d22
- (void)updateResultTracker;	// IMP=0x0010000000014bcf
- (void)callCompletionHandler;	// IMP=0x00100000000148d4
- (void)loadAsset;	// IMP=0x0010000000014747
@property(readonly) NSURL *outputMainResourceURL;
@property(readonly) NSURL *sourceMainResourceURL;
- (void)resolveSourceBookmarkDictionary:(id)arg1;	// IMP=0x0010000000014447
- (id)initWithSourceBookmarkDictionary:(id)arg1 outputURLCollection:(id)arg2 options:(id)arg3 requestTracker:(id)arg4;	// IMP=0x00100000000142f7
