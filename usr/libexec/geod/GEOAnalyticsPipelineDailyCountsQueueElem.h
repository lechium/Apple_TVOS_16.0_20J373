...
- (void).cxx_destruct;	// IMP=0x0020000000028b92
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000286dd
- (unsigned long long)hash;	// IMP=0x0010000000028662
- (id)copy;	// IMP=0x0010000000028603
- (id)initWithType:(int)arg1 usageString:(id)arg2 usageBool:(id)arg3 appId:(id)arg4 createTime:(id)arg5;	// IMP=0x0010000000028500
