...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000028cb9
- (unsigned long long)hash;	// IMP=0x0010000000028ca8
- (id)copy;	// IMP=0x0010000000028c63
- (id)initWithType:(unsigned long long)arg1 collectionId:(unsigned long long)arg2 createTime:(id)arg3;	// IMP=0x0010000000028bd4
