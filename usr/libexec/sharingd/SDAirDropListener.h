...
- (void).cxx_destruct;	// IMP=0x002000000008a243
...
- (void)dealloc;	// IMP=0x001000000008a152
- (void)stop;	// IMP=0x001000000008a103
- (void)start;	// IMP=0x001000000008a090
- (void)networkOperation:(id)arg1 event:(long long)arg2 withResults:(id)arg3;	// IMP=0x0010000000089d4e
- (id)init;	// IMP=0x0010000000089d00
