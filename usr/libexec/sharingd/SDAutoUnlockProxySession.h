...
- (void).cxx_destruct;	// IMP=0x002000000009763d
...
- (void)sendProxyTrigger;	// IMP=0x001000000009717c
- (void)notifyDelegateWithError:(id)arg1;	// IMP=0x00100000000970a8
- (void)handleFoundBLEDevice:(id)arg1;	// IMP=0x0010000000096e51
- (void)deviceConnected:(id)arg1;	// IMP=0x0010000000096ce1
- (id)results;	// IMP=0x0010000000096b81
- (void)removeObservers;	// IMP=0x0010000000096b2e
- (void)addObservers;	// IMP=0x0010000000096ac7
- (void)invalidate;	// IMP=0x00100000000969eb
- (void)_start;	// IMP=0x0010000000096939
- (void)start;	// IMP=0x00100000000968b2
- (id)initWithDevice:(id)arg1 sessionID:(id)arg2 bleDevice:(id)arg3;	// IMP=0x0010000000096820
