...
@interface SDAutoUnlockSessionManager : NSObject
{
    ...
    MISSING_TYPE *_useBTPipe;	// 23 = 0x17
...
+ (id)sharedManager;	// IMP=0x0020000000056bb3
- (void).cxx_destruct;	// IMP=0x002000000006b3b7
- (void)setRemotePeer:(id)arg1;	// IMP=0x001000000006b3a3
- (id)remotePeer;	// IMP=0x001000000006b396
...
- (void)loadPreviousSessionIDs;	// IMP=0x001000000006a872
- (_Bool)previousSessionExists:(id)arg1;	// IMP=0x001000000006a7d0
- (void)storePreviousSessionID:(id)arg1;	// IMP=0x001000000006a621
- (struct os_state_data_s *)dumpState;	// IMP=0x0010000000069fac
- (void)initializeCaptureBlock;	// IMP=0x0010000000069f0d
- (void)generateStateDump;	// IMP=0x0010000000069ecc
- (void)savePresentedWiFiError;	// IMP=0x0010000000069e58
- (void)savePresentedBluetoothError;	// IMP=0x0010000000069de4
- (void)loadPresentedWiFiError;	// IMP=0x0010000000069d7d
- (void)loadPresentedBluetoothError;	// IMP=0x0010000000069d16
- (_Bool)shouldShowErrorForWiFiEnabled:(_Bool)arg1;	// IMP=0x0010000000069ba1
- (_Bool)shouldShowErrorForBluetoothEnabled:(_Bool)arg1;	// IMP=0x0010000000069a2c
- (long long)errorCodeForBluetoothEnabled:(_Bool)arg1 wifiEnabled:(_Bool)arg2 faceIDEnabled:(_Bool)arg3;	// IMP=0x00100000000699fb
- (id)errorStringForBluetoothEnabled:(_Bool)arg1 wifiEnabled:(_Bool)arg2 faceIDEnabled:(_Bool)arg3;	// IMP=0x0010000000069988
- (void)handleWiFiPowerChanged:(id)arg1;	// IMP=0x0010000000069982
- (void)handleBluetoothPowerChanged:(id)arg1;	// IMP=0x001000000006986b
- (id)baseResultsDictionaryForError:(id)arg1;	// IMP=0x0010000000069628
- (void)createRadarForError:(id)arg1 devices:(id)arg2 rangingResults:(id)arg3;	// IMP=0x0010000000069622
- (void)cancelMagnetLinkTimer;	// IMP=0x00100000000693dc
- (void)btPipeConnectionChanged:(id)arg1;	// IMP=0x00100000000693d6
- (void)setUpMagnetLinkTimer;	// IMP=0x0010000000068fe9
- (_Bool)deviceCurrentlyUnlockedByWatch;	// IMP=0x0010000000068f79
- (void)releaseLanguageAssertionForAutoRelock;	// IMP=0x0010000000068ed4
- (void)grabLanguageAssertionForAutoRelock;	// IMP=0x0010000000068d78
- (void)handleAuthenticationSessionStarted;	// IMP=0x0010000000068bae
- (void)handlePairedDeviceLockStateChanged;	// IMP=0x0010000000068ba8
- (void)handleBioLockout;	// IMP=0x0010000000068953
- (void)beginKeyRegistrationIfNecessary;	// IMP=0x0010000000068667
- (void)handleDisplayStateChanged:(unsigned long long)arg1;	// IMP=0x00100000000685ab
- (void)handleNearbyStateChanged;	// IMP=0x0010000000068599
- (void)pipeConnectionChanged:(id)arg1;	// IMP=0x00100000000684d1
- (id)unlockedOnWristDate;	// IMP=0x00100000000684c9
- (void)wristStateChanged:(id)arg1;	// IMP=0x00100000000684c3
- (void)handleLockStateChanged;	// IMP=0x0010000000068363
- (void)handleUnexpectedDisablement:(id)arg1;	// IMP=0x0010000000068234
- (_Bool)shouldNotify;	// IMP=0x001000000006822c
- (void)upsellPhoneAutoUnlock;	// IMP=0x0010000000068226
- (void)upsellBehaviorChangedAfterUpgradeIfNecessary;	// IMP=0x0010000000067ee9
- (_Bool)behaviorChangedAfterUpgrade;	// IMP=0x0010000000067ee1
- (void)clearPhoneAutoUnlockNotification:(_Bool)arg1;	// IMP=0x0010000000067de8
- (void)screenLockUnlocked:(id)arg1;	// IMP=0x0010000000067de2
- (void)onqueue_keyBagLockStateChange:(id)arg1;	// IMP=0x0010000000067c66
- (void)keyBagLockStateChange:(id)arg1;	// IMP=0x0010000000067b98
- (void)handleRelockMessage;	// IMP=0x0010000000067b63
- (void)handleBLEDataReceivedNotification:(id)arg1;	// IMP=0x00100000000671a0
- (void)removeServiceClientForIdentifier:(id)arg1;	// IMP=0x0010000000067121
- (void)addServiceClientForIdentifier:(id)arg1;	// IMP=0x00100000000670a2
- (long long)idsMacCount;	// IMP=0x0010000000066ff7
- (_Bool)watchLockedAndOnWrist;	// IMP=0x0010000000066fef
- (_Bool)advertisingEnabled;	// IMP=0x0010000000066fe7
- (void)updateAdvertising;	// IMP=0x0010000000066cfe
- (_Bool)watchLockedOnWristForPeer:(id)arg1;	// IMP=0x0010000000066cd1
- (_Bool)proxyAdvertisementForPeer:(id)arg1;	// IMP=0x0010000000066ca4
- (_Bool)unlockEnabledForPeer:(id)arg1;	// IMP=0x0010000000066c77
- (void)handleScanTimerFired;	// IMP=0x0010000000066648
- (void)handleBLEScanTimerFired;	// IMP=0x00100000000665f1
- (void)invalidateScanTimer;	// IMP=0x001000000006651b
- (void)restartScanTimer:(unsigned long long)arg1;	// IMP=0x00100000000662e2
- (void)handleFoundPeer:(id)arg1;	// IMP=0x0010000000065dbe
- (void)invalidateScanner;	// IMP=0x0010000000065c49
- (void)startScannerWithWatchBluetoothIDs:(id)arg1 phoneBluetoothIDs:(id)arg2;	// IMP=0x00100000000651da
- (void)idsController:(id)arg1 didReceiveProtoData:(id)arg2 forType:(unsigned short)arg3 deviceID:(id)arg4;	// IMP=0x0010000000064cad
- (void)transport:(id)arg1 didReceiveKeyOriginatingRegistrationRequestWithSessionID:(id)arg2 deviceID:(id)arg3 requestData:(id)arg4;	// IMP=0x0010000000064b24
- (void)transport:(id)arg1 didReceiveRegistrationRequestWithSessionID:(id)arg2 deviceID:(id)arg3 requestData:(id)arg4;	// IMP=0x00100000000649d0
- (void)transport:(id)arg1 didReceivePairingRequestWithSessionID:(id)arg2 deviceID:(id)arg3 requestData:(id)arg4;	// IMP=0x00100000000648a3
- (void)transportDidChangeNearbyState:(id)arg1;	// IMP=0x00100000000647f8
- (void)transportDidChangeDevices:(id)arg1;	// IMP=0x0010000000064720
- (void)performRegistrationIfNecessaryForLockSession:(id)arg1 error:(id)arg2;	// IMP=0x001000000006457b
- (_Bool)isDisplayOff;	// IMP=0x0010000000064573
- (void)sessionDidSendInitialData:(id)arg1;	// IMP=0x001000000006456d
- (void)sessionDidReceiveKeyDeviceLocked:(id)arg1;	// IMP=0x00100000000644af
- (void)handleProxyConnectionStartedForSession:(id)arg1;	// IMP=0x00100000000640a3
- (void)handleLockConnectionStartedForSession:(id)arg1;	// IMP=0x0010000000063765
- (void)sessionDidStartConnection:(id)arg1;	// IMP=0x00100000000636f0
- (void)handleProxySessionCompleted:(id)arg1 error:(id)arg2;	// IMP=0x0010000000063445
- (void)handleLockSessionCompleted:(id)arg1 error:(id)arg2;	// IMP=0x0010000000062855
- (void)session:(id)arg1 didCompleteWithError:(id)arg2;	// IMP=0x001000000006185a
- (void)cancelParallelRegistrationSessionsForDeviceID:(id)arg1 newSessionID:(id)arg2;	// IMP=0x0010000000061646
- (void)registerRemotePeerIfNecessary;	// IMP=0x0010000000061640
- (void)initializeRemotePeer;	// IMP=0x0010000000061437
- (void)armDevicesWaitingForUnlock;	// IMP=0x0010000000061373
- (void)createRegistrationLockSessionWithDeviceID:(id)arg1 sessionID:(id)arg2 requestData:(id)arg3;	// IMP=0x00100000000610ce
- (void)createRegistrationKeySessionWithIdentifier:(id)arg1 deviceID:(id)arg2 requestData:(id)arg3 locallyGenerated:(_Bool)arg4;	// IMP=0x0010000000060e39
- (void)invalidateExistingSessionsForBLEDevice:(id)arg1 incomingSessionID:(id)arg2;	// IMP=0x00100000000609c1
- (void)cancelAllLockSessionsForScanTimeout;	// IMP=0x001000000006082d
- (void)clearAllKeysWithTokens;	// IMP=0x0010000000060789
- (void)cleanUpProxySessions;	// IMP=0x001000000006058b
- (void)updateStringForProxySession;	// IMP=0x001000000006030b
- (void)createProxySessionWithDeviceID:(id)arg1;	// IMP=0x001000000006004e
- (void)createKeySessionWithBLEDevice:(id)arg1 sessionID:(id)arg2 wrapper:(id)arg3 useEncryption:(_Bool)arg4;	// IMP=0x001000000005fc37
- (void)createLockSessionWithWatchDevice:(id)arg1;	// IMP=0x001000000005f6ea
- (void)createPairingKeySessionWithIdentifier:(id)arg1 deviceID:(id)arg2 requestData:(id)arg3;	// IMP=0x001000000005f472
- (void)createPairingLockSessionWithDevice:(id)arg1 passcode:(id)arg2;	// IMP=0x001000000005f037
- (void)disableKeyPairingForDeviceID:(id)arg1;	// IMP=0x001000000005ee97
- (void)handleDisableMessageForLock:(id)arg1 fromDeviceID:(id)arg2;	// IMP=0x001000000005ecbb
- (void)handleDisableMessageForKey:(id)arg1 fromDeviceID:(id)arg2;	// IMP=0x001000000005e899
- (void)transport:(id)arg1 didReceiveDisableMessage:(id)arg2 fromDeviceID:(id)arg3;	// IMP=0x001000000005e644
- (void)sendDisableMessageToDeviceID:(id)arg1 pairingID:(id)arg2;	// IMP=0x001000000005e3b9
- (_Bool)disablePairingForDeviceID:(id)arg1 pairingID:(id)arg2;	// IMP=0x001000000005e294
- (void)authPromptInfoWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x001000000005e203
- (id)stringForState:(long long)arg1;	// IMP=0x001000000005e1e4
- (void)autoUnlockStateWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x001000000005e029
- (void)requestRelock;	// IMP=0x001000000005debc
- (void)generateAppIconImageWithOptions:(unsigned int)arg1;	// IMP=0x001000000005deb6
- (void)decrementAttemptCount;	// IMP=0x001000000005de1b
- (void)incrementAttemptCount;	// IMP=0x001000000005dc72
- (void)logUnintentionalAutoUnlockAttempt:(unsigned long long)arg1;	// IMP=0x001000000005da2e
- (void)cancelAttemptsForDeviceUnlocked;	// IMP=0x001000000005d83d
- (void)cancelAutoUnlockWithCancelReason:(long long)arg1 usingTool:(_Bool)arg2;	// IMP=0x001000000005d837
- (void)cancelAutoUnlock;	// IMP=0x001000000005d81c
- (void)completeSuccessfulAttempt;	// IMP=0x001000000005d816
- (void)invalidateAttempt;	// IMP=0x001000000005d517
- (void)donateDeviceUnlockedWithMask:(_Bool)arg1;	// IMP=0x001000000005d457
- (void)completeAutoUnlockWithNotification:(_Bool)arg1;	// IMP=0x001000000005ccaf
- (void)attemptAutoUnlockWithoutNotifyingWatch;	// IMP=0x001000000005cc20
- (void)attemptAutoUnlockForSiri;	// IMP=0x001000000005cb91
- (void)prewarmAutoUnlock;	// IMP=0x001000000005ca77
- (void)attemptAutoUnlock;	// IMP=0x001000000005b326
- (void)failedAttemptBeforeStarting:(id)arg1 metricErrorString:(id)arg2;	// IMP=0x001000000005aff6
- (void)dropEscrowRecordsIfNecessary;	// IMP=0x001000000005aff0
- (void)generateAttemptForType:(long long)arg1;	// IMP=0x001000000005a81f
- (void)attemptAutoUnlockForType:(long long)arg1 externalACMContext:(id)arg2 preventRadarNotification:(_Bool)arg3 bundlePath:(id)arg4 appName:(id)arg5 navBarTitle:(id)arg6 reply:(CDUnknownBlockType)arg7;	// IMP=0x001000000005a57f
- (void)attemptAutoUnlockForType:(long long)arg1 preventRadarNotification:(_Bool)arg2;	// IMP=0x001000000005a54c
- (void)attemptAutoUnlockForType:(long long)arg1;	// IMP=0x001000000005a535
- (void)disableAutoUnlockForDevice:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000005a2b3
- (void)disableAutoUnlockForAllDevices;	// IMP=0x001000000005a10c
- (void)cancelEnablingAutoUnlockForDeviceID:(id)arg1;	// IMP=0x0010000000059f41
- (void);	// IMP=0x0010000000059e3f
- (void)cancelEnablingAllDevices;	// IMP=0x0010000000059c11
- (void)enableAutoUnlockWithDevice:(id)arg1 passcode:(id)arg2;	// IMP=0x0010000000059960
- (void)eligibleDevicesRequestFromBundleID:(id)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000005946c
- (_Bool)phoneAutoUnlockSupportedByDevice:(id)arg1;	// IMP=0x0010000000059380
- (void)eligibleDevicesFilterCompatibleDevices:(id)arg1;	// IMP=0x0010000000059114
- (void)repairCloudPairing;	// IMP=0x0010000000059038
- (void)notifyObserversOfUnlockFailureWithResults:(id)arg1 error:(id)arg2;	// IMP=0x0010000000058ce5
- (void)notifyObserversOfUnlockCompletionWithDevice:(id)arg1;	// IMP=0x0010000000058a1a
- (void)notifyObserverOfAttemptBeganWithDevice:(id)arg1;	// IMP=0x001000000005876e
- (void)notifyObserverOfFailedToEnableDevice:(id)arg1 error:(id)arg2;	// IMP=0x001000000005848f
- (void)notifyObserverOfEnabledDevice:(id)arg1;	// IMP=0x00100000000581e3
- (void)notifyObserverOfKeyDeviceLockWithDevice:(id)arg1;	// IMP=0x0010000000057f37
- (void)unregisterObserver:(id)arg1;	// IMP=0x0010000000057db1
- (void)registerObserver:(id)arg1;	// IMP=0x0010000000057c2b
- (void)addNotificationsObservers;	// IMP=0x0010000000057ab2
- (void)initializeAttemptState;	// IMP=0x00100000000576af
- (void)onqueue_start;	// IMP=0x00100000000571fc
- (void)start;	// IMP=0x0010000000057175
- (id)initWithTransport:(id)arg1 magnetTransport:(id)arg2 keyManager:(id)arg3;	// IMP=0x0010000000056cb8
- (id)init;	// IMP=0x0010000000056c08
