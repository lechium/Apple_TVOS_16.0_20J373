...
- (void).cxx_destruct;	// IMP=0x00200000000740dd
...
- (_Bool)stateIsNearby;	// IMP=0x0010000000073cf4
- (_Bool)stateIsMedium;	// IMP=0x0010000000073cc3
- (_Bool)stateIsClose;	// IMP=0x0010000000073cb1
- (void)resetTicks;	// IMP=0x0010000000073b1a
- (id);	// IMP=0x0010000000073a9d
@property(readonly, copy, nonatomic) NSString *effectiveID;
@property(readonly, nonatomic) _Bool isReady;
- (_Bool)_canTransition:(int)arg1;	// IMP=0x001000000007382a
- (_Bool)canTransition:(int)arg1;	// IMP=0x0010000000073734
- (id)description;	// IMP=0x0010000000073428
