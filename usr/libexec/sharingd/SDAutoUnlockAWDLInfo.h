...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000098d53
- (unsigned long long)hash;	// IMP=0x0010000000098ad6
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000098823
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000098665
- (void)copyTo:(id)arg1;	// IMP=0x00100000000984f8
- (void)writeTo:(id)arg1;	// IMP=0x0010000000098371
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000098364
- (id)dictionaryRepresentation;	// IMP=0x00100000000979be
- (id)description;	// IMP=0x001000000009790f
