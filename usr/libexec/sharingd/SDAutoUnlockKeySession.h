...
- (void).cxx_destruct;	// IMP=0x00200000000151ec
...
- (void)logAutoUnlockEnd;	// IMP=0x0010000000014d2a
- (void)logAutoUnlockStart;	// IMP=0x0010000000014d24
- (void)invalidateAssertionTimer;	// IMP=0x0010000000014c4e
- (void)restartAssertionTimer;	// IMP=0x0010000000014a3f
- (void)releaseIdleSleepAssertion;	// IMP=0x00100000000149a0
- (void)declareSystemActivityAssertion;	// IMP=0x001000000001470c
- (void)sendConfirmationACK;	// IMP=0x00100000000144ea
- (void)sendSessionAuthToken:(id)arg1 error:(id)arg2;	// IMP=0x0010000000014082
- (void)sendKeyExchangeRequestWithData:(id)arg1 error:(id)arg2;	// IMP=0x0010000000013d84
- (void)sendAuthPromptResponseWithData:(id)arg1 error:(id)arg2;	// IMP=0x0010000000013a89
- (void)sendAWDLInfoWithKeyData:(id)arg1 error:(id)arg2;	// IMP=0x0010000000013479
- (void)handleCleanUpAWDL;	// IMP=0x00100000000133eb
- (void)handleUnlockConfirmation:(id)arg1;	// IMP=0x0010000000012f9d
- (void)createAuthTokenIfReady;	// IMP=0x0010000000012797
- (void)handleSessionKeyExchangeResponse:(id)arg1;	// IMP=0x0010000000012570
- (void)handleAuthPromptImageData:(id)arg1;	// IMP=0x00100000000122a5
- (void)handleAuthPromptRequest:(id)arg1;	// IMP=0x0010000000011db5
- (_Bool)handleAWDLInfo:(id)arg1;	// IMP=0x00100000000117f8
- (void)handleMessageWithWrapper:(id)arg1;	// IMP=0x0010000000011078
- (void)nq_handleWiFiRequestInvalidated;	// IMP=0x0010000000010fdb
- (void)nq_handleWiFiRequestStartedWithStartAWDLHandler:(CDUnknownBlockType)arg1;	// IMP=0x0010000000010f23
- (void)nq_awdlNetworkStarted;	// IMP=0x0010000000010d43
- (void)createWiFiRequest;	// IMP=0x0010000000010595
- (void)alertOfUnlock;	// IMP=0x0010000000010479
- (void)promptForApproval;	// IMP=0x0010000000010473
- (void)systemIsActive:(id)arg1;	// IMP=0x00100000000102bf
- (void)deviceDisconnected:(id)arg1;	// IMP=0x0010000000010068
- (void)removeObservers;	// IMP=0x0010000000010015
- (void)addObservers;	// IMP=0x001000000000ff18
- (void)postBeganUnlockingNotification;	// IMP=0x001000000000fe85
- (void)beginAKSSession;	// IMP=0x001000000000fe7f
- (void)notifyDelegateWithError:(id)arg1;	// IMP=0x001000000000fcbb
- (void)keyCanUnlock:(CDUnknownBlockType)arg1;	// IMP=0x001000000000fcb5
- (_Bool)keyInState;	// IMP=0x001000000000fb15
- (void)_invalidate;	// IMP=0x001000000000f882
- (void)invalidateOnQueue;	// IMP=0x001000000000f843
- (void)invalidate;	// IMP=0x001000000000f7c2
- (id)initWithBLEDevice:(id)arg1 sessionID:(id)arg2;	// IMP=0x001000000000f51c
