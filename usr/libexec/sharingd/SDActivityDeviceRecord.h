...
- (void).cxx_destruct;	// IMP=0x002000000001d6d1
...
- (void)updateWithRawAdvertisementData:(id)arg1 receivedViaScanning:(_Bool)arg2 isReplay:(_Bool)arg3 newAdvertisementHandler:(CDUnknownBlockType)arg4;	// IMP=0x001000000001c62d
- (void)updateWithRawAdvertisementData:(id)arg1 receivedViaScanning:(_Bool)arg2 newAdvertisementHandler:(CDUnknownBlockType)arg3;	// IMP=0x001000000001c615
- (id)description;	// IMP=0x001000000001c533
- (id)initWithDevice:(id)arg1;	// IMP=0x001000000001c4a1
