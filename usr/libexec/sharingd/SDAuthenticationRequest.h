...
- (void).cxx_destruct;	// IMP=0x002000000018ce55
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000018cccd
- (unsigned long long)hash;	// IMP=0x001000000018cb08
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000018c972
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000018c84c
- (void)copyTo:(id)arg1;	// IMP=0x001000000018c765
- (void)writeTo:(id)arg1;	// IMP=0x001000000018c67d
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000018c670
- (id)dictionaryRepresentation;	// IMP=0x001000000018c159
- (id)description;	// IMP=0x001000000018c0aa
