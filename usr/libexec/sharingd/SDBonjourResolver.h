...
- (void).cxx_destruct;	// IMP=0x00200000001923c4
...
- (struct _DNSServiceRef_t *);	// IMP=0x001000000019238a
...
- (void)cancel;	// IMP=0x001000000019226f
- (void)resolve;	// IMP=0x0010000000191de2
- (void)parseResults:(const char *)arg1 port:(unsigned short)arg2 txtLen:(unsigned short)arg3 txtRecord:(const char *)arg4 interface:(unsigned int)arg5;	// IMP=0x0010000000191a32
- (void)notifyClient:(int)arg1;	// IMP=0x00100000001919de
- (void)dealloc;	// IMP=0x00100000001919a0
- (id)initWithName:(id)arg1 type:(id)arg2 domain:(id)arg3 path:(id)arg4 timeout:(_Bool)arg5;	// IMP=0x001000000019186c
