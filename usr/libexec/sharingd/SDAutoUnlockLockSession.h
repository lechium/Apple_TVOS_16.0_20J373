...
@class MISSING_TYPE, NSArray, NSData, NSDate, NSObject, NSString, NSUUID, SDAutoUnlockIconTransferStore, SDUnlockSessionAuthToken, SFAutoUnlockDevice;
...
@interface SDAutoUnlockLockSession
{
    ...
    MISSING_TYPE *_peerFoundInterval;	// 352 = 0x160
...
- (void).cxx_destruct;	// IMP=0x002000000019daba
...
- (void)sendUnlockConfirmation:(_Bool)arg1 withError:(id)arg2 suppressNotification:(_Bool)arg3;	// IMP=0x001000000019ca0f
- (void)sendUnlockConfirmation:(_Bool)arg1 withError:(id)arg2;	// IMP=0x001000000019c9fa
- (void)completeAttemptPostNotification:(_Bool)arg1;	// IMP=0x001000000019c953
- (void)sendKeyExchangeResponseWithData:(id)arg1;	// IMP=0x001000000019c6a1
- (void)sendAuthPromptImageDataIfReady:(id)arg1;	// IMP=0x001000000019be43
- (void)sendAuthPromptRequestWithImageHash:(id)arg1 appName:(id)arg2;	// IMP=0x001000000019ba03
- (void)sendAWDLInfoData:(id)arg1 type:(unsigned short)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x001000000019b668
- (void)consumeAuthTokenIfReady;	// IMP=0x001000000019af76
- (void)startAWDL;	// IMP=0x001000000019a542
- (void)handleConfirmationACK;	// IMP=0x001000000019a2cd
- (void)handleSessionAuthToken:(id)arg1;	// IMP=0x0010000000199df9
- (void)handleSessionKeyExchangeRequest:(id)arg1;	// IMP=0x00100000001994e5
- (void)handleAuthPromptResponse:(id)arg1;	// IMP=0x001000000019918f
- (void)handleAWDLInfo:(id)arg1;	// IMP=0x0010000000198a9c
- (void)handleMessageWithWrapper:(id)arg1;	// IMP=0x0010000000198647
- (void)notifyDelegateWithError:(id)arg1;	// IMP=0x0010000000198401
- (void)handleWiFiRequestInvalidated;	// IMP=0x00100000001983a5
- (void)handleRangingStarted;	// IMP=0x00100000001982a1
- (void)handlePeerFound:(_Bool)arg1;	// IMP=0x00100000001981e2
- (void)handleAWDLUp;	// IMP=0x0010000000198023
- (void)handlePeerOutOfRange;	// IMP=0x0010000000197d39
- (void)handlePeerInRange;	// IMP=0x0010000000197a51
- (_Bool)peerInRange:(id)arg1;	// IMP=0x00100000001978b3
- (void)handleRangingResults:(id)arg1 errorCode:(long long)arg2;	// IMP=0x001000000019737f
- (void)invalidateConfirmationTimer;	// IMP=0x00100000001972a9
- (void)restartConfirmationTimer:(unsigned long long)arg1 error:(id)arg2;	// IMP=0x0010000000197004
- (void)handleTimerFired;	// IMP=0x0010000000196a9c
- (void)invalidateTimerIfReady;	// IMP=0x0010000000196a51
- (id)aksPeerAvailable;	// IMP=0x001000000019686d
- (void)deviceConnected:(id)arg1;	// IMP=0x00100000001964a4
- (_Bool)handleFoundBLEDevice:(id)arg1 available:(_Bool)arg2 lockedOnWrist:(_Bool)arg3;	// IMP=0x00100000001961cb
- (_Bool)handleFoundBLEDevice:(id)arg1;	// IMP=0x001000000019616a
- (void)connectionActivated;	// IMP=0x0010000000195e93
- (void)updateImageData:(id)arg1 imageHash:(id)arg2;	// IMP=0x0010000000195783
- (id)getAppName;	// IMP=0x001000000019577b
@property(readonly, nonatomic) _Bool usingProxy;
- (id)hintToken;	// IMP=0x001000000019564d
- (_Bool)isAcceptor;	// IMP=0x0010000000195645
- (id)attemptResults;	// IMP=0x0010000000194a01
- (void)logResults;	// IMP=0x0010000000193ba1
- (void)displayConfigChanged:(id)arg1;	// IMP=0x0010000000193b05
- (void)clamshellStateChanged:(id)arg1;	// IMP=0x0010000000193a69
- (void)removeObservers;	// IMP=0x0010000000193a16
- (void)addObservers;	// IMP=0x001000000019391c
- (void)handleDecryptionFailure:(long long)arg1;	// IMP=0x00100000001937cb
- (void)_handleCanceledAfterSuccess;	// IMP=0x00100000001936c4
- (void)handleCanceledAfterSuccess;	// IMP=0x001000000019363d
- (void)lockKeyBagIfNeeded;	// IMP=0x0010000000193560
- (void)cancelWiFiRequest;	// IMP=0x001000000019336e
- (void)_cancel;	// IMP=0x0010000000193023
- (void)cancel;	// IMP=0x0010000000192f9c
- (void)tearDownAWDLIfNecessary;	// IMP=0x0010000000192dc8
- (void)completeAttemptIfNecessary;	// IMP=0x0010000000192c06
- (void)invalidateNoDisconnect;	// IMP=0x0010000000192bd7
- (void)invalidate;	// IMP=0x00100000001929b1
- (id)initWithAutoUnlockDevice:(id)arg1 sessionID:(id)arg2 bleDevice:(id)arg3;	// IMP=0x00100000001925b0
