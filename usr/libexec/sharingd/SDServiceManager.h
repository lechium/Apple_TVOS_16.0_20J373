...
- (void).cxx_destruct;	// IMP=0x002000000012ddfb
...
- (void)companionStreamClosedStreams:(id)arg1;	// IMP=0x001000000012dd22
- (void)manager:(id)arg1 connectedToService:(id)arg2 withFileHandle:(id)arg3 acceptHandler:(CDUnknownBlockType)arg4;	// IMP=0x001000000012daf6
- (void)disableService:(id)arg1;	// IMP=0x001000000012da6c
- (void)enableService:(id)arg1;	// IMP=0x001000000012d9ee
- (id)streamHandlerForService:(id)arg1;	// IMP=0x001000000012d98b
- (void)stop;	// IMP=0x001000000012d71c
- (void)start;	// IMP=0x001000000012d6c9
- (id)initWithClientProxy:(id)arg1 withIdentifier:(id)arg2;	// IMP=0x001000000012d5d2
