...
- (void).cxx_destruct;	// IMP=0x00200000001320b6
...
- (id)peerListFromAWDLInfo:(id)arg1;	// IMP=0x0010000000131895
- (void)sendData:(id)arg1 bleDevice:(id)arg2 direct:(_Bool)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00100000001312cc
- (void)sendData:(id)arg1 bleDevice:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000001312b4
- (void)sendAWDLInfo:(_Bool)arg1;	// IMP=0x0010000000130bd6
- (void)sendAWDLInfo;	// IMP=0x0010000000130bc2
- (void)sendData:(id)arg1 type:(unsigned short)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0010000000130b25
- (void)sendData:(id)arg1 type:(unsigned short)arg2 errorHandler:(CDUnknownBlockType)arg3;	// IMP=0x0010000000130a39
- (void)sendAWDLInfoData:(id)arg1 type:(unsigned short)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0010000000130a27
- (void)_start;	// IMP=0x0010000000130a15
- (void)start;	// IMP=0x001000000013098e
- (id)getAppName;	// IMP=0x0010000000130986
- (void)handleMessageWithWrapper:(id)arg1;	// IMP=0x0010000000130980
- (void)connectionActivated;	// IMP=0x001000000013097a
- (void)invalidate;	// IMP=0x0010000000130881
- (id)initWithDevice:(id)arg1 sessionID:(id)arg2 bleDevice:(id)arg3;	// IMP=0x00100000001307e5
