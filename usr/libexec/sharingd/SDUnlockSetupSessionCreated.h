...
- (void).cxx_destruct;	// IMP=0x00200000001338b8
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000133689
- (unsigned long long)hash;	// IMP=0x0010000000133532
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000133300
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000133169
- (void)copyTo:(id)arg1;	// IMP=0x0010000000133019
- (void)writeTo:(id)arg1;	// IMP=0x0010000000132eb5
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000132ea8
- (id)dictionaryRepresentation;	// IMP=0x00100000001325cf
- (id)description;	// IMP=0x0010000000132520
...
- (_Bool)hasErrorCode;	// IMP=0x00100000001323cf
- (void)setHasErrorCode:(_Bool)arg1;	// IMP=0x00100000001323b7
