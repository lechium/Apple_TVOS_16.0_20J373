...
- (void).cxx_destruct;	// IMP=0x00200000000d7d59
...
- (void)stop;	// IMP=0x00100000000d7cab
- (int)start;	// IMP=0x00100000000d7c00
- (void)eject;	// IMP=0x00100000000d79ed
- (void)ejectMountPoints:(id)arg1 useAssistant:(_Bool)arg2;	// IMP=0x00100000000d79e7
- (void)notifyClientAboutEject:(int)arg1;	// IMP=0x00100000000d787d
- (void)dealloc;	// IMP=0x00100000000d7843
- (id)initWithNode:(struct __SFNode *)arg1;	// IMP=0x00100000000d77c8
