...
- (void).cxx_destruct;	// IMP=0x002000000019182a
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000191708
- (unsigned long long)hash;	// IMP=0x0010000000191671
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000191541
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000019145a
- (void)copyTo:(id)arg1;	// IMP=0x00100000001913b7
- (void)writeTo:(id)arg1;	// IMP=0x0010000000191319
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000019130c
- (id)dictionaryRepresentation;	// IMP=0x0010000000190f9b
- (id)description;	// IMP=0x0010000000190eec
