...
+ (id)contextWithBundleID:(id)arg1 transactionID:(unsigned long long)arg2;	// IMP=0x0040000000062c7d
+ (id)contextWithBundleID:(id)arg1;	// IMP=0x0010000000062c19
- (void).cxx_destruct;	// IMP=0x0020000000062ccd
...
- (id)init;	// IMP=0x0010000000062b77
