...
+ (id)_titleForProtectionSpace:(id)arg1;	// IMP=0x0040000000031b8b
+ (id)_messageForProtectionSpace:(id)arg1;	// IMP=0x0010000000031952
...
- (id)initWithAuthenticationChallenge:(id)arg1;	// IMP=0x0010000000031816
