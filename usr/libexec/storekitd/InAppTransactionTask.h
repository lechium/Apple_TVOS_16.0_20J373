...
@interface InAppTransactionTask
{
    ...
    NSString *_serverCorrelationIdentifier;	// 208 = 0xd0
    CDStruct_4c969caf _auditToken;	// 216 = 0xd8
}

- (void).cxx_destruct;	// IMP=0x002000000001e1cf
...
- (void)_cacheLegacyTransaction;	// IMP=0x001000000001d9e6
- (id)_processPurchaseResult:(id)arg1 authorizationResult:(id)arg2;	// IMP=0x001000000001cb1c
- (void)purchase:(id)arg1 handleEngagementRequest:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x001000000001c836
- (void)purchase:(id)arg1 handleDialogRequest:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x001000000001c544
- (void)purchase:(id)arg1 handleAuthenticateRequest:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x001000000001c252
- (id)_authenticateWithAccountInfo:(id)arg1 error:(id *)arg2;	// IMP=0x001000000001bc15
- (void)clearTransactionCache;	// IMP=0x001000000001bbc3
- (id)_buyParams;	// IMP=0x001000000001aaf2
- (void)main;	// IMP=0x0010000000018ca1
- (id)initWithProductIdentifier:(id)arg1 quantity:(unsigned long long)arg2 client:(id)arg3 apiVersion:(long long)arg4;	// IMP=0x0010000000018b9d
- (id)initWithBuyParams:(id)arg1 client:(id)arg2 apiVersion:(long long)arg3;	// IMP=0x0010000000018a9c
