...
+ (id)taskInfoForTask:(id)arg1;	// IMP=0x004000000008b1e5
+ (void)removeTaskInfo:(id)arg1;	// IMP=0x001000000008b161
+ (void)removeAllTaskInfo;	// IMP=0x001000000008b126
+ (void)recordTaskInfo:(id)arg1 forTask:(id)arg2;	// IMP=0x001000000008afbe
+ (void)exchangeTaskForTaskInfo:(id)arg1 withTask:(id)arg2;	// IMP=0x001000000008afac
+ (id)newTaskInfoForTask:(id)arg1;	// IMP=0x001000000008aead
- (void).cxx_destruct;	// IMP=0x002000000008b457
...
- (id)initWithTask:(id)arg1;	// IMP=0x001000000008af18
