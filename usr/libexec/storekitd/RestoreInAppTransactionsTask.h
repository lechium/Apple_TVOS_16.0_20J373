...
- (void).cxx_destruct;	// IMP=0x002000000004cd8e
...
- (id)_authenticateAccount:(id)arg1 error:(id *)arg2;	// IMP=0x001000000004c734
- (id)_runRequestWithError:(id *)arg1;	// IMP=0x001000000004c3e2
- (void)main;	// IMP=0x001000000004beb9
- (id)initWithClient:(id)arg1;	// IMP=0x001000000004be1a
