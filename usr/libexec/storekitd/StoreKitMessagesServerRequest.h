...
- (void).cxx_destruct;	// IMP=0x002000000000465d
...
- (void)startWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0010000000003e80
- (id)initWithClient:(id)arg1 status:(id)arg2;	// IMP=0x0010000000003de7
