...
- (void).cxx_destruct;	// IMP=0x002000000006f392
...
- (int)_encryptDatabase:(struct sqlite3 *)arg1;	// IMP=0x001000000006f0f5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000006f050
- (void)setCacheSizeWithNumberOfKilobytes:(long long)arg1;	// IMP=0x001000000006f03b
- (void)setCacheSizeWithNumberOfDatabasePages:(long long)arg1;	// IMP=0x001000000006f029
- (int)applyToDatabase:(struct sqlite3 *)arg1;	// IMP=0x001000000006ef5a
- (id)initWithDatabasePath:(id)arg1;	// IMP=0x001000000006eecd
