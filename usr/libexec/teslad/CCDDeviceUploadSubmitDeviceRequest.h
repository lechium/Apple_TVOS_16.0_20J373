...
- (void).cxx_destruct;	// IMP=0x0020000000003839
...
- (id)_deviceDetails;	// IMP=0x00100000000034fd
- (id)requestBody;	// IMP=0x001000000000319b
- (id)endpointPath;	// IMP=0x0010000000003187
- (id)httpMethod;	// IMP=0x001000000000317a
- (long long)requestType;	// IMP=0x001000000000316f
