...
- (void).cxx_destruct;	// IMP=0x00200000000a3d4a
...
- (void)softFailItem:(id)arg1 withError:(id)arg2;	// IMP=0x00100000000a3c6d
- (void)itemSucceeded:(id)arg1 storeItem:(id)arg2;	// IMP=0x00100000000a397a
- (void)hardFailItem:(id)arg1 withError:(id)arg2;	// IMP=0x00100000000a38ed
- (id)initWithItems:(id)arg1 account:(id)arg2;	// IMP=0x00100000000a348a
