...
+ (void)enumerateApplicationsOfType:(unsigned long long)arg1 usingBlock:(CDUnknownBlockType)arg2;	// IMP=0x00400000001c79ff
+ (id)proxyForBundleURL:(id)arg1;	// IMP=0x00100000001c647d
+ (id)proxyForItemID:(id)arg1;	// IMP=0x00100000001c626d
+ (id)proxyForBundleID:(id)arg1;	// IMP=0x00100000001c6220
+ (id)proxyForBundle:(id)arg1;	// IMP=0x00100000001c61d3
+ (id)proxyMatchingBundleID:(id)arg1 orItemID:(id)arg2;	// IMP=0x00100000001c5b7c
- (void).cxx_destruct;	// IMP=0x00200000001c8035
...
- (long long);	// IMP=0x00100000001c7f08
...
- (id)description;	// IMP=0x00100000001c7cf1
- (id)validLocationProxy;	// IMP=0x00100000001c7ce8
...
- (id)_initWithLSApplicationRecord:(id)arg1;	// IMP=0x00100000001c6d2e
- (id)initWithBundleURL:(id)arg1;	// IMP=0x00100000001c6950
- (id)initWithBundlePath:(id)arg1;	// IMP=0x00100000001c68f6
- (id)initWithBundleID:(id)arg1;	// IMP=0x00100000001c66db
- (id)initWithBundle:(id)arg1;	// IMP=0x00100000001c6685
- (id)initWithItemID:(id)arg1 error:(id *)arg2;	// IMP=0x00100000001c6039
- (id)initWithBundleURL:(id)arg1 allowPlaceholder:(_Bool)arg2 error:(id *)arg3;	// IMP=0x00100000001c5e9e
- (id)initWithBundleID:(id)arg1 allowPlaceholder:(_Bool)arg2 error:(id *)arg3;	// IMP=0x00100000001c5d12
