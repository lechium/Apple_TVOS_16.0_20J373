...
- (void).cxx_destruct;	// IMP=0x0020000000050216
- (void)main;	// IMP=0x001000000004b4c8
- (void)URLSession:(id)arg1 task:(id)arg2 didReceiveChallenge:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x001000000004acf7
