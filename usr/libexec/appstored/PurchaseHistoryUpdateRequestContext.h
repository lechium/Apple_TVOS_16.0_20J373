...
+ (id)newContextWithRevision:(id)arg1 forAccountID:(long long)arg2 requestingAccount:(id)arg3 client:(id)arg4 purchaseHistoryContext:(unsigned long long)arg5;	// IMP=0x0040000000188311
- (void).cxx_destruct;	// IMP=0x00200000001884cd
...
- (id)_initWithRevision:(id)arg1 forAccountID:(long long)arg2 requestingAccount:(id)arg3 client:(id)arg4 purchaseHistoryContext:(unsigned long long)arg5;	// IMP=0x00100000001883b2
