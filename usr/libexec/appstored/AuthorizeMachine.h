...
- (void).cxx_destruct;	// IMP=0x00200000001d004a
...
- (id)_checkRequestThrottle;	// IMP=0x00100000001cfe36
- (id)_buildRequestTask;	// IMP=0x00100000001cfcab
- (id)_buildRequestParametersWithError:(id *)arg1;	// IMP=0x00100000001cfc50
- (id)_buildRequest;	// IMP=0x00100000001cf99f
- (void)performAuthorizationWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00100000001cf8d2
- (id)performAuthorization;	// IMP=0x00100000001cf49e
- (id)initWithAccount:(id)arg1 authorizeReason:(long long)arg2;	// IMP=0x00100000001cf43e
- (id)init;	// IMP=0x00100000001cf33b
