...
+ (id)newContextWithItems:(id)arg1 account:(id)arg2 client:(id)arg3;	// IMP=0x0040000000077f68
- (void).cxx_destruct;	// IMP=0x00200000000780f9
...
- (id)_initWithItems:(id)arg1 account:(id)arg2 client:(id)arg3;	// IMP=0x0010000000077ff9
