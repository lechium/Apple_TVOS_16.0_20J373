...
- (void).cxx_destruct;	// IMP=0x0020000000191d60
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000191a11
- (unsigned long long)hash;	// IMP=0x0010000000191879
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000019159f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000019136a
- (void)copyTo:(id)arg1;	// IMP=0x00100000001911ac
- (void)writeTo:(id)arg1;	// IMP=0x0010000000190ff9
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000190fec
- (id)dictionaryRepresentation;	// IMP=0x00100000001906ff
- (id)description;	// IMP=0x0010000000190650
@property(nonatomic) _Bool hasBatteryPercentage;
@property(readonly, nonatomic) _Bool hasDisk;
- (int)StringAsConnection:(id)arg1;	// IMP=0x0010000000190547
- (id)connectionAsString:(int)arg1;	// IMP=0x00100000001904fe
...
- (int)StringAsDeviceFamily:(id)arg1;	// IMP=0x00100000001902d4
- (id)deviceFamilyAsString:(int)arg1;	// IMP=0x001000000019028b
@property(nonatomic) _Bool hasDeviceFamily;
@property(nonatomic) int deviceFamily; // @synthesize deviceFamily=_deviceFamily;
- (int)StringAsDevicePlatform:(id)arg1;	// IMP=0x0010000000190172
- (id)devicePlatformAsString:(int)arg1;	// IMP=0x0010000000190129
