...
+ (int)_fairplayStatusForApplication:(id)arg1 options:(id)arg2;	// IMP=0x002000000001c5df
+ (_Bool)shouldAttemptToRepairApplication:(id)arg1 options:(id)arg2 logUUID:(id)arg3;	// IMP=0x001000000001c4c0
...
- (void)_showFamilyLeaveAlert:(id)arg1;	// IMP=0x001000000001c759
- (void)_showInternetConnectionAlert;	// IMP=0x001000000001c5ef
- (_Bool)_isSystemIntegrityProtected;	// IMP=0x001000000001c5e7
- (_Bool)repairApplication:(id)arg1 error:(id *)arg2;	// IMP=0x001000000001c4c8
@property(readonly, nonatomic) NSString *repairType;
- (void)setRepairedBundleIDs:(id)arg1;	// IMP=0x001000000001c3f4
...
- (id)initWithApplication:(id)arg1 options:(id)arg2;	// IMP=0x001000000001bde5
- (id)init;	// IMP=0x001000000001bd68
