...
@class ASDRepairOptions, MISSING_TYPE, NSArray, NSString, TaskQueue;
...
+ (_Bool)shouldAttemptToRepairApplication:(id)arg1 options:(id)arg2 logUUID:(id)arg3;	// IMP=0x00200000000627ec
- (void).cxx_destruct;	// IMP=0x0020000000063223
- (_Bool)_handleVPPRecoveryWithOutError:(id *)arg1;	// IMP=0x0010000000062eb6
- (_Bool)repairApplication:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000062999
@property(readonly, nonatomic) NSString *repairType;
- (void)setRepairedBundleIDs:(id)arg1;	// IMP=0x0010000000062770
...
- (id)initWithApplication:(id)arg1 options:(id)arg2;	// IMP=0x0010000000062527
- (id)init;	// IMP=0x00100000000624ec
