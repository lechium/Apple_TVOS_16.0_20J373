...
- (void).cxx_destruct;	// IMP=0x0020000000045b02
...
- (void)_setResponse:(id)arg1;	// IMP=0x0010000000045a56
@property(readonly) ASDRequestResponse *response; // @synthesize response=_response;
- (id)initForClient:(id)arg1 withOptions:(id)arg2;	// IMP=0x00100000000458c6
