...
+ (id)newUpdateResponseWithAddedIAPs:(id)arg1 removedIAPs:(id)arg2 revision:(id)arg3 forAccount:(id)arg4;	// IMP=0x004000000002c797
+ (id)newRefreshResponseWithIAPs:(id)arg1 revision:(id)arg2 forAccount:(id)arg3;	// IMP=0x001000000002c700
- (void).cxx_destruct;	// IMP=0x002000000002c9c2
...
- (id)_initWithAddedIAPs:(id)arg1 removedIAPs:(id)arg2 revision:(id)arg3 isUpdate:(_Bool)arg4 forAccount:(id)arg5;	// IMP=0x001000000002c84b
