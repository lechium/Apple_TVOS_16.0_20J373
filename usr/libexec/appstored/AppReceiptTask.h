...
- (void).cxx_destruct;	// IMP=0x002000000002e8ed
...
- (void)handleEngagementRequest:(id)arg1 resultHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000002e7d5
- (void)handleDialogRequest:(id)arg1 resultHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000002e764
- (void)handleAuthenticateRequest:(id)arg1 resultHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000002e6f3
- (void)main;	// IMP=0x001000000002e307
- (id)initWithApplicationProxy:(id)arg1;	// IMP=0x001000000002e2aa
