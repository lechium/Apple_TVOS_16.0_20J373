...
- (void).cxx_destruct;	// IMP=0x00200000000f9de1
...
- (id)_newSelectSQLWithProperties:(id)arg1 columns:(id)arg2;	// IMP=0x00100000000f9677
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000f9585
- (id)initWithEntityClass:(Class)arg1 memoryEntityClass:(Class)arg2;	// IMP=0x00100000000f953d
- (id)initWithEntityClass:(Class)arg1;	// IMP=0x00100000000f9529
