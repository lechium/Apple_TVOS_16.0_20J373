...
- (id)initWithReason:(long long)arg1 requestToken:(id)arg2 logKey:(id)arg3 callbackHandler:(CDUnknownBlockType)arg4 includeMetrics:(_Bool)arg5 isVPPLookup:(_Bool)arg6 userInitiated:(_Bool)arg7;	// IMP=0x0010000000008f80
- (id)initWithReason:(long long)arg1;	// IMP=0x0010000000008f10
- (id)init;	// IMP=0x0010000000008ea0
