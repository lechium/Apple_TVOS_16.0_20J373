...
- (void).cxx_destruct;	// IMP=0x00200000000e0d7f
- (void)_publishStreamEvent:(unsigned long long)arg1;	// IMP=0x00100000000e0d22
- (void)signalEvent:(unsigned long long)arg1;	// IMP=0x00100000000e0d11
- (void)open;	// IMP=0x00100000000e0cd9
- (void)close;	// IMP=0x00100000000e0cc2
...
- (id)init;	// IMP=0x00100000000e06ba
