...
+ (id)_variantDescriptorsFromTargetArray:(id)arg1;	// IMP=0x002000000000edb1
+ (id)_variantDeltasFromDeltasInfo:(id)arg1;	// IMP=0x001000000000ebc4
- (void).cxx_destruct;	// IMP=0x002000000000efe2
...
- (id)variantDeltaFromAssetToken:(id)arg1;	// IMP=0x001000000000e8da
@property(readonly) _Bool deltaUpdate;
- (id)initWithDictionary:(id)arg1;	// IMP=0x001000000000e744
