...
- (void).cxx_destruct;	// IMP=0x0020000000017c15
- (void)close;	// IMP=0x0010000000017bcb
- (long long)readBytes:(char *)arg1 length:(unsigned long long)arg2 error:(id *)arg3;	// IMP=0x0010000000017bae
@property(readonly) _Bool hasBytesAvailable;
- (void)dealloc;	// IMP=0x0010000000017ad8
- (id)_initWithBufferedStream:(id)arg1;	// IMP=0x0010000000017a6a
