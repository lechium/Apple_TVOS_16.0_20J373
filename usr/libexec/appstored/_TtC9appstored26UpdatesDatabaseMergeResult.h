...
- (void).cxx_destruct;	// IMP=0x0040000000003ce0
- (id)init;	// IMP=0x0010000000003c80
- (id)initWithAvailableUpdateCount:(long long)arg1 shouldNotifyOfChanges:(_Bool)arg2 bundleIDs:(id)arg3 result:(_Bool)arg4;	// IMP=0x0010000000003c00
