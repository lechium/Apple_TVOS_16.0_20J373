...
+ (_Bool)isErrorBadTokenError:(id)arg1;	// IMP=0x00400000000a1434
- (void).cxx_destruct;	// IMP=0x00200000000a3426
...
- (void)_processBatchFailureItems:(id)arg1 error:(id)arg2 context:(id)arg3;	// IMP=0x00100000000a2f76
- (id)_processContentRestoreResponse:(id)arg1 context:(id)arg2;	// IMP=0x00100000000a24f5
- (void)main;	// IMP=0x00100000000a1594
- (_Bool)isErrorSoftFail:(id)arg1;	// IMP=0x00100000000a158c
- (id)initWithRestoreAppInstalls:(id)arg1;	// IMP=0x00100000000a13c6
