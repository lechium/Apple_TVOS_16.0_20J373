...
@class ACAccount, AMSProcessInfo, MISSING_TYPE, NSNumber, NSString;
...
+ (id)newContextWithRevision:(id)arg1 forAccount:(id)arg2 token:(id)arg3;	// IMP=0x00400000001f4af2
- (MISSING_TYPE *).cxx_destruct;	// IMP=0x00200000001f4d08
...
- (id)_initWithRevision:(id)arg1 forAccount:(id)arg2 client:(id)arg3 logUUID:(id)arg4;	// IMP=0x00100000001f4bd6
