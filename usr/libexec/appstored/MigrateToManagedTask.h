...
- (void).cxx_destruct;	// IMP=0x002000000008b9ab
@property(copy, nonatomic) NSArray *bundleIDs; // @synthesize bundleIDs=_bundleIDs;
- (void)main;	// IMP=0x001000000008b5b6
- (_Bool)attemptVPPMigrationForApp:(id)arg1;	// IMP=0x001000000008b23a
- (id)init;	// IMP=0x001000000008b1a8
