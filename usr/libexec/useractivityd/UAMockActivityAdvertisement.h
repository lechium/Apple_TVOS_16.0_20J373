...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000006a549
- (void).cxx_destruct;	// IMP=0x002000000006a951
...
- (id)description;	// IMP=0x001000000006a782
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000006a658
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000006a551
- (id)init;	// IMP=0x001000000006a51a
