...
- (void).cxx_destruct;	// IMP=0x002000000004036c
...
- (id)reportedActivityType;	// IMP=0x00100000000402bf
- (void)sendEvent;	// IMP=0x0010000000040264
- (id)eventPayload;	// IMP=0x0010000000040162
- (id)eventName;	// IMP=0x0010000000040155
- (id)initWithAnalyticsInfo:(id)arg1;	// IMP=0x0010000000040088
