...
+ (unsigned long long)setup:(id)arg1 interval:(double)arg2;	// IMP=0x0040000000004420
+ (id)idleTracker:(id)arg1 queue:(id)arg2 interval:(double)arg3 block:(CDUnknownBlockType)arg4;	// IMP=0x0010000000004049
- (void).cxx_destruct;	// IMP=0x0020000000004d4f
...
- (void)invalidate;	// IMP=0x0010000000004973
- (void)dealloc;	// IMP=0x0010000000004334
- (id)init:(id)arg1 queue:(id)arg2 interval:(double)arg3 block:(CDUnknownBlockType)arg4;	// IMP=0x00100000000040eb
