...
- (void).cxx_destruct;	// IMP=0x0020000000045858
...
- (_Bool)terminate;	// IMP=0x0010000000045208
- (void)activityPayloadFromDevice:(id)arg1 forAdvertisementPayload:(id)arg2 command:(id)arg3 timeout:(unsigned long long)arg4 withCompletionHandler:(CDUnknownBlockType)arg5;	// IMP=0x001000000004509e
- (void)activityAdvertiser:(id)arg1 activityPayloadForAdvertisementPayload:(id)arg2 command:(id)arg3 requestedByDevice:(id)arg4 withCompletionHandler:(CDUnknownBlockType)arg5;	// IMP=0x0010000000045098
- (_Bool)processCommands:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0010000000044dcf
- (_Bool)sendResponse:(id)arg1;	// IMP=0x0010000000044dc7
- (_Bool)processCommand:(id)arg1;	// IMP=0x0010000000042907
- (id)scanMockAdvertisement:(id)arg1;	// IMP=0x0010000000041fbe
- (void)doAdvertiseAdvertisementPayload:(id)arg1 options:(id)arg2;	// IMP=0x0010000000041ccd
- (id)sharingAdvertiser;	// IMP=0x0010000000041aec
- (id)sharingReceiver;	// IMP=0x001000000004190b
- (void)dealloc;	// IMP=0x001000000004167e
- (id)initWithManager:(id)arg1 name:(id)arg2;	// IMP=0x00100000000410e0
