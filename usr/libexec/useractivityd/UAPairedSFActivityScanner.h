...
- (void).cxx_destruct;	// IMP=0x0020000000046b2b
...
- (void)activityPayloadFromDevice:(id)arg1 forAdvertisementPayload:(id)arg2 command:(id)arg3 timeout:(unsigned long long)arg4 withCompletionHandler:(CDUnknownBlockType)arg5;	// IMP=0x0010000000046935
- (void)receiveAdvertisement:(id)arg1 options:(id)arg2 fromPeer:(id)arg3;	// IMP=0x00100000000466e8
- (void)scanForTypes:(unsigned long long)arg1;	// IMP=0x00100000000466e2
- (id)initWithDelegate:(id)arg1;	// IMP=0x001000000004660d
