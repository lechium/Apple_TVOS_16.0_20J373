...
- (void).cxx_destruct;	// IMP=0x0020000000005029
@property(copy) CDUnknownBlockType wasContinuedBlock; // @synthesize wasContinuedBlock=_wasContinuedBlock;
- (id)statusString;	// IMP=0x0010000000004f31
- (id)initFromPing:(id)arg1;	// IMP=0x0010000000004e9e
- (id)initWithPayloadSize:(unsigned long long)arg1;	// IMP=0x0010000000004d8d
