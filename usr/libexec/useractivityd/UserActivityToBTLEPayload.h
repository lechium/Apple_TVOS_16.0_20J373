...
- (void).cxx_destruct;	// IMP=0x00200000000563e1
...
- (id)description;	// IMP=0x0010000000055f36
- (id)encodeAsData;	// IMP=0x001000000005568c
- (id)initWithData:(id)arg1;	// IMP=0x0010000000054c6d
- (void)addAdditionalItem:(id)arg1 forKey:(id)arg2;	// IMP=0x0010000000054b5f
@property(readonly, copy) NSDictionary *additionalItems;
- (id)initWithNSError:(id)arg1;	// IMP=0x0010000000054ad9
- (id)init:(id)arg1 title:(id)arg2 date:(id)arg3 userInfoPayload:(id)arg4 teamID:(id)arg5 activityType:(id)arg6;	// IMP=0x0010000000054903
