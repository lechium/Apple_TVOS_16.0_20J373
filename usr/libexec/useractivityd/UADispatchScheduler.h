...
+ (id)dispatchScheduler:(id)arg1 frequency:(double)arg2 queue:(id)arg3 block:(CDUnknownBlockType)arg4;	// IMP=0x004000000002bee8
- (void).cxx_destruct;	// IMP=0x002000000002ced7
...
- (id)nextRunTimeString;	// IMP=0x001000000002ce20
- (void)waitUntilComplete;	// IMP=0x001000000002cd9c
- (void)suspend;	// IMP=0x001000000002cd26
- (void)resume;	// IMP=0x001000000002ccf1
- (void)reset;	// IMP=0x001000000002cb2f
- (void)updateFrequency:(double)arg1;	// IMP=0x001000000002c946
- (void)_doIt;	// IMP=0x001000000002c674
- (void)doIt;	// IMP=0x001000000002c5ed
- (_Bool)scheduleAt:(id)arg1;	// IMP=0x001000000002c57e
- (_Bool)scheduleNext:(double)arg1;	// IMP=0x001000000002bf9d
- (id)init:(id)arg1 frequency:(double)arg2 queue:(id)arg3 block:(CDUnknownBlockType)arg4;	// IMP=0x001000000002bbe0
