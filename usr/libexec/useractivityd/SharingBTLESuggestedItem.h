...
+ (id)statusString;	// IMP=0x0040000000066f61
+ (id)cornerActionBTLEItemWithPayload:(id)arg1 device:(id)arg2 options:(id)arg3 optionBits:(unsigned int)arg4 scanner:(id)arg5 receiver:(id)arg6;	// IMP=0x00100000000617a7
+ (id)cornerActionBTLEItemWithSFAdvertisement:(id)arg1 optionBits:(unsigned int)arg2 scanner:(id)arg3 receiver:(id)arg4;	// IMP=0x0010000000061678
- (void).cxx_destruct;	// IMP=0x0020000000067157
...
- (id)description;	// IMP=0x0010000000066e25
- (void)setWhen:(id)arg1;	// IMP=0x0010000000066d1f
- (id)when;	// IMP=0x0010000000066c48
- (id)statusString;	// IMP=0x00100000000666bb
- (void)clearPayload;	// IMP=0x0010000000066497
- (void)resignCurrent;	// IMP=0x0010000000066427
- (_Bool)requestPayloadWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0010000000064309
- (_Bool)updateFromSFAdvertisement:(id)arg1;	// IMP=0x0010000000063d7d
- (id)initWithPayload:(id)arg1 device:(id)arg2 options:(id)arg3 optionBits:(unsigned int)arg4 type:(unsigned long long)arg5 activityType:(id)arg6 bundleIdentifier:(id)arg7 teamIDs:(id)arg8 advertisingOptions:(id)arg9 scanner:(id)arg10 receiver:(id)arg11;	// IMP=0x0010000000063142
- (id)initWithPayload:(id)arg1 device:(id)arg2 options:(id)arg3 optionBits:(unsigned int)arg4 type:(unsigned long long)arg5 activityType:(id)arg6 bundleIdentifier:(id)arg7 teamIDs:(id)arg8 advertisingOptions:(id)arg9 scanner:(id)arg10 receiver:(id)arg11 dynamicIdentifier:(id)arg12;	// IMP=0x001000000006309e
