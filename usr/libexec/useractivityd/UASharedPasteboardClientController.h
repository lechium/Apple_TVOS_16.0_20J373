...
- (MISSING_TYPE *)localPBStatus;	// IMP=0x0010000000039ffa
- (id)statusString;	// IMP=0x0010000000039fed
- (void)hideProgressUI:(_Bool)arg1;	// IMP=0x0010000000039b56
- (void)showProgressUI:(id)arg1;	// IMP=0x0010000000038fdc
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x00100000000382f2
- (void)advertiser:(id)arg1 didReceiveInputStream:(id)arg2 outputStream:(id)arg3;	// IMP=0x001000000003771c
- (void)startServiceForPasteVersion:(long long)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x0010000000035942
- (void)getLocalPasteboardInfoData:(CDUnknownBlockType)arg1;	// IMP=0x00100000000357e7
- (void)setLocalPasteboardReflection:(_Bool)arg1;	// IMP=0x00100000000357d5
- (void)receivePasteboardStreamData:(id)arg1 version:(long long)arg2 withCompletion:(CDUnknownBlockType)arg3;	// IMP=0x0010000000032d8b
- (void)fetchRemotePasteboardForProcess:(int)arg1 withCompletion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000030c59
- (void)fetchRemotePasteboardTypesForProcess:(int)arg1 withCompletion:(CDUnknownBlockType)arg2;	// IMP=0x001000000003094e
- (void)removeLocalPasteboardFromAdvertisers:(id)arg1;	// IMP=0x001000000003085a
- (void)clearLocalPasteboardTypes:(id)arg1;	// IMP=0x00100000000305e7
- (void)clearLocalPasteboardInformation;	// IMP=0x001000000003051a
- (void)localPasteboardTypesDidChange:(id)arg1 forGeneration:(unsigned long long)arg2;	// IMP=0x001000000002fe5d
- (void)fetchRemoteDeviceName:(CDUnknownBlockType)arg1;	// IMP=0x001000000002fd8f
- (void)fetchRemotePasteboardStatus:(CDUnknownBlockType)arg1;	// IMP=0x001000000002fd1d
- (void)setReturnPasteboardDataEarlyWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000002fbfe
- (void)setRemotePasteboardAvalibility:(_Bool)arg1 withDataRequester:(id)arg2;	// IMP=0x001000000002f855
- (id)currentPasteboardActivityInfo;	// IMP=0x001000000002f538
- (id)eligibleAdvertiseableItemsInOrder;	// IMP=0x001000000002f3e1
- (id)items;	// IMP=0x001000000002f3cf
- (void)startConnection:(int)arg1;	// IMP=0x001000000002f33a
...
- (id)uuid;	// IMP=0x001000000002f0bd
- (void)dealloc;	// IMP=0x001000000002eff5
- (id)initWithManager:(id)arg1 name:(id)arg2;	// IMP=0x001000000002e925
