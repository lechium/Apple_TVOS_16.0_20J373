...
- (void).cxx_destruct;	// IMP=0x0020000000014832
...
- (id)reportedActivityType;	// IMP=0x0010000000014785
- (id)eventPayload;	// IMP=0x0010000000014688
- (id)eventName;	// IMP=0x001000000001467b
