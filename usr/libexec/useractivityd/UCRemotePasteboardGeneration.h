...
- (void).cxx_destruct;	// IMP=0x002000000002e7fd
...
- (void)requestRemotePasteboardData:(CDUnknownBlockType)arg1;	// IMP=0x001000000002e2e6
- (void)requestRemoteTypeInfo:(CDUnknownBlockType)arg1;	// IMP=0x001000000002d408
- (void)dealloc;	// IMP=0x001000000002d2c3
- (void)updateState:(unsigned long long)arg1;	// IMP=0x001000000002d156
- (id)stateAsString;	// IMP=0x001000000002d124
- (id)initWithRequester:(id)arg1;	// IMP=0x001000000002cf67
