...
+ (id)simulatorWithController:(id)arg1 parentSimulatorPortName:(id)arg2;	// IMP=0x002000000008f888
+ (id)simulatorWithController:(id)arg1 pairedPort:(unsigned int)arg2 childSimPid:(int)arg3 childVersion:(unsigned long long)arg4;	// IMP=0x001000000008f880
- (void).cxx_destruct;	// IMP=0x0020000000091096
...
- (id)statusString;	// IMP=0x0010000000090ef2
- (_Bool)terminate;	// IMP=0x0010000000090c21
- (_Bool)suspend;	// IMP=0x0010000000090b32
- (_Bool)resume;	// IMP=0x0010000000090a43
- (void)setSimulatorInFront:(_Bool)arg1;	// IMP=0x00100000000908b8
- (_Bool)active;	// IMP=0x0010000000090885
@property(copy) NSSet *notifiedItems;
@property(readonly) unsigned int pairedClientPort; // @dynamic pairedClientPort;
- (_Bool)reconnectToParentSimulator;	// IMP=0x001000000008fc2b
- (void)dealloc;	// IMP=0x001000000008fb60
- (id)initWithController:(id)arg1;	// IMP=0x001000000008f160
