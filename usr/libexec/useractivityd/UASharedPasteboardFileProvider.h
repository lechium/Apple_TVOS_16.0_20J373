...
- (void).cxx_destruct;	// IMP=0x0020000000004016
...
- (void)_provideItemAtURL:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0010000000003ecb
- (void)_provideItemAtURL:(id)arg1 toReaderWithID:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0010000000003d1e
- (void)unlockWithError:(id)arg1;	// IMP=0x0010000000003a9f
- (id)initWithURL:(id)arg1;	// IMP=0x00100000000039d0
