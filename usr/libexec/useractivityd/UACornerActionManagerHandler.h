...
- (void).cxx_destruct;	// IMP=0x0020000000014585
...
- (id)statusString;	// IMP=0x0010000000014434
- (_Bool)terminate;	// IMP=0x00100000000142d1
- (_Bool)resume;	// IMP=0x00100000000141b2
- (_Bool)suspend;	// IMP=0x001000000001408d
@property _Bool suspended;
@property(readonly) _Bool active;
- (id)initWithManager:(id)arg1 name:(id)arg2;	// IMP=0x0010000000013dfe
