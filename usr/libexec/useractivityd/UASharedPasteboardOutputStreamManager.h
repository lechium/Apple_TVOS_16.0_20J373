...
- (void).cxx_destruct;	// IMP=0x0020000000068356
...
- (void)shutdownStream;	// IMP=0x0010000000068098
- (void)shutdownTimerFired:(id)arg1;	// IMP=0x0010000000067fd5
- (void)stream:(id)arg1 handleEvent:(unsigned long long)arg2;	// IMP=0x0010000000067843
- (id)headerForData:(id)arg1;	// IMP=0x001000000006777b
- (void)sendTypes:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00100000000673f1
- (id)initWithOutputStream:(id)arg1 inputStream:(id)arg2 pasteboard:(id)arg3;	// IMP=0x001000000006725b
