...
- (void).cxx_destruct;	// IMP=0x002000000001beae
...
- (void)_triggerWatchdog;	// IMP=0x001000000001bc78
- (void)cancel;	// IMP=0x001000000001bb84
- (void)poke;	// IMP=0x001000000001baf7
- (void)start;	// IMP=0x001000000001b8e1
- (void)dealloc;	// IMP=0x001000000001b87e
- (id)initWithName:(id)arg1 timeout:(double)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x001000000001b7ba
