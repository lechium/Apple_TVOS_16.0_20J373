...
+ (id)searchCriterionForSenderAddresses:(id)arg1;	// IMP=0x0020000000007c6a
- (void).cxx_destruct;	// IMP=0x00200000000087fc
...
- (void)search:(id)arg1 didFinishWithError:(id)arg2;	// IMP=0x0010000000008637
- (_Bool)search:(id)arg1 didFindResults:(id)arg2;	// IMP=0x00100000000082d9
- (id)nextOutgoingMessageBatch;	// IMP=0x0010000000008190
- (void)searchMailWithSenderAddresses:(id)arg1;	// IMP=0x0010000000007fdc
- (void)searchAccounts:(id)arg1;	// IMP=0x0010000000007a69
- (void)initializeSearchIfNecessary;	// IMP=0x001000000000778b
- (id)init;	// IMP=0x0010000000007731
- (void)dealloc;	// IMP=0x00100000000076d7
