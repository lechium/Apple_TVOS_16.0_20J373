...
- (void).cxx_destruct;	// IMP=0x0040000000201e10
- (id)init;	// IMP=0x0010000000201d60
- (_Bool)gftaasPseudonymsEnabled:(id)arg1;	// IMP=0x0010000000201c60
- (_Bool)isGuestModeSupported;	// IMP=0x0010000000201be0
@property(nonatomic, readonly) double neighborhoodActivityConduitTimeout;
- (_Bool)isUPlusNDowngradeAvailable;	// IMP=0x0010000000201b60
@property(nonatomic, readonly) unsigned long long maxRemoteMirageParticipants;
- (_Bool)isGFTDowngradeToOneToOneAvailable;	// IMP=0x0010000000201ac0
- (_Bool)isExpanseConduitProxyEnabled;	// IMP=0x0010000000201aa0
...
- (id)stableBundleIdentifierForLocalBundleIdentifier:(id)arg1;	// IMP=0x00100000002019c0
...
- (id)localBundleIDForActivityIdentifier:(id)arg1;	// IMP=0x0010000000201770
...
- (_Bool)isSharePlayVersionCheckEnabled;	// IMP=0x00100000002015a0
- (_Bool)isModernGFTEnabled;	// IMP=0x0010000000201580
- (_Bool)isAutomaticUpgradingEnabled;	// IMP=0x0010000000201560
