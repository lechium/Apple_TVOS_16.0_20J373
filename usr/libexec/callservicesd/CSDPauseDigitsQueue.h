...
- (void).cxx_destruct;	// IMP=0x00200000000a2d2a
...
- (void)_parsePauseDigitsFromDestinationID:(id)arg1;	// IMP=0x00100000000a291a
- (id)dequeueAllPauseDigits;	// IMP=0x00100000000a281f
- (id)dequeueNextPauseDigits;	// IMP=0x00100000000a2770
@property(readonly, nonatomic) _Bool hasQueuedHardPauseDigits;
@property(readonly, nonatomic) CSDPauseDigits *nextPauseDigits;
- (id)description;	// IMP=0x00100000000a2488
- (id)initWithDestinationID:(id)arg1;	// IMP=0x00100000000a23f1
- (id)init;	// IMP=0x00100000000a2367
