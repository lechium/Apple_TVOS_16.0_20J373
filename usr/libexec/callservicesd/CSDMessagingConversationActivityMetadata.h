...
- (void).cxx_destruct;	// IMP=0x002000000014861e
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000148424
- (unsigned long long)hash;	// IMP=0x0010000000148323
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000148153
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000147ffd
- (void)copyTo:(id)arg1;	// IMP=0x0010000000147ef6
- (void)writeTo:(id)arg1;	// IMP=0x0010000000147df5
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000147de8
- (id)dictionaryRepresentation;	// IMP=0x0010000000147866
- (id)description;	// IMP=0x00100000001477b7
@property(readonly, nonatomic) _Bool hasSceneAssociationBehavior;
// Error: Property attributes should begin with the type ('T') attribute, property name: hasPreferredBroadcastingAttributes
