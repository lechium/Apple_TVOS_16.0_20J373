...
+ (Class)contactIdentifiersType;	// IMP=0x0020000000121b8a
- (void).cxx_destruct;	// IMP=0x0010000000123535
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000012301e
- (unsigned long long)hash;	// IMP=0x0010000000122e87
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000122b53
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000012277f
- (void)copyTo:(id)arg1;	// IMP=0x0010000000122515
- (void)writeTo:(id)arg1;	// IMP=0x001000000012226d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000122260
- (id)dictionaryRepresentation;	// IMP=0x0010000000121c4a
- (id)description;	// IMP=0x0010000000121b9b
- (id)contactIdentifiersAtIndex:(unsigned long long)arg1;	// IMP=0x0010000000121b6d
- (unsigned long long)contactIdentifiersCount;	// IMP=0x0010000000121b50
- (void)addContactIdentifiers:(id)arg1;	// IMP=0x0010000000121ae6
- (void)clearContactIdentifiers;	// IMP=0x0010000000121ac9
...
- (id)initWithCallDisplayContext:(id)arg1;	// IMP=0x00100000001427e9
