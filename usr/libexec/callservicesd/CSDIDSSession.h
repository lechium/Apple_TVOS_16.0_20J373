...
- (void).cxx_destruct;	// IMP=0x0020000000121990
...
- (void)_updateSessionPreferences;	// IMP=0x0010000000121208
@property(readonly, copy, nonatomic) NSString *UUID;
@property(readonly, copy, nonatomic) NSString *propertiesDescription;
- (id)description;	// IMP=0x00100000001210c4
- (id)initWithSessionProvider:(id)arg1;	// IMP=0x001000000012102f
- (id)init;	// IMP=0x0010000000120fa5
