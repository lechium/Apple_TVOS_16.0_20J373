...
+ (id)activityWithCSDConversationActivity:(id)arg1 handle:(id)arg2;	// IMP=0x0010000000093daa
+ (id)activityWithCSDConversationActivity:(id)arg1 fromConversation:(id)arg2 forStorage:(_Bool)arg3;	// IMP=0x001000000009370d
- (void).cxx_destruct;	// IMP=0x001000000011a317
...
- (void)setApplicationContext:(id)arg1;	// IMP=0x001000000011a1a7
- (id)applicationContext;	// IMP=0x001000000011a196
@property(retain, nonatomic) NSString *identifierUUIDString; // @synthesize identifierUUIDString=_identifierUUIDString;
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000119f3e
- (unsigned long long)hash;	// IMP=0x0010000000119bd9
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001198d2
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000011968e
- (void)copyTo:(id)arg1;	// IMP=0x00100000001194c3
- (void)writeTo:(id)arg1;	// IMP=0x001000000011930d
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000119300
- (id)dictionaryRepresentation;	// IMP=0x0010000000118ac2
- (id)description;	// IMP=0x0010000000118a13
