...
@interface CSDMessagingCall : PBCodable
{
    ...
    MISSING_TYPE *_has;	// 144 = 0x90
}

+ (Class)remoteParticipantHandlesType;	// IMP=0x002000000009a1dc
- (void).cxx_destruct;	// IMP=0x001000000009e3f1
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000009dbb2
- (unsigned long long)hash;	// IMP=0x001000000009d622
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000009cec5
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000009c8cd
- (void)copyTo:(id)arg1;	// IMP=0x001000000009c457
- (void)writeTo:(id)arg1;	// IMP=0x001000000009bf3d
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000009bf30
- (id)dictionaryRepresentation;	// IMP=0x001000000009a441
- (id)description;	// IMP=0x001000000009a392
...
- (id)remoteParticipantHandlesAtIndex:(unsigned long long)arg1;	// IMP=0x001000000009a1bf
- (unsigned long long)remoteParticipantHandlesCount;	// IMP=0x001000000009a1a2
- (void)addRemoteParticipantHandles:(id)arg1;	// IMP=0x001000000009a138
- (void)clearRemoteParticipantHandles;	// IMP=0x001000000009a11b
...
- (void)setTuProvider:(id)arg1 isVideo:(_Bool)arg2;	// IMP=0x001000000011d41f
...
- (_Bool)isEqualToCall:(id)arg1;	// IMP=0x001000000011c5bc
- (void)updateRelayCall:(id)arg1;	// IMP=0x001000000011c0b7
...
- (void)setService:(int)arg1;	// IMP=0x001000000011bb7f
- (int)service;	// IMP=0x001000000011bb6d
@property(nonatomic, getter=isConferenced) _Bool conferenced;
@property(nonatomic) int status;
- (id)initWithCall:(id)arg1;	// IMP=0x001000000011b679
