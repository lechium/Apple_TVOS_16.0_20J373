...
- (void).cxx_destruct;	// IMP=0x0020000000055dc1
...
- (id)groupUUID;	// IMP=0x0010000000055815
- (id)UUID;	// IMP=0x0010000000055803
@property(readonly, nonatomic) long long state;
- (id)description;	// IMP=0x0010000000055597
- (id)initWithConversationLink:(id)arg1 localMember:(id)arg2 queue:(id)arg3;	// IMP=0x0010000000055471
