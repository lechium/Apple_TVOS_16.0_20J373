...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000011b5ff
- (unsigned long long)hash;	// IMP=0x001000000011b5b9
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000011b4eb
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000011b46e
- (void)copyTo:(id)arg1;	// IMP=0x001000000011b414
- (void)writeTo:(id)arg1;	// IMP=0x001000000011b3a1
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000011b394
- (id)dictionaryRepresentation;	// IMP=0x001000000011b00f
- (id)description;	// IMP=0x001000000011af60
...
- (id)initWithCallCapabilitiesState:(id)arg1;	// IMP=0x0010000000117af3
