...
+ (id)errorForDisabledPseudonyms;	// IMP=0x002000000017c8de
+ (id)errorForUnregisteredProviderIdentifier:(id)arg1;	// IMP=0x001000000017c7f1
+ (id)sharedInstance;	// IMP=0x001000000017ae5c
- (void).cxx_destruct;	// IMP=0x002000000017cd34
...
- (void)createProcessMonitorIfNecessary:(id)arg1 forClient:(id)arg2;	// IMP=0x001000000017c99c
- (id)serviceForProvider:(id)arg1;	// IMP=0x001000000017c51d
- (void)doesHandle:(id)arg1 correspondToConversationProvider:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x001000000017c32d
- (void)revokePseudonymHandle:(id)arg1 forConversationProvider:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x001000000017c1a9
- (void)renewPseudonymHandle:(id)arg1 forConversationProvider:(id)arg2 expirationDate:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x001000000017bffe
- (void)generatePseudonymHandleForConversationProvider:(id)arg1 expiryDuration:(double)arg2 URI:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x001000000017bd97
- (id)tuConversationProviderForIdentifier:(id)arg1;	// IMP=0x001000000017bcf8
- (id)conversationProviderForIdentifier:(id)arg1;	// IMP=0x001000000017bc52
- (void)registerConversationProvider:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000017b43b
- (id)providerIdentifiersForClient:(id)arg1;	// IMP=0x001000000017b30d
- (void)startTrackingClient:(id)arg1 forProviderIdentifier:(id)arg2;	// IMP=0x001000000017afbd
- (id)init;	// IMP=0x001000000017aee1
