...
- (void).cxx_destruct;	// IMP=0x00200000000219f0
...
- (id)queue;	// IMP=0x00100000000219c0
- (oneway void)allCallHistoryDeleted;	// IMP=0x00100000000218b1
- (oneway void)recentCallsDeleted:(id)arg1;	// IMP=0x001000000002172b
- (void)unregisterClient:(id)arg1;	// IMP=0x0010000000021629
- (void)registerClient:(id)arg1;	// IMP=0x0010000000021527
- (void)notifyClientsToConnectIfNecessary;	// IMP=0x001000000002147e
- (void)invalidate;	// IMP=0x0010000000021375
- (void)dealloc;	// IMP=0x00100000000212e8
- (id)initWithCallHistoryController:(id)arg1;	// IMP=0x0010000000020d93
