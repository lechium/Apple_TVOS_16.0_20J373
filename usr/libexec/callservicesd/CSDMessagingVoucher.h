...
+ (id)voucherWithTUVoucher:(id)arg1;	// IMP=0x0020000000002c50
- (void).cxx_destruct;	// IMP=0x00100000001152d2
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000115181
- (unsigned long long)hash;	// IMP=0x00100000001150fd
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000114fd1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000114ee7
- (void)copyTo:(id)arg1;	// IMP=0x0010000000114e44
- (void)writeTo:(id)arg1;	// IMP=0x0010000000114dad
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000114da0
- (id)dictionaryRepresentation;	// IMP=0x0010000000114a67
- (id)description;	// IMP=0x00100000001149b8
