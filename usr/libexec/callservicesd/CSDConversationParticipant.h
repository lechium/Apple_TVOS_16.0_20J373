...
- (void).cxx_destruct;	// IMP=0x0020000000145f0d
...
- (unsigned long long)hash;	// IMP=0x00100000001459fa
- (_Bool)isEqualToParticipant:(id)arg1;	// IMP=0x00100000001454e9
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000014548c
- (_Bool)pseudonym;	// IMP=0x001000000014541e
...
- (id)description;	// IMP=0x0010000000144b94
- (id)initWithIDSDictionaryRepresentation:(id)arg1;	// IMP=0x00100000001449d5
- (id)initWithIdentifier:(unsigned long long)arg1 handle:(id)arg2 avcData:(id)arg3;	// IMP=0x00100000001449c0
- (id)initWithIdentifier:(unsigned long long)arg1 handle:(id)arg2 avcData:(id)arg3 senderCorrelationIdentifier:(id)arg4;	// IMP=0x001000000014482a
