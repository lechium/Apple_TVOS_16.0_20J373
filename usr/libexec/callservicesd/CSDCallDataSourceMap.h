...
- (void).cxx_destruct;	// IMP=0x002000000014644e
...
- (id)callsForDataSource:(id)arg1 identifier:(id)arg2;	// IMP=0x0010000000146349
- (void)addCalls:(id)arg1 forIdentifier:(id)arg2;	// IMP=0x001000000014601c
@property(readonly, copy, nonatomic) NSArray *dataSources;
- (id)init;	// IMP=0x0010000000145f6f
