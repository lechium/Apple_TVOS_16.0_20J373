...
@class CXCallFailureContext, CXCallSource, CXCallUpdate, CXProviderConfiguration, CXTransaction, MISSING_TYPE, NSData, NSDate, NSString, NSUUID;
...
- (MISSING_TYPE *)callSource:reportedAudioFinishedForCallWithUUID: /* Error: Ran out of types for this method. */;
