...
- (void).cxx_destruct;	// IMP=0x00000000002c8b00
- (_Bool)destinationIDsCanUseV2Blobs:(id)arg1;	// IMP=0x00100000002c7fe0
- (void)idsPeersForHandle:(id)arg1 video:(_Bool)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000002c7f50
- (id)init;	// IMP=0x00100000002c7580
