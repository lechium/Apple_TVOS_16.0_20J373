...
+ (Class)emergencyHandlesType;	// IMP=0x0020000000077dc0
+ (Class)prioritizedSenderIdentitiesType;	// IMP=0x0010000000077cee
+ (Class)emergencyLabeledHandlesType;	// IMP=0x0010000000077bd1
+ (Class)handoffIdentifierType;	// IMP=0x00100000000779d4
- (void).cxx_destruct;	// IMP=0x001000000007af7e
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000007a7d5
- (unsigned long long)hash;	// IMP=0x001000000007a59d
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000007a1d1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000079aa8
- (void)copyTo:(id)arg1;	// IMP=0x001000000007962f
- (void)writeTo:(id)arg1;	// IMP=0x00100000000790c5
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000790b8
- (id)dictionaryRepresentation;	// IMP=0x0010000000077e80
- (id)description;	// IMP=0x0010000000077dd1
- (id)emergencyHandlesAtIndex:(unsigned long long)arg1;	// IMP=0x0010000000077da3
- (unsigned long long)emergencyHandlesCount;	// IMP=0x0010000000077d86
- (void)addEmergencyHandles:(id)arg1;	// IMP=0x0010000000077d1c
- (void)clearEmergencyHandles;	// IMP=0x0010000000077cff
- (id)prioritizedSenderIdentitiesAtIndex:(unsigned long long)arg1;	// IMP=0x0010000000077cd1
- (unsigned long long)prioritizedSenderIdentitiesCount;	// IMP=0x0010000000077cb4
- (void)addPrioritizedSenderIdentities:(id)arg1;	// IMP=0x0010000000077c4a
- (void)clearPrioritizedSenderIdentities;	// IMP=0x0010000000077c2d
@property(nonatomic) _Bool hasSupportsRecents;
- (id)emergencyLabeledHandlesAtIndex:(unsigned long long)arg1;	// IMP=0x0010000000077bb4
- (unsigned long long)emergencyLabeledHandlesCount;	// IMP=0x0010000000077b97
- (void)addEmergencyLabeledHandles:(id)arg1;	// IMP=0x0010000000077b2d
- (void)clearEmergencyLabeledHandles;	// IMP=0x0010000000077b10
- (void)setProtoSupportedHandleTypes:(unsigned int *)arg1 count:(unsigned long long)arg2;	// IMP=0x0010000000077af9
- (unsigned int)protoSupportedHandleTypeAtIndex:(unsigned long long)arg1;	// IMP=0x0010000000077a2c
- (void)addProtoSupportedHandleType:(unsigned int)arg1;	// IMP=0x0010000000077a19
- (void)clearProtoSupportedHandleTypes;	// IMP=0x0010000000077a08
...
- (id)handoffIdentifierAtIndex:(unsigned long long)arg1;	// IMP=0x00100000000779b7
- (unsigned long long)handoffIdentifiersCount;	// IMP=0x001000000007799a
- (void)addHandoffIdentifier:(id)arg1;	// IMP=0x0010000000077930
- (void)clearHandoffIdentifiers;	// IMP=0x0010000000077913
...
- (void)dealloc;	// IMP=0x00100000000776b0
...
- (id)initWithProvider:(id)arg1;	// IMP=0x00100000000a3564
