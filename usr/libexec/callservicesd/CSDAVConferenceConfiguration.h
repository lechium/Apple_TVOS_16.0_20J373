...
@class MISSING_TYPE, NSDictionary, NSUUID, RTCSecureHierarchyToken, VCCapabilities;
...
@interface CSDAVConferenceConfiguration : NSObject
{
    ...
    MISSING_TYPE *_localPortraitAspectRatio;	// 64 = 0x40
}

- (void).cxx_destruct;	// IMP=0x002000000001029f
...
- (id)description;	// IMP=0x00100000000100d7
