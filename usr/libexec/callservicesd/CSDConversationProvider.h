...
- (void).cxx_destruct;	// IMP=0x0020000000199f30
...
- (void)isPseudonymHandleForProvider:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0010000000199e12
- (void)revokePseudonymHandle:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0010000000199d66
- (void)renewPseudonymHandle:(id)arg1 expirationDate:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0010000000199c4f
- (void)generatePseudonymHandleForConversationWithExpiryDuration:(double)arg1 URI:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x001000000019999d
- (id)callerIDAccount;	// IMP=0x001000000019994d
- (void)registerWithIDSWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00100000001998ba
- (id)tuConversationProvider;	// IMP=0x0010000000199791
- (id)initWithProvider:(id)arg1;	// IMP=0x0010000000199634
