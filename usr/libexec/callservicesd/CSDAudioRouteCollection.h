...
- (void).cxx_destruct;	// IMP=0x0020000000118794
...
- (void)_setRoutesFromRouteDictionaries:(id)arg1;	// IMP=0x00100000001184cc
- (void)updatePickableRoutes;	// IMP=0x00100000001184c6
- (_Bool)_anyRoutePassesTest:(CDUnknownBlockType)arg1;	// IMP=0x00100000001183ec
- (id)_routePassingTest:(CDUnknownBlockType)arg1;	// IMP=0x0010000000118285
- (void)enumerateRoutesInvokingBlock:(CDUnknownBlockType)arg1 forRoutesPassingTest:(CDUnknownBlockType)arg2;	// IMP=0x0010000000118112
...
- (_Bool)isAnyRouteAvailableWithUniqueIdentifier:(id)arg1;	// IMP=0x0010000000117f9b
- (_Bool)isAnyRouteAvailableWithBluetoothEndpointType:(long long)arg1;	// IMP=0x0010000000117f22
...
- (id)initWithCategory:(id)arg1 mode:(id)arg2;	// IMP=0x0010000000117c3b
