...
+ (id)makePairedHostDeviceRouteController;	// IMP=0x0020000000297850
+ (id)makeLocalRouteController;	// IMP=0x0010000000297830
- (void).cxx_destruct;	// IMP=0x0040000000299700
- (id)init;	// IMP=0x00100000002996a0
- (void)handleUpdatedPairedHostDeviceRoutes:(id)arg1;	// IMP=0x00100000002992a0
- (void)clearState;	// IMP=0x0010000000298d90
- (void)pickRouteWithUniqueIdentifier:(id)arg1 shouldWaitUntilAvailable:(_Bool)arg2;	// IMP=0x0010000000298a20
