...
- (void).cxx_destruct;	// IMP=0x0010000000117ac2
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000001178ce
- (unsigned long long)hash;	// IMP=0x001000000011779a
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000011756a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000117404
- (void)copyTo:(id)arg1;	// IMP=0x00100000001172d4
- (void)writeTo:(id)arg1;	// IMP=0x0010000000117189
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000011717c
- (id)dictionaryRepresentation;	// IMP=0x0010000000116824
- (id)description;	// IMP=0x0010000000116775
@property(readonly, nonatomic) _Bool hasProtoUpgradeSessionUUID;
@property(nonatomic) _Bool hasProtoMomentsV2Available;
- (void);	// IMP=0x0010000000116730
...
- (int)StringAsType:(id)arg1;	// IMP=0x00100000001164fd
- (id)typeAsString:(int)arg1;	// IMP=0x00100000001164b4
@property(nonatomic) _Bool hasType;
@property(nonatomic) int type; // @synthesize type=_type;
- (void)addProtocolVersion;	// IMP=0x0010000000012fa5
...
- (void)setWantsVideo:(_Bool)arg1;	// IMP=0x0010000000012e6f
- (_Bool)wantsVideo;	// IMP=0x0010000000012e5d
