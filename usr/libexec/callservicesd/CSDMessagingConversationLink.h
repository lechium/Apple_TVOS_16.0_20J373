...
+ (Class)invitedHandlesType;	// IMP=0x002000000000603c
+ (id)linkWithTUConversationLink:(id)arg1 includeGroupUUID:(_Bool)arg2;	// IMP=0x0010000000005b5b
- (void).cxx_destruct;	// IMP=0x0010000000008062
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000007c1e
- (unsigned long long)hash;	// IMP=0x00100000000078aa
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000075c3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000007222
- (void)copyTo:(id)arg1;	// IMP=0x0010000000006ffc
- (void)writeTo:(id)arg1;	// IMP=0x0010000000006d69
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000006d5c
- (id)dictionaryRepresentation;	// IMP=0x001000000000634e
- (id)description;	// IMP=0x001000000000629f
- (int)StringAsLinkLifetimeScope:(id)arg1;	// IMP=0x001000000000623d
- (id)linkLifetimeScopeAsString:(int)arg1;	// IMP=0x00100000000061e8
...
- (id)invitedHandlesAtIndex:(unsigned long long)arg1;	// IMP=0x001000000000601f
- (unsigned long long)invitedHandlesCount;	// IMP=0x0010000000006002
- (void)addInvitedHandles:(id)arg1;	// IMP=0x0010000000005f98
- (void)clearInvitedHandles;	// IMP=0x0010000000005f7b
