...
- (void)preferredLanguageChangedForBundleID:(id)arg1;	// IMP=0x001000000000102b
- (void)removeSubscriber:(unsigned long long)arg1;	// IMP=0x0010000000000fb5
- (void)addSubscriber:(unsigned long long)arg1;	// IMP=0x0010000000000f3f
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0010000000000df1
- (id)init;	// IMP=0x0010000000000d6a
