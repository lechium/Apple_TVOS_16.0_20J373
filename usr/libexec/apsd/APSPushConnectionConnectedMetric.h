...
- (void).cxx_destruct;	// IMP=0x0020000000095097
...
- (id)initWithGuid:(id)arg1 connectDuration:(id)arg2 connectionType:(unsigned int)arg3 linkQuality:(id)arg4 dualChannelState:(unsigned int)arg5 dnsTimeMilliSeconds:(id)arg6 tlsTimeMilliSeconds:(id)arg7;	// IMP=0x0010000000094cbd
