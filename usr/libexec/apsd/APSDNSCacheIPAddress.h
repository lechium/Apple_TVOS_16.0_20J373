...
- (void).cxx_destruct;	// IMP=0x0020000000068564
...
- (void)updateExpirationTime:(double)arg1;	// IMP=0x00100000000684ef
- (id)initWithIPAddress:(id)arg1 addressFamily:(unsigned long long)arg2 timeToLive:(double)arg3;	// IMP=0x001000000006845f
