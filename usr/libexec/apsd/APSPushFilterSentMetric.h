...
- (void).cxx_destruct;	// IMP=0x002000000001c279
...
- (id)initWithGuid:(id)arg1 connectionType:(unsigned int)arg2 linkQuality:(id)arg3 reason:(unsigned int)arg4;	// IMP=0x001000000001c003
