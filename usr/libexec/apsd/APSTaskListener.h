...
- (void).cxx_destruct;	// IMP=0x00200000000703d4
...
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x001000000006ff12
- (void)_cleanupConnection:(id)arg1;	// IMP=0x001000000006fd71
- (void)dealloc;	// IMP=0x001000000006fcdf
- (id)initWithQueue:(id)arg1 apsDaemon:(id)arg2;	// IMP=0x001000000006fb35
