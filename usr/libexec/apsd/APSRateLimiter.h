...
- (id)description;	// IMP=0x0010000000043011
- (_Bool)isUnset;	// IMP=0x0010000000042ff4
- (void)clear;	// IMP=0x0010000000042fd8
- (_Bool)isUnderLimit;	// IMP=0x0010000000042fae
- (void)note;	// IMP=0x0010000000042f5f
- (_Bool)_checkIsExpired;	// IMP=0x0010000000042ef1
- (id)initWithLimit:(long long)arg1 timeLimit:(double)arg2;	// IMP=0x0010000000042ea5
