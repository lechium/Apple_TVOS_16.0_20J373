...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000001bd81
- (void).cxx_destruct;	// IMP=0x002000000001bfd0
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000001bf2f
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000001bd89
- (id)initResponseForHostname:(id)arg1 ipv4Address:(id)arg2 ipv6Address:(id)arg3;	// IMP=0x001000000001bc76
