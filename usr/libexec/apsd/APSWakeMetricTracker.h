...
- (void).cxx_destruct;	// IMP=0x00200000000437b3
...
- (void)_clearState;	// IMP=0x001000000004366b
- (void)_fireMetricIfNeeded;	// IMP=0x0010000000043541
- (void)_timerFired:(id)arg1;	// IMP=0x0010000000043510
- (void)noteReceivedLiveMessage;	// IMP=0x00100000000434fe
- (void)noteSystemWillSleep;	// IMP=0x00100000000434ec
- (void)noteReceivedStoredMessage;	// IMP=0x001000000004349c
- (void)noteDidConnect;	// IMP=0x001000000004342c
- (void)noteSystemDidFullWakeWhileConnected:(_Bool)arg1;	// IMP=0x0010000000043377
- (id)initWithOnConnectedInterval:(double)arg1 onDisconnectedInterval:(double)arg2 metricSubmissionBlock:(CDUnknownBlockType)arg3;	// IMP=0x0010000000043271
- (id)init;	// IMP=0x00100000000430f5
