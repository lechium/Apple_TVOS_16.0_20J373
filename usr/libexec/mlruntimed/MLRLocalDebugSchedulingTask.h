...
- (void).cxx_destruct;	// IMP=0x002000000000a932
...
- (id)description;	// IMP=0x001000000000a7b3
- (id)initWithBundleIdentifier:(id)arg1 taskSource:(long long)arg2 maxTimeLimit:(double)arg3;	// IMP=0x001000000000a78a
- (id)initWithBundleIdentifier:(id)arg1 taskSource:(long long)arg2 maxTimeLimit:(double)arg3 recipePath:(id)arg4 recordUUIDs:(id)arg5 attachments:(id)arg6;	// IMP=0x001000000000a6a2
