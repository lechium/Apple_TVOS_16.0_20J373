...
- (void).cxx_destruct;	// IMP=0x002000000000acc6
...
- (_Bool)commitWithError:(id *)arg1;	// IMP=0x001000000000ab59
- (id)description;	// IMP=0x001000000000aadb
- (id)initWithPluginID:(id)arg1;	// IMP=0x001000000000a974
