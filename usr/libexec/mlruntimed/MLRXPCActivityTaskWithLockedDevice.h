...
- (void).cxx_destruct;	// IMP=0x0020000000002bf2
...
- (void)stop;	// IMP=0x0010000000002ba5
- (void)startTaskWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000002aa1
- (id)createTaskScheduler;	// IMP=0x0010000000002a71
- (id)criteria;	// IMP=0x001000000000291c
