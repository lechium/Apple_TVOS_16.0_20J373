...
+ (id)brailleEventWithCommand:(id)arg1 info:(id)arg2;	// IMP=0x0040000000015262
+ (id)appleTVRemoteEventWithCommand:(id)arg1 info:(id)arg2;	// IMP=0x00100000000151c4
+ (id)systemServerEventWithCommand:(id)arg1 info:(id)arg2;	// IMP=0x0010000000015126
+ (id)internalEventWithCommand:(id)arg1 info:(id)arg2;	// IMP=0x0010000000015088
+ (id)touchEventWithCommand:(id)arg1 info:(id)arg2;	// IMP=0x0010000000014fea
+ (id)keyEventWithCommand:(id)arg1 keyInfo:(id)arg2;	// IMP=0x0010000000014fce
+ (id)keyEventWithCommand:(id)arg1 keyInfo:(id)arg2 otherInfo:(id)arg3;	// IMP=0x0010000000014f01
+ (id)externalDeviceEventWithCommand:(id)arg1 info:(id)arg2;	// IMP=0x0010000000014e63
- (void).cxx_destruct;	// IMP=0x002000000001566d
...
- (id)description;	// IMP=0x0010000000015479
@property(nonatomic) _Bool bypassHelp; // @dynamic bypassHelp;
- (id)objectForIndex:(unsigned long long)arg1;	// IMP=0x0010000000015451
- (void)setObject:(id)arg1 forIndex:(unsigned long long)arg2;	// IMP=0x00100000000153d8
- (void)setInfo:(id)arg1;	// IMP=0x001000000001538d
@property(retain, nonatomic) VOTKeyInfo *keyInfo; // @dynamic keyInfo;
- (_Bool)isAppleTVRemoteEvent;	// IMP=0x0010000000015351
- (_Bool)isSystemServerEvent;	// IMP=0x0010000000015343
- (_Bool)isBrailleEvent;	// IMP=0x0010000000015335
- (_Bool)isExternalDeviceEvent;	// IMP=0x0010000000015327
- (_Bool)isTouchEvent;	// IMP=0x0010000000015319
- (_Bool)isKeyEvent;	// IMP=0x001000000001530b
- (double)time;	// IMP=0x0010000000015300
- (id)initWithType:(long long)arg1;	// IMP=0x0010000000014e12
