...
- (void).cxx_destruct;	// IMP=0x0020000000061010
...
- (long long)_repeatStateForEvent:(id)arg1;	// IMP=0x0010000000060f10
- (long long)_currentGestureRepeaterEvent;	// IMP=0x0010000000060eeb
- (double)_delayForCurrentRepeatCount;	// IMP=0x0010000000060edd
- (void)_handleRepeaterTimerDidFire:(id)arg1;	// IMP=0x0010000000060dfd
- (void)updateWithEvent:(id)arg1;	// IMP=0x0010000000060bc8
- (void)dealloc;	// IMP=0x0010000000060ac5
- (id)initWithThread:(id)arg1;	// IMP=0x001000000006087d
