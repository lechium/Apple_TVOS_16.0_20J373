...
+ (id)fetchFoundData:(id)arg1 forceUpdate:(_Bool)arg2 direction:(long long)arg3 generation:(unsigned long long)arg4 range:(struct _NSRange)arg5 searchType:(long long)arg6;	// IMP=0x0040000000103a69
- (void).cxx_destruct;	// IMP=0x0020000000103cc8
...
- (id)description;	// IMP=0x0010000000103b37
