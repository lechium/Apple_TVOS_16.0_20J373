...
+ (id)sharedInstance;	// IMP=0x002000000002ae29
...
- (void)_resetConsecutiveCrashCount;	// IMP=0x001000000002b2ee
- (void)_incrementConsecutiveCrashCount;	// IMP=0x001000000002b205
@property(readonly, nonatomic) long long consecutiveCrashCount;
- (void)handleStartUp;	// IMP=0x001000000002aebd
- (id)_init;	// IMP=0x001000000002ae8e
