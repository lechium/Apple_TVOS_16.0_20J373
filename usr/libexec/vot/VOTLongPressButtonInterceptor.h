...
- (void).cxx_destruct;	// IMP=0x002000000011e0ba
...
- (void)_timerFired;	// IMP=0x001000000011dfb2
- (void)buttonUpOccurred:(id)arg1;	// IMP=0x001000000011de5a
- (void)buttonDownOccurred:(id)arg1;	// IMP=0x001000000011dd8c
- (void)dealloc;	// IMP=0x001000000011dd21
- (id)initWithThreadKey:(id)arg1 longPressDelay:(double)arg2 longPressHandler:(CDUnknownBlockType)arg3;	// IMP=0x001000000011dc42
