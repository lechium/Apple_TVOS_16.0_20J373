...
@class AXVoiceOverActivity, MISSING_TYPE, NSArray, NSNumber, VOTElement, VOTEvent, VOTRotor;
...
- (MISSING_TYPE *)moveToElementMatchingRotorType:inDirection: /* Error: Ran out of types for this method. */;
