...
- (void).cxx_destruct;	// IMP=0x00200000000d6a40
...
- (id)_localizedStringForKey:(id)arg1;	// IMP=0x00100000000d6985
- (void)previousSegment;	// IMP=0x00100000000d68f9
- (void)nextSegment;	// IMP=0x00100000000d6886
...
- (id)initWithSegments:(id)arg1;	// IMP=0x00100000000d662b
