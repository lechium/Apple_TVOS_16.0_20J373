...
- (void).cxx_destruct;	// IMP=0x002000000006086d
...
- (id)description;	// IMP=0x00100000000605c4
- (id)_descriptionForBool:(_Bool)arg1;	// IMP=0x00100000000605a6
- (id)_descriptionForCharacterSets:(unsigned long long)arg1;	// IMP=0x00100000000604e8
- (id)initWithAttributes:(id)arg1;	// IMP=0x00100000000601f4
