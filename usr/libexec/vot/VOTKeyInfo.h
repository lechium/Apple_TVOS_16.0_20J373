...
- (void).cxx_destruct;	// IMP=0x0010000000100dd0
...
- (id)description;	// IMP=0x0010000000100b66
// Error: Property attributes should begin with the type ('T') attribute, property name: isEscapeKey
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001005dc
- (id)initWithEventRepresentation:(id)arg1;	// IMP=0x001000000010047c
- (void)_setCommandKeyPressed:(_Bool)arg1;	// IMP=0x0010000000100e03
