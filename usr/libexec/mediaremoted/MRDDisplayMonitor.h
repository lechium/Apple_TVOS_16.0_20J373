...
+ (id)sharedMonitor;	// IMP=0x00200000000faf02
- (void).cxx_destruct;	// IMP=0x00200000000fbaa6
...
- (void)dealloc;	// IMP=0x00100000000fba40
- (void)scheduleLayoutChangeForReason:(id)arg1;	// IMP=0x00100000000fb824
- (void)layoutMonitor:(id)arg1 didUpdateDisplayLayout:(id)arg2 withContext:(id)arg3;	// IMP=0x00100000000fb46b
@property(readonly, nonatomic) _Bool controlCenterVisible;
@property(readonly, nonatomic) _Bool lockScreenVisible;
- (id)_fbsDisplayMonitorConfiguration;	// IMP=0x00100000000fb1e8
- (id)init;	// IMP=0x00100000000faf57
