...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000002ba18
- (void).cxx_destruct;	// IMP=0x002000000002bdd4
...
- (void)dealloc;	// IMP=0x001000000002bc61
- (id)description;	// IMP=0x001000000002bc19
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000002bab5
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000002ba20
