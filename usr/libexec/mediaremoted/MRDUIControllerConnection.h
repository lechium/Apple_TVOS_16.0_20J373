...
+ (id)serviceInterface;	// IMP=0x00200000000516c2
- (void).cxx_destruct;	// IMP=0x0020000000051802
...
- (void)dealloc;	// IMP=0x0010000000050ecd
- (id)initWithClientObject:(id)arg1 invalidationHandler:(CDUnknownBlockType)arg2;	// IMP=0x0010000000050d8a
