...
+ (id)allocWithZone:(struct _NSZone *)arg1;	// IMP=0x0040000000102b74
- (void).cxx_destruct;	// IMP=0x0020000000102d3f
...
- (unsigned long long)sampleRate;	// IMP=0x0010000000102ccd
- (_Bool)matchesUniqueIdentifier:(id)arg1;	// IMP=0x0010000000102c56
- (id)initWithDictionary:(id)arg1;	// IMP=0x0010000000102bc4
