...
- (void)handleCanBeNowPlayingPlayerDidChange:(id)arg1;	// IMP=0x00100000000b5eec
- (void)_onQueue_popState;	// IMP=0x00100000000b5434
- (void)_onQueue_pushState;	// IMP=0x00100000000b5389
- (id)notificationPlayerPathFromPlayer:(id)arg1;	// IMP=0x00100000000b52f5
@property(readonly, nonatomic) _Bool hasNowPlayingData;
- (void)_onQueue_removePlayerClientForPlayer:(id)arg1;	// IMP=0x00100000000b5049
- (void)removePlayerClientForPlayer:(id)arg1;	// IMP=0x00100000000b4f9f
- (id)_onQueue_existingPlayerClientForPlayer:(id)arg1;	// IMP=0x00100000000b4dca
- (id)existingPlayerClientForPlayer:(id)arg1;	// IMP=0x00100000000b4c77
- (id)existingPlayerClientForPlayerPath:(id)arg1;	// IMP=0x00100000000b4c15
- (id)_onQueue_addPlayer:(id)arg1;	// IMP=0x00100000000b4a06
- (id)_onQueue_playerClientForPlayer:(id)arg1;	// IMP=0x00100000000b48b8
- (id)playerClientForPlayer:(id)arg1;	// IMP=0x00100000000b4765
- (_Bool)canBeNowPlayingForPlayerClient:(id)arg1;	// IMP=0x00100000000b4662
- (_Bool)_onQueue_anyPlayerIsPlaying;	// IMP=0x00100000000b451d
@property(readonly, nonatomic) _Bool anyPlayerIsPlaying;
@property(nonatomic) _Bool canBeNowPlaying;
- (void)_reevaluateCanBeNowPlaying;	// IMP=0x00100000000b3e5b
- (id)_onQueue_activePlayerClient;	// IMP=0x00100000000b3e3a
@property(retain, nonatomic) MRDNowPlayingPlayerClient *activePlayerClient;
- (void)_onQueue_setActivePlayerClient:(id)arg1;	// IMP=0x00100000000b3b0b
@property(retain, nonatomic) MRClient *client;
- (void)updateClient:(id)arg1;	// IMP=0x00100000000b3821
...
- (void)initializeDisplayName;	// IMP=0x00100000000b32d8
- (void)initializeBundleIdentifier;	// IMP=0x00100000000b2b2a
@property(readonly, nonatomic) NSArray *playerClients;
- (id)debugDescription;	// IMP=0x00100000000b2542
- (id)description;	// IMP=0x00100000000b24c5
- (void)dealloc;	// IMP=0x00100000000b2483
- (id)initWithPlayerPath:(id)arg1;	// IMP=0x00100000000b2065
