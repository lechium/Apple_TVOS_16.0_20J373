...
- (void).cxx_destruct;	// IMP=0x00200000001025f3
...
- (id)_copyWithZone:(struct _NSZone *)arg1 usingConcreteClass:(Class)arg2;	// IMP=0x00100000001024eb
- (id)_optionsDictionary;	// IMP=0x0010000000102461
- (void)_setCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0010000000102434
- (CDUnknownBlockType)_completionHandler;	// IMP=0x001000000010241e
- (id)optionValueForKey:(struct __CFString *)arg1;	// IMP=0x00100000001023bf
...
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000101dbf
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000101d93
- (id)debugDescription;	// IMP=0x0010000000101c48
- (id)description;	// IMP=0x0010000000101b31
- (id)initWithCommandType:(unsigned int)arg1 playerPath:(id)arg2 unresolvedPlayerPath:(id)arg3 senderAppDisplayID:(id)arg4 optionsData:(id)arg5;	// IMP=0x00100000001019bd
