...
- (void).cxx_destruct;	// IMP=0x0020000000011be9
...
- (void)clearRoutedCommands;	// IMP=0x0010000000011b70
- (void)addRoutedCommand:(id)arg1;	// IMP=0x0010000000011982
@property(readonly, nonatomic) NSArray *routedCommands;
- (id)initWithContextID:(id)arg1 originatingAppDisplayID:(id)arg2;	// IMP=0x0010000000011781
