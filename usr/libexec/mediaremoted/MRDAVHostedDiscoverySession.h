...
@class MISSING_TYPE, MRDHostedRoutingController, MRDMediaRemoteClient, MROSTransaction, MRXPCConnectionMonitor, NSArray, NSDate, NSString, NSXPCConnection;
...
@interface MRDAVHostedDiscoverySession : NSObject
{
    ...
    MISSING_TYPE *_hostedRoutingController;	// 24 = 0x18
...
- (void)_maybeWakeClient;	// IMP=0x001000000003a52e
- (void)_resumeConnection;	// IMP=0x001000000003a17f
- (void)_notifyAvailableEndpointsDidChange:(id)arg1;	// IMP=0x0010000000039f1f
- (void)_notifyAvailableOutputDevicesDidChange:(id)arg1;	// IMP=0x0010000000039cbf
- (void)_invalidate;	// IMP=0x0010000000039c6b
- (void)connectionDidResume:(id)arg1;	// IMP=0x0010000000039c59
- (void)getAvailableOutputDevicesWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000039bf7
- (void)getAvailableEndpointsWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000039b95
- (void)setDiscoveryMode:(unsigned int)arg1 enableThrottling:(_Bool)arg2 withCompletion:(CDUnknownBlockType)arg3;	// IMP=0x0010000000039adf
- (void)getDiscoveryModeWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000039acc
- (void)getDevicePresenceDetectedWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000039a7d
- (void)hostedRoutingController:(id)arg1 outputDevicesDidChange:(id)arg2 forFeature:(unsigned int)arg3;	// IMP=0x0010000000039916
- (void)hostedRoutingController:(id)arg1 endpointsDidChange:(id)arg2;	// IMP=0x00100000000397af
@property(readonly, nonatomic) NSString *reason;
@property(readonly, copy) NSString *debugDescription;
- (void)dealloc;	// IMP=0x00100000000392e7
- (id)initWithConnection:(id)arg1 hostedRoutingController:(id)arg2;	// IMP=0x0010000000038ecc
