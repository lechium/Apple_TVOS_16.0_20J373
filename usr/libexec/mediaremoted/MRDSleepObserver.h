...
- (void).cxx_destruct;	// IMP=0x00200000000ee452
...
- (void)notifyDelegateOfWake;	// IMP=0x00100000000ee38b
- (void)notifyDelegateOfSleepWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00100000000ee2ef
- (id)init;	// IMP=0x00100000000ee01e
