...
- (void).cxx_destruct;	// IMP=0x002000000007b425
...
- (_Bool)containsLocalDevice;	// IMP=0x001000000007b24e
- (_Bool)hasPlayedRecently;	// IMP=0x001000000007b20c
- (double)timeSincePlaying;	// IMP=0x001000000007b125
- (_Bool)isPlaying;	// IMP=0x001000000007b042
- (_Bool)isMemberOfActiveSystemEndpoint;	// IMP=0x001000000007ac35
- (id)activeSystemEndpointUID;	// IMP=0x001000000007ab8b
- (void)_handleActiveSystemEndpointChangedNotification:(id)arg1;	// IMP=0x001000000007aa2a
- (void)_handleLayoutDidChangeNotification:(id)arg1;	// IMP=0x001000000007a7fb
- (void)_adjustPlaybackTimerIfNeeded;	// IMP=0x001000000007a534
- (void)_handleIsPlayingDidChangeNotification:(id)arg1;	// IMP=0x001000000007a354
- (void)_handleDeviceInfoDidChangeNotification:(id)arg1;	// IMP=0x001000000007a1a0
- (void)_onQueue_evaluateShouldDisconnectWithReason:(id)arg1;	// IMP=0x00100000000797d0
- (void)unregisterForChanges;	// IMP=0x0010000000079776
- (void)registerForChanges;	// IMP=0x0010000000079608
- (void)dealloc;	// IMP=0x0010000000079547
- (void)_initialize;	// IMP=0x0010000000079326
- (id)initWithDataSource:(id)arg1 delegate:(id)arg2;	// IMP=0x00100000000790f9
