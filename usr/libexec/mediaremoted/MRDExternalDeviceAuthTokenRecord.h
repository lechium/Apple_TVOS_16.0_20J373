...
- (void).cxx_destruct;	// IMP=0x0020000000104243
...
- (id)_copyWithZone:(struct _NSZone *)arg1 usingConcreteClass:(Class)arg2;	// IMP=0x0010000000104194
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000104161
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000104135
