...
- (void).cxx_destruct;	// IMP=0x00200000000dc696
...
- (void)_onCalloutQueue_notifyStatusDidChange:(unsigned long long)arg1;	// IMP=0x00100000000dc153
- (void)_checkConnectionStatus;	// IMP=0x00100000000dbc86
- (_Bool)_canSendMessage;	// IMP=0x00100000000dbba0
- (void)canSendMessage:(CDUnknownBlockType)arg1;	// IMP=0x00100000000dbae5
@property(readonly, nonatomic) NSString *label;
- (id)debugDescription;	// IMP=0x00100000000db80a
- (id)description;	// IMP=0x00100000000db77f
- (id)_initWithLabel:(id)arg1;	// IMP=0x00100000000db6f8
- (id)initWithXPCConnection:(id)arg1 label:(id)arg2;	// IMP=0x00100000000db63e
- (id)initWithConnection:(id)arg1 label:(id)arg2;	// IMP=0x00100000000db573
