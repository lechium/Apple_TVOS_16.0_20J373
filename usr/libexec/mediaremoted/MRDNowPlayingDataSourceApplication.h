...
- (void).cxx_destruct;	// IMP=0x0020000000023b2c
...
- (id)dictionaryRepresentation;	// IMP=0x0010000000023981
- (id)description;	// IMP=0x0010000000023931
- (id)initWithPID:(int)arg1 audioSessionID:(id)arg2 mxSessionIDs:(id)arg3;	// IMP=0x001000000002388e
