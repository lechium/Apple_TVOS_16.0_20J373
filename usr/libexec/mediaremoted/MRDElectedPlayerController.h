...
- (void).cxx_destruct;	// IMP=0x00200000000c6025
...
- (void)_onSyncSelf_maybeSetupPlaybackTimeoutTimerForEvent:(long long)arg1;	// IMP=0x00100000000c5c0c
- (id)_onSyncSelf_calculateElectedPlayerForOriginClient:(id)arg1 event:(long long)arg2 reason:(id *)arg3;	// IMP=0x00100000000c58eb
- (long long)_resolveChangeTypeWithOriginClient:(id)arg1 forEvent:(long long)arg2;	// IMP=0x00100000000c553e
- (void)_onSyncSelf_reevaluateElectedPlayerForEvent:(long long)arg1 withReason:(id)arg2;	// IMP=0x00100000000c5096
- (void)_handleActiveSystemEndpointDidChangeNotification:(id)arg1;	// IMP=0x00100000000c4a9b
- (void)_handleNowPlayingApplicationDidForegroundNotification:(id)arg1;	// IMP=0x00100000000c494a
- (void)_handleNowPlayingApplicationDidChangeNotification:(id)arg1;	// IMP=0x00100000000c4831
- (void)_handleIsPlayingDidChangeNotification:(id)arg1;	// IMP=0x00100000000c46b2
- (void)_handlePlaybackQueueChangedNotification:(id)arg1;	// IMP=0x00100000000c45a7
- (_Bool)_shouldUseNotification:(id)arg1;	// IMP=0x00100000000c450d
@property(retain, nonatomic) NSString *activeSystemEndpointOutputDeviceUID;
- (void)setOriginClient:(id)arg1 withChangeType:(long long)arg2;	// IMP=0x00100000000c43ad
- (id)initWithOriginClient:(id)arg1;	// IMP=0x00100000000c3fb5
