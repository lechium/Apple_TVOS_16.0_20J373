...
- (void).cxx_destruct;	// IMP=0x002000000003e600
...
- (void)gameController:(id)arg1 propertiesDidChange:(id)arg2;	// IMP=0x001000000003e2be
@property(readonly, nonatomic) NSArray *discoverySessionConfigurations;
- (void)setDiscoveryMode:(unsigned int)arg1 forConfiguration:(id)arg2;	// IMP=0x001000000003e1a3
- (unsigned int)discoveryModeForConfiguration:(id)arg1;	// IMP=0x001000000003e0f2
- (void)endpointDidDisconnect:(id)arg1 withError:(id)arg2;	// IMP=0x001000000003e0bf
- (id)exportContentItemArtworkUpdates:(id)arg1 forPlayerPath:(id)arg2;	// IMP=0x001000000003dfbb
- (id)exportContentItems:(id)arg1 forPlayerPath:(id)arg2;	// IMP=0x001000000003dd3d
- (id)exportPlaybackQueue:(id)arg1 forPlayerPath:(id)arg2;	// IMP=0x001000000003da8f
- (id)exportSupportedCommands:(id)arg1;	// IMP=0x001000000003d966
- (id)exportNowPlayingState:(id)arg1 forPlayerPath:(id)arg2;	// IMP=0x001000000003d830
- (_Bool)_wantsLibraryCommands;	// IMP=0x001000000003d776
...
- (void)requestDestinationEndpoint:(CDUnknownBlockType)arg1;	// IMP=0x001000000003d1ed
- (void)requestConnectedDestinationEndpoint:(CDUnknownBlockType)arg1;	// IMP=0x001000000003cfff
- (void)localizeDestinationOrigin:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x001000000003cee0
- (void)localizeDestinationPlayerPath:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x001000000003cd23
- (void)flushPendingPlaybackSessionMigrateEvents:(CDUnknownBlockType)arg1;	// IMP=0x001000000003ca29
- (_Bool)removePendingPlaybackSessionMigrateEvent:(id)arg1;	// IMP=0x001000000003c881
- (void)addPendingPlaybackSessionMigrateEvent:(id)arg1 playerPath:(id)arg2;	// IMP=0x001000000003c708
- (void)flushVolumeEvents:(CDUnknownBlockType)arg1;	// IMP=0x001000000003c592
- (void)addVolumeEvent:(struct _MRHIDButtonEvent)arg1;	// IMP=0x001000000003c4e2
- (void)flushLyricsEvents:(CDUnknownBlockType)arg1;	// IMP=0x001000000003c298
- (void)removeLyricsEvent:(id)arg1;	// IMP=0x001000000003bfff
- (void)addLyricsEvent:(id)arg1;	// IMP=0x001000000003bf46
- (unsigned long long)virtualTouchIDWithPackedID:(unsigned long long)arg1;	// IMP=0x001000000003bec3
- (void)unregisterAllVirtualVoiceInputDevices;	// IMP=0x001000000003bc59
- (void)addRegisteredVirtualVoiceInputDevice:(unsigned int)arg1;	// IMP=0x001000000003b9a4
- (void)removeAllVirtualTouchDevices;	// IMP=0x001000000003b901
- (id)virtualTouchDeviceWithID:(unsigned long long)arg1;	// IMP=0x001000000003b65f
- (unsigned long long)addVirtualTouchDevice:(id)arg1;	// IMP=0x001000000003b4e2
- (void)removeGameController:(unsigned long long)arg1;	// IMP=0x001000000003b429
- (id)gameControllerWithID:(unsigned long long)arg1;	// IMP=0x001000000003b2e0
- (unsigned long long)addGameController:(id)arg1;	// IMP=0x001000000003b12b
...
- (void)dealloc;	// IMP=0x001000000003aa61
- (id)initWithConnection:(id)arg1;	// IMP=0x001000000003a89a
