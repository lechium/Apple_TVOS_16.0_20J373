...
- (void).cxx_destruct;	// IMP=0x00200000000c961f
...
- (id)_notifyDelegateWithConnection:(id)arg1;	// IMP=0x00100000000c93ed
- (void)stop;	// IMP=0x00100000000c9387
- (void)start;	// IMP=0x00100000000c9320
- (id)idsRemoteControlService:(id)arg1 didAcceptConnection:(id)arg2;	// IMP=0x00100000000c930b
- (id)idsCompanionRemoteControlService:(id)arg1 didAcceptConnection:(id)arg2;	// IMP=0x00100000000c92f6
- (void)rapportRemoteControlService:(id)arg1 didAcceptConnection:(id)arg2;	// IMP=0x00100000000c92d8
- (void)airPlayRemoteControlService:(id)arg1 didAcceptConnection:(id)arg2;	// IMP=0x00100000000c92ba
- (void)bonjourRemoteControlService:(id)arg1 didAcceptConnection:(id)arg2;	// IMP=0x00100000000c929c
@property(readonly, copy) NSString *debugDescription;
- (void)_initializeIDSRemoteControlServiceWithRoutingDataSource:(id)arg1;	// IMP=0x00100000000c8c64
- (id)initWithRoutingDataSource:(id)arg1;	// IMP=0x00100000000c8993
