...
- (void)_onQueue_beginTimerWithInterval:(double)arg1;	// IMP=0x0010000000045ada
- (void)_onQueue_recalculateStateForReason:(id)arg1;	// IMP=0x00100000000454ea
- (void)_onQueue_restoreState;	// IMP=0x0010000000045168
- (void)_handlePersonalDeviceChangeNotification:(id)arg1;	// IMP=0x0010000000045100
- (id)init;	// IMP=0x0010000000044f28
