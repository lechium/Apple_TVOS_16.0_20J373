...
- (void).cxx_destruct;	// IMP=0x0020000000048b28
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000048377
- (id)description;	// IMP=0x001000000004826e
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x0010000000048082
