...
- (void).cxx_destruct;	// IMP=0x0020000000023850
...
- (id)data;	// IMP=0x0010000000023821
@property(readonly, nonatomic) IDSDevice *device; // @synthesize device=_device;
- (_Bool)replyWithData:(id)arg1 priority:(long long)arg2;	// IMP=0x00100000000237ca
- (id)initWithID:(id)arg1 data:(id)arg2 device:(id)arg3 service:(id)arg4;	// IMP=0x00100000000236cf
