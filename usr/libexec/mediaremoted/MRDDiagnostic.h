...
@interface MRDDiagnostic : NSObject
{
    ...
    NSDictionary *_uiSessionInfo;	// 384 = 0x180
}

- (void).cxx_destruct;	// IMP=0x00200000000c874e
// Error: Property attributes should begin with the type ('T') attribute, property name: uiSessionInfo
...
- (void)_appendDescribableArray:(id)arg1 toString:(id)arg2 withTitle:(id)arg3 indentLevel:(unsigned int)arg4 usingDebugDescription:(_Bool)arg5;	// IMP=0x00100000000c7f22
- (void)_appendDescribableArray:(id)arg1 toString:(id)arg2 withTitle:(id)arg3 indentLevel:(unsigned int)arg4;	// IMP=0x00100000000c7f00
- (void)_appendDescribableArray:(id)arg1 toString:(id)arg2 withTitle:(id)arg3;	// IMP=0x00100000000c7edb
- (void)_appendNullableObjectDescription:(id)arg1 toString:(id)arg2 withTitle:(id)arg3 usingDebugDescription:(_Bool)arg4;	// IMP=0x00100000000c7e1b
- (void)_appendNullableObjectDescription:(id)arg1 toString:(id)arg2 withTitle:(id)arg3;	// IMP=0x00100000000c7e06
- (void)_appendSubheader:(id)arg1 toString:(id)arg2;	// IMP=0x00100000000c7de2
- (id)createDiagnosticInfo;	// IMP=0x00100000000c6cff
- (id)init;	// IMP=0x00100000000c6ca9
