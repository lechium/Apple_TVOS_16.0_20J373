...
- (void).cxx_destruct;	// IMP=0x00200000000c9842
...
- (void)dealloc;	// IMP=0x00100000000c9787
- (id)description;	// IMP=0x00100000000c9746
- (id)initWithConnection:(id)arg1 bundleID:(id)arg2;	// IMP=0x00100000000c96a3
