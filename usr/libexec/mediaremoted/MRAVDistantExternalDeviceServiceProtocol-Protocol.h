...
@class MISSING_TYPE, MRAVRoutingDiscoverySessionConfiguration, NSArray, NSData, NSDictionary, NSError, NSString;
...
- (MISSING_TYPE *)getExternalDeviceMetadataWithCompletion: /* Error: Ran out of types for this method. */;
