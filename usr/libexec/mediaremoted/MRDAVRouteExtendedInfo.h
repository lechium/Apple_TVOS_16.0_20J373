...
+ (id)extendedInfoWithRoute:(id)arg1;	// IMP=0x0040000000044d53
- (void).cxx_destruct;	// IMP=0x0020000000044f18
...
- (id)_extendedInfo;	// IMP=0x0010000000044ecd
@property(readonly, nonatomic) NSString *deviceIdentifier;
@property(readonly, nonatomic) NSString *modelName;
@property(readonly, nonatomic) _Bool requiresPIN;
- (id)initWithRoute:(id)arg1;	// IMP=0x0010000000044da4
