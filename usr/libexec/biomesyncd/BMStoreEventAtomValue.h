...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000029027
- (void).cxx_destruct;	// IMP=0x002000000002925e
...
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000002910a
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000002902f
- (id)proto;	// IMP=0x0010000000028f9b
- (id)initWithProto:(id)arg1;	// IMP=0x0010000000028e24
- (id)initWithEventData:(id)arg1 dataVersion:(unsigned int)arg2 dataTimestamp:(double)arg3;	// IMP=0x0010000000028d9f
