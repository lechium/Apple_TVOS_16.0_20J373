...
- (void).cxx_destruct;	// IMP=0x0020000000005eaa
@property(nonatomic) _Bool moreComing; // @synthesize moreComing=_moreComing;
- (void)didAddAtomWithData:(id)arg1;	// IMP=0x0010000000005e82
- (_Bool)canAddAtomWithData:(id)arg1;	// IMP=0x0010000000005e6c
- (id)initWithChunkerPolicy:(id)arg1;	// IMP=0x0010000000005df9
