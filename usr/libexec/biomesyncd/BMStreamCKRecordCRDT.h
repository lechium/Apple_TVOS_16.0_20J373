...
- (void).cxx_destruct;	// IMP=0x00200000000027b9
...
- (unsigned long long)deltaDeliveryRequirements;	// IMP=0x0010000000002761
- (id)mergeableDeltasForMetadata:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000001d0e
- (_Bool)mergeDeltas:(id)arg1 error:(id *)arg2;	// IMP=0x00100000000018c9
- (id)stateVector;	// IMP=0x0010000000001808
- (id)initWithStreamCRDT:(id)arg1 locationRow:(id)arg2 database:(id)arg3 queue:(id)arg4 maxDeltaSize:(long long)arg5 sessionContext:(id)arg6;	// IMP=0x00100000000016fc
