...
- (void)requestTimeoutDidFire;	// IMP=0x0010000000007a72
- (void)stopRequestTimeout;	// IMP=0x0010000000007a3c
- (void)startRequestTimeout;	// IMP=0x00100000000078d8
- (void)markAsDeliveredToDevice:(id)arg1 withError:(id)arg2;	// IMP=0x001000000000784c
- (void)markAsInFlightToDevice:(id)arg1;	// IMP=0x0010000000007836
- (void)runRequestOnDevice:(id)arg1;	// IMP=0x00100000000077bf
- (id)initWithUUID:(id)arg1 activity:(id)arg2 requestBlock:(CDUnknownBlockType)arg3 queue:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x0010000000007626
