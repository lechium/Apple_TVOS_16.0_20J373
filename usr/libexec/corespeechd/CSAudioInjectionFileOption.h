...
- (void).cxx_destruct;	// IMP=0x0020000000018f77
...
- (id)description;	// IMP=0x0010000000018eda
- (id)initWithAudioURL:(id)arg1 withScaleFactor:(float)arg2 outASBD:(struct AudioStreamBasicDescription)arg3;	// IMP=0x0010000000018e3c
