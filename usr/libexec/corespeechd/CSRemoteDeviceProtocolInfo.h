...
+ (id)localDeviceProtocolInfo;	// IMP=0x004000000006389e
+ (id)defaultProtocolInfo;	// IMP=0x0010000000063853
- (void).cxx_destruct;	// IMP=0x0020000000063d2f
...
- (id)description;	// IMP=0x0010000000063cbb
@property(readonly, nonatomic) NSObject<OS_xpc_object> *xpcObject;
- (id)initWithXPCObject:(id)arg1;	// IMP=0x00100000000639e3
- (id)initWithProtocolVersion:(unsigned long long)arg1 buildVersion:(id)arg2 deviceProductVersion:(id)arg3 deviceProductType:(id)arg4 deviceCategory:(unsigned long long)arg5;	// IMP=0x0010000000063788
