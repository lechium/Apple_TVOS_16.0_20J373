...
- (void).cxx_destruct;	// IMP=0x0020000000051793
...
- (void)resetForNewRequestWithSampleRate:(unsigned long long)arg1 recordContext:(id)arg2;	// IMP=0x001000000005160c
- (void)stopEndpointer;	// IMP=0x001000000005158d
- (void)recordingStoppedForReason:(long long)arg1;	// IMP=0x001000000005150e
- (void)processAudioSamplesAsynchronously:(id)arg1;	// IMP=0x001000000005148f
- (void)reset;	// IMP=0x0010000000051410
- (void)preheat;	// IMP=0x0010000000051391
- (id)init;	// IMP=0x00100000000512da
