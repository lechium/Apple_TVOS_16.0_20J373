...
- (void).cxx_destruct;	// IMP=0x002000000001113b
...
- (void)speechRecognizer:(id)arg1 didRecognizePartialResult:(id)arg2;	// IMP=0x0010000000010ffa
- (void)reset;	// IMP=0x0010000000010f3b
- (void)speechRecognizer:(id)arg1 didRecognizePartialResultNbest:(id)arg2;	// IMP=0x00100000000105ba
- (void)speechRecognizer:(id)arg1 didRecognizeFinalResults:(id)arg2;	// IMP=0x0010000000010517
- (void)speechRecognizer:(id)arg1 didFinishRecognitionWithError:(id)arg2;	// IMP=0x0010000000010474
- (void)processAudioChunk:(id)arg1;	// IMP=0x001000000001028e
- (void)startKeywordSpottingWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000000fb87
- (id)init;	// IMP=0x001000000000fb27
