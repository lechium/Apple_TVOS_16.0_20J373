...
@interface CSHybridEndpointAnalyzer : NSObject
{
    ...
    MISSING_TYPE *_automaticEndpointingSuspensionEndTime;	// 112 = 0x70
...
- (void).cxx_destruct;	// IMP=0x002000000006fc06
...
- (_Bool)_multimodalEndpointerEnabled;	// IMP=0x001000000006f62b
- (_Bool)_shouldUsePhaticWithRecordContext;	// IMP=0x001000000006f58d
- (id)_getCSHybridEndpointerConfigForAsset:(id)arg1;	// IMP=0x001000000006f2b3
- (void)_updateAssetWithCurrentLanguage;	// IMP=0x001000000006f23d
- (void)_updateAssetWithLanguage:(id)arg1;	// IMP=0x001000000006f06a
- (void)CSFirstUnlockMonitor:(id)arg1 didReceiveFirstUnlock:(_Bool)arg2;	// IMP=0x001000000006efa0
- (void)CSAssetManagerDidDownloadNewAsset:(id)arg1;	// IMP=0x001000000006ef0a
- (void)CSLanguageCodeUpdateMonitor:(id)arg1 didReceiveLanguageCodeChanged:(id)arg2;	// IMP=0x001000000006ee4d
...
- (void)reset;	// IMP=0x001000000006ee35
- (void)_readParametersFromHEPAsset:(id)arg1;	// IMP=0x001000000006eb54
- (void)resetForNewRequestWithSampleRate:(unsigned long long)arg1 recordContext:(id)arg2;	// IMP=0x001000000006deaf
- (long long)fetchCurrentEndpointerOperationMode;	// IMP=0x001000000006dea7
- (void)setEndpointerOperationMode:(long long)arg1;	// IMP=0x001000000006dea1
- (void)stopEndpointer;	// IMP=0x001000000006de0b
- (void)recordingStoppedForReason:(long long)arg1;	// IMP=0x001000000006dd63
- (void)terminateProcessing;	// IMP=0x001000000006dcf0
- (void)preheat;	// IMP=0x001000000006dcea
- (void)handleVoiceTriggerWithActivationInfo:(id)arg1;	// IMP=0x001000000006d976
- (void)logFeaturesWithEvent:(id)arg1 locale:(id)arg2;	// IMP=0x001000000006d14c
- (void)_emitEndpointDetectedEventWithEndpointTimeMs:(double)arg1 endpointBufferHostTime:(unsigned long long)arg2 endpointerFeatures:(id)arg3 endpointerDecisionLagInNs:(double)arg4 extraDelayMs:(unsigned long long)arg5 endpointScore:(double)arg6 asrFeatureLatencies:(id)arg7;	// IMP=0x001000000006d13b
- (void)osdAnalyzer:(id)arg1 didUpdateOSDFeatures:(id)arg2;	// IMP=0x001000000006b1ab
- (void)shouldAcceptEagerResultForDuration:(double)arg1 resultsCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000006aa84
- (void)processServerEndpointFeatures:(id)arg1;	// IMP=0x001000000006a7b6
- (void)updateEndpointerDelayedTrigger:(_Bool)arg1;	// IMP=0x001000000006a70d
- (void)updateEndpointerThreshold:(float)arg1;	// IMP=0x001000000006a660
- (void)processAudioSamplesAsynchronously:(id)arg1;	// IMP=0x0010000000069f36
- (void)_loadAndSetupEndpointerAssetIfNecessary;	// IMP=0x0010000000069c1b
- (id)init;	// IMP=0x0010000000069469
