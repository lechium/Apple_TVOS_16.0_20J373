...
- (void).cxx_destruct;	// IMP=0x00200000000d5040
...
- (void)_emitMHEndpointLatencyInfo:(id)arg1 withRequestMHUUID:(id)arg2;	// IMP=0x00100000000d4f97
- (void)report;	// IMP=0x00100000000d4cef
- (void)addPktInfoWithTimestamp:(unsigned long long)arg1 arrivalTimestamp:(unsigned long long)arg2 currentMachTime:(unsigned long long)arg3;	// IMP=0x00100000000d4a32
- (id)initWithRequestMHUUID:(id)arg1;	// IMP=0x00100000000d4947
