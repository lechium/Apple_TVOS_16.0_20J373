...
- (void).cxx_destruct;	// IMP=0x00200000000608af
...
- (void)spgEndpointAnalyzer:(id)arg1 hasSilenceScoreEstimate:(double)arg2 clientProcessedAudioTimeMS:(float)arg3;	// IMP=0x0010000000060346
- (void)audioStreamProvider:(id)arg1 audioChunkForTVAvailable:(id)arg2;	// IMP=0x0010000000060340
- (_Bool)_shouldReportBoron;	// IMP=0x0010000000060308
- (_Bool)_popRemoteVADSignal;	// IMP=0x0010000000060289
- (void)_addRemoteVADSignal:(_Bool)arg1;	// IMP=0x00100000000601fb
- (void)audioStreamProvider:(id)arg1 audioBufferAvailable:(id)arg2;	// IMP=0x001000000005fe6c
- (void)audioStreamProvider:(id)arg1 didStopStreamUnexpectly:(long long)arg2;	// IMP=0x001000000005fdbd
- (void)stopListenWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000005fda6
- (void)stopListenWithStateReset:(_Bool)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x001000000005fa20
- (void)_startRequestWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000005f436
- (void)_resetAlignBuffer;	// IMP=0x001000000005f40d
- (void)startListenWithOption:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x001000000005ef0d
- (id)init;	// IMP=0x001000000005ee1f
