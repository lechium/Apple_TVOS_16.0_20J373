...
+ (id)noAlertOption;	// IMP=0x002000000002678c
- (void).cxx_destruct;	// IMP=0x00100000000271fc
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000026d73
@property(readonly, nonatomic) NSObject<OS_xpc_object> *xpcObject;
- (id)initWithXPCObject:(id)arg1;	// IMP=0x001000000002691c
- (id)initTandemWithOption:(id)arg1;	// IMP=0x00100000000267c4
- (long long)_alertBehaviorTypeFromAVVCOberrideType:(long long)arg1;	// IMP=0x0010000000006252
- (long long)_avvcAlertOverrideType:(long long)arg1;	// IMP=0x001000000000623b
- (_Bool)isAlertBehaviorOverridedBeep;	// IMP=0x00100000000061e5
- (id)avvcAlertBehavior;	// IMP=0x001000000000603d
- (void)setAVVCAlertBehavior:(id)arg1;	// IMP=0x0010000000005de3
- (id)avvcStartRecordSettingsWithAudioStreamHandleId:(unsigned long long)arg1;	// IMP=0x0010000000005b16
