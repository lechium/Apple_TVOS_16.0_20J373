...
+ (id)sharedMonitor;	// IMP=0x0040000000028be5
- (void).cxx_destruct;	// IMP=0x0020000000028dfd
@property(nonatomic) __weak id <CSVoiceTriggerAssetChangeDelegate> delegate; // @synthesize delegate=_delegate;
- (void)notifyVoiceTriggerAssetChanged;	// IMP=0x0010000000028dc5
- (void)startMonitoring;	// IMP=0x0010000000028c99
- (id)init;	// IMP=0x0010000000028c3a
