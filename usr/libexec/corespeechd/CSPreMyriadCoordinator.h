...
- (void).cxx_destruct;	// IMP=0x0020000000016430
...
- (void)secondPassDidStartForClient:(unsigned long long)arg1 deviceId:(id)arg2 withFirstPassEstimate:(double)arg3;	// IMP=0x0010000000015fdf
- (void)secondPassDidStopForClient:(unsigned long long)arg1 deviceId:(id)arg2;	// IMP=0x0010000000015dd8
- (void)voiceTriggerDidRejected:(id)arg1 deviceId:(id)arg2;	// IMP=0x0010000000015d10
- (void)raiseToSpeakDetected:(id)arg1;	// IMP=0x0010000000015cb6
- (void)voiceTriggerGotSuperVector:(id)arg1;	// IMP=0x0010000000015c5c
- (void)keywordDetectorDidDetectKeyword;	// IMP=0x0010000000015c2b
- (void)voiceTriggerDidDetectSpeakerReject:(id)arg1;	// IMP=0x0010000000015bd1
- (void)voiceTriggerDidDetectNearMiss:(id)arg1 deviceId:(id)arg2;	// IMP=0x0010000000015b09
- (void)voiceTriggerDidDetectKeyword:(id)arg1 deviceId:(id)arg2;	// IMP=0x00100000000159c4
- (void)voiceTriggerDidDetectKeyword:(id)arg1 deviceId:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x001000000001591d
- (_Bool)_isRemoraSecondPassRunning;	// IMP=0x001000000001581a
- (void)_getHighestRemoraFirstPassGoodnessScore:(CDUnknownBlockType)arg1;	// IMP=0x00100000000155e3
- (_Bool)handlePendingBuiltInVoiceTriggerIfNeeded;	// IMP=0x00100000000152ed
- (void)_clearPendingBuiltInVoiceTrigger;	// IMP=0x00100000000151f0
- (_Bool)handlePendingRemoraVoiceTriggerIfNeeded;	// IMP=0x0010000000014da2
- (void)_clearPendingRemoraVoiceTrigger;	// IMP=0x0010000000014c77
- (MISSING_TYPE *)isRemoraVoiceTriggerEvent: /* Error: Ran out of types for this method. */;	// IMP=0x0010000000014b69
- (_Bool)isBultInVoiceTriggerEvent:(id)arg1;	// IMP=0x0010000000014a5b
- (id)initWithTargetQueue:(id)arg1;	// IMP=0x0010000000014998
