...
+ (id)sharedInstance;	// IMP=0x0040000000060ff7
- (void).cxx_destruct;	// IMP=0x0020000000061fae
...
- (void)localDevice:(struct BTLocalDeviceImpl *)arg1 event:(int)arg2 result:(int)arg3;	// IMP=0x0010000000061ee7
- (void)_tearDownLocalDevice;	// IMP=0x0010000000061eba
- (void)_setUpLocalDevice;	// IMP=0x0010000000061de5
- (void)_sessionTerminated:(struct BTSessionImpl *)arg1;	// IMP=0x0010000000061cf7
- (void)_sessionDetached:(struct BTSessionImpl *)arg1;	// IMP=0x0010000000061c08
- (void)_sessionAttached:(struct BTSessionImpl *)arg1 result:(int)arg2;	// IMP=0x0010000000061b0d
- (void)device:(struct BTDeviceImpl *)arg1 serviceMask:(unsigned int)arg2 serviceEventType:(int)arg3 serviceSpecificEvent:(unsigned int)arg4 result:(int)arg5;	// IMP=0x0010000000061b07
- (void)_attachBluetoothSession;	// IMP=0x0010000000061a0b
- (void)_detachBluetoothSession;	// IMP=0x001000000006190b
- (id)_getWirelessSplitterInfoFromLocalDevice:(struct BTLocalDeviceImpl *)arg1;	// IMP=0x0010000000061438
- (void)getWirelessSplitterInfoWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000006135c
- (void)getBTLocalDeviceWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000061152
