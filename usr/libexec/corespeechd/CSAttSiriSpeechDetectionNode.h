...
- (void).cxx_destruct;	// IMP=0x002000000002637a
...
- (void)_startActivation;	// IMP=0x0010000000025fe2
- (void)attSiriNode:(id)arg1 didUpdateOSDFeatures:(id)arg2 withFrameDurationMs:(double)arg3;	// IMP=0x0010000000025d95
- (void)stop;	// IMP=0x0010000000025d3c
- (void)pause;	// IMP=0x0010000000025d36
- (void)start;	// IMP=0x0010000000025cc3
- (void)removeReceiver:(id)arg1;	// IMP=0x0010000000025c09
- (void)addReceiver:(id)arg1;	// IMP=0x0010000000025b74
- (id)initWithAttSiriController:(id)arg1;	// IMP=0x0010000000025aa7
