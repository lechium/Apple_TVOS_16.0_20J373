...
- (void).cxx_destruct;	// IMP=0x00200000000a93f6
...
- (void)removeReceiver:(id)arg1;	// IMP=0x00100000000a9377
- (void)addReceiver:(id)arg1;	// IMP=0x00100000000a9371
- (void)stop;	// IMP=0x00100000000a936b
- (void)pause;	// IMP=0x00100000000a9365
- (void)start;	// IMP=0x00100000000a935f
- (id)initWithAttSiriController:(id)arg1;	// IMP=0x00100000000a9351
