...
- (void).cxx_destruct;	// IMP=0x0020000000083719
...
- (void)osdAnalyzer:(id)arg1 didDetectEndOfSpeechAt:(double)arg2;	// IMP=0x001000000008328b
- (void)osdAnalyzer:(id)arg1 didDetectStartOfSpeechAt:(double)arg2;	// IMP=0x00100000000830d3
- (void)osdAnalyzer:(id)arg1 didUpdateOSDFeatures:(id)arg2;	// IMP=0x0010000000082dab
- (void)endpointerAssetManagerDidUpdateAsset:(id)arg1;	// IMP=0x0010000000082da5
- (void)endpointerAssetManagerDidUpdateOSDAsset:(id)arg1;	// IMP=0x0010000000082cfa
- (unsigned long long)fetchLastKnownConsecutiveBoronStartSampleCount;	// IMP=0x0010000000082c51
- (unsigned long long)audioStartSampleCount;	// IMP=0x0010000000082ba5
- (void)resetForNewRequestWithRecordContext:(id)arg1 endpointerSettings:(id)arg2 voiceTriggerInfo:(id)arg3 osdMode:(unsigned long long)arg4;	// IMP=0x00100000000824c2
- (void)resetForNewRequestWithRecordContext:(id)arg1 endpointerSettings:(id)arg2 voiceTriggerInfo:(id)arg3;	// IMP=0x00100000000824ad
- (void)attSiriAudioSrcNodeDidStop:(id)arg1;	// IMP=0x0010000000082303
- (void)checkConsecutiveBoronSignalWithAudioChunk:(id)arg1;	// IMP=0x00100000000820ab
- (void)attSiriAudioSrcNodeLPCMRecordBufferAvailable:(id)arg1 audioChunk:(id)arg2;	// IMP=0x001000000008139d
- (void)attSiriAudioSrcNodeDidStartRecording:(id)arg1 successfully:(_Bool)arg2 error:(id)arg3;	// IMP=0x0010000000081397
- (void)stop;	// IMP=0x001000000008117f
- (void)pause;	// IMP=0x0010000000081179
- (void)start;	// IMP=0x0010000000081173
- (void)removeReceiver:(id)arg1;	// IMP=0x0010000000081012
- (void)addReceiver:(id)arg1;	// IMP=0x0010000000080e1b
- (id)initWithAttSiriController:(id)arg1;	// IMP=0x00100000000809d6
