...
- (void).cxx_destruct;	// IMP=0x002000000000a518
...
- (id)dictionary;	// IMP=0x001000000000a2a4
- (id)description;	// IMP=0x001000000000a1f3
- (id)initWithWordCount:(long long)arg1 trailingSilenceFrames:(long long)arg2 endOfSilenceLikelihood:(double)arg3 pauseCounts:(id)arg4 silencePosterior:(double)arg5 taskName:(id)arg6;	// IMP=0x001000000000a1d0
- (id)initWithWordCount:(long long)arg1 trailingSilenceDuration:(long long)arg2 eosLikelihood:(double)arg3 pauseCounts:(id)arg4 silencePosterior:(double)arg5 taskName:(id)arg6 processedAudioDurationInMilliseconds:(long long)arg7;	// IMP=0x001000000000a0fc
