...
- (void).cxx_destruct;	// IMP=0x002000000000c490
...
- (void)dispatchStateChangedFrom:(unsigned long long)arg1 to:(unsigned long long)arg2;	// IMP=0x001000000000bffe
- (void)notifyObserver:(id)arg1 didChangeStateFrom:(unsigned long long)arg2 to:(unsigned long long)arg3;	// IMP=0x001000000000bf1e
- (void)notifyObserver:(id)arg1 didReceiveNotificationWithToken:(int)arg2;	// IMP=0x001000000000be1c
- (id)initWithDelegate:(id)arg1;	// IMP=0x001000000000bca9
