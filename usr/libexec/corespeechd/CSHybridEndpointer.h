...
- (void).cxx_destruct;	// IMP=0x00200000000a4512
...
// Error: Property attributes should begin with the type ('T') attribute, property name: lastEndpointPosterior
...
- (_Bool)_multimodalEndpointerEnabled;	// IMP=0x00100000000a3f6c
- (_Bool)_shouldUsePhaticWithRecordContext;	// IMP=0x00100000000a3ece
- (id)_getCSHybridEndpointerConfigForAsset:(id)arg1;	// IMP=0x00100000000a3bf4
- (void)endpointerAssetManagerDidUpdateOSDAsset:(id)arg1;	// IMP=0x00100000000a3bee
- (void)endpointerAssetManagerDidUpdateAsset:(id)arg1;	// IMP=0x00100000000a3a25
...
- (void)reset;	// IMP=0x00100000000a3a0d
- (void)_readParametersFromHEPAsset:(id)arg1;	// IMP=0x00100000000a35da
- (void)resetForNewRequestWithSampleRate:(unsigned long long)arg1 recordContext:(id)arg2;	// IMP=0x00100000000a2b3a
- (void)stopEndpointer;	// IMP=0x00100000000a2aa4
- (void)recordingStoppedForReason:(long long)arg1;	// IMP=0x00100000000a29fc
- (void)terminateProcessing;	// IMP=0x00100000000a2971
- (void)preheat;	// IMP=0x00100000000a296b
- (void)handleVoiceTriggerWithActivationInfo:(id)arg1;	// IMP=0x00100000000a25f7
- (void)logFeaturesWithEvent:(id)arg1 locale:(id)arg2;	// IMP=0x00100000000a1ea4
- (void)_emitEndpointDetectedEventWithEndpointTimeMs:(double)arg1 endpointBufferHostTime:(unsigned long long)arg2 endpointerFeatures:(id)arg3 endpointerDecisionLagInNs:(double)arg4 extraDelayMs:(unsigned long long)arg5 endpointScore:(double)arg6 asrFeatureLatencies:(id)arg7;	// IMP=0x00100000000a1e93
- (void)processOSDFeatures:(id)arg1 withFrameDurationMs:(double)arg2;	// IMP=0x00100000000a00dc
- (void)processFirstAudioPacketTimestamp:(id)arg1 firstAudioSampleSensorTimestamp:(unsigned long long)arg2;	// IMP=0x001000000009ff64
- (void)logAnchorMachAbsTime:(unsigned long long)arg1 numSamplesProcessedBeforeAnchorTime:(unsigned long long)arg2 isAnchorTimeBuffered:(_Bool)arg3;	// IMP=0x001000000009fedc
- (void)shouldAcceptEagerResultForDuration:(double)arg1 resultsCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000009f7b5
- (void)processServerEndpointFeatures:(id)arg1;	// IMP=0x001000000009f438
- (void)processTaskString:(id)arg1;	// IMP=0x001000000009f0b2
- (void)processASRFeatures:(id)arg1 fromServer:(_Bool)arg2;	// IMP=0x001000000009f00b
- (long long)fetchCurrentEndpointerOperationMode;	// IMP=0x001000000009eec9
- (void)updateEndpointerDelayedTrigger:(_Bool)arg1;	// IMP=0x001000000009ecd2
- (void)_updateEndpointerDelayedTriggerByMhId:(id)arg1;	// IMP=0x001000000009ebbb
- (void)updateEndpointerThreshold:(float)arg1;	// IMP=0x001000000009eab0
- (void)processAudioSamplesAsynchronously:(id)arg1;	// IMP=0x001000000009eaaa
- (id)init;	// IMP=0x001000000009e388
