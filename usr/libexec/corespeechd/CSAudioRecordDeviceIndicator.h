...
- (void).cxx_destruct;	// IMP=0x00200000000e4eec
...
- (void)updateDeviceId:(id)arg1;	// IMP=0x00100000000e4eb4
- (void)updateWithLatestRecordContext:(id)arg1;	// IMP=0x00100000000e4d16
- (id)initWithRecordContext:(id)arg1 deviceId:(id)arg2 shouldUseRemoteRecorder:(_Bool)arg3 streamHandleId:(unsigned long long)arg4;	// IMP=0x00100000000e4c4d
