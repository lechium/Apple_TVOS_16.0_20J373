...
- (void).cxx_destruct;	// IMP=0x00200000000da5bd
...
- (void)audioEngineAudioChunkForTvAvailable:(id)arg1 audioChunk:(id)arg2;	// IMP=0x00100000000da459
- (void)audioEngineBufferAvailable:(id)arg1 audioStreamHandleId:(unsigned long long)arg2 buffer:(id)arg3 remoteVAD:(id)arg4 atTime:(unsigned long long)arg5;	// IMP=0x00100000000d9e0c
- (void)audioEngineDidStopRecord:(id)arg1 audioStreamHandleId:(unsigned long long)arg2 reason:(unsigned long long)arg3;	// IMP=0x00100000000d9e06
- (void)audioEngineDidStartRecord:(id)arg1 audioStreamHandleId:(unsigned long long)arg2 successfully:(_Bool)arg3 error:(id)arg4;	// IMP=0x00100000000d9e00
- (void)stopAudioStream;	// IMP=0x00100000000d9ce0
- (void)startAudioStreamWithOption:(id)arg1;	// IMP=0x00100000000d9b56
- (_Bool)isRecording;	// IMP=0x00100000000d9aa2
- (_Bool)injectAudio:(id)arg1 withScaleFactor:(float)arg2 playbackStarted:(CDUnknownBlockType)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00100000000d9a73
- (_Bool)injectAudio:(id)arg1;	// IMP=0x00100000000d9a44
- (void)stop;	// IMP=0x00100000000d997f
- (void)start;	// IMP=0x00100000000d98a7
- (void)dealloc;	// IMP=0x00100000000d97ed
- (void)attachDevice:(id)arg1;	// IMP=0x00100000000d96fb
- (_Bool)alwaysOnVoiceTriggerEnabled;	// IMP=0x00100000000d9647
- (void)setAlwaysOnVoiceTriggerEnabled:(_Bool)arg1;	// IMP=0x00100000000d95db
- (_Bool)isAlwaysOnVoiceTriggerAvailable;	// IMP=0x00100000000d95d3
- (id)initWithStreamHandleId:(unsigned long long)arg1;	// IMP=0x00100000000d946b
