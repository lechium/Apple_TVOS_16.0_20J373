...
- (void).cxx_destruct;	// IMP=0x00200000000bd84d
...
- (id)metrics;	// IMP=0x00100000000bd7b7
- (void)flush;	// IMP=0x00100000000bd72e
- (void)processBuffer:(id)arg1 atTime:(unsigned long long)arg2;	// IMP=0x00100000000bd469
- (void)resetWithSampleRate:(float)arg1 containsVoiceTrigger:(_Bool)arg2 voiceTriggerInfo:(id)arg3;	// IMP=0x00100000000bd1b1
- (id)init;	// IMP=0x00100000000bd182
