...
- (void).cxx_destruct;	// IMP=0x0020000000038e59
...
- (void)_reportUEIUserSpeakingContext;	// IMP=0x0010000000038d79
- (void)reportEndpointDelayIfNeed;	// IMP=0x0010000000038d73
- (void)setSpeechRecognizedContext:(id)arg1 withEndpointerMetrics:(id)arg2;	// IMP=0x0010000000038ad7
- (unsigned long long)estimatedUserSpeakingEndedHostTime;	// IMP=0x0010000000038a93
- (unsigned long long)estimatedUserSpeakingStartedHostTime;	// IMP=0x0010000000038a5d
- (void)reset;	// IMP=0x001000000003899c
- (id)initWithRequestMHUUID:(id)arg1 turnIdentifier:(id)arg2;	// IMP=0x0010000000038852
