...
- (void).cxx_destruct;	// IMP=0x0020000000036661
...
- (void)keywordAnalyzerNDEAPI:(id)arg1 hasResultAvailable:(id)arg2 forChannel:(unsigned long long)arg3;	// IMP=0x00100000000363d7
- (double)currentShadowMicScore;	// IMP=0x00100000000363a4
- (void)processAudioChunk:(id)arg1 activeChannel:(unsigned long long)arg2;	// IMP=0x0010000000036171
- (void)reset;	// IMP=0x0010000000036157
- (id)initWithAsset:(id)arg1 assetConfig:(id)arg2 firstPassSource:(unsigned long long)arg3 activeChannel:(unsigned long long)arg4 siriLanguage:(id)arg5 shouldEnableShadowMicScore:(_Bool)arg6;	// IMP=0x0010000000035f7a
