...
- (void).cxx_destruct;	// IMP=0x00200000000e052a
...
- (struct AudioStreamBasicDescription)_defaultOutASBD;	// IMP=0x00100000000e0316
- (id)_compensateChannelDataIfNeeded:(id)arg1 receivedNumChannels:(unsigned int)arg2;	// IMP=0x00100000000e0140
- (id)_deinterleaveBufferIfNeeded:(struct AudioBufferList *)arg1;	// IMP=0x00100000000dffe9
- (void)stopAudioStream;	// IMP=0x00100000000dfe91
- (void)startAudioStreamWithOption:(id)arg1;	// IMP=0x00100000000dfda2
- (_Bool)injectAudio:(id)arg1 withScaleFactor:(float)arg2 outASBD:(struct AudioStreamBasicDescription)arg3 playbackStarted:(CDUnknownBlockType)arg4 completion:(CDUnknownBlockType)arg5;	// IMP=0x00100000000df84e
- (_Bool)injectAudio:(id)arg1 withScaleFactor:(float)arg2 playbackStarted:(CDUnknownBlockType)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x00100000000df78d
- (_Bool)injectAudio:(id)arg1;	// IMP=0x00100000000df76e
- (void)_readAudioBufferAndFeed;	// IMP=0x00100000000deaf9
- (void)_startAudioFeedingTimer;	// IMP=0x00100000000de9d6
- (void)stop;	// IMP=0x00100000000de851
- (void)_createDeInterleaverIfNeeded;	// IMP=0x00100000000de6be
- (void)start;	// IMP=0x00100000000de640
- (void)attachDevice:(id)arg1;	// IMP=0x00100000000de63a
- (_Bool)alwaysOnVoiceTriggerEnabled;	// IMP=0x00100000000de632
- (void)setAlwaysOnVoiceTriggerEnabled:(_Bool)arg1;	// IMP=0x00100000000de62c
- (_Bool)isAlwaysOnVoiceTriggerAvailable;	// IMP=0x00100000000de624
- (void)dealloc;	// IMP=0x00100000000de5d4
- (id)initWithStreamHandleId:(unsigned long long)arg1;	// IMP=0x00000000000de4ae
