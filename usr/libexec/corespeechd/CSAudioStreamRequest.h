...
+ (id)requestForSpeexRecordSettingsWithContext:(id)arg1;	// IMP=0x00200000000c4215
+ (id)requestForOpusRecordSettingsWithContext:(id)arg1;	// IMP=0x00100000000c40a7
+ (id)requestForLpcmRecordSettingsWithContext:(id)arg1;	// IMP=0x00100000000c3f1c
+ (id)defaultRequestWithContext:(id)arg1;	// IMP=0x00100000000c3c74
- (void).cxx_destruct;	// IMP=0x00200000000c4a81
...
- (id)description;	// IMP=0x00100000000c48b1
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000c47d0
@property(readonly, nonatomic) NSObject<OS_xpc_object> *xpcObject;
- (id)initWithXPCObject:(id)arg1;	// IMP=0x00100000000c44e3
- (id)initTandemWithRequest:(id)arg1;	// IMP=0x00100000000c4374
