...
+ (unsigned long long)getSSVDeviceType;	// IMP=0x0010000000039b9c
+ (unsigned int)SSVDefaultDistanceChannelCount;	// IMP=0x0010000000039b3e
+ (unsigned int)SSVDefaultLKFSChannelCount;	// IMP=0x0010000000039aeb
+ (unsigned int)SSVDefaultNoiseChannelCount;	// IMP=0x0010000000039a8d
- (unsigned long long)_mapInputOriginFromAssetToCSAudioRecordType:(id)arg1;	// IMP=0x001000000003709c
...
- (id)_getNumberFromASVDictionaryForKey:(id)arg1 category:(id)arg2 default:(id)arg3;	// IMP=0x001000000003c0c1
...
- (id)_adaptiveSiriVolumeDictionary;	// IMP=0x0010000000038e81
- (id)_sha256:(id)arg1;	// IMP=0x0010000000053783
- (id)_sha1:(id)arg1;	// IMP=0x0010000000053692
- (id)localeMapWithName:(id)arg1;	// IMP=0x00100000000534e9
- (id)rtModelLocaleMapWithModelType:(long long)arg1;	// IMP=0x00100000000534b5
- (id)remoraRTModelLocaleMap;	// IMP=0x001000000005349c
- (id)jarvisRTModelLocaleMap;	// IMP=0x0010000000053483
- (id)hearstRTModelLocaleMap;	// IMP=0x001000000005346a
- (id)hearstRTModelWithMajorVersion:(unsigned long long)arg1 minorVersion:(unsigned long long)arg2 locale:(id)arg3;	// IMP=0x001000000005344d
- (id)remoraRTModelWithMajorVersion:(unsigned long long)arg1 minorVersion:(unsigned long long)arg2 locale:(id)arg3;	// IMP=0x001000000005342d
- (id)rtModelWithAccessoryRTModelType:(long long)arg1 majorVersion:(unsigned long long)arg2 minorVersion:(unsigned long long)arg3 locale:(id)arg4;	// IMP=0x0010000000052c09
- (id)latestHearstRTModelForLocale:(id)arg1;	// IMP=0x001000000005283b
- (id)RTModelWithFallbackLanguage:(id)arg1;	// IMP=0x00100000000527d5
- (id)createRTModelWithLocale:(id)arg1;	// IMP=0x00100000000527a1
...
- (long long)multiUserLowScoreThreshold;	// IMP=0x0010000000088426
@property(readonly, nonatomic) float satScoreThreshold;
- (float)satScoreThresholdForPhId:(unsigned long long)arg1;	// IMP=0x0010000000088267
@property(readonly, nonatomic) _Bool containsSpeakerRecognitionCategory;
- (_Bool)isHSVoiceTrigger:(id)arg1;	// IMP=0x00100000000c3263
- (id)getCategoryKeyWithRecordCtx:(id)arg1;	// IMP=0x00100000000c31fe
- (_Bool)shouldRunSpkrIdForCategory:(id)arg1;	// IMP=0x00100000000c31dc
- (id)nldaConfigFileForCategory:(id)arg1;	// IMP=0x00100000000c312a
- (id)mitigationConfigFileForCategory:(id)arg1;	// IMP=0x00100000000c3078
...
- (id)nldaConfigFile;	// IMP=0x00100000000c2edb
@property(readonly, nonatomic) float mitigationModelDefaultAFTMScore;
- (id)mitigatonConfigFile;	// IMP=0x00100000000c2de1
