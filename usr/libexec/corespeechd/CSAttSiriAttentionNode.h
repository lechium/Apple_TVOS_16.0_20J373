...
+ (_Bool)supportAttentionLostAndGain;	// IMP=0x00200000000d18da
- (void).cxx_destruct;	// IMP=0x00200000000d196c
...
- (void)removeReceiver:(id)arg1;	// IMP=0x00100000000d1908
- (void)addReceiver:(id)arg1;	// IMP=0x00100000000d1902
- (void)stop;	// IMP=0x00100000000d18fc
- (void)pause;	// IMP=0x00100000000d18f6
- (void)start;	// IMP=0x00100000000d18f0
- (id)initWithAttSiriController:(id)arg1;	// IMP=0x00100000000d18e2
