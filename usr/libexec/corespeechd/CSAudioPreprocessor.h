...
- (void).cxx_destruct;	// IMP=0x002000000009aa2d
...
- (void)beepCancellerDidCancelSamples:(id)arg1 buffer:(id)arg2 timestamp:(unsigned long long)arg3;	// IMP=0x001000000009a8ef
- (void)zeroFilter:(id)arg1 zeroFilteredBufferAvailable:(id)arg2 atHostTime:(unsigned long long)arg3;	// IMP=0x001000000009a816
- (_Bool)_isNarrowBand:(float)arg1;	// IMP=0x001000000009a7e2
- (id)_fetchCurrentMetrics;	// IMP=0x001000000009a628
- (void)_reportMetrics;	// IMP=0x001000000009a5ad
- (void)reportMetricsForSiriRequestWithUUID:(id)arg1;	// IMP=0x001000000009a5a7
- (void)willBeepWithRecordRoute:(id)arg1 playbackRoute:(id)arg2;	// IMP=0x001000000009a547
- (void)flush;	// IMP=0x001000000009a40f
- (void)processBuffer:(id)arg1 atTime:(unsigned long long)arg2 arrivalTimestampToAudioRecorder:(unsigned long long)arg3;	// IMP=0x001000000009a1db
- (void)resetWithSampleRate:(float)arg1 containsVoiceTrigger:(_Bool)arg2 voiceTriggerInfo:(id)arg3;	// IMP=0x0010000000099fa3
- (id)initWithSampleRate:(float)arg1 withNumberOfChannels:(int)arg2;	// IMP=0x0010000000099e6d
