...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000001280ff
- (unsigned long long)hash;	// IMP=0x0010000000128068
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000127f74
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000127eaa
- (void)copyTo:(id)arg1;	// IMP=0x0010000000127e1e
- (void)writeTo:(id)arg1;	// IMP=0x0010000000127d55
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000127d48
- (id)dictionaryRepresentation;	// IMP=0x0010000000127768
- (id)description;	// IMP=0x00100000001276f1
