...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000ee80b
- (unsigned long long)hash;	// IMP=0x00100000000ee46b
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000ee348
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000ee267
- (void)copyTo:(id)arg1;	// IMP=0x00100000000ee1c4
- (void)writeTo:(id)arg1;	// IMP=0x00100000000ee0cd
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000ee0c0
- (id)dictionaryRepresentation;	// IMP=0x00100000000ed994
- (id)description;	// IMP=0x00100000000ed91d
