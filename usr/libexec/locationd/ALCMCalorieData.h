...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000002bf378
- (unsigned long long)hash;	// IMP=0x00100000002bee0c
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000002bec91
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000002beb81
- (void)copyTo:(id)arg1;	// IMP=0x00100000002beaaf
- (void)writeTo:(id)arg1;	// IMP=0x00100000002be981
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000002be974
- (id)dictionaryRepresentation;	// IMP=0x00100000002bde08
- (id)description;	// IMP=0x00100000002bdd91
@property(nonatomic) _Bool hasMetsFM;
@property(nonatomic) _Bool hasMetsWR;
@property(nonatomic) _Bool hasMetsHR;
- (int)StringAsTruthMetsSource:(id)arg1;	// IMP=0x00100000002bdc0e
- (id)truthMetsSourceAsString:(int)arg1;	// IMP=0x00100000002bdbd5
...
- (int)StringAsUserMetsSource:(id)arg1;	// IMP=0x00100000002bdac7
- (id)userMetsSourceAsString:(int)arg1;	// IMP=0x00100000002bda8e
...
- (int)StringAsActivityType:(id)arg1;	// IMP=0x00100000002bd518
- (id)activityTypeAsString:(int)arg1;	// IMP=0x00100000002bd174
