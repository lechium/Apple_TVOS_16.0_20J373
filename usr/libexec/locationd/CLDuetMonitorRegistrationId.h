...
+ (id)withEvent:(long long)arg1 andPredicate:(id)arg2;	// IMP=0x00200000004670d5
...
- (void)dealloc;	// IMP=0x0010000000467198
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000046703b
- (unsigned long long)hash;	// IMP=0x0010000000466fd0
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000466f18
