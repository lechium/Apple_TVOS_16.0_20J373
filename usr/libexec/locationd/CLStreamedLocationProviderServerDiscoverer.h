...
- (void)findCandidateServersWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00100000000e6d87
- (id)deviceWithEffectiveID:(id)arg1;	// IMP=0x00100000000e6b6c
- (void)invalidate;	// IMP=0x00100000000e6a40
- (void)dealloc;	// IMP=0x00100000000e6a02
- (id)initOnQueue:(id)arg1;	// IMP=0x00100000000e64d6
