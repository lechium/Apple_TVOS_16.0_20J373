...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000d1bb6
- (unsigned long long)hash;	// IMP=0x00100000000d1a0d
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000d1901
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000d1828
- (void)copyTo:(id)arg1;	// IMP=0x00100000000d178d
- (void)writeTo:(id)arg1;	// IMP=0x00100000000d16ad
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000d16a0
- (id)dictionaryRepresentation;	// IMP=0x00100000000d0ff5
- (id)description;	// IMP=0x00100000000d0f7e
- (int)StringAsSource:(id)arg1;	// IMP=0x00100000000d0f37
- (id)sourceAsString:(int)arg1;	// IMP=0x00100000000d0ef8
@property(nonatomic) _Bool hasSource;
@property(nonatomic) int source; // @synthesize source=_source;
- (int)StringAsRawGradeType:(id)arg1;	// IMP=0x00100000000d0e08
- (id)rawGradeTypeAsString:(int)arg1;	// IMP=0x00100000000d0dcf
...
- (int)StringAsGradeType:(id)arg1;	// IMP=0x00100000000d0c92
- (id)gradeTypeAsString:(int)arg1;	// IMP=0x00100000000d0c59
