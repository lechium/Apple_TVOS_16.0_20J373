...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000018b9d1
- (unsigned long long)hash;	// IMP=0x001000000018b56c
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000018b454
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000018b37c
- (void)copyTo:(id)arg1;	// IMP=0x001000000018b2e2
- (void)writeTo:(id)arg1;	// IMP=0x001000000018b1f5
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000018b1e8
- (id)dictionaryRepresentation;	// IMP=0x001000000018abb2
- (id)description;	// IMP=0x001000000018ab3b
