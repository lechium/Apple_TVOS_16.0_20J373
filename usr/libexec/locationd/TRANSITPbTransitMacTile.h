...
+ (Class)macsType;	// IMP=0x0020000000377e25
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000378e8b
- (unsigned long long)hash;	// IMP=0x0010000000378ccc
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000378ba3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000378949
- (void)copyTo:(id)arg1;	// IMP=0x001000000037882a
- (void)writeTo:(id)arg1;	// IMP=0x0010000000378679
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000037866c
- (id)dictionaryRepresentation;	// IMP=0x0010000000377ead
- (id)description;	// IMP=0x0010000000377e36
- (id)macsAtIndex:(unsigned long long)arg1;	// IMP=0x0010000000377e08
- (unsigned long long)macsCount;	// IMP=0x0010000000377deb
- (void)addMacs:(id)arg1;	// IMP=0x0010000000377d9e
- (void)clearMacs;	// IMP=0x0010000000377d81
...
- (void)dealloc;	// IMP=0x0010000000377bd0
