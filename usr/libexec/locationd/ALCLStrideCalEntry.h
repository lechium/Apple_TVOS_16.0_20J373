...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000ed5bf
- (unsigned long long)hash;	// IMP=0x00100000000ecd7c
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000ecbad
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000eca6d
- (void)copyTo:(id)arg1;	// IMP=0x00100000000ec96b
- (void)writeTo:(id)arg1;	// IMP=0x00100000000ec7e5
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000ec7d8
- (id)dictionaryRepresentation;	// IMP=0x00100000000ebe21
- (id)description;	// IMP=0x00100000000ebdaa
