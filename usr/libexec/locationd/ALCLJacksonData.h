...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000151e77
- (unsigned long long)hash;	// IMP=0x0010000000151c39
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000151b79
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000151ace
- (void)copyTo:(id)arg1;	// IMP=0x0010000000151a61
- (void)writeTo:(id)arg1;	// IMP=0x00100000001519bd
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000001519b0
- (id)dictionaryRepresentation;	// IMP=0x0010000000151548
- (id)description;	// IMP=0x00100000001514d1
