...
- (id)debugDescription;	// IMP=0x00100000007ffb88
- (id)description;	// IMP=0x00100000007ffb1f
- (id)initWithArchive:(id)arg1 index:(unsigned int)arg2 score:(float)arg3 unslammedAPCount:(unsigned int)arg4 macsNotInALSDatabase:(id)arg5;	// IMP=0x00100000007ffa93
