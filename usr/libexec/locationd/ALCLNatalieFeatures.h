...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000f1ecd
- (unsigned long long)hash;	// IMP=0x00100000000f1a06
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000f193a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000f1887
- (void)copyTo:(id)arg1;	// IMP=0x00100000000f1812
- (void)writeTo:(id)arg1;	// IMP=0x00100000000f1755
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000f1748
- (id)dictionaryRepresentation;	// IMP=0x00100000000f1193
- (id)description;	// IMP=0x00100000000f111c
- (int)StringAsFEpochType:(id)arg1;	// IMP=0x00100000000f10b5
- (id)fEpochTypeAsString:(int)arg1;	// IMP=0x00100000000f107c
