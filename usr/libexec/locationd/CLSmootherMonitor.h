...
+ (id)getSilo;	// IMP=0x0020000000a4a0bc
+ (void)performSyncOnSilo:(id)arg1 invoker:(CDUnknownBlockType)arg2;	// IMP=0x0010000000a4a0a3
+ (void)becameFatallyBlocked:(id)arg1 index:(unsigned long long)arg2;	// IMP=0x0010000000a4a046
...
- (void)smoothLocations:(id)arg1 workoutActivity:(int)arg2 handler:(CDUnknownBlockType)arg3;	// IMP=0x0010000000a4acd3
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0010000000a4a405
- (void)dealloc;	// IMP=0x0010000000a4a3d6
- (void)endService;	// IMP=0x0010000000a4a2c0
- (void)beginService;	// IMP=0x0010000000a4a155
- (id)init;	// IMP=0x0010000000a4a118
