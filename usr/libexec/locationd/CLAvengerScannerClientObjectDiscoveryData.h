...
- (void)dealloc;	// IMP=0x0010000000a7b00a
- (id)initWithAddress:(id)arg1 advertisementData:(id)arg2 status:(unsigned char)arg3 reserved:(id)arg4 rssi:(long long)arg5 scanDate:(id)arg6 channel:(id)arg7;	// IMP=0x0010000000a7af66
