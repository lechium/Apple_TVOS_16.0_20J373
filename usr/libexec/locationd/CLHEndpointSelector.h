...
- (id)description;	// IMP=0x00100000009cd77c
- (id)jsonObject;	// IMP=0x00100000009cd602
- (void)updateEndpoint:(id *)arg1 withKey:(id)arg2;	// IMP=0x00100000009cd470
- (void)refresh;	// IMP=0x00100000009cd384
- (void)dealloc;	// IMP=0x00100000009cd302
- (id)init;	// IMP=0x00100000009cd15f
