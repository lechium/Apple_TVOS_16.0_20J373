...
- (void)fireAlarm:(id)arg1 error:(int)arg2;	// IMP=0x0010000000393593
- (void)onNotification:(int)arg1 withData:(id)arg2;	// IMP=0x001000000039358d
- (id)initWithMotionAlarmSubscription:(void *)arg1;	// IMP=0x0010000000393550
