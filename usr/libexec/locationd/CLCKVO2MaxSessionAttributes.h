...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000809d4a
- (unsigned long long)hash;	// IMP=0x00100000008099c9
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000080987e
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000809791
- (void)copyTo:(id)arg1;	// IMP=0x00100000008096e2
- (void)writeTo:(id)arg1;	// IMP=0x00100000008095f5
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000008095e8
- (id)dictionaryRepresentation;	// IMP=0x001000000080900b
- (id)description;	// IMP=0x0010000000808f94
