...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000006f3abe
- (unsigned long long)hash;	// IMP=0x00100000006f39aa
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000006f3821
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000006f36fc
- (void)copyTo:(id)arg1;	// IMP=0x00100000006f3615
- (void)writeTo:(id)arg1;	// IMP=0x00100000006f34c9
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000006f34bc
- (id)dictionaryRepresentation;	// IMP=0x00100000006f2b7c
- (id)description;	// IMP=0x00100000006f2b05
