...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000004d5592
- (unsigned long long)hash;	// IMP=0x00100000004d4f12
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000004d4d70
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000004d4c52
- (void)copyTo:(id)arg1;	// IMP=0x00100000004d4b6a
- (void)writeTo:(id)arg1;	// IMP=0x00100000004d4a15
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000004d4a08
- (id)dictionaryRepresentation;	// IMP=0x00100000004d3d8d
- (id)description;	// IMP=0x00100000004d3d16
@property(nonatomic) _Bool hasMetsWR;
@property(nonatomic) _Bool hasMetsHR;
@property(nonatomic) _Bool hasTimestamp;
- (int)StringAsMetSource:(id)arg1;	// IMP=0x00100000004d3bb1
- (id)metSourceAsString:(int)arg1;	// IMP=0x00100000004d3b78
- (int)StringAsActivityType:(id)arg1;	// IMP=0x00100000004d366c
- (id)activityTypeAsString:(int)arg1;	// IMP=0x00100000004d32c7
