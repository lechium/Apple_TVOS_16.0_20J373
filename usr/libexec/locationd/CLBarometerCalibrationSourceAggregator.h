...
+ (_Bool)isLocationUsefulForCalibration:(struct NotificationData)arg1;	// IMP=0x0020000000804c27
- (id).cxx_construct;	// IMP=0x0020000000804ff3
- (void).cxx_destruct;	// IMP=0x0010000000804fe1
...
- (_Bool)goodSurfaceCalibration:(float)arg1;	// IMP=0x0010000000804d33
- (void)wetStateUpdated:(unsigned long long)arg1;	// IMP=0x0010000000804d17
- (array_c343414b)copyDataBuffersForTrack:(unsigned long long)arg1;	// IMP=0x0010000000804b40
- (void)didUpdateSource:(unsigned long long)arg1 withData:(shared_ptr_16a5184d)arg2;	// IMP=0x0010000000802bf2
- (void)disableSources:(id)arg1 forContext:(id)arg2;	// IMP=0x00100000008029fc
- (void)enableSources:(id)arg1 forContext:(id)arg2;	// IMP=0x0010000000802806
- (void)dealloc;	// IMP=0x001000000080274e
- (id)initWithUniverse:(id)arg1 buffers:(void *)arg2;	// IMP=0x001000000080248b
