...
- (void)_clearBuffers;	// IMP=0x00100000007dafea
- (unsigned long long)_removeAdditionalInconsistentSpeedPedometerEntries;	// IMP=0x00100000007dada2
- (void)_closeCurrentTrack;	// IMP=0x00100000007da428
- (void)_closeTrackCheckPedometer;	// IMP=0x00100000007d9be4
- (void)_closeTrackCheckGpsOdometer;	// IMP=0x00100000007d94c0
- (void)_closeTrackCheckGpsLocationFiltered;	// IMP=0x00100000007d912b
- (void)_closeTrackCheckGpsLocation;	// IMP=0x00100000007d8f50
- (void)_calculateTimeStartEndDistanceGpsPed;	// IMP=0x00100000007d8405
- (double)_extremaRemovedMean:(double [5])arg1;	// IMP=0x00100000007d83a1
- (id)_filterGpsLocationBuffer;	// IMP=0x00100000007d7e3d
- (void)updatePedometerBuffer:(struct CLExtendedStepCountEntry)arg1;	// IMP=0x00100000007d7cf3
- (void)updateGpsOdometerBuffer:(struct CLOdometerEntry)arg1;	// IMP=0x00100000007d7a81
- (void)_updateGpsLocationBufferFiltered:(id)arg1;	// IMP=0x00100000007d79a8
- (void)updateGpsLocationBuffer:(id)arg1 gpsSource:(int)arg2;	// IMP=0x00100000007d733f
- (void)stop;	// IMP=0x00100000007d7273
- (void)dealloc;	// IMP=0x00100000007d71f8
- (id)init;	// IMP=0x00100000007d7067
