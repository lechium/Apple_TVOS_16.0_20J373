...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000001532c2
- (unsigned long long)hash;	// IMP=0x001000000015309f
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000152ebb
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000152d49
- (void)copyTo:(id)arg1;	// IMP=0x0010000000152c1b
- (void)writeTo:(id)arg1;	// IMP=0x0010000000152ad9
- (_Bool)readFrom:(id)arg1;	// IMP=0x0010000000152acc
- (id)dictionaryRepresentation;	// IMP=0x0010000000152280
- (id)description;	// IMP=0x0010000000152209
...
- (void)dealloc;	// IMP=0x0010000000151f38
