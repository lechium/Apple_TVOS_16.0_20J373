...
+ (_Bool)isSupported;	// IMP=0x0020000000a07752
+ (id)getSilo;	// IMP=0x0010000000a076f6
+ (void)performSyncOnSilo:(id)arg1 invoker:(CDUnknownBlockType)arg2;	// IMP=0x0010000000a076dd
+ (void)becameFatallyBlocked:(id)arg1 index:(unsigned long long)arg2;	// IMP=0x0010000000a07680
- (id).cxx_construct;	// IMP=0x0020000000a09ad1
- (void).cxx_destruct;	// IMP=0x0010000000a09a8c
...
- (void)stopLocation;	// IMP=0x0010000000a0985a
- (void)activateRapportLinkIfNecessary;	// IMP=0x0010000000a09067
- (void)registerRequestHandlers;	// IMP=0x0010000000a0879c
- (void)onLocationNotification:(const int *)arg1 withData:(const void *)arg2;	// IMP=0x0010000000a0813f
- (void)toggleLocationUpdates:(_Bool)arg1 inFitnessSession:(_Bool)arg2 inAirborneSession:(_Bool)arg3 emergencyEnablementAssertionActive:(_Bool)arg4;	// IMP=0x0010000000a07f84
- (void)endService;	// IMP=0x0010000000a07b37
- (void)beginService;	// IMP=0x0010000000a077bc
- (id)init;	// IMP=0x0010000000a0777f
