...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000ff068
- (unsigned long long)hash;	// IMP=0x00100000000feb66
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000fe95d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000fe7fd
- (void)copyTo:(id)arg1;	// IMP=0x00100000000fe6db
- (void)writeTo:(id)arg1;	// IMP=0x00100000000fe555
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000fe548
- (id)dictionaryRepresentation;	// IMP=0x00100000000fd74b
- (id)description;	// IMP=0x00100000000fd6d4
@property(nonatomic) _Bool hasIsVehicleConnected;
@property(nonatomic) _Bool hasStartTime;
@property(nonatomic) _Bool hasEstExitTime;
- (int)StringAsExitState:(id)arg1;	// IMP=0x00100000000fd58d
- (id)exitStateAsString:(int)arg1;	// IMP=0x00100000000fd554
...
- (int)StringAsMountedConfidence:(id)arg1;	// IMP=0x00100000000fd3ea
- (id)mountedConfidenceAsString:(int)arg1;	// IMP=0x00100000000fd3b1
...
- (int)StringAsMountedState:(id)arg1;	// IMP=0x00100000000fd2ff
- (id)mountedStateAsString:(int)arg1;	// IMP=0x00100000000fd2c0
@property(nonatomic) _Bool hasMountedState;
@property(nonatomic) int mountedState; // @synthesize mountedState=_mountedState;
- (int)StringAsConfidence:(id)arg1;	// IMP=0x00100000000fd1ee
- (id)confidenceAsString:(int)arg1;	// IMP=0x00100000000fd1b5
@property(nonatomic) _Bool hasConfidence;
@property(nonatomic) int confidence; // @synthesize confidence=_confidence;
- (int)StringAsType:(id)arg1;	// IMP=0x00100000000fcc40
- (id)typeAsString:(int)arg1;	// IMP=0x00100000000fc89c
