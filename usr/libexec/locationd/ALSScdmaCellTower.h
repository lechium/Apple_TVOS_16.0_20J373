...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000009ad7c7
- (unsigned long long)hash;	// IMP=0x00100000009ad6f9
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000009ad5f4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000009ad507
- (void)copyTo:(id)arg1;	// IMP=0x00100000009ad464
- (void)writeTo:(id)arg1;	// IMP=0x00100000009ad381
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000009ad374
- (id)dictionaryRepresentation;	// IMP=0x00100000009accd6
- (id)description;	// IMP=0x00100000009acc5f
@property(nonatomic) _Bool hasPsc;
@property(nonatomic) _Bool hasArfcn;
@property(readonly, nonatomic) _Bool hasLocation;
- (void)dealloc;	// IMP=0x00100000009acb7c
