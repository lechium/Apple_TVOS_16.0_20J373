...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000005da6cf
- (unsigned long long)hash;	// IMP=0x00100000005d9d6d
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000005d9a6a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000005d9888
- (void)copyTo:(id)arg1;	// IMP=0x00100000005d96e4
- (void)writeTo:(id)arg1;	// IMP=0x00100000005d94d9
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000005d94cc
- (id)dictionaryRepresentation;	// IMP=0x00100000005d8932
- (id)description;	// IMP=0x00100000005d88bb
