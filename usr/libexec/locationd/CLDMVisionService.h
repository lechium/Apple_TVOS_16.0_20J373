...
+ (_Bool)isSupported;	// IMP=0x00200000005ed284
+ (id)getSilo;	// IMP=0x00100000005ed228
+ (void)performSyncOnSilo:(id)arg1 invoker:(CDUnknownBlockType)arg2;	// IMP=0x00100000005ed20f
+ (void)becameFatallyBlocked:(id)arg1 index:(unsigned long long)arg2;	// IMP=0x00100000005ed1b2
- (id).cxx_construct;	// IMP=0x00200000005ed37e
- (void).cxx_destruct;	// IMP=0x00100000005ed302
- (id)init;	// IMP=0x00100000005ed2b1
