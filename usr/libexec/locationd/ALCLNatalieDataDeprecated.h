...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000007dd46e
- (unsigned long long)hash;	// IMP=0x00100000007dcfa6
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000007dcdff
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000007dccd8
- (void)copyTo:(id)arg1;	// IMP=0x00100000007dcbe3
- (void)writeTo:(id)arg1;	// IMP=0x00100000007dcaa1
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000007dca94
- (id)dictionaryRepresentation;	// IMP=0x00100000007dbe2f
- (id)description;	// IMP=0x00100000007dbdb8
...
- (int)StringAsActivityType:(id)arg1;	// IMP=0x00100000007db734
- (id)activityTypeAsString:(int)arg1;	// IMP=0x00100000007db38f
