...
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000077afec
- (_Bool)inUseLevelIsAtLeast:(int)arg1;	// IMP=0x001000000077afe0
- (_Bool)isAuthorizedForServiceType:(unsigned long long)arg1;	// IMP=0x001000000077afc1
- (_Bool)isAuthorizedForServiceTypeMask:(unsigned long long)arg1;	// IMP=0x001000000077af7a
- (_Bool)isNonProvisionallyAuthorizedForServiceType:(unsigned long long)arg1;	// IMP=0x001000000077af5b
- (_Bool)isNonProvisionallyAuthorizedForServiceTypeMask:(unsigned long long)arg1;	// IMP=0x001000000077af35
- (id)description;	// IMP=0x001000000077aef4
- (id)authorizationContextByANDingServiceMaskTuple:(struct CLClientServiceTypeMaskTuple)arg1;	// IMP=0x001000000077ae6b
- (id)initWithInUseLevel:(int)arg1 registrationResult:(int)arg2 transientAwareRegistrationResult:(int)arg3 serviceMaskTuple:(struct CLClientServiceTypeMaskTuple)arg4 authorizedForWidgetUpdates:(_Bool)arg5;	// IMP=0x001000000077ae04
