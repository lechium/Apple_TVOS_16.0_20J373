...
- (void).cxx_destruct;	// IMP=0x002000000001122c
...
- (id)pairingNotification:(id *)arg1;	// IMP=0x00100000000111d9
- (void)stop;	// IMP=0x0010000000011079
- (void)start;	// IMP=0x0010000000010f74
- (void)dealloc;	// IMP=0x0010000000010f0f
- (id)initWithTokenServer:(id)arg1 tokenRegistry:(id)arg2;	// IMP=0x0010000000010d5c
- (void)hostTokenRegistry:(id)arg1 removedToken:(id)arg2;	// IMP=0x0010000000010a51
- (void)hostTokenRegistry:(id)arg1 addedToken:(id)arg2;	// IMP=0x001000000001043c
- (void)getEndpoint:(CDUnknownBlockType)arg1;	// IMP=0x00100000000103cf
- (void)startWatchingWithReply:(CDUnknownBlockType)arg1;	// IMP=0x001000000000fd3e
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x001000000000fab3
