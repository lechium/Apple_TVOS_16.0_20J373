...
- (void).cxx_destruct;	// IMP=0x0020000000003b92
...
- (void)run;	// IMP=0x00100000000035a2
- (void)ensureSlotWatcherIsRunning;	// IMP=0x001000000000351d
- (id)initWithArgc:(int)arg1 argv:(const char **)arg2;	// IMP=0x00100000000032db
...
- (void)initializeSandBox;	// IMP=0x00100000000031c1
