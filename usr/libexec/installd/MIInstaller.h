...
+ (id)installerForURL:(id)arg1 identity:(id)arg2 domain:(unsigned long long)arg3 options:(id)arg4 forClient:(id)arg5;	// IMP=0x0040000000016326
- (void).cxx_destruct;	// IMP=0x002000000001ca6b
...
// Error: Property attributes should begin with the type ('T') attribute, property name: installURL
...
- (_Bool)performInstallationWithError:(id *)arg1;	// IMP=0x001000000001bcd8
- (_Bool)_registerInstalledInfo:(id)arg1 error:(id *)arg2;	// IMP=0x001000000001bad5
- (_Bool)_onRegistrationQueue_registerInstalledInfo:(id)arg1 error:(id *)arg2;	// IMP=0x001000000001b54c
- (_Bool)_installInstallable:(id)arg1 containingSymlink:(_Bool)arg2 error:(id *)arg3;	// IMP=0x001000000001a676
- (_Bool)_installProvisioningProfilesAtStagingRootWithError:(id *)arg1;	// IMP=0x001000000001a177
- (_Bool)_installProvisioningProfilesFromUserOptionsWithError:(id *)arg1;	// IMP=0x0010000000019d50
- (id)_discoverInstallableWithError:(id *)arg1;	// IMP=0x0010000000018d22
- (_Bool)_writeLockBundle:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000018c32
- (id)_identifiersToLockForBundle:(id)arg1 error:(id *)arg2;	// IMP=0x00100000000189ae
- (id)_bundleInDirectory:(id)arg1 withBundleID:(id)arg2 error:(id *)arg3;	// IMP=0x001000000001819a
- (id)_manifestPathForBase:(id)arg1 withIdentifier:(id)arg2 patchType:(unsigned char *)arg3 error:(id *)arg4;	// IMP=0x0010000000017ca9
- (_Bool)_extractPackageContainedSymlink:(_Bool *)arg1 withError:(id *)arg2;	// IMP=0x00100000000174a7
- (_Bool)_setupPackageStateWithError:(id *)arg1;	// IMP=0x0010000000016722
- (_Bool)_takeOwnershipOfInstallableContainingSymlink:(_Bool *)arg1 error:(id *)arg2;	// IMP=0x00100000000164cc
- (void)_fireCallbackWithStatus:(id)arg1;	// IMP=0x001000000001645a
- (void)_fireCallbackWithStatus:(id)arg1 percentComplete:(unsigned int)arg2;	// IMP=0x00100000000163e2
- (void)dealloc;	// IMP=0x0010000000016241
- (id)initWithURL:(id)arg1 identity:(id)arg2 domain:(unsigned long long)arg3 options:(id)arg4 forClient:(id)arg5;	// IMP=0x0010000000016151
- (id)init;	// IMP=0x0010000000016148
