...
+ (id)defaultManager;	// IMP=0x0040000000036162
- (void).cxx_destruct;	// IMP=0x002000000003675a
...
- (void)waitForSystemAppMigrationToComplete:(CDUnknownBlockType)arg1;	// IMP=0x0010000000036513
@property(nonatomic) _Bool systemAppMigrationComplete; // @synthesize systemAppMigrationComplete=_systemAppMigrationComplete;
- (id)init;	// IMP=0x0010000000036024
