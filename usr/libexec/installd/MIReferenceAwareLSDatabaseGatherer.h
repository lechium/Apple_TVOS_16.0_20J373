...
- (id)initWithOptions:(unsigned long long)arg1 forTargetUID:(unsigned int)arg2 enumerator:(CDUnknownBlockType)arg3;	// IMP=0x00100000000160ce
- (_Bool)scanExecutableBundle:(id)arg1 inContainer:(id)arg2 withError:(id *)arg3;	// IMP=0x0010000000015e69
