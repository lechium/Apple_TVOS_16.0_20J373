...
- (void).cxx_destruct;	// IMP=0x00200000000301b8
...
- (_Bool)applyPatchWithError:(id *)arg1;	// IMP=0x001000000002fe49
- (_Bool)_applyDeltaPatchWithError:(id *)arg1;	// IMP=0x001000000002f787
@property(readonly, nonatomic) NSString *patchTypeName; // @dynamic patchTypeName;
- (id)initWithBundle:(id)arg1 inStagingRoot:(id)arg2 packageFormat:(unsigned char)arg3 domain:(unsigned long long)arg4 userOptions:(id)arg5 manifestURL:(id)arg6 existingBundleContainer:(id)arg7 patchType:(unsigned char)arg8 error:(id *)arg9;	// IMP=0x001000000002f31b
