...
- (void).cxx_destruct;	// IMP=0x002000000000fca2
...
- (void)_addBodyToRequest:(id)arg1;	// IMP=0x000000000000f9fd
- (void)_addHeadersToRequest:(id)arg1;	// IMP=0x001000000000f7ce
- (id)updateMemberFlags;	// IMP=0x001000000000f325
- (id)initWithNetworkService:(id)arg1 grandSlamSigner:(id)arg2 familyGrandSlamSigner:(id)arg3 memberDSID:(id)arg4 flags:(id)arg5;	// IMP=0x001000000000f22f
