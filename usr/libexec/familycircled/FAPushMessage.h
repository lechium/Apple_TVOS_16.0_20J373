...
- (void).cxx_destruct;	// IMP=0x002000000000b725
...
- (id)initWithMessage:(id)arg1;	// IMP=0x001000000000b46e
- (id)initWithMessage:(id)arg1 accountStore:(id)arg2;	// IMP=0x001000000000b2ac
