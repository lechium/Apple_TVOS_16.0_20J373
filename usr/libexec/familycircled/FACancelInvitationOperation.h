...
- (void).cxx_destruct;	// IMP=0x002000000000ffeb
...
- (id)cancelInvitation;	// IMP=0x001000000000fd9f
- (id)initWithNetworkService:(id)arg1 email:(id)arg2 familyID:(id)arg3;	// IMP=0x001000000000fcf5
