...
- (void).cxx_destruct;	// IMP=0x0020000000017572
@property(copy, nonatomic) NSString *pushTopic; // @synthesize pushTopic=_pushTopic;
- (id)initWithDictionary:(id)arg1;	// IMP=0x00100000000174e2
- (_Bool)_booleanValueOfObject:(id)arg1;	// IMP=0x0010000000017470
- (id)description;	// IMP=0x00100000000173db
...
- (id)initWithHTTPResponse:(id)arg1 data:(id)arg2;	// IMP=0x0010000000016fb9
