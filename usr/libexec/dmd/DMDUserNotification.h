...
- (void).cxx_destruct;	// IMP=0x002000000006fdd6
...
- (void)setNotificationRef:(struct __CFUserNotification *)arg1;	// IMP=0x001000000006fced
- (struct __CFUserNotification *)notificationRef;	// IMP=0x001000000006fce3
- (void)dealloc;	// IMP=0x001000000006fca4
- (id)init;	// IMP=0x001000000006fc42
