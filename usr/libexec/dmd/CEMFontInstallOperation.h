...
- (void).cxx_destruct;	// IMP=0x00200000000056cd
...
- (void)assetResolutionFailedWithError:(id)arg1;	// IMP=0x0010000000005639
- (void)assetResolutionDidSucceedWithAssetURL:(id)arg1;	// IMP=0x0010000000005333
...
- (void)main;	// IMP=0x001000000000516e
- (_Bool)isAsynchronous;	// IMP=0x0010000000005166
- (id)initWithFontDeclaration:(id)arg1 resolver:(id)arg2;	// IMP=0x00100000000050c4
