...
+ (_Bool)supportsSecureCoding;	// IMP=0x0040000000064b88
- (void).cxx_destruct;	// IMP=0x0020000000064df3
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000064cdb
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000064b90
