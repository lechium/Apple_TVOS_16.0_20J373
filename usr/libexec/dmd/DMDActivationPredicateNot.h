...
- (void).cxx_destruct;	// IMP=0x002000000000d81c
...
- (id)metadata;	// IMP=0x001000000000d6ed
- (id)evaluatePredicateWithError:(id *)arg1;	// IMP=0x001000000000d521
- (id)initWithDelegate:(id)arg1 uniqueIdentifier:(id)arg2 subPredicateObserver:(id)arg3 predicate:(id)arg4;	// IMP=0x001000000000d497
