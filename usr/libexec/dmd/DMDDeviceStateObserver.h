...
- (void)networkDidChange;	// IMP=0x001000000003a0f4
- (void)keybagLockStateDidChange;	// IMP=0x001000000003a0bc
- (void)stopObservingChanges;	// IMP=0x001000000003a084
- (void)startObservingChanges;	// IMP=0x0010000000039eed
@property(readonly, copy) NSString *description;
- (id)init;	// IMP=0x0010000000039e0d
