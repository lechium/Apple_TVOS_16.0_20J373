...
- (void).cxx_destruct;	// IMP=0x0020000000045bd2
...
- (void)delegateUpdatedDeclarationSourceAndEndOperation:(id)arg1;	// IMP=0x0010000000045a2e
- (void)main;	// IMP=0x00100000000451c5
