...
+ (id)sharedServer;	// IMP=0x00200000000670f1
- (void).cxx_destruct;	// IMP=0x0020000000067382
...
- (void)invalidate;	// IMP=0x0010000000067259
- (void)run;	// IMP=0x0010000000067146
- (id)init;	// IMP=0x0010000000066dff
