...
+ (_Bool)supportsSecureCoding;	// IMP=0x00400000000684f3
- (void).cxx_destruct;	// IMP=0x0020000000068a6f
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000000687c7
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000684fb
