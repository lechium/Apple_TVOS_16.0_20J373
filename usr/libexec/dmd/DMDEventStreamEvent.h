...
- (void).cxx_destruct;	// IMP=0x002000000004940a
...
- (id);	// IMP=0x00100000000492bf
- (id)description;	// IMP=0x0010000000049222
- (id)initWithEventType:(id)arg1 details:(id)arg2;	// IMP=0x0010000000049152
