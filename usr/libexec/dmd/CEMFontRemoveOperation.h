...
- (void).cxx_destruct;	// IMP=0x0020000000005913
...
- (void)main;	// IMP=0x00100000000057a0
- (id)initWithFontDeclaration:(id)arg1 installMetadata:(id)arg2;	// IMP=0x00100000000056fe
