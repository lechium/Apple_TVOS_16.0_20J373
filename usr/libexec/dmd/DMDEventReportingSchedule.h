...
- (void)startWithScheduleElapsedHandler:(CDUnknownBlockType)arg1;	// IMP=0x0010000000047f0e
- (unsigned long long)hash;	// IMP=0x0010000000047dd5
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000047b84
- (id)description;	// IMP=0x0010000000047ad1
- (void)dealloc;	// IMP=0x0010000000047a8f
- (id)initWithScheduleRegistration:(id)arg1;	// IMP=0x00100000000477b4
