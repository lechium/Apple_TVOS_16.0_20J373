...
- (void).cxx_destruct;	// IMP=0x002000000006de34
@property(readonly, nonatomic) CATTaskServer *taskServer; // @synthesize taskServer=_taskServer;
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x001000000006dd30
- (id)initWithTaskServer:(id)arg1;	// IMP=0x001000000006dcc5
