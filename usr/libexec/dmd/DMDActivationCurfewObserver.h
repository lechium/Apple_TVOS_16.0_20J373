...
- (void).cxx_destruct;	// IMP=0x002000000000ad8e
...
- (id)_nextDateAfter:(id)arg1 matchingWeekday:(long long)arg2 hour:(long long)arg3 minute:(long long)arg4 second:(long long)arg5 inCalendar:(id)arg6;	// IMP=0x001000000000aafd
- (id)_datesForNextCurfewBoundary;	// IMP=0x001000000000a61d
- (void)_registerPredicateObserver;	// IMP=0x001000000000a160
- (_Bool)_extractComponentsFromPredicate:(id)arg1;	// IMP=0x0010000000009827
- (id)metadata;	// IMP=0x00100000000096f6
- (void)updateObserverRegistration;	// IMP=0x00100000000096e4
- (void)invalidate;	// IMP=0x0010000000009528
- (id)evaluatePredicateWithError:(id *)arg1;	// IMP=0x0010000000008f8b
- (id)initWithDelegate:(id)arg1 uniqueIdentifier:(id)arg2 curfewPredicate:(id)arg3;	// IMP=0x0010000000008e9a
