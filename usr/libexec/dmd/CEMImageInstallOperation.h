...
- (void)assetResolutionFailedWithError:(id)arg1;	// IMP=0x0010000000006147
- (void)assetResolutionDidSucceedWithAssetURL:(id)arg1;	// IMP=0x0010000000005e41
...
- (void)main;	// IMP=0x0010000000005c7c
- (_Bool)isAsynchronous;	// IMP=0x0010000000005c74
- (id)initWithImageDeclaration:(id)arg1 resolver:(id)arg2;	// IMP=0x0010000000005bd2
