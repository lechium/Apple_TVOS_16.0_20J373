...
- (void).cxx_destruct;	// IMP=0x0020000000056884
...
- (void)session:(id)arg1 object:(id)arg2 didUpdateRegion:(id)arg3 previousRegion:(id)arg4;	// IMP=0x0010000000056490
- (void)invalidate;	// IMP=0x001000000005639b
- (void)activateWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000056029
- (id)init;	// IMP=0x0010000000055fb9
