...
- (void).cxx_destruct;	// IMP=0x0020000000069d21
...
- (void)xpcPrivateDiscoveryUpdate:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000069b9e
- (void)xpcPrivateDiscoveryActivate:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000069a8a
- (void)xpcPrivateAdvertiserUpdate:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000069990
- (void)xpcPrivateAdvertiserActivate:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x001000000006987c
- (void)xpcConnectionInvalidated;	// IMP=0x00100000000696f9
- (_Bool)_entitledAndReturnError:(id *)arg1;	// IMP=0x00100000000695d4
