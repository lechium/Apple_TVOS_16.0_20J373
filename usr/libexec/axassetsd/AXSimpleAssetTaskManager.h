...
+ (id)sharedInstance;	// IMP=0x004000000000d9a0
- (void).cxx_destruct;	// IMP=0x0020000000011af0
...
- (id)_getBootTime;	// IMP=0x0010000000011830
- (id)_taskQueueForTask:(Class)arg1;	// IMP=0x0010000000011620
- (void)_handleXPCActivity:(id)arg1 taskClass:(Class)arg2;	// IMP=0x00100000000114a0
- (void)_dispatchTask:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000010390
- (id)_tasksForFirstBoot;	// IMP=0x001000000000fd80
- (id)_anonymousTaskForId:(id)arg1 withArguments:(id)arg2;	// IMP=0x001000000000f900
- (id)_tasksForNotification:(id)arg1;	// IMP=0x001000000000f1f0
- (void)_handleNotification:(id)arg1;	// IMP=0x001000000000efb0
- (void)invokeTaskById:(id)arg1 arguments:(id)arg2;	// IMP=0x001000000000eee0
- (void)handleFirstBoot:(_Bool)arg1;	// IMP=0x001000000000e900
- (void)registerTask:(Class)arg1;	// IMP=0x001000000000df00
- (void)start;	// IMP=0x001000000000dc80
- (id)init;	// IMP=0x001000000000da60
