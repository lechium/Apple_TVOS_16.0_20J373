...
+ (id)sharedInstance;	// IMP=0x0020000000014f50
- (void).cxx_destruct;	// IMP=0x00200000000160a0
...
- (void)willBecomeIdle:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000015c90
- (void)_updateAssetForAssetType:(id)arg1;	// IMP=0x0010000000015be0
- (void)_refreshAssetCatalogForAssetType:(id)arg1 withOverrideTimeout:(id)arg2 forceCatalogRefresh:(_Bool)arg3;	// IMP=0x0010000000015af0
- (id)_managedAssetForAssetType:(id)arg1;	// IMP=0x00100000000157e0
- (void)run;	// IMP=0x0010000000015570
- (void)registerManagedAssets:(id)arg1;	// IMP=0x00100000000154f0
- (void)registerManagedAsset:(id)arg1;	// IMP=0x0010000000015470
- (id)_init;	// IMP=0x0010000000015020
