...
- (void).cxx_destruct;	// IMP=0x00200000000023b2
...
- (void)stopProducingData;	// IMP=0x00100000000022db
- (id)startProducingDataWithCallback:(CDUnknownBlockType)arg1;	// IMP=0x001000000000221c
- (id)initWithConfiguration:(id)arg1 receiverQueue:(id)arg2;	// IMP=0x0010000000002179
