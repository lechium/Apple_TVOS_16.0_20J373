...
- (void).cxx_destruct;	// IMP=0x0020000000004a56
...
- (void)stopProducingData;	// IMP=0x0010000000004972
- (id)startProducingDataWithCallback:(CDUnknownBlockType)arg1;	// IMP=0x0010000000004698
- (id)initWithConfiguration:(id)arg1 receiverQueue:(id)arg2;	// IMP=0x00100000000045aa
