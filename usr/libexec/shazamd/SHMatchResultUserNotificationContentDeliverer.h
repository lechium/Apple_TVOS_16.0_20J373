...
- (void)deliverContentForMatchedMediaItem:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x001000000000a665
- (void)deliverContentForNoMatchWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000000a47a
- (id)initWithContentProvider:(id)arg1;	// IMP=0x001000000000a40f
