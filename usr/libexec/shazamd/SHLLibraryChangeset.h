...
- (void).cxx_destruct;	// IMP=0x0020000000010dc8
...
- (id)description;	// IMP=0x0010000000010c39
- (void)mergeChangeset:(id)arg1;	// IMP=0x0010000000010b33
- (void)deleteGroups:(id)arg1;	// IMP=0x00100000000109ec
- (void)addGroups:(id)arg1;	// IMP=0x00100000000106ba
- (void)deleteTracks:(id)arg1;	// IMP=0x0010000000010573
- (void)addTracks:(id)arg1;	// IMP=0x001000000001042c
...
- (id)init;	// IMP=0x0010000000010055
