...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000003df6b
- (void).cxx_destruct;	// IMP=0x002000000003e132
...
- (void)updateProgress;	// IMP=0x001000000003df73
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000003de99
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000003dcaa
@property(readonly, nonatomic) NSArray *allItemIdentifiers;
@property(readonly, nonatomic) long long size;
@property(readonly, nonatomic) long long type;
- (id)subdivideTaskIntoBatchesOfSize:(long long)arg1;	// IMP=0x001000000003d292
- (id)_init;	// IMP=0x001000000003d166
- (id)initWithTracksToModify:(id)arg1 groupsToModify:(id)arg2;	// IMP=0x001000000003cfdd
