...
- (void).cxx_destruct;	// IMP=0x002000000000ff98
...
- (double)timeRequiredToPerformWork;	// IMP=0x001000000000ff55
- (oneway void)stop;	// IMP=0x001000000000ff4f
@property(readonly, nonatomic) _Bool managesRecordingSession;
- (void)setIsRunning:(_Bool)arg1;	// IMP=0x001000000000fef2
- (oneway void)sendEventSignal:(id)arg1;	// IMP=0x001000000000fd87
