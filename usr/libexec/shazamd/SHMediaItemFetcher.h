...
- (void).cxx_destruct;	// IMP=0x002000000000c4b5
...
- (double)timeRequiredToPerformWork;	// IMP=0x001000000000c440
- (oneway void)stop;	// IMP=0x001000000000c43a
@property(readonly, nonatomic) _Bool managesRecordingSession;
- (void)mediaItemForShazamID:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000000b9d9
- (id)initWithAttribution:(id)arg1 clientType:(long long)arg2 URLBuilder:(id)arg3 contextBuilder:(id)arg4 networkRequester:(id)arg5;	// IMP=0x001000000000b8f6
- (id)initWithAttribution:(id)arg1 clientType:(long long)arg2;	// IMP=0x001000000000b80c
