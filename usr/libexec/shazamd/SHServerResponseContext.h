...
- (void)sh_setCampaignTokenForClientIdentifier:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000004d92
- (void)sh_setDefaultValuesWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000004c24
