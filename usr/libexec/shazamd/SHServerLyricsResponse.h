...
- (void).cxx_destruct;	// IMP=0x00200000000120cf
@property(retain, nonatomic) NSDictionary *lyricsDictionary; // @synthesize lyricsDictionary=_lyricsDictionary;
- (id)itemForIdentifiers:(id)arg1;	// IMP=0x0010000000011e6c
- (id)initWithLyricsDictionary:(id)arg1;	// IMP=0x0010000000011e01
