...
+ (id)sharedInstance;	// IMP=0x002000000002d455
- (void).cxx_destruct;	// IMP=0x002000000002ed46
...
- (void)recorder:(id)arg1 producedAudioBuffer:(id)arg2 atTime:(id)arg3;	// IMP=0x001000000002e999
- (_Bool)isAudioSourceSupported:(long long)arg1;	// IMP=0x001000000002e84d
@property(readonly, nonatomic) long long suggestedAudioRecordingSource;
@property(readonly, nonatomic) _Bool isRunning;
- (void)detachTap:(id)arg1;	// IMP=0x001000000002e34b
- (void)attachTap:(id)arg1;	// IMP=0x001000000002e223
- (void)stopRecordingForReason:(long long)arg1;	// IMP=0x001000000002dc3b
- (void)startRecording;	// IMP=0x001000000002d63d
- (id)initWithRecorders:(id)arg1;	// IMP=0x001000000002d549
- (void)dealloc;	// IMP=0x001000000002d4aa
