...
- (void).cxx_destruct;	// IMP=0x00200000000060d7
...
- (void)stop;	// IMP=0x0010000000005efe
- (id)buildURLForSignature:(id)arg1 endpoint:(id)arg2;	// IMP=0x0010000000005e4b
- (id)partnerURLRequestForSignature:(id)arg1 endpoint:(id)arg2;	// IMP=0x0010000000005a2f
- (void)matchSignature:(id)arg1 tokenizedURL:(id)arg2;	// IMP=0x0010000000005617
- (void)startRecognitionForRequest:(id)arg1;	// IMP=0x0010000000005375
- (void)responseForServerData:(id)arg1 signature:(id)arg2;	// IMP=0x001000000000515b
@property(readonly, nonatomic) NSISO8601DateFormatter *iso8601Formatter; // @synthesize iso8601Formatter=_iso8601Formatter;
- (id)initWithCatalog:(id)arg1 recognitionRequester:(id)arg2;	// IMP=0x0010000000005071
- (id)initWithCatalog:(id)arg1;	// IMP=0x0010000000004fbd
- (void)dealloc;	// IMP=0x0010000000004f7b
