...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000001d0dc
- (void).cxx_destruct;	// IMP=0x002000000001d182
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000001d057
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000001cf70
@property(readonly, nonatomic) long long size;
@property(readonly, nonatomic) long long type;
- (id)init;	// IMP=0x001000000001ce8d
