...
- (void).cxx_destruct;	// IMP=0x0020000000009a39
...
- (id)sessionConfiguration;	// IMP=0x001000000000976a
- (void)performRequest:(id)arg1 withReply:(CDUnknownBlockType)arg2;	// IMP=0x001000000000940b
- (_Bool)isTokenFailureError:(id)arg1;	// IMP=0x001000000000937c
- (void)handleResult:(id)arg1 callback:(CDUnknownBlockType)arg2 error:(id)arg3;	// IMP=0x001000000000914d
- (void)invalidate;	// IMP=0x0010000000009110
- (id)initWithClientIdentifier:(id)arg1 clientType:(long long)arg2;	// IMP=0x0010000000009040
