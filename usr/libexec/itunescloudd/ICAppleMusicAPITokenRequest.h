...
- (void).cxx_destruct;	// IMP=0x002000000007e89e
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000007e70a
- (unsigned long long)hash;	// IMP=0x001000000007e634
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000007e49a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000007e36f
- (void)writeTo:(id)arg1;	// IMP=0x001000000007e288
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000007df98
- (id)dictionaryRepresentation;	// IMP=0x001000000007de03
- (id)description;	// IMP=0x001000000007dd54
