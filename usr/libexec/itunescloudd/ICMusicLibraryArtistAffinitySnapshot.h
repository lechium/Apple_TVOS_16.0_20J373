...
- (void).cxx_destruct;	// IMP=0x00200000000624bd
...
- (id)debugDescription;	// IMP=0x0010000000062275
- (float)legacyScore;	// IMP=0x0010000000062163
...
- (id)initWithContentItemSnapshot:(id)arg1;	// IMP=0x0010000000061e70
