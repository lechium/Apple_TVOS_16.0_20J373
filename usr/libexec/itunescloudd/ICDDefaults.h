...
+ (id)daemonDefaults;	// IMP=0x002000000001ee16
- (void).cxx_destruct;	// IMP=0x002000000001edee
...
- (void)_setOrRemoveObject:(id)arg1 forKey:(id)arg2;	// IMP=0x001000000001ed16
- (id)_init;	// IMP=0x001000000001ec26
