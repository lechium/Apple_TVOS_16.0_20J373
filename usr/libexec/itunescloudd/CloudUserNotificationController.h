...
- (void).cxx_destruct;	// IMP=0x002000000003ae69
...
- (id)_createBag;	// IMP=0x001000000003ae0c
- (void)userNotificationCenter:(id)arg1 didReceiveNotificationResponse:(id)arg2 withCompletionHandler:(CDUnknownBlockType)arg3;	// IMP=0x001000000003ace6
- (void)userNotificationCenter:(id)arg1 didChangeSettings:(id)arg2;	// IMP=0x001000000003ab0b
- (id)init;	// IMP=0x001000000003a9bc
