...
+ (id)request;	// IMP=0x00400000000f9ef7
- (void).cxx_destruct;	// IMP=0x00200000000f9e4b
...
- (id)_HTTPMethodStringForICDRequestMethod:(long long)arg1;	// IMP=0x00100000000f9d6f
@property(readonly, nonatomic) _Bool acceptsGzipEncoding;
- (id)canonicalResponseForResponse:(id)arg1;	// IMP=0x00100000000f9d5a
- (id)URLRequestForBaseURL:(id)arg1 sessionID:(unsigned int)arg2;	// IMP=0x00100000000f9bfb
- (id)requestURLForBaseURL:(id)arg1 sessionID:(unsigned int)arg2;	// IMP=0x00100000000f9a30
- (void)setValue:(id)arg1 forArgument:(id)arg2;	// IMP=0x00100000000f99b0
@property(readonly, nonatomic) double timeoutInterval;
- (id)description;	// IMP=0x00100000000f98f5
- (id)initWithAction:(id)arg1;	// IMP=0x00100000000f987a
