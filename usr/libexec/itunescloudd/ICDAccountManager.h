...
- (void).cxx_destruct;	// IMP=0x00200000000f0fb8
...
- (void)_updateStateWithChange:(id)arg1;	// IMP=0x00100000000f0eca
- (id)_buildStateChange;	// IMP=0x00100000000f0cc8
...
- (void)changeLibraryManagementPolicy:(long long)arg1;	// IMP=0x00100000000f06ff
- (void)updateState;	// IMP=0x00100000000f04f2
- (id)initWithLibraryManagementPolicy:(long long)arg1;	// IMP=0x00100000000f028e
