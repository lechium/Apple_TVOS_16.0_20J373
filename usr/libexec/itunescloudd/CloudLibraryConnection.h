...
- (void).cxx_destruct;	// IMP=0x00200000000c0c09
...
- (void)disconnect;	// IMP=0x00100000000c0b4f
- (void)connectWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00100000000c0a48
- (void)_onQueue_sendRequest:(id)arg1 withInternalResponseHandler:(CDUnknownBlockType)arg2;	// IMP=0x00100000000bf11f
- (void)sendRequest:(id)arg1 withResponseHandler:(CDUnknownBlockType)arg2;	// IMP=0x00100000000bf043
@property(readonly, nonatomic) ICUserIdentityStore *userIdentityStore;
@property(readonly, nonatomic) ICUserIdentity *userIdentity;
- (id)initWithConfiguration:(id)arg1;	// IMP=0x00100000000bef1c
