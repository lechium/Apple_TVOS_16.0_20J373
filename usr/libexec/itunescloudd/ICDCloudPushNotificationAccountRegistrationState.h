...
- (void).cxx_destruct;	// IMP=0x00200000000d8443
...
- (id)dictionaryRepresentation;	// IMP=0x00100000000d8393
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x00100000000d82f0
