...
- (void).cxx_destruct;	// IMP=0x002000000003a516
...
- (void)main;	// IMP=0x0010000000039f33
- (id)initWithConfiguration:(id)arg1 clientIdentity:(id)arg2 sagaID:(unsigned long long)arg3;	// IMP=0x0010000000039eef
- (id)initWithClientIdentity:(id)arg1 sagaID:(unsigned long long)arg2;	// IMP=0x0010000000039e7c
