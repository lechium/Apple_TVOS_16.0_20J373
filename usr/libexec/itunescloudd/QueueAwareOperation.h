...
- (void).cxx_destruct;	// IMP=0x002000000005970f
...
- (id)initWithArtworkImporter:(id)arg1 clientIdentity:(id)arg2 operationQueue:(id)arg3 artistPersistentIDsToUpdate:(id)arg4 albumArtistPersistentIDsToUpdate:(id)arg5;	// IMP=0x00100000000594b8
