...
+ (id)eTagValueFromContentTasteResponse:(id)arg1;	// IMP=0x004000000003afba
- (void).cxx_destruct;	// IMP=0x002000000003af92
...
- (id)initWithContentTasteResponse:(id)arg1;	// IMP=0x001000000003ae9d
