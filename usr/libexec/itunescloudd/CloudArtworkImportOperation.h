...
- (id)_resizedImageDataFromLocation:(id)arg1;	// IMP=0x00100000000a4063
- (void)cancel;	// IMP=0x00100000000a400a
- (void)start;	// IMP=0x00100000000a368c
- (id)description;	// IMP=0x00100000000a35bc
- (void)callCompletionHandlers;	// IMP=0x00100000000a3430
- (void)addCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00100000000a3392
- (id)initWithURLSession:(id)arg1 configuration:(id)arg2 cloudID:(unsigned long long)arg3 artworkToken:(id)arg4 artworkType:(long long)arg5 sourceType:(long long)arg6 clientIdentity:(id)arg7;	// IMP=0x00100000000a3268
