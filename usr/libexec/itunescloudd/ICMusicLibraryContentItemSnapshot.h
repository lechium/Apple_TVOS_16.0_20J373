...
- (void).cxx_destruct;	// IMP=0x002000000005e972
...
- (id)debugDescription;	// IMP=0x001000000005e787
- (_Bool)isValid;	// IMP=0x001000000005e77e
- (id)initWithSong:(id)arg1;	// IMP=0x001000000005e3da
