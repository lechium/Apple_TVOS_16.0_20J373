...
- (void).cxx_destruct;	// IMP=0x00200000000d634a
...
- (void)_adjustOperationQueueStatusForMediaDownloads;	// IMP=0x00100000000d6109
- (void)downloadManager:(id)arg1 didCancelAssets:(id)arg2;	// IMP=0x00100000000d60f7
- (void)downloadManager:(id)arg1 didFinishAsset:(id)arg2 withError:(id)arg3;	// IMP=0x00100000000d60e5
- (void)downloadManager:(id)arg1 didUpdateDownloadProgress:(id)arg2;	// IMP=0x00100000000d60d3
- (void)downloadManager:(id)arg1 didEnqueueAssetDownloads:(id)arg2 didRemoveAssetDownloads:(id)arg3;	// IMP=0x00100000000d60c1
- (void)cancelAllImports;	// IMP=0x00100000000d60ad
- (void)cancelAllImportsAndWaitForOperationsToFinish:(_Bool)arg1;	// IMP=0x00100000000d5ff6
- (void)increasePriorityForAllOperations;	// IMP=0x00100000000d5f85
- (void)decreasePriorityForAllOperations;	// IMP=0x00100000000d5f14
- (void)deprioritizeImportArtworkForCloudID:(unsigned long long)arg1 artworkType:(long long)arg2;	// IMP=0x00100000000d5e8d
- (void)importCloudArtworkForRequests:(id)arg1;	// IMP=0x00100000000d5dd6
- (void)importArtworkForCloudID:(unsigned long long)arg1 artworkType:(long long)arg2 token:(id)arg3 mediaType:(unsigned int)arg4 allowsCellularData:(_Bool)arg5 clientIdentity:(id)arg6 completionHandler:(CDUnknownBlockType)arg7;	// IMP=0x00100000000d5c6c
- (void)dealloc;	// IMP=0x00100000000d5b64
- (id)initWithConfiguration:(id)arg1 sourceType:(long long)arg2;	// IMP=0x00100000000d55dd
