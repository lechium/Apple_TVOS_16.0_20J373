...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000008e546
- (void).cxx_destruct;	// IMP=0x002000000008e508
...
- (unsigned long long)hash;	// IMP=0x001000000008b23a
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000008b134
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000008b05e
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000008aed2
- (id)description;	// IMP=0x001000000008ade0
- (id)initWithGlobalPlaylistID:(id)arg1 contentTaste:(long long)arg2 configuration:(id)arg3;	// IMP=0x001000000008ac95
- (id)initWithStoreItemID:(long long)arg1 mediaContentTasteItem:(long long)arg2 contentTaste:(long long)arg3 configuration:(id)arg4 timeStamp:(id)arg5;	// IMP=0x001000000008ab62
