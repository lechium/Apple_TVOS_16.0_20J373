...
- (void).cxx_destruct;	// IMP=0x002000000003caa1
...
- (void)main;	// IMP=0x001000000003c55c
- (id)initWithConfiguration:(id)arg1 cloudIDs:(id)arg2;	// IMP=0x001000000003c43b
- (id)initWithCloudIDs:(id)arg1;	// IMP=0x001000000003c3d7
