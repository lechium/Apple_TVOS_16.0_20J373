...
- (void).cxx_destruct;	// IMP=0x0020000000010471
...
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0010000000010017
- (void)scheduleBackgroundTasks;	// IMP=0x001000000000f35a
- (void)resume;	// IMP=0x001000000000f344
- (void)dealloc;	// IMP=0x001000000000f2ea
- (id)init;	// IMP=0x001000000000f254
