...
- (void).cxx_destruct;	// IMP=0x0020000000113621
...
- (void)runOperations;	// IMP=0x001000000011359b
- (id)initWithController:(id)arg1 scopedIdentifiers:(id)arg2 targetMapping:(id)arg3 transportScopeMapping:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x001000000011348d
