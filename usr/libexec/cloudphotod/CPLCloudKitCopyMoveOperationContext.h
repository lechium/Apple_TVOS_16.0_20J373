...
- (void).cxx_destruct;	// IMP=0x00200000000b0c70
...
- (id)extendedStatusDescriptionStrings;	// IMP=0x00100000000b09a5
- (id)operationDescription;	// IMP=0x00100000000b08f7
- (void)addCopyMoveFromRecordID:(id)arg1 toRecordID:(id)arg2;	// IMP=0x00100000000b0828
- (id)initFromZoneID:(id)arg1 toZoneID:(id)arg2;	// IMP=0x00100000000b0786
