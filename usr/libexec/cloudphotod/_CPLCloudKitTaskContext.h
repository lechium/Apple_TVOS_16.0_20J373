...
- (void).cxx_destruct;	// IMP=0x00200000000ccf9a
...
- (_Bool)_operationAllowsCellular:(id)arg1;	// IMP=0x00100000000cc351
- (id)_priorityDescriptionForOperation:(id)arg1;	// IMP=0x00100000000cc1f5
...
- (void)cancelAllOperations;	// IMP=0x00100000000cc0b0
- (id)contextForOperation:(id)arg1;	// IMP=0x00100000000cc09a
- (_Bool)hasBlockedOperationsIncludingBackground:(_Bool)arg1;	// IMP=0x00100000000cbe47
- (void)operationDidFinish:(id)arg1;	// IMP=0x00100000000cbdba
- (void)operationWillStart:(id)arg1 context:(id)arg2;	// IMP=0x00100000000cbd1a
- (id)initWithTask:(id)arg1;	// IMP=0x00100000000cbc53
