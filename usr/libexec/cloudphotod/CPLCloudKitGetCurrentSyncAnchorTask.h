...
- (void).cxx_destruct;	// IMP=0x0020000000131c51
...
- (void)runOperations;	// IMP=0x001000000013188c
- (void)_fetchLibraryInfoAndStateWithCurrentSyncAnchor:(id)arg1 currentUserID:(id)arg2;	// IMP=0x0010000000131610
- (void)_fetchLibraryInfoAndStateWithCurrentSyncAnchor:(id)arg1;	// IMP=0x001000000013153e
- (id)initWithController:(id)arg1 cloudKitScope:(id)arg2 scope:(id)arg3 previousScopeChange:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x0010000000131431
