...
- (void).cxx_destruct;	// IMP=0x00200000000b9b71
...
- (id)initWithRealResourceType:(unsigned long long)arg1 realFingerPrint:(id)arg2 outputType:(id)arg3 dimensions:(struct CGSize)arg4;	// IMP=0x00100000000b9818
- (id)initWithFakeFingerPrint:(id)arg1;	// IMP=0x00100000000b94f4
- (id)initWithFakeIdentity:(id)arg1;	// IMP=0x00100000000b949e
