...
+ (id)moveStepFaultInjectionWithMoveStep:(long long)arg1 workItemDelay:(double)arg2;	// IMP=0x00400000000adb31
...
- (id)initWithMoveStep:(long long)arg1 workItemDelay:(double)arg2;	// IMP=0x00100000000adb6a
