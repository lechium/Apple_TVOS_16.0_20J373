...
- (void).cxx_destruct;	// IMP=0x0020000000004db1
...
- (void)getStatusDictionaryWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x001000000000477c
- (void)getStatusWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00100000000039cc
- (void)_setPushRegistrationStatus:(id)arg1 error:(id)arg2;	// IMP=0x0010000000003953
- (void)connection:(id)arg1 didReceiveToken:(id)arg2 forTopic:(id)arg3 identifier:(id)arg4;	// IMP=0x0010000000003824
- (void)connection:(id)arg1 didReceiveIncomingMessage:(id)arg2;	// IMP=0x00100000000032a9
- (void)connection:(id)arg1 didReceivePublicToken:(id)arg2;	// IMP=0x00100000000031c3
- (void)unregisterFromPushNotifications;	// IMP=0x001000000000312c
- (void)stopWaitingForPushNotifications;	// IMP=0x0010000000003046
- (void)startWaitingForPushNotificationsForContainer:(id)arg1;	// IMP=0x0010000000002988
- (id)init;	// IMP=0x001000000000275b
