...
- (void).cxx_destruct;	// IMP=0x0020000000057bc2
...
- (id)resource;	// IMP=0x00100000000579dc
- (id)initWithResource:(id)arg1;	// IMP=0x00100000000577f6
- (id)initFromPQLResultSet:(id)arg1 error:(id *)arg2;	// IMP=0x001000000005767b
