...
- (void).cxx_destruct;	// IMP=0x00200000000fe9cf
@property(readonly, copy, nonatomic) CDUnknownBlockType completionHandler; // @synthesize completionHandler=_completionHandler;
@property(copy, nonatomic) NSArray *downloadTasks; // @synthesize downloadTasks=_downloadTasks;
- (void)runOperations;	// IMP=0x00100000000fe455
- (void)_downloadNextGroup;	// IMP=0x00100000000fde7a
- (void)_downloadNextOperationType;	// IMP=0x00100000000fdd78
- (void)_downloadCurrentGroup;	// IMP=0x00100000000fc966
- (id)_recordIDForResourcesWithItemScopedIdentifier:(id)arg1;	// IMP=0x00100000000fc718
- (id)_cloudKitScopeForTask:(id)arg1;	// IMP=0x00100000000fc44b
- (id)_downloadOperationWithRecordIDsAndTasks:(id)arg1 keys:(id)arg2 perRecordProgressBlock:(CDUnknownBlockType)arg3 perRecordCompletionBlock:(CDUnknownBlockType)arg4 completionBlock:(CDUnknownBlockType)arg5;	// IMP=0x00100000000fbd5d
- (void)_finishRemainingTasksWithError:(id)arg1;	// IMP=0x00100000000fbb2e
- (void)cancelDownloadTask:(id)arg1;	// IMP=0x00100000000fb918
- (id)initWithController:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00100000000fb2c6
