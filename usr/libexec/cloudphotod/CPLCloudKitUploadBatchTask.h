...
+ (id)simulateOverQuotaPhases;	// IMP=0x002000000010b76e
- (void).cxx_destruct;	// IMP=0x0020000000110524
...
- (void)_executeUnsharePlanFromPlanner:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0010000000110197
- (void)_executeSharePlanFromPlanner:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000010fe69
- (void)_uploadSharedBatchFromPlanner:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000010faf5
- (void)_uploadBatchFromPlanner:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000010f656
- (void)_uploadRecords:(id)arg1 deleteRecordIDs:(id)arg2 identification:(id)arg3 fromPlanner:(id)arg4 uploadContext:(id)arg5 updateProgress:(CDUnknownBlockType)arg6 completionHandler:(CDUnknownBlockType)arg7;	// IMP=0x001000000010e3e8
- (void)_fetchPrivateRecordsFromPlanner:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000010de81
- (void)_fetchSharedRecordsFromPlanner:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000010d8ee
- (void)_runModernOperationsWithCurrentUserID:(id)arg1;	// IMP=0x001000000010c681
- (void)runOperations;	// IMP=0x001000000010c5ff
- (id)initWithController:(id)arg1 scope:(id)arg2 targetMapping:(id)arg3 transportScopeMapping:(id)arg4 progressHandler:(CDUnknownBlockType)arg5 completionHandler:(CDUnknownBlockType)arg6;	// IMP=0x001000000010b801
