...
+ (unsigned long long)resourceTypeForFieldName:(id)arg1;	// IMP=0x0040000000100ec1
+ (id)resourceKeysForResourceType:(unsigned long long)arg1;	// IMP=0x0010000000100e6c
- (void).cxx_destruct;	// IMP=0x0020000000101375
...
- (id)redactedDescription;	// IMP=0x00100000001011cd
- (id)description;	// IMP=0x0010000000101150
- (id)initWithPrefix:(id)arg1 resourceType:(unsigned long long)arg2;	// IMP=0x0010000000100f55
