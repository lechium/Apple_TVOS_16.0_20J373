...
+ (id)selfCrashResetReason;	// IMP=0x002000000009976e
- (void).cxx_destruct;	// IMP=0x002000000009983a
- (void)finalizeWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0010000000098a5d
- (void)acknowledgeChangeBatch:(id)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x001000000009796d
- (void)getChangeBatchWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00100000000969a3
- (void)beginSessionWithKnownLibraryVersion:(id)arg1 context:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0010000000096152
- (id)clientWorkDescription;	// IMP=0x0010000000096145
