...
- (void).cxx_destruct;	// IMP=0x00200000000efb64
- (id)_scopeChangeFromShareMetadata:(id)arg1 currentUserID:(id)arg2 error:(id *)arg3;	// IMP=0x00100000000ef561
- (void)_fetchSharedScopeWithCurrentUserID:(id)arg1;	// IMP=0x00100000000eead9
- (void)runOperations;	// IMP=0x00100000000eea58
- (id)initWithController:(id)arg1 shareURL:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000000ee99b
