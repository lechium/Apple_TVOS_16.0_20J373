...
- (id)bindValuesToKeepAlive;	// IMP=0x001000000004a796
- (int)bindWithStatement:(struct sqlite3_stmt *)arg1 startingAtIndex:(int)arg2;	// IMP=0x001000000004a4be
- (id)initWithVariables:(id)arg1 object:(id)arg2 sql:(id)arg3;	// IMP=0x001000000004a407
