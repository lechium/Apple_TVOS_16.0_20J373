...
- (void).cxx_destruct;	// IMP=0x00200000000af0a2
...
- (id)startDateDescriptionWithNow:(id)arg1;	// IMP=0x00100000000aece5
- (id)operationDescription;	// IMP=0x00100000000aecdd
- (id)extendedStatusDescriptionStrings;	// IMP=0x00100000000aecd5
