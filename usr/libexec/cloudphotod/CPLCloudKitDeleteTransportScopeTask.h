...
- (void).cxx_destruct;	// IMP=0x00200000000bb7b5
...
- (void)runOperations;	// IMP=0x00100000000babdd
- (void)_didFinishDeleteWithError:(id)arg1;	// IMP=0x00100000000ba8ef
- (id)_errorForDeleteError:(id)arg1;	// IMP=0x00100000000ba793
- (id)initWithController:(id)arg1 cloudKitScope:(id)arg2 scope:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00100000000ba6b1
