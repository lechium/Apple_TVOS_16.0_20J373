...
- (void).cxx_destruct;	// IMP=0x0020000000030d6b
...
- (void)unpublish;	// IMP=0x0010000000030cef
- (void)publish;	// IMP=0x0010000000030cc8
- (void)_publishRealProgressIfNecessary;	// IMP=0x0010000000030b9d
- (void)setUserInfoObject:(id)arg1 forKey:(id)arg2;	// IMP=0x0010000000030b0c
- (id)initWithIdentifier:(id)arg1 firstSyncOfMainLibrary:(_Bool)arg2;	// IMP=0x001000000003094c
