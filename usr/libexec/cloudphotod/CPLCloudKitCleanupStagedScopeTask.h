...
- (void).cxx_destruct;	// IMP=0x00200000001273ba
...
- (void)auxiliaryOperationDidFinishWithError:(id)arg1;	// IMP=0x0010000000127299
- (void)launchAuxiliaryOperation:(id)arg1 type:(long long)arg2 withContext:(id)arg3;	// IMP=0x001000000012712a
- (void)operationDidFinishWithError:(id)arg1;	// IMP=0x00100000001270cd
- (void)updateProgress:(double)arg1;	// IMP=0x001000000012709a
- (void)updateContextWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x001000000012703d
- (void)updateOneBatch;	// IMP=0x000000000012700a
- (void)operationDidFinish:(id)arg1 error:(id)arg2;	// IMP=0x0010000000126f95
- (void)launchOperation:(id)arg1 type:(long long)arg2 withContext:(id)arg3 sourceBundleIdentifiers:(id)arg4;	// IMP=0x0010000000126e99
- (void)dispatchAsync:(CDUnknownBlockType)arg1;	// IMP=0x0010000000126d10
- (void)runOperations;	// IMP=0x0010000000126996
- (void)runAuxiliaryOperation;	// IMP=0x00100000001264fc
- (void)_fetchAndMoveNextBatchWithUserRecordID:(id)arg1;	// IMP=0x0010000000125fcc
- (void)_moveBatchRecordWithNames:(id)arg1 userRecordID:(id)arg2 operationID:(id)arg3 moveBatchID:(id)arg4 hasMore:(_Bool)arg5;	// IMP=0x0010000000125956
- (void)_sendExitFeedbackWithSourceRecordIDs:(id)arg1 destinationRecordIDs:(id)arg2 moveError:(id)arg3 operationID:(id)arg4 moveBatchID:(id)arg5;	// IMP=0x0010000000125548
- (id)initWithController:(id)arg1 stagedScope:(id)arg2 stagingScope:(id)arg3 destinationScope:(id)arg4 transportScopeMapping:(id)arg5 progressHandler:(CDUnknownBlockType)arg6 completionHandler:(CDUnknownBlockType)arg7;	// IMP=0x001000000012530d
