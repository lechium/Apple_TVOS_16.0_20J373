...
- (void).cxx_destruct;	// IMP=0x00200000001313de
...
- (void)_determineScopeTypeAndFetchLibraryInfoWithCurrentUserID:(id)arg1;	// IMP=0x0010000000130d92
- (void)getScopeInfoWithCurrentUserID:(id)arg1;	// IMP=0x0010000000130746
- (void)runOperations;	// IMP=0x00100000001306b1
- (id)initWithController:(id)arg1 cloudKitScope:(id)arg2 scope:(id)arg3 previousScopeChange:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x001000000013058c
