...
- (void).cxx_destruct;	// IMP=0x0020000000100dc4
...
- (id)description;	// IMP=0x0010000000100c8f
@property(readonly, nonatomic) NSString *resourceTypeDescription;
- (id)propertyKeys;	// IMP=0x0010000000100c4f
- (id)cloudResourceForRecordWithScopedIdentifier:(id)arg1;	// IMP=0x0010000000100bd1
- (void)enumerateRecordScopedIdentifiersAndTasksWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x0010000000100acd
...
- (_Bool)cancelDownloadTask:(id)arg1;	// IMP=0x0010000000100619
- (void)allDownloadsDidFailWithError:(id)arg1;	// IMP=0x0010000000100409
- (void)resourceWithRecordScopedIdentifier:(id)arg1 didFailToDownloadWithError:(id)arg2;	// IMP=0x00100000001001f7
- (void)resourceWithRecordScopedIdentifier:(id)arg1 didDownloadCKAsset:(id)arg2 withOperationType:(long long)arg3 transcoderVersion:(long long)arg4 withFingerPrint:(id)arg5 andFileUTI:(id)arg6;	// IMP=0x00100000000ff4b0
- (void)resourceWithRecordScopedIdentifier:(id)arg1 didProgress:(double)arg2;	// IMP=0x00100000000ff24b
- (void)resourceWithRecordScopedIdentifierDidStart:(id)arg1 operationID:(id)arg2;	// IMP=0x00100000000ff095
- (void)allDownloadsDidStartWithOperationID:(id)arg1;	// IMP=0x00100000000fef36
- (_Bool)addDownloadTask:(id)arg1;	// IMP=0x00100000000feb33
- (id)initWithResourceType:(unsigned long long)arg1;	// IMP=0x00100000000fea66
