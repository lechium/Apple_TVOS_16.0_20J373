...
- (void).cxx_destruct;	// IMP=0x00200000000ddfe3
- (void)runOperations;	// IMP=0x00100000000dd87d
- (_Bool)_shouldSkipRampingRequest;	// IMP=0x00100000000dd801
- (double)timeoutIntervalForRequest;	// IMP=0x00100000000dd7f3
- (id)initWithController:(id)arg1 resourceType:(unsigned long long)arg2 numRequested:(unsigned long long)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00100000000dd738
