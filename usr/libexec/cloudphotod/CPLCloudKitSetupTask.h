...
- (void).cxx_destruct;	// IMP=0x00200000000b390b
...
- (void)runOperations;	// IMP=0x00100000000b38e9
- (void)fetchUserRecord;	// IMP=0x00100000000b3828
- (void)fetchDerivativesFilter;	// IMP=0x00100000000b354a
- (void)fetchDisabledFeatures;	// IMP=0x00100000000b310f
- (id)initWithController:(id)arg1 updateDisabledFeatures:(_Bool)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000000b3079
