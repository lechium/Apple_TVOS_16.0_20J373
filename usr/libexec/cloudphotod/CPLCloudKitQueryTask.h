...
- (void).cxx_destruct;	// IMP=0x00200000000b56b1
...
- (void)_runOperationsWithCurrentUserID:(id)arg1;	// IMP=0x00100000000b3d2d
- (void)runOperations;	// IMP=0x00100000000b3cab
- (void)sendProgressBatch:(id)arg1 updatedCursor:(id)arg2;	// IMP=0x00100000000b3c31
- (id)initWithController:(id)arg1 cursor:(id)arg2 class:(Class)arg3 scope:(id)arg4 transportScopeMapping:(id)arg5 progressHandler:(CDUnknownBlockType)arg6 completionHandler:(CDUnknownBlockType)arg7;	// IMP=0x00100000000b3a80
