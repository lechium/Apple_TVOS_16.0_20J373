...
- (void).cxx_destruct;	// IMP=0x00200000000311a2
...
- (void)enumerateChangesWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x0010000000031018
@property(readonly, nonatomic) _Bool hasChanges;
- (id)initWithStore:(id)arg1 table:(id)arg2;	// IMP=0x0010000000030ed6
