...
- (void).cxx_destruct;	// IMP=0x0020000000112fc8
...
- (void)_fetchStreamingURL;	// IMP=0x0010000000112309
- (void)runOperations;	// IMP=0x001000000011227c
- (_Bool)shouldRequestEncryptedStream;	// IMP=0x0010000000112223
- (id)_streamOperationForKey:(id)arg1 operationType:(long long)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0010000000111873
- (id)initWithController:(id)arg1 resource:(id)arg2 hints:(id)arg3 timeRange:(CDStruct_e83c9415)arg4 target:(id)arg5 transportScopeMapping:(id)arg6 cache:(id)arg7 completionHandler:(CDUnknownBlockType)arg8;	// IMP=0x0010000000111693
