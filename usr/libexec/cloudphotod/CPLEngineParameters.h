...
- (void).cxx_destruct;	// IMP=0x002000000001ac95
...
- (_Bool)matchesParameters:(id)arg1;	// IMP=0x001000000001aabf
- (id)redactedDescription;	// IMP=0x001000000001aa0b
- (id)description;	// IMP=0x001000000001a957
@property(readonly, nonatomic) id asPlist;
- (id)initWithPlist:(id)arg1;	// IMP=0x001000000001a585
- (id)initWithClientLibraryBaseURL:(id)arg1 cloudLibraryStateStorageURL:(id)arg2 cloudLibraryResourceStorageURL:(id)arg3 libraryIdentifier:(id)arg4 options:(unsigned long long)arg5;	// IMP=0x001000000001a470
