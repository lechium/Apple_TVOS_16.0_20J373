...
- (void).cxx_destruct;	// IMP=0x002000000012179e
...
- (void)_startDownload;	// IMP=0x0010000000120e00
- (void)_fetchPlaceholderRecordAndStartDownload;	// IMP=0x0010000000120be9
- (void)runOperations;	// IMP=0x0010000000120a91
- (id)_inMemoryDownloadOperationForRecordID:(id)arg1 resource:(id)arg2 record:(id)arg3 keys:(id)arg4 operationType:(long long)arg5 completionBlock:(CDUnknownBlockType)arg6;	// IMP=0x00100000001201df
- (id)initWithController:(id)arg1 resource:(id)arg2 record:(id)arg3 target:(id)arg4 transportScopeMapping:(id)arg5 completionHandler:(CDUnknownBlockType)arg6;	// IMP=0x0010000000120030
