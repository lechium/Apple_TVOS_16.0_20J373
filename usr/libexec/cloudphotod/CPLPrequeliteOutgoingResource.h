...
- (void).cxx_destruct;	// IMP=0x002000000003e30d
...
- (id)resourceWithScopeIdentifier:(id)arg1;	// IMP=0x001000000003e168
- (id)resourceWithOutgoingResources:(id)arg1;	// IMP=0x001000000003e05d
- (id)initWithResource:(id)arg1 uploadIdentifier:(id)arg2;	// IMP=0x001000000003dd94
- (id)initFromPQLResultSet:(id)arg1 error:(id *)arg2;	// IMP=0x001000000003dc40
