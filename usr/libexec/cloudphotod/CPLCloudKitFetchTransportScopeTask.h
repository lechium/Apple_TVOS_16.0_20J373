...
- (void).cxx_destruct;	// IMP=0x002000000009f399
...
- (void)runOperations;	// IMP=0x001000000009d902
- (void)createRecordZoneWithID:(id)arg1;	// IMP=0x001000000009d2bc
- (void)_callCompletionWithZone:(id)arg1;	// IMP=0x001000000009d141
- (void)_updateCloudKitScopeWithZone:(id)arg1;	// IMP=0x001000000009d021
- (id)initWithController:(id)arg1 scope:(id)arg2 cloudKitScope:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x001000000009cf0e
