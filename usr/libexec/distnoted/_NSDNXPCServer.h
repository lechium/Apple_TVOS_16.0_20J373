...
- (id)createEndpoint;	// IMP=0x002000000000191a
- (id)allClients;	// IMP=0x00100000000018dc
- (void)start;	// IMP=0x00100000000016fb
- (void)addInvalidationHandler:(CDUnknownBlockType)arg1;	// IMP=0x0010000000001681
- (void)invalidate;	// IMP=0x001000000000152f
- (id)__invalidate;	// IMP=0x00100000000014ec
- (void)setPrivileged:(_Bool)arg1;	// IMP=0x00100000000014e0
- (id)dispatchQueue;	// IMP=0x00100000000014d6
...
- (void)dealloc;	// IMP=0x00100000000012ef
- (id)initWithConfiguration:(struct distnoted_configuration *)arg1;	// IMP=0x001000000000123a
