...
+ (id)keyPathsForValuesAffectingManagementSourceIdentifier;	// IMP=0x0020000000029baa
- (id)reportDetails;	// IMP=0x002000000002a7f1
- (void)_validateLoadStateWithErrors:(id)arg1;	// IMP=0x001000000002a6b9
- (short)_currentLoadState;	// IMP=0x001000000002a575
- (void)_validateSetOncePropertiesWithErrors:(id)arg1;	// IMP=0x001000000002a10f
- (void)_validateManagementSourceWithErrors:(id)arg1;	// IMP=0x001000000002a072
- (_Bool)validateForUpdate:(id *)arg1;	// IMP=0x0010000000029e46
- (_Bool)validateForInsert:(id *)arg1;	// IMP=0x0010000000029c1a
