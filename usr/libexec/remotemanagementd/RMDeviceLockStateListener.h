...
+ (id)newListenerWithDelegate:(id)arg1;	// IMP=0x002000000002c552
- (void).cxx_destruct;	// IMP=0x002000000002cb4f
...
- (void)triggerAggregatingTimerAction;	// IMP=0x001000000002c972
- (void)didReceiveNotification:(id)arg1;	// IMP=0x001000000002c8b9
- (void)stopListening;	// IMP=0x001000000002c82d
- (void)startListening;	// IMP=0x001000000002c6a8
- (id)initWithDelegate:(id)arg1;	// IMP=0x001000000002c59b
