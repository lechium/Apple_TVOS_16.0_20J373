...
+ (id)sharedQueryQueue;	// IMP=0x004000000005eb9d
- (void).cxx_destruct;	// IMP=0x0020000000060514
...
- (void)_queryForTransactionsWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x001000000005f421
- (void)_delayedQuery;	// IMP=0x001000000005f0e8
- (void)_scheduleQueryForTransactions;	// IMP=0x001000000005efc3
- (void)_managedObjectContextDidSave:(id)arg1;	// IMP=0x001000000005eedf
- (void)start;	// IMP=0x001000000005ec44
- (void)dealloc;	// IMP=0x001000000005eaf5
- (id)initWithContext:(id)arg1;	// IMP=0x001000000005ea53
- (id)initWithPersistentHistoryToken:(id)arg1 context:(id)arg2;	// IMP=0x001000000005e9b2
