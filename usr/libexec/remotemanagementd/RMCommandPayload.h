...
+ (id)keyPathsForValuesAffectingManagementSourceIdentifier;	// IMP=0x0020000000020d51
- (id)reportDetails;	// IMP=0x002000000002159e
- (_Bool)validateForUpdate:(id *)arg1;	// IMP=0x0010000000021034
- (_Bool)validateForInsert:(id *)arg1;	// IMP=0x0010000000020dc1
