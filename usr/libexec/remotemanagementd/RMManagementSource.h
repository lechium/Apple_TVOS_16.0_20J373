...
+ (id)fetchRequestWithAccountIdentifier:(id)arg1;	// IMP=0x002000000004fe1a
+ (id)fetchRequestWithIdentifier:(id)arg1;	// IMP=0x001000000004fd73
+ (id)fetchRequestWithDeviceChannel;	// IMP=0x001000000004fcf0
+ (id)fetchRequestWithBootstrapURI:(id)arg1 enrollmentType:(short)arg2;	// IMP=0x001000000004fc3b
+ (id)fetchRequestWithBootstrapURI:(id)arg1;	// IMP=0x001000000004fb94
- (id)reportDetails;	// IMP=0x002000000004fec1
- (void)awakeFromInsert;	// IMP=0x001000000004faff
