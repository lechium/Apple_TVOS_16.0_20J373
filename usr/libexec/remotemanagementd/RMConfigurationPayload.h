...
- (id)reportDetails;	// IMP=0x0010000000022530
- (void)failedLoadingWithError:(id)arg1;	// IMP=0x0010000000022c53
- (_Bool)loadPayload:(id)arg1 error:(id *)arg2;	// IMP=0x001000000002268b
