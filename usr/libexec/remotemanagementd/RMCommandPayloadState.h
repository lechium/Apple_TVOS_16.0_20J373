...
- (void)markPending;	// IMP=0x0020000000021dfa
- (void)markFailedWithError:(id)arg1 reasons:(id)arg2;	// IMP=0x0010000000021aaa
- (void)markExecutedWithResult:(id)arg1 reasons:(id)arg2 unknownPayloadKeys:(id)arg3;	// IMP=0x0010000000021737
- (void)markQueued;	// IMP=0x00100000000216d4
