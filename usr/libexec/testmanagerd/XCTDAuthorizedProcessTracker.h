...
- (void).cxx_destruct;	// IMP=0x002000000002ba9d
...
- (id)_dispatchSourceForProcessID:(int)arg1;	// IMP=0x001000000002b783
- (_Bool)hasAuthorizedProcessID:(int)arg1;	// IMP=0x001000000002b61e
- (void)authorizeProcessID:(int)arg1;	// IMP=0x001000000002b313
- (void)dealloc;	// IMP=0x001000000002b1ee
- (id)init;	// IMP=0x001000000002b1b0
- (id)initWithDispatchSourceProvider:(CDUnknownBlockType)arg1;	// IMP=0x001000000002b0e5
