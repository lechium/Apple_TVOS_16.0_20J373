...
+ (id)processStateDescriptor;	// IMP=0x002000000001deac
+ (id)predicatesForBundleIDs:(id)arg1;	// IMP=0x001000000001dcdf
+ (id)stateSnapshotFromRBSState:(id)arg1 forRBSBundle:(id)arg2 pid:(int)arg3;	// IMP=0x001000000001da16
- (void).cxx_destruct;	// IMP=0x002000000001f112
...
- (id)bundleIDForPID:(int)arg1 error:(id *)arg2;	// IMP=0x001000000001effa
- (id)processSpecifierForPID:(int)arg1 error:(id *)arg2;	// IMP=0x001000000001efae
- (void)startMonitoringApplicationWithBundleID:(id)arg1 path:(id)arg2;	// IMP=0x001000000001df4a
- (void)guardIsValid:(CDUnknownBlockType)arg1;	// IMP=0x001000000001d9a1
- (void)invalidate;	// IMP=0x001000000001d8b2
- (id)initWithDelegate:(id)arg1;	// IMP=0x001000000001d83f
- (id)initWithDelegate:(id)arg1 processMonitor:(id)arg2 processHandleClass:(Class)arg3;	// IMP=0x001000000001d73c
