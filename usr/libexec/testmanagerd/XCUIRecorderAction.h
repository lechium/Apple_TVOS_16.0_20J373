...
- (void).cxx_destruct;	// IMP=0x0020000000009854
...
- (id)gestureNamesWaitForTimeInterval:(double *)arg1;	// IMP=0x0010000000008df3
- (id)eventTypeNameWaitForTimeInterval:(double *)arg1;	// IMP=0x0010000000008d2b
@property(readonly, getter=isHandEvent) _Bool handEvent;
- (id)init;	// IMP=0x0010000000008c18
