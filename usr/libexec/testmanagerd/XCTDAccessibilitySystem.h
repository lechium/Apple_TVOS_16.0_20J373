...
+ (id)sharedSystem;	// IMP=0x002000000001a3a7
- (void).cxx_destruct;	// IMP=0x002000000001bc1c
...
- (id)_queue_createAccessibilitySessionToken;	// IMP=0x001000000001ba3c
- (void)invalidateToken:(id)arg1;	// IMP=0x001000000001b833
- (void)_queue_setAccelerometerEnabled:(_Bool)arg1;	// IMP=0x001000000001b6af
- (void)_queue_setPassiveListeningModeEnabled:(_Bool)arg1;	// IMP=0x001000000001b424
- (void)_queue_unloadAccessibility;	// IMP=0x001000000001b1fb
- (_Bool)_queue_setDisableOnTerminationWithError:(id *)arg1;	// IMP=0x001000000001b004
- (_Bool)_queue_loadAccessibilityIfNeeded:(_Bool)arg1 andWaitForNotificationWithTimeout:(double)arg2 error:(id *)arg3;	// IMP=0x001000000001ac43
- (id)_queue_loadAccessibilityWithTimeout:(double)arg1 error:(id *)arg2;	// IMP=0x001000000001a8d6
- (id)loadAccessibilityWithTimeout:(double)arg1 error:(id *)arg2;	// IMP=0x001000000001a637
- (void)dealloc;	// IMP=0x001000000001a536
- (id)initWithAccessibilityFunctions:(CDStruct_f25c63ae)arg1;	// IMP=0x001000000001a44f
