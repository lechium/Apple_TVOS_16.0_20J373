...
+ (void)cacheAccessIdentity:(id)arg1 forAccessorAuditToken:(CDStruct_4c969caf *)arg2 responsibleAuditToken:(CDStruct_4c969caf *)arg3 isSpecificIdentity:(_Bool)arg4;	// IMP=0x004000000000fbc1
+ (id)cachedAccessIdentityForAccessorAuditToken:(CDStruct_4c969caf *)arg1 responsibleAuditToken:(CDStruct_4c969caf *)arg2 isSpecificIdentity:(_Bool)arg3;	// IMP=0x001000000000fafa
+ (void)clearCache;	// IMP=0x001000000000fa7a
+ (id)_createCacheKeyWithAccessorAuditToken:(CDStruct_4c969caf *)arg1 responsibleAuditToken:(CDStruct_4c969caf *)arg2 isSpecificIdentity:(_Bool)arg3;	// IMP=0x001000000000f67a
+ (void)_initIdentityCache;	// IMP=0x001000000000f5d6
- (void).cxx_destruct;	// IMP=0x0020000000012eca
...
- (_Bool)isPlugInWithExtensionPointIdentifier:(id)arg1;	// IMP=0x0010000000012cc9
- (_Bool)getSDKVersion:(unsigned int *)arg1 platformType:(unsigned int *)arg2;	// IMP=0x00100000000122a8
@property(readonly) NSString *attributionPath;
- (id)displayName;	// IMP=0x001000000001225c
- (id)description;	// IMP=0x001000000001221a
- (void)_updateFromAccessIdentity:(id)arg1;	// IMP=0x001000000001212f
- (id)_initWithAccessIdentity:(id)arg1;	// IMP=0x00100000000120c1
- (id)initWithIdentifier:(id)arg1 type:(int)arg2 executableURL:(id)arg3 SDKVersion:(unsigned int)arg4 platformType:(unsigned int)arg5;	// IMP=0x0010000000011b74
- (id)initWithBundleIdentifier:(id)arg1 isWK2Proxy:(_Bool)arg2;	// IMP=0x00100000000119bd
- (id)initWithMessage:(id)arg1;	// IMP=0x001000000001156b
- (id)initWithAttributionChain:(id)arg1 preferMostSpecificIdentifier:(_Bool)arg2;	// IMP=0x00100000000112dd
- (_Bool)_deriveIdentityFromAttributionChain:(id)arg1 preferMostSpecificIdentifier:(_Bool)arg2;	// IMP=0x001000000001028a
- (void)_makeDisplayNameBlockForURL:(id)arg1;	// IMP=0x0010000000010179
- (_Bool)isEqualToCachedIdentity:(id)arg1;	// IMP=0x001000000000f773
