...
+ (void)populateReplyMessageToDeny:(id)arg1 withError:(id)arg2;	// IMP=0x00400000000349b9
- (void).cxx_destruct;	// IMP=0x0020000000035443
...
- (void)populateReplyMessage:(id)arg1;	// IMP=0x0010000000034f77
- (id)description;	// IMP=0x0010000000034f63
- (id)descriptionWithRespectToService:(id)arg1;	// IMP=0x0010000000034cbb
- (void)denyAuthorizationWithErrorCode:(long long)arg1 format:(id)arg2;	// IMP=0x0010000000034afb
- (id)init;	// IMP=0x0010000000034aaa
