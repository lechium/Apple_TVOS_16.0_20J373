...
@interface TCCDService : NSObject
{
    ...
    NSBundle *_defaultLocalizedResourcesBundle;	// 392 = 0x188
}

+ (id)defaultLocalizedResourcesBundlePath;	// IMP=0x004000000002c57a
+ (id)requestDenyNotificationButtonTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x001000000002b208
+ (id)requestDenyNotificationTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x001000000002b1ec
+ (id)subsequentRequestLimitedAuthorizationButtonTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x001000000002b1d0
+ (id)subsequentRequestDenyAuthorizationButtonTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x001000000002b1b4
+ (id)subsequentRequestAllowAuthorizationButtonTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x001000000002b198
+ (id)requestLimitedAuthorizationButtonTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x001000000002b17c
+ (id)requestDenyAuthorizationButtonTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x001000000002b160
+ (id)requestAllowAuthorizationButtonTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x001000000002b144
+ (id)requestAdditionalTextForSubsequentRequestsKeyNameForServiceName:(id)arg1;	// IMP=0x001000000002b128
+ (id)requestAdditionalTextAfterV2UpgradeLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x001000000002b10c
+ (MISSING_TYPE *)requestAdditionalTextLocalizationKeyNameForServiceName: /* Error: Ran out of types for this method. */;	// IMP=0x001000000002b0f0
+ (id)requestTitleTextForSubsequentRequestsLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x001000000002b0d4
+ (id)requestTitleTextAfterV2UpgradeLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x001000000002b0b8
+ (id)requestTitleTextLocalizationKeyNameForServiceName:(id)arg1;	// IMP=0x001000000002b09c
+ (id)localizationKeyName:(id)arg1 forServiceName:(id)arg2;	// IMP=0x001000000002b074
+ (id)versionStringFromDYLDVersionNumber:(id)arg1;	// IMP=0x001000000002affc
+ (id)tccdPlatformNameForDYLDPlatformName:(id)arg1;	// IMP=0x001000000002af36
+ (id)serviceDescriptionsForPlatformName:(id)arg1;	// IMP=0x001000000002abf0
+ (id)serviceAll;	// IMP=0x001000000002ab6e
+ (id)allServices;	// IMP=0x0010000000027756
- (void).cxx_destruct;	// IMP=0x000000000002cfb8
...
- (id)localizedTextWithKey:(id)arg1;	// IMP=0x001000000002c74b
- (long long)developmentAuthorizationValue;	// IMP=0x001000000002c233
...
- (id)descriptionForAuthorizationValue:(unsigned long long)arg1 reason:(unsigned long long)arg2;	// IMP=0x001000000002c16a
- (id)authorizationRightStateForValue:(unsigned long long)arg1 reason:(unsigned long long)arg2;	// IMP=0x001000000002c0fc
- (_Bool)isAuthorizationValue:(unsigned long long)arg1 equalToRight:(unsigned long long)arg2;	// IMP=0x001000000002c0d0
- (long long)compare:(id)arg1;	// IMP=0x001000000002c03f
- (id)descriptionDictionary;	// IMP=0x001000000002b737
- (id)description;	// IMP=0x001000000002b725
- (id)initWithName:(id)arg1 availability:(id)arg2;	// IMP=0x001000000002b224
