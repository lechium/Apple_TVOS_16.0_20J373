...
@class ADSharedData, MISSING_TYPE, NSMutableArray, NSString, _ADPBDeviceOutputVoiceInfo, _ADPBDeviceStringKeyValueDictionary;
...
@interface _ADPBDeviceSetDataRequest : PBRequest
{
    ...
    MISSING_TYPE *_loggingAssistantId;	// 56 = 0x38
...
+ (Class)notificationPreviewRestrictedAppsType;	// IMP=0x00200000000f7274
+ (unsigned short)_ADPBDeviceRequestType;	// IMP=0x00100000000a246c
- (void).cxx_destruct;	// IMP=0x00100000000fa308
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000f9add
- (unsigned long long)hash;	// IMP=0x00100000000f9756
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000f9130
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000f8b6a
- (void)copyTo:(id)arg1;	// IMP=0x00100000000f8779
- (void)writeTo:(id)arg1;	// IMP=0x00100000000f8325
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000f8318
- (id)dictionaryRepresentation;	// IMP=0x00100000000f7451
- (id)description;	// IMP=0x00100000000f73a2
...
- (id)notificationPreviewRestrictedAppsAtIndex:(unsigned long long)arg1;	// IMP=0x00100000000f7257
- (unsigned long long)notificationPreviewRestrictedAppsCount;	// IMP=0x00100000000f723a
- (void)addNotificationPreviewRestrictedApps:(id)arg1;	// IMP=0x00100000000f71d0
- (void)clearNotificationPreviewRestrictedApps;	// IMP=0x00100000000f71b3
...
- (void)_ad_performWithSharedDataRemote:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00100000000c1d5d
- (void)_ad_performWithCloudService:(id)arg1 fromPeer:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x001000000013714c
