...
- (void).cxx_destruct;	// IMP=0x00200000001b2028
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001b1f4e
- (unsigned long long)hash;	// IMP=0x00100000001b1e9d
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001b1df8
- (id)description;	// IMP=0x00100000001b1d1a
