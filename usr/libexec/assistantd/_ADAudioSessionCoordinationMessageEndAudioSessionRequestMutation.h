...
- (void).cxx_destruct;	// IMP=0x00200000000ad4db
- (void)setEffectiveDate:(id)arg1;	// IMP=0x00100000000ad4bb
- (id)getEffectiveDate;	// IMP=0x00100000000ad483
- (_Bool)isDirty;	// IMP=0x00100000000ad478
- (id)initWithBase:(id)arg1;	// IMP=0x00100000000ad40d
