...
+ (void)updateSharedInfoWithIdentifier:(id)arg1 productType:(id)arg2 buildVersion:(id)arg3;	// IMP=0x00200000002cd148
+ (id)locallyPairedPeerInfo;	// IMP=0x00100000002cc7b1
+ (id)_queue;	// IMP=0x00100000002cc724
- (void).cxx_destruct;	// IMP=0x00200000002cd53e
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000002cd288
- (unsigned long long)hash;	// IMP=0x00100000002cd272
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000002cd267
- (id)afPeerInfo;	// IMP=0x00100000002ccf38
@property(readonly, copy, nonatomic) NSDictionary *dictionaryRepresentation;
- (id)description;	// IMP=0x00100000002cce21
- (id)initWithAFPeerInfo:(id)arg1;	// IMP=0x00100000002cca97
- (id)initWithUniqueIdentifer:(id)arg1;	// IMP=0x00100000002cca2a
- (id)initWithIDSIdentifer:(id)arg1;	// IMP=0x00100000002cca10
- (id)initWithIDSIdentifer:(id)arg1 productType:(id)arg2 buildVersion:(id)arg3 name:(id)arg4;	// IMP=0x00100000002cc8ff
