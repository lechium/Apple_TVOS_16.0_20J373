...
- (void).cxx_destruct;	// IMP=0x00200000001f36d9
...
- (id)analyticsDictionary;	// IMP=0x00100000001f33ea
- (void)markFailedWithType:(unsigned long long)arg1;	// IMP=0x00100000001f33dc
- (void)markSucceeded;	// IMP=0x00100000001f33d2
- (void)markEndTime;	// IMP=0x00100000001f3399
- (void)markStartTime;	// IMP=0x00100000001f3360
- (_Bool)hasFailureType;	// IMP=0x00100000001f3352
- (id)initWithDeliveryStream:(unsigned long long)arg1;	// IMP=0x00100000001f32d3
