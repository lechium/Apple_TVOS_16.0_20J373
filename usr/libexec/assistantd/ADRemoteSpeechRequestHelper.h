...
- (void).cxx_destruct;	// IMP=0x0020000000123dc1
...
- (void)reset;	// IMP=0x0010000000123d5f
- (id)setSpeechRequestOptions:(id)arg1 withCompletion:(CDUnknownBlockType)arg2;	// IMP=0x0010000000123ca0
