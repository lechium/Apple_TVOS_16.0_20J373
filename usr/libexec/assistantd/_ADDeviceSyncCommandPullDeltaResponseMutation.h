...
- (void).cxx_destruct;	// IMP=0x00200000000ae86f
- (void)setIncrementalChanges:(id)arg1;	// IMP=0x00100000000ae84f
- (id)getIncrementalChanges;	// IMP=0x00100000000ae817
- (_Bool)isDirty;	// IMP=0x00100000000ae80c
- (id)initWithBase:(id)arg1;	// IMP=0x00100000000ae7a1
