...
- (void).cxx_destruct;	// IMP=0x002000000011b4ee
...
- (id)forwardingTargetForSelector:(SEL)arg1;	// IMP=0x001000000011b49e
- (_Bool)respondsToSelector:(SEL)arg1;	// IMP=0x001000000011b450
@property double endWaitTime;
@property double interspeechWaitTime;
@property double startWaitTime;
@property int endpointMode;
- (void)reset;	// IMP=0x001000000011b38a
- (int)getStatus:(struct AudioQueueBuffer *)arg1;	// IMP=0x001000000011b2f3
- (_Bool)configureWithASBD:(struct AudioStreamBasicDescription *)arg1 andFrameRate:(unsigned int)arg2;	// IMP=0x001000000011b24f
