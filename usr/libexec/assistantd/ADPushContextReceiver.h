...
- (void).cxx_destruct;	// IMP=0x0020000000270ca6
- (oneway void)sendContext:(id)arg1;	// IMP=0x0010000000270b94
- (id)initWithCollector:(id)arg1 pid:(int)arg2 connection:(id)arg3;	// IMP=0x0010000000270af7
