...
- (void).cxx_destruct;	// IMP=0x002000000020de8e
@property(readonly, copy, nonatomic) NSString *deviceIdentifier; // @synthesize deviceIdentifier=_deviceIdentifier;
- (void)sendMessage:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x001000000020ddbb
- (id)initWithDeviceIdentifier:(id)arg1 messagingService:(id)arg2;	// IMP=0x001000000020dd17
