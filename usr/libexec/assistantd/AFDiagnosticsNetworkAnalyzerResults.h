...
- (void).cxx_destruct;	// IMP=0x00200000001bf960
...
- (unsigned long long)_durationInMillisecondsForDuration:(id)arg1;	// IMP=0x00100000001bfdb3
- (id)metricValue;	// IMP=0x00100000001bf9ca
