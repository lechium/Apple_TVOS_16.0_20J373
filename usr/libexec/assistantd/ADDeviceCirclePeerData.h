...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000012944d
+ (id)newWithBuilder:(CDUnknownBlockType)arg1;	// IMP=0x0010000000128cdb
- (void).cxx_destruct;	// IMP=0x0010000000129cb0
...
- (id)buildDictionaryRepresentation;	// IMP=0x0010000000129af1
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x0010000000129756
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000129671
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000129455
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000129442
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000129144
@property(readonly) unsigned long long hash;
- (id)_descriptionWithIndent:(unsigned long long)arg1;	// IMP=0x0010000000128fe4
@property(readonly, copy) NSString *description;
- (id)initWithAceVersion:(id)arg1 assistantIdentifier:(id)arg2 buildVersion:(id)arg3 productType:(id)arg4 sharedUserIdentifier:(id)arg5 userAssignedDeviceName:(id)arg6 userInterfaceIdiom:(id)arg7 homeAccessoryInfo:(id)arg8;	// IMP=0x0010000000128d3c
- (id)init;	// IMP=0x0010000000128d28
- (id)initWithBuilder:(CDUnknownBlockType)arg1;	// IMP=0x00100000001289fc
- (id)mutatedCopyWithMutator:(CDUnknownBlockType)arg1;	// IMP=0x001000000012a0c7
