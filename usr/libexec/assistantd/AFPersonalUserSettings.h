...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000001525e3
- (void).cxx_destruct;	// IMP=0x0020000000152868
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000152699
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000001525eb
