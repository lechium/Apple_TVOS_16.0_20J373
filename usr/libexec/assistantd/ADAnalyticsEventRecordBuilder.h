...
- (void).cxx_destruct;	// IMP=0x0020000000116178
- (id)build;	// IMP=0x0010000000115f4f
- (void)setValue:(id)arg1 forColumnName:(id)arg2;	// IMP=0x0010000000115ddc
- (void)reset;	// IMP=0x0010000000115d56
