...
- (void).cxx_destruct;	// IMP=0x002000000022e73b
...
- (id)dictionaryRepresentation;	// IMP=0x001000000022e677
- (id)initWithIdentifier:(id)arg1 name:(id)arg2 RSSI:(id)arg3 state:(id)arg4;	// IMP=0x001000000022e595
