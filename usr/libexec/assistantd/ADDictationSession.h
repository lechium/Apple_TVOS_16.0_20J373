...
- (void).cxx_destruct;	// IMP=0x00200000000da0cc
...
- (void)_setAudioFileIOTransactionState:(long long)arg1;	// IMP=0x00100000000d9d7d
- (void)_setSpeechRecognitionTransactionState:(long long)arg1;	// IMP=0x00100000000d9a74
- (void)dealloc;	// IMP=0x00100000000d979c
- (id)initWithUUID:(id)arg1 timestamp:(unsigned long long)arg2 languageCode:(id)arg3 options:(id)arg4 speechRequestOptions:(id)arg5;	// IMP=0x00100000000d9691
- (id)init;	// IMP=0x00100000000d9683
