...
@class AFRequestInfo, MISSING_TYPE, NSDate, NSUUID;
...
- (MISSING_TYPE *).cxx_destruct;	// IMP=0x00200000000aebcf
...
- (void)dealloc;	// IMP=0x00100000000aead1
- (void)completeRequestWithSuccess:(_Bool)arg1 forReason:(long long)arg2 shouldEmitInstrumentationEvent:(_Bool)arg3;	// IMP=0x00100000000aea79
- (id)initWithAnnouncementRequestType:(unsigned long long)arg1 platform:(long long)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00100000000ae99c
