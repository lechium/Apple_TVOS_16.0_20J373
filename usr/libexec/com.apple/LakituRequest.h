...
- (void).cxx_destruct;	// IMP=0x00200000000417da
...
- (void)performRequestWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x0010000000040fe2
- (id)sessionConfig;	// IMP=0x0010000000040eae
- (void)URLSession:(id)arg1 task:(id)arg2 willPerformHTTPRedirection:(id)arg3 newRequest:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x0010000000040b56
@property(readonly, nonatomic) NSMutableURLRequest *urlRequest;
- (id)protectionSpace;	// IMP=0x0010000000040a9a
- (id);	// IMP=0x0010000000040a92
- (id)validateInput;	// IMP=0x0010000000040948
- (id)additionalHeaders;	// IMP=0x001000000004093b
- (id)authorizationHeader;	// IMP=0x0010000000040933
- (id)bodyDictionary;	// IMP=0x001000000004092b
