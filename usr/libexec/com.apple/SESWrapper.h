...
- (void).cxx_destruct;	// IMP=0x00200000000606c8
...
- (void)dealloc;	// IMP=0x001000000006054e
- (id)recoveryResponseForBlob:(id)arg1;	// IMP=0x001000000005fcbb
- (id)srpResponseForEscrowBlob:(id)arg1 withKey:(struct __SecKey *)arg2 withFullCCKey:(struct ccrsa_full_ctx *)arg3;	// IMP=0x001000000005f0eb
- (id)decodedEscrowRecordFromData:(id)arg1 stingray:(_Bool)arg2 env:(id)arg3 duplicate:(_Bool)arg4;	// IMP=0x001000000005e244
- (id)encodedEscrowRecordWithPublicKey:(struct __SecKey *)arg1 error:(id *)arg2;	// IMP=0x001000000005c2e6
- (id)srpRecoveryBlobFromData:(id)arg1 error:(id *)arg2;	// IMP=0x001000000005b2e4
- (void)srpRecoveryUpdateDSID:(id)arg1 recoveryPassphrase:(id)arg2;	// IMP=0x001000000005b266
- (unsigned long long)srpPublicKeySize;	// IMP=0x001000000005b20c
- (unsigned long long)srpKeySize;	// IMP=0x001000000005b196
- (id)srpInitBlob;	// IMP=0x001000000005b00e
- (id)initWithDSID:(id)arg1 escrowRecordContents:(id)arg2 recoveryPassphrase:(id)arg3 recordID:(id)arg4 recordLabel:(id)arg5 ckvrFlag:(_Bool)arg6 reqVersion:(int)arg7;	// IMP=0x001000000005ad9c
- (id)initWithDSID:(id)arg1 escrowRecordContents:(id)arg2 recoveryPassphrase:(id)arg3 recordID:(id)arg4 recordLabel:(id)arg5;	// IMP=0x001000000005acb7
- (id)initWithRequest:(id)arg1 ckvrFlag:(_Bool)arg2 reqVersion:(int)arg3;	// IMP=0x001000000005aafa
- (id)initWithRequest:(id)arg1 reqVersion:(int)arg2;	// IMP=0x001000000005aa99
- (id)initWithRequest:(id)arg1;	// IMP=0x001000000005aa85
