...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000000fd4a
...
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000000fe6a
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000000fd52
- (id)description;	// IMP=0x001000000000fc20
- (id)initWithStoredCertificate:(id)arg1 uuid:(id)arg2;	// IMP=0x001000000000fafc
