...
- (void).cxx_destruct;	// IMP=0x0020000000019f1b
...
- (id)_filteredMetadataForDoubleEnrollment:(id)arg1;	// IMP=0x0010000000019b2b
- (id)urlString;	// IMP=0x0010000000019a7b
- (id)urlRequest;	// IMP=0x0010000000019941
- (id)authorizationHeader;	// IMP=0x0010000000019831
- (id)authorizationHeaderWithUser:(id)arg1 password:(id)arg2 authType:(id)arg3;	// IMP=0x0010000000019634
- (id)bodyDictionary;	// IMP=0x0010000000019313
- (id)validateInput;	// IMP=0x0010000000018fc4
...
- (id)currentAccount;	// IMP=0x0010000000018b45
@property(readonly, copy, nonatomic) NSString *recoveryPassphrase; // @synthesize recoveryPassphrase=_recoveryPassphrase;
- (id)loggingDescription;	// IMP=0x0010000000018971
- (id)initWithRequest:(id)arg1;	// IMP=0x00100000000184cf
