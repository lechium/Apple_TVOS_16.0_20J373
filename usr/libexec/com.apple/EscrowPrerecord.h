...
+ (id)createPrerecordFromCandidate:(id)arg1 storedCertificate:(id)arg2 request:(id)arg3 error:(id *)arg4;	// IMP=0x001000000004d176
- (void).cxx_destruct;	// IMP=0x0010000000042d8e
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000042a54
- (unsigned long long)hash;	// IMP=0x00100000000428f3
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000004262a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000423fa
- (void)copyTo:(id)arg1;	// IMP=0x0010000000042257
- (void)writeTo:(id)arg1;	// IMP=0x00100000000420d1
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000420c4
- (id)dictionaryRepresentation;	// IMP=0x0010000000041b0a
- (id)description;	// IMP=0x0010000000041a5b
@property(readonly, nonatomic) _Bool hasDuplicateEscrowBlob;
- (int)StringAsPassphraseType:(id)arg1;	// IMP=0x0010000000041997
- (id)passphraseTypeAsString:(int)arg1;	// IMP=0x001000000004194e
...
- (id)initWithCandidate:(id)arg1 certificate:(id)arg2 escrowBlob:(id)arg3 passphraseType:(int)arg4;	// IMP=0x001000000004cf2d
