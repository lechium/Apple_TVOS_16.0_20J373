...
+ (id)personaAwareAccountWithDSID:(id)arg1;	// IMP=0x004000000004df1f
- (void).cxx_destruct;	// IMP=0x002000000004e9f7
...
- (id)initWithACAccount:(id)arg1;	// IMP=0x001000000004e168
