...
@class MISSING_TYPE, NSString, NSXPCConnection, PGPictureInPictureApplication, PGPictureInPictureController, PGPictureInPictureViewController;

@protocol PGPictureInPictureControllerDelegate <NSObject>

@optional
- (MISSING_TYPE *)pictureInPictureControllerCanBackgroundStartForFaceTimeVideoCall: /* Error: Ran out of types for this method. */;
