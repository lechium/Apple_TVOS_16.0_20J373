...
- (id)description;	// IMP=0x00100000000dafca
- (unsigned long long)hash;	// IMP=0x00100000000dac3e
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000da8b3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000da6c1
