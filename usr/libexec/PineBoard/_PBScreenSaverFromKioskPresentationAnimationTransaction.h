...
- (void).cxx_destruct;	// IMP=0x002000000014d0a5
...
- (void)_willInterruptWithReason:(id)arg1;	// IMP=0x001000000014cf78
- (void)_begin;	// IMP=0x001000000014c50d
- (_Bool)_canBeInterrupted;	// IMP=0x001000000014c505
