...
+ (id)sharedMetricsWithPhotoLibrary:(id)arg1;	// IMP=0x004000000006573b
- (void).cxx_destruct;	// IMP=0x0020000000066373
- (int)persist;	// IMP=0x0010000000065c11
- (int)reportAnalyzedAsset:(id)arg1 withAnalysis:(id)arg2 andProcessingTime:(double)arg3;	// IMP=0x001000000006595d
- (void)dealloc;	// IMP=0x00100000000656af
- (id)initWithPhotoLibrary:(id)arg1;	// IMP=0x0010000000064c50
