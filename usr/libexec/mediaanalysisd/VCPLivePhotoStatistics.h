...
- (unsigned long long)assetCountWithLivePhotoEffectsAnalyzed;	// IMP=0x000000000003c6b6
- (unsigned long long)firstFailedSubClassifierCounter:(unsigned long long)arg1;	// IMP=0x001000000003c6a8
- (unsigned long long)stablizeResultsCounter:(unsigned long long)arg1;	// IMP=0x001000000003c69a
- (unsigned long long)activityDecisionCounter:(unsigned long long)arg1;	// IMP=0x001000000003c68c
- (unsigned long long)gatingDecisionCounter:(unsigned long long)arg1;	// IMP=0x001000000003c681
- (void)addLivePhotoEffectsAnalyzedCount:(unsigned long long)arg1;	// IMP=0x001000000003c674
- (void)addCount:(unsigned long long)arg1 toFirstFailedSubClassifierCounter:(unsigned long long)arg2;	// IMP=0x001000000003c666
- (void)addCount:(unsigned long long)arg1 toStablizeResultsCounter:(unsigned long long)arg2;	// IMP=0x001000000003c658
- (void)addCount:(unsigned long long)arg1 toActivityDecisionCounter:(unsigned long long)arg2;	// IMP=0x001000000003c64a
- (void)addCount:(unsigned long long)arg1 toGatingDecisionCounter:(unsigned long long)arg2;	// IMP=0x001000000003c63f
- (id)init;	// IMP=0x001000000003c5de
