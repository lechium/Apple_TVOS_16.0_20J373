...
- (void).cxx_destruct;	// IMP=0x00200000000d5425
...
- (void)main;	// IMP=0x00100000000d5388
- (int)mainInternal;	// IMP=0x00100000000d537d
- (_Bool)isCancelled;	// IMP=0x00100000000d532d
- (id)initWithPhotoLibrary:(id)arg1;	// IMP=0x00100000000d5279
- (id)init;	// IMP=0x00100000000d526b
