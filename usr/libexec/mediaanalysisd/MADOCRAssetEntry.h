...
+ (id)entryWithAsset:(id)arg1 andPreviousStatus:(unsigned long long)arg2;	// IMP=0x0040000000054911
- (void).cxx_destruct;	// IMP=0x0020000000054a29
...
- (void)setVersion:(int)arg1;	// IMP=0x00100000000549b4
- (int)version;	// IMP=0x00100000000549ab
...
- (id)initWithAsset:(id)arg1 andPreviousStatus:(unsigned long long)arg2;	// IMP=0x0010000000054880
