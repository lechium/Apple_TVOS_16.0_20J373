...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000000073c6
- (void).cxx_destruct;	// IMP=0x002000000000835f
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000007be0
@property(readonly) unsigned long long hash;
- (id)offerWithMetrics:(id)arg1;	// IMP=0x00100000000078c3
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000078b8
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000000076e0
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000073ce
- (id)initWithID:(id)arg1 titles:(id)arg2 subtitles:(id)arg3 flags:(long long)arg4 ageRating:(id)arg5 metrics:(id)arg6 notSubscribedOffer:(id)arg7 subscribedOffer:(id)arg8;	// IMP=0x0010000000007221
