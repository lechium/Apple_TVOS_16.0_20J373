...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000001b92c
- (void).cxx_destruct;	// IMP=0x002000000001c7c0
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000001c0e8
@property(readonly) unsigned long long hash;
- (id)offerWithMetrics:(id)arg1;	// IMP=0x001000000001bdf6
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000001bdeb
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000001bc23
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000001b934
- (id)initWithID:(id)arg1 titles:(id)arg2 subtitles:(id)arg3 flags:(long long)arg4 ageRating:(id)arg5 metrics:(id)arg6 url:(id)arg7 isSensitive:(_Bool)arg8;	// IMP=0x001000000001b7bf
