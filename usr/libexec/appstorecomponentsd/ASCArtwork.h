...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000000084f1
- (void).cxx_destruct;	// IMP=0x0020000000009203
...
- (id)makeURLWithSubstitutions:(id)arg1;	// IMP=0x0010000000009033
- (id)description;	// IMP=0x0010000000008ea4
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000008b14
- (unsigned long long)hash;	// IMP=0x00100000000089cb
@property(readonly, copy, nonatomic) NSString *URLTemplate;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000000890c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000000087b3
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000084f9
- (id)initWithURLTemplate:(id)arg1 width:(double)arg2 height:(double)arg3 decoration:(id)arg4 preferredCrop:(id)arg5 preferredFormat:(id)arg6;	// IMP=0x00100000000083be
