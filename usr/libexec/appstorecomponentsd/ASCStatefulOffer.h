...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000019e86
- (void).cxx_destruct;	// IMP=0x002000000001afbd
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000001a71d
@property(readonly) unsigned long long hash;
- (id)offerWithMetrics:(id)arg1;	// IMP=0x001000000001a3ae
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000001a3a3
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000001a197
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000019e8e
- (id)initWithID:(id)arg1 titles:(id)arg2 subtitles:(id)arg3 flags:(long long)arg4 ageRating:(id)arg5 metrics:(id)arg6 defaultOffer:(id)arg7 buyOffer:(id)arg8 openOffer:(id)arg9;	// IMP=0x0010000000019ccc
