...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000000c3fb
- (void).cxx_destruct;	// IMP=0x001000000000db62
...
- (id)lockupWithOffer:(id)arg1;	// IMP=0x001000000000d94d
- (id)lockupByAddingFeature:(id)arg1;	// IMP=0x001000000000d687
- (id)featureWithClass:(Class)arg1;	// IMP=0x001000000000d53a
@property(readonly, copy) NSString *description;
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000000cb5d
@property(readonly) unsigned long long hash;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000000c91c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000000c6cc
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000000c403
- (id)initWithID:(id)arg1 kind:(id)arg2 metrics:(id)arg3 icon:(id)arg4 heading:(id)arg5 title:(id)arg6 subtitle:(id)arg7 ageRating:(id)arg8 offer:(id)arg9;	// IMP=0x001000000000c3ba
- (id)initWithID:(id)arg1 kind:(id)arg2 metrics:(id)arg3 icon:(id)arg4 heading:(id)arg5 title:(id)arg6 subtitle:(id)arg7 ageRating:(id)arg8 offer:(id)arg9 features:(id)arg10;	// IMP=0x001000000000c1ad
- (id)initWithID:(id)arg1 kind:(id)arg2 icon:(id)arg3 heading:(id)arg4 title:(id)arg5 subtitle:(id)arg6 ageRating:(id)arg7 offer:(id)arg8;	// IMP=0x001000000000dbe2
...
- (id)lockupWithSignpostTags:(id)arg1;	// IMP=0x001000000000fedb
