...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000000586d
- (void).cxx_destruct;	// IMP=0x002000000000718b
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000006565
@property(readonly) unsigned long long hash;
- (id)offerWithMetrics:(id)arg1;	// IMP=0x00000000000060ae
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000060a3
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000005dc7
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000005875
- (id)initWithID:(id)arg1 titles:(id)arg2 subtitles:(id)arg3 flags:(long long)arg4 ageRating:(id)arg5 metrics:(id)arg6 baseBuyParams:(id)arg7 metricsBuyParams:(id)arg8 additionalHeaders:(id)arg9 preflightPackageURL:(id)arg10 bundleID:(id)arg11 itemName:(id)arg12 vendorName:(id)arg13;	// IMP=0x0010000000005611
