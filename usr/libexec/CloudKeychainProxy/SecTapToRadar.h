...
+ (_Bool)askUserIfTTR:(id)arg1;	// IMP=0x0040000000012a69
+ (void)triggerTapToRadar:(id)arg1;	// IMP=0x0010000000012970
+ (void)disableTTRsEntirely;	// IMP=0x0010000000012963
+ (_Bool)isRateLimited:(id)arg1;	// IMP=0x0010000000012941
+ (id)keyname:(id)arg1;	// IMP=0x00100000000128cb
- (void).cxx_destruct;	// IMP=0x002000000001271b
...
- (void)trigger;	// IMP=0x00100000000125b5
- (void)clearRetryTimestamp;	// IMP=0x001000000001252c
- (void)updateRetryTimestamp;	// IMP=0x001000000001244b
- (_Bool)isRateLimited;	// IMP=0x0010000000012334
- (id)initTapToRadar:(id)arg1 description:(id)arg2 radar:(id)arg3;	// IMP=0x00100000000121e3
