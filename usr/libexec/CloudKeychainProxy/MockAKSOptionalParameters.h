...
- (void).cxx_destruct;	// IMP=0x002000000000e571
...
- (void)mergeFrom:(id)arg1;	// IMP=0x001000000000e47f
- (unsigned long long)hash;	// IMP=0x001000000000e412
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000000e31a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000000e256
- (void)copyTo:(id)arg1;	// IMP=0x001000000000e1d3
- (void)writeTo:(id)arg1;	// IMP=0x001000000000e159
- (_Bool)readFrom:(id)arg1;	// IMP=0x001000000000dfed
- (id)dictionaryRepresentation;	// IMP=0x001000000000df43
- (id)description;	// IMP=0x001000000000de94
