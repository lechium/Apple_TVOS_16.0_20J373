...
+ (id)monitor;	// IMP=0x002000000000198a
- (void).cxx_destruct;	// IMP=0x00200000000018b3
...
- (void)_onqueueRecheck;	// IMP=0x0010000000001732
- (void)recheck;	// IMP=0x00100000000016e7
- (void)connectTo:(id)arg1;	// IMP=0x00100000000016bc
- (void)notifyListener;	// IMP=0x0010000000001655
- (void)handleNotification:(const char *)arg1;	// IMP=0x0010000000001609
- (id)init;	// IMP=0x001000000000149c
