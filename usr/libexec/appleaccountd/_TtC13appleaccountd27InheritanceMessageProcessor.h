...
- (void).cxx_destruct;	// IMP=0x00400000001218e0
- (id)init;	// IMP=0x0010000000121880
- (void)messageService:(id)arg1 didReceiveMessage:(id)arg2 fromID:(id)arg3;	// IMP=0x00100000001217c0
