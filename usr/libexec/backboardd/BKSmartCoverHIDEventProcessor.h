...
+ (_Bool)isSmartCoverSupported;	// IMP=0x002000000004f47b
- (void).cxx_destruct;	// IMP=0x002000000004f218
...
- (void)appendDescriptionToFormatter:(id)arg1;	// IMP=0x001000000004efa0
- (id)addSmartCoverObserver:(id)arg1;	// IMP=0x001000000004eee0
- (long long)processEvent:(inout struct __IOHIDEvent **)arg1 sender:(id)arg2 dispatcher:(id)arg3;	// IMP=0x001000000004e740
@property(readonly, nonatomic, getter=isSmartCoverClosed) _Bool smartCoverClosed;
- (int)_smartCoverSensorsDidDisengage:(unsigned long long)arg1;	// IMP=0x001000000004e6bc
- (int)_smartCoverSensorsDidEngage:(unsigned long long)arg1;	// IMP=0x001000000004e687
- (id)initWithContext:(id)arg1;	// IMP=0x001000000004e444
- (unsigned long long)_currentMaskForUsage:(unsigned int)arg1 HIDSystem:(id)arg2 mask:(unsigned long long *)arg3 maskIfEngaged:(unsigned long long *)arg4;	// IMP=0x001000000004e31a
- (id)initWithSupportedHES:(unsigned long long)arg1 disengagedHES:(unsigned long long)arg2 attached:(_Bool)arg3 unknownState:(_Bool)arg4;	// IMP=0x001000000004dfe8
