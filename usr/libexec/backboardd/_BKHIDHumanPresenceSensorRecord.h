...
- (void).cxx_destruct;	// IMP=0x0020000000061ab0
...
- (void)removeService:(id)arg1;	// IMP=0x0010000000061a3b
- (void)addService:(id)arg1;	// IMP=0x00100000000619c7
- (void)_resetServiceStatus;	// IMP=0x0010000000061800
- (id)description;	// IMP=0x0010000000061712
