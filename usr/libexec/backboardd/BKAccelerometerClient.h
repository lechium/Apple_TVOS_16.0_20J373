...
- (_Bool)_shouldSendSampleEventWithTimestamp:(double)arg1 samplingInterval:(double)arg2;	// IMP=0x00100000000452a3
- (_Bool)_passesThresholdForX:(float)arg1 y:(float)arg2 z:(float)arg3;	// IMP=0x00100000000451f8
- (void)_queue_invalidate;	// IMP=0x00100000000451c9
- (void)handleOrientationEvent:(long long)arg1 orientationLocked:(_Bool)arg2;	// IMP=0x00100000000451c3
- (void)handleAccelerometerEventWithTimestamp:(double)arg1 x:(float)arg2 y:(float)arg3 z:(float)arg4 samplingInterval:(double)arg5;	// IMP=0x00100000000451bd
- (id)descriptionBuilderWithMultilinePrefix:(id)arg1;	// IMP=0x00100000000450d0
