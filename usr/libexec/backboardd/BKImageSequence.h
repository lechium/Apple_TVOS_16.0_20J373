...
- (void).cxx_destruct;	// IMP=0x0020000000021825
...
- (void)_loadAllImages;	// IMP=0x0010000000021763
- (struct CGImage *)_imageAtIndex:(long long)arg1;	// IMP=0x00100000000214b5
- (id)_idiomSuffix;	// IMP=0x00100000000214a8
- (struct CGImage *)_createImageForIndex:(unsigned long long)arg1 basename:(id)arg2 scale:(double)arg3 idiom:(id)arg4 bundle:(id)arg5;	// IMP=0x0010000000021164
- (id)allImages;	// IMP=0x0010000000021135
- (struct CGImage *)imageAtIndex:(long long)arg1;	// IMP=0x0010000000021123
- (id)initWithBasename:(id)arg1 bundle:(id)arg2 imageCount:(long long)arg3 scale:(double)arg4;	// IMP=0x0010000000020ff4
