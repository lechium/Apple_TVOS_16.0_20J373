...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000002096e
+ (id)classesRequiredToDecode;	// IMP=0x00100000000208e8
- (void).cxx_destruct;	// IMP=0x00200000000208c0
...
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000002071a
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000000205aa
- (void)dealloc;	// IMP=0x0010000000020520
- (id)_initWithDescriptor:(id)arg1 overlayType:(long long)arg2 imageData:(id)arg3 level:(float)arg4 frozen:(_Bool)arg5;	// IMP=0x001000000002042d
