...
- (void).cxx_destruct;	// IMP=0x0020000000017791
...
- (id)newLayerForContent:(id)arg1 scale:(double)arg2;	// IMP=0x00100000000175ab
- (void)sizeLayer:(id)arg1 toFitAtScale:(double)arg2;	// IMP=0x00100000000174fb
- (void)applyToLayer:(id)arg1 forContent:(id)arg2;	// IMP=0x001000000001747d
