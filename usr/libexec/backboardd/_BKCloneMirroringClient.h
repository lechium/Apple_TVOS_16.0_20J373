...
+ (id)defaultClient;	// IMP=0x0040000000061639
- (void).cxx_destruct;	// IMP=0x00200000000615cd
// Error: Property attributes should begin with the type ('T') attribute, property name: versionedPID
// Property attributes: (null)

@property(readonly, nonatomic) unsigned long long mode; // @synthesize mode=_mode;
@property(nonatomic) __weak id <_BKCloneMirroringClientDelegate> delegate; // @synthesize delegate=_delegate;
- (id)initWithMode:(unsigned long long)arg1 port:(id)arg2 auditToken:(id)arg3;	// IMP=0x001000000006144f
