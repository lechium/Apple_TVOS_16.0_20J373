...
+ (id)_bundleInfoOverrides;	// IMP=0x002000000001be46
- (void).cxx_destruct;	// IMP=0x002000000001bba8
...
- (void)_noteExitedWithContext:(id)arg1;	// IMP=0x001000000001b9fe
- (_Bool)terminate;	// IMP=0x001000000001b7d6
- (_Bool)launchWithResultBlock:(CDUnknownBlockType)arg1 exitBlock:(CDUnknownBlockType)arg2;	// IMP=0x001000000001a54f
- (void)appendDescriptionToFormatter:(id)arg1;	// IMP=0x001000000001a4b8
@property(readonly, copy) NSString *description;
- (id)initWithBundleId:(id)arg1 options:(id)arg2 queue:(id)arg3;	// IMP=0x001000000001a3d5
