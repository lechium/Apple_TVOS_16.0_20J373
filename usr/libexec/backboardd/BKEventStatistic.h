...
+ (id)statisticWithLabel:(id)arg1;	// IMP=0x00200000000459a5
- (void).cxx_destruct;	// IMP=0x002000000004594c
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000458ac
- (void)reset;	// IMP=0x0010000000045771
- (void)appendDescriptionToFormatter:(id)arg1;	// IMP=0x001000000004566c
