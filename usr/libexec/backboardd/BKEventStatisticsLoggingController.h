...
+ (id)workQueue;	// IMP=0x00200000000474b8
- (void).cxx_destruct;	// IMP=0x0020000000046deb
@property(copy, nonatomic) NSArray *statistics; // @synthesize statistics=_statistics;
- (void)invalidate;	// IMP=0x0010000000046d87
- (void)updateStatistics:(CDUnknownBlockType)arg1;	// IMP=0x0010000000046cfc
- (id)beginTransactionForReason:(id)arg1;	// IMP=0x0010000000046ce6
- (void)dealloc;	// IMP=0x0010000000046b5f
- (id)initWithLabel:(id)arg1 logCategory:(id)arg2;	// IMP=0x0010000000046993
