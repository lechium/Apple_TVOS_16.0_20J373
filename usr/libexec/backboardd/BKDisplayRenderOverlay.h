...
- (void).cxx_destruct;	// IMP=0x002000000001cfd2
...
- (id)descriptionBuilderWithMultilinePrefix:(id)arg1;	// IMP=0x001000000001ce87
- (id)descriptionWithMultilinePrefix:(id)arg1;	// IMP=0x001000000001ce37
- (id)succinctDescriptionBuilder;	// IMP=0x001000000001cdcf
- (id)succinctDescription;	// IMP=0x001000000001cd7f
@property(readonly, copy) NSString *description;
- (void)_wrapInCATransaction:(CDUnknownBlockType)arg1;	// IMP=0x001000000001cd06
- (id)_persistenceData;	// IMP=0x001000000001cc90
- (void)_cleanup;	// IMP=0x001000000001cc8a
- (void)_freeze;	// IMP=0x001000000001cc84
- (void)_dismissWithAnimationSettings:(id)arg1;	// IMP=0x001000000001cc7e
- (void)_stopAnimating;	// IMP=0x001000000001cc78
- (void)_startAnimating;	// IMP=0x001000000001cc72
- (_Bool)_presentWithAnimationSettings:(id)arg1;	// IMP=0x001000000001cc6a
- (void)dismissWithAnimationSettings:(id)arg1;	// IMP=0x001000000001cb20
- (void)freeze;	// IMP=0x001000000001c8e6
- (_Bool)presentWithAnimationSettings:(id)arg1;	// IMP=0x001000000001c712
...
- (void)dealloc;	// IMP=0x001000000001c4b6
- (id)_initWithPersistenceData:(id)arg1;	// IMP=0x001000000001c406
- (id)initWithOverlayDescriptor:(id)arg1 level:(float)arg2;	// IMP=0x001000000001bf29
