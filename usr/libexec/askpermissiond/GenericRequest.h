...
- (void).cxx_destruct;	// IMP=0x002000000001c5b2
...
- (id)compile;	// IMP=0x001000000001c359
- (id)initWithDictionary:(id)arg1;	// IMP=0x001000000001c037
- (id)initWithDate:(id)arg1 identifier:(id)arg2 itemIdentifier:(id)arg3 localizations:(id)arg4 offerName:(id)arg5 status:(long long)arg6;	// IMP=0x001000000001bf2b
