...
@interface ApprovalRequest : NSObject
{
    ...
    MISSING_TYPE *_itemIdentifier;	// 32 = 0x20
...
- (void).cxx_destruct;	// IMP=0x002000000001be28
...
- (id)compile;	// IMP=0x001000000001b742
- (id)initWithCloudPushDictionary:(id)arg1 bag:(id)arg2;	// IMP=0x0010000000019f4a
- (id)initWithCloudPushDictionary:(id)arg1;	// IMP=0x0010000000019ec9
- (id)initWithApproverDSID:(id)arg1 date:(id)arg2 identifier:(id)arg3 itemBundleID:(id)arg4 itemDescription:(id)arg5 itemIdentifier:(id)arg6 itemTitle:(id)arg7 localizations:(id)arg8 offerName:(id)arg9 mocked:(_Bool)arg10 previewURL:(id)arg11 productType:(id)arg12 productTypeName:(id)arg13 productURL:(id)arg14 requesterName:(id)arg15 requesterDSID:(id)arg16 requestInfo:(id)arg17 status:(long long)arg18;	// IMP=0x0010000000019c1e
- (id)initWithDictionary:(id)arg1;	// IMP=0x00100000000195c4
