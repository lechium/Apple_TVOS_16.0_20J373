...
- (void).cxx_destruct;	// IMP=0x002000000001e190
...
- (id)compile;	// IMP=0x001000000001df37
- (id)initWithDictionary:(id)arg1;	// IMP=0x001000000001dc15
- (id)initWithDate:(id)arg1 identifier:(id)arg2 itemIdentifier:(id)arg3 localizations:(id)arg4 offerName:(id)arg5 status:(long long)arg6;	// IMP=0x001000000001db09
