...
- (void).cxx_destruct;	// IMP=0x0020000000048b9c
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0010000000048a49
- (unsigned long long)hash;	// IMP=0x0010000000048996
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000048847
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000004873e
- (void)copyTo:(id)arg1;	// IMP=0x001000000004867c
- (void)writeTo:(id)arg1;	// IMP=0x00100000000485b2
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000485a5
- (id)dictionaryRepresentation;	// IMP=0x0010000000048437
- (id)description;	// IMP=0x0010000000048388
