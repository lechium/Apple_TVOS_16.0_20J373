...
+ (id)entityName;	// IMP=0x0040000000061350
- (id)internalRepresentation;	// IMP=0x00200000000610a9
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x0010000000060d38
