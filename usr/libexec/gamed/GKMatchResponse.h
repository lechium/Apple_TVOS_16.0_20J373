...
+ (id)secureCodedPropertyKeys;	// IMP=0x00400000000b09bf
- (void).cxx_destruct;	// IMP=0x00200000000b0e11
...
- (_Bool)transitionToState:(long long)arg1;	// IMP=0x00100000000b0bf2
- (_Bool)isNetworkError;	// IMP=0x00100000000b0bb1
- (_Bool)isTimeout;	// IMP=0x00100000000b0b70
- (_Bool)isCancelled;	// IMP=0x00100000000b0b2f
- (_Bool)isFinished;	// IMP=0x00100000000b0aee
- (int)_incrementSequence;	// IMP=0x00100000000b0add
