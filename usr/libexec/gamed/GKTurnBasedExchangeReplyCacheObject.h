...
+ (id)entityName;	// IMP=0x004000000006af6f
- (id)internalRepresentation;	// IMP=0x002000000006b2d0
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x001000000006af7c
