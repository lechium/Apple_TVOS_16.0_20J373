...
+ (id)entityName;	// IMP=0x004000000006a1ba
- (id)internalRepresentation;	// IMP=0x002000000006a5e1
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x001000000006a1c7
