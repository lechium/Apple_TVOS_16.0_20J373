...
@interface GKAuthenticateResponse
{
    ...
    long long _accessPointLocation;	// 88 = 0x58
}

+ (id)secureCodedPropertyKeys;	// IMP=0x0040000000070742
- (void).cxx_destruct;	// IMP=0x0020000000070b15
...
- (id)init;	// IMP=0x001000000007062c
