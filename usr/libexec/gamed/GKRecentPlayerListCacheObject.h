...
+ (Class)entryClass;	// IMP=0x00400000000632ce
+ (id)entityName;	// IMP=0x00100000000632c1
- (id)internalRepresentation;	// IMP=0x0020000000063566
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x00100000000632df
