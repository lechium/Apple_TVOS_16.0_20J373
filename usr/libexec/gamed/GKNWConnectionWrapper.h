...
- (void).cxx_destruct;	// IMP=0x00200000000fa023
...
- (void)cancelConnection;	// IMP=0x00100000000f9f89
- (void)readData;	// IMP=0x00100000000f9f83
- (void)_sendData:(id)arg1;	// IMP=0x00100000000f9f7d
- (_Bool)sendData:(id)arg1;	// IMP=0x00100000000f9f1a
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x00100000000f9d1a
- (void)dealloc;	// IMP=0x00100000000f9c7d
- (id)initWithConnection:(id)arg1 delegate:(id)arg2 delegateQueue:(id)arg3;	// IMP=0x00100000000f9b95
