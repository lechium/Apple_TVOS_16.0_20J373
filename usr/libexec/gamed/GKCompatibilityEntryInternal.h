...
+ (id)secureCodedPropertyKeys;	// IMP=0x0040000000177e50
- (void).cxx_destruct;	// IMP=0x002000000017841b
...
- (unsigned long long)hash;	// IMP=0x00100000001782b7
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000017803d
