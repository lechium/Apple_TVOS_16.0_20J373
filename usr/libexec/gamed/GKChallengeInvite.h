...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000000bb204
- (void).cxx_destruct;	// IMP=0x00200000000bca88
...
- (void)loadGoalTextForGameDescriptor:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x00100000000bbdc9
- (void)loadDetailsWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x00100000000bb2eb
- (id)initWithChallenge:(id)arg1;	// IMP=0x00100000000bb280
- (id)challengeInternalObject;	// IMP=0x00100000000bb278
- (id)description;	// IMP=0x00100000000bb20c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000000bb11f
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000baf15
