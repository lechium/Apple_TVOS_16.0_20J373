...
+ (id)entityName;	// IMP=0x002000000006eadb
+ (id)fetchSortDescriptors;	// IMP=0x001000000006dac8
+ (id)challengeWithServerRepresentation:(id)arg1 context:(id)arg2;	// IMP=0x001000000006d71a
+ (id)challengesWithChallengeIDs:(id)arg1 context:(id)arg2;	// IMP=0x001000000006d504
+ (const void *)uniqueObjectIDLookupKey;	// IMP=0x001000000006d4f7
+ (id)uniqueAttributeName;	// IMP=0x001000000006d4ea
- (void)invalidate;	// IMP=0x002000000006ec9b
- (_Bool)hasDetails;	// IMP=0x001000000006eae8
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x001000000006e363
- (id)orderedSetOfCompatibleBundleIDs;	// IMP=0x001000000006dfc4
- (id)internalRepresentation;	// IMP=0x001000000006db6b
- (Class)classForInternalRepresentation;	// IMP=0x001000000006db63
