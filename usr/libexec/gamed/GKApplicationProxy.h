...
+ (id)metadataForBundleURL:(id)arg1;	// IMP=0x00400000000b1fbd
- (void).cxx_destruct;	// IMP=0x00000000000b25f9
...
- (id)bundleURL;	// IMP=0x00100000000b2271
...
- (id)initWithBundleID:(id)arg1;	// IMP=0x00100000000b1f63
- (id)initWithProxy:(id)arg1;	// IMP=0x00100000000b1efb
