...
+ (id)bagKey;	// IMP=0x002000000024a347
- (void).cxx_destruct;	// IMP=0x002000000024ac98
...
- (id)requestIdentifier;	// IMP=0x001000000024aacf
- (void)handleNetworkRequest:(id)arg1 session:(id)arg2 clientProxy:(id)arg3;	// IMP=0x001000000024aabc
- (id)taskInfo;	// IMP=0x001000000024a8e1
- (id)postBody;	// IMP=0x001000000024a8cf
- (_Bool)isDuplicateRequest:(id)arg1;	// IMP=0x001000000024a83e
- (id)initWithInstanceScore:(id)arg1 bundleID:(id)arg2 challenges:(id)arg3;	// IMP=0x001000000024a58a
- (void)updateWithTaskInfo:(id)arg1;	// IMP=0x001000000024a400
- (id)initWithTask:(id)arg1;	// IMP=0x001000000024a354
