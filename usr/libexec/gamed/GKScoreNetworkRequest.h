...
+ (long long)coalescingDelay;	// IMP=0x0020000000247880
+ (id)bagKey;	// IMP=0x0010000000246d09
- (void).cxx_destruct;	// IMP=0x0020000000247a89
...
- (void)updateWithTaskInfo:(id)arg1;	// IMP=0x001000000024769e
- (void)handleNetworkRequest:(id)arg1 session:(id)arg2 clientProxy:(id)arg3 previousKnownPendingAmount:(long long)arg4;	// IMP=0x001000000024768b
- (void)addInRequestData:(id *)arg1 additional:(id)arg2;	// IMP=0x0010000000247564
- (id)requestIdentifier;	// IMP=0x001000000024755a
- (id)taskInfo;	// IMP=0x0010000000247375
- (void)removeFromStore:(id)arg1;	// IMP=0x0010000000247291
- (id)postBody;	// IMP=0x001000000024719b
@property(readonly) long long numberOfRequests; // @dynamic numberOfRequests;
- (id)initWithScores:(id)arg1 bundleID:(id)arg2 eligibleChallenges:(id)arg3;	// IMP=0x0010000000246dd7
- (id)initWithTask:(id)arg1;	// IMP=0x0010000000246d2b
- (void)handleNetworkRequest:(id)arg1 session:(id)arg2 clientProxy:(id)arg3;	// IMP=0x0010000000246d16
