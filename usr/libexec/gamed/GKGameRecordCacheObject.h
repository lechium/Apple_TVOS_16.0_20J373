...
+ (id)relationshipKeyPathsForPrefetch;	// IMP=0x0040000000058851
+ (id)fetchSortDescriptors;	// IMP=0x0010000000058722
+ (id)entityName;	// IMP=0x0010000000058715
+ (id)recordForGame:(id)arg1 playerProfile:(id)arg2;	// IMP=0x00100000000569fb
+ (id)recordsForGames:(id)arg1 playerProfile:(id)arg2;	// IMP=0x0010000000056634
- (id)internalRepresentation;	// IMP=0x0020000000058570
- (void)updateAchievementsWithServerRepresentation:(id)arg1;	// IMP=0x00100000000582d4
- (void)updateIDsWithServerRepresentation:(id)arg1;	// IMP=0x0010000000057821
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x0010000000056af3
