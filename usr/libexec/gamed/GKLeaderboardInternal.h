...
+ (id)secureCodedPropertyKeys;	// IMP=0x004000000016e02c
- (void).cxx_destruct;	// IMP=0x002000000016e7ff
...
- (unsigned long long)hash;	// IMP=0x001000000016e4cb
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000016e3f7
