...
+ (id)secureCodedPropertyKeys;	// IMP=0x0040000000165ed6
- (void).cxx_destruct;	// IMP=0x0010000000166727
...
- (void)storeItemURLForGamePlatform:(long long)arg1 withContext:(id)arg2 withHandler:(CDUnknownBlockType)arg3;	// IMP=0x001000000016625c
- (id)storeItemURLForURL:(id)arg1 gamePlatform:(long long)arg2 extraQueryParams:(id)arg3;	// IMP=0x0010000000166193
- (_Bool)isValid;	// IMP=0x0010000000166160
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001660b3
- (unsigned long long)hash;	// IMP=0x0010000000166096
- (void)updateWithProperties:(id)arg1;	// IMP=0x001000000017b203
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x001000000017ac6c
- (void)updateWithCacheObject:(id)arg1;	// IMP=0x001000000017a7c5
