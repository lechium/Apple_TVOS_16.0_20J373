...
+ (id)deduperForPool:(id)arg1;	// IMP=0x004000000017e623
+ (id)deduper;	// IMP=0x001000000017e60a
- (void).cxx_destruct;	// IMP=0x002000000017fd98
...
- (void)notifyOnQueue:(id)arg1 block:(CDUnknownBlockType)arg2;	// IMP=0x001000000017fbb7
- (void)openRequestForResources:(id)arg1 processCallback:(CDUnknownBlockType)arg2;	// IMP=0x001000000017ea8b
- (void)getTransactionPool:(CDUnknownBlockType)arg1;	// IMP=0x001000000017e794
- (id)initWithPool:(id)arg1;	// IMP=0x001000000017e684
- (id)init;	// IMP=0x001000000017e670
