...
+ (id)entityName;	// IMP=0x002000000005987b
- (id)internalRepresentation;	// IMP=0x0020000000059579
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x0010000000058f52
