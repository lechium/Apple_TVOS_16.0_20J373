...
+ (_Bool)supportsSecureCoding;	// IMP=0x004000000016d6a3
+ (id)secureCodedPropertyKeys;	// IMP=0x001000000016d46a
- (void).cxx_destruct;	// IMP=0x001000000016ddf7
...
- (id)descriptionSubstitutionMap;	// IMP=0x001000000016dc9e
...
- (unsigned long long)hash;	// IMP=0x001000000016db98
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000016da5c
- (id)serverRepresentation;	// IMP=0x001000000016d882
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000016d783
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000016d6ab
- (void)mergePropertiesFromDescription:(id)arg1;	// IMP=0x001000000016de8e
