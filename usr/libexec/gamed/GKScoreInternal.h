...
+ (id)secureCodedPropertyKeys;	// IMP=0x004000000016f6e7
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000016f097
- (void).cxx_destruct;	// IMP=0x001000000016fe80
...
- (unsigned long long)hash;	// IMP=0x001000000016fd10
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000016fa1e
- (id)serverRepresentation;	// IMP=0x001000000016f88c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000016f5d3
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000016f0bb
