...
+ (id)entityName;	// IMP=0x0040000000056627
- (id)internalRepresentation;	// IMP=0x002000000005661f
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x0010000000056343
