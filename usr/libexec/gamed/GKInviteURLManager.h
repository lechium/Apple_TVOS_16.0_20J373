...
+ (id)sharedManager;	// IMP=0x00400000001404e1
- (void).cxx_destruct;	// IMP=0x0020000000140a04
...
- (_Bool)isRecordEqualToMostRecentInviteShare:(id)arg1;	// IMP=0x0010000000140745
- (id)init;	// IMP=0x0010000000140691
