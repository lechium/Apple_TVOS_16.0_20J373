...
+ (id)secureCodedPropertyKeys;	// IMP=0x0040000000177652
+ (id)nearbyInviteIDForPlayerID:(id)arg1 deviceID:(id)arg2 bundleID:(id)arg3;	// IMP=0x00100000001775c3
+ (id)inviteFromNearbyPlayer:(id)arg1 participantID:(id)arg2 deviceID:(id)arg3 bundleID:(id)arg4 connectionData:(id)arg5;	// IMP=0x001000000017740a
+ (id)inviteWithBulletin:(id)arg1;	// IMP=0x0010000000176e3b
- (void).cxx_destruct;	// IMP=0x0020000000177d64
...
- (id)descriptionSubstitutionMap;	// IMP=0x0010000000177aaf
@property(readonly, nonatomic) _Bool isNearby; // @dynamic isNearby;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001779d4
- (unsigned long long)hash;	// IMP=0x0010000000177990
- (id)init;	// IMP=0x00100000001775f2
