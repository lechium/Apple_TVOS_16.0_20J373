...
+ (id)entityName;	// IMP=0x004000000006f83d
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x002000000006fe47
- (id)internalRepresentation;	// IMP=0x001000000006fa59
- (Class)classForInternalRepresentation;	// IMP=0x001000000006fa48
- (_Bool)hasDetails;	// IMP=0x001000000006f84a
