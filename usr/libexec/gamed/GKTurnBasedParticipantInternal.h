...
+ (id)secureCodedPropertyKeys;	// IMP=0x0040000000174e69
- (void).cxx_destruct;	// IMP=0x0010000000175583
...
- (id)descriptionSubstitutionMap;	// IMP=0x001000000017537d
- (id)serverRepresentation;	// IMP=0x0010000000175110
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000175024
- (unsigned long long)hash;	// IMP=0x001000000017500e
@property(readonly, nonatomic) NSString *playerID;
- (void)updateWithCacheObject:(id)arg1;	// IMP=0x001000000017d9a8
