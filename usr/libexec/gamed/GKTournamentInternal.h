...
+ (id)defaultCustomTournamentForTournamentDefinition:(id)arg1;	// IMP=0x0040000000132552
+ (id)secureCodedPropertyKeys;	// IMP=0x00100000001321a3
- (void).cxx_destruct;	// IMP=0x0020000000132a47
