...
+ (_Bool)supportsSecureCoding;	// IMP=0x00400000000bad70
+ (id)secureCodedPropertyKeys;	// IMP=0x00100000000bac25
- (void).cxx_destruct;	// IMP=0x00200000000baea0
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000bab5b
