...
+ (id)secureCodedPropertyKeys;	// IMP=0x004000000016e959
- (void).cxx_destruct;	// IMP=0x001000000016ed1c
...
- (unsigned long long)hash;	// IMP=0x001000000016ec1f
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000016eb4b
