...
+ (id)entityName;	// IMP=0x004000000005da54
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x002000000005da61
- (id)internalRepresentation;	// IMP=0x001000000005d83b
