...
+ (Class)entryClass;	// IMP=0x0040000000063e25
+ (id)entityName;	// IMP=0x0010000000063e18
- (id)internalRepresentation;	// IMP=0x00200000000640bd
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x0010000000063e36
