...
+ (id)entityName;	// IMP=0x00200000000550b5
+ (id)_gamesForFullGameDescriptors:(id)arg1 context:(id)arg2;	// IMP=0x0010000000052a34
+ (id)gamesForGameDescriptors:(id)arg1 context:(id)arg2;	// IMP=0x0010000000052875
+ (id)gamesForBundleIDs:(id)arg1 context:(id)arg2;	// IMP=0x00100000000526b6
+ (id)gameForBundleID:(id)arg1 context:(id)arg2;	// IMP=0x0010000000052455
+ (id)gameForGameDescriptor:(id)arg1 context:(id)arg2;	// IMP=0x0010000000052356
+ (id)fetchSortDescriptors;	// IMP=0x0010000000052277
+ (const void *)uniqueObjectIDLookupKey;	// IMP=0x001000000005226a
+ (id)uniqueAttributeName;	// IMP=0x001000000005225d
- (id)gameDescriptor;	// IMP=0x0020000000054ca5
- (id)leaderboardSetWithIdentifier:(id)arg1;	// IMP=0x0010000000054c05
- (id)internalRepresentation;	// IMP=0x0010000000054a60
- (_Bool)storePiecesExpired;	// IMP=0x0010000000054a13
- (_Bool)storePiecesValid;	// IMP=0x00100000000549e0
- (void)updateStorePiecesWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x00100000000541fa
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x001000000005387d
- (void)updateWithGameDescriptor:(id)arg1;	// IMP=0x0010000000052fe3
- (_Bool)isValid;	// IMP=0x0010000000052f51
