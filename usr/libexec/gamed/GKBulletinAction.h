...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000000a0bfb
- (void).cxx_destruct;	// IMP=0x00200000000a108e
...
- (id)description;	// IMP=0x00100000000a0e8c
@property(readonly) NSDictionary *actionDictionary;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000a0c03
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000000a08b7
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000a0586
- (id)initWithDictionary:(id)arg1;	// IMP=0x00100000000a04c2
- (id)init;	// IMP=0x00100000000a0488
