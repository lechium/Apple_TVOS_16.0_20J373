...
+ (id)entityName;	// IMP=0x0040000000058d97
+ (id)ratingForGameDescriptor:(id)arg1 context:(id)arg2;	// IMP=0x0010000000058875
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x0020000000058b3a
