...
+ (id)secureCodedPropertyKeys;	// IMP=0x00200000001669ec
+ (id)gameRecordForGame:(id)arg1;	// IMP=0x00100000001667ad
+ (id)_gameProperties;	// IMP=0x001000000017a27c
+ (id)propertiesToFetch;	// IMP=0x0010000000179ed4
- (void).cxx_destruct;	// IMP=0x0020000000166d6e
...
- (void)updateWithGame:(id)arg1;	// IMP=0x001000000016681f
- (void)updateWithProperties:(id)arg1;	// IMP=0x001000000017a379
- (void)updateWithCacheObject:(id)arg1;	// IMP=0x0010000000179ba0
