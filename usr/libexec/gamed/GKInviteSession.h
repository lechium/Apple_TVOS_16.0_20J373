...
- (void).cxx_destruct;	// IMP=0x00200000000f5d76
...
- (_Bool)shouldBeCleared;	// IMP=0x00100000000f5765
- (void)removeAllResponses;	// IMP=0x00100000000f55c1
- (void)addResponse:(id)arg1;	// IMP=0x00100000000f5571
- (void)removeAllInvitees;	// IMP=0x00100000000f5219
- (id)allInvitees;	// IMP=0x00100000000f51f9
- (id)referencesForInvitee:(id)arg1;	// IMP=0x00100000000f5196
- (void)removeInvitee:(id)arg1 reference:(id)arg2;	// IMP=0x00100000000f473b
- (void)addInvitee:(id)arg1 reference:(id)arg2;	// IMP=0x00100000000f45ba
- (void)performSync:(CDUnknownBlockType)arg1;	// IMP=0x00100000000f45a9
- (void)performAsync:(CDUnknownBlockType)arg1;	// IMP=0x00100000000f4401
- (id)initWithSessionToken:(id)arg1;	// IMP=0x00100000000f43a7
- (id)init;	// IMP=0x00100000000f42b0
