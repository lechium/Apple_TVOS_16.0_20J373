...
+ (id)entityName;	// IMP=0x00200000000632b4
- (id)internalRepresentation;	// IMP=0x0020000000062e0d
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x001000000006251a
