...
+ (id)secureCodedPropertyKeys;	// IMP=0x004000000016c3a5
+ (_Bool)supportsSecureCoding;	// IMP=0x001000000016c39d
- (void).cxx_destruct;	// IMP=0x002000000016c6a9
...
- (unsigned long long)hash;	// IMP=0x001000000016c59e
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000016c484
