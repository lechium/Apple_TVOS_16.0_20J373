...
+ (id)internalRepresentation;	// IMP=0x0040000000171ce6
+ (id)secureCodedPropertyKeys;	// IMP=0x001000000017188a
- (void).cxx_destruct;	// IMP=0x0020000000172408
...
- (id)descriptionSubstitutionMap;	// IMP=0x001000000017228c
@property(readonly, nonatomic) NSString *subtitleText;
@property(readonly, nonatomic) NSString *titleText;
@property(readonly, nonatomic) unsigned long long type;
- (id)findLocalGameBundleID;	// IMP=0x0010000000171e6e
- (id)serverRepresentationForReceivingPlayer:(id)arg1;	// IMP=0x0010000000171d00
- (id)serverRepresentation;	// IMP=0x0010000000171cee
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000171c39
- (unsigned long long)hash;	// IMP=0x0010000000171bf5
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000171ac3
