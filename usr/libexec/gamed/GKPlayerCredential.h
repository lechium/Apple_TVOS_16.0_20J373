...
+ (id)secureCodedPropertyKeys;	// IMP=0x0040000000167bba
- (void).cxx_destruct;	// IMP=0x0020000000167ebe
...
- (id)description;	// IMP=0x0010000000167a6e
@property(readonly) NSString *scopeAsString;
- (unsigned long long)hash;	// IMP=0x0010000000167938
- (MISSING_TYPE *)isEqual: /* Error: Ran out of types for this method. */;	// IMP=0x00100000001676cb
