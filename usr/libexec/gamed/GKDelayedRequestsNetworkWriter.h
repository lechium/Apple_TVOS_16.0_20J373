...
+ (id)writerWithTransport:(id)arg1 forBagKey:(id)arg2;	// IMP=0x002000000015f0e8
- (void).cxx_destruct;	// IMP=0x002000000015f593
...
- (void)writeResources:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x001000000015f1f6
- (id)initWithTransport:(id)arg1 forBagKey:(id)arg2;	// IMP=0x001000000015f158
