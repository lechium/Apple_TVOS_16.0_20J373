...
+ (id)entityName;	// IMP=0x0040000000059ed4
- (_Bool)isValid;	// IMP=0x0020000000059fe1
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x0010000000059ee1
