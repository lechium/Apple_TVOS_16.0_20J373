...
+ (id)bagKey;	// IMP=0x002000000024acf7
- (void).cxx_destruct;	// IMP=0x002000000024b448
...
- (_Bool)isDuplicateRequest:(id)arg1;	// IMP=0x001000000024b2d6
@property(readonly, copy) NSString *description;
- (id)requestIdentifier;	// IMP=0x001000000024b167
- (void)handleNetworkRequest:(id)arg1 session:(id)arg2 clientProxy:(id)arg3;	// IMP=0x001000000024b154
- (MISSING_TYPE *)updateWithTaskInfo: /* Error: Ran out of types for this method. */;	// IMP=0x001000000024b071
- (id)taskInfo;	// IMP=0x001000000024af51
- (id)initWithFriendPlayerID:(id)arg1;	// IMP=0x001000000024ae51
- (id)initWithTask:(id)arg1;	// IMP=0x001000000024ada5
- (id)postBody;	// IMP=0x001000000024ad04
