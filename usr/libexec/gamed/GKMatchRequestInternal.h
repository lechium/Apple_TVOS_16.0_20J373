...
@class GKTournamentInternal, MISSING_TYPE, NSArray, NSData, NSDictionary, NSString;
...
@interface GKMatchRequestInternal
{
    ...
    MISSING_TYPE *_maxPlayers;	// 85 = 0x55
...
+ (id)secureCodedPropertyKeys;	// IMP=0x00400000001766ff
- (void).cxx_destruct;	// IMP=0x0020000000176db5
...
- (_Bool)hasGuestPlayers;	// IMP=0x0010000000176a8d
- (unsigned long long)hash;	// IMP=0x0010000000176690
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000175f2c
- (id)init;	// IMP=0x0010000000175eb6
