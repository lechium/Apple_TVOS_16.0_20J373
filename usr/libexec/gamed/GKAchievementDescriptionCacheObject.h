...
+ (id)entityName;	// IMP=0x002000000005598b
- (id)internalRepresentation;	// IMP=0x0020000000055646
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x001000000005525f
