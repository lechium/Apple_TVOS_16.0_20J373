...
@interface GKPlayerInternal
{
    ...
    unsigned long long _lastWelcomeWhatsNewCopyVersionDisplayed;	// 144 = 0x90
    unsigned long long _lastPrivacyNoticeVersionDisplayed;	// 152 = 0x98
    NSString *_lastPersonalizationVersionDisplayed;	// 160 = 0xa0
    NSString *_lastProfilePrivacyVersionDisplayed;	// 168 = 0xa8
    NSString *_lastContactsIntegrationConsentVersionDisplayed;	// 176 = 0xb0
    unsigned short _numberOfFriends;	// 184 = 0xb8
    unsigned short _numberOfGames;	// 186 = 0xba
    unsigned short _numberOfFriendsInCommon;	// 188 = 0xbc
    unsigned short _numberOfGamesInCommon;	// 190 = 0xbe
    unsigned int _numberOfAchievements;	// 192 = 0xc0
    unsigned int _numberOfAchievementPoints;	// 196 = 0xc4
    int _achievementsVisibility;	// 200 = 0xc8
    int _friendsVisibility;	// 204 = 0xcc
    int _gamesPlayedVisibility;	// 208 = 0xd0
    int _globalFriendListAccess;	// 212 = 0xd4
    union {
        struct {
    ...
    _Bool _isArcadeSubscriber;	// 224 = 0xe0
    _Bool _isInContacts;	// 225 = 0xe1
    GKMessageInboxEntryInternal *_inboxEntry;	// 232 = 0xe8
}

+ (Class)classForFamiliarity:(int)arg1;	// IMP=0x002000000016a386
+ (id)displayNameWithOptions:(unsigned char)arg1 alias:(id)arg2 composite:(id)arg3;	// IMP=0x001000000016a231
+ (id)compositeNameForFirstName:(id)arg1 lastName:(id)arg2;	// IMP=0x001000000016a090
+ (id)secureCodedPropertyKeys;	// IMP=0x00100000001694d5
+ (_Bool)supportsSecureCoding;	// IMP=0x00100000001694cd
+ (id)propertiesToFetch;	// IMP=0x001000000017bbaf
+ (int)familiarity;	// IMP=0x001000000017bba7
+ (unsigned char)piecesToLoad;	// IMP=0x001000000017bb73
- (void).cxx_destruct;	// IMP=0x001000000016ad44
...
- (void)setAlias:(id)arg1;	// IMP=0x001000000016a938
- (id)alias;	// IMP=0x001000000016a927
...
- (void)stripPIIs;	// IMP=0x001000000016a7fa
- (id)debugDescription;	// IMP=0x001000000016a608
...
- (void)setAllowNearbyMultiplayer:(_Bool)arg1;	// IMP=0x001000000016a5d0
- (_Bool)allowNearbyMultiplayer;	// IMP=0x001000000016a5c8
...
- (int)globalFriendListSharingStatus;	// IMP=0x001000000016a56d
...
- (int)defaultFamiliarity;	// IMP=0x001000000016a3b9
- (id)displayNameWithOptions:(unsigned char)arg1;	// IMP=0x001000000016a16a
- (id)minimalInternal;	// IMP=0x0010000000169d2d
- (unsigned long long)hash;	// IMP=0x0010000000169ce9
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000169c1e
- (id)serverRepresentation;	// IMP=0x0010000000169b13
- (id)conciseDescription;	// IMP=0x0010000000169a56
- (id)cacheKey;	// IMP=0x0010000000169a44
- (void)updateWithProperties:(id)arg1;	// IMP=0x001000000017bbff
- (void)updateWithCacheObject:(id)arg1;	// IMP=0x001000000017b637
