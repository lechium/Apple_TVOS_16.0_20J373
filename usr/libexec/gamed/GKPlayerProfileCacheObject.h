...
+ (id)entityName;	// IMP=0x002000000005092f
+ (id)playerProfilesWithPlayerIDs:(id)arg1 inManagedObjectContext:(id)arg2;	// IMP=0x001000000004eb85
+ (id)playerProfilesWithPlayers:(id)arg1 inManagedObjectContext:(id)arg2;	// IMP=0x001000000004eae0
+ (id)profileForPlayer:(id)arg1 context:(id)arg2;	// IMP=0x001000000004e9f8
+ (id)playerProfileWithPlayerID:(id)arg1 inManagedObjectContext:(id)arg2;	// IMP=0x001000000004e72c
+ (id)localPlayerInManagedObjectContext:(id)arg1;	// IMP=0x001000000004e48a
+ (const void *)uniqueObjectIDLookupKey;	// IMP=0x001000000004d80c
+ (id)uniqueAttributeName;	// IMP=0x001000000004d7ff
+ (id)filterPlayerIDs:(id)arg1 familiarity:(int)arg2 includeSelf:(_Bool)arg3;	// IMP=0x001000000005206a
+ (unsigned char)piecesToLoadForFamiliarity:(int)arg1;	// IMP=0x0010000000052044
+ (id)playersByFamiliarity:(id)arg1;	// IMP=0x0010000000051a10
+ (void)setFamiliarPlayerIDs:(id)arg1 familiarity:(int)arg2;	// IMP=0x00100000000517dc
+ (void)removeFamiliarPlayerIDs:(id)arg1 familiarity:(int)arg2;	// IMP=0x00100000000513db
+ (void)addFamiliarPlayerIDs:(id)arg1 familiarity:(int)arg2;	// IMP=0x00100000000511d4
+ (int)familiarityForPlayerID:(id)arg1;	// IMP=0x0010000000050fdf
+ (id)selfPlayerID;	// IMP=0x0010000000050f88
+ (void)buildFamiliarilyLookupForProfile:(id)arg1;	// IMP=0x0010000000050cba
+ (id)_familiarityLookup;	// IMP=0x0010000000050ac6
- (void)expireRecentMatchesWithGame:(id)arg1;	// IMP=0x001000000005093c
- (id)internalRepresentation;	// IMP=0x0010000000050778
- (id)internalRepresentationWithPieces:(unsigned char)arg1;	// IMP=0x0010000000050521
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2 pieces:(unsigned char)arg3;	// IMP=0x001000000004f3f4
- (id)updateImagesWithImageURLs:(id)arg1;	// IMP=0x001000000004ef6d
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x001000000004ef58
- (void)deleteCachedImage:(id)arg1;	// IMP=0x001000000004df8f
- (void)deleteCachedAvatars;	// IMP=0x001000000004dcca
- (void)clearImages;	// IMP=0x001000000004d99b
...
- (void)invalidate;	// IMP=0x001000000004d88f
