...
+ (id)entityName;	// IMP=0x004000000006a5e9
- (id)internalRepresentation;	// IMP=0x002000000006af67
- (void)updateWithServerRepresentation:(id)arg1 participants:(id)arg2;	// IMP=0x001000000006a5f6
