...
- (void).cxx_destruct;	// IMP=0x0020000000003f2b
...
- (void)complete;	// IMP=0x0010000000003c06
- (void)applicationNoLongerInForeground:(id)arg1;	// IMP=0x0010000000003955
- (void)applicationEnteredForeground:(id)arg1;	// IMP=0x00100000000036a4
- (id)_schedulerTaskIdentifier;	// IMP=0x00100000000035c2
- (void)dealloc;	// IMP=0x00100000000033df
- (id)initWithConnection:(id)arg1 operationID:(id)arg2 group:(id)arg3 bundleID:(id)arg4 isSpringBoardApp:(_Bool)arg5 requiresPastBuddy:(_Bool)arg6 options:(id)arg7 schedulerClass:(Class)arg8 startHandler:(CDUnknownBlockType)arg9 suspendHandler:(CDUnknownBlockType)arg10;	// IMP=0x0010000000002483
