...
- (void).cxx_destruct;	// IMP=0x0020000000047249
...
- (void)handleRepairSuggestions:(_Bool)arg1 postEscrowCFU:(_Bool)arg2 resetOctagon:(_Bool)arg3 leaveTrust:(_Bool)arg4 moveRequest:(id)arg5;	// IMP=0x0010000000046ec7
- (void)groupStart;	// IMP=0x0010000000046461
- (_Bool)checkIfPasscodeIsSetForDevice;	// IMP=0x0010000000046459
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3 deviceInfo:(id)arg4 skipRateLimitedCheck:(_Bool)arg5;	// IMP=0x0010000000046357
