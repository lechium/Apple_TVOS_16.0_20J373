...
- (void)cancel;	// IMP=0x001000000016ab6c
- (void)groupStart;	// IMP=0x001000000016a5bc
- (id)initWithDependencies:(id)arg1 rollTLKIfPresent:(_Bool)arg2 preexistingPendingKeySets:(id)arg3 intendedState:(id)arg4 errorState:(id)arg5;	// IMP=0x001000000016a28b
- (id)init;	// IMP=0x001000000016a27d
