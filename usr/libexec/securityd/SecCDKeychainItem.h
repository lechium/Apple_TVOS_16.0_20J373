...
- (void).cxx_destruct;	// IMP=0x002000000004259d
...
- (id)secretsFromEncryptedData:(id)arg1 withKeybag:(int)arg2 error:(id *)arg3;	// IMP=0x001000000004201b
- (id)encryptedSecretDataWithAttributeData:(id)arg1 keybag:(int)arg2 error:(id *)arg3;	// IMP=0x00100000000418c9
- (id)primaryKeyStringRepresentationWithError:(id *)arg1;	// IMP=0x001000000004144e
- (id)primaryKeys;	// IMP=0x0010000000041438
...
- (id)description;	// IMP=0x0010000000041264
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000041193
- (id)initWithManagedItem:(id)arg1 keychain:(id)arg2 error:(id *)arg3;	// IMP=0x0010000000040e26
- (id)initItemType:(id)arg1 withPersistentID:(id)arg2 attributes:(id)arg3 lookupAttributes:(id)arg4 secrets:(id)arg5 owner:(id)arg6 keyclass:(int)arg7;	// IMP=0x0010000000040cd5
