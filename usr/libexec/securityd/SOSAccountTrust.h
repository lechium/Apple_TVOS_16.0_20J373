...
+ (id)trust;	// IMP=0x0040000000210e63
- (void).cxx_destruct;	// IMP=0x0020000000210e30
...
- (void)dealloc;	// IMP=0x0010000000210c05
- (id)initWithRetirees:(id)arg1 fpi:(struct __OpaqueSOSFullPeerInfo *)arg2 circle:(struct __OpaqueSOSCircle *)arg3 departureCode:(int)arg4 peerExpansion:(id)arg5;	// IMP=0x0010000000210b26
- (id)init;	// IMP=0x0010000000210a3b
