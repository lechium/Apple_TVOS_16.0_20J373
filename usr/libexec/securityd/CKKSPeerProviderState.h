...
+ (id)createFromProvider:(id)arg1;	// IMP=0x004000000012fdf7
+ (id)noPeersState:(id)arg1;	// IMP=0x001000000012fcdd
- (void).cxx_destruct;	// IMP=0x002000000012fc89
...
- (_Bool)unwrapKey:(id)arg1 fromShares:(id)arg2 error:(id *)arg3;	// IMP=0x001000000012ec94
- (id)description;	// IMP=0x001000000012eb62
- (id)initWithPeerProviderID:(id)arg1 essential:(_Bool)arg2 selfPeers:(id)arg3 selfPeersError:(id)arg4 trustedPeers:(id)arg5 trustedPeersError:(id)arg6;	// IMP=0x001000000012e871
