...
- (void).cxx_destruct;	// IMP=0x0020000000082f1f
...
- (void)proceedAfterFetch;	// IMP=0x00100000000829cd
- (void)groupStart;	// IMP=0x00100000000826d8
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3;	// IMP=0x0010000000082612
