...
- (void).cxx_destruct;	// IMP=0x002000000015b0bc
...
- (void)proceedWithKeys:(id)arg1;	// IMP=0x001000000015ac20
- (void)groupStart;	// IMP=0x001000000015a9e6
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3 deviceInfo:(id)arg4 peerID:(id)arg5 permanentInfo:(id)arg6 permanentInfoSig:(id)arg7 stableInfo:(id)arg8 stableInfoSig:(id)arg9;	// IMP=0x001000000015a84b
