...
+ (id)filterTrustedPeers:(id)arg1 missingTLKSharesFor:(id)arg2 databaseProvider:(id)arg3 error:(id *)arg4;	// IMP=0x00200000001a36a5
+ (id)createMissingKeyShares:(id)arg1 peers:(id)arg2 databaseProvider:(id)arg3 error:(id *)arg4;	// IMP=0x00100000001a2cc5
+ (id)createMissingKeyShares:(id)arg1 trustStates:(id)arg2 databaseProvider:(id)arg3 error:(id *)arg4;	// IMP=0x00100000001a28c5
- (void).cxx_destruct;	// IMP=0x00200000001a1d93
...
- (_Bool)areNewSharesSufficient:(id)arg1 trustStates:(id)arg2 error:(id *)arg3;	// IMP=0x00100000001a17f4
- (void)checkAndHealTLKShares:(id)arg1 currentTrustStates:(id)arg2;	// IMP=0x001000000019fed6
- (void)groupStart;	// IMP=0x001000000019f844
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3;	// IMP=0x001000000019f75b
- (id)init;	// IMP=0x001000000019f74d
