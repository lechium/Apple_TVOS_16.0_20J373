...
- (void).cxx_destruct;	// IMP=0x0020000000044a4e
...
- (_Bool)matchesPeer:(id)arg1;	// IMP=0x0010000000044954
...
- (id)initWithPeerID:(id)arg1 signingIdentity:(id)arg2 encryptionIdentity:(id)arg3;	// IMP=0x00100000000446e1
