...
- (void).cxx_destruct;	// IMP=0x00200000000eebae
...
- (void)proceedWithFilteredTLKShares:(id)arg1;	// IMP=0x00100000000ee89f
- (void)proceedWithRecoveryKeyID:(id)arg1;	// IMP=0x00100000000ee732
- (void)groupStart;	// IMP=0x00100000000ee237
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3 custodianRecoveryKey:(id)arg4 saveVoucher:(_Bool)arg5;	// IMP=0x00100000000ee132
