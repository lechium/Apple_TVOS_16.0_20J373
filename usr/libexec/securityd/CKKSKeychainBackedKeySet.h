...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000001bbb81
- (void).cxx_destruct;	// IMP=0x00200000001bbb4e
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000001bb9aa
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000001bb8a2
- (id)description;	// IMP=0x00100000001bb7cd
- (id)initWithTLK:(id)arg1 classA:(id)arg2 classC:(id)arg3 newUpload:(_Bool)arg4;	// IMP=0x00100000001bb70b
