...
{
    MISSING_TYPE *_currentState;	// 8 = 0x8
...
- (void).cxx_destruct;	// IMP=0x0020000000119c1b
...
- (id)doWatchedStateMachineRPC:(id)arg1 sourceStates:(id)arg2 path:(id)arg3 transitionOp:(id)arg4 reply:(CDUnknownBlockType)arg5;	// IMP=0x0010000000119491
- (id)doWatchedStateMachineRPC:(id)arg1 sourceStates:(id)arg2 path:(id)arg3 reply:(CDUnknownBlockType)arg4;	// IMP=0x0010000000119349
- (void)setWatcherTimeout:(unsigned long long)arg1;	// IMP=0x0010000000119337
- (void)doSimpleStateMachineRPC:(id)arg1 op:(id)arg2 sourceStates:(id)arg3 reply:(CDUnknownBlockType)arg4;	// IMP=0x0010000000118f93
- (void)_onqueueRegisterMultiStateArrivalWatcher:(id)arg1;	// IMP=0x0010000000118e57
- (void)registerMultiStateArrivalWatcher:(id)arg1;	// IMP=0x0010000000118da5
- (void)registerStateTransitionWatcher:(id)arg1;	// IMP=0x0010000000118cf3
- (void)handleExternalRequest:(id)arg1;	// IMP=0x0010000000118c41
- (void)haltOperation;	// IMP=0x0010000000118b95
- (void)startOperation;	// IMP=0x0010000000118b24
- (_Bool)isPaused;	// IMP=0x0010000000118a5a
- (void)testReleaseStateMachinePause:(id)arg1;	// IMP=0x00100000001189a8
- (void)testPauseStateMachineAfterEntering:(id)arg1;	// IMP=0x00100000001188f6
- (void)_onqueueSendAnyPendingFlags;	// IMP=0x0010000000117f5e
- (void)_onqueueRecheckConditions;	// IMP=0x0010000000117625
- (id)possiblePendingFlags;	// IMP=0x00100000001175d5
- (id)dumpPendingFlags;	// IMP=0x00100000001174b0
- (void)disablePendingFlags;	// IMP=0x001000000011743f
- (void)_onqueueHandlePendingFlag:(id)arg1;	// IMP=0x0010000000117218
- (void)_onqueueHandlePendingFlagLater:(id)arg1;	// IMP=0x001000000011713e
- (void)handlePendingFlag:(id)arg1;	// IMP=0x001000000011708c
- (void)_onqueueHandleFlag:(id)arg1;	// IMP=0x0010000000116fe7
- (void)handleFlag:(id)arg1;	// IMP=0x0010000000116f35
- (void)_onqueuePokeStateMachine;	// IMP=0x0010000000116ee0
- (void)pokeStateMachine;	// IMP=0x0010000000116e6f
- (id)createOperationToFinishAttempt:(id)arg1;	// IMP=0x0010000000116d08
- (void)_onqueueStartNextStateMachineOperation:(_Bool)arg1;	// IMP=0x0010000000116810
- (id)_onqueueNextStateMachineTransition;	// IMP=0x00100000001163af
- (id)waitForState:(id)arg1 wait:(unsigned long long)arg2;	// IMP=0x00100000001162f8
@property(retain) NSString<OctagonStateString> *currentState;
@property(readonly) id <OctagonFlagContainer> flags;
- (id)description;	// IMP=0x0010000000115fbf
- (id)pendingFlagsString;	// IMP=0x0010000000115f3e
@property(readonly) NSDictionary *stateConditions;
- (id)initWithName:(id)arg1 states:(id)arg2 flags:(id)arg3 initialState:(id)arg4 queue:(id)arg5 stateEngine:(id)arg6 lockStateTracker:(id)arg7 reachabilityTracker:(id)arg8;	// IMP=0x00100000001158cc
