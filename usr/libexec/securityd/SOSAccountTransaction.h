...
- (void).cxx_destruct;	// IMP=0x00200000001f1e19
...
- (void)requestSyncWithPeers:(id)arg1;	// IMP=0x00100000001f1c26
- (void)requestSyncWith:(id)arg1;	// IMP=0x00100000001f1b53
- (void)finish;	// IMP=0x00100000001f0064
- (void)restart;	// IMP=0x00100000001f0036
- (void)start;	// IMP=0x00100000001efbdd
- (id)initWithAccount:(id)arg1 quiet:(_Bool)arg2;	// IMP=0x00100000001efb55
@property(readonly) NSString *description;
- (void)updateSOSCircleCachedStatus;	// IMP=0x00100000001ef8e0
- (unsigned long long)currentTrustBitmask;	// IMP=0x00100000001ef7d1
