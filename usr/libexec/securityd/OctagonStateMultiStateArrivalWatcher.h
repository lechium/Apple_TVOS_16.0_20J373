...
- (void).cxx_destruct;	// IMP=0x00200000000cae3a
...
- (void)completeWithErrorIfPending:(id)arg1;	// IMP=0x00100000000caca7
- (void)onqueueStartFinishOperation:(id)arg1;	// IMP=0x00100000000caba2
- (id)timeout:(unsigned long long)arg1;	// IMP=0x00100000000caabf
- (void)_onqueuePerformTimeoutWithUnderlyingError;	// IMP=0x00100000000ca980
- (void)onqueueEnterState:(id)arg1;	// IMP=0x00100000000ca89f
- (void)onqueueHandleTransition:(id)arg1;	// IMP=0x00100000000ca807
- (id)description;	// IMP=0x00100000000ca74a
- (id)initNamed:(id)arg1 serialQueue:(id)arg2 states:(id)arg3 failStates:(id)arg4;	// IMP=0x00100000000ca591
- (id)initNamed:(id)arg1 serialQueue:(id)arg2 states:(id)arg3;	// IMP=0x00100000000ca578
