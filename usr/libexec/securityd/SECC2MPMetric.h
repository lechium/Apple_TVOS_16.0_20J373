...
- (void).cxx_destruct;	// IMP=0x00200000000aaa5e
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000000aa7af
- (unsigned long long)hash;	// IMP=0x00100000000aa674
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000aa461
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000aa2c7
- (void)copyTo:(id)arg1;	// IMP=0x00100000000aa186
- (void)writeTo:(id)arg1;	// IMP=0x00100000000aa044
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000000a9aa5
- (id)dictionaryRepresentation;	// IMP=0x00100000000a974a
- (id)description;	// IMP=0x00100000000a969b
...
- (int)StringAsMetricType:(id)arg1;	// IMP=0x00100000000a94bd
- (id)metricTypeAsString:(int)arg1;	// IMP=0x00100000000a9451
