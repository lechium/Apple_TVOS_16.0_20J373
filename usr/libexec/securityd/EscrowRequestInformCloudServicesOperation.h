...
+ (id)triggerCloudServicesPasscodeRequest:(id)arg1 serializedReason:(id)arg2 error:(id *)arg3;	// IMP=0x00200000001d5d4c
- (void).cxx_destruct;	// IMP=0x00200000001d5d0a
...
- (void)main;	// IMP=0x00100000001d53cf
- (id)initWithIntendedState:(id)arg1 errorState:(id)arg2 lockStateTracker:(id)arg3;	// IMP=0x00100000001d5309
