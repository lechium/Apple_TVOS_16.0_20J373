...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000001bde27
- (void).cxx_destruct;	// IMP=0x00200000001bddff
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000001bdcd3
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000001bdb35
- (id)description;	// IMP=0x00100000001bdab7
- (id)initWithSuccessfulKeyUUIDs:(id)arg1 totalTLKSharesRecovered:(long long)arg2 tlkRecoveryErrors:(id)arg3;	// IMP=0x00100000001bda12
