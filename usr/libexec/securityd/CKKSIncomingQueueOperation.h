...
+ (id)decryptCKKSItemToAttributes:(id)arg1 keyCache:(id)arg2 ckksOperationalDependencies:(id)arg3 error:(id *)arg4;	// IMP=0x0020000000078b45
- (void).cxx_destruct;	// IMP=0x0020000000076c4e
...
- (void)_onqueueHandleIQEDelete:(id)arg1 class:(const struct SecDbClass *)arg2 viewState:(id)arg3;	// IMP=0x00100000000760fb
- (_Bool)_onqueueHandleIQEChange:(id)arg1 item:(struct SecDbItem *)arg2 viewState:(id)arg3 sortedForThisView:(_Bool)arg4 keyCache:(id)arg5;	// IMP=0x0010000000074880
- (void)_onqueueHandleIQEChange:(id)arg1 attributes:(id)arg2 class:(const struct SecDbClass *)arg3 viewState:(id)arg4 sortedForThisView:(_Bool)arg5 keyCache:(id)arg6;	// IMP=0x001000000007468e
- (void)_onqueueGenerateNewUUIDPersistentRefOnSecItem:(struct SecDbItem *)arg1 viewState:(id)arg2;	// IMP=0x00100000000744f9
- (_Bool)fixMismatchedViewItems:(id)arg1;	// IMP=0x001000000007421b
- (_Bool)loadAndProcessEntries:(id)arg1 withActionFilter:(id)arg2;	// IMP=0x0010000000073f21
- (void)main;	// IMP=0x0010000000072f8f
- (_Bool)_onqueueUpdateIQE:(id)arg1 withState:(id)arg2 error:(id *)arg3;	// IMP=0x0010000000072de6
- (void)_onqueueHandleMismatchedViewItem:(id)arg1 secDbClass:(const struct SecDbClass *)arg2 attributes:(id)arg3 intendedView:(id)arg4 viewState:(id)arg5 keyCache:(id)arg6;	// IMP=0x0010000000072657
- (_Bool)intransaction:(id)arg1 processQueueEntries:(id)arg2;	// IMP=0x0010000000070e88
- (_Bool)processNewCurrentItemPointers:(id)arg1 viewState:(id)arg2;	// IMP=0x0010000000070ad9
- (id)initWithDependencies:(id)arg1 intending:(id)arg2 pendingClassAItemsRemainingState:(id)arg3 errorState:(id)arg4 handleMismatchedViewItems:(_Bool)arg5;	// IMP=0x0010000000070974
- (id)init;	// IMP=0x0010000000070966
