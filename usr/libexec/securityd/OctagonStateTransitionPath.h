...
+ (id)pathFromDictionary:(id)arg1;	// IMP=0x00400000000c9226
- (void).cxx_destruct;	// IMP=0x00200000000c91fe
...
- (id)asPathStep;	// IMP=0x00100000000c90c5
- (id)initWithState:(id)arg1 pathStep:(id)arg2;	// IMP=0x00100000000c902c
