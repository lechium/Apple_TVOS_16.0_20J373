...
- (void).cxx_destruct;	// IMP=0x00200000001c5e46
...
- (void)halt;	// IMP=0x00100000001c5a40
- (void)cancel;	// IMP=0x00100000001c5a03
- (void)holdFetchesUntil:(id)arg1;	// IMP=0x00100000001c59f1
- (id)createSuccesfulFetchDependency;	// IMP=0x00100000001c5986
- (void)_onqueueCreateNewFetch;	// IMP=0x00100000001c51f6
- (void)maybeCreateNewFetch;	// IMP=0x00100000001c5185
- (void)maybeCreateNewFetchOnQueue;	// IMP=0x00100000001c4f83
- (id)inflightFetch;	// IMP=0x00100000001c4e8c
- (id)requestSuccessfulFetchForManyReasons:(id)arg1;	// IMP=0x00100000001c4d4f
- (id)requestFetchDueToAPNS:(id)arg1;	// IMP=0x00100000001c49a3
- (void)notifyZoneChange:(id)arg1;	// IMP=0x00100000001c48c8
- (id)requestSuccessfulFetch:(id)arg1;	// IMP=0x00100000001c4862
- (id)strongClientMap;	// IMP=0x00100000001c45da
- (void)registerClient:(id)arg1 zoneID:(id)arg2;	// IMP=0x00100000001c450e
@property(readonly, copy) NSString *description;
- (id)initWithContainer:(id)arg1 fetchClass:(Class)arg2 reachabilityTracker:(id)arg3;	// IMP=0x00100000001c408a
