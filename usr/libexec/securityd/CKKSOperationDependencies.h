...
- (void).cxx_destruct;	// IMP=0x00200000000a0f0f
...
- (id)keychainMusrForCurrentAccount;	// IMP=0x00100000000a0b0b
- (id)viewNameForItem:(struct SecDbItem *)arg1;	// IMP=0x00100000000a0903
- (_Bool)intransactionCKWriteFailed:(id)arg1 attemptedRecordsChanged:(id)arg2;	// IMP=0x001000000009f8c4
- (_Bool)intransactionCKRecordDeleted:(id)arg1 recordType:(id)arg2 resync:(_Bool)arg3;	// IMP=0x001000000009f394
- (_Bool)intransactionCKRecordChanged:(id)arg1 resync:(_Bool)arg2;	// IMP=0x001000000009ea22
- (void)provideKeySets:(id)arg1;	// IMP=0x001000000009e700
- (_Bool)considerSelfTrusted:(id)arg1 error:(id *)arg2;	// IMP=0x001000000009e44c
- (id)currentTrustStates;	// IMP=0x001000000009e20e
- (void)applyNewSyncingPolicy:(id)arg1 viewStates:(id)arg2;	// IMP=0x001000000009df58
- (id)readyAndSyncingViews;	// IMP=0x001000000009dc3d
- (id)viewStateForName:(id)arg1;	// IMP=0x001000000009da2d
- (id)viewStatesByNames:(id)arg1;	// IMP=0x001000000009d7e2
- (id)viewsInState:(id)arg1;	// IMP=0x001000000009d5d5
- (void)limitOperationToPriorityViews;	// IMP=0x001000000009d508
- (void)operateOnAllViews;	// IMP=0x001000000009d42b
- (void)operateOnSelectViews:(id)arg1;	// IMP=0x001000000009d343
- (void)setStateForAllViews:(id)arg1;	// IMP=0x001000000009d1f2
- (void)setStateForActiveExternallyManagedViews:(id)arg1;	// IMP=0x001000000009d06c
- (void)setStateForActiveCKKSManagedViews:(id)arg1;	// IMP=0x001000000009cee6
- (void)setStateForActiveZones:(id)arg1;	// IMP=0x001000000009cd95
