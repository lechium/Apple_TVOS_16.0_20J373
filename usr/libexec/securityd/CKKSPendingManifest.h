...
+ (_Bool)intransactionRecordChanged:(id)arg1 resync:(_Bool)arg2 error:(id *)arg3;	// IMP=0x004000000012babe
+ (id)sqlTable;	// IMP=0x001000000012bab1
- (void).cxx_destruct;	// IMP=0x002000000012ba9e
...
- (id)commitToDatabaseWithError:(id *)arg1;	// IMP=0x001000000012b616
- (_Bool)isReadyToCommit;	// IMP=0x001000000012b3f9
