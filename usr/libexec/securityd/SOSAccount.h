...
+ (id)urlForSOSAccountSettings;	// IMP=0x00200000001e054e
+ (unsigned int)ghostBustGetRampSettings;	// IMP=0x00100000001e0546
+ (id)accountFromData:(id)arg1 factory:(struct SOSDataSourceFactory *)arg2 error:(id *)arg3;	// IMP=0x00100000001eefd8
+ (id)accountFromDER:(const char **)arg1 end:(const char *)arg2 factory:(struct SOSDataSourceFactory *)arg3 error:(id *)arg4;	// IMP=0x00100000001ee000
+ (void)performOnQuietAccountQueue:(CDUnknownBlockType)arg1;	// IMP=0x00100000001f27bc
- (void).cxx_destruct;	// IMP=0x00200000001dcddb
...
- (id)_onqueueNextStateMachineTransition:(id)arg1 flags:(id)arg2 pendingFlags:(id)arg3;	// IMP=0x00100000001dc791
- (id)performRingUpdate;	// IMP=0x00100000001dc6b5
- (id)performBackup;	// IMP=0x00100000001dc5d9
- (void)triggerRingUpdate;	// IMP=0x00100000001dc4ff
- (void)triggerBackupForPeers:(id)arg1;	// IMP=0x00100000001dc3ab
- (void)addRingUpdateFlag;	// IMP=0x00100000001dc329
- (void)addBackupFlag;	// IMP=0x00100000001dc2a7
- (void)setupStateMachine;	// IMP=0x00100000001dbd44
- (void)_onQueueRecordRetiredPeersInCircle;	// IMP=0x00100000001dbbd3
- (void)keyStatusFor:(int)arg1 complete:(CDUnknownBlockType)arg2;	// IMP=0x00100000001dbb54
- (int)getPublicKeyStatusForKey:(int)arg1 error:(id *)arg2;	// IMP=0x00100000001db661
- (void)setPublicKeyStatus:(int)arg1 forKey:(int)arg2;	// IMP=0x00100000001db5e9
- (_Bool)_onQueueEnsureInBackupRings:(struct __CFString *)arg1;	// IMP=0x00100000001db31c
- (_Bool)isInCircle:(struct __CFError **)arg1;	// IMP=0x00100000001db2dd
- (int)getCircleStatus:(struct __CFError **)arg1;	// IMP=0x00100000001db23e
- (void)flattenToSaveBlock;	// IMP=0x00100000001db182
- (_Bool)sosEvaluateIfNeeded;	// IMP=0x00100000001dadb2
- (id)sosIsEnabledString;	// IMP=0x00100000001dad87
- (_Bool)sosIsEnabled;	// IMP=0x00100000001dad2c
- (void)sosIsEnabledCB:(CDUnknownBlockType)arg1;	// IMP=0x00100000001dace0
- (void)sosEnable;	// IMP=0x00100000001dac29
- (void)sosDisable;	// IMP=0x00100000001dab36
- (void)sosEnableValidityCheck;	// IMP=0x00100000001daa22
- (void)removeV0Peers:(CDUnknownBlockType)arg1;	// IMP=0x00100000001da994
- (void)setWatchdogParmeters:(id)arg1 complete:(CDUnknownBlockType)arg2;	// IMP=0x00100000001da821
- (void)getWatchdogParameters:(CDUnknownBlockType)arg1;	// IMP=0x00100000001da6a5
- (void)rpcTriggerRingUpdate:(CDUnknownBlockType)arg1;	// IMP=0x00100000001da65e
- (void)rpcTriggerBackup:(id)arg1 complete:(CDUnknownBlockType)arg2;	// IMP=0x00100000001da58c
- (void)rpcTriggerSync:(id)arg1 complete:(CDUnknownBlockType)arg2;	// IMP=0x00100000001da3a6
- (void)importInitialSyncCredentials:(id)arg1 complete:(CDUnknownBlockType)arg2;	// IMP=0x00100000001da302
- (void)initialSyncCredentials:(unsigned int)arg1 complete:(CDUnknownBlockType)arg2;	// IMP=0x00100000001d9f1c
- (void)joinCircleWithBlob:(id)arg1 version:(int)arg2 complete:(CDUnknownBlockType)arg3;	// IMP=0x00100000001d9dae
- (void)circleJoiningBlob:(id)arg1 complete:(CDUnknownBlockType)arg2;	// IMP=0x00100000001d9bda
- (void)iCloudIdentityStatus_internal:(CDUnknownBlockType)arg1;	// IMP=0x00100000001d9bc8
- (void)accountStatus:(CDUnknownBlockType)arg1;	// IMP=0x00100000001d9bb6
- (void)iCloudIdentityStatus:(CDUnknownBlockType)arg1;	// IMP=0x00100000001d9ba4
- (_Bool)ghostBustCheckDate;	// IMP=0x00100000001d9b9c
- (void)ghostBustInfo:(CDUnknownBlockType)arg1;	// IMP=0x00100000001d9b8a
- (void)ghostBustTriggerTimed:(unsigned int)arg1 complete:(CDUnknownBlockType)arg2;	// IMP=0x00100000001d9b78
- (void)ghostBustPeriodic:(unsigned int)arg1 complete:(CDUnknownBlockType)arg2;	// IMP=0x00100000001d9b66
- (void)ghostBust:(unsigned int)arg1 complete:(CDUnknownBlockType)arg2;	// IMP=0x00100000001d9b54
- (void)ghostBustSchedule;	// IMP=0x00100000001d9b4e
- (void)ghostBustFollowup;	// IMP=0x00100000001d9b48
- (id)ghostBustGetDate;	// IMP=0x00100000001d9b40
- (void)circleHash:(CDUnknownBlockType)arg1;	// IMP=0x00100000001d9a5d
- (void)myPeerInfo:(CDUnknownBlockType)arg1;	// IMP=0x00100000001d990b
- (void)stashAccountCredential:(id)arg1 complete:(CDUnknownBlockType)arg2;	// IMP=0x00100000001d97b1
- (void)validatedStashedAccountCredential:(CDUnknownBlockType)arg1;	// IMP=0x00100000001d96bc
- (_Bool)syncWaitAndFlush:(struct __CFError **)arg1;	// IMP=0x00100000001d940c
- (void)assertStashedAccountCredential:(CDUnknownBlockType)arg1;	// IMP=0x00100000001d935b
- (void)stashedCredentialPublicKey:(CDUnknownBlockType)arg1;	// IMP=0x00100000001d92aa
- (void)rateLimitingPerformanceCounters:(CDUnknownBlockType)arg1;	// IMP=0x00100000001d9237
- (void)setBypass:(_Bool)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x00100000001d9180
- (void)kvsPerformanceCounters:(CDUnknownBlockType)arg1;	// IMP=0x00100000001d90dc
- (void)userPublicKey:(CDUnknownBlockType)arg1;	// IMP=0x00100000001d902b
- (_Bool)getAccountInBypassMode;	// IMP=0x00100000001d9019
- (void)setAccountInBypassMode:(_Bool)arg1;	// IMP=0x00100000001d9007
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001d8d57
- (void)startStateMachine;	// IMP=0x00100000001d8d1a
- (id)initWithGestalt:(struct __CFDictionary *)arg1 factory:(struct SOSDataSourceFactory *)arg2;	// IMP=0x00100000001d8a43
- (void)ensureOctagonPeerKeys;	// IMP=0x00100000001d8992
- (_Bool)ensureFactoryCircles;	// IMP=0x00100000001d8637
...
- (void)dealloc;	// IMP=0x00100000001d82f6
- (id)encodedData:(id *)arg1;	// IMP=0x00100000001edecc
- (void)performTransaction:(_Bool)arg1 action:(CDUnknownBlockType)arg2;	// IMP=0x00100000001f26a3
- (void)performTransaction:(CDUnknownBlockType)arg1;	// IMP=0x00100000001f268c
- (void)performTransaction_Locked:(_Bool)arg1 action:(CDUnknownBlockType)arg2;	// IMP=0x00100000001f25f7
- (void)performTransaction_Locked:(CDUnknownBlockType)arg1;	// IMP=0x00100000001f25e0
