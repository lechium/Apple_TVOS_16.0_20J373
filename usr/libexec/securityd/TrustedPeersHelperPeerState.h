...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000001bc406
- (void).cxx_destruct;	// IMP=0x00200000001bc3d3
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000001bc1a7
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000001bc033
- (id)description;	// IMP=0x00100000001bbed1
- (id)initWithPeerID:(id)arg1 isPreapproved:(_Bool)arg2 status:(unsigned long long)arg3 memberChanges:(_Bool)arg4 unknownMachineIDs:(_Bool)arg5 osVersion:(id)arg6 walrus:(id)arg7;	// IMP=0x00100000001bbdf2
