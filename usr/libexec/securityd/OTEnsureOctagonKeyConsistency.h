...
- (void).cxx_destruct;	// IMP=0x002000000008b6a6
...
- (void)groupStart;	// IMP=0x001000000008a970
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3;	// IMP=0x001000000008a8aa
