...
- (void)proceedWithKeys:(id)arg1 salt:(id)arg2;	// IMP=0x00100000000b0e75
- (void)groupStart;	// IMP=0x00100000000b0ab4
- (id)initWithDependencies:(id)arg1 recoveryKey:(id)arg2;	// IMP=0x00100000000b0a12
