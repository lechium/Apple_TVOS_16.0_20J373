...
- (void).cxx_destruct;	// IMP=0x0020000000228203
...
- (int)stateForAccessGroup:(id)arg1;	// IMP=0x0010000000228060
- (id)initWithPeer:(struct __OpaqueSOSPeer *)arg1;	// IMP=0x0010000000227f5b
- (id)setUpConfigForPeer;	// IMP=0x0010000000227ee0
