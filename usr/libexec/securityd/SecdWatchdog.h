...
+ (_Bool)triggerOSFaults;	// IMP=0x0040000000003234
+ (_Bool)watchdogrusage:(struct rusage_info_v6 *)arg1;	// IMP=0x001000000000320b
+ (id)watchdog;	// IMP=0x00100000000031a8
- (void).cxx_destruct;	// IMP=0x0020000000002e9a
@property(readonly) _Bool diskUsageHigh; // @synthesize diskUsageHigh=_diskUsageHigh;
- (_Bool)setWatchdogParameters:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000002c10
- (id)watchdogParameters;	// IMP=0x0010000000002a7a
- (void)activateTimer;	// IMP=0x00100000000028c0
- (void)runWatchdog;	// IMP=0x00100000000025d6
- (unsigned long long)secondsFromMachTime:(unsigned long long)arg1;	// IMP=0x0010000000002584
- (id)init;	// IMP=0x001000000000250e
