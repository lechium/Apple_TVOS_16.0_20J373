...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000001bd098
- (void).cxx_destruct;	// IMP=0x00200000001bd04f
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000001bce54
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000001bcc4d
- (id)description;	// IMP=0x00100000001bcaf6
- (id)initWithPeerID:(id)arg1 signingSPKI:(id)arg2 encryptionSPKI:(id)arg3 secureElementIdentity:(id)arg4 viewList:(id)arg5;	// IMP=0x00100000001bc9f4
