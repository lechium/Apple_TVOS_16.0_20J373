...
- (void).cxx_destruct;	// IMP=0x002000000010bf29
...
- (id)initWithData:(id)arg1;	// IMP=0x001000000010bc3c
- (id)initWithCiphertext:(id)arg1 wrappedKey:(id)arg2 tamperCheck:(id)arg3 error:(id *)arg4;	// IMP=0x001000000010ba4f
