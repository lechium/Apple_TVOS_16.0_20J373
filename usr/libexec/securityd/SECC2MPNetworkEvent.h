...
- (void).cxx_destruct;	// IMP=0x00200000001ad6f4
...
- (void)setNetworkTaskDescription:(id)arg1;	// IMP=0x00100000001ad3af
- (id)networkTaskDescription;	// IMP=0x00100000001ad39e
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000001ace44
- (unsigned long long)hash;	// IMP=0x00100000001ac800
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000001abf68
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000001ab993
- (void)copyTo:(id)arg1;	// IMP=0x00100000001ab486
- (void)writeTo:(id)arg1;	// IMP=0x00100000001aaf4b
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000001aaf3e
- (id)dictionaryRepresentation;	// IMP=0x00100000001aa2c8
- (id)description;	// IMP=0x00100000001aa219
