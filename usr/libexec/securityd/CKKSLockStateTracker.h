...
+ (id)globalTracker;	// IMP=0x0040000000170dda
- (void).cxx_destruct;	// IMP=0x0020000000170a80
...
- (void)addLockStateObserver:(id)arg1;	// IMP=0x00100000001708d7
- (_Bool)isLockedError:(id)arg1;	// IMP=0x0010000000170848
- (_Bool)checkErrorChainForLockState:(id)arg1;	// IMP=0x001000000017076a
- (_Bool)lockedError:(id)arg1;	// IMP=0x001000000017069f
- (void)recheck;	// IMP=0x001000000017062e
- (void)_onqueueRecheck;	// IMP=0x00100000001702f4
- (void)resetUnlockDependency;	// IMP=0x0010000000170207
- (id)description;	// IMP=0x001000000017015f
@property(readonly) NSDate *lastUnlockTime;
@property(readonly) _Bool isLocked;
- (void)dealloc;	// IMP=0x001000000016ff9c
- (id)initWithProvider:(id)arg1;	// IMP=0x001000000016fd87
