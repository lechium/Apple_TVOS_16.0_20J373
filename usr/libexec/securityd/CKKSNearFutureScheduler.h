...
- (void).cxx_destruct;	// IMP=0x00200000000ae2be
...
- (void)cancel;	// IMP=0x00100000000ae084
- (void)_onqueueTrigger:(unsigned long long)arg1 maximumDelay:(unsigned long long)arg2;	// IMP=0x00100000000adaca
- (void)trigger;	// IMP=0x00100000000ada05
- (void)_onqueueTimerTick;	// IMP=0x00100000000ad6c0
- (void)triggerAt:(unsigned long long)arg1;	// IMP=0x00100000000ad5f0
- (void)waitUntil:(unsigned long long)arg1;	// IMP=0x00100000000ad574
@property(readonly) NSDate *nextFireTime;
- (id)description;	// IMP=0x00100000000ad395
- (id)makeOperationDependency;	// IMP=0x00100000000ad2c8
- (void)changeDelays:(unsigned long long)arg1 continuingDelay:(unsigned long long)arg2;	// IMP=0x00100000000ad241
- (id)initWithName:(id)arg1 initialDelay:(unsigned long long)arg2 exponentialBackoff:(double)arg3 maximumDelay:(unsigned long long)arg4 keepProcessAlive:(_Bool)arg5 dependencyDescriptionCode:(long long)arg6 block:(CDUnknownBlockType)arg7;	// IMP=0x00100000000ad065
- (id)initWithName:(id)arg1 initialDelay:(unsigned long long)arg2 continuingDelay:(unsigned long long)arg3 keepProcessAlive:(_Bool)arg4 dependencyDescriptionCode:(long long)arg5 block:(CDUnknownBlockType)arg6;	// IMP=0x00100000000ad00a
- (id)initWithName:(id)arg1 delay:(unsigned long long)arg2 keepProcessAlive:(_Bool)arg3 dependencyDescriptionCode:(long long)arg4 block:(CDUnknownBlockType)arg5;	// IMP=0x00100000000acfe6
