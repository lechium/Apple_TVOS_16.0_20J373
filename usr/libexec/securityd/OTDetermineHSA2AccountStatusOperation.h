...
- (void).cxx_destruct;	// IMP=0x002000000016da77
...
- (void)groupStart;	// IMP=0x001000000016d119
- (id)initWithDependencies:(id)arg1 stateIfHSA2:(id)arg2 stateIfNotHSA2:(id)arg3 stateIfNoAccount:(id)arg4 errorState:(id)arg5;	// IMP=0x001000000016cfff
