...
- (void).cxx_destruct;	// IMP=0x0020000000081933
...
- (void)proceedWithFilteredTLKShares:(id)arg1;	// IMP=0x00100000000815c9
- (void)proceedWithPeerID:(id)arg1 refetchWasNeeded:(_Bool)arg2;	// IMP=0x001000000008145c
- (void)groupStart;	// IMP=0x0010000000080fa6
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3 bottleID:(id)arg4 entropy:(id)arg5 bottleSalt:(id)arg6 saveVoucher:(_Bool)arg7;	// IMP=0x0010000000080e58
