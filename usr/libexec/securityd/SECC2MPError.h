...
- (void).cxx_destruct;	// IMP=0x002000000015262a
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00100000001524ec
- (unsigned long long)hash;	// IMP=0x0010000000152458
- (_Bool)isEqual:(id)arg1;	// IMP=0x001000000015232f
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000152247
- (void)copyTo:(id)arg1;	// IMP=0x00100000001521a3
- (void)writeTo:(id)arg1;	// IMP=0x0010000000152104
- (_Bool)readFrom:(id)arg1;	// IMP=0x00100000001520f7
- (id)dictionaryRepresentation;	// IMP=0x0010000000151fc5
- (id)description;	// IMP=0x0010000000151f16
