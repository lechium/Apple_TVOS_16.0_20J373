...
- (void).cxx_destruct;	// IMP=0x002000000016f93a
...
- (id)sfaStatus;	// IMP=0x000000000016f899
- (id)sysdiagnoseStatus;	// IMP=0x001000000016f891
- (_Bool)clearFollowUp:(unsigned char)arg1 activeAccount:(id)arg2 error:(id *)arg3;	// IMP=0x001000000016f591
- (_Bool)postFollowUp:(unsigned char)arg1 activeAccount:(id)arg2 error:(id *)arg3;	// IMP=0x001000000016f26f
- (id)createCDPFollowupContext:(unsigned char)arg1;	// IMP=0x001000000016f22d
- (id)initWithFollowupController:(id)arg1;	// IMP=0x001000000016f196
- (void)clearAllPostedFlags;	// IMP=0x001000000016f9c4
- (_Bool)hasPosted:(unsigned char)arg1;	// IMP=0x001000000016f962
