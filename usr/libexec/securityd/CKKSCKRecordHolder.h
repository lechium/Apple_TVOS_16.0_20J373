...
- (void).cxx_destruct;	// IMP=0x00200000000ba19b
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000ba069
- (_Bool)matchesCKRecord:(id)arg1;	// IMP=0x00100000000b9f81
- (void)setFromCKRecord:(id)arg1;	// IMP=0x00100000000b9e99
- (id)updateCKRecord:(id)arg1 zoneID:(id)arg2;	// IMP=0x00100000000b9da4
- (id)CKRecordName;	// IMP=0x00100000000b9ccb
- (id)CKRecordWithZoneID:(id)arg1;	// IMP=0x00100000000b9b3d
...
- (id)initWithCKRecordType:(id)arg1 encodedCKRecord:(id)arg2 contextID:(id)arg3 zoneID:(id)arg4;	// IMP=0x00100000000b9559
- (id)initWithCKRecord:(id)arg1 contextID:(id)arg2;	// IMP=0x00100000000b9458
