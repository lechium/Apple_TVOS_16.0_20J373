...
- (void).cxx_destruct;	// IMP=0x00200000001a610b
...
- (id)timeout:(unsigned long long)arg1;	// IMP=0x00100000001a5fb5
- (id)_onqueueStart;	// IMP=0x00100000001a5f30
- (id)description;	// IMP=0x00100000001a5e66
- (id)init:(id)arg1 sourceStates:(id)arg2 serialQueue:(id)arg3 timeout:(unsigned long long)arg4 transitionOp:(id)arg5;	// IMP=0x00100000001a5d6a
