...
+ (id)loadForZone:(id)arg1 contextID:(id)arg2;	// IMP=0x00400000000a8b13
- (void).cxx_destruct;	// IMP=0x00200000000a8a93
...
- (id)asKeychainBackedSet:(id *)arg1;	// IMP=0x00100000000a8711
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000a8418
- (id)description;	// IMP=0x00100000000a8180
- (id)initWithZoneID:(id)arg1 contextID:(id)arg2;	// IMP=0x00100000000a80e7
