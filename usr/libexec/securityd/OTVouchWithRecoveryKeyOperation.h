...
- (void)proceedWithFilteredTLKShares:(id)arg1;	// IMP=0x00100000000cf242
- (void)proceedWithRecoveryKeyID:(id)arg1;	// IMP=0x00100000000cf0d5
- (void)groupStart;	// IMP=0x00100000000ceca3
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3 recoveryKey:(id)arg4 saveVoucher:(_Bool)arg5;	// IMP=0x00100000000ceb9e
