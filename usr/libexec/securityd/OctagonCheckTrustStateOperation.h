...
- (void).cxx_destruct;	// IMP=0x002000000016ef42
...
- (void)afterTPHTrustState:(id)arg1 trustedPeers:(id)arg2;	// IMP=0x001000000016ddf9
- (void)groupStart;	// IMP=0x001000000016dc56
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3;	// IMP=0x001000000016db90
