...
@interface OTJoinWithVoucherOperation
{
    ...
    MISSING_TYPE *_voucherData;	// 32 = 0x20
...
- (void).cxx_destruct;	// IMP=0x00200000000c2b0a
...
- (void)proceedWithPendingTLKShares:(id)arg1;	// IMP=0x00100000000c25ed
- (void)groupStart;	// IMP=0x00100000000c22fa
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 ckksConflictState:(id)arg3 errorState:(id)arg4;	// IMP=0x00100000000c21b8
