...
+ (id)itemTypeForVersion:(int)arg1;	// IMP=0x00400000000446cf
+ (id)itemType;	// IMP=0x00100000000446c7
- (void).cxx_destruct;	// IMP=0x0020000000044689
...
- (id)managedItemTypeWithContext:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000044493
@property(readonly, copy) NSArray *syncableKeys;
@property(readonly, copy) NSArray *primaryKeys;
- (id)debugDescription;	// IMP=0x00100000000443d5
- (id)description;	// IMP=0x00100000000443a8
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000442c1
- (id)_initWithName:(id)arg1 version:(int)arg2 primaryKeys:(id)arg3 syncableKeys:(id)arg4;	// IMP=0x00100000000441a9
