...
+ (void)cdpUploadPrerecord:(id)arg1 secretType:(unsigned long long)arg2 reply:(CDUnknownBlockType)arg3;	// IMP=0x00200000000bb3cf
...
- (void)groupStart;	// IMP=0x00100000000ba558
- (_Bool)checkFatalError:(id)arg1;	// IMP=0x00100000000ba3c5
- (id)initWithIntendedState:(id)arg1 errorState:(id)arg2 enforceRateLimiting:(_Bool)arg3 lockStateTracker:(id)arg4;	// IMP=0x00100000000ba2ed
