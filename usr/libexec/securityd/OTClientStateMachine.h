...
@class CKKSResultOperation, MISSING_TYPE, NSMutableArray, NSMutableDictionary, NSOperation, NSOperationQueue, NSString;
...
- (MISSING_TYPE *).cxx_destruct;	// IMP=0x00200000001bf60b
...
- (void)rpcVoucher:(id)arg1 peerID:(id)arg2 permanentInfo:(id)arg3 permanentInfoSig:(id)arg4 stableInfo:(id)arg5 stableInfoSig:(id)arg6 reply:(CDUnknownBlockType)arg7;	// IMP=0x00100000001bf162
- (void)rpcEpoch:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x00100000001bee5f
- (id)_onqueueNextClientStateMachineTransition:(id)arg1;	// IMP=0x00100000001be97c
- (_Bool)isAcceptorWaitingForFirstMessage;	// IMP=0x00100000001be8e5
- (void)handleExternalClientStateMachineRequest:(id)arg1 client:(id)arg2;	// IMP=0x00100000001be808
- (void)_onqueueStartNextClientStateMachineOperation:(id)arg1;	// IMP=0x00100000001be5d7
- (void)_onqueuePokeClientStateMachine:(id)arg1;	// IMP=0x00100000001be539
- (id)createOperationToFinishAttemptForClient:(id)arg1 clientName:(id)arg2;	// IMP=0x00100000001be3b5
- (void)startOctagonStateMachine;	// IMP=0x00100000001be344
@property(retain) NSString<OctagonStateString> *currentState;
- (void)dealloc;	// IMP=0x00100000001be1db
- (id)initWithContainerName:(id)arg1 contextID:(id)arg2 clientName:(id)arg3 cuttlefish:(id)arg4;	// IMP=0x00100000001bded1
