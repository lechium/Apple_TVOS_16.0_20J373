...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000001bda0a
- (void).cxx_destruct;	// IMP=0x00200000001bd9cc
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00100000001bd76d
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000001bd396
- (id)description;	// IMP=0x00100000001bd303
- (id)initWithEgoPeerID:(id)arg1 egoPeerMachineID:(id)arg2 status:(unsigned long long)arg3 viablePeerCountsByModelID:(id)arg4 peerCountsByMachineID:(id)arg5 isExcluded:(_Bool)arg6 isLocked:(_Bool)arg7;	// IMP=0x00100000001bd0a0
