...
- (void).cxx_destruct;	// IMP=0x0020000000094f79
...
- (_Bool)ensureKeyPresent:(id)arg1 viewState:(id)arg2;	// IMP=0x0010000000094938
- (void)attemptToHealView:(id)arg1 currentTrustStates:(id)arg2;	// IMP=0x00100000000947d8
- (void)groupStart;	// IMP=0x00100000000942f7
- (id)initWithDependencies:(id)arg1 allowFullRefetchResult:(_Bool)arg2 intending:(id)arg3 errorState:(id)arg4;	// IMP=0x00100000000941e1
- (id)init;	// IMP=0x00100000000941d3
