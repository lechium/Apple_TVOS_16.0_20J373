...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000000595d
...
- (id)description;	// IMP=0x001000000000601b
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000005bd0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000005af5
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000005a19
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000005965
- (id)init;	// IMP=0x00100000000058cb
