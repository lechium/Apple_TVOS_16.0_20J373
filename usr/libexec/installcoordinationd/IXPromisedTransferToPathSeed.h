...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000003a6fa
- (void).cxx_destruct;	// IMP=0x002000000003a81c
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000003a702
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000003a614
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000003a52e
