...
- (oneway void)_remote_setTryDeltaCopy:(_Bool)arg1;	// IMP=0x001000000002fb1d
- (oneway void)_remote_setShouldCopy:(_Bool)arg1;	// IMP=0x001000000002fa06
- (oneway void)_remote_setTransferPath:(id)arg1;	// IMP=0x001000000002f8c9
