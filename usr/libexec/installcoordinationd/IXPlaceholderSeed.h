...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000033476
- (void).cxx_destruct;	// IMP=0x002000000003360b
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000003347e
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000003330a
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000003313b
