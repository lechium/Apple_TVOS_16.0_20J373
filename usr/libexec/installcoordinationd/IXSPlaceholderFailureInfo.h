...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000003b0fc
- (void).cxx_destruct;	// IMP=0x002000000003b42f
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000003b27b
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000003b104
