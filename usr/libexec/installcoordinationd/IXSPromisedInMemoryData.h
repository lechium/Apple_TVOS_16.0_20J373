...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000039eab
@property(readonly, copy, nonatomic) NSData *data;
- (id)initWithSeed:(id)arg1 data:(id)arg2 error:(id *)arg3;	// IMP=0x0010000000039eb3
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000039e26
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000039df7
