...
- (void).cxx_destruct;	// IMP=0x0020000000038044
...
- (CDUnknownBlockType)actionForButtonAtIndex:(unsigned long long)arg1;	// IMP=0x0010000000037c73
- (void)addButtonDefinition:(id)arg1 forAction:(CDUnknownBlockType)arg2;	// IMP=0x0010000000037ba6
- (id)initWithTitle:(id)arg1 message:(id)arg2;	// IMP=0x0010000000037aad
