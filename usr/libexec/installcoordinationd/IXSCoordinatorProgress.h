...
+ (double)_computeOverallProgressForCurrentProgress:(double)arg1 progressPhase:(unsigned long long)arg2;	// IMP=0x004000000000d78a
- (void).cxx_destruct;	// IMP=0x002000000000dad3
...
- (void)_notifyDelegateAndUpdateProgressWithPhaseCompleted:(_Bool)arg1;	// IMP=0x001000000000d7c1
- (void)finishInstalling;	// IMP=0x001000000000d71b
- (void)finishLoading;	// IMP=0x001000000000d6b0
- (id)description;	// IMP=0x001000000000d5ce
- (id)initForCoordinatorWithIdentity:(id)arg1 totalUnits:(unsigned long long)arg2 delegate:(id)arg3;	// IMP=0x001000000000d519
