...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000000d34e
- (void).cxx_destruct;	// IMP=0x002000000000d4c9
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000000d356
- (void)encodeWithCoder:(id)arg1;	// IMP=0x001000000000d1da
- (id)initWithCoder:(id)arg1;	// IMP=0x001000000000d05b
