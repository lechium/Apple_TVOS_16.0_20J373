...
+ (id)stringForCFOptionFlag:(unsigned long long)arg1;	// IMP=0x0040000000039d23
- (void).cxx_destruct;	// IMP=0x0020000000039db9
...
- (void)dealloc;	// IMP=0x0010000000039cdc
- (_Bool)isMDMRestrictedWithOrganizationName:(id *)arg1;	// IMP=0x0010000000039b6d
- (id)localizedStringForKey:(id)arg1 withFormatHint:(id)arg2;	// IMP=0x0010000000039a88
- (void)otherButtonActionWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000039a76
- (void)displayAlertWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000039455
- (void)_configureOptionalButtonForConfiguration:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x001000000003911b
- (void)_onMainQueue_displayAlertWithCompletion:(CDUnknownBlockType)arg1 uninstallAlertConfiguration:(id)arg2;	// IMP=0x0010000000038bd4
- (void)_processUserNotification:(struct __CFUserNotification *)arg1 withConfiguration:(id)arg2 response:(unsigned long long)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x001000000003843e
- (_Bool)_onMainQueue_deleteButtonActionWithDisposition:(unsigned long long *)arg1 error:(id *)arg2;	// IMP=0x00100000000382c6
...
- (id)initWithAppRecord:(id)arg1 bundleIdentifier:(id)arg2 isRemovable:(_Bool)arg3;	// IMP=0x0010000000038082
