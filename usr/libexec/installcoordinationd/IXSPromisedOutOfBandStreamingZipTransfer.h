...
- (unsigned long long)totalBytesForProgress;	// IMP=0x0010000000002e8b
- (void)reset;	// IMP=0x0010000000002df0
- (id)initWithSeed:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000002dc1
- (oneway void)_remote_setArchiveBytesConsumed:(unsigned long long)arg1;	// IMP=0x0010000000002f04
