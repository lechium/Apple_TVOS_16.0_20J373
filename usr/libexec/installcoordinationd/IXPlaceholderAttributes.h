...
+ (_Bool)supportsSecureCoding;	// IMP=0x002000000001062f
- (void).cxx_destruct;	// IMP=0x002000000001235f
...
- (id)description;	// IMP=0x001000000001217b
- (id)infoPlistContent;	// IMP=0x0010000000011e47
- (void)setRequiredDeviceCapabilitiesWithArray:(id)arg1;	// IMP=0x0010000000011c00
- (id)initWithInfoPlistDictionary:(id)arg1;	// IMP=0x0010000000011516
- (id)initWithInfoPlistFromBundle:(struct __CFBundle *)arg1 error:(id *)arg2;	// IMP=0x001000000001147f
- (id)initWithInfoPlistFromBundleURL:(id)arg1 error:(id *)arg2;	// IMP=0x00100000000113ca
- (id)_plistKeys;	// IMP=0x001000000001131c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000110b1
- (unsigned long long)hash;	// IMP=0x0010000000010e1b
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000010637
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000010354
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000010024
- (id)init;	// IMP=0x001000000000fff5
