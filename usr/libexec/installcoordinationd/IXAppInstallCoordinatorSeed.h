...
+ (_Bool)supportsSecureCoding;	// IMP=0x00200000000592c7
- (void).cxx_destruct;	// IMP=0x00200000000599ae
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000059802
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000059627
- (id)initWithCoder:(id)arg1;	// IMP=0x00100000000592cf
