...
- (void).cxx_destruct;	// IMP=0x00200000000214ac
...
- (void)URLSession:(id)arg1 task:(id)arg2 didCompleteWithError:(id)arg3;	// IMP=0x00100000000211ab
- (void)URLSession:(id)arg1 dataTask:(id)arg2 didReceiveData:(id)arg3;	// IMP=0x0010000000020f76
- (void)URLSession:(id)arg1 dataTask:(id)arg2 didReceiveResponse:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x0010000000020a02
- (long long)versionFromTask:(id)arg1;	// IMP=0x00100000000209a6
- (void)updateDb:(long long)arg1;	// IMP=0x0010000000020745
- (void)reschedule;	// IMP=0x0010000000020646
