...
- (void).cxx_destruct;	// IMP=0x0020000000206750
...
- (void)resumeOTRNegotiation;	// IMP=0x0010000000206330
- (void)suspendOTRNegotiation:(id)arg1;	// IMP=0x00100000002062f0
- (_Bool)processSuspendOTRNegotiationMessage:(id)arg1;	// IMP=0x00100000002062a0
- (void)sendSuspendOTRNegotiationMessage:(id)arg1;	// IMP=0x0010000000206260
- (_Bool)processOTRNegotiationMessage:(id)arg1;	// IMP=0x00100000002056c0
- (void)sendOTRNegotiationMessage:(id)arg1 negotiationCount:(unsigned int)arg2 negotiationData:(id)arg3;	// IMP=0x0010000000205650
- (void)_destroyFairplayDeviceSession;	// IMP=0x0010000000205640
- (void)_destroyFairplayHostSession;	// IMP=0x0010000000205630
- (void)_handleFairplayAuthenticationFailure;	// IMP=0x0010000000205560
- (_Bool)processFairplayDeviceSessionInfo:(id)arg1;	// IMP=0x0010000000205510
- (_Bool)processFairplayDeviceInfo:(id)arg1;	// IMP=0x00100000002054c0
- (_Bool)processFairplayHostSessionInfo:(id)arg1;	// IMP=0x0010000000205470
- (id)_utunControlMessageFairplayDeviceSessionInfo:(char *)arg1 grappaDeviceSessionInfoSize:(unsigned int)arg2;	// IMP=0x0010000000205450
- (id)_utunControlMessageFairplayHostSessionInfo:(unsigned char)arg1 deviceType:(unsigned char)arg2 protocolVersion:(unsigned int)arg3;	// IMP=0x0010000000205430
- (id)_utunControlMessageFairplayDeviceInfo;	// IMP=0x0010000000205420
- (void)dealloc;	// IMP=0x00100000002053d0
- (void)invalidate;	// IMP=0x0010000000205360
- (void)sendPriorityMessage:(id)arg1;	// IMP=0x00100000002052b0
- (void)sendMessage:(id)arg1;	// IMP=0x0010000000205200
- (void)_checkSendNewMessage;	// IMP=0x0010000000203ab0
- (void)_clearChannel;	// IMP=0x00100000002038f0
@property(readonly, nonatomic) _Bool connected;
- (void)cancelConnection;	// IMP=0x0010000000203890
- (void)_cancelConnectionAndResetDataConnections:(_Bool)arg1 shouldObliterate:(_Bool)arg2 encryptionFailure:(_Bool)arg3 shouldTriggerCorruptionRecovery:(_Bool)arg4;	// IMP=0x0010000000203610
- (void)_callHandlerWithMessage:(id)arg1 resetDataConnections:(_Bool)arg2 shouldObliterate:(_Bool)arg3 decryptionFailed:(_Bool)arg4 shouldTriggerCorruptionRecovery:(_Bool)arg5;	// IMP=0x0010000000203540
- (void)useConnection:(id)arg1 withFirstMessage:(id)arg2;	// IMP=0x0010000000201fa0
- (void)writeToConnection;	// IMP=0x00100000002013b0
- (void)readFromConnection;	// IMP=0x00100000001ff320
@property(readonly, nonatomic) _Bool isDefaultPairedDeviceStartingToEncrypt;
- (void)encryptControlChannelForStoredIdentities;	// IMP=0x00100000001ff2f0
- (void)simulateDecryptionFailure;	// IMP=0x00100000001ff220
- (void)_cleanupConnection;	// IMP=0x00100000001ff170
- (id)initWithDeviceUniqueID:(id)arg1 cbuuid:(id)arg2 receiveHandler:(CDUnknownBlockType)arg3;	// IMP=0x00100000001fee80
