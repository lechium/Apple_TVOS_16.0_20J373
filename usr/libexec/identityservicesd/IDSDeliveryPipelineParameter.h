...
- (void).cxx_destruct;	// IMP=0x00200000005a75b0
...
- (id)description;	// IMP=0x00100000005a6c30
- (_Bool)overrideSendOnePerTokenForService:(id)arg1;	// IMP=0x00100000005a6ba0
- (id)initWithInfo:(id)arg1 uris:(id)arg2 service:(id)arg3 maxSize:(unsigned long long)arg4;	// IMP=0x00100000005a6450
