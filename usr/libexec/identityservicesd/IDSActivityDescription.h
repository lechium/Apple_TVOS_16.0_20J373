...
+ (_Bool)supportsSecureCoding;	// IMP=0x0020000000078bc0
- (void).cxx_destruct;	// IMP=0x0020000000078f40
...
- (id)description;	// IMP=0x0010000000078de0
- (id)initWithCoder:(id)arg1;	// IMP=0x0010000000078c80
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0010000000078be0
