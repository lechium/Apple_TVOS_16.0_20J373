...
- (void).cxx_destruct;	// IMP=0x0020000000006ed0
...
- (id)init;	// IMP=0x0010000000006dc0
- (id)initWithDeviceIdentifier:(id)arg1 delegate:(id)arg2 queue:(id)arg3;	// IMP=0x0010000000006d20
