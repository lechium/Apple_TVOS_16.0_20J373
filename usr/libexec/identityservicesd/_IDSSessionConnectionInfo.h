...
- (void).cxx_destruct;	// IMP=0x002000000044e010
...
- (unsigned int)_numberOfOutagesSinceInterval:(double)arg1;	// IMP=0x001000000044d5c0
- (void)_addRemotePacketOutage;	// IMP=0x001000000044d510
- (id)description;	// IMP=0x001000000044d400
@property(readonly, nonatomic) _Bool isFinished;
- (id)init;	// IMP=0x001000000044d320
