...
- (id)initWithMPIdentityIdentifier:(id)arg1;	// IMP=0x00100000002164c0
- (id)initWithEncryptionType:(long long)arg1;	// IMP=0x0010000000216430
- (id)init;	// IMP=0x00100000002163d0
