...
@interface IDSGenericConnection : NSObject
{
    ...
    MISSING_TYPE *_uint32Key;	// 176 = 0xb0
...
- (void).cxx_destruct;	// IMP=0x00200000005cb350
...
- (void)_createStallDetectorWithName:(id)arg1;	// IMP=0x00100000005c9880
- (void)_triggerStallDetectionLogsForDetector:(id)arg1 withEvent:(id)arg2;	// IMP=0x00100000005c9110
- (void)reportToAWD:(unsigned long long)arg1 connectionType:(int)arg2 error:(int)arg3;	// IMP=0x00100000005c8ef0
- (void)invalidate;	// IMP=0x00100000005c8510
- (void)dealloc;	// IMP=0x00100000005c8420
- (void)_closeSockets;	// IMP=0x00100000005c7d10
@property(nonatomic) NSObject<OS_dispatch_queue> *completionQueue;
- (id)initWithAddressPair:(id)arg1 protocol:(int)arg2;	// IMP=0x00100000005c78c0
- (id)flagsString;	// IMP=0x00100000005c77c0
- (CDStruct_eff2b79e *)encryptionState;	// IMP=0x00100000005c77a0
- (id)description;	// IMP=0x00100000005c7230
- (id)initWithConnectionID:(id)arg1 protocol:(int)arg2 keyMaterialLength:(int)arg3 isCloudEnabled:(_Bool)arg4;	// IMP=0x00100000005c6e20
- (id)initWithConnectionID:(id)arg1 protocol:(int)arg2 isCloudEnabled:(_Bool)arg3;	// IMP=0x00100000005c6a20
