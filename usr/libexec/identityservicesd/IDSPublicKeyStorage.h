...
+ (id)sharedInstance;	// IMP=0x004000000036abd0
- (void).cxx_destruct;	// IMP=0x002000000036bd60
...
- (void)logState;	// IMP=0x001000000036bbb0
- (id)publicDeviceIdentityContainerForDeviceID:(id)arg1;	// IMP=0x001000000036b530
- (void)clearCache;	// IMP=0x001000000036b440
- (void)dealloc;	// IMP=0x001000000036b3e0
- (void)_removeOldPersistence;	// IMP=0x001000000036b2f0
- (id)initWithPeerIDManager:(id)arg1 accountController:(id)arg2;	// IMP=0x001000000036ad80
- (id)init;	// IMP=0x001000000036acc0
