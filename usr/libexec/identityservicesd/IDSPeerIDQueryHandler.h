...
+ (int)queryRetryNumberForBadSignature;	// IMP=0x00200000006095e0
+ (double)queryRetryIntervalForBadSignature;	// IMP=0x0010000000609510
+ (_Bool)isQueryRetryForBadSignatureEnabled;	// IMP=0x0010000000609450
+ (int)serverBackoffModeReceiverRetryInterval;	// IMP=0x0010000000609300
+ (int)serverBackoffModeMaxSenderRetries;	// IMP=0x00100000006091b0
+ (_Bool)isServerBackoffModeActive;	// IMP=0x0010000000609110
+ (_Bool)shouldUseSelfTokens;	// IMP=0x0010000000609040
- (void).cxx_destruct;	// IMP=0x0020000000617cd0
...
- (void)removeCompletionBlockForToken:(id)arg1;	// IMP=0x0010000000617790
- (void)addCompletionBlock:(CDUnknownBlockType)arg1 forToken:(id)arg2;	// IMP=0x00100000006172c0
- (_Bool)startQueryForURIs:(id)arg1 fromIdentity:(id)arg2 fromURI:(id)arg3 fromService:(id)arg4 context:(id)arg5 completionBlock:(CDUnknownBlockType)arg6;	// IMP=0x00100000006170b0
- (void)_dequeuePendingQueryIfPossible;	// IMP=0x001000000060bff0
- (void)_startQueryForURIs:(id)arg1 fromIdentity:(id)arg2 fromURI:(id)arg3 fromService:(id)arg4 context:(id)arg5 completionBlock:(CDUnknownBlockType)arg6;	// IMP=0x001000000060b2a0
- (void)_removeCompletionBlocksForURIs:(id)arg1 fromURI:(id)arg2 fromService:(id)arg3 forRefresh:(_Bool)arg4;	// IMP=0x001000000060ada0
- (id)_completionBlocksForURIs:(id)arg1 fromURI:(id)arg2 fromService:(id)arg3 forRefresh:(_Bool)arg4;	// IMP=0x001000000060abe0
- (_Bool)_addCompletionBlock:(CDUnknownBlockType)arg1 forURIs:(id)arg2 fromURI:(id)arg3 fromService:(id)arg4 context:(id)arg5;	// IMP=0x0010000000609dd0
- (void)_bagLoaded:(id)arg1;	// IMP=0x0010000000609b00
- (void)dealloc;	// IMP=0x0010000000609a60
- (id)initWithDelegate:(id)arg1 dataSource:(id)arg2 dualMessageDelivery:(id)arg3 networkChangeNotifier:(id)arg4 pushHandler:(id)arg5;	// IMP=0x0010000000609820
- (id)initWithDelegate:(id)arg1 dataSource:(id)arg2;	// IMP=0x00100000006096a0
