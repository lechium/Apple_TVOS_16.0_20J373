...
- (void).cxx_destruct;	// IMP=0x00200000003eda70
...
- (void)_storeGossipRecipients;	// IMP=0x00100000003ed4b0
- (void)_loadGossipRecipients;	// IMP=0x00100000003eca40
- (void)markSelfVerifyBecauseOfPeer;	// IMP=0x00100000003ec9f0
- (_Bool)shouldSelfVerifyBecauseOfPeer;	// IMP=0x00100000003ec920
- (void)markGossipForURI:(id)arg1;	// IMP=0x00100000003ec7c0
- (_Bool)shouldGossipToURI:(id)arg1;	// IMP=0x00100000003ec680
- (_Bool)havePreviouslyGossipedToURI:(id)arg1;	// IMP=0x00100000003ec610
- (void)resetGossipState;	// IMP=0x00100000003ec5b0
- (id)initWithGossipSpecification:(id)arg1;	// IMP=0x00100000003ec290
