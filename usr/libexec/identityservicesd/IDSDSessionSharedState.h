...
- (void).cxx_destruct;	// IMP=0x002000000058f180
...
- (void)setSharedSession:(_Bool)arg1;	// IMP=0x001000000058ed10
- (_Bool)sharedSession;	// IMP=0x001000000058ecf0
...
- (id)publicIdentityFromData:(id)arg1;	// IMP=0x001000000058db10
- (_Bool)destinationIsDefaultPairedDevice:(id)arg1;	// IMP=0x001000000058da40
- (_Bool)destinationIsGuestDevice:(id)arg1;	// IMP=0x001000000058d9d0
- (id)getQuickRelayAllocateOptions:(id)arg1;	// IMP=0x001000000058d5f0
- (_Bool)supportsReinitiate;	// IMP=0x001000000058d4f0
- (void)_endSessionTimedOut;	// IMP=0x001000000058d390
- (void)_endSessionTimerFiredOnMain;	// IMP=0x001000000058d2c0
- (void)setEndSessionTimeoutTimer;	// IMP=0x001000000058d040
- (void)_clearEndSessionTimeoutTimer;	// IMP=0x001000000058ce50
- (void)_clearPacketLossTimer;	// IMP=0x001000000058ccd0
- (void)_connectionTimedOut;	// IMP=0x001000000058cb80
- (void)_connectionTimerFiredOnMain;	// IMP=0x001000000058cab0
- (void)setConnectionTimer;	// IMP=0x001000000058c640
- (void)_clearConnectionTimer;	// IMP=0x001000000058c450
- (void)_clearInvitationTimer;	// IMP=0x001000000058c260
- (void)_inviteTimedOut;	// IMP=0x001000000058c0a0
- (void)_inviteTimerFiredOnMain;	// IMP=0x001000000058bfd0
- (void)setInvitationTimer;	// IMP=0x001000000058bd40
- (void)clearAllTimers;	// IMP=0x001000000058bce0
@property(readonly, nonatomic) CDStruct_eff2b79e *encryptionState;
- (id)initWithDictionary:(id)arg1 serviceName:(id)arg2 isInitiator:(_Bool)arg3 uniqueID:(id)arg4 accountID:(id)arg5 destinations:(id)arg6;	// IMP=0x0010000000589410
