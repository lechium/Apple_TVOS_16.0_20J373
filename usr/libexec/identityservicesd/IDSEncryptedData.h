...
- (void).cxx_destruct;	// IMP=0x0020000000176a10
...
- (id)description;	// IMP=0x00100000001768f0
- (id)initWithData:(id)arg1 encryptionType:(long long)arg2 payloadMetadata:(id)arg3;	// IMP=0x00100000001767e0
