...
- (void).cxx_destruct;	// IMP=0x0020000000065440
...
- (void)setOTREncryptionBlock:(CDUnknownBlockType)arg1 decryptionBlock:(CDUnknownBlockType)arg2;	// IMP=0x0010000000064ed0
- (void)setNotifyWhenConnectionReceivesBytes:(_Bool)arg1;	// IMP=0x0010000000064e80
- (void)_endSession;	// IMP=0x0010000000064ae0
- (_Bool)sendDataMessage:(id)arg1 canFragment:(_Bool)arg2;	// IMP=0x0010000000064630
- (_Bool)sendDataMessage:(id)arg1;	// IMP=0x00100000000645c0
- (void)_sendToConnectedSocket;	// IMP=0x0010000000063650
- (_Bool)_queueNextOutgoingData;	// IMP=0x0010000000062460
- (void)_processBytesAvailable;	// IMP=0x0010000000060eb0
- (_Bool)_processIncomingMessage:(id)arg1;	// IMP=0x001000000005feb0
- (void)processStoredIncomingMessage:(id)arg1;	// IMP=0x001000000005fab0
- (void)removePendingMessagesForProtectionClass:(unsigned int)arg1;	// IMP=0x001000000005f1c0
- (long long)_read:(char *)arg1 maxLength:(unsigned long long)arg2;	// IMP=0x001000000005ecd0
- (void)_callDelegateWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x001000000005eb50
...
- (void)endSession;	// IMP=0x001000000005e070
- (void)dealloc;	// IMP=0x001000000005df80
- (void)start;	// IMP=0x001000000005dd10
- (id)initWithSocket:(int)arg1 queue:(id)arg2 delegate:(id)arg3 priority:(long long)arg4 connectionID:(id)arg5 linkType:(unsigned long long)arg6;	// IMP=0x001000000005d690
