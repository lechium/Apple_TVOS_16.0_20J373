...
- (void).cxx_destruct;	// IMP=0x00200000004adde0
...
- (_Bool)isPrefightEnabledByServerBag;	// IMP=0x00100000004ad570
...
- (id)initWithServerBag:(id)arg1;	// IMP=0x00100000004ad0b0
- (id)init;	// IMP=0x00100000004ad020
