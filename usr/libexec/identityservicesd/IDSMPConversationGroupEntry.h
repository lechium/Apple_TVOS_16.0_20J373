...
+ (id)entryFromPublicDataRepresentation:(id)arg1 error:(id *)arg2;	// IMP=0x00400000001b2940
- (void).cxx_destruct;	// IMP=0x00200000001b33f0
...
- (id)description;	// IMP=0x00100000001b3080
- (id)publicDataRepresentationWithError:(id *)arg1;	// IMP=0x00100000001b2d00
- (id)initWithStableGroupID:(id)arg1 groupServerEntry:(id)arg2;	// IMP=0x00100000001b2700
