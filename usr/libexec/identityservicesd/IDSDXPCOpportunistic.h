...
- (void).cxx_destruct;	// IMP=0x0020000000093090
...
- (void)copyOpportunisticCacheWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x0010000000092bf0
- (id)initWithQueue:(id)arg1 connection:(id)arg2 opportunisticCache:(id)arg3;	// IMP=0x0010000000092ad0
