...
- (void).cxx_destruct;	// IMP=0x00200000006dcbf0
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x00100000006dc6e0
- (id)bagKey;	// IMP=0x00100000006dc6c0
- (id)requiredKeys;	// IMP=0x00100000006dc660
- (id)messageBody;	// IMP=0x00100000006dc2c0
- (id)additionalMessageHeaders;	// IMP=0x00100000006dbfe0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000006dbcd0
