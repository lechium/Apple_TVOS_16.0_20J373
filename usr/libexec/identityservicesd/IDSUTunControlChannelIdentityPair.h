...
- (void).cxx_destruct;	// IMP=0x0020000000206a90
...
- (id)description;	// IMP=0x0010000000206960
- (id)initWithLocalFullIdentity:(id)arg1 remotePublicIdentity:(id)arg2;	// IMP=0x0010000000206870
