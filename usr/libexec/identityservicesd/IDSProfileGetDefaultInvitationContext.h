...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x0010000000077700
- (double)anisetteHeadersTimeout;	// IMP=0x00100000000776e0
- (id)messageBody;	// IMP=0x0010000000077680
- (id)requiredKeys;	// IMP=0x0010000000077620
- (id)bagKey;	// IMP=0x0010000000077600
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000077490
- (id)init;	// IMP=0x00100000000773f0
