...
- (void).cxx_destruct;	// IMP=0x0020000000581a20
...
- (id)description;	// IMP=0x001000000057ff60
- (unsigned long long)requestLength;	// IMP=0x001000000057f7f0
- (unsigned long long)_recipientDataSize;	// IMP=0x001000000057e390
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x001000000057e350
- (_Bool)wantsAPSRetries;	// IMP=0x001000000057e330
- (id)messageBody;	// IMP=0x001000000057d660
- (id)requiredKeys;	// IMP=0x001000000057d550
- (long long)responseCommand;	// IMP=0x001000000057d530
- (long long)command;	// IMP=0x001000000057d510
- (_Bool)wantsIntegerUniqueIDs;	// IMP=0x001000000057d4f0
- (_Bool)wantsBinaryPush;	// IMP=0x001000000057d4d0
- (_Bool)wantsCompressedBody;	// IMP=0x001000000057d4b0
- (_Bool)wantsHTTPHeaders;	// IMP=0x001000000057d490
- (_Bool)wantsBagKey;	// IMP=0x001000000057d470
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000057c6e0
- (id)initWithDictionary:(id)arg1;	// IMP=0x0010000000570130
- (id)init:(id)arg1;	// IMP=0x001000000056ff10
