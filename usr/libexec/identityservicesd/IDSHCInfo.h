...
- (void *)remoteContext;	// IMP=0x00100000002e30a0
- (void *)localContext;	// IMP=0x00100000002e3080
- (void)setRemoteContext:(void *)arg1;	// IMP=0x00100000002e2e80
- (void)setLocalContext:(void *)arg1;	// IMP=0x00100000002e2c80
- (void)invalidate;	// IMP=0x00100000002e29f0
