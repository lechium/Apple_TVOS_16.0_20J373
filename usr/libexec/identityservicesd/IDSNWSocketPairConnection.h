...
@class MISSING_TYPE, NSMutableArray, NSMutableDictionary, NSSet, NSString;
...
- (void).cxx_destruct;	// IMP=0x002000000070b4b0
...
- (MISSING_TYPE *)_sendDataViaNWConnection:isLargeTransfer: /* Error: Ran out of types for this method. */;	// IMP=0x001000000070a930
@property(readonly, nonatomic) NSSet *inFlightMessages;
- (void)_dequeueNextMessageFromOutgoingQueue;	// IMP=0x001000000070a1f0
- (double)lastSocketActivityTime;	// IMP=0x001000000070a1d0
- (_Bool)sendDataMessage:(id)arg1 canFragment:(_Bool)arg2;	// IMP=0x00100000007099f0
- (_Bool)sendDataMessage:(id)arg1;	// IMP=0x0010000000709980
- (void)_processIncomingRawMessage:(id)arg1;	// IMP=0x00100000007084a0
- (void)processStoredIncomingMessage:(id)arg1;	// IMP=0x0010000000708440
- (void)_receiveFromNWConnection:(id)arg1;	// IMP=0x0010000000707490
- (void)setOTREncryptionBlock:(CDUnknownBlockType)arg1 decryptionBlock:(CDUnknownBlockType)arg2;	// IMP=0x00100000007073d0
- (void)_notifyDelegateAboutClosedConnection;	// IMP=0x0010000000707330
- (void)endSession;	// IMP=0x0010000000707030
- (void)dealloc;	// IMP=0x0010000000706f40
- (void)start;	// IMP=0x0010000000705d50
- (id)initWithSocket:(int)arg1 queue:(id)arg2 delegate:(id)arg3 priority:(long long)arg4 identifier:(id)arg5;	// IMP=0x0010000000705a70
