...
- (id)socketPairMessage;	// IMP=0x00100000002df4a0
- (void)processAckForSocketPairMessage:(id)arg1;	// IMP=0x00100000002df440
- (void)kickProgressBlock;	// IMP=0x00100000002df290
- (id)init;	// IMP=0x00100000002deff0
