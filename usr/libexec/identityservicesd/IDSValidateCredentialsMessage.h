...
- (void).cxx_destruct;	// IMP=0x0020000000198d30
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x00100000001988b0
- (id)bagKey;	// IMP=0x0010000000198890
- (id)requiredKeys;	// IMP=0x0010000000198830
- (id)messageBody;	// IMP=0x0010000000198650
- (id)additionalMessageHeaders;	// IMP=0x00100000001984c0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000198250
