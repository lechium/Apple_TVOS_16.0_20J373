...
- (_Bool)isEqualToContext:(id)arg1;	// IMP=0x00100000006fd7d0
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000006fd730
- (id)initWithSending:(_Bool)arg1 refresh:(_Bool)arg2 messaging:(_Bool)arg3 resultExpected:(_Bool)arg4 preventNewQuery:(_Bool)arg5;	// IMP=0x00100000006fd620
