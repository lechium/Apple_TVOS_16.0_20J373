...
- (void).cxx_destruct;	// IMP=0x002000000036a3c0
...
- (void)didUpdatePairedDevice:(id)arg1;	// IMP=0x0010000000369e70
- (void)_checkRegistrationStatus;	// IMP=0x0010000000369230
- (void)_setupForCurrentSubscriptionState;	// IMP=0x00100000003691f0
- (void)SIMInformationDidChange;	// IMP=0x00100000003690a0
- (void)userStore:(id)arg1 didUpdateUser:(id)arg2;	// IMP=0x0010000000369030
- (void)userStore:(id)arg1 didRemoveAuthenticationCertificateForUser:(id)arg2;	// IMP=0x0010000000368fc0
- (void)userStore:(id)arg1 didAddAuthenticationCertificate:(id)arg2 forUser:(id)arg3;	// IMP=0x0010000000368f30
- (void)userStore:(id)arg1 didAddUser:(id)arg2;	// IMP=0x0010000000368ec0
- (void)userStore:(id)arg1 didRemoveUser:(id)arg2 withAuthenticationCertificate:(id)arg3;	// IMP=0x0010000000368dd0
- (void)selectedSubscriptionLabelDidChange:(id)arg1;	// IMP=0x0010000000368c50
- (id)updatedUserSetForRealm:(long long)arg1 currentUsers:(id)arg2;	// IMP=0x0010000000366d00
- (void)forceRemoveUser:(id)arg1 silently:(_Bool)arg2;	// IMP=0x0010000000366bf0
- (_Bool)_isInDualPhoneIdentityModeForSims:(id)arg1;	// IMP=0x00100000003668f0
- (void)verifyState;	// IMP=0x0010000000366820
- (void)dealloc;	// IMP=0x00100000003667c0
- (id)initWithUserStore:(id)arg1 queue:(id)arg2 lockdownManager:(id)arg3 systemMonitor:(id)arg4 CTAdapter:(id)arg5 userConfiguration:(id)arg6 registrationController:(id)arg7 pairingManager:(id)arg8;	// IMP=0x0010000000366490
