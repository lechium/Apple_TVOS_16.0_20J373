...
- (void).cxx_destruct;	// IMP=0x0020000000444230
...
- (_Bool)wantsBinaryPush;	// IMP=0x0010000000444160
- (id)messageBody;	// IMP=0x0010000000443f60
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000443ea0
- (id)initWithPayload:(id)arg1 command:(id)arg2;	// IMP=0x0010000000443d70
