...
- (void).cxx_destruct;	// IMP=0x002000000071ebe0
...
- (void)injectFakePacket:(CDStruct_dc2926a3 *)arg1;	// IMP=0x001000000071e830
- (void)suspendLink:(_Bool)arg1;	// IMP=0x001000000071e410
- (_Bool)isLinkSuspended;	// IMP=0x001000000071e3f0
- (id)generateLinkReport:(double)arg1 isCurrentLink:(_Bool)arg2;	// IMP=0x001000000071df90
- (void)_processOutgoingPacket;	// IMP=0x001000000071d5c0
- (void)_processIncomingPacket;	// IMP=0x001000000071a7e0
- (long long)_readFromDataChannel:(void *)arg1 size:(unsigned long long)arg2 withFlags:(int)arg3 isSynced:(_Bool *)arg4;	// IMP=0x001000000071a7b0
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x001000000071a280
- (void)flushBuffer:(unsigned long long)arg1;	// IMP=0x001000000071a210
- (unsigned long long)sendPacketBufferArray:(struct **)arg1 arraySize:(int)arg2 toDeviceUniqueID:(id)arg3 cbuuid:(id)arg4;	// IMP=0x001000000071a190
- (unsigned long long)sendPacketBuffer:(CDStruct_dc2926a3 *)arg1 toDeviceUniqueID:(id)arg2 cbuuid:(id)arg3;	// IMP=0x0010000000719970
- (void)invalidate;	// IMP=0x0010000000719920
- (void)remoteDetectedCorruption;	// IMP=0x0010000000719750
- (void)start;	// IMP=0x00100000007195e0
- (void)triggerBTCorruptionRecovery;	// IMP=0x00100000007195b0
- (void)_submitMagnetCorruptionMetricsToAWD;	// IMP=0x0010000000719230
- (void)_resetMagnetCorruptionMetrics;	// IMP=0x00100000007191f0
- (void)_dumpLogs:(double)arg1 isDownstream:(_Bool)arg2;	// IMP=0x00100000007188b0
- (void)_localDetectedCorruption;	// IMP=0x0010000000718720
- (void)dealloc;	// IMP=0x0010000000718400
- (id)initWithPipe:(id)arg1 useSkywalkChannel:(_Bool)arg2 withDeviceUniqueID:(id)arg3 cbuuid:(id)arg4;	// IMP=0x0010000000717740
- (id)copyLinkStatsDict;	// IMP=0x00100000007175e0
