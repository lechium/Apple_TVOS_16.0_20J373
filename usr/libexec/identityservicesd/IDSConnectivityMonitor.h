...
- (void).cxx_destruct;	// IMP=0x00200000001fb950
...
- (void)deliveryController:(id)arg1 uniqueID:(id)arg2 isConnected:(_Bool)arg3;	// IMP=0x00100000001fb590
- (void)sendMonitorMessage;	// IMP=0x00100000001fac40
- (void)checkConnectivityState:(id)arg1;	// IMP=0x00100000001fa840
- (id)init;	// IMP=0x00100000001fa7b0
