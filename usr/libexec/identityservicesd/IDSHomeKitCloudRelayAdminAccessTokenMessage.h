...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x00100000004d1450
- (id)bagKey;	// IMP=0x00100000004d1430
- (id)messageBody;	// IMP=0x00100000004d12e0
- (id)additionalMessageHeaders;	// IMP=0x00100000004d1100
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000004d0e90
