...
- (void).cxx_destruct;	// IMP=0x002000000013ea60
...
- (id)_signData:(id)arg1 withType:(long long)arg2 error:(id *)arg3;	// IMP=0x001000000013e750
- (unsigned short)_retrieveKeyIndex;	// IMP=0x001000000013e680
- (id)signData:(id)arg1 withType:(long long)arg2 onQueue:(id)arg3 error:(id *)arg4;	// IMP=0x001000000013e2b0
- (id)batchSignDatas:(id)arg1 withType:(long long)arg2 onQueue:(id)arg3 error:(id *)arg4;	// IMP=0x001000000013def0
- (void)signData:(id)arg1 withType:(long long)arg2 onQueue:(id)arg3 withCompletion:(CDUnknownBlockType)arg4;	// IMP=0x001000000013dba0
- (void)batchSignDatas:(id)arg1 withType:(long long)arg2 onQueue:(id)arg3 withCompletion:(CDUnknownBlockType)arg4;	// IMP=0x001000000013d820
- (id)initWithKeyType:(unsigned int)arg1 keyDiversifier:(id)arg2 service:(id)arg3 serviceController:(id)arg4 fullDeviceIdentitySigner:(id)arg5;	// IMP=0x001000000013d690
