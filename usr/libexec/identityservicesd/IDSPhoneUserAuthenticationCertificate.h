...
- (void).cxx_destruct;	// IMP=0x00200000006fb3c0
...
- (id)description;	// IMP=0x00100000006fb2a0
- (id)initWithPhoneUser:(id)arg1 authenticationCertificate:(id)arg2;	// IMP=0x00100000006fb1b0
