...
- (void).cxx_destruct;	// IMP=0x00200000002ddd90
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x00100000002dd890
- (_Bool)wantsHTTPGet;	// IMP=0x00100000002dd870
- (id)additionalQueryStringParameters;	// IMP=0x00100000002dd660
- (id)additionalMessageHeaders;	// IMP=0x00100000002dd3f0
- (id)bagKey;	// IMP=0x00100000002dd3d0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000002dd110
