...
- (void).cxx_destruct;	// IMP=0x0020000000015e30
...
- (void)_signalDidUpdateEndpoints;	// IMP=0x0010000000015c10
- (void)_noteSourceDidDiscoverEndpointMap:(id)arg1 forLocalURI:(id)arg2;	// IMP=0x0010000000015650
- (void)_registerEndpointQueryCompletionBlock;	// IMP=0x0010000000015310
- (id)resolvedEndpoints;	// IMP=0x0010000000015050
- (void)initializeWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0010000000014950
- (id)peerIDManager;	// IMP=0x0010000000014920
- (id)description;	// IMP=0x0010000000014810
- (void)dealloc;	// IMP=0x0010000000014790
- (id)initWithServiceIdentifier:(id)arg1 localURI:(id)arg2 subscribedURIs:(id)arg3 queue:(id)arg4;	// IMP=0x00100000000145e0
