...
- (void).cxx_destruct;	// IMP=0x0020000000558a10
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x0010000000558740
- (id)bagKey;	// IMP=0x0010000000558720
- (id)messageBody;	// IMP=0x0010000000558570
- (id)additionalMessageHeaders;	// IMP=0x0010000000558390
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000558170
