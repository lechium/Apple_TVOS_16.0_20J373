...
- (void).cxx_destruct;	// IMP=0x00200000001a0b00
...
- (id)initWithBytes:(const void *)arg1 length:(unsigned long long)arg2 loggingPrefixString:(id)arg3;	// IMP=0x001000000019d580
- (id)data;	// IMP=0x001000000019c6e0
- (id)init;	// IMP=0x001000000019c670
- (_Bool)_isTinkerFlagSet;	// IMP=0x001000000019c5f0
- (_Bool)_isSupportIPsecLinkFlagSet;	// IMP=0x001000000019c570
- (id)description;	// IMP=0x001000000019c3d0
