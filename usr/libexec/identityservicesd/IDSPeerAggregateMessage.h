...
- (void).cxx_destruct;	// IMP=0x00200000000ad120
...
- (id)messageBody;	// IMP=0x00100000000aba50
- (id)requiredKeys;	// IMP=0x00100000000ab970
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000ab350
- (unsigned long long)sizeOfKeysWithValues;	// IMP=0x00100000000aaea0
- (void)logFailureInfo;	// IMP=0x00100000000aa640
- (_Bool)expectingMoreResponses;	// IMP=0x00100000000aa600
- (id)_processMessageResponseForMessage:(id)arg1 withError:(id)arg2 resultCode:(long long)arg3 toURI:(id)arg4 fromURI:(id)arg5 service:(id)arg6 fromIdentity:(id)arg7;	// IMP=0x00100000000a8fe0
- (void)noteResponseForToken:(id)arg1;	// IMP=0x00100000000a8380
- (void)callAllAckBlocks;	// IMP=0x00100000000a8130
- (void)clearAllPendingResponseTokens;	// IMP=0x00100000000a80b0
- (void)callAllIndividualCompletionBlocksWithDeliveryContext:(id)arg1;	// IMP=0x00100000000a7e40
- (_Bool)removeAllAggregatableMessages;	// IMP=0x00100000000a7d00
- (_Bool)addAggregatableMessage:(id)arg1;	// IMP=0x00100000000a7b70
- (_Bool)hasSpaceForAggregatableMessage:(id)arg1;	// IMP=0x00100000000a7ab0
- (id)initWithPeerMessage:(id)arg1 service:(id)arg2 fromIdentity:(id)arg3 maxSize:(unsigned long long)arg4;	// IMP=0x00100000000a7360
- (id)initWithHighPriority:(_Bool)arg1;	// IMP=0x00100000000a7290
- (id)init;	// IMP=0x00100000000a71f0
