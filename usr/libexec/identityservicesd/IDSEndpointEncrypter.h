...
- (void).cxx_destruct;	// IMP=0x0020000000523cf0
...
- (_Bool)_isSecKeyType;	// IMP=0x0010000000523af0
- (_Bool)_isNGMKeyType;	// IMP=0x0010000000523a80
- (_Bool)verifySignedData:(id)arg1 matchesData:(id)arg2 forType:(long long)arg3 onQueue:(id)arg4 error:(id *)arg5;	// IMP=0x0010000000523330
- (void)verifySignedData:(id)arg1 matchesData:(id)arg2 forType:(long long)arg3 onQueue:(id)arg4 withCompletion:(CDUnknownBlockType)arg5;	// IMP=0x0010000000522c80
- (void)decryptData:(id)arg1 usingIdentifier:(id)arg2 onQueue:(id)arg3 isRetry:(_Bool)arg4 replayKey:(id)arg5 withCompletion:(CDUnknownBlockType)arg6;	// IMP=0x0010000000522040
- (id)decryptData:(id)arg1 usingIdentifier:(id)arg2 isRetry:(_Bool)arg3 onQueue:(id)arg4 error:(id *)arg5;	// IMP=0x00100000005216f0
- (id)encryptData:(id)arg1 withEncryptedAttributes:(id)arg2 usedIdentifier:(id *)arg3 onQueue:(id)arg4 error:(id *)arg5;	// IMP=0x0010000000520da0
- (id)initWithEndpoint:(id)arg1 fullDeviceIdentitySigner:(id)arg2 keyType:(unsigned int)arg3 keyDiversifier:(id)arg4;	// IMP=0x0010000000520c60
- (id)initWithEndpoint:(id)arg1 fullDeviceIdentityContainerEncrypter:(id)arg2 replayCommitter:(id)arg3 forceLegacyPK:(_Bool)arg4;	// IMP=0x0010000000520b10
