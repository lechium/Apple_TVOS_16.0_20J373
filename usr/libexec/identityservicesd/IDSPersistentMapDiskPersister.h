...
- (void).cxx_destruct;	// IMP=0x00200000005a3c40
...
- (void)purgeData;	// IMP=0x00100000005a3640
- (void)saveData:(id)arg1;	// IMP=0x00100000005a2340
- (id)data;	// IMP=0x00100000005a1870
@property(readonly, nonatomic) _Bool isAvailable;
- (id)initWithIdentifier:(id)arg1 dataProtectionClass:(long long)arg2 keychainWrapper:(id)arg3 systemMonitor:(id)arg4 fileDirectory:(id)arg5;	// IMP=0x00100000005a15f0
- (id)initWithIdentifier:(id)arg1 dataProtectionClass:(long long)arg2 keychainWrapper:(id)arg3 systemMonitor:(id)arg4;	// IMP=0x00100000005a1500
