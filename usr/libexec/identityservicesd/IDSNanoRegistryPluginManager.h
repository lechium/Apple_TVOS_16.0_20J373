...
+ (id)sharedInstance;	// IMP=0x00400000000714c0
- (void).cxx_destruct;	// IMP=0x0020000000073380
...
- (void)_initializePluginWithClass:(Class)arg1;	// IMP=0x0010000000072650
- (void)_initializePlugin;	// IMP=0x00100000000722b0
- (void)executeSynchronouslyOnCallbackQueue:(CDUnknownBlockType)arg1;	// IMP=0x00100000000721c0
- (void)initializePluginWithClass:(Class)arg1;	// IMP=0x00100000000720e0
- (MISSING_TYPE *)notifyWatchToStopAdvertising;	// IMP=0x0010000000071dd0
- (void)notifyWatchDidStopAdvertisingWithPeripheralManager:(id)arg1;	// IMP=0x0010000000071be0
- (void)notifyWatchToStartAdvertising;	// IMP=0x00100000000718d0
- (void)notifyWatchDidStartAdvertisingWithPeripheralManager:(id)arg1;	// IMP=0x0010000000071720
- (id)init;	// IMP=0x0010000000071580
