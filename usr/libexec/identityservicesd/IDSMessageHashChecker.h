...
- (void).cxx_destruct;	// IMP=0x00200000001efe00
...
- (id)_legacyIdentity;	// IMP=0x00100000001efc50
- (_Bool)allowMessageData:(id)arg1 withDelayedCommitBlock:(CDUnknownBlockType *)arg2;	// IMP=0x00100000001ef970
- (_Bool)allowMessageData:(id)arg1;	// IMP=0x00100000001ef7b0
- (id)initWithRegistrationKeyManager:(id)arg1 messageHashStore:(id)arg2 usePairingKey:(_Bool)arg3;	// IMP=0x00100000001ef6a0
- (id)initWithRegistrationKeyManager:(id)arg1;	// IMP=0x00100000001ef5d0
