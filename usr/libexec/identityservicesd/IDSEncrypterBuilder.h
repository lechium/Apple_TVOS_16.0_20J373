...
+ (id)builderWithPublicKeyStorage:(id)arg1 peerIDManager:(id)arg2 accountController:(id)arg3 registrationKeyManager:(id)arg4 rateLimiter:(id)arg5 OTRController:(id)arg6 serviceController:(id)arg7 avoidMainQueue:(_Bool)arg8 forceLegacy:(_Bool)arg9;	// IMP=0x0040000000159e00
- (void).cxx_destruct;	// IMP=0x002000000015b270
...
- (id)verifierWithEndpoint:(id)arg1 keyType:(unsigned int)arg2 keyDiversifier:(id)arg3;	// IMP=0x001000000015ae70
- (id)verifierWithLocalURI:(id)arg1 remoteURI:(id)arg2 pushToken:(id)arg3 service:(id)arg4 cert:(id)arg5 keyType:(unsigned int)arg6 keyDiversifier:(id)arg7;	// IMP=0x001000000015ab80
- (id)signerWithKeyType:(unsigned int)arg1 keyDiversifier:(id)arg2 service:(id)arg3;	// IMP=0x001000000015aa40
- (id)encrypterWithOTRToken:(id)arg1;	// IMP=0x001000000015a990
- (id)encrypterWithEndpoint:(id)arg1;	// IMP=0x001000000015a820
- (id)encrypterWithDeviceID:(id)arg1;	// IMP=0x001000000015a700
- (id)encrypterWithLocalURI:(id)arg1 remoteURI:(id)arg2 pushToken:(id)arg3 service:(id)arg4 cert:(id)arg5;	// IMP=0x001000000015a3d0
- (id)_createHashingDeviceIdentityEncrypter;	// IMP=0x000000000015a2c0
- (id)initWithPublicKeyStorage:(id)arg1 peerIDManager:(id)arg2 accountController:(id)arg3 registrationKeyManager:(id)arg4 rateLimiter:(id)arg5 OTRController:(id)arg6 serviceController:(id)arg7 avoidMainQueue:(_Bool)arg8 forceLegacy:(_Bool)arg9;	// IMP=0x001000000015a050
