...
- (void).cxx_destruct;	// IMP=0x00200000001981a0
...
- (id)generateLinkReport:(double)arg1 isCurrentLink:(_Bool)arg2;	// IMP=0x0010000000197b70
- (void)_didReceiveData:(id)arg1;	// IMP=0x0010000000196bc0
- (void)didReceiveData:(id)arg1;	// IMP=0x0010000000196ab0
- (void)setHasSpaceAvailable:(_Bool)arg1;	// IMP=0x00100000001966d0
- (unsigned long long)sendPacketBufferArray:(struct **)arg1 arraySize:(int)arg2 toDeviceUniqueID:(id)arg3 cbuuid:(id)arg4;	// IMP=0x0010000000196650
- (unsigned long long)sendPacketBuffer:(CDStruct_dc2926a3 *)arg1 toDeviceUniqueID:(id)arg2 cbuuid:(id)arg3;	// IMP=0x00100000001962f0
- (id)copyLinkStatsDict;	// IMP=0x0010000000196190
@property(readonly, getter=linkTypeString) NSString *linkTypeString;
@property(readonly) unsigned long long headerOverhead;
- (void)start;	// IMP=0x00100000001960d0
- (void)triggerBTCorruptionRecovery;	// IMP=0x00100000001960a0
- (void)_localDetectedCorruption;	// IMP=0x0010000000196090
- (void)dealloc;	// IMP=0x0010000000196020
- (id)initWithWPLinkManager:(id)arg1 withIdentifier:(id)arg2;	// IMP=0x0010000000195ea0
