...
- (void).cxx_destruct;	// IMP=0x0020000000295c60
...
- (unsigned long long)count;	// IMP=0x0010000000295b10
- (_Bool)isEmpty;	// IMP=0x0010000000295ab0
- (id)initWithTopic:(id)arg1 sendMode:(id)arg2;	// IMP=0x00100000002959b0
