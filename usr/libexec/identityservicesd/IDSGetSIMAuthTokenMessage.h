...
- (void).cxx_destruct;	// IMP=0x00200000007174b0
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x0010000000717030
- (_Bool)isMultipleAuthCertCapable;	// IMP=0x0010000000717010
- (id)bagKey;	// IMP=0x0010000000716ff0
- (id)requiredKeys;	// IMP=0x0010000000716f90
- (id)messageBody;	// IMP=0x0010000000716c50
- (id)additionalMessageHeaders;	// IMP=0x0010000000716ac0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000007167b0
