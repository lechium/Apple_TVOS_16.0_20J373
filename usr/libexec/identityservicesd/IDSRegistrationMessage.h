...
- (void).cxx_destruct;	// IMP=0x00200000003798d0
...
- (void)setResponseHBI:(id)arg1;	// IMP=0x00100000003797b0
- (id)responseHBI;	// IMP=0x0010000000379780
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x0010000000379230
- (double)anisetteHeadersTimeout;	// IMP=0x0010000000379210
- (id)nonStandardMessageHeadersForOutgoingPush;	// IMP=0x0010000000379200
- (id)messageBody;	// IMP=0x0010000000378ce0
- (id)requiredKeys;	// IMP=0x0010000000378c00
- (_Bool)isMultipleAuthCertCapable;	// IMP=0x0010000000378be0
- (id)bagKey;	// IMP=0x0010000000378bc0
- (_Bool)requiresPushTokenKeys;	// IMP=0x0010000000378ba0
- (_Bool)hasRequiredKeys:(id *)arg1;	// IMP=0x0010000000378ac0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000003786c0
