...
- (void).cxx_destruct;	// IMP=0x00200000005a4620
...
- (void)purgeData;	// IMP=0x00100000005a4290
- (void)saveData:(id)arg1;	// IMP=0x00100000005a4190
- (id)data;	// IMP=0x00100000005a40f0
@property(readonly, nonatomic) _Bool isAvailable;
@property(readonly, nonatomic) NSString *identifier;
@property(readonly, copy) NSString *description;
- (id)initWithOriginPersister:(id)arg1 destinationPersister:(id)arg2 userDefaults:(id)arg3;	// IMP=0x00100000005a3d90
- (id)initWithOriginPersister:(id)arg1 destinationPersister:(id)arg2;	// IMP=0x00100000005a3ca0
