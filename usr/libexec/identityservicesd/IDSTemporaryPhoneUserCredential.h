...
- (void).cxx_destruct;	// IMP=0x00200000006b0810
...
- (id)initWithDataRepresentation:(id)arg1;	// IMP=0x00100000006b05c0
- (long long)realm;	// IMP=0x00100000006b05a0
- (id)initWithPhoneAuthenticationCertificate:(id)arg1;	// IMP=0x00100000006b03d0
