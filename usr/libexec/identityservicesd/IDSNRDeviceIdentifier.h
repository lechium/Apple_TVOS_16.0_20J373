...
+ (id)newDeviceIdentifierWithBluetoothUUID:(id)arg1;	// IMP=0x0020000000006410
- (void).cxx_destruct;	// IMP=0x0020000000006480
@property(readonly, nonatomic) NSUUID *nrDeviceIdentifier; // @synthesize nrDeviceIdentifier=_nrDeviceIdentifier;
- (id)initWithUUID:(id)arg1;	// IMP=0x00100000000063c0
