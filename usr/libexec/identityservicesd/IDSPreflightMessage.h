...
- (void).cxx_destruct;	// IMP=0x0020000000018850
...
- (void)setHardwareVersion:(id)arg1;	// IMP=0x00100000000184b0
- (id)hardwareVersion;	// IMP=0x0010000000018490
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x0010000000017f40
- (_Bool)requiresPushTokenKeys;	// IMP=0x0010000000017f20
- (id)bagKey;	// IMP=0x0010000000017f00
- (id)requiredKeys;	// IMP=0x0010000000017ea0
- (id)messageBody;	// IMP=0x00100000000179b0
- (id)additionalMessageHeaders;	// IMP=0x0010000000017820
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000017470
