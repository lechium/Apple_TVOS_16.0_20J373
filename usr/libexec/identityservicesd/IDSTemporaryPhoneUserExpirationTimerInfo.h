...
+ (long long)phaseForExpirationDate:(id)arg1;	// IMP=0x0040000000176da0
- (void).cxx_destruct;	// IMP=0x0020000000176e80
...
- (id)initWithUser:(id)arg1 expirationPhase:(long long)arg2;	// IMP=0x0010000000176b30
- (id)initWithUser:(id)arg1;	// IMP=0x0010000000176a50
