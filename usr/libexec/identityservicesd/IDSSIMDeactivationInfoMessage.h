...
- (void).cxx_destruct;	// IMP=0x002000000000f6a0
...
- (id)messageBody;	// IMP=0x001000000000ec80
- (id)requiredKeys;	// IMP=0x001000000000ec00
- (id)bagKey;	// IMP=0x001000000000ebe0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000000ead0
