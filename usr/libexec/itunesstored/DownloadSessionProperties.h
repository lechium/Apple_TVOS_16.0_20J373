...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000025cf9
- (unsigned long long)hash;	// IMP=0x0010000000025cef
- (id)description;	// IMP=0x0010000000025c89
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000025bc9
- (void)dealloc;	// IMP=0x0010000000025b71
- (id)initWithClientIdentifier:(id)arg1 handlerIdentifier:(long long)arg2;	// IMP=0x0010000000025b0f
