...
+ (id)changesetWithDownloadID:(id)arg1 state:(long long)arg2;	// IMP=0x0020000000012828
- (void).cxx_destruct;	// IMP=0x0020000000012d5b
...
- (id)copyXPCEncoding;	// IMP=0x0010000000012ad2
- (id)initWithXPCEncoding:(id)arg1;	// IMP=0x00100000000128c6
