...
- (void).cxx_destruct;	// IMP=0x0020000000185377
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000185211
- (id)initWithEntity:(id)arg1 accountIdentifier:(id)arg2;	// IMP=0x0010000000184f43
