...
- (void).cxx_destruct;	// IMP=0x00200000000b1a6f
- (id)_requestPropertiesWithAccount:(id)arg1 syncState:(id)arg2 fairPlaySubscriptionController:(id)arg3;	// IMP=0x00100000000b1a67
- (id)_newMachineDataOperationWithAccount:(id)arg1 response:(id)arg2;	// IMP=0x00100000000b193e
- (void)run;	// IMP=0x00100000000b18d5
