...
- (void)setError:(id)arg1 forItemIdentifier:(id)arg2;	// IMP=0x00100000001854fc
- (id)errorForItemIdentifier:(id)arg1;	// IMP=0x00100000001854d5
- (void)dealloc;	// IMP=0x001000000018547d
