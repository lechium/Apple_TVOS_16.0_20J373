...
+ (id)_unrecoverableErrors;	// IMP=0x002000000013a57e
- (void).cxx_destruct;	// IMP=0x002000000013a6cc
...
- (_Bool)_isUnrecoverable:(id)arg1 statusCode:(long long)arg2;	// IMP=0x001000000013a4fb
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000013a449
- (void)setValuesWithResponseDictionary:(id)arg1;	// IMP=0x001000000013a01a
