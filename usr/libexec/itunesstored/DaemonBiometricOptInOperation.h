...
- (void).cxx_destruct;	// IMP=0x002000000006972f
- (_Bool)_updateTouchIDSettingsForAccount:(id)arg1;	// IMP=0x0010000000069087
- (id)_authenticateWithAccount:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000068174
- (void)run;	// IMP=0x00100000000680d7
@property(copy) CDUnknownBlockType resultBlock;
@property _Bool requiresStoreAuthentication;
- (id)init;	// IMP=0x0010000000067f2f
