...
+ (void)forceSandboxForBundleIdentifier:(id)arg1 untilDate:(id)arg2;	// IMP=0x002000000018e930
+ (void)initialize;	// IMP=0x001000000018e902
...
- (id)description;	// IMP=0x001000000018f06c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000018ef72
- (void)setValuesWithSoftwareApplicationProxy:(id)arg1;	// IMP=0x001000000018ed04
- (void)setValuesWithPaymentQueueClient:(id)arg1;	// IMP=0x001000000018eb59
- (void)dealloc;	// IMP=0x001000000018eaec
