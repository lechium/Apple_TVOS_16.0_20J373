...
- (id)description;	// IMP=0x00200000000255b4
...
- (id)resetDisavowedSessionProperties;	// IMP=0x0010000000025139
@property(readonly) NSSet *disavowedSessionProperties;
- (void)addDisavowedSessionProperties:(id)arg1;	// IMP=0x0010000000024d2d
- (void)dealloc;	// IMP=0x0010000000024cd5
- (id)initWithInputConnection:(id)arg1;	// IMP=0x0010000000024c8b
