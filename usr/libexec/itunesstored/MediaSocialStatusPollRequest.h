...
- (void).cxx_destruct;	// IMP=0x0020000000025adc
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0010000000025990
- (unsigned long long)hash;	// IMP=0x001000000002597a
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000258b3
