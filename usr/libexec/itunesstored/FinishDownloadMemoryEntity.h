...
+ (id)defaultProperties;	// IMP=0x00400000000774e3
+ (Class)databaseEntityClass;	// IMP=0x00100000000774d2
- (void).cxx_destruct;	// IMP=0x0020000000077830
...
// Error: Property attributes should begin with the type ('T') attribute, property name: storeAccountName
// Property attributes: (null)

@property(readonly, nonatomic) NSNumber *storeAccountIdentifier;
- (id)secondaryAssetForType:(id)arg1;	// IMP=0x00100000000771a0
@property(readonly, nonatomic) long long restoreState;
- (id)newITunesMetadataDictionary;	// IMP=0x00100000000769e9
- (void)loadAssetsUsingSession:(id)arg1;	// IMP=0x0010000000076475
...
- (id)destinationDirectoryPathForAsset:(id)arg1;	// IMP=0x0010000000075eea
