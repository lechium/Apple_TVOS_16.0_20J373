...
- (void).cxx_destruct;	// IMP=0x0020000000030743
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000305a9
@property(readonly, nonatomic) RestoreDownloadItem *restoreDownloadItem;
@property(readonly, copy, nonatomic) NSDictionary *dictionaryRepresentation;
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x0010000000030020
- (id)initWithApplication:(id)arg1;	// IMP=0x001000000002fe8f
