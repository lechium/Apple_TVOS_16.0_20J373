...
- (void).cxx_destruct;	// IMP=0x00200000001c2a76
...
- (void)_updateWithDictionary:(id)arg1;	// IMP=0x00100000001c294a
- (id)description;	// IMP=0x00100000001c2833
- (id)initWithItemID:(id)arg1 bundleID:(id)arg2 clusterVersionID:(id)arg3 dictionary:(id)arg4;	// IMP=0x00100000001c272a
