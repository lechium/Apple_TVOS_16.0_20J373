...
@interface PrepareDownloadResponse : NSObject
{
    ...
    MISSING_TYPE *_ignoresDownloadHandler;	// 104 = 0x68
...
- (void).cxx_destruct;	// IMP=0x002000000016406b
...
- (id)_reuseExistingTaskInSession:(id)arg1;	// IMP=0x001000000016344a
- (id)_getExistingTaskInSession:(id)arg1;	// IMP=0x0010000000162de8
@property(readonly, nonatomic) NSString *URLSessionIdentifier;
- (id)sessionTaskWithSession:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000162a91
- (id)sessionConfiguration;	// IMP=0x00100000001628b9
