...
- (void)runWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x001000000004b22c
@property(readonly, nonatomic) _Bool blocksAppInstallation;
- (_Bool)applicationIsInstalled:(id)arg1;	// IMP=0x001000000004b1ab
- (void)dealloc;	// IMP=0x001000000004b170
- (id)initWithApplicationHandle:(id)arg1;	// IMP=0x001000000004b119
