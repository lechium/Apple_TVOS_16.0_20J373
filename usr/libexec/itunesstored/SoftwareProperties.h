...
@class MISSING_TYPE, NSData, NSDictionary, NSNumber, NSString;
...
@interface SoftwareProperties : NSObject
{
    ...
    MISSING_TYPE *_isFromStore;	// 48 = 0x30
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000b63f0
- (void)dealloc;	// IMP=0x00100000000b6367
