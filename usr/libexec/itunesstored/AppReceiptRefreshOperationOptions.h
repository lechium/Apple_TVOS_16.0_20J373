...
- (void).cxx_destruct;	// IMP=0x002000000018f380
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x001000000018f256
@property(readonly, nonatomic) NSString *URLBagKey;
- (id)initWithReceiptFlags:(unsigned long long)arg1;	// IMP=0x001000000018f1ee
