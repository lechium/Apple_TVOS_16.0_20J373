...
+ (id)periodFromISO8601String:(id)arg1;	// IMP=0x004000000005fe1a
...
- (id)copyProduct;	// IMP=0x001000000005fa49
- (void)dealloc;	// IMP=0x001000000005f9c7
- (id)initWithDictionary:(id)arg1;	// IMP=0x001000000005f31b
