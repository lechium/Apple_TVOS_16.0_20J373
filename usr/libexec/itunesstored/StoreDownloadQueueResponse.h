...
- (void).cxx_destruct;	// IMP=0x0010000000011d8c
...
- (id)_errorWithFailureType:(id)arg1 customerMessage:(id)arg2;	// IMP=0x0010000000011c88
...
- (id)errorForItemIdentifier:(id)arg1;	// IMP=0x001000000001197f
@property(readonly) NSOrderedSet *downloads;
- (id)initWithError:(id)arg1 userIdentifier:(id)arg2;	// IMP=0x00100000000117cb
- (id)initWithDictionary:(id)arg1 userIdentifier:(id)arg2 preferredAssetFlavor:(id)arg3;	// IMP=0x00100000000108a6
- (id)initWithDictionary:(id)arg1 userIdentifier:(id)arg2;	// IMP=0x0010000000010891
- (id)init;	// IMP=0x001000000001087f
- (id)_initStoreDownloadQueueResponse;	// IMP=0x0010000000010827
- (id)_newManifestWithStoreDownloadQueueResponse:(id)arg1 accountID:(id)arg2 accountName:(id)arg3;	// IMP=0x00100000001576c0
- (void)enumerateActivitiesWithAccountID:(id)arg1 accountName:(id)arg2 usingBlock:(CDUnknownBlockType)arg3;	// IMP=0x0010000000156da3
- (id)copyJobManifestWithAccountID:(id)arg1 accountName:(id)arg2;	// IMP=0x0010000000156d3a
