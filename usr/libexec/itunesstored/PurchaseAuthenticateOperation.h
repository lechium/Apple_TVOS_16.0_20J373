...
- (id)_userAgentForPurchases:(id)arg1;	// IMP=0x00200000001a8cc1
- (id)_clientIdentifierForPurchases:(id)arg1;	// IMP=0x00100000001a8b4f
- (void)run;	// IMP=0x00100000001a8999
@property(copy) NSString *clientIdentifierHeader;
@property(copy) CDUnknownBlockType authenticationBlock;
- (void)dealloc;	// IMP=0x00100000001a87e8
- (id)initWithPurchases:(id)arg1;	// IMP=0x00100000001a8620
