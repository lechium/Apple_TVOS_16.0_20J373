...
@class NSArray, NSData, NSMutableDictionary, NSString, StoreDownload;
...
+ (unsigned int)mediaTypeForStoreDownload:(id)arg1;	// IMP=0x00200000000f13df
- (id)_copyChapterVideoTracksForAsset:(id)arg1;	// IMP=0x00200000000f2a1f
@property long long updateType;
- (void)setValue:(id)arg1 forAdditionalEntityProperty:(id)arg2;	// IMP=0x00100000000f28b7
...
// Error: Property attributes should begin with the type ('T') attribute, property name: additionalEntityProperties
// Property attributes: (null)

- (void)loadPropertiesFromMediaPath:(id)arg1 includeTracks:(_Bool)arg2;	// IMP=0x00100000000f1fad
@property(readonly) _Bool hasItemArtwork;
@property(readonly, getter=isDownloading) _Bool downloading;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000f1228
- (void)dealloc;	// IMP=0x00100000000f11b9
- (id)init;	// IMP=0x00100000000f116b
