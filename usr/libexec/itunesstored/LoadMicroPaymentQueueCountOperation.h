...
- (_Bool)_setCountWithResponse:(id)arg1 error:(id *)arg2;	// IMP=0x001000000007ed97
- (_Bool)_loadCountReturningError:(id *)arg1;	// IMP=0x001000000007eac5
- (void)run;	// IMP=0x001000000007e81b
- (void)dealloc;	// IMP=0x001000000007e7b5
