...
- (void).cxx_destruct;	// IMP=0x00000000000d0eae
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000d0dba
- (void)addUploadIdentifier:(long long)arg1;	// IMP=0x00100000000d0d60
- (void)addPostIdentifier:(long long)arg1;	// IMP=0x00100000000d0d06
- (id)init;	// IMP=0x00100000000d0c91
