...
+ (void)initialize;	// IMP=0x00200000000af3b6
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00100000000af31b
- (_Bool)isEqual:(id)arg1;	// IMP=0x00100000000af1f1
- (unsigned long long)hash;	// IMP=0x00100000000af1db
- (id)description;	// IMP=0x00100000000af17b
@property(readonly, nonatomic) NSString *queueCountURLBagKey;
@property(readonly, nonatomic) NSString *queueContentsURLBagKey;
- (void)dealloc;	// IMP=0x00100000000af0c8
