...
- (void)_writeCacheWithFamilyCircle:(id)arg1 accountIdentifier:(id)arg2;	// IMP=0x0010000000010672
- (id)_familyCircleForDictionary:(id)arg1;	// IMP=0x001000000000fd0a
- (id)_cachePath;	// IMP=0x001000000000fc7e
- (id)_cachedFamilyCircleWithAccountIdentifier:(id)arg1;	// IMP=0x001000000000fa90
- (void)run;	// IMP=0x001000000000f548
- (void)dealloc;	// IMP=0x001000000000f4e2
