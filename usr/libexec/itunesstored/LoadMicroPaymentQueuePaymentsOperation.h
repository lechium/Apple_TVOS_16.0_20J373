...
- (_Bool)_parsePropertyList:(id)arg1 error:(id *)arg2;	// IMP=0x00100000000815ab
- (_Bool)_loadResponseReturningError:(id *)arg1;	// IMP=0x00100000000812d9
- (_Bool)_appendRangeRequestsToResponse:(id)arg1 error:(id *)arg2;	// IMP=0x0010000000081076
- (void)run;	// IMP=0x0010000000081014
