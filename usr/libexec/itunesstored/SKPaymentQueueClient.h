...
- (void).cxx_destruct;	// IMP=0x00200000000991df
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0010000000098fe4
- (id)copyXPCEncoding;	// IMP=0x0010000000098eef
- (id)initWithXPCEncoding:(id)arg1;	// IMP=0x0010000000098d18
