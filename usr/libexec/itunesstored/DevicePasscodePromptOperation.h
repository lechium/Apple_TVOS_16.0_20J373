...
- (void).cxx_destruct;	// IMP=0x00200000001090de
- (long long)_keyboardType;	// IMP=0x001000000010907f
- (void)remoteAlertHandleDidDeactivate:(id)arg1;	// IMP=0x001000000010906a
- (void)run;	// IMP=0x0010000000108fc8
@property(copy) CDUnknownBlockType tokenBlock;
- (id)initWithTitle:(id)arg1 message:(id)arg2;	// IMP=0x0010000000108bd2
