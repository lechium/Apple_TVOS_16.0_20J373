...
- (void)_setValue:(id)arg1 forKey:(id)arg2;	// IMP=0x001000000000f4ac
...
- (void)dealloc;	// IMP=0x001000000000f363
- (id)initWithManifestItemDictionary:(id)arg1;	// IMP=0x001000000000f30c
- (id)init;	// IMP=0x001000000000f2c0
