...
- (void).cxx_destruct;	// IMP=0x0020000000134276
...
- (id)_privacyAcknowledgementURLString;	// IMP=0x0010000000133f88
- (void)remoteAlertHandle:(id)arg1 didInvalidateWithError:(id)arg2;	// IMP=0x0010000000133dc1
- (void)remoteAlertHandleDidDeactivate:(id)arg1;	// IMP=0x0010000000133c24
- (void)run;	// IMP=0x0010000000133975
- (id)initWithPrivacyIdentifier:(id)arg1;	// IMP=0x0010000000133907
