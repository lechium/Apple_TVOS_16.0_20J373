...
+ (_Bool)responseIsValid:(id)arg1;	// IMP=0x004000000003ddcf
+ (id)paymentEntityFromContext:(id)arg1;	// IMP=0x001000000003dd82
@property(nonatomic, getter=isTransientFailed) _Bool transientFailed; // @synthesize transientFailed=_transientFailed;
- (void)_updateDownloadsFromResponse:(id)arg1;	// IMP=0x001000000003f043
- (id)_temporaryIdentifier;	// IMP=0x001000000003eff4
- (long long)_serverStateForClientState:(long long)arg1;	// IMP=0x001000000003ef98
- (long long)_clientStateForServerState:(long long)arg1;	// IMP=0x001000000003ef13
- (void)setValuesWithPaymentTransaction:(id)arg1;	// IMP=0x001000000003eb45
@property(retain, nonatomic) NSString *transactionIdentifier; // @dynamic transactionIdentifier;
- (void)awakeFromInsert;	// IMP=0x001000000003ea5e
- (void)setFailedWithError:(id)arg1;	// IMP=0x001000000003e97a
@property(readonly, nonatomic) NSString *matchingIdentifier;
@property(readonly, nonatomic, getter=isReady) _Bool ready;
- (void)mergeValuesFromResponse:(id)arg1;	// IMP=0x001000000003e59b
- (_Bool)isEqualToResponse:(id)arg1 compareAllFields:(_Bool)arg2;	// IMP=0x001000000003e39d
- (id)copyPaymentTransaction;	// IMP=0x001000000003de1b
- (void)dealloc;	// IMP=0x001000000003dd34
