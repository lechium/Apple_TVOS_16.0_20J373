...
- (void)addRefreshed:(id)arg1;	// IMP=0x0010000000108b0d
- (void)addRevoked:(id)arg1;	// IMP=0x0010000000108ab1
- (void)addExpiring:(id)arg1 expirationDate:(id)arg2;	// IMP=0x00100000001089d6
- (void)dealloc;	// IMP=0x0010000000108970
