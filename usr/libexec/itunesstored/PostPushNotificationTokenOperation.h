...
- (_Bool)_postTokenToURL:(id)arg1 error:(id *)arg2;	// IMP=0x0020000000095ebb
- (void)run;	// IMP=0x0010000000095993
@property(readonly) NSData *tokenData;
@property(copy) SSAuthenticationContext *authenticationContext;
@property(readonly) NSString *environmentName;
- (void)dealloc;	// IMP=0x001000000009583b
- (id)initWithEnvironmentName:(id)arg1 tokenData:(id)arg2;	// IMP=0x00100000000957b3
- (id)init;	// IMP=0x001000000009579d
