...
- (void)_setURLCredential:(id)arg1;	// IMP=0x0020000000175220
- (void)_setState:(long long)arg1;	// IMP=0x00100000001751d1
- (id)_openSession;	// IMP=0x0010000000174f86
- (void)downloadHandlerManager:(id)arg1 sessionsDidChange:(id)arg2;	// IMP=0x0010000000174db2
- (void)run;	// IMP=0x00100000001748c4
- (void)cancel;	// IMP=0x001000000017483c
- (id);	// IMP=0x00100000001747e7
@property(copy) CDUnknownBlockType outputBlock;
@property(readonly) DownloadSessionProperties *sessionProperties;
@property(readonly) long long downloadSessionState;
- (void)dealloc;	// IMP=0x001000000017465b
- (id)initWithSessionProperties:(id)arg1;	// IMP=0x00100000001745eb
