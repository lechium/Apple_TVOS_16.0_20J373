...
- (void).cxx_destruct;	// IMP=0x00200000001bf240
@property(nonatomic) __weak id <MediaSocialStatusPollingDelegate> delegate; // @synthesize delegate=_delegate;
- (void)_finishRequests:(id)arg1 withResponses:(id)arg2;	// IMP=0x00100000001beb97
- (void)_addBackgroundTaskJob;	// IMP=0x00100000001beb91
- (void)_handleBackgroundTaskEvent:(id)arg1;	// IMP=0x00100000001beb8b
@property(readonly, nonatomic) long long numberOfPollRequests;
- (void)addPollRequest:(id)arg1;	// IMP=0x00100000001beb6f
- (void)dealloc;	// IMP=0x00100000001beb40
- (id)initWithDispatchQueue:(id)arg1;	// IMP=0x00100000001bea71
