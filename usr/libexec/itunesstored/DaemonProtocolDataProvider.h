...
- (_Bool)processDictionary:(id)arg1 error:(id *)arg2;	// IMP=0x00100000001972a3
- (void)_presentDialog:(id)arg1;	// IMP=0x001000000019720f
- (void)dealloc;	// IMP=0x00100000001971cd
