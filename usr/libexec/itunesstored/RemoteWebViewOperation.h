...
- (void).cxx_destruct;	// IMP=0x002000000016a3f3
...
- (void)_sendActivationWithError:(id)arg1;	// IMP=0x001000000016a23e
- (void)remoteAlertHandle:(id)arg1 didInvalidateWithError:(id)arg2;	// IMP=0x001000000016a069
- (void)remoteAlertHandleDidDeactivate:(id)arg1;	// IMP=0x0010000000169eba
- (void)remoteAlertHandleDidActivate:(id)arg1;	// IMP=0x0010000000169d1b
- (void)run;	// IMP=0x00100000001697ee
- (id)initWithWebViewRequest:(id)arg1;	// IMP=0x001000000016975d
