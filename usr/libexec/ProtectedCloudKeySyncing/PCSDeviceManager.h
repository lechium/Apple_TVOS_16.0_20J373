...
+ (id)sharedManager;	// IMP=0x00200000000043f7
- (void).cxx_destruct;	// IMP=0x0020000000005189
...
- (void)setSimulatedDevices:(id)arg1;	// IMP=0x0010000000004e10
@property(readonly) NSArray *allDevices;
- (id)deviceForPairingID:(id)arg1;	// IMP=0x0010000000004909
- (id)deviceForIDSIdentifier:(id)arg1;	// IMP=0x001000000000466d
- (id)currentActivePairedDevice;	// IMP=0x00100000000044c3
- (id)init;	// IMP=0x001000000000444c
