...
- (void).cxx_destruct;	// IMP=0x002000000000c6a6
...
- (void)trigger;	// IMP=0x001000000000c4cf
- (void)setHoldTransaction:(_Bool)arg1;	// IMP=0x001000000000c445
- (void)run;	// IMP=0x001000000000c433
- (void)setAction:(CDUnknownBlockType)arg1;	// IMP=0x001000000000c401
- (id)initWithDelay:(unsigned long long)arg1 operationQueue:(id)arg2;	// IMP=0x001000000000c025
