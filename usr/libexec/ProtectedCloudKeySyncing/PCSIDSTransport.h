...
+ (id)transportWithIDSServiceName:(id)arg1;	// IMP=0x0020000000001f84
- (void).cxx_destruct;	// IMP=0x00200000000039ab
...
- (id)copyLocalPairedDevices;	// IMP=0x001000000000391a
- (void)service:(id)arg1 account:(id)arg2 identifier:(id)arg3 didSendWithSuccess:(_Bool)arg4 error:(id)arg5;	// IMP=0x00100000000037e3
- (void)service:(id)arg1 account:(id)arg2 incomingMessage:(id)arg3 fromID:(id)arg4 context:(id)arg5;	// IMP=0x00100000000033e8
- (void)sendResponse:(id)arg1 toMessage:(id)arg2 withPriority:(long long)arg3 timeout:(double)arg4 logDescription:(id)arg5;	// IMP=0x0010000000002d0d
- (void)sendMessage:(id)arg1 toDevice:(id)arg2 withPriority:(long long)arg3 timeout:(double)arg4 logDescription:(id)arg5 handleReply:(CDUnknownBlockType)arg6;	// IMP=0x001000000000254c
- (id)initWithServiceName:(id)arg1;	// IMP=0x00100000000021e2
